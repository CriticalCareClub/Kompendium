...
\newcommand{\PictureSeriesRowWide}[9]{
\ifthenelse{\equal{#1}{2}}
{\subfloat
[#3]
{\ifthenelse{\equal{#2}{empty}}{\parbox{0.32\linewidth}{~}}{\includegraphics[width=0.45\linewidth]{#2}}}
...
{\subfloat
[#3]
{\ifthenelse{\equal{#2}{empty}}{\parbox{\ThirdNetWidth}{~}}{\includegraphics[width=\ThirdNetWidth]{#2}}}%
\hspace{\columnsep}%
\subfloat[#5]
{\ifthenelse{\equal{#4}{empty}}{\parbox{\ThirdNetWidth}{~}}{\includegraphics[width=\ThirdNetWidth]{#4}}}%
\hspace{\columnsep}%
\subfloat[#7]
{\ifthenelse{\equal{#6}{empty}}{\parbox{\ThirdNetWidth}{~}}{\includegraphics[width=\ThirdNetWidth]{#6}}}
}
{}
\ifthenelse{\equal{#1}{4}}
{\subfloat
...
Vicco von Bülow (\textborn\,1923, \textdied\,2011)
