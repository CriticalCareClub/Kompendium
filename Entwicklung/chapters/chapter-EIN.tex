...
\begin{description}
  ...
  \item[Indikation] Grund zur Anwendung eines bestimmten
  Verfahrens.
  ...
  Diagnose zu stellen, egal ob man sich der eignen Sinne
...
\begin{itemize}
    ...
    ähnliche Krankheitsbilder können  aber nicht mit
...
\paragraph{Anhängsel
{\enquote*{\T{-itis}}}}\index{itis@-itis}
Gastritis ${\rightarrow}$
\enquote*{Magenentzündung}, Hepatitis
...
\enquote*{Schnupfen}, Otitis ${\rightarrow}$
Ohrenentzündung, ...
...
Gewebes mit sauerstoffreichem Blut infolge der Verstopfung
...
Schermzen sind ein typisches Symptom. Häufig betroffene
Gewebe sind:
