...
\gEs{Aspiration}\index{Aspiration} von Speichel, Blut oder Erbrochenen kommen. 
}{
Gefahren:
\begin{itemize}
...
\gLayout{2}{Schutzreflexe}
{
 Ab einem gewissen Punkt können auch so wesentliche
    Funktionen wie der \gEs{Schluck-}, \gEs{Würge-} bzw. \gEs{Hustenreflex}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\gLayout{0}{Einteilung der Störungen}
{
Man unterscheidet zwischen der Quantität ("`\gE{Wieviel} Bewusstsein ist
vorhanden?"') und der Qualität ("`\gE{Wie gut} funktioniert das vorhandene
Bewusstsein?"'). Maßgeblich ist der \gEs{Bewusstseinsgrad} (quanititativ) und
die \gEs{Orientiertheit} des Patienten (qualitativ). 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\gLayout{2}{Bewusstseinsgrad}
{
\index{Bewusstseinsgrad}
\label{topic:bewusstseinsstoerung-grade}
\index{Bewusstsein!Symptome}

Der Bewusstseinsgrad gibt Auskunft über die Quantität des Bewusstseins ("`\gE{Wieviel} Bewusstsein ist
...
\gCaptionof{table}{Bewusstseinsgrade\label{tab:bewusstseinsgrade}}
...
Heutzutage dient die \gAbk{GCS} vorwiegend statistischen
Zwecken\gZFootnote{Regelmäßig findet man Handlungsanweisungen -- überwiegend
für ärztliches Personal -- in der Literatur, welche die \gAbk{GCS} als
...
Bewusstseinsstörung. Diese Schädigung kann direkt das \gAbk{ZNS} betreffen
(primäre Ursache) oder über Umwege einen schädlichen Einfluß auf das \gAbk{ZNS}
haben (sekundäre Ursache). \prettyref{tab:bewusstseinsstoerungen-ursachen}
listet typische Ursachen auf.

\begin{table}[H]
\gCaptionof{table}{Typische Ursachen von
...
{
\begin{itemize}
  \item Direkt das \gAbk{ZNS} betreffend (primär).
  \item Indirekt das \gAbk{ZNS} betreffend (sekundär).
\end{itemize}
...
\begin{labeling}[\dots{}]{Atemminutenwolumen (AMV)}
  \item[\gT{Atemfrequenz} (\gT{AF})] gibt die Anzahl der Atemzüge pro
  Minute an.
  \item[\gT{Atemzugsvolumen} (\gT{AZV})] gibt die Menge
  Luft an, die \gE{pro Atemzug} eingeatmet wird.
  \item[\gT{Atemminutenvolumen} (\gT{AMV})] gibt die Menge an \gE{pro Minute}
...
\gCave{Bei jedem Patienten ist zu erheben, ob ein Schock
...
\gLayout{20}{Flüssigkeitsverschiebung durch Diffusion}
{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TODO : Fließtext/Slide fehlt!
\begin{anfxwarning}[author=GABS]{Fließtext/Slide fehlt!}
...
Membran}halbdurchlässige\gZFootnote{semipermeable} 
...
Elektrolyte einen Druck auf das Wasser ausüben {\quotedblbase}die Seiten zu
wechseln{\textquotedblleft}. Man nennt diesen Druck den
{\quotedblbase}\index{osmotischer Druck}\gT{osmotischen
Druck}{\textquotedblleft}. Man kann auch sagen
