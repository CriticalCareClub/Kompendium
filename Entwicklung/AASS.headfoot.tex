...
\fancyfoot[RO]{{\noindent{\sffamily\tiny\color{AsboeGreyLight}\DocVersion}~~\AASS{}\,{\color{AsboeRed}$\cdot$}\,{\ASBOE}~ }}
% even
\fancyfoot[LE]{{\noindent\AASS{}\,{\color{AsboeRed}$\cdot$}\,{\ASBOE}~~\sffamily\tiny\color{AsboeGreyLight}\DocVersion}}
\fancyfoot[RE]{{\noindent\sffamily\tiny\color{AsboeGreyLight}\url{http://www.aass.at}~~$\cdot$~~\url{http://www.samariterbund.net}}}
}
