...
\Layout{0}{Rechtslage}{
\subparagraph{Behandlungspflicht für Krankenanstalten}\ZFootnote{{\S}{\S}\,22 und 40 KAKuG}
...
\subparagraph{Ärztliche Behandlungspflicht}\ZFootnote{{\S}\,48 ÄrzteG}:
...
\subparagraph{Behandlungspflicht für Sanitäter}\ZFootnote{{\S}\,4 i.\,V.\,m. {\S}\,8 i.\,V.\,m. {\S}\,9 Abs. 1 Z 1
SanG}
...
Durchschnittsbürger}\ZFootnote{{\S}\,95 StGB}
...
\subparagraph{Unzumutbarkeit der Behandlung}\ZFootnote{{\S}\,95 Abs. 2 StGB}
Für alle Berufe oder Durchschnittsbürger ist die Behandlung dann
nicht zumutbar, wenn:
\begin{itemize}
  \item man das eigene Leben oder die Gesundheit gefährden würde
  \item höherwertige Interessen verletzen müsste.
\end{itemize}
}{
\begin{itemize}
...
\end{wrapfigure}Dort angekommen finden sie in einer Lacke von Blut die
