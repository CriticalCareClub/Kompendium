...
Die Sterblichkeit bei polytraumatisierten Patienten liegt zwischen \VonBis{20}{50}\,\%, ist
...
Ab ca. 20\,--\,30\,\% verbrannter Körperoberfläche kann sich eine
\T{Verbrennungskrankheit} entwickeln. Dabei kommt es zu einer körperweiten
...
Verbrennungspatienten von einer über 40\,\%ig erhöhten Chance zu versterben wenn
...
der Körper in 9\,\%-Teile eingeteilt um das Ausmaß der Vebrennung abschätzen zu können.
...
einer betroffenen Körperoberfläche von >\,20\,\% (Erwachsene; Kinder >\,10\,\%,
Säuglinge >\,5\,\%) gilt eine Verbrennung als \E{großflächig}. Aufgrund des
\E{Flüssigkeitsverlustes} durch die Verbrennungskrankheit und Verdunstung
besteht ab \E{10\,\%} (oder \E{5\,\%} bei Kindern) $\geq$\,2\,{\textdegree}
verbrannter Körperoberfläche \EE{Schockgefahr}
(hypovolämischer Schock)! Der Schock entwickelt sich allerdings erst allmählich.

\Fazit{Ab \EE{10\,\% $\geq$\,2\,{\textdegree}} verbrannter Körperoberfläche gilt
eine Verbrennung als "`schwer"', für \EE{Kinder} gilt eine Grenze von
\EE{5\,{\%}}.}

}{%
Ab \EE{10\,\% $\geq$\,2\,{\textdegree}} verbrannter Körperoberfläche gilt
eine Verbrennung als "`schwer"'; für \EE{Kinder} gilt eine Grenze von
\EE{5\,{\%}}.
}{}{}{}
