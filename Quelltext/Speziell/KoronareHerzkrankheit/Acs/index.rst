...
.. index::
    single: GP IIb/IIIa-Inhibitor (ACS)
    single: Ticagrelor (ACS)
    single: Brilique® (ACS)
    single: Clopidogrel (ACS)
...
.. index::
    ...
    single: Ticagrelor (STEMI)
    single: Brilique® (STEMI)
...
.. versionchanged:: 4.0.0-0.2021-08-25
    ...
    `#94 Aktualisierung Handlungsempfehlung ACS <https://gitlab.com/CriticalCareClubAustria/Ccca-Kompendium/-/issues/94>`_
