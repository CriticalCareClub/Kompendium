...
\begin{itemize}
    ...
    \item \gEs{brodelnde Atemgeräusch} beim Lungenödem
    \item Ödeme
\end{itemize}
}
...
\gSee{topic:lungenoedem} (Lungenödem) besprochen. 
...
\begin{itemize}
	...
	mehrerer Eineingung(en) von Herzkranzgefäßren (Koronararterien)
	oder
	\item Erhöhter Sauerstoffbedarf des Herzens bei Anstregung
\end{itemize}
{\mdseries
...
\\\midrule 
\gEs{Kammerflimmern} & Reanimation  & \emph{"`schockbarer"'} Rhythmus
\\\addlinespace
...
Definition MCI nicht überien, AP wäre besser oder? GABS: AP dazugenommen,
...
erhöhten Druck gegen den das Herz pumpen muß. Der Muskel
...
\begin{itemize}
    ...
    \end{itemize}
    \item Herzmuskel (Herz muss gegen größeren Widerstand pumpen)
    \begin{itemize}
...
Immobilisation (Reisen, Bettlägrigkeit, Gips, \ldots) enstehen können.
...
besteht die Gefahr, daß der Patient nach einiger Zeit keine
...
\gMassnahmen{
    ...
    \begin{itemize}
       ...
       geschlossene Lippen ausatmen lassen (Lippenbremse)
        \item Sprays, die Patient ev. bei sich hat dürfen nicht mehr genommen
        werden.
    \end{itemize}
...
der Körper gewöhnt sich daran. Der Körper regelt dann den
Atemantrieb direkt über den $O_2$-Gehalt im Blut. 
...
\gMassnahmen{
    ...
    \begin{itemize}
        ...
        erwägen!
        \item $O_2$-Gabe\footnote{Sauerstoff vorsichtig
        dosieren, anfänglich nur 2-3~l/ min. und Atmung überwachen. Wenn der Patient bereits Heimsauerstoff benutzt kann man bei
    Atemnot versuchen 1-2~l/min höher zu dosieren. Die Atmung muss
...
\begin{itemize}
    \item Dyspnoe, Husten
    \item Fieber (muß aber nicht sein)
...
Patient nicht bei Bewußtsein, es besteht ausserdem i.d.R.
...
von 24 Stunden). Der Krampf muß dann mit Medikamenten
durchbrochen werden.
...
Unterzuckers (zuviel Insulin gespritzt oder zu wenig
...
\begin{description}
    ...
    kein Insulin -- absoluter Mangel. Es muß
    ...
    Relativer Insulinmangel, Körper ist übersättig an Insulin und
...
\begin{itemize}
    ...
    \item {\mdseries
    Verwirrtheit, Krampfanfälle, Bewußtlosigkeit}
...
schwallartiges Erbrechen von Kaffeesatz-artigem Mageninhalt (wenn das Blut von der
...
heftigem, akutem Bauchscherz zum Tod. Kleinere Läsionen sind
ebenfalls von heftigem, akut einsetzendem Bauchschmerz
...
akute Erkankung. Sie entsteht dadurch, dass Nierensteine den
Harnleiter blockieren und verstopfen. Dadurch wird der Harn
...
klassichen Dialyse wird der Patient jeden zweiten oder dritten Tag für
einige Stunden an eine Maschine angeschlossen, welche sein
...
Zwischen der 18. und der 20. SSW kann die Mutter die erste Kindsbewegungen
spüren. \gEs{Ab der 24.
...
\gMarried{
Nachdem der Muttermund vollständig eröffnet ist (10 cm), berginnt die
Austreibungsphase. Die Wehen kommen nun alle 2-3 Minuten und sind nun keine
...
\begin{enumerate}
    \item Nun wird das Neugeborenen mittles Schleimabsuager abgesaugt und kann
    für das Abnabeln vorbereitet werden.
...
(\gE{Mutterkuchen}). Die Gefahr hiebei ist, dass es zu
...
\begin{itemize}
	...
	\item \emph{"`Gab es während der Schwangerschft
	Komplikationen?"'}
...
natürlich ein sehr großes Geburtshindernis, ausserdem kann es durch vorzeitiges
Lösen des Mutterkuchens zu massiven Blutungen kommen.
...
Diese Wahnideen können in weiterer zu einem \gT{Wahnsystem}
ausgebaut werden 
...
Überdosierungen. Die Folge sind Herzrhythmusstörungen udn
...
und Hepatits C. Eine weitere Gefahr geht vom Spritzbesteck
