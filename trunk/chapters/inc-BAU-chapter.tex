...
(\T{mmHg}).\index{Millimeter Quecksilbersäule}\index{mmHg}\footnote{\E{Hg} ist
das chemische Symbol für Quecksilber.}

\Married{
Der Blutdruck kann auf verschiedene Arten gemessen werden. 
%Üblich ist die
%\E{indirekte Methode}, bei welcher mittels einer Druckmanschette an einer
...
\Layout{28}{Was ist besonders zu beachten?}
{
