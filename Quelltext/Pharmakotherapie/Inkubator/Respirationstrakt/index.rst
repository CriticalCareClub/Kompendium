...
+-----------------------+---------------------------------------------+
| Cetirizin             | **Zyrtec®, Alerid®, Reactine®, Rigix®,      |
|                       | Virlix®**                                   |
+-----------------------+---------------------------------------------+
| **Clemastin \***      | Tavegil®                                    |
+-----------------------+---------------------------------------------+
...
+-----------------------+---------------------------------------------+
| **Dimenhydrinat \***  | **Vomex A®, Vertirosan®**                   |
+-----------------------+---------------------------------------------+
| **Dimetinden \***     | **Fenistil®, Vibrocil®, Trimedil®**         |
+-----------------------+---------------------------------------------+
| **Diphenhydramin \*** | **Vivinox®, Calmaben®, Noctor®, Seltoc®**   |
+-----------------------+---------------------------------------------+
| Fexofenadin           | Telfast®                                    |
+-----------------------+---------------------------------------------+
| **Ketotifen \***      | **Zaditen®, Ketotisan®**                    |
+-----------------------+---------------------------------------------+
| Levocetirizin         | **Xusal®, Xyzall®**                         |
+-----------------------+---------------------------------------------+
| Loratadin             | **Lisino®, Allernon®, Clarityn®, Lorano®,   |
|                       | Clarinase®**                                |
+-----------------------+---------------------------------------------+
| **Meclozin \***       | **Peremesin®, Diligan®**                    |
+-----------------------+---------------------------------------------+
| **Promethazin \***    | Atosil®                                     |
+-----------------------+---------------------------------------------+
| Terfenadin            | **Hisfedin®, Allergin®**                    |
+-----------------------+---------------------------------------------+
...
=============== ====================================================
Mesna           **Mistabronco®, Uromitexan®**
N-Acetylcystein **Fluimucil®, ACC®, Aeromuc®, Muccobene®, Siccoral**
=============== ====================================================

-   sekretolytisch (Anregung zur Produktion eines dünnflüssigeren
    Sekretes):

========= ======================================
Ambroxol  **Mucosolvan®, Mucoangin®, Mucospas®**
Bromhexin Bisolvon®
========= ======================================

-   sekretomotorisch (Anregung der Bewegungen des Flimmerepithels des
    Bronchialtraktes)

+-------------+-------------------------------------------------------+
| Theophyllin | **Bronchoretard®, Euphyllin®, Respicur®, Theospirex®, |
|             | Unifyl®**                                             |
+-------------+-------------------------------------------------------+
...
.. attention::
    ...
    Die Gabe eines Expektorans sollte spätestens 2 Stunden vor dem Schlafengehen erfolgen.
...
============= =================================
Codein        Codipront®
Dihydrocodein **Paracodin®, Codidol®, Dehace®**
Hydrocodon    Dicodil®
============= =================================
...
.. attention:: Antitussiva sollten knap vor dem Zu-Bett-Gehen genommen werden, um einen möglichst ruhigen Schlaf zu ermöglichen.

β₂-Sympathomimetika:
-----------------------------

Diese Substanzgruppe enthält die stärksten verfügbaren
Bronchodilatatoren. Daher werden sie bei der Therapie des Asthma
bronchiale und der COPD eingesetzt. Durch die meist inhalative
Applikation zeigen sie kaum systemische Nebenwirkungen.

+----------------------------------+----------------------------------+
| Clenbuterol                      | **Spiroprent®, Mucospas®**       |
+----------------------------------+----------------------------------+
| **Fenoterol**\ :sup:`●`\ **\***  | **Berotec®, Berodual®,           |
|                                  | Berodualin®**                    |
+----------------------------------+----------------------------------+
| **Formoterol**\ :sup:`■`\ **\*** | **Foradil®, Oxis®, Symbicord®**  |
+----------------------------------+----------------------------------+
| **Reproterol**\ :sup:`●`\ **\*** | **Bronchospasmin®**              |
+----------------------------------+----------------------------------+
| **Salbutamol**\ :sup:`●`\ **\*** | **Sultanol®, Asmalon®,           |
|                                  | Buventol®, Epaq®, Combivent®,    |
|                                  | Ventide®**                       |
+----------------------------------+----------------------------------+
| **Salmeterol**\ :sup:`■`         | **Serevent®, Seretide®, Viani®** |
+----------------------------------+----------------------------------+
| **Terbutalin**\ :sup:`●`\ **\*** | **Bricanyl®**                    |
+----------------------------------+----------------------------------+

:sup:`●`\ kurzwirksameβ₂-Sympathomimetika,\ :sup:`■`\ langwirksame
β₂-Sympathomimetika, \* raschwirksame
β₂-Sympathomimetika

Die s.c.- und i.v.-Gabe ist reserviert für die Notfalltherapie.

Für Nebenwirkungen und Kontraindikationen *siehe Kap. NS.*
...
+-------------+-------------------------------------------------------+
| Coffein     | u.a. im Kaffee enthalten                              |
+-------------+-------------------------------------------------------+
| Theobromin  | u.a. im Tee enthalten                                 |
+-------------+-------------------------------------------------------+
| Theophyllin | **Bronchoretard®, Euphyllin®, Respikur®, Theospirex®, |
|             | Unifyl®**                                             |
+-------------+-------------------------------------------------------+
...
Therapie der wichtigsten respiratorischen Erkrankungen
-------------------------------------------------------
...
Schweregrade eines Asthmaanfalls:

+-------------+------------+-------------+-------------+-------------+
| Schweregrad | Dyspnoe    | Haltung     | Sprache     | Bewus       |
|             |            |             |             | stseinslage |
+-------------+------------+-------------+-------------+-------------+
| leicht      | beim Gehen | Kann ohne   | Sätze       | normal      |
|             |            | Probleme    |             |             |
|             |            | liegen      |             |             |
+-------------+------------+-------------+-------------+-------------+
| Mäßig       | beim Reden | Sitzen      | kurze Sätze | aufgeregt   |
+-------------+------------+-------------+-------------+-------------+
| Schwer      | in Ruhe    | aufrechtes  | Worte       | aufgeregt   |
|             |            | Sitzen      |             |             |
+-------------+------------+-------------+-------------+-------------+
| Drohender   | in Ruhe    | aufechtes   | stumm,      | benommen    |
| Ate         |            | Sitzen,     | stöhnen     |             |
| mstillstand |            | Liegen      |             |             |
|             |            | (E          |             |             |
|             |            | rschöpfung) |             |             |
...
+---------------------------+-----------------------------------------+
| 1 (intermittierend)       | intermittierende Symptome unter einmal  |
|                           | pro Woche, nächtliche Symptome weniger  |
|                           | als zweimal pro Monat; im Intervall     |
|                           | beschwerdefrei                          |
+---------------------------+-----------------------------------------+
| 2 (persistierend, leicht) | Symptome unter einmal pro Tag           |
+---------------------------+-----------------------------------------+
| 3 (persistierend, mittel) | Symptome jeden Tag, nächtliche Symptome |
|                           | weniger als einmal pro Woche; Anfälle   |
|                           | beeinträchtigen den Schlaf und          |
|                           | körperliche Aktivität                   |
+---------------------------+-----------------------------------------+
| 4 (persistierend, schwer) | ständige Symptome, häufig auch nachts;  |
|                           | häufige Anfälle; Einschränkung der      |
|                           | körperlichen Aktivität                  |
+---------------------------+-----------------------------------------+

Auch hier ist die Therapie nach dem Erkrankungs-Schweregrad eingeteilt:

+-------------+-------------+-------------+-------------+-------------+
| 1           | schne       |             |             |             |
| (inter      | llwirksame, |             |             |             |
| mittierend) | inhalative  |             |             |             |
|             | β2-Mimetika |             |             |             |
|             | bei Bedarf  |             |             |             |
+-------------+-------------+-------------+-------------+-------------+
| 2           | Th 1        | Da          |             |             |
...
| 3           | Th 1        | Th 2        | l           |             |
| (per        |             |             | angwirksame |             |
| sistierend, |             |             | inhalative  |             |
| mittel)     |             |             | β2-Mimetika |             |
+-------------+-------------+-------------+-------------+-------------+
| 4           | Th 1        | Th 2        | Th 3        | Theophyllin |
| (per        |             |             |             | oder orale  |
| sistierend, |             |             |             | Gluk        |
| schwer)     |             |             |             | okortikoide |
|             |             |             |             | oder        |
