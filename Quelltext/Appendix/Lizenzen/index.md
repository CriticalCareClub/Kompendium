...
2. Sie dürfen Auszüge in Form von mehreren vollständigen und
...
3. Sie dürfen einzelne Bilder und Grafiken gemäß den Bedingungen von
   {ref}`Lizenz` nutzen, sofern diese unter der Lizenz des Kompendiums des CCCA stehen.

4. Sie dürfen folgende Seiten eigenständig gemäß den Bedingungen von
   {ref}`Lizenz` nutzen:
