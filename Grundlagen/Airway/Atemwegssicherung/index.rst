...
Flüssigkeiten bietet sich die *Absaugung* an ([topic:absaugung]). Um
...
aus dem Mund-Rachen-Raum abgesaugt werden. Es gibt dabei
unterschiedliche Geräteklassen: Grundsätzlich wird nach der Betriebsart
unterschieden zwischen einer *elektrischen Absaugeinheit*, einer
...
vom Helfer in den Mund genommen wird. Der Oro-Sauger wird *nicht* an ein
Absauggerät angeschlossen, der Helfer muss selbsttätig mit dem Mund
(*lat.* *oro*) saugen. Dadurch gelangt das Sekret aus dem Absaugkatheter
in den Behälter. Der Katheter und der andere Schlauch müssen dabei *von
oben* den Behälter verlassen, um zu verhindern, dass Sekret in den Mund
...
bestimmt werden. Es darf *maximal auf Sicht* abgesaugt werden!

Der Katheter wird *ohne Sog eingeführt*, dazu wird entweder der Katheter
abgeknickt oder der Fingertip offen gelassen. Unter kreisenden
Bewegungen wird dann auf Sicht abgesaugt und der Katheter herausgezogen.
Wenn sich der Katheter festsaugt, muss der Fingertip geöffnet oder der
Katheter abgesteckt werden. Der Vorgang wird nach Bedarf wiederholt.

-  Es darf nur auf Sicht abgesaugt werden!
...
([topic:parasymapthikus]). Weiters kann es zu *Schleimhautverletzungen*
...
Schädel-Hirn-Trauma ([topic:sht]) darf aufgrund möglicher Verletzungen
