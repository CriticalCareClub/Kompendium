...
Den \gEs{Lebensrettenden Sofortmaßnahmen}, welche noch in \gE{Allgemeine
Sofortmaßnahmen} und in am Patienten gesetzten \gE{Lebensrettende
Sofortmaßnahmen} unterteilt werden können. Zu den \gE{Allgemeinen Sofortmaßnahmen} zählt das Absichern der Unfallstelle - Eigensicherung! Das
Retten von Personen aus Gefahrenzonen. Das Absetzen des Notrufes durch eine 2.
Person. Zu den am Patienten zusetzenden \gE{Lebensrettenden Sofortmaßnahmen}
...
starken Blutungen, Schockbekämpfung beim Schock. Nach den Lebensrettenden
Sofortmaßnahmen kann der \gEs{Notruf} abgesetzt werden. 

Anschließend sollte 
\gEs{weitere Erste Hilfe} geleistet werden. Wie die Versorgung von einfacheren
Verletzung, und die psychologische Betreuung des Patienten. Der eintreffende
Rettungsdienst übernimmt den Patienten für die \gEs{Sanitätshilfe} und den
\gEs{Transport} durch. Im Spital erfolgt die \gEs{ärztliche Betreuung} des
Patienten. Jenachdem wie gut die Rettungskette funktionert hat noch im
...
Vor dem Setzen irgend einer Maßnahme sollte der Ersthelfer seine. Einmal tief
durchatmen und dann sich einen \gEs{Überblick} über die Situation verschaffen.
Was ist überhaupt passiert? Um welche Art von Notfall handelt es sich? Welche
Gefahren können drohen? Anschließend \gEs{Ruhe bewahren} und \gEs{Ruhe
vermitteln}. Dabei ruhig und gezielt auf die bevorstehenden Maßnahmen einstellt und die bevorstehenden Maßnahmen nach \gEs{Dringlichkeit} sortieren. Erst wenn
all diese Schritte gesetzt wurden, darf mit einer Behandlung begonnen werden!
}{
\begin{itemize}
...
Bei der Überblickgewinnung kann der Ersthelfer eine \gEs{Gefahr erkennen}.
Diese kann für den Patienten, den Ersthelfer und dazukommende Dritte bestehen.
Daher muss der Ersthelfer \gEs{Absperrmaßnahmen durchführen} - den Notfallort
absichern. Wenn möglich bzw. nötig ist der Patient aus dem Gefahrenbereich zu
retten. Anschließend \gEs{Spezialkräfte anfordern} und sämtliche Informationen
über die Gefahr bekannt geben.
}{
\begin{description}
...
telefonieren, klingeln und rauchen. Hier darf bzw. soll das Fenster geöffnet werden. Wenn
	...
	Stecker rausziehen oder die Sicherung herausdrehen. Zuguter letzt bleibt noch
	die Möglichkeit den Verunglückten von der Stromquelle loszureisen. Bei einem
	Hochspannungsunfall funktioniert dies nicht so leicht. Hier bleibt nur die
	Möglichkeit über die Polizei das Energieversorgungsunternehmen zu
	informieren und das Abschalten zu veranlassen.

Viele Gefahren laueren aber auch bei den \gEs{Freizeit- und Sportunfällen}. Zum
Beispiel beim Eislaufen auf Natureis (Seen und Teiche). Kommt es zu einem
\gE{Einbruch auf dem Eis} sollte sich der Ersthelfer flach am Bauch liegend mit
Bretter, Stange oder Leiter dem Patienten nähern. Keine Rettungsversuche ohne
Absicherung durchführen! Bei \gE{Skiunfällen} gilt als Absicherung der
Unfallstelle zwei gekreuzte Ski auf zustellen.

Wenn ein \gEs{Verschütteter} gerettet werden soll, muss der Ersthelfer darauf
achten, dass kein Schüttmaterial nachrutscht. Es sollte mindestens der Kopf und
der Brustkorb des Patienten vreigeschaufelt werden, damit die Atmung möglich
ist.
}{
\begin{itemize}
    \item Strassenverkehr:
    \begin{itemize}
        \item Überfahrenwerden von nachkommenden Fahrzeugen
        \item Explosions- und Brandgefahr 
    \end{itemize}
    \item Gefahrgut: Warntafel beachten und beim Notruf mitteilen
    \item Beginnender Fahrzeugbrand: mit Feuerlöscher löschen
    \item Brennende Kleidungsstücke: Flammen ersticken; vom Patienten entfernen
    \item Zimmerbrand: kein Fenster öffnen; nur zum Retten betretten
    \item Gasgefüllter Raum: Kein Licht etc. aufdrehen, Explosionsgefahr!
    \item Stromunfall:
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Ski-Unfälle: Absicherung mit zwei gekreuzte Ski
    \end{itemize}
    \item Verschütteter: Kopf und Brustkorb freimachen zum Atmen
\end{itemize}

}

Eine Besonderheit stellen \gEs{Gefahrenguttransporter} dar
(\gSee{topic:gefahrengutunfall}). Sie sind -- wie es ihr Name schon sagt -- mit gefährlichen Gütern versehen und tragen
somit eine höhere Gefahrenpotentialität in sich. Zu erkennen sind
Gefahrenguttransporter durch eine orange, rechteckige Warntafel mit
schwarzen Rand (s. Tafel \ref{tab:gefahrentafel-ehi}). 
...
Beschriftung zeigt in seinem oberen Feld die Gefahrennummer
(Kemmlernummer) und in seinem unteren Bereich die Stoffnummer
(UN-Nummer) an. Die Nummern sind beim Notruf
...
Bei einem Unfall mit einem motorisiertem einspurigen Kraftfahrzeug kann es
vorkommen, dass ein Patient mit aufgesetztem Sturzhelm vorgefunden wird. In der
Regel wird davon ausgegangen, ist der Verunglückte bei Bewußtsein hat dieser
den Helm schon selbst abgenommen. Ansonsten gilt, befindet sich der PAtient in
einer Gefahrenzone, so ist er aus dieser zu retten. Das Visier ist zu öffnen,
um den Verletzten anzusprechen. 

\gFazit{ Der Helm ist immer abzunehmen, ausser der Pstient verweigert dies!}

Am idelasten wird der Sturzhelm mit zwei Helfern abgenommen. Es funktioniert
aber auch nur mit einem. Das wichtigste ist, dass der Kopf immer stablisiert
wird.
...
nämlich \gEs{Bewusstsein} und \gEs{Atmung}. Eine Kontrolle des Kreislaufes,
durch Tasten des Pulses an der Halsschlagader (oder irgendeiner anderen
...
Anwesiungen wie \gE{Können Sie mich hören? Machen Sie bitte die Augen auf!}.
Gleichzeit dazu kann man den Patienten an seinen Schultern \gEs{berühren} und
leicht rütteln.
...
Lebenszeichen gewertet. Wenn es jedoch keine gibt, sollte nun der Ersthelfer
\gEs{um Hilfe rufen} und wenn möglich eine zweite Person mit dem Notruf
beauftragen.
}{
\begin{itemize}
    \item Ansprechen
...
\gEs{Atemwege freimachen}. Dazu zählt im Verdachtsfall die Kontrolle der
Mundhöhle auf Fremdkörper. Anschließend wird der Kopf nackenwärts überstreckt.
Nun kann die Atemkontrolle durch \gEs{hören}, \gEs{sehen} und \gEs{fühlen}
durchgeführt werden. Dafür wird das Ohr über den Mund des Patienten gelegt und
10 sec. lang überprüft, ob eine normale Atmung vorhanden ist oder nicht. Es
wird davon ausgegangen, wenn eine Atmung vorhanden ist, dann ist auch ein
Kreislauf vorhanden.
}{
\begin{itemize}
    \item Atemwege freimachen
    \item Atemkontrolle: 10 Sekunden
    \begin{itemize}
        \item hören
        \item sehen
        \item fühlen
    \end{itemize}
    \item wenn Atmung vorhanden dann ist auch Kreislauf vorhanden
\end{itemize}
}
...
\gMarriedNG{Bewusstlosigkeit
}{
Nach Beendigung der Vitalfunktionkontrolle, kann der Ersthelfer zum
Ergebnis kommen, dass der Patient zwar \gEs{kein Bewusstsein} hat, aber eine
\gEs{ausreichende Atmung} und daher ein \gEs{vorhandener Kreislauf} besteht. In
einer solchen Situation liegt die Notfalldiagnose Bewusstlosigkeit vor. Der
...
die Zunge dauerhaft die Atemwege unverschlossen lässt. Sonst würde er daran
ersticken. Dies ist erreichbar durch die sogenannte \gEs{stabile
Seitenlagerung}.
}{
\begin{itemize}
...
des Gesundheitszustandes zu vermeiden. Dazu zählt einerseits \gEs{Wärmeerhalt
sichern}. Die Erhaltung der Körperwärme ist absolut notwendig. Der
Ersthelfer kann  sich hierfür unterschiedlicher Mittel bedienen, eines ist die in einer
Autoapotheke gemäß ÖNORM befindliche Rettungsdecke. Weiters sollte eine
\gEs{laufende Kontrolle der Atmung} durchgeführt werden. Der Ersthelfer soll
sich alle 30 Sek. durch Überprüfung der Atemtätigkeit davon überzeugen, dass
der Patientenzustand unverändert geblieben ist. Durch öffnen eines Fensters in
geschlossenen Räumen, wird dem Patienten die benötigtet \gEs{Frischluft}
zugeführt. Zu guter letzt kommt die \gEs{psychische Betreuung} des Patienten
durch den Ersthelfer.
}{
\begin{itemize}
...
\gMarriedNG{Atem- und Kreislaufstillstand
}{
Nach Beendigung der Vitalfunktionkontrolle, kann der Ersthelfer zum
Ergebnis kommen, dass der Patient \gEs{kein Bewusstsein} hat, und 
\gEs{keine normale Atmung} und daher  \gEs{kein vorhandener Kreislauf} besteht.
In einer solchen Situation liegt die Notfalldiagnose Atem- und Kreislaufstillsand
vor. 
}{
\begin{itemize}
    \item kein Bewusstsein
    \item keine normale Atmung
    \item kein Kreislauf vorhanden
\end{itemize}
}
...
Kreislaufstillstand \gEs{nach der Kontrolle der Vitalfunktionen} schon der
\gEs{Notruf abgesetzt} und erst danach mit der \gEs{lebensrettenden
Sofortmaßnahme} begonnen. }{
\begin{itemize}
    \item nach der Kontrolle der Vitalfunktioen
    \item Notruf absetzen
    \item anschließend lebensrettende Sofortmaßnahme
\end{itemize}
}
...
Die Herzdruckmassage bewirkt ein künstliches Fließgeschehen (Cirkulation)des
Blutes, mittels Kompression des Herzens zwischen Wirbelsäule und Brustbein.

\gMarriedNG{Technik
}{
Der Patient sollte auf einem harten Untergrund liegen. Der Helfer kniet
seitlich daneben und sucht sich den richtigen \gEs{Druckpunkt} für die
Herzdruckmassage. Dieser liegt in der \gEs{Mitte des Brustkorbes}. Die richtige
\gEs{Arm- und Körperhaltung} ist wichtig, um mit wenig Kraftaufwand eine
hervorragende Leistung zubekommen. Die \gEs{Finger sollten verschränkt sein},
und nur der \gEs{Handballen liegt am Brustein}. Die \gEs{Arme bleiben gestreckt}
und die \gEs{Schultern liegen genau über den Druckpunkt}. Nun wird mit dem
Gewicht des Oberkörpers Druck auf das Brustbein ausgeübt. Die
\gEs{Druckerzeugung} hat \gEs{kräftig aber nicht stoßartig} zu erfolgen. Die
\gEs{Eindrücktiefe} sollte \gEs{1/3 des Brustkorbes} bertragen. Bei der
\gEs{Druckentlastung} ist zu beachten, dass sich der Brustkorb wieder ganz
ausdehnt. Es darf \gEs{kein Restdruck} mehr bestehen. Die Druck- und
Entlastungsphasen dauern beide gleichlange. Die \gEs{Arbeitsgeschwindigkeit} der
Herzdruckmassage beträgt \gEs{100 Massagen pro Minute}.
}{
\begin{itemize}
    \item Druckpunkt
    \begin{itemize}
    	\item Mitte des Brustkorbes
    \end{itemize}
    \item Arm- und Körperhaltung
    \begin{itemize}
        \item Finger sollten verschränkt sein
        \item Handballen liegt am Brustbein
        \item Arme bleiben gestreckt
        \item Schultern liegen genau über den Druckpunkt
    \end{itemize}
    \item Druckerzeugung
    \begin{itemize}
        \item kräftig aber nicht stößartig
        \item Eindrucktiefe = 1/3 des Brustkorbes
    \end{itemize}
...
Daher sofort aus dem Bett bringen auf den Boden und weiter arbeiten. Natürlich
kann es auch zu \gEs{Verletzungen durch den Ersthelfer} kommen. Dazu zählt der
...
\gCave{ Cave: Wenn einmal falsch Druck ausgeübt wurde, oder eine Rippe bricht nicht 
sofort auf hören sondern den
richtigen Druckpunkt erneut aufsuchen und weiter machen. Gebrochene Rippen und
...
\gEs{ungenügende Cirkulation} des Blutkreislaufes. 
}{
\begin{itemize}
    \item keine feste Unterlage
    \item Verletzungen durch den Ersthelfer
    \item ungenügende Cirkulation
\end{itemize}
}
...
Die häufigste Art der Beatmung ist die \gEs{Mund zu Mund Beatmung}. Dabei wird
bei überstreckten Kopf mit der stirnseitigen Hand die Nase des Patienten zu
gedrückt. Anschließend mit dem eigenen Mund den des Patienten umschließen und
...
können. Die zweite Möglichkeit ist die \gEs{Mund zu Nase Beatmung}. Hier wird
bei überstrecktem Kopf mit der kinnseitigen Hand der Mund des Patienten
zugehalten. Anshließend mit dem eigenem Mund die Nase des Patienten um schlißen
und die Lippen luftdicht an den Patienten drücken. Nun wird die eigene
Ausatemluft in den Patient eingeblasen. Vor der nächsten Atemspende
muss der Mund wieder abgesetzt werden um selbst frische Luft einatmen zu
können. Bei Säuglingen und Kleinkindern wäre noch die \gEs{Mund zu Mund und
Nasen Beatmung} möglich. In diesem besonderen Fall wird der Mund und die Nase
des Patient mit dem eigenem Mund umschlossen.
}{
\begin{itemize}
    \item Mund zu Mund Beatmung
    \item Mund zu Nasen Beatmung
    \item Mund zu Mund und Nasen Beatmung
\end{itemize}
}
...
wir atmen 12-16 mal ein und wieder aus pro Minute. Das \gEs{max.
Atemzugsvolumen} entspricht dem 10fachen des Körpergewichtes im ml gerechnet.
D.h. ein 90 kg Mann kann 900 ml Luft ein und wieder ausatmen. Auch wichtig ist die ausreichende
\ce{O2}-Konzentration in der Umgebungsluft. Ohne Sauerstoff in der
\gEs{Einatemluft} ist die beste Atmung nutzlos. Der normale \ce{O2}-Gehalt der
Umgebungsluft beträgt 21\,\%. Der \ce{O2}-Gehalt in der \gEs{Ausatemluft}
beträgt 16\,\%. D.h. der Mensch verbraucht  nur 5\,\% Sauerstoff.
}{
\begin{itemize}
	\item Atemfrequenz 12-16\,\nicefrac{x}{min}
	\item max. Atemzugsvolumen 10fache des Körpergewichtes im ml
	\item Einatemluft 21\,\% \ce{O2}-Gehalt
	\item Ausatemluft 16\,\% \ce{O2}-Gehalt
\end{itemize}
}

\gMarriedNG{Bei der Batmung ist zu bachten
}{
...
in den Magen. Die kann während einer Herz-Lungen-Wiederbelebung meist unbemerkt
geschehen. Bei einem \gEs{zu niedriges Atemzugsvolumen} kann die
\ce{O2}-Versorgung nicht sichergestellt sein, da die Luft nicht bis in die
...
\gMarriedNG{Wann kann der Ersthelfer die HLW beenden?
}{
...
unterbrechen. Erstens der Patient zeigt \gEs{Lebenszeichen}. Dies kann jetzt in
zwei Kategorien auftreten. Entweder sichere Lebenszeichen, d.h. der Patient erwacht 
und ist ansprechbar. Eine leider äußerst seltene Form der 
Reanimationsbeendigung. Oder unsicher Lebenszeichen, d.h. der Patient gibt ein Husten 
oder Räuspern von sich bzw. atmet beim Beatmungsvorgang dem  Ersthelfer
entgegen. Erbrechen zählt nicht als Lebenszeichen.
...
Zweitens \gEs{kompetente Hilfe kommt}. Der Ersthelfer darf aber bei Eintreffen
der Rettungskräfte nicht sofort mit der Wiederbelebung  aufhören, sondern muss diese weiterführen
bis er ausdrücklich vom Einsatzpersonal abgelöst  wird.
Drittens \gEs{der Ersthelfer ist zu erschöpft um selbst fortzufahren}. Sollte der Ersthelfer 
...
\begin{itemize}
    ...
    \end{itemize}
    \item kompetente Hilfe kommt
    \item Ersthelfer ist zu erschöpft um fortzufahren
\end{itemize}
}
...
der Patient \gEs{sichere Lebenszeichen}, ist er in eine für ihn
...
Patient zugedeckt werden. Bei \gEs{unsicheren Lebenszeichen} ist eine
...
Bewustlosigkeit. Beim eintreffen von \gEs{kompetenter Hilfe} muss der Ersthelfer
dem Rettungspersonal Auskunft über relevante Umstände und gesetzte ersthelferische Maßnahmen 
geben. Wenn der \gEs{Ersthelfer erschöpft} ist, sollte er (falls überhaupt
...
\begin{itemize}
    \item sichere Lebenszeichen ${\rightarrow}$ psychische Betreuung, zudecken
    \item unsicher Lebenszeichen
    \begin{itemize}
        \item Atemkontrolle
    ...
    \item Ersthelfer erschöpft ${\rightarrow}$ versuchen weitere Ersthelfer zu
    finden
\end{itemize}
...
diese gestoppt werden. Ein gEs{Hochhalten der verletzten Extremität} verstärkt die
Wirkung. Dies ist auch die \gEs{einzige Möglichkeit Halsschlagaderblutungen zu
...
Oberschenkelinnenseite. Nachteil hierbei ist nicht nur dasselbe Handicap wie
...
der Wund gewährleistet. Ein Druckverband besteht aus drei Teilen. Einer
...
\gCave{ Cave: Abbindung nur bei lebensbedrohlichen Verblutungen wie bei totaler
Abrennung oder teilweiser Abtrennung/Zerfetzung} 
...
der Extremität. Die \gEs{maximale Abbindezeit} sollte \gEs{30 Minuten} betragen. 
Daher ist es für den Ersthelfer wichtig den Zeitpunkt der Abbingund zu notieren. 
Am besten gleich am Oberarm bzw. Oberschenkel.
}{
\begin{itemize}
    \item nur am Oberarm und Oberschenkel
    \item nur breites und schonendes Material
    \item maximale Abbindezeit: 30 Minuten
\end{itemize}
}
...
Kreislaufstörung.{\textquotedblleft}}
...
Niere mit Sauerstoff kommt. \gEs{Zentralisation} Der Körper hilft sich selbst in
dem er das Blut zu den lebenswichtigen Organen bringt und äußere Körpergebiete wie Arme,
Beine und Haut weniger bis gar nicht durchblutet. \gEs{Dezentralisation} Hält
...
Es gibt drei mögliche Ursachen welche zum Schock führen können. Als erstes
...
bei extremen Brechdurchfall vorkommen. Beim \gEs{Herzversagen} ist zwar
genügend Blut vorhanden, aber die Pumpe das Herz ist zu schwach um es durch den
Körper zu pumpen. Bei \gEs{Vergiftungen und allergischen Reaktionen} bleibt
...
Lagerung} des Patienten. Bei Bewusstlosigkeit stabiel Seitenlage, bei Blut- und
...
beantworten können, um dem Herrn oder der Dame am anderen Ende des Telfons
dienliche Informationen geben zu können. \gEs{Wo}ist der Notfallort? Im
Zweifelsfall wenn er nicht weiß wo er sich befindet mit einer Beschreibung des
Notfallortes. \gEs{Was} ist passiert? Die Art des Notfalls bekannt geben. Es
reicht die Wahrnehmungen weiter zugeben. Es müssen keine medizinisch relevante
Diagnosen gestellt werden. \gEs{Wieviele} Leute sind betroffen? Hier ist es
notwendig die Anzahl der Patienten bekannt zugeben. Dementsprechend viele
Rettungsmittel kommen zum Notfallsort. \gEs{Wer} ruft an? Hier ist es sinnvoll
...
\gEs{122 Feuerwehr}, \gEs{133 Polizei} und \gEs{144 Rettung}. Vor einigen
Jahren kam durch die EU eine weitere Notrufnummer dazu: \gEs{112 Euro-Notruf}.
...
Heimatsprache und Englisch verpflichtend. Für spezielle Notfälle gibt es auch spezielle 
Notrufnummern. Die beiden relevantesten sind: \gEs{01/406 43 43
Vergiftungsinformationszentrale} und \gEs{141 Ärztefunkdienst}. Die
Vergiftungsinformationszentrale dient jedoch nur dazu, lediglich Auskunft über die 
Risiken und Behandlungen von sicher festgestellten Vergiftungen zu geben. Der
Anruf dort erspart nicht einen Anruf beim Rettungsdienst. Der Ärztefunkdienst
ist in Wien nur von Montag bis Freitag in der Nacht und Samstag, Sonn- und
Feiertag rund um die Uhr besetzt. Der Ärztefunkdienst
...
von allgemein-ärztlichen Ordinationsfällen. Ausserdem hat er durchschnittliche
Wartezeiten von 2-3 Stunden. Was leider viele dazu verleitet lieber bei der
Rettung anzurufen, welche durchschnittlich in 11 Minuten vor Ort ist.
}{
\begin{itemize}
    \item 122 Feuerwehr
    \item 133 Polizei
    \item 144 Rettung
    \item 112 Euro-Notruf
    \item 01/406 43 43 Vergiftungsinformationszentrale
    \item 141 Ärztefunkdienst
\end{itemize}
}
...
\subsection{Wunden und andere Verletzungen}
...
länger als 2 cm sind. Bei idealer Behandlung müssen diese nicht von einem Arzt
versorgt werden. }{
\begin {itemize}
...
\gMassnahmen{
\paragraph{Ersthelfermaßmahmen bei Bagatellverletzungen}~
...
einem Arzt versorgt werden. Für diese Fälle gibt es \gEs{zwei Gebote} für den
Ersthelfer, welche er unbedingt einhalten muss. Erstens \gEs{es kommt nichts
hinein} in die Wunde, wie z.B. Wundpuder oder Wundsalben. Dies muss sonst im
Spital nur wieder mühsamst aus der Wunde gereinigt werden. Zweitens \gEs{es
kommt nichts heraus} aus der Wunde. Fremdkörper, welche ein Blutgefäß
durchtrennen können dieses eventuell abdichten. Wenn nun der Fremdkörper
entfernt wird, kommte es zu einer stark blutenden Wunde. Die anschließende
...
\begin{table}[H]
\gTagBugfix{Wunden die unbedingt vom Arzt
versorgt werden müssen!}\gCaptionof{table}{Wunden die unbedingt vom Arzt
...
&
es putzt sich weder Mensch noch Tier die Zähne bovor zugebissen wird, daher ist
...
&
trotz Schahmgefül wegen der Infektionsgefahr durch die Ausscheidungsorgane
...
erstes der Schweregrd der Schädigung der Haut eingeteilt werden. Dies geschiet
...
\begin{itemize}
    \item 1.Grad
    \begin{itemize}
        \item Rötung, Schwellung, Schmerzen
    \end{itemize}
    \item 2.Grad
    \begin{itemize}
        \item Blasenbildung, Schmerzen
    \end{itemize}
    \item 3.Grad
    \begin{itemize}
        \item Schörfbildung
...
\gCave{Cave: SCHOCKGEFAHR!! Bei Kindern ab 5\,\% bei Erwachsenen ab 10\,\%
verbrannter Körperoberfläche (mind. 2.Grad)}

\gMassnahmen{
\paragraph{Ersthelfermaßmahmen bei Verbrennungen}~

\begin{itemize}
    \item Hitzeeinwirkung sofort stoppen
    \item mind. 10 min mit mäßig kaltem Wasser kühlen \gCave{Unterkühlung!}
    \item Keimfreier Wundverband
    \item Schockbekämpfung
\end{itemize}

\gCave{keine Salben und Puder etc. verwenden}
}
...
\gMassnahmen{
\paragraph{Ersthelfermaßnahmen bei Erfrierungen}~
...
unter 27\,\textdegree Grad tritt der Tod ein.
}{
\begin{itemize}
    \item Schmerzen
...
\gMassnahmen{
\paragraph{Ersthelfermaßnahmen bei Unterkühlung}~
...
\gDefinition{Überdehnung eines Gelens}
...
\gMassnahmen{
\paragraph{Ersthelfermaßnahmen bei Verstauchung}~
...
Der Patient wird starke \gEs{Schmerzen} im Bereich des Gelenks haben.
Die  betroffene Extremität kann nicht mehr bewegt werden. Es
herrscht \gEs{Bewegungsunfähigkeit}. Ausserdem kommt es zu einer \gEs{abnormen
Stellung} , welche \gEs{federnd fixiert} gelagert ist.
}{
\begin{itemize}
    \item Schmerzen
    \item Bewegungsunfähigkeit
    \item abnorme Stellung, "federd fixiert"
\end{itemize}
}

\gMassnahmen{
\paragraph{Erstehilfemaßnahme bei Verrenkung}

\begin{itemize}
    \item Vorgefundene Stellung beibehalten
    \item Ruhigstellung
    \item Rettungsdienstverständigen
...
Es gibt sicher und unsicher Kennzeichen für einen Knochenbruch. Zu den
\gEs{sicheren Kennzeichen} zählt die \gEs{abnorme Stellung}, die \gEs{abnorme
Beweglichkeit} und die \gEs{Krepitation} (das hörbare und fühlbare aneinander
reiben der Knochen). \gEs{Unsicher Kennzeichen} sind, \gEs{Schmerzen},
\gEs{Schwellung}, \gEs{Bewegungseinschränkung}, \gEs{Bluterguss}.
}{
\begin{itemize}
...
Bei Knochenbrüche können folgende Gefahren auftreten. Nachdem ein Knochen kein
totes Gewebe ist, ist er auch gut durchblutet. Daher ist ein der Gefahren der
\gEs{Blutverlust}. Je größer der Blutverlust ist umso größer
ist die Gefahr, dass der Patient in den \gEs{Schock} gerät. Bei einem offenen 
Knochenbruch besteht ausserdem die Gefahr einer \gEs{Wundinfektion}. Bei Rippen brüchen kann
...
\gMassnahmen{
\paragraph{Erstehilfemaßnahmen bei Knochenbrüche}~
...
\begin{itemize}
    ...
    \item Ruhigstellungdurch unterstützte Lagerung
    \item Schockbekämpfung
\end{itemize}
}
...
es entweder verschlucken, einatmen oder über die Haut aufnehmen. Das Gift
...
\gMassnahmen{
\paragraph{Erstehilfemaßnahmen bei Vergiftungen}~
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Wenn das Gift bekannt ist Vergiftungsinformationszentrale 01/406
        43 43 anrufen
        \item Wenn das Gift unbekannt ist betreuen und ins Krankenhaus bringen
        \item Selbstschutz nicht vergessen
        \item Giftstoffe sichern
    \end{itemize}
\end{itemize}
}
...
\gMassnahmen{
\paragraph{Erstehilfemaßnahme bei Verätzungen der Haut}~
...
\gMassnahmen{
\paragraph{Erstehilfemaßnahmen bei Verätzungen der Augen}~

\begin{itemize}
    \item Auge mit reinem Wasser ausspülen von innen nach aussen
    \item Auge mit keinfreiem Wundverband bedecken zum Ruhigstellen beide Augen
    bedecken
    \item Selbstschutz beachten!
\end{itemize}
}
...
\gMassnahmen{
\paragraph{Erstehilfemaßnahmen bei Verätzungen des Verdauungstrakt}~
