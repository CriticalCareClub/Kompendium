...
[^footnote-2]: Verbrennung / Unterscheidung leichte und schwere Verbrennung: Um die
...
⛑ Basismaßnahmen
: 01. Auf Selbsschutz achten!

      - Patienten ggfs. retten, aber nur wenn es der
        Eigenschutz zulässt.

  02. Gefahr erkennen: **Welcher Stoff?**  Expertenrat einholen!

  03. Wenn erforderlich:
      Vorgehen analog zu Abschnitt
      "Gefahrengutunfall", GAS-Regel
      ({ref}`gefahrengutunfall`)

  04. Weitere Opfer ausschließen (lassen)

  05. Sicherung der Vitalfunktionen, Beurteilung ob der
      Patient vital bedroht ist.

  06. {{ TxBeiVit }} {{ TxMassVitMKBes }}

      - Lagerung: situationsgerecht.

  07. Entfernung kontaminierter Kleidung

  08. Spülung der betroffenen Hautpartien mit Wasser
      (richtig abrinnen lassen)

  09. Auge: Spülung mit Wasser / Ringerlösung
