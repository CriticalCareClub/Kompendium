...
NACA \VonBis{I}{III}, \Ca{Verwechslung mit lebensbedrohlichen Differentialdiagnosen möglich!}

\EE{Taktik}: \Speech{Ausführliche Untersuchung und symptomatische Behandlung}
...
{NACA \VonBis{IV}{V}: \Ca{Vitale Bedrochung!}

\EE{Taktik}: \Speech{Rasche Blutdrucksenkung (veranlassen)}
...
\EE{Taktik}: \Speech{Symptomatische Therapie und zügiger
Transport an geeignete Einrichtung}
...
\clearpage % TEMP temp clearpage
\chapter
[\CO{[RSP]} Respiratorische Notfälle]
{\CC{[RSP]} Respiratorische Notfälle}
...
{%
NACA \VonBis{II}{V}: \Ca{Vitale Bedrohung bei schwerer
Verlegung!}

\EE{Taktik}: 

\Speech{Schwer: Zeitkritisch; wenn möglich
rasche Entfernung des Fremdkörpers. 
\\
Mild: Symptomatische
Therapie}
...
\begin{itemize}
  ...
  \item \ce{O2}-Gabe hochdosiert (10\LPerMin*, bei Bedarf
  bis zu 15\LPerMin*)
  \item Lagerung: Situationsgerecht, z.\,B. Oberkörper erhöht
  \item \TxBeiVit \TxMassVit
  \item Weitere Maßnahmen abhängig von der Beurteilung der
...
NACA \VonBis{II}{V}: \Ca{Vitale Bedrohung im Falle
...
\begin{itemize}
  ...
  Frage "`Darf der Patient seinen (vom Arzt vielleicht gerade für
...
NACA \VonBis{II}{V}: \Ca{Vitale Bedrohung bei anhaltender
schwerer Atemnot!}
...
NACA \VonBis{IV}{V}: \Ca{Vitale Bedrohung!}

\EE{Taktik}: \Speech{Atemnot lindern, rasche medikamentöse
Therapie, ärztliche Therapie sinnvoll}
...
Atemgeräusche nicht mit freiem Ohr, sonders
...
\MassnahmenNG{Spezielle Maßnahmen}{Lungenödem, leicht}{}{
NACA \VonBis{II}{III}

\EE{Taktik}: \Speech{Belastung minimieren, bestmögliches
Monitoring}
...
\EE{Taktik}: \Speech{Belastung minimieren, rasche
...
\EE{Taktik}: \Speech{Beruhigen,
Differentialdiagnosen ausschließen, symptomatische Therapie}
...
NACA \VonBis{III}{V}: \Ca{Vitale Bedrohung!}

\EE{Taktik}: \Speech{Zeitkritisch (>>\EE{Time is brain.}<<):
...
NACA \VonBis{II}{V}: \Ca{Vitale Bedrohung!}
...
NACA \VonBis{II}{V}: Vitale Bedrohung je nach
Bewusstseinsgrad
...
\begin{description}
  ...
  von intravenöder Glukose ist u.\,U. durch NKV vorgesehen
...
Übersäuerung (metabolische \EE{Azidose}\ZFootnote{Genauer:
...
NACA {V}: \Ca{Vitale Bedrochung!}

\EE{Taktik}: \Speech{Sichern der Vitalfunktionen}
