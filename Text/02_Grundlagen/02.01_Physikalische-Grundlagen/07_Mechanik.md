...
Ein **Hebel** ist ein starrer Körper, der um einen Drehpunkt bewegt werden kann.
...
Das **Impulserhaltungsgesetz** gilt bei Zusammenstößen:
$$
p_\text{vor} = p_\text{nach}
$$

Die **Kraftwirkung** beim Stoß hängt von der Zeit ab:
$$
