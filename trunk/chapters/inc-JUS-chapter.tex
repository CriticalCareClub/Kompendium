...
\gLayout{2}{Zugang zu den Gesetzestexten}
{
~
% POI 28
...
\gLayout{2}{Tatbestandserf\"ullung}
{
...
\gLayout{2}{Vorkommende Personen}
{
\begin{center}
...
\gLayout{2}{Der Tag beginnt \ldots}
{
...
\begin{itemize}
    ...
    \item \gE{Notwehr\"uberschreitung im Affekt} \gZ{{\S}~3
    Abs. 2 StGB}:
    \begin{itemize}
        \item {\mdseries
    ...
    \end{itemize}
    \item  \gE{Anhalterecht Privater} \gZ{\S 80 Abs. 2
...
\end{itemize}
\gLayout{2}{Rechtsfolge}{}{}{}{}{}
\gFazit{
Alex, Sepp und Bernd haben somit \gE{grundsätzlich} das
Recht, eventuelle Gewaltausbrüche des Hr. Hauzu gegen sich
und andere abzuwehren. In der Situation, in der bloß aus einiger
Entfernung mit Gewalt gedroht wird, \gE{ohne dass eine
unmittelbare Gefahr vorliegt}, ist
es \gE{verhältnismäßig}, zurück zu treten, die Wohnung zu
...
gegen den unmittelbaren Angriff zu \gE{schützen}. Sie sind
jedenfalls \gE{verpflichtet}, unverz\"uglich die Polizei und
...
\begin{itemize}
    ...
    (siehe \gSee{jus-fall-aufklaerung}).
\end{itemize}
...
\begin{itemize}
    ...
    \item Zivilrecht:
    \begin{itemize}
        \item a) \gEs{Schadenersatzanspr\"uche} - {\S}{\S}
        1293 ff ABGB: die Heilbehandlung muss alle drei
        Voraussetzungen erf\"ullen (auch Aufklärung);
        Umfang des Schadenersatzes siehe \gSee{jus-fall:fortbildung}.
    \end{itemize}
...
\gFazit{Seit dem 1. Dezember 2009 wurde das \gEs{Recht auf
Aufklärung} durch das Inkrafttreten des Artikel~3 Abs.~2
lit.~a der Grundrechtecharta der \gAbk{EU} zu einem
eigenen \gEs{Grundrecht}.} 
...
\subparagraph*{\gEs{Besonderheit \gT{Revers}}:}\index{Revers}
...
\subparagraph*{\gEs{Besonderheit
\gT{Gleichheitsgrundsatz}}:}\index{Gleichheitsgrundsatz}
\gZ{(Art.~7 B-VG, Art.~2 StGG, Art.~20 Z.~1 EGC)}
...
\subparagraph{\gEs{Absolute Unwirksamkeit/Unbeachtlichkeit bei}:}
...
\begin{itemize}
    ...
    (\gSee{topic:dokumentation-medizinisch})
...
\gFazit{Grundsatz: Es muss gründlich und ausführlich
dokumentiert werden.}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \gE{Geheimnisse}: alle Informationen, die
...
\gEs{Umfang des Schadenersatzes bei Sachbeschädigung}:
...
Abteilung für \gE{Innere Medizin} aufgenommen wurde, erholen
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \gE{SARS}, \gE{Vogelgrippe}, \gE{Schweinegrippe}
...
\begin{itemize}
    ...
    \item {\mdseries
    polizeiliche Ermittlungspflicht - \gZ{{\S} 99 StPO}}
...
{\mdseries
\gEs{Anzeigerecht} - \gZ{{\S} 80 Abs. 1 StPO}:}
