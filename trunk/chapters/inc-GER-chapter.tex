...
\gT{auskultatorische Methode} (durch hören von Strömungsgeräuschen). Die zweite
Möglichkeit ist die \gT{palpatorische Methode} (durch
tasten des Pulses). 
...
\subparagraph{Auskultatorische Methode}
...
\subparagraph{Palpatorische Methode}
...
ermöglicht. Je nach Bauart kann der Druckminderer über
ein \gE{Regelventil}, ein \gE{Flowmeter}\index{Flowmeter}
...
Der große Druck birgt weitere Gefahren: Sollte ein Ventil abbrechen
