...
Somit kann, bei Kenntnis des Fülldrucks und der Flaschengröße die Füllmenge einfach berechnet werden: 
...
\EE{ausreichende Zeitreserve} einzuplanen ist! Die Reserve ist abhängig von der geplanten Fahrtdauer, Strecke und Uhrzeit der Fahrt -> großzügig Planen.  

{\FontSansNarrowFamily
\begin{equation}
\text{Verfügbare Menge in \Liter} = {\begin{array}{c}
