...
\TODO{GABS}{2010-04-18}{Bild: Schmerzausdehnung beim ischämischen
Herzschmerz}{} 
...
\begin{itemize}
  ...
  \item Einweisung in ein \index{Herzkatheterlabor}\Es{Herzkatheterlabor}
  ("`PCI"',
  "`\index{PTCA}\Es{PTCA}"'
  \Z{{}- Perkutane Transluminale Coronar
  Angioplastie})
...
\begin{itemize}
  ...
  (Extremitätenableitung, \See{topic:ekg}) abgeleitet werden. Der
...
\Es{Richtwert:} Beim Erwachsenen RR {\textless} 100 mmHg
...
\Definition{Blutgerinnsel (Thrombus\footnote{Thrombus: Blutgerinnsel. Im
Gegensatz dazu \T{Embolus}: Losgelöster Thrombus, welcher woanders ein Gefäß
verstopft und eine \T{Embolie} verursacht.}) verstopft Vene}
...
\begin{itemize}
  ...
  Syndrom}\T{Economy class Syndrom}
\end{itemize}
}{
\begin{itemize}
...
\begin{itemize}
  ...
  \Es{Lungenembolie} (\See{topic:lungenembolie})
\end{itemize}
}{}{}{}
...
\begin{itemize}
  \item Lungenentzündung (Pneumonie): \See{topic:pneumonie}
  \item Tuberkulose: \See{topic:tuberkulose}
\end{itemize}
...
Spezialfall: \index{Aspiration}\T{Aspiration} =
Fremdkörper/-säfte (Magensaft, Erbrochenes, Nahrung) gelangt in die
unteren Atemwege
\TODO{GABS}{2010-04-18}{Bild: Atemwegsverlegung (Schema)}{}
}
{}
...
\begin{itemize}
  ...
  \Cave{Achtung: In seltenen Fällen
...
\emph{Syn.: \T{Chronic obstructive pulmonary disease}}
...
evt. Zyanose. Man kann oft ein \E{brummendes oder giemendes Atemgeräusch}
hören.
...
Endstadium zeigen sich Zeichen einer Rechtsherzinsuffizienz (\See{topic:rechtsherzinsuffizienz}) aufgrund einer Störung im Lungenkreislauf.
...
\includegraphics{./icons/under-construction.png}

\TODO{GABS}{2010-04-18}{Bild:COPD Stufen }{}
\Captionof{figure}{Eine COPD
entsteht nicht plötzlich: Ein COPD{\textquotesingle}ler hat eine
Karriere hinter sich. \SourcePicture{Quelle unbekannt}}
\end{center}
\end{figure}
...
\begin{itemize}
  ...
  \Cave{Sauerstoff vorsichtig dosieren,
  anfänglich nur 2-3{\LMin} und Atmung überwachen.
  
  Wenn der Patient bereits Heimsauerstoff benutzt, kann
  man bei Atemnot versuchen 1-2\LMin{} höher zu dosieren. Die Atmung muss
...
\Layout{22}{Herkunft des Embolus}
{
...
\TODO{GABS}{2010-04-18}{Bild: Herkunft des Thrombus.}{}
}{
...
\begin{itemize}
  ...
  \item Striktes Bewegungsverbot
  \item Beengende Kleidung öffnen
  \item \Z{evt. Gabe von Nitroglycerin-Spray durch einen
  Notfallsanitäter}
\end{itemize}
}
...
des Körpers wesentlich beeinflusst (\See{topic:saeure-basen-haushalt}). Atmet
...
Beispiel dafür (\See{topic:koma-diabetisches}).
...
kommen. Dieser wird unter \See{topic:eklampsie}
besprochen.
}{
\begin{itemize}
    \item Folge einer Präemklampsie.
    \item \See{topic:eklampsie}.
\end{itemize}
}{}{}{}
...
\See{topic:azidose-metabolische}).

Unter \See{topic:alkalose-respiratorische} wurde besprochen dass der pH-Wert
...
\begin{itemize}
  ...
  Bei weiblichen Patienten Abt. für Gynäkologie (evt. im "`Hintergrund"') erwägen.
\end{itemize}
}
...
\Z{\emph{Vgl. Kolik: \See{topic:kolik}}}
...
\begin{itemize}
  ...
  \item \Z{Notarzt: evt. Sengstaken-Blakemore-Sonde}
...
\emph{Syn.: Brechdurchfall, \Z{Gastroduodenitis}}
...
\begin{itemize}
    \item Hepatitis: \See{topic:hepatitis}
\end{itemize}
...
\paragraph{Schwangerschaftsdauer} Die normale Schwangerschaft dauert \Es{40
...
\MassnahmenNG{Spezielle Maßnahmen}{Verdacht auf Eileiterschwangerschaft}{}{
\begin{itemize}
    \item Hospitalisation: Abt. f. Gynäkologie
\end{itemize}
}

\MassnahmenNG{Spezielle Maßnahmen}{Rupturierte Eileiterschwangerschaft}{}{
...
Senkwehen mehr, sondern richtige \Es{Presswehen}. Das
...
sind. Es kommt zur Geburt der \E{Placenta}
...
\Es{Fragen des Sanitäters an die Gebärende:}
...
(\See{topic:vena-cava-syndrom}) zu vermeiden, sollte die
Patientin liegend in leichter \Es{Linkseitenlage}
...
\TODO{GABS}{????-??-??}{Psychologie/Psychiatrie: Neuerstellung von Text
notwendig}{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
}{}{}{}{}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TODO Psychologie: Neuerstellung
\TODO{GABS}{????-??-??}{Psychologie/Psychiatrie: Stress: Neuerstellung von Text
notwendig}{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TODO Psychologie: Neuerstellung
\TODO{GABS}{????-??-??}{Psychologie/Psychiatrie: Coping: Neuerstellung von Text
notwendig}{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TODO Psychologie: Neuerstellung
\TODO{GABS}{????-??-??}{Psychologie/Psychiatrie: PTS: Neuerstellung von Text
notwendig}{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
zu einem Lied und sichert sich dank der AKM\footnote{\Z{Autoren, Komponisten
...
\E{Vincent van Gogh} (\textborn\,1853\,--\,\textdied\,1890). Im Alter von 35
...
\caption{Krank? \SourcePicture{Vincent van Gogh: Sternennacht über der
...
\E{Fremdgefährdung} aufgrund einer psychiatrischen Erkrankung, hier hat der
Gesetzgeber Maßnahmen nach dem \T{Unterbringungsgesetz} (\T{UbG}) vorgesehen. Auch der
...
Bestimmungen (\Es{Unterbringungsgesetz}) Maßnahmen
durchzuführen sein, so sind diese von der \Es{Exekutive}
(Polizei) vorzunehmen. Das Ziel des Unterbringungsgesetz
ist es, das Maß der \E{Einschränkung der Freiheit des
Patienten so gering wie möglich zu halten}. 

Auch im Rahmen der
\Es{Besachwaltung} kann ein \E{Gericht} das Selbstbestimmungsrecht des
...
\See{topic:kommunikationsregeln} besprochen wurden. Der
...
\begin{itemize}
    \item Besonders wichtig ist ein \Es{ruhiges,
    sachliches Auftreten}.
    \item  Eventuelle \Es{Aufregung} (durch den
    Patienten; Angehörige; Feuerwehr; Polizei;
    Spezialeinsatzgruppe mit Rammbock, Tränengas,
    Maschinengewehr und Angst; \ldots) \Es{soll nicht auf
    den Helfer abfärben}.
    \item Der Patient soll sich \Es{nicht beengt},
    bedroht und -- wenn möglich -- nicht bevormundet
    \Es{fühlen}.
    \item Es sollen \Es{keine falschen oder nicht
...
\begin{enumerate}
  ...
  der Exekutive.
  \item Wahnvorstellungen sollen \Es{nicht ausgeredet}
  werden.
  \item  Wahnvorstellungen sollen aber auch \Es{nicht
  bestätigt} werden.
  \item Am besten man nimmt die Schilderungen des
  Patienten \Es{interessiert, aber neutral und möglichst
...
\subsubsection{\Z{Reserviert}\A{Der \emph{stuporöse}
Patient}}
...
dies vertraulich, aber \Es{direkt angesprochen und geklärt
...
\Es{Die geäußerten Aussagen und Gefühle des Patienten sollen nicht
...
Daraus ergibt sich bei \Es{fehlender}\Es{Freiwilligkeit}:

\paragraph{Voraussetzungen für eine Unterbringung ({\S}\,3)}

\begin{itemize}
    \item \Es{Psychiatrische Erkrankung}
    (ursächlich!), (${\rightarrow}$~{\S}\,3~Abs.\,1)
    \item \Es{Eigen-}  und/oder
    \Es{Fremdgefährdung},
    (${\rightarrow}$~{\S}\,3~Abs.\,1)
    \item \Es{Keine weniger einschränkende
...
"`\index{Amtsarzt}\Es{Amtsarzt}"',
welcher über die Polizei verständigt wird. 

\Es{Der Notarzt, auch wenn er von der Gemeinde Wien
...
\Es{Eine Unterbringung kann nur in einer psychiatrischen Abteilung erfolgen!}

Eine Unterbringung \Es{kann auch freiwillig}
...
Zittern, Unruhe, Angst, \Es{Halluzinationen} ("`weiße Mäuse"', \ldots), vegetativer Entgleisung (Tachykardie,
...
\Married{Bei einem Wärmestau, bei dem die zugeführte Wärme
...
\Married{Beim Hitzeschlag ist nun auch die Regulation der Körpertemperatur gestört, es
...
\Married{Der Sonnenstich ist eine Sonderform des Hitzeschadens: 
...
nur \Es{unspezifische Symptome} vor, wie z.B. Erbrechen,
...
\begin{enumerate}\raggedbottom
  \item \Es{Wer}? (Alter, KG, Vorerkrankungen, \ldots
  $\rightarrow$ Risikoabschätzung!)
  \item \Es{Was}? (Art des Giftes $\rightarrow$ ev.
  zu erwartende Symptome)
  \item \Es{Wann}? (Zeit seit Einnahme)
  \item \Es{Wie}?
  (inhalativ, oral, perkutan, intravenös etc.)
  \item \Es{Wieviel}? (Dosisabschätzung)
  \item \Es{Warum}? (Ursachenforschung:
  Selbst\-mord\-ver\-such, Unfall, Fremdverschulden,
  Vorsatz?)
\end{enumerate}
\end{multicols}
\item ggfs. \Es{Expertenrat einholen} und Entscheidung
...
\Margin{\includegraphics[width=\linewidth]{./images/TAE/dif-w2-zelt-1.jpg}}Die
...
Die \Es{vitale Bedrohung} ist vor allem anhand der
Vitalparameter, der körperlichen Untersuchung und des
Bewusstseinszustandes zu beurteilen.

\MassnahmenNG{Spezielle Maßnahmen}{Vergiftungen mit Alkohol}{}{
\begin{itemize}
...
\See{topic:alkohol-entzug} abgehandelt.
...
% wurde erst \Es{nachdem die Feuerwehr \E{sämtliche} (!)
...
\Cave{
Bei Gasunfällen hat der \Es{Selbstschutz} Vorrang.
Oft ist die Bergung nur mit \Es{schwerem
...
\begin{description}
  ...
  Hustenreiz, Latenzphase (kaum Symptome), \Es{3-24\,h
...
unter \See{topic:veraetzung-trauma} besprochen.
...
\begin{itemize}
  ...
  \item \Es{Niemals absichtlich Erbrechen  herbeiführen!}
...
% Verätzung der Haut \See{topic:veraetzung}
...
\begin{itemize}
    ...
    \item \Es{Verlegung der Atemwege}.
\end{itemize}
}{
...
\begin{itemize}
    ...
    \item \Es{Niemals absichtlich Erbrechen 
    herbeiführen!}
\end{itemize}
}
