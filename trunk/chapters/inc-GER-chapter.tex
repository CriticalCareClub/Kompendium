...
\gT{Sauerstoffsättigung} (\gT{Sp\ce{O2}}) des arteriellen
Blutes. Dies geschieht mittels Photorezeptoren und
Infrarotlicht.~~\cite{LoefflerBiochemie7} Dabei wird das Verhältnis der mit Sauerstoff beladenen roten
Blutkörperchen zu den nicht beladenen bestimmt. Der
Normalwert liegt zwischen 96\% und 99\%. Als zweiten Wert
zeigt das Pulsoxymeter die \gEs{Pulsfrequenz} an.
}{
