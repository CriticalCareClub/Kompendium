...
\begin{description}
    ...
    Diagnose geführt hat mit ``Z.n.'' angegeben. 
    \begin{itemize}
...
ob man sich der eignen SInne oder komplizierter Geräte bedient. 

\paragraph{Befund}

Jede diagnostische Maßnahme hat (hoffentlich) nein Ergebnis, welches man als
