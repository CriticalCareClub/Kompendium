...
\titlecontents{part} [5pc]
   {\addvspace{1.0pc}\bfseries
   \color{ubuntured}\titlerule[1pt]\filright\addvspace{1mm}
   }
   {\sffamily\color{ubuntured}\large\contentslabel
...
pdfsubject=v-0.9.x, % Sets the document information Subject field
...
\newcommand{\SignTable}{{\noindent\sffamily\mdseries\color{darkBlue}\ovalbox{T}}}
