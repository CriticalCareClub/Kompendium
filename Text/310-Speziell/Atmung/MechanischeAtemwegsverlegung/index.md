```{index} single: Atemwegsverlegung
```
...
: - Schwer: **Vitale Bedrohung! Zeitkritisch**;
    wenn möglich rasche Entfernung des Fremdkörpers.
...
```{eval-rst}
.. table:: Beurteilung der Schwere der Atemwegsverlegung
    ...
    | **Schwer**                                                       |  | **Mild**                              |
    |                                                                  |  |                                       |
    | Kann nicht sprechen,                                             |  | Kann sprechen,       hustet effektiv  |
    | Hustet ineffektiv                                                |  |                                       |
    |                                                                  |  |                                       |
    +----------------------+--+----------------------------------------+  +---------------------------------------+
    ...
    |                      |  | -   5 Heimlich-Manöver (> 1 a)         |  | -   Husten lassen                     |
    | -   Reanimation      |  |     oder Thoraxkompressionen (< 1 a)   |  | -   Überwachung                       |
    |                      |  | -   Wiederholung                       |  | -   Keine weitere Manipulation        |
    |                      |  |                                        |  |                                       |
    |                      |  |                                        |  |                                       |
    +----------------------+--+----------------------------------------+--+---------------------------------------+
