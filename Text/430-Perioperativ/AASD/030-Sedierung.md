...
(AASD-KP-Sedierung)=
(AASD-KP-AnSed-Indikationen-tiefe-Sedierung)=

# Sedierung

Die Sedierung ist die hypnotische Komponente der Analgosedierung.
Auch diese muss individuell auf jeden Patienten und seine aktuelle Krankheit angepasst werden.
Die Dosis und Dauer müssen **so niedrig wie möglich** gehalten werden.
...
:::{index} single: RASS
:::
:::{index} single: Richmond Agitation Sedation Scale
:::
:::{index} single: Scale; Richmond Agitation Sedation
:::
...
Zur Abwechslung gibt es zur Objektivierung und Therapiesteuerung einen Score, den {ref}`Tab-Richmond-Agitation-Sedation-Scale`.

:::{table} Richmond Agitation Sedation Scale
:name: Tab-Richmond-Agitation-Sedation-Scale

| Wert | Bezeichnung           | Erläuterung                                                  |
| ---- | --------------------- | ------------------------------------------------------------ |
| \+ 4 | streitlustig          | aggressives verhalten, Personal gefährdet                    |
| \+ 3 | Sehr agitiert         | Zieht oder entfernt „Schläuche“,  aggressiv                  |
| \+ 2 | agitiert              | Häufig ungezielte Bewegungen, atmet gegen den Respirator     |
| \+ 1 | unruhig               | Ängstlich, Bewegungen aber nicht  aggressiv oder lebhaft     |
| 0    | aufmerksam  und ruhig |                                                              |
| \- 1 | schläfrig             | Erwacht anhaltend mit Blickkontakt bei Ansprache (> 10 sec)  |
| \- 2 | leichte Sedierung     | Kurzes Erwachen mit Blickkontakt bei Ansprache (\< 10 sec)   |
| \- 3 | mäßige Sedierung      | Bewegung oder Augenöffnung bei Ansprache (ohne Blickkontakt) |
...
: - **Atemdepression**: geringe therapeutische Breite!
  ...
  - {ref}`propofolinfusionssyndrom`

:::{note}
Verfärbung des Harns auch beim PRIS..
:::

:::{index} single: Propofolinfusionssyndrom
:::
:::{index} single: PIS
:::
:::{index} single: Rhabdomyolyse; Propofolinfusionssyndrom
:::
:::{index} single: Mitochondrien; Propofolinfusionssyndrom
:::
...
- Symptomkomplex aus
  ...
  - Laktatazidose,
  - meist bradykarde Rhythmusstörungen ,
  - Hypotonie,
  - Herzversagen,
  - Nierenversagen
  - Rhabdomyolyse der Herz und Skelettmuskeln mit extremen CPK↑ und Hyperkaliämie

- Therapie: Propofol stopp, Symptomatische Behandlung (Herzschrittmacher, Katecholamine, Hämofiltration, Pufferung)
:::

Das Propofol-Infusionssyndrom (**PRIS**) ist eine seltene[^pis-inzidenz], aber potenziell tödliche Komplikation der Langzeitverabreichung von Propofol (50% Letalität).  {term}`🗎 Hemphill 2019`
...
Es wird im Allgemeinen mit hohen Dosen (> 4 mg / kg /h bzw. > 67 µg / kg / min) und längerer Anwendung (> 48 h) in Verbindung gebracht.
Zu den Risikofaktoren für PRIS gehören somit eine verlängerte Infusionsdauer, hohe Dosen und die gleichzeitige Anwendung anderer Arzneimittel, die das Risiko einer mitochondrialen Toxizität erhöhen können, sowie eine vorbestehende mitochondriale Funktionsstörung. {term}`🗎 Hemphill 2019`

Die Therapie umfasst die Sedierungsumstellung (Propofol stopp) und symptomatische Behandlung (Herzschrittmacher, Katecholamine, Hämofiltration, Pufferung).

:::{warning}
Daher ist Propofol zur Sedierung erst **ab dem 17. Lebensjahr** und **bis 4 mg / kg KG / h** zugelassen.
:::
...
:::{index} single: Benzodiazepine
:::
:::{index} single: Antidot; Flumazenil
:::
:::{index} single: Flumazenil
:::
:::{index} single: Reaktion; paradoxe
:::
...
:::{index} pair: α₂; Agonisten
:::
:::{index} single: Clonidin
:::
:::{index} single: Dexmedetomidin
:::
:::{index} single: Dexdor™
:::
:::{index} single: Bradykardie; α₂-Agonisten
:::
