...
Protonen\footnote{\E{Protonen}: positiv geladene Teile eines Atoms.} 
...
{%
Der Mechanismus des \Z{Bicarbonat-}Puffers wandelt Säure \Z{(Bikarbonat und
