...
\Layout{2}{Schwangerschaftsverlauf}
{%
...
\FormatTable
\begin{WidePar}
\Captionof{table}{Bilderserie: Schwangerschaft}
\begin{tabularx}{\linewidth}{XXX}
\includegraphics[width=\linewidth]{./images/wikipedia-pd/Nabelschnur.png}
\Captionof{figure}{Die Lage des Fötus in der Gebärmutter. \SourcePicture{Gray's Anatomy, 20th ed., PD, Copyright expired.}}
&
&
\\\bottomrule
\end{tabularx}
...
Austreibungsphase und ist der Kindskopf zwischen den
