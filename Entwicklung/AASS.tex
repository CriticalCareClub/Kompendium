...
\definecolor{LabelItem}{named}{CyanMiddle}
\definecolor{LabelItemBoxStandard}{cmyk}{0.6,0,0,0}
% \definecolor{LabelItemBoxProcedures}{named}{BoxProcedures} % Definition nach BoxProcedures
\definecolor{Customized}{named}{cyan}
\definecolor{CustomizedBackground}{named}{CyanMiddle}
% \definecolor{BoxStandard}{named}{AsboeGreenDeco}
% \definecolor{BoxStandardBackground}{named}{AsboeGreenDecoLight}
\definecolor{BoxStandard}{cmyk}{0.6,0,0,0}
% \definecolor{BoxStandardBackground}{named}{CyanLight}
\definecolor{BoxStandardBackground}{named}{CyanVeryLight}
\definecolor{BoxStandardText}{named}{cyan}
        ...
        \path let \p1 = (current page.west), \p2 = (current page.east) in
              node[minimum width=\x2-\x1, minimum height=5cm, rectangle, fill=cyan, anchor=north west, align=left, text width=\x2-\x1] at ($(current page.north west)$) {
                ...
                \begin{textblock*}{5in}(\dimexpr\x2-9.4in,\dimexpr0.25\headheight-1.7in)
                    \tikz \node [white,text width=2in, align=left, font=\sffamily] {{\Huge \usefont{T1}{PTSansCaption-TLF}{m}{n}\selectfont\color{White} AAS\color{cyan!50}S \usefont{T1}{PTSansNarrow-TLF}{m}{n}\selectfont\normalsize ASBÖ 921}};
                \end{textblock*}
              };
        \path let \p1 = (current page.west), \p2 = (current page.east) in
...
\renewcommand{\AASS}{{\usefont{T1}{PTSansCaption-TLF}{m}{n}\selectfont\color{cyan} AAS\color{AsboeRed}S}}
\renewcommand{\ARGE}{{\usefont{T1}{PTSansCaption-TLF}{m}{n}\selectfont ARGE \color{cyan} AAS\color{AsboeRed}S}}
...
\noindent{\Huge \usefont{T1}{lmss}{m}{n}\selectfont\color{cyan} AAS\color{AsboeRed}S}

\bigskip

\noindent{\Huge \usefont{T1}{lmss}{m}{n}\selectfont\color{cyan} AAS\color{cyan!50}S}

\vspace{3\baselineskip}

\noindent{\Huge \usefont{T1}{PTSansCaption-TLF}{m}{n}\selectfont\color{cyan} AAS\color{AsboeRed}S}

\bigskip

\noindent{\Huge \usefont{T1}{PTSansCaption-TLF}{m}{n}\selectfont\color{cyan} AAS\color{cyan!50}S}

\vspace{3\baselineskip}

\noindent{\Huge \usefont{T1}{PTSans-TLF}{m}{n}\selectfont\color{cyan} AAS\color{AsboeRed}S}

\bigskip

\noindent{\Huge \usefont{T1}{PTSans-TLF}{m}{n}\selectfont\color{cyan} AAS\color{cyan!50}S}

\vspace{3\baselineskip}

\noindent{\Huge \usefont{T1}{PTSansNarrow-TLF}{m}{n}\selectfont\color{cyan} AAS\color{AsboeRed}S}

\bigskip

\noindent{\Huge \usefont{T1}{PTSansNarrow-TLF}{m}{n}\selectfont\color{cyan} AAS\color{cyan!50}S}
