...
{\rdnr}Die österreichische Rechtsordnung ist ein
...
{\rdnr}Durch den Beitritt zur \E{EU} wurde ein weiterer
...
{%
\begin{itemize}
    \item {\rdnr}\T{Strafrecht}: Erfasst jene Delikte, die
    ...
    \item {\rdnr}\T{Verwaltungsrecht}: Umfasst Regelungen
    die sich idR. nur an bestimmte Personenkreise richten
    und von Verwaltungsbehörden (nicht von Gerichten) bei
    Verstoß insofern sanktioniert werden, dass (vorrangig)
    Geldstrafen verhängt werden.
    
    \item {\rdnr}\T{Verfassungsrecht}: Jener Teil der
...
\end{figure}
{\rdnr}Das Rechtsverhältnis im Rettungswesen besteht
...
{\rdnr}Als wichtigstes Verhältnis in dieser
...
{\rdnr}Aus beiden Verhältnissen schuldet die
...
{\rdnr}Im \EE{Verhältnis zwischen Patient und Personal}
