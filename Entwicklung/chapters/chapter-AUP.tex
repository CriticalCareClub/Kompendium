...
\begin{itemize}
  ...
  speziell, der Patient kann i.\,d.\,R. nur mit \emph{\enquote{ja}},
  \emph{\enquote{nein}} oder \emph{\enquote{weiß nicht}} antworten. Sie
  machen daher eher nur dann Sinn, wenn man ganz spezielle
  Dinge bewusst direkt abfragen kann oder muss. \Ca{Achtung!}
  Manche Patienten neigen dazu, grundsätzlich \enquote{ja} zu sagen,
  ...
  legt der Gesprächsführende den Patienten die Antworten \enquote{in
...
\subsection{Struktur durch \enquote{S-KAMEL}}
\index{S-KAMEL}
...
Einstiegsfrage, z.\,B. \enquote{Was können wir für Sie tun?},
...
\begin{quote}
    \Speech{\enquote{Haben Sie Schmerzen?}}
\end{quote}
}{
...
\begin{itemize}
    ...
    Schmerzen?}}
    \item \EE{Zeitdauer/Beginn}: \Speech{\enquote{Seit wann haben Sie
    ...
    irgendwohin aus?}} 
    \item \EE{Provokation}: \Speech{\enquote{Was
...
\begin{quote}
    \emph{\enquote{Welche Medikamente nehmen Sie?}}
