...
Sind die Elektroden angeklebt,
kann mit der Beurteilung des elektrischen Herzrhythmus
begonnen werden. Die \EE{Rhythmusanalyse} (kurz Analyse)
führt das Gerät auf Knopfdruck selbständig durch. Es ertönt
eine Warnung, z.\,B. \Speech{"`Analyse läuft! Patienten
nicht berühren!"'} Der Patient (oder elektrisch
...
(\EE{BLS}). Ziel der ERC-Leitlinien ist eine 
einheitliche, bestmögliche Vorgehensweise bei der
Reanimation. Diese hier beschriebenen Basismaßnahmen der
Herz-Lugen-Wiederbelebung sind durch zahlreiche Studien wissenschaftlich abgesichert und werden  alle fünf
