...
\gT{\gTxMassVit}}, die sobald als möglich (evt. sogar
noch vor Abschluß des Ersteinschätzungsblockes) zu erfolgen haben. 


\gMassnahmen{
\captionof{table}{\gTxMassVit \label{tab:standardmassnahmen-vital}}
\begin{center}

\begin{tabulary}{\linewidth}{LL}
\toprule
\multicolumn{2}{c}{\gTabHeading{\gTxMassVit}\label{topic:standardmassnahmen-vital}}
\\\midrule
