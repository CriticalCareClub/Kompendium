\begin{savequote}
\begin{minipage}{5cm}
\Speech{\enquote{Der, der den
Schlüssel hat, ist der Arzt.}}
\begin{flushright}
{\upshape
Otto Pötzl, nach \cite{Jolesch2}}
\end{flushright}
\end{minipage}
\dictum[]{}
\end{savequote}
...
\enquote{gesund} und \enquote{krank} treffsicher zu unterscheiden. 
}{
...
\paragraph{Der \enquote{Krankheitsbegriff} in der Psychiatrie} Man
...
\MassnahmenMK{Spezielle Maßnahmen}{Umgang mit Patienten mit
Wahnvorstellungen}{m:wahnvorstellungen}{
}{}
...
\MassnahmenMK{Spezielle Maßnahmen}{Unruhiger oder
aggressiver Patient}{m:aggressiver-patient}{
}{}
...
% \end{itemize}
% {\mdseries
% Kann bei allen \enquote{normalen},
% \enquote{körperlichen} Notfällen, die mit
