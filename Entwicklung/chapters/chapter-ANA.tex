...
(natürlicher "`Schrittmacher"'), er feuert mit einer Eigenfrequenz von ca.
\VonBis{60}{100}\,\nicefrac{}{min} elektrische Impulse (Erregung) ab. 
Die Erregung wird über den rechten Vorhof zum  \T{AV-Knoten} \Es{(2)} geleitet
und gebündelt, und von dort über das \T{His-Bündel}, welches sich im Bereich der
Vorhof-Kammer-Grenze befindet in Richtung der Kammern weitergeleitet. Der
AV-Knoten und das His-Bündel \E{filtern}  und \E{verlangsamen} die
...
Bei einem \E{Ausfall} eines Knotens, bzw. der Unterbrechung der Erregungsleitung
