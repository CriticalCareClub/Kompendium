...
{Herzdruckmassage \SourcePicture{Hirtler}}
...
\item \EE{Position und Druckpunkt}: Der Patient muss auf einem
...
\item \EE{Arm- und Körperhaltung}: Die richtige Arm- und
...
\item \EE{Druckerzeugung und Druckentlastung}: Der \E{Druck} wird
...
durchschnittlichen Erwachsenen entspricht das ungefähr
...
\item \EE{Druckfrequenz}: Die Druckfrequenz
...
\item \EE{Verhältnis}: Die Herzdruckmassage wechselt sich mit der Beatmung des Patienten ab. 
Der seitlich am Patient knieende
  Helfer beginnt die Wiederbelebung mit \E{30
  Herzdruckmassagen}, darauf folgen \E{zwei Beatmungen} 
  durch den am Knopf befindlichen Helfer,
  danach wird sofort mit 30 HDM fortgefahren usw. 
  \E{Erfolglose Beatmungsversuche} werden
...
\begin{figure}[h]
\caption{Normaler Sinusrhythmus und reanimationspflichtige Rhythmen}

\subfloat[\Z{Sinusrhythmus (Normalbefund)} \SourcePicture{WM/PD}]
{\includegraphics[width=\linewidth]{./images/wikipedia-pd/Lead_II_rhythm_generated_sinus_bradycardia}}
