...
\begin{itemize}
    \item \"Uberprüfung der Triage
    \item pflegerische Ma{\ss}nahmen
    \item Betreuung (Kriseninterventionsteam (\gAbk{KIT})
...
\begin{itemize}
    ...
    \item Psychologische Betreuung, evt. durch \gAbk{KIT}
    \item \"Uberwachung
\end{itemize}
 &
...
\begin{itemize}
    ...
    \item Beruhigen
    \item Informieren
    \item \gAbk{KIT}\footnote{In Wien ist die Akutbetreuung Wien (\gAbk{ABW})
...
\gMarried{
\begin{itemize}
    \item Die \gAbk{MLS} beherbergt i.d.R. die Ein\-satz\-leitung sowie wichtige
    ...
    zuständig.
    \item Wenn die  die Einsatzleitung beinhaltet wird sie mit einem
