...
\gE{Lebensrettenden Sofortmaßnahmen} zählt die stabile Seitenlage bei Bewusstlosigkeit, die
...
Sofortmaßnahmen wird der \gEs{Notruf} abgesetzt, falls dies
...
\gEs{Transport} durch. Im Spital erfolgt schließlich die
...
Vor dem Setzen irgend welcher Maßnahmen sollte der Ersthelfer tief
...
Der Ersthelfer muss \gEs{Absperrmaßnahmen durchführen} und
den Notfallort absichern. 

Wenn möglich und nötig ist der Patient aus dem
Gefahrenbereich zu retten, wobei unbedingt auf den Selbstschutz zu achten ist. Anschließend müssen
...
\gLayout{2}{Stabile Seitenlage}{\index{Stabile Seitenlage}
...
vorhanden ist, Umlagerung in die stabile Seitenlage. Anschließend weiterführende Maßnahmen gemäß Notfalldiagnose
Bewusstlosigkeit. 
...
\gMassnahmenNG{Erste-Hilfe-Maßnahmen}{Starke Blutungen}{
\begin{itemize}
    \item Blutstillung
    \begin{itemize}
...
Oberschenkel des Patienten.\footnote{Früher wurde
empfohlen, dass die maximale Abbindezeit ca. 30 Minuten
...
\gE{nicht} (auch nicht probeweise) zu öffnen.
...
\gEs{kalten, klebrigen Schweiß} auf der Stirn hat. Der Patient kann ausserdem \gEs{verwirrt, unruhig
...
{\index{Ärztefunkdienst@Arztefunkdienst}
\index{ÄFD@AFD}
...
Fremdkörper, welche ein Blutgefäß durchtrennen, können dieses eventuell abdichten. Wenn nun der Fremdkörper entfernt wird, kommte es zu einer stark blutenden Wunde. 
...
\gLayout{22}{}{
Pflasterverbände können überall an Händen und Füßen
