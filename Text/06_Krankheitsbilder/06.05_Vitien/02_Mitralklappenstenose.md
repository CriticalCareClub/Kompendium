...
:::{index} single: Mitralklappenstenose
:::
:::{index} single: Vitium; Mitralklappenstenose
:::
:::{index} single: MKS
:::
...
| Mitralklappenstenose | leicht  | mittelgradig | hochgradig |
|----------------------|---------|--------------|------------|
| MPG, mmHg            | < 5     | 5 – 10       | > 10       |
| KÖF, cm²             | > 1,5   | 1 – 1,5      | < 1        |
...
:::{seealso}
- https://echobasics.de/klappen.html
:::
