...
Kapitel stellt daher die Grundlage für die im weiteren
Verlauf beschriebenen Notfälle dar.

Zellen sind die kleinsten lebenden Einheiten. Zellverbände
bilden Gewebe, diese bauen wiederum Organe auf. Organe die
eine gemeinsame Hauptaufgabe erfüllen werden zu
funktionalen Einheiten, zu (Organ-)Systemen, zusammen
gefasst. Alle Organsysteme zusammen ergeben den Organismus.
} {%
\begin{description}
...
\Z{Durch krankhafte Vorgänge kann es im Gewebe zu
\begin{inparaitem}
    \item Ödemen (Wasseransammlung im Gewebe),
...
hauptsächlich als
   Stützgerüst der \EE{Haltung} des Körpers (aufrechte Haltung)
    ...
    und als \E{Ursprungs- und Ansatzfläche für die Muskulatur}. Dies ist Voraussetzung für die
...
\A{Vorschlag: "`Der menschliche Körper besteht aus ??? Knochen."'}
...
\TODO{GABS}{2010-12-13}{Gelenk: Grafik vektorisieren,
...
\Commentary[Gelenksarten, Beispiel Scharniergelenk]{Scharniergelenk ist nur das Gelenk, welches von Ellle und Oberarmknochen gebildet wird.}
...
\begin{inparadesc}
  ...
  \item[C:] Sattelgelenk (z.\,B. Daumen\-grund\-ge\-lenk),
  \item[D:] Scharniergelenk (z.\,B.
  Finger\-glied\-ge\-lenke, Ell\-bogen\-ge\-lenk),
...
\begin{itemize}
  ...
  \item Scharniergelenk (Fingergliedgelenke, Ellbogengelenk,
  \ldots)
  \item \Z{Zapfengelenk (Radioulnargelenk, \ldots)}
\end{itemize}
}{}{}{}
...
{}
{}
{./images/anatomie/Human_arm_bones_diagram_de-edited.png}
{Der
...
Es gibt insgesamt 8 \T{Handwurzelknochen}, Würfelknochen,
\Z{welche in zwei Reihen zu jeweils 4 Knochen angeordnet
sind.}
...
Der Blutdruck und die Pumpfunktion des Herzens werden unter \prettyref{topic:blutdruck}
und \prettyref{topic:herzfunktion}
besprochen.
}
{
\begin{itemize}
...
\E{Hämoglobin}. Es ist auch der \E{Blutfarbstoff}. Ein Mangel an Hämoglobin wird als \T{Anämie} bezeichnet.
...
Trennlinie ist hier das \T{Trommelfell}, dass das Außenohr
...
ist ja mit dem Brustkorb und dem Zwerchfell verwachsen). Da
der Pleurazwischenraum luftdicht ist, muss sich zwangsläufig
aber auch das Lungenfell (an dem wiederum die Lunge
angewachsen ist) mitbewegen. Und wenn sich das Lungenfell
mitbewegt wird automatisch auch die Lunge wie eine
...
{}
{}
{./images/anatomie/Digestive_system_diagram_de.pdf}
...
Speichel aus den diversen Speicheldrüsen vermischt.
...
unten. Es folgt der \EE{S-förimig gebogene Teil}
...
Milz erkannt und entfernt. Beim Embryo fungiert sie auch an
...
in den Bauchraum. → \Ca{Der Patient wirkt zuerst "`ganz
normal", unerwartet und plötzlich "`verfällt"' er.}
}{%
\begin{itemize}
...
mündet an der Eichel in die Außenwelt. Bei einer
...
Durch die kürzeren Harnwege bei der Frau kann es bei ihr
leichter zu Harnwegsinfektionen kommen.
}
{
\begin{itemize}
    \item Nieren inkl. Nierenbecken
...
untersuchen lassen. Mit dem zunehmenden Alter kann sie
...
Die Bläschendrüse liegt der Prostata ann beiden Seiten an.
...
Erektion kommt es durch einer Kombination aus physischen und
