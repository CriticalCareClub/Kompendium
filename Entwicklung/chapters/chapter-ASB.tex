...
geeigneter Größe, welche dicht sitzend angelegt wird.
...
bilden dabei die Form des Buchstaben \enquote{C}, die restlichen drei
...
Mit dem Beatmungsgerät \emph{\enquote*{Medumat}} der Fa.
...
\MetricUnit{cm} Wassersäule (\MetricUnit{cm\,\ce{H2O}}) oder Millibar
(\MetricUnit{mbar}) angebeben. Typische Werte sind z.\,B. 5
oder 10\,\MetricUnit{cm\,\ce{H2O}}.}. 
Es gibt \Abk{PEEP}-Ventil-Produkte sowohl als
\EE{Einweg-}, als auch als \EE{Mehrweg}material!\ZFootNote{Moderne Beatmungsgeräte verfügen oft über eine
integrierte PEEP-Funktion und benötigen kein zusätzliches
\Abk{PEEP}-Ventil.}
