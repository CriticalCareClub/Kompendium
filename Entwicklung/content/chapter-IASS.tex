...
{Beispiele für Infusionsbeutel \SourcePicture{Christoph Pallinger}}% Text Bild 2
{}% Pfad Bild 3
{}% Text Bild 3
{}% Pfad Bild 4
{}% Text Bild 4
...
%{3}% Anzahl Spalten
%{empty}% Pfad Bild 1
%{Closeup Tropfkammer}% Text Bild 1
%{empty}% Pfad Bild 2
%{Closeup Stellrad}% Text Bild 2
%{empty}% Pfad Bild 3
%{Closeup Anschluss Venflon}% Text Bild 3
%{empty}% Pfad Bild 4
%{}% Text Bild 4
\end{PictureSeriesWide}
