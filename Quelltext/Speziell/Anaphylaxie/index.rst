...
.. index::
    single: Urtikaria
    single: Ausschlag, urtikarieller
    single: Exanthem, urtikarielles
    single: Quaddeln
    single: Schock; anaphylaktischer
...
-   Haut: Urtikaria (Nesselsucht)
    ...
    aus kutanen Mastzellen,
    die zu einem Flüssigkeitsleck
    aus oberflächlichen Blutgefäßen führen
...
.. figure:: /Bilder/WikipediaCcBySa-3.0-unported/Rash-922px.jpg
    ...
    [`Enoch Lau <https://en.wikipedia.org/wiki/User:Enochlau>`_ //  Creative Commons Attribution-Share Alike 3.0 Unported]
...
.. list-table:: Stadien der Anaphylaxie (nach [Ring:1977]_)
    ...
    *   -   **II°**
        -   Juckreiz, Flush, Urtikaria, Angioödem
        -   Übelkeit, Ernrechen, Krämpfe
        -   Rhinits,
            Heiserkeit,
            Dyspnoe
        -   Tachykardie (↗ > 20 / min),
            Hypotension (↘ 20 mm Hg / min),
            Arrythmie
    *   -   **III°**
        -   Juckreiz, Flush, Urtikaria, Angioödem
...
-   Patienteneinschätzung (:ref:`Einschaetzungsblock`)
    ...
    -   Inspektion leicht einsehbarer Hautareale
        sowie der Schleimhäute und Uvula
    -   Beurteilung der Atmung
        (Sprechdyspnoe, Stridor, Giemen; optional: Auskultation)

-   **Kernfrage:** *"Welche Organsysteme sind betroffen?"*
