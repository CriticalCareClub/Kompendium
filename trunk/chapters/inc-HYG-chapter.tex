...
\gTODO{GABS}{yyyy-mm-dd}{Fließtext/Slide fehlt!}{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\gZ{Sie können die unterschiedlichsten Formen (Kugeln, Stäbchen, mit Geißeln \ldots ) haben.}
...
Zellen.\gZFootnote{Sie sind so klein dass
sie im Lichtmikroskop nicht sichtbar sind.} \gZ{Sie brauchen Wirtszellen um sich
...
\gEs{"`Verkühlungskrankheiten"'}, sowie andere bekannte
Krankheiten wie z.B. die \gEs{Grippe}, \gE{Feuchtblattern} und
viele \gE{Hepatitis}-Formen, werden durch Viren verursacht.
...
\gZFootnote{Viren lassen sich nicht auf
...
\gTODO{GABS}{yyyy-mm-dd}{Layout-Anpassung notwendig!}{Dieser Abschnitt
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TODO : Überarbeitung
\gTODO{GABS}{yyyy-mm-dd}{Überarbeitung notwendig.}
...
\gTODO{GABS}{yyyy-mm-dd}{LIT, HYG: MDR/XDR-TB Quelle bei AGES}{}
...
Die hergestellte Lösung ist nur \gE{begrenzt haltbar} und muss regelmäßig
...
\gTODO{GABS}{yyyy-mm-dd}{Fließtext fehlt!}{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TODO : Layout-Anpassung
\gTODO{GABS}{	}{Layout-Anpassung notwendig!}{Dieser Abschnitt
entspricht nicht dem Standard-Layout! (Fließtext -- Punkte)}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Mund-Nasen-Maske (\gAbk{MNM}, "`OP-Maske"'), welche für viele Situationen einen ausreichenden Schutz
