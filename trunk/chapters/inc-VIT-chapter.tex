...
\subsection{Bewusstseinsstörung}
...
Bewusstseinsklarer Patient: 15 Punkte. Toter Patient: 3 Punkte (nicht
0!)
...
\gMassnahmen{
    \paragraph{Maßnahmen bei bewusstlosen und soporösen Patienten}
    \begin{itemize}
        \item BAK -- Schema  (Bewusstsein/Atmung/Kreislauf)
        \item \gTxMassVitBes
        \begin{itemize}
...
\begin{itemize}
    ...
    ist eine Zelle geladen (innen Minuspol, außen Pluspol). Das ist besonders wichtig für
    \begin{itemize}
...
pH-Wert zu messen, jedoch haben wir großen Einfluss auf ihn
