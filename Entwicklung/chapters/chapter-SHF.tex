...
\begin{itemize}
  \item \Speech{"`Guten Tag! Mein Name ist
...
\begin{itemize}
  \item \Speech{"`Was können wir für Sie tun?"'}
\end{itemize}
...
\begin{itemize}
  \item \Speech{"`Wie heissen Sie denn?"'}
  \item \Speech{"`Wissen Sie was gerade passiert ist?"'}
  \item \Speech{"`Können Sie mir sagen wo Sie gerade
  sind?"'}
  \item \Speech{"`Wissen Sie wie spät es ist?"'}
  
  oder: \Speech{"`Welche Tageszeit hebn wir?"'}
  
  oder: \Speech{"`Welche Jahreszeit haben wir?"'}
  
  oder: \Speech{"`Welches Jahr haben wir?"'}
  
  Für Britische Staatsbürger: \Speech{"`Who is the
  current Regent?"'}
\end{itemize}
