...
\definecolor{chaptergrey}{named}{DefaultA}
...
\newcommand{\SAMPLE}[1]{{\color{DefaultB}\small\textcircled{\ttfamily\bfseries\scriptsize#1}}}
\newcommand{\TxSAMPLE}{(S)A}
...
\newenvironment{PictureSeries}[3][H]
{%
\begin{figure}[#1]
...
\newenvironment{PictureSeriesWide}[3][H]
{%
\begin{figure}[#1]
\begin{WidePar}
\Captionof{figure}{#3}\par\end{WidePar}\begin{WidePar}}
{%
\end{WidePar}
\end{figure}
}
...
{\subfloat
[#3]
{\ifthenelse{\equal{#2}{empty}}{\parbox{0.30\linewidth}{~}}{\includegraphics[width=0.30\linewidth]{#2}}}
\hfill
\subfloat[#5]
{\ifthenelse{\equal{#4}{empty}}{\parbox{0.30\linewidth}{~}}{\includegraphics[width=0.30\linewidth]{#4}}}
\hfill
\subfloat[#7]
{\ifthenelse{\equal{#6}{empty}}{\parbox{0.30\linewidth}{~}}{\includegraphics[width=0.30\linewidth]{#6}}}
}
{}
...
{\subfloat
[#3]
{\ifthenelse{\equal{#2}{empty}}{\parbox{0.23\linewidth}{~}}{\includegraphics[width=0.23\linewidth]{#2}}}
\hfill
\subfloat[#5]
{\ifthenelse{\equal{#4}{empty}}{\parbox{0.23\linewidth}{~}}{\includegraphics[width=0.23\linewidth]{#4}}}
\hfill
\subfloat[#7]
{\ifthenelse{\equal{#6}{empty}}{\parbox{0.23\linewidth}{~}}{\includegraphics[width=0.23\linewidth]{#6}}}
\hfill
\subfloat[#9]
{\ifthenelse{\equal{#8}{empty}}{\parbox{0.23\linewidth}{~}}{\includegraphics[width=0.23\linewidth]{#8}}}
}
{}
}
