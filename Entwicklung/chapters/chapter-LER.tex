...
Die \Es{Ausstellung der Entlehnberechtigung} erfolgt in der Zeit von
...
EKG-Kurs
ekg-online.de \url{www.ekg-online.de}
...
\begin{labeling}{mmmm}
\item[\cite{RedelsteinerHRNS1}] \Es{Lehrbuch für Fortgeschrittene}:
\emph{\bibentry{RedelsteinerHRNS1}}
\item[\cite{BLIM3}] \Es{Fachbuch} für speziell an Medizin interessierte, mit
guter, kurzer Einführung in anatomische und physiologische Grundlagen am Anfang
eines jeden Kapitels:
\emph{\bibentry{BLIM3}}
\item[\cite{BoehmerTaschRett6}] \Es{Taschenbuch}, jackentaschentauglich:
...
\begin{labeling}{mmmm}
  \item[\cite{Helfen2008}] \Es{Kurzgefasste Basics} der Notfallmedizin auf 141
  Seiten:
