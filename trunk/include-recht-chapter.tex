...
\begin{itemize}
	\item {\mdseries
	\gT{ Heilbehandlung svertrag}: Der Patient selber oder sein
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item {\mdseries
		Inhalt muss eine konkrete Heilbehandlung ablehnen ${\rightarrow}$ allgemeine oder
...
\begin{itemize}
	...
	Die \gEs{Arzneimittelliste 2} wird vom leitenden
		...
		practicandi -- nicht unbedingt NA) oder
		\item
...
Bluterguß.} \"uberziehen den K\"orper und ein gro{\ss}es
Feilchen ziert das rechte Auge der jungen Patienten. Als Natascha auf diese weiteren Verletzungen
