...
\gTempPicMissing{Todesfeststellung}
\end{center}
...
\gTempPicMissing{Abbruch d Rea, Kopf neben Puppe}
\end{center}
...
\gFazit{Grundsatz: Der Schock muss bek\"ampft werden bevor
man ihn bemerkt.}
...
\begin{itemize}
    ...
    \end{itemize}
    \item Medikament\"ose Therapie durch Notarzt  (Diuretika,
    Katecholamine, Heparin)
\end{itemize}
\end{gMassnahmenEnv}
