...
&
\begin{compactdesc}
  \item[Dos] Pulslose KT od Asystolie: 75-100~in 1-2~min IV (1-1,5~\MgKg),
  bei Bedarf alle 5~Min 50{\Mg} in 1~Min~IV (0,5-0,75~\MgKg); max
  200-300\Mgwährend der ersten Stunde
  \item[Hämodynamisch stabile KT:]  50{\Mg} (0,5-0,75~\MgKg)~IV dann el
...
20{\Mg} über 20~min; max 1,5~\MgKg
  ...
  Erh: IV: max 1,5~{\MgKg} IV aufgeteilt in 4 Tagesdosen\newline
...
\begin{labeling}[:]{mm}
  ...
  \item[Rx]Bolus 1{\MgKg} langsam iv, dann Perf.
  \VonBis{2}{4}\MgKgH\newline
...
\begin{labeling}[:]{mm}
  ...
  \item[Cave] Bei Betablocker-Pat. überwiegend {\textalpha}-Rezeptoren-Wirkung.
\end{labeling}
}
{}
...
NASCIS-Schema: Bolus (30\MgKg) nach {\textless}3\,h, spätestens
...
\begin{labeling}[:]{mm}
  ...
  \item[Rx] Erw: \VonBis{2,5}{10}{\Mg} iv, \E{Kinder}: 0,05{\MgKg} iv; auch
  sc/im.
  \item[Cave] ---.
...
\begin{labeling}[:]{mm}
  ...
  \item[\textrecipe :]
  Analgesie: \VonBis{0,1}{0,25}{\MgKg} IV,
  \VonBis{0,25}{0,5}{\MgKg} IM; 
  Anästhesie: \VonBis{1}{2,5}{\MgKg} IV, 2,5\,-\,4{\MgKg} IM;
  Bronchospasmus: \VonBis{1}{2,5}{\MgKg} IV.
...
\item[Rx] 0,005{\MgKg} (1A/100kg) IV/SC
