...
\begin{labeling}[~--]{xxxxxxxxxxxxxxxxxx}
  ...
  Insult"',
  \I[Ischämie!Schlaganfall]{Ischämie},
  \FullPrettyRef{topic:ischaemie}), oder
...
\begin{itemize}
    ...
    \item Kaffesatz-artiges Erbrechen, Teerstuhl
\end{itemize}
}{}{}{}
...
\begin{itemize}
  \item Allgemeine Maßnahmen bei Abdominalerkrankungen
  (\prettyref{m:am-abdominalerkrankungen})
  \item \EE{Transportentscheidung}: Abt. f. Chirurgie, bei
  akutem Schub einer chronischen Pankreatitis evtl. auch
  Abt. f. Innere Medizin möglich 
\end{itemize}
}
...
(\Speech{"`Der Stein wandert, der Schmerz wandert, der
Patient wandert"'}).
