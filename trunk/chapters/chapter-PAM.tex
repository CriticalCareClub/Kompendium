...
\Layout{0}{GI -- Bewusstsein}{Beurteilt wird der \E{quantitative}
Bewusstseinsgrad (\Speech{"`\S{Wieviel} Bewusstsein ist vorhanden?"'}, vgl.
\prettyref{topic:bewusstsein-grade}). Es wird dazu die Reaktion auf verbale
...
Reaktion auf verbale
Ansprache, Weckversuch, Schmerzreiz
