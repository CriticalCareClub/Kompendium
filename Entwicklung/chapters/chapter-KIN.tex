...
{\CC{[KIN]} \emph{Spezielle Patientengruppe:} Kinder}
...
\TabHeading{Bezeichnung}&\TabHeading{Alter}&\TabHeading{alternativ}
...
In der Literatur kommt es gelegentlich zu
...
\TabSub{Atemfrequenz}
&
Neugeborenes: \VonBis{30}{50}\PerMin*

Säugling: \VonBis{20}{30}\PerMin*

Kleinkind: \VonBis{20}{30}\PerMin*
...
\index{Nasenflügeln}\EE{Nasenflügeln}
...
\TabSub{Herzfrequenz}
&
Neugeborenes: \VonBis{140}{180}\PerMin* (Lebensgefahr
unter 80\PerMin*)

Säugling: \VonBis{110}{160}\PerMin*\nocite{Lissauer2007}

Kleinkind: \VonBis{95}{140}\PerMin*\nocite{Lissauer2007}

Schulkind: \VonBis{80}{120}\PerMin*\nocite{Lissauer2007}
...
\prettyref{topic:mechanische-atemwegsverlegung} behandelt.


% \TODOCRITICAL{GABS}{????-??-??}{Fremdkörperaspiration: Erwachsen -- Kind
% überarbeiten und zusammenführen}
% {
...
%   \begin{itemize}
%     \item \EE{leichte Atemwegsverlegung} Kind weint und kann noch auf Fragen verbal Antworten; deutliches Einatmen ist möglich.
%     \begin{itemize}
%       \item zum Husten auffordern; überwachen; hospitalisieren
%     \end{itemize}
%     \item \EE{schwere Atemwegsverlegung} unfähig zu sprechen, atmen oder husten
%     \begin{itemize}
...
{%
Bei der Laryngitis
(Pseudokrupp\index{Pseudokrupp}\footnote{"`Pseudokrupp"'
...
daraus folgende \EE{Schwellung des Kehldeckels}. Sie kommt eher selten vor, kann aber
...
Familienleben. Aus \EE{unbekannter Ursache} -- und aus oft völliger Gesundheit
...
Letzten Endes ist die genaue \EE{Ursache unbekannt}, eine
...
\EE{die Eltern keine Schuld trifft}!
...
\Definition{\EE{Ertrinken}: Tod in den ersten 24\,h nach
Ertrinkungsunfall; ansonsten:
...
\Layout{0}{\TxBeschreibung}
{%
Kleinkinder unter 5~Jahren können bei Fieber sogenannte
...
\begin{multicols}{2}
\begin{labeling}{mmm}
  \item[\cite{Lissauer2007}] \emph{\bibentry{Lissauer2007}}
  \item[\cite{SitzmannPaediatrie2}] \emph{\bibentry{SitzmannPaediatrie2}}
  \item[\cite{NetterPaediatrie1}] \emph{\bibentry{NetterPaediatrie1}}
  \item[\cite{OHCSP7}] \emph{\bibentry{OHCSP7}}
  \item[\cite{Erc2010Sec6}] \emph{\bibentry{Erc2010Sec6}}
