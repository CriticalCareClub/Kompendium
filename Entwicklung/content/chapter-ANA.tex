...
\begin{itemize}
  ...
  Die \T[Blutkörperchen!rote]{roten Blutkörperchen} (\I{Erythrozyten}) sind quasi die wichtigsten des
  ganzen Körpers -- ohne ihren Sauerstofftransport
  funktioniert im Körper gar nichts. Das Protein \T{Hämoglobin} ist der \E{Blutfarbstoff} und für die
  Bindung des Sauerstoffes in den Erythrozyten verantwortlich. Ein Mangel an Hämoglobin wird als
  \T{Anämie} bezeichnet.
  Die Erythrozyten sind die häufigsten festen
  Blutbestandteile (4\,000\,000\,/\,{\Mul}) und tragen u.\,a. die
...
\subsubsection{Vitalfunktion: Immunsystem}
...
\subsection{Herzleistung und Blutdruck}
