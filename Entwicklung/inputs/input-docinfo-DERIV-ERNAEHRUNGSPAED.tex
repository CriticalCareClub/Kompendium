...
\newcommand{\DocVersion}{0.19.x-{\pdfdate}}
\renewcommand{\DocVersion}{0.20.x-{\pdfdate}}
...
pdftitle={Arbeits- und Ausbildungsstandards für die Sanitätsberufe - Derivat der AASS für die
Ernährungspädagogik - \DocVersion},
% Sets the document information Title field pdfauthor=ARGE AASS, % Sets the document information Author field
pdfsubject={AASS Derivat Ernährungspaedagogik \DocVersion},
