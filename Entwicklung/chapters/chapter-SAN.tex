...
\Fazit{Die hygienische Händedesinfektion ist \EE{vor} bzw. \EE{nach
...
Der Transport mit Hilfe des Tragetuchs ist jedoch \EE{nicht
...
Transport über Stiegen hat der Patient immer \EE{talwärts} zu blicken.
}{
...
\clearpage
\subsection{Dekubitus und Dekubitusprophylaxe}
\index{Dekubitus!Prophylaxe}
\label{topic:dekubitusprophylaxe}

\Definition{\T{Dekubitus}: \I{Wundliegen}. Bereich
...
Patienten ist dies nur mehr eingeschränkt oder gar nciht
...
\begin{itemize}
  \item \EE{Druck}: Je Höher der Druck, desto größer die
  Schädigung.
...
\begin{itemize}
  ...
  Lagerunf ist korrekt,wenn der unten liegnde Trochanter
  ohne Druckbelastung ist. Der untern liegende Fuß kann
  ...
  auf 5 oder mehr Polstern gelagert. Ziel ist das Freilegen
...
\begin{itemize}
  ...
  \item \Z{\EE{Ernährung}: Hierbei sie auch die
  entsprechende pflegerische Fachliteratur verwiesen.}
\end{itemize}
...
Krankentransportdienst, jedoch sind die teichnischen
...
werden. Als einfaches Hilfsmittel steht die (nicht
abgesaugte!) Vakuummatratze zur Verfügung, welche bei
geringen Dekubitusrisiko als Unterlage verwendet werden
kann. Ausserdem sind diverse künstliche
...
\Layout{2}{\TxBeschreibung}
{%
Dient zum Ruhigstellen und Stabilisieren der {\bfseries
H}als{\bfseries W}irbel{\bfseries S}äule (HWS). Sie soll bei
jedem Verdacht auf eine Verletzung der Halswirbelsäule
eingesetzt werden; auf jeden Fall nach einer Helmabnahme und
bei Verdacht auf ein Schädel-Hirn-Trauma
(\Abk{SHT})!

Es sind verschiedene
Fabrikate verfügbar (z.\,B. Stifneck\texttrademark). Es gibt
...
einer Schaufeltrage (ohne Verwendeung einer Vakuummatratze)
...
eng anzupassen und somit Bewegungen effektiv verhindern.
...
\begin{enumerate}
    ...
    Blutung verlangsamen (Pat. kann dies je nach Zustand
    selbst tun!)
