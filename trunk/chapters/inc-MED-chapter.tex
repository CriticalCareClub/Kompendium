...
\gLayout{1}{Beurteilung des Schweregrades}
{
...
\gLayout{1}{Kardiales Lungenödem und Linksherzinsuffizienz}
...
\gLayout{1}{{\RainCloud} Komplikationen}
{
\begin{itemize}
...
\gLayout{1}{Pulslose Ventrikuläre Tachykardie}
{
\index{Pulslose Ventrikuläre Tachykardie}
...
\gLayout{1}{Ursachen -- Warum kommt es zu einem Gefäßverschluss?}
{
Meistens liegt eine 
...
\gLayout{1}{Probleme mit Sauerstoff bei
COPD-Patienten}
{
...
\gLayout{1}{Differntialdiagnosen}
{
...
\gLayout{1}{Differentialdiagnose}
{
...
\gLayout{1}{Sonstige Besonderheiten}
{
...
\gLayout{1}{Eklamptischer Krampfanfall während der
Schwangerschaft}
{
...
\begin{itemize}
    ...
    \item Subfebrile Temperatur.
    \item \gEs{Nachschweiß, Lymphknotenschwellung}
    \item Anamnese!
\end{itemize}
}
{}
...
\gLayout{2}{Impfung}
{
Impfung nur für Hepatitis A und B
...
\gMassnahmenNG{Allgemeine Maßnahmen (Ursachen-unabhängig)}{Abdominalerkrankung}{
\begin{itemize}
...
Patienten geprägt. } {\gSlideHeading{\gTxSymptome}
...
\gLayout{1}{\gTxBeschreibung und Ursachen}
...
(\gSee{topic:vena-cava-syndrom}) zu vermeiden, sollte die Patientin liegend in leichter \gEs{Linkseitenlage}
...
\gLayout{1}{Psychiatrische Erkrankung in der Praxis}
{
...
\gLayout{1}{Der psychiatrische Patient ist nicht entrechtet!}
{
...
\gMassnahmenNG{Spezielle Maßnahmen}{Umgang mit Patienten mit Wahnvorstellungen}{
...
Herangehensweise}{Vergiftungen}{\label{vergiftung-allgemein-massnahmen}
\begin{enumerate}
    \item Selbstschutz
...
\begin{itemize}
    \item Allgemeine Maßnahmen bei Vergiftungen
    (\ref{vergiftung-allgemein-massnahmen}) und
...
\gMassnahmenNG{Allgemeine Maßnahmen}{Stickgasvergiftungen}{
...
\gMassnahmenNG{Allgemeine Maßnahmen}{Reizgasvergiftungen}{
...
}{./images/med/schild-atemschutzmaske-abnehmen.jpg}{}{}
