...
\Layout{0}{\TxSymptome}
{%
Das Leitsymptom ist die \Es{Atemnot}. 

Meist atmet der Patient schnell
(Tachypnoe) und klagt über einen \Es{atemabhängigen Thoraxschmerz}. Daneben
...
{%
Oft findet man deutlich hervortretende, \Es{gestaute Venen} am Hals aufgrund des
Blutrückstaues. 

Je nach Ursache der Embolie und Herkumpft des Embolus kann man Zeichen anderer
Krankheitsbilder Wahrnehmen: Bei einer \Es{tiefen Beinvenenthombose} ist ein
...
Puls} in Folge eines Vorhofflimmerns ertasten; evtl. gibt der Patient auch an an
Vorhofflimmern zu leiden. 
}{
\begin{itemize}
...
{%
\Es{Immobilisation}, z.\,B. durch Bettlägrigkeit,
...
Oft ist bei den Patienten auch \Es{Vorhofflimmern} als chronische Erkrankung
bekannt.

\Z{Weiters tritt die Lungenembolie gehäuft in der Schwangerschaft
Schwangerschaft auf. Rauchen sowie die Einnahme der Verhütungspille erhöhen
ebenso das Risiko.}
}{
\begin{itemize}
  \item Immobilisation.
...
{%
Ein Lungenödem kann aufgrund einer \Es{Herzschwäche} (\E{kardial}) oder
aufgrund von \Es{Inhalation giftiger Substanzen} (\E{toxisch}) entstehen.

Beim \Es{kardialen Lungenödem} versagt die Auswurfleistung des linken Herzens
(\Es{Linksherzinsuffizienz}), dadurch kommt es zu einem \Es{Rückstau} des Blutes
in die Lunge. Aufgrund der Druckerhöhung tritt Flüssigkeit in das Gewebe über, es
bilden sich Ödeme im Gewebe bzw. \Es{Flüssigkeitsansammlungen} in den Alveolen.
Auslöser können zum Beispiel ein Herzinfarkt, oder auch ein einfacher grippaler
Infekt sein, der dem vorgeschädigtem Herzen "`den letzten Stoß"' versetzt. 

Beim \Es{toxischen  Lungenödem} kommt es aufgrund reizender Stoffe zu einer
\Es{Entzündung}, und damit zu einem \Es{Flüssigkeitsaustritt}, im Lungengewebe.

In beiden Fällen behindert die Flüssigkeit den \Es{Gasaustausch} massiv, beim
...
sind \Es{lebensbedrohlich krank}. Das Herz verbraucht oft
...
Es kommt tatsächlich relativ häufig vor, dass diese Patienten \Es{im
Stiegenhaus} oder \Es{im Auto}
\Es{reanimationspflichtig} werden. Solche Patienten müssen daher \Es{an Ort
...
Das Leitsymptom ist das \Es{brodelnde Atemgeräusch}, welches in schweren Fällen
...
Weitere häufige Symptome sind \Es{Atemnot} und \Es{Zyanose}. Der Patient bekommt
...
können sehr unterschiedlich sein und umfassen:
  ...
  der Gesichtsmuskulatur. Durch die Lähmungen kann es zu \Es{Schluckstörungen} kommen, es
  ...
  häufig. Oft nimmt man eine \Es{verwaschene Sprache} wahr, welche (fälschlich) an
...
\Es{Schutzimpfung} angeboten. Sie basiert auf der \E{Voraussage},
welcher Stamm in der jeweils bevorstehenden Grippewelle
vorherrschen wird. Sie wirkt daher nur für ein Jahr (eine Saioson) und muss
...
Viren oder Pilze\ZFootnote{(häufig bei HIV/Immunsupression)} oder eine
...
fiebern selbst bei schwereren Erkraknkungen kaum an.
}{
\begin{itemize}
...
\Es{Lichtscheu}. Dies bezeichnet man als \T{Meningismuszeichen}. 
...
dass der \Es{HIV-Test nicht "`aktuell"', sondern "`12 Wochen blind"'} ist!
}
{
% TODO VIT: Slide fehlt!
}
