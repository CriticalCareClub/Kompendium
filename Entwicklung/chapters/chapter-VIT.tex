...
\Layout{abstract}{}
{Vitalfunktionen ermöglichen die Funktion des Körpers. Es
gibt grundlegende Vitalfunktionen 1. Ordnung (Bewusstsein,
Atmung, Kreislauf), deren Störung binnen kurzem zum
...
\Z{Bicarbonat-}\II{Puffersystem} im Blut.~\ZFootnote{Ein
Puffer ist ein Stoff welcher pH-Änderungen abfedert.}
...
Ein klassisches Krankheitsbild ist das
\II[Koma!diabetisches]{Diabetische Koma}. Auch hier werden
saure Stoffe gebildet \Z{Ketonkörper}, welche ein Ungleichgewicht verursachen. }{%
\begin{itemize}
