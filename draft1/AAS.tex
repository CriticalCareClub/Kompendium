...
{\begin{center}
 { \cornersize{0.5}
   \ovalbox{\makebox[12cm]{\parbox{10cm}{\sffamily\textcolor{red}{#1}}}}}
\end{center}}
...
{\begin{tabularx}{\linewidth}{XX}\addlinespace
...
\end{tabulary}
\end{center}
\marginpar{{\sffamily \gEs{Alarmzeichen}
...
\chapter{Krankheiten und Notfälle --- \gAasRsN{RS VI}}
...
\paragraph{Symptome} \begin{wraptable}{r}{5cm}
\label{tab:5p}
\centering
...
\begin{gMassnahmenEnv}
    ...
    \begin{itemize}
        ...
        \item unerträgliche Schmerzen ={\textgreater} Notarzt
    \end{itemize}
\end{gMassnahmenEnv}
...
\paragraph{EPH-Gestose -- Präeklampsie - Eklampsie}
\label{topic:eph-gestose}\index{EPH-Gestose}
\begin{enumerate}
    \item Edema (\"Odeme)
...
\begin{itemize}
\item \textbf{Wärmestau}  (zugef\"uhrte Wärme  kurzfristig {\textgreater}
abgegebene)
