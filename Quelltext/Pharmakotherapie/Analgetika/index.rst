...
Folgende Komponenten hat die Schmerzempfindung:
...
Schmerzen kann man nach dem Ort ihres Auftretens verteilen in:

-  somatische Oberflächenschmerzen (Haut)
...
-  das periphere nozizeptive System: Hier sind die Nozizeptoren gemeint,
   die in normalem Gewebe verteilt sind und auf noxische mechanische,
   thermische und chemische Reize reagieren. Sie bestehen aus
   sensorischen Endigungen und langsam leitenden Neuronen. Ihre
   Aktivierung erfolgt über Ionenkanäle.
-  das spinale nozizeptive System: Diese nozizeptiven Rückenmarkszellen
   bilden aufsteigende Bahnen zum Thalamus und Hirnstamm sowie spinale
   Reflexbögen.
-  das thalamo-kortikale nozizeptive System: Dieses System ist für die
   bewusste Schmerzempfindung verantwortlich.

Über den Hirnstamm kann der Schmerz moduliert werden, und zwar über

-  deszendierende Hemmung: hier wird die Schwelle der
   Rückenmarksneuronen angehoben und ihre Antwort auf noxische Reize
   abgeschwächt.
-  deszendierende Bahnung: trägt zur Verstärkung der nozizeptiven
   Signalverarbeitung im Rückenmark bei.

klinische Schmerzen
~~~~~~~~~~~~~~~~~~~~~~~~

Folgende Schmerzen sind im klinischen Alltag von Bedeutung:

-  pathophysiologische Nozizeptorschmerzen: z.B. bei Entzündung,
   Verletzung
-  neuropathische Schmerzen: bei Schädigung oder Erkrankung der
   Nervenzellen selbst

Zu klinisch bedeutsamen Schmerzen führen diese Mechanismen:

-  periphere Sensibilisierung -> primäre Hyperalgesie
-  ektopische Entladungen -> wichtige Mechanismen für Neuropathie
-  zentrale Sensibilisierung -> sekundäre Hyperalgesie
-  kortikale Reorganisation -> mitverantwortlich für Phantomschmerz
-  kortikale Lernprozesse -> Beitrag zur Chronifizierung

Grundlagen der Schmerztherapie
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Zwei Arten der Schmerztherapie sind möglich:

-  medikamentöse Schmerztherapie mit folgenden Medikamentengruppen
...
Folgende Wirkungen kann man bei NSARs beobachten:
...
+--------------+------------------------------------------------------+
| Dexibuprofen | **Deltaran®, Actifen®, Monactil®, Seractil®**        |
+--------------+------------------------------------------------------+
| Diclofenac   | **Voltaren®, Tratul®, Diclobene®, Deflamat®,         |
|              | Dolpasse®, Arthrotec®, Neodolpasse®**                |
+--------------+------------------------------------------------------+
| Ibuprofen    | **Brufen®, Ibuhexal®, Dolofort®**                    |
+--------------+------------------------------------------------------+
| Indometacin  | **Amuno®, Indobene®**                                |
+--------------+------------------------------------------------------+
| Meloxicam    | **Mobic®, Metosan®**                                 |
+--------------+------------------------------------------------------+
| Piroxicam    | **Felden®, Pirox®**                                  |
+--------------+------------------------------------------------------+
...
============= ================================
**Celecoxib** **Celebrex®, Onsenal®, Solexa®**
...
-  **Morphin (Compensan®, Vendal®, Modiscop®)**:
   ...
   -  Wirkungen: Analgesie, Sedierung, emetisch, antiemetisch,
      antitussiv, Hirndrucksteigerung, Atemdepression, Miosis,
      Muskelrigidität, Euphorie, Toleranz, Abhängigkeit, zentrale
      Sympatholyse.
   -  Trias der Intoxikation: Atemdepression, Koma, Miosis

-  **Heroin**: hohes Abhängigkeitspotential
...
-  **Levomethadon (L-Polamidon®)**:
   ...
   -  ähnlich wie Morphin
   -  Entzugssymptomatik verzögert und leichter
   -  Ersatzdroge für Opioidabhängige

-  **Piritramid (Dipidolor®)**: lange Wirkdauer (6-8h)

-  **Pethidin (Dolantin®, Alodan®)**:

   -  bessere orale Bioverfügbarkeit als Morphin
   -  kurze Wirkdauer (2-4h)

-  **Tramadol (Tramal®, Adamon®, Dolol®, Zalidar®)**:

   -  geringe Wirkung und Nebenwirkung
   -  keine Interaktionen mit Morphin, daher Kombination möglich

-  **Dihydrocodein (DHC Mundipharma®, Codidol®, Dehace®)**: starker
   antitussiver Effekt
...
-> **Buprenorphin (Temgesic®, Transtec®, Tridol®, Subutex®)**:

-  nur sublinguale oder parenterale Gabe
-  Ceiling-Effekt, keine Antagonisierung
-  längste Wirkdauer aller Opioide (6-8h)
...
-  rasche Aufhebung aller durch Opioidrezeptorvermittelte Effekte, außer
   Buprenorphin; nur parenteral!
-  bewirkt ein akutes Entzugssyndrom bei Abhängigen
...
Eletriptan   **Relpax®**
Frovatriptan **Allegro®, Eumitan®, Frovamig®**
Naratriptan  **Naramig®, Antimig®**
Rizatriptan  **Maxalt®, Rizalief®**
Sumatriptan  **Imigran®**
Zolmitriptan **Asco Top®, Zomig®**
============ =================================
