...
\begin{itemize}
  ...
  (\T{AED}\footnote{\Lang{Abkz.} AED: Automatisierter
  ...
  auch von Laienhelfern verwendet
  werden.
  ...
  \enquote{Halbautomaten-Modus} (AED-Modus), in welchem das Gerät als
  ...
  implantiert werden (\I{ICD} (\Lang{Abkz.} \I{Implantable Cardiac Device})).}
\end{itemize}
...
Manuelle Defibrillatoren sind meist Bestandteil eines Multifunktions-Gerätes, welches oft auch umfangreiche Überwachungsmöglichkeiten bietet. 

\begin{description}
  \item[Therapieelektroden] 
  Bei aktuellen Geräten werden für die Defibrillation Klebeelektroden für die Defibrillation eingesetzt, wie sie auch bei AEDs zum Einsatz kommen. 
  %
  Alternativ, oder bei älteren Geräten auch ausschließlich, können auch \EE{Hardpaddles} verwendet werden. 
  %
  ...
  %
  Zusätzlich wird noch ein \E{Elektrodengel} benötigt, 
  um den Leitungswiederstand herabzusetzen. 
  Anders als in den Medien dargestellt, 
  ...
  Viele manuelle Defibrillatoren besitzen einen AED-Modus, 
  ...
  zum gleichen Zeitpunkt wie im AED-Modus,
  also alle 2\Min* 
  bzw. 5 Zyklen.
  ...
  %
  Neuere Geräte verfügen oft über eine Rhythmuserkennung und \enquote*{\I{Auto-Sync}}-Funktion, hier entfällt das manuelle einstellen.
  %
  \begin{Danger}
  ...
  \begin{enumerate}
    ...
    \item \Speech{\enquote{Achtung! Schock kommt!}}
...
%   nicht defibrilliert werden. % ex mit ERC 2010
  ...
  \begin{itemize}
    ...
    \item \StepHeading{Eletrische Interferenzen}: 
...
\begin{Synopsis}
  ...
  \EE{supraglottische Atemwegshilfen} als \EE{primärer} Zugang
