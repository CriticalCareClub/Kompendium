...
Lokalanästhetika unterbinden die Reizweiterleitung an Nervenzellen durch Blockade der Fähigkeit der Nervenzelle zur Depolarisation.
...
Lokalanästhetika blockieren die *Innenseite* der **Natriumkanäle** der Nervenzellen und verhindern dadurch den Einstrom von Natriumionen und damit die Bildung von Aktionspotentialen.
...
Als Wedensky-Block wird die Unempfindlichkeit gegen einen Einzelreiz, nicht jedoch gegen fortgesetzte Reize bezeichnet.
...
Durch die Zwischen- und Aminogrupper ergibt sich ein *Aminoamid* oder *Aminoester*.
Die Unterscheidung von **Amid-** und den **Ester-Typ** ist hinsichtlich des Abbaus wichtig:
*Aminoester* werden *im Gewebe* durch die Cholinesterase abgebaut, die *Aminoamide* in der *Leber*.
