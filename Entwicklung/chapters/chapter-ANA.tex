...
fähig, sofern ihr nicht die übergeordnete Station zuvor kommt.}. Im Extremfall, wenn das gesamte Leitungssystem ausfällt, können auch die
Herzmuskelzellen selbst einen minimalen Rhythmus ($\sim$\,30\,\nicefrac{}{min})
aufrecht erhalten.
...
eine Reihe weiterer Atemhilfsmuskeln die die Atmung unterstützen. Diese verbinden den Thorax und die Oberarme. Fixiert man
die Arme, z.\,B. durch aufstützen, können die Muskeln die Hebung des Brustkorbes
unterstützen. Vgl. dazu \emph{'Asthma', \ref{topic:asthma-bronchiale}} und
\emph{'COPD', \ref{topic:copd}}.
...
\Layout{0}{\TxBeschreibung}{%
Der Zwölffingerdarm ist der Beginn des Dünndarmes und ca. 25\,cm lang. 
...
welches zu chronischen Leberschädigungen, wie z.\,B. einer Leberentzündung oder 
Leberzirrhose, führen kann.
Über die \T{Pfortader} (Vena portae, \ref{topic:pfortader}) erhält die
Leber nährstoffreiches Blut von Teilen des  Darms um es zu entgiften, bevor es
in den normalen Blutkreislauf zurückkehrt. 
...
Gallenflüssigkeit \E{gespeichert (!)} wird.
...
\\\hhline{~--}
 &
\EE{Aufsteigender} Teil \index{Dickdarm!aufsteigender
Teil} &
\multirow{4}{\columnwidth}{Wasserentzug, Eindickung, \\
Bakterienbesiedlung, \\Speicherung} 
\\\hhline{~-~}
 &
\EE{Querender} Teil \index{Dickdarm!querender 
Teil}
 &
\\\hhline{~-~}
 &
\EE{Absteigender} Teil \index{Dickdarm!absteigender
Teil}
 &
\\\hhline{~-~}
 &
...
\EE{aufsteigenden Teil} des Dickdarmes, \E{nach unten} in
...
Das Bauchfell ist auch verantwortlich für die \EE{Schmerzen}, die z.\,B. bei
...
Sie ist Teil des Immunsystems und entfernt alte Erythrozyten, beim Embryo
ist sie auch an der Blutbildung beteiligt; daher ist sie \EE{sehr gut
durchblutet}!

Sie ist weiters von einer festen \EE{Kapsel} umgeben.
}{
\begin{itemize}
