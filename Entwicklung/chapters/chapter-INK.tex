...
(38{\textdegree}-40{\textdegree}C) mit Schüttelfrost, 
Kopf-, Hals-, Muskel-, Gelenksschmerzen, Husten und stark
...
Komplikationen ist allerdings natürlich höher.
}
{
\begin{itemize}
  \item Hohes Fieber
...
"`\Code{A(H1N1)}"' zu Stande. Je nach Unterart verhalten
...
Viren, allerdings mit anderen als bei der "`echten Grippe"'
...
\Layout{2}{Wichtige Differentialdiagnosen}{% Wie bei jedem
...
\HeadingSub{\Z{Mykobacterium Tuberculosis, "`Schwindsucht"'.}}
Abk.: "`\T{Tbc}"'
...
{%
\subparagraph{HI-Virus} Das HIV befällt vor allem die Zellen
des Abwehrsystems. Es vermehrt sich in ihnen, setzt sie
...
\subparagraph{AIDS} HIV verursacht das \E{AIDS} (Aquired
...
Immunsystem} zu Folgeerkrankungen, an denen der Patient
versterben kann:
...
Krankheitsgefühl, ähnlich einem grippalem Infekt,
...
Der Erreger des Wundstarrkrampfes\ZFootnote{Clostridium
tetani} kommt \E{überall in der Umgebung} vor. Er produziert
