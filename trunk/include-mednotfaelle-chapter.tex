...
ienen verminderten Trinkantrieb. Auch durch die Einnahme von Drogen
(Ecstacy) kann auf den Durst "`vergessen"' werden.  
...
\begin{enumerate}
    ...
    \item Ursachenforschung: Selbstmordversuch, Unfall,
    Fremdverschulden, Vorsatz?
...
\section{Besondere Vergiftungen}

\subsection{Vergiftungen mit Alkohol}

Alkohol wirkt enthemmend, z.T. stimulierend und
stimmungsmodulatorisch. Mit zunehmender Menge werden die
Auswirkungen auf das {\scshape{zns}} aber immer
unerwünschter: Es kann zu einem totalen Kontrollverlust
kommen und der Bewusstseinszustand wird immer
beeinträchtigter. Im Extremfall kann es zu einer
vegetativen Entgleisung und einem tief komatösen Zustand
kommen. Spätestens dann besteht akute Lebensgefahr.
...
\begin{itemize}
    \item Allgemeine Masnahmen bei Vergiftungen
