...
\paragraph{\gTxSymptome} Die Verletzungsmuster und Symptome variieren je nach Spannung (Volt) und Stromst\"arke (Ampere):
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item ZNS ${\rightarrow}$ Bewußtseinsst\"orung
