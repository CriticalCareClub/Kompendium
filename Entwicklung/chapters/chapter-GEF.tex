...
Die Persönliche Schutzausrüstung (\I{PSA}) Ist ein
wesentlicher Bestandteil zur Verhinderung von Verlertzungen
...
Standardausstattung gehört eine den einschlägigen Normen
entsprechende Arbeitsbekleidung (lange Hose, Jacke \E{mit Ärmeln}),
sowie Sicherheitsschuhe mit durchtrittsicherer Sohle und
Stahlkappen. Bei Bedarf wird diese durch weitere Ausrüstung
ergänzt, z.\,B. Helme mit Nackenschutz. Die Arbeit auf
Verkehrsflächen erfordert eine Bekleidung mit Warnschutz
(Tagesleuchtfarbe und Reflektorstreifen, gem.
\I{EN\,471}).\VARIANT{REG-AUT}{\footnote{In Österreich ist
das Tragen von Warnschutzbekleidung gesetzlich nur auf
Autobahnen ftesgeschrieben, dennoch ist das Tragen von
...
werden vom Personal grundsätzlich Einweghandschuhe getragen.
Diese sollen wenn notwendig um Schürzen oder
Spritzschutzbrillen ergänzt werden. Bei infektiösen
Patienten werden je nach Erkrankung spezielle Anzüge bzw.
Atemmasken verwendet. Als Atemmasken stehen
verschiedene Modelle zu Auswahl, von der
einfachen Mund-Nasen-Maske bis hin zu Partikelfiltermasken
der Klassen FFP~\VonBis{1}{3}, vgl. \FullPrettyRef{topic:schutzkleidung-hygiene}, und
\FullPrettyRef{topic:atemmasken}.

In manchen Bereichen, z.\,B. im Wasser-, Berg-, Höhlen- oder
Psitenrettungsdienst können die Erfordernisse erheblich vom
...
Fläche an fluroeszierndem Material (\VonBis{1}{3}); Y: Fläche der Reflektorstreifen (\VonBis{1}{2})}
{./images/pd/en343}
...
\Layout{0}{Mögliche Gefahren für den Helfer}{
\begin{itemize}
...
\begin{description}
  ...
  \VARIANT{VAR-STANDARD}{\Speech{"`Die Freischaltung
  und Erdung wird vom ÖBB-Einsatzleiter veranlasst. Hilfs- und Einsatzkräfte
...
\T[Europäisches Übereinkommen über die Beförderung
gefährlicher Güter auf der Straße]{Europäischen
Übereinkommen über die Beförderung gefährlicher Güter auf
der Straße} \citep{ADR2011} (\Lang{Abk.}
\T{ADR}\ZFootnote{Accord européen relatif au transport
...
{Gefahrenklassen und ausgewählte Symbole (Gefahrenzettel),
nach \citep{ADR2011}} {}
...
\Layout{2}{Gefahrnummer}
{\label{topic:gefahrnummer}
Die Gefahrnummr gibt Aufschluss über die zu erwartenden
...
\PictureSeriesRow{3}
{./images/noauth/gefahrgut-unfall.jpg}
{\TabHeading{{\color{ubuntured}G}efahr erkennen:} Die Suche
nach Warntafeln ist bei umgestürzten Fahrzeugen erschwert
}
{./images/noauth/gefahrgut-absperrung.png}
...
\Layout{2}{Absperrmaßnahmen durchführen}
...
{Bilderserie:
\SlideHeading{Misslungene Absperrung} \SourcePicture{Gabriel}}
\PictureSeriesRow{3}
...
\Layout{2}{Spezialkräfte anfordern}
{Bei Gefahrgut und -stoffen ist häufig Hilfe von
Spezialisten gefragt. In der Regel ist hier die Fuerwehr
