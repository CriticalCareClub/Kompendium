...
\\\addlinespace\hhline{---}\addlinespace
\noindent\T{Speiseröhre} (\T[Oesophagus@Ösophagus]{Ösophagus})
 &
 &
...
%
In der Wand des Ösophagus finden sich zahlreiche Venen.}%2 Text
{
\begin{itemize}
...
Das Ileum mündet in den Dickdarm. Diese Mündung
ist wie eine \E{T-Kreuzung} gebaut: 

\E{Zehenwärts} geht es in den \II{Blinddarm},
\E{Kopfwärts} in den 
...
\II[Dickdarm!aufsteigender Teil]{aufsteigenden Teil}, 
den \II[Dickdarm!querender Teil]{querenden} 
und den \II[Dickdarm!ábsteigenden Teil]{absteigenden Teil des Dickdarms}
...
%
Es folgt der 
\II[Dickdarm!s-förmig gebogener Teil]{S-förmig gebogene Teil}
\Z{(Sigmoideum)} 
und danach der \II{Mastdarm} (\II{Rektum}), 
welcher den Stuhl 
über den \II{Anus} nach außen entlässt.
...
\subsection{\HeadingKeyword{Harnableitendes System} (Harntrakt)}
...
leichter zu \E{Harnwegsinfektionen} kommen.}%2 Text
{
\begin{itemize}
...
\clearpage
\section{\HeadingKeyword{Geschlechtsorgane}}
...
\subsection{\HeadingKeyword{Männliche} Geschlechtsorgane}
...
\subsection{\HeadingKeyword{Weibliche} Geschlechtsorgane}
