...
% \begin{multicols}{2}
\begin{enumerate}
    \item \gEs{Patient auffordern den Kopf nicht zu bewegen.}
...
\begin{enumerate}
    ...
    Herstellerangabe. Wir empfehlen die Vewrwendung von mind. \gE{3} Gurte};
...
einem Anästhesiegerät. Was fehlt? %\gTakeNotesLarge
}
{Gabriel, cc-by}
...
\marginpar{\scriptsize\gH{Warum mach{\textquotesingle} ich mir wegen
der Verletzungsgefahr Sorgen? Ist ja nur ein kleiner
Schnitt, ist ja meine Sache {\dots}}

\gH{\color{ubuntured}Nein! Unter Normalbedingungen, wenn ich in aller Ruhe mein
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item \gEs{Durchflußregler (Radklemme) schließen}
