...
\end{savequote}
	...
	\chapter
[\CO{[PAM]} Patientenmanagement alt]
{\CC{[PAM]} Patientenmanagement alt}
\label{chp:PAMalt}
...
geachtet. Bei jedem Notfallpatienten soll -- wenn vorhanden -- ein
\EE{Pulsoxymeter} angeschlossen werden (Bei
nicht-Notfallpatienten, z.\,B. im Rahmen des
Krankentransports, kann die Pulsoxymetrie entfallen).
...
\begin{itemize}
  ...
  \item Rekap-Zeit 
  \item Radialispuls 
  \item Wenn Trauma od. Verdacht: Inspektion
  und Abtasten von
  \begin{inparaenum}
    \item \E{Bauch},
    \item \E{Becken} und
...
\ZFootnote{E: \Lang{engl.} \E{Environment}, \E{Exposure}.}
Ist die vitale Bedrohung noch nicht klar einzuschätzen, müssen \EE{gezielt
...
gebräuchlichen Begriff \enquote{ständige Verlaufskontrolle}.
Die Formulierungen \enquote{regelmäßig} und \enquote{in angemessenem Umfang}
...
Unter \FullPrettyRef{MK-m:standardmassnahmen-immer}, 
sind \EE{immer
...
\begin{itemize}
  ...
  \item[*] \EE{Sp\ce{O2}}
  \item Atemgeräusche
  \item Inspektion (und Abtasten) von \EE{Thorax},
  *Atemprobe
  \item \E{Zeichen der
...
{\tiny Mit einem * gekennzeichnete Punkte werden nur durchgeführt, wenn
...
\begin{itemize}
  ...
  (\prettyref{MK-m:standardmassnahmen-immer})
  \item \ldots
\end{itemize}
\end{minipage}
\\\addlinespace\midrule\addlinespace
...
\MassnahmenMK{Standardmaßnahmen}{Standardmaßnahmen bei vital bedrohten Patienten}{m:standardmassnahmen-vital}{
}{}
...
\begin{quote}
  ...
  Stiche in der Herzgegend, diese habe er aber nicht ernst genommen.
