...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item fühlen
    \end{itemize}
    \item Wenn Atmung vorhandenist, dann ist auch
    ein Kreislauf vorhanden.
\end{itemize}
}
...
Kreislaufstillstand grundsätzlich \gE{nach der Kontrolle der Vitalfunktionen}
schon der \gE{Notruf abgesetzt} und erst danach mit der \gE{lebensrettenden
Sofortmaßnahme} begonnen. }{
\begin{itemize}
    \item Nach der Kontrolle der Vitalfunktioen Notruf absetzen.
...
Die Herzdruckmassage bewirkt ein künstliches Fließgeschehen
(Circulation) des Blutes, mittels Kompression des Herzens
zwischen Wirbelsäule und Brustbein.

\gMarriedNG{Technik
}{
\gEs{Position und Druckpunkt} Der Patient sollte auf einem harten
    Untergrund liegen. Ggfs. soll der Pateint aus einem Bett o.ä. auf den Boden verbracht werden. Der Helfer kniet seitlich
    daneben und sucht sich den richtigen \gE{Druckpunkt} für die Herzdruckmassage. Dieser liegt in der \gEs{Mitte des Brustkorbes}.
...
\gEs{Arm- und Körperhaltung} Die richtige
    ...
    und nur der \gE{Handballen liegt am Brustein}. Die \gE{Arme bleiben gestreckt}
...
\gEs{Druckerzeugung} Die
    Druckerzeugung hat \gE{kräftig, aber nicht stoßartig} zu erfolgen. Die
    \gE{Eindrücktiefe} sollte \gE{\nicefrac{1}{3} des Brustkorbes} bertragen.
...
Die häufigste Art der Beatmung ist die \gT{Mund--zu--Mund--Beatmung}. Dabei wird bei überstreckten Kopf mit der stirnseitigen Hand die Nase des Patienten zu
...
muss der Mund wieder abgesetzt werden um selbst frische Luft einatmen zu
können. Bei Säuglingen und Kleinkindern wäre noch die
...
\gMassnahmen{
\paragraph{Erste-Hilfe-Maßnahmen: Schockbekämpfung}~
...
\gMassnahmen{
\paragraph{Erste-Hilfe-Maßnahmen bei Bagatellverletzungen}~
...
\gMassnahmen{
\paragraph{Erste-Hilfe-Maßnahmen bei Verbrennungen}~
...
\gMassnahmen{
\paragraph{Erste-Hilfe-Maßnahmen bei Erfrierungen}~
...
\gMassnahmen{
\paragraph{Erste-Hilfe-Maßnahmen bei Unterkühlung}~
...
\gMassnahmen{
\paragraph{Erste-Hilfe-Maßnahmen bei Verstauchung}~
...
% \end{table}
% 
% \gMassnahmen{\paragraph{Erste-Hilfe-Maßnahmen}
% 
% {
