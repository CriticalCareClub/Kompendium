...
\begin{itemize}
    \item \gEs{Lokalisation}: \emph{"`Wo sind die Schmerzen?}
    ...
    \item \gEs{Stärke}: \emph{"`Wie stark ist der Schmerz? (In
    einigen Lehrbüchern wird empfohlen, den Schmerz anhand
