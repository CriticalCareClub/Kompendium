...
Nasenbluten (\gT{Epistaxis}\index{Epistaxis}) ist häufig
ein Hinweis auf einen hypertensiven Notfall.
...
unteren Atemwege
 ...
 \includegraphics[width=\linewidth]{./images/pharynx-schema.png}
 \gCaptionof{figure}{\gAuthNotesPicLegalNotOk{pharynx-schema}{}Atemwegsverlegung (Schema). } }
...
% TODO DONE INHALT: Hyperventilationstetanie: völlig überarbeitn
...
die Hyperventilation nicht rechtzeitig beendet kann es zur Eintrübung bis hin
...
\begin{itemize}
  ...
  \begin{itemize}
      \item Psych. Belastngsreaktion, Panikattacke
      \item Vernastaltungen
%   \item Lungenembolie
...
\gMarriedNG{Differntialdiagnosen}
{
...
\gMassnahmen{
\paragraph{Spezielle Maßnahmen: Hyperventilationstetanie}
...
\begin{itemize}
  ...
  Dosierung (1\gLMin{})} zu verabreichen.
...
\begin{description}
    ...
    \item 
    Sonderform \index{TIA}TIA:
    \index{Transitorisch-Ischämische Attacke}Transitorisch-Ischämische Attacke
...
% TODO INHALT: Meningitis Maßnahmen

\subsection{Vom Gehirn ausgehende Krämpfe --- Zerebrale Krampfanfälle}
\label{topic:zerebrale-krampfanfaelle}\label{topic:krampfanfall}
...
% XXX INHALT-NEU: Hyperglykämie, Text und Überarbeitung,
% POI 11
...
(\ce{CO2} - Abatmung durch Hyperventilation\index{Hyperventilation!bei
Hyperglykämie})
...
\gMarriedNG{Der Bauch -- unendliche Weiten}
{
...
% TODO DONE INHALT Ileus Maßnahmen

\gMassnahmen{
\paragraph{Spezielle Maßnahmen: Darmverschluß}~
...
\begin{itemize}
    \item Abflussstau der Gallenwege → Rückstau
    \item Gallenblase kontrahiert gegen Widerstand (Stein)
\end{itemize}
\gSlideHeading{Symptome}
...
(\gSee{topic:hepatitis-virale} besprochen.
...
\end{wrapfigure}Befindet sich die Mutter noch in der Eröffnungsphase wird ein schnellstmöglicher,
...
% FIXME Fremdkörperaspiration: Erwachsen -- Kind
...
Dabei handelt es sich um eine Entzündung des Kehlkopfes. Es können auch die
oberen Atemwege durch das Anschwellen der Schleimhäute behindert sein
(Pseudokrupp/Kruppsyndrom). Diese Infektion wird durch Viren verursacht.
...
Dabei handelt es sich um eine bakterielle Entzündung und daraus  folgende
Schwellung des Kehldeckels. Sie kommt eher selten vor, kann aber eventuell
lebensbedrohlich werden. Die Epiglottitis ist eine schwere Erkrankung, mit
...
\begin{itemize}
	...
	\opt{ORGASBFLO}{\item \ASBFLO{} Meldung an Gesamteinsatzleiter.} 
\end{itemize}
...
\begin{wrapfigure}{r}{3cm}
\marginnote{\gCaptionof{figure}{Sie kommen in eine Wohung und finden diese
Situation vor \ldots Was machen Sie? \gSourcePicture{Gabriel}}}\includegraphics[width=\linewidth]{./images/shared/mann_mit_pistole.jpg}
 \end{wrapfigure}Die
\index{Unterbringung}Unterbringung wird durch das \index{Unterbringungsgesetz}Unterbringungsgesetz geregelt. Auszug:
...
\subsubsection{Allgemeine Maßnahmen bei
Reizgasvergiftungen}
\label{reizgase-allgemeine-massnahmen}
