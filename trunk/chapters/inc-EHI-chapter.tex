...
\emph{Maintainer: Roman Koch, Co-Maintainer: Christof Koller}
...
Retten von Personen aus Gefahrenzonen, sowie das Absetzen des Notrufs durch
...
Versorgung von einfacheren Verletzungen und die psychologische Betreuung des
Patienten. Der eintreffende Rettungsdienst übernimmt den Patienten für die \gEs{Sanitätshilfe} und führt den
...
Vor dem Setzen irgendwelcher Maßnahmen sollte der Ersthelfer tief
...
\begin{itemize}
    ...
    \item \gE{Freilandstraße}: ca. 150\,m
...
Gewicht des Zuges, ca. 600-800\,m). Das \gEs{Haltesignal} für den Lokführer ist
eine \gEs{kreisende Armbewegung}. Dadurch wird er gewarnt und leitet 
...
\gE{Einbruch druch Eis} hat sich der Ersthelfer flach am
...
\gFazit{Der Helm ist immer abzunehmen, außer der Patient
verweigert dies!}
...
\\
% Schritt 4 
Helm abziehen. \gACh{GABS}{2010-02-19}{Helm kippen bis
...
&
% Schritt 6
Kopf halten, HWS-Schiene anlegen.
...
\\
Schritt 4 
\gACh{Instruktor 1}{0.8.0}{Weg lassen. }\gACh{GABS}{2010-02-19}{Helm kippen bis
Nasenspitze sichtbar?} &
% Schritt 5 
Kopf stabilisieren, Helm abziehen.
&
...
eine \gEs{ausreichende Atmung} und daher einen \gEs{vorhandenen Kreislauf}. 
...
der Großteil des Erbrochenen in der stabielen Seitenlage allein aus dem Mund-
...
Vitalfunktionen} der \gE{Notruf abgesetzt} und erst danach mit der \gE{lebensrettenden
...
harten Untergrund liegen. Ggfs. ist der Patient aus einem Bett
    ...
    auf. Dieser liegt in der \gEs{Mitte des Brustkorbs}.
...
\gEs{Arm- und Körperhaltung} Die richtige
    ...
    sollten verschränkt sein}, nur der \gE{Handballen liegt am Brustbein auf}.
    Die \gE{Arme bleiben gestreckt}, und die \gE{Schultern liegen genau über
...
\gEs{Druckentlastung} Der Brustkorb muss sich wieder ganz
    ausdehnen können. Es darf daher \gE{kein Restdruck} bestehen. Die Druck-
...
\begin{itemize}
    \item Druckpunkt: \gE{Mitte} des Brustkorbs
...
Bruch des Brustbeins durch einen zu festen Druck, Lungen- oder Herzquetschung
durch Abweichung des Druckpunkts, Rippenbrüche durch Abweichen des
Druckpunkts oder nicht senkrecht ausgeführten Druck, Organquestschung bzw.
...
\gEs{ungenügenden Zirkulation} des Blutkreislaufs. 

\gCave{Wird einmal falsch Druck ausgeübt, oder eine Rippe gebrochen, nicht 
...
\gT{Mund--zu--Mund--Beatmung}. Dabei wird bei überstrecktem Kopf mit der stirnseitigen Hand die Nase des Patienten zugedrückt. Anschließend mit dem eigenen Mund den des Patienten umschließen und
...
Atemzugsvolumen} in ml entspricht dem 10-fachen des Körpergewichts, d.h. ein
...
&
% Schritt 7
Wenn vorhanden: Defibrillation.\gACh{Instruktor 1}{0.8.0}{Weg lassen.
}\gACh{GABS}{2010-02-19}{Wieso? Hinweis auf AED wär doch sinnvoll.} 
&
\\\addlinespace\bottomrule
\end{tabularx}
...
aufbrauchen, und daher fortführen können, ist es  ihm erlaubt diese
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Atemkontrolle
        \item stabil Seitenlage
        \item Wärmeerhalt sichern durch zudecken
        \item laufende Kontrolle der Atmung alle 30 Sek.
        \item Frischluftzufuhr durch Öffen von Fenstern in geschlossenen Räumen
        \item psychische Betreuung
    \end{itemize}
...
Mit einem \gEs{direkten Druck in die stark blutende Wunde} mittels Finger,
Handballen oder Faust - je nach größe der Verletzung - mit einer Wundauflage 
kann diese gestoppt werden. Ein \gEs{Hochhalten der verletzten Extremität} verstärkt
...
den Transport gilt es \gEs{kühl und trocken} zu \gEs{lagern}. Dazu eignen
sich idealerweise Kühlakkus für Kühltaschen falls vorhanden. Wichtig ist aber,
dass Amputat darf nicht direkt mit Eis oder dem Kühlakku in Berührung kommen, da es
...
wichtigen Körperregionen fließen. Der dadurch entstehende Sauerstoffmangel
bei den lebenswichtigen Organen führt zu einer \gEs{Schädigung der Organe}, die
in weiterer Folge zum \gEs{Versagen der Organe} führt. Der Schock
...
\gEs{kalten, klebrigen Schweiß} auf der Stirn hat. Der Patient kann außerdem \gEs{verwirrt, unruhig
...
notwendig die Anzahl der Patienten bekannt zu geben. Dementsprechend viele
...
werden, besteht die Möglichkeit zurückzurufen und nochmals nachzufragen.
...
Behandlung von allgemeinmedizinischen "`Ordinationsfällen"'. Außerdem hat er durchschnittliche
...
&
besonders mit gleichzeitiger Bewegungseinschrenkung
\\\addlinespace
...
&
trotz Schamgefühl wegen Infektionsgefahr durch Ausscheidungsorgane
\\\addlinespace\bottomrule
\end{tabulary}
}
...
Schweregrad der Schädigung der Haut eingeteilt werden. Dies geschieht mittels drei Grade. Beim \gEs{1.~Grad} kommt es zur Rötung der Haut, einer
...
Dazu gibt es zwei Möglichkeiten. Einerseits die \gEs{Handregel}, welche
...
\gDefinition{Durchblutungsstörungen mit Gewebstod an den Körperenden}
...
Am Beginn wird der Patient \gEs{Schmerzen} haben und einen Anstieg der
...
\begin{itemize}
    ...
    \item Warme Getränke wenn Pateint bewusstseinsklar ist.
    \item Keinesfalls bewegen oder frottieren: \gCa{Bergungstod!}
\end{itemize}
}
...
kann sich auch ein \gEs{Bluterguss} bilden.
}{
\begin{itemize}
    \item Schmerzen
    \item Schwellung
...
Der Patient hat starke \gEs{Schmerzen} im Bereich des betroffenen Gelenks und
die betroffene Extremität kann nicht mehr bewegt werden
(\gEs{Bewegungsunfähigkeit}). Außerdem kommt es zu einer \gEs{abnormen
...
Gewalteinwirkung von außen auf dem Knochen die Haut über der Bruchstelle verletzt ist. Es muss
...
Beweglichkeit} und die \gEs{Krepitation} (das hörbare und fühlbare Aneinanderreiben der Knochen). \gT{Unsichere Kennzeichen} sind \gEs{Schmerzen},
...
gerät. Bei einem offenen Knochenbruch besteht außerdem die Gefahr einer \gEs{Wundinfektion}. Bei Rippenbrüchen kann
...
\begin{itemize}
    ...
    \item Auge mit keimfreiem Wundverband bedecken; zum Ruhigstellen \gE{beide}
    Augen bedecken.
