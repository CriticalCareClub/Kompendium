...
\marginlabel{Kreuzinfektion}
\index{Kreuzinfektion}
\gDefinition{Verschleppung von Erregern von einem Patienten
...
\subsubsection{Viren}\marginnote{Viren}
\index{Viren}

\marginlabel{Viren}Viren sind sehr klein \gZ{und im
...
\paragraph{Stämme} Grippeviren kommen in verschiednen
...
klingende Namen wie "`\gCode{A(H5N3)}"' oder "`\gCode{A(H1N1)}"' zu Stande. Je nach Unterart verhalten
sich die Viren anders und man beobachtet Unterschiede hinsichtlich der
Ansteckungsgefahr, Schwere der Erkrankung usw. 
\gZ{}

\paragraph{Schutzimpfung}Gegen die Grippe wird eine
...
\paragraph{Schweinegrippe, Vogelgrippe -- Warum die große
Aufregung?}~
...
\paragraph{Symptome}Es kommt zu tonischen \gEs{Krämpfen der
...
\paragraph{Schutzimpfung} \index{Impfschutz} 
Es existiert
...
\gTagNo{HIV}Das HIV befällt vor allem die Zellen des
...
\paragraph{Resistenzen} \gMargin{Resistenzen}Bakterien entwickeln Resistenzen
...
\end{center}
\gCaptionof{figure}{Hygienische Händedesinfektion.
...
\end{enumerate}
\end{multicols}
\gEs{Einwirkzeit beachten!} (lt. Herstellervorgaben, i.d.R.
mind. 30 Sekunden) 
...
\marginlabel{\gZ{Basierend auf: Gemeinsame Erklärung der
