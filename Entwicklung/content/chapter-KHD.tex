...
{Einführung in den Gro{\ss}schadens- und Katastrophenhilfsdienst}
\label{chp:KHD}
...
{}%2
{\label{tab:uebersicht-unfall-grossunfall-katastrophe}}%3
{}%4
{}%5
{%
\small
...
\DefinitionInPara{Unter \T{Individualmedizin} versteht man die bedarfsgerechte, 
maximale und bestmögliche Versorgung jedes
Patienten, die vorhandenen Ressourcen werden für den Einzelnen ausgeschöpft.}
...
\DefinitionInPara{Unter \T{Katastrophenmedizin} versteht man die 
\EE{Massenversorgung} von Verletzten und Erkrankten
mit \EE{beschränkten Mitteln} und dem Zwang zur \EE{Einteilung nach
Dringlichkeit} und \EE{Durchführbarkeit} der Behandlung.}
...
Umständen so viele Leben wie möglich zu retten, 
\EE{mit
...
\E{Einteilung} der Patienten gemäß der \E{Dringlichkeit} 
und \E{Durchführbarkeit} ihrer Behandlung
oder ihres Transportes.
Diese Einteilung nennt man Triage (\FullPrettyRef{topic:triage}).
}{%
\begin{itemize}
  \item {Massenversorgung} 
  mit {beschränkten Mitteln}
  \item Einteilung nach Dringlichkeit und Durchführbarkeit
  \item Auf maximale Versorgung Einzelner wird
  bewusst verzichtet
\end{itemize}
}{}{}{}
...
\begin{Synopsis}
  \SynopsisItem{Im Rahmen der Katastrophenmedizin versucht man, 
  bei beschränkten Mitteln das Beste für Viele herauszuholen.}
\end{Synopsis}
...
\TextSlide{Sanitäter und Notärzte müssen Führungsaufgaben übernehmen}
{%
Der erste am Schadensort eintreffende Sanitäter muss:

\begin{enumerate}
    \item \EE{Lagemeldung} abgeben
    \item Erste, vorläufige \EE{Grundstrukturen einer SanHiSt}
    aufbauen (provisorischer Einsatzleiter,
    festlegen von Sammelstellen, Wagenhalteplatz, etc.)
    \item Mit bereits anwesenden Einsatzkräften die \EE{ersten
...
\begin{itemize}
  \item Lagemeldung
  \item Grundstrukturen SanHiSt
  \item Erste Maßnahmen festlegen
\end{itemize}
}
...
\section{Katastrophenschutz und -hilfe}



\subsection{Katastrophenschutz in Österreich}


\TextSlide{Katastrophenhilfegesetze regeln die Zuständigkeiten}
{%
\label{topic:katastrophenhilfsgesetze}%
Die Organisation der Katastrophenhilfe fällt in den Aufgabenbereich der 
Bundesländer bzw. der Gemeinden.
Dementsprechend verfügt jedes Bundesland über ein inhaltlich abweichendes 
Rettungsdienst- und \EE{Katastrophenschutzgesetz}, welches die Aufgaben der 
Behörden 
und
...
Behördliche \EE{Alarmpläne} dienen zur Festlegung
...
{%
\begin{itemize}
  \item Katastrophenschutzgesetze der Bundesländer
  \item Katastrophe wird von Behörde erklärt
  \item Alarmpläne
  \item Zuständigkeiten: 
  \begin{compactitem}
    \item \E{Gemeinde}      ${\rightarrow}$    Bürgermeister
    \item \E{Bezirk}      ${\rightarrow}$    Bezirkshauptmann
    \item \E{Bundesland}     ${\rightarrow}$    Landeshauptmann
    \item \E{Bundesgebiet}     ${\rightarrow}$    Innenminister%, Bundeskanzler 
  \end{compactitem}
\end{itemize}}


\Text{Die Katastrophenwarnung mittels Sirene alarmiert die
Bevölkerung}
{%
...
Österreich \cite{wiki:zivilschutzsignale20120810}
\label{fig:zvivilschutz-sirenensignale-at}}
...
\TextSlide{{\TxBeschreibung}: Katastrophenhilfe}
{%
Unter Katastrophenhilfe versteht man die medizinische und sanitätsdienstliche,
pflegerische, 
soziale und 
technische 
Hilfeleistung im Rahmen von Katastrophen, 
sowohl im In-, als auch im Ausland. 
%
Je nach Art, Umfang und Ort der Katastrophen können die notwendigen Maßnahmen 
sehr unterschiedlich sein.
%
Typische Tätigkeiten der Katastrophenhilfe umfassen:
\begin{itemize}
  \item \StepHeading{Medizinischer- und Sanitätseinsatz}:
  Suchmaßnahmen, 
  Retten/Bergen, 
  \E{Katastrophenmedizin} (Triage),
  Lebensrettende Sofortmaßnahmen,
  Sanitätshilfe,
  Erstversorgung,
  \E{Abtransport} bzw. Evakuierung von Erkrankten oder Verletzten,
  evtl. abschließende medizinische Behandlung, 
  evtl. Einrichtung einer dauerhaften medizinischen Infrastruktur und 
  Behandlungsmöglichkeit.
  \item \StepHeading{Pflegeeinsatz}:
  Wenn die pflegerische Versorgung durch die bestehenden
  Einrichtungen nicht mehr sichergestellt ist 
  müssen vorhandenen \E{Behandlungs- und Pflegemöglichkeiten} erweitert, 
  bzw. Ersatzeinrichtugnen errichtet werden. 
  \item \StepHeading{Sozialeinsatz}
  Wenn Menschen infolge einer Katastrophe ihre 
  Selbstversorgungsmöglichkeit verloren haben
  müssen sie mit \E{lebensnotwendigen Gegenständen und Dienstleistungen} 
  versorgt 
  werden:
  Einrichtung bzw. Betrieb von \E{Notunterkünften} oder Lagern,
  Beschaffung, Zubereitung und Ausgabe von \E{Lebensmitteln}, 
  Kleidern
  und Gebrauchsgegenständen, 
  \E{psychologische Betreuung} und Krisenintervention,
  fürsorgliche Hilfe, Registrierung und Betreuung.
  \item \StepHeading{Technischer Einsatz}: 
  Schaffung einer überlebenswichtigen \E{Infrastruktur} (Strom, Wärme, Licht, 
  Wasseraufbereitung, Zufahrtswege, \ldots)
  und ggfs. technische Such-, Rettungs- und Bergemaßnahmen.
\end{itemize}
}
{%
\begin{itemize}
  \item {Medizinischer- und Sanitätseinsatz}
  \item {Pflegeeinsatz}
  \item {Sozialeinsatz}
  \item {Technischer Einsatz} 
\end{itemize}
}
...
den vorhandenen Resourcen soviel als möglich zu erreichen\ZFootnote{Triage
\Lang{franz.}: Sichtung, Auswahl.}.}
Anhand der Triage können Prioritäten bei der Behandlung von 
Patienten gesetzt werden.
Zur Anwendung kommt eine Einteilung in vier Gruppen 
(\Range{\textbf{I}}{\textbf{IV}}), die Tabelle
\FullPrettyRef{tab:khd-behandlungsstellen-uebersicht}, gibt eine
Übersicht über diese Triagegruppen.
}
...
{}%2
{\label{tab:khd-behandlungsstellen-uebersicht}\label{tab:khd-triagegruppen-uebersicht}}%3
{}%4
{}%5
{%
...
\cite{RkPlsNeu2008}
%\url{http://www.roteskreuz.at/nocache/organisieren/organisation/wer-wir-sind/rechtliche-grundlagen/vorschriften/grossunfall/do/download/uid/2815/}
}
\end{Parallel}
}%6
...
{Bergetriage}%1 Titel
{%
Die Bergetriage nimmt die \EE{Festlegung der Bergepriorität} vor,
...
\EE{Patientenleitsystems} (PLS).

Die Bergetriage wird nur gebildet wenn \EE{keine
Gefahrenzone} und genügend Personal vorhanden ist.
Das Team muss mind. aus einem NFS und einem NA bestehen. 
Die Bergetriage \EE{behandelt nicht} und betreibt keine
...
\begin{itemize}
  ...
  \begin{enumerate} 
    ...
    \item Verstorben
  \end{enumerate} 
  \item Kennzeichnung mit PLS
  \item Mind. NA + NFS
  \item Nicht in Gefahrenzone
...
{%
Aufgabe der Triagestelle ist die Zuordnung der Patienten zu den 
\EE{Triagegruppen}
(\begin{inparadesc}
...
\EE{zentrale Registrierung} aller Betroffenen mittels
Patientenleitsystem (PLS).

Die Triage erfolgt schnell, mit geringem Aufwand und unter
\EE{hohem Zeitdruck}. Der maximale Zeitaufwand pro Patient
beträgt bei gehenden Patienten \E{1 Minute} und bei liegenden
Patienten \E{3 Minuten}. Es erfolgt \EE{keine detaillierte}
...
\EE{protokolliert} werden, welcher Patient mit welchem
...
Es gibt eine definierte \EE{Ein- und Ausfahrt}, eine
Einbahnregelung ist 
anzustreben! }%2 Text
{%
\begin{itemize}
...
Fahrzeuge aufnehmen zu können. Wenn möglich gilt eine
\EE{Schrägparkordnung} mit einer freien Front der Fahrzeuge um ein 
ungehindertes Wegfahren zu ermöglichen.
Die Witterung und die Beschaffenheit des Untergrunds ist zu
beachten.
Die Fahrzeuge sollen nach Einsatzmittelkategorien
(\Abk{NAW}, \Abk{RTW}, \ldots) \EE{sortiert} abgestellt werden.
Die \EE{Schlüssel} müssen stecken gelassen werden!}%2 Text
{
\begin{itemize}
    \item Frühzeitig, Abstand von SanHiSt
    \item Groß genug; Bodenbeschaffenheit und Witterung bedenken!
    \item Schrägparkordnung, freie Front zum Wegfahren
...
\EE{25\,$\times$\,25\Meter*}. 
%
Die \EE{Umgebung} muss sicher sein, 
d.\,h. es dürfen keine
Oberleitungen, lose Gegenstände o.\,ä. den 
Anflug stören, 
der Untergrund muss tragfähig 
und darf nicht leicht verwehbar sein (Sand!).
%
...
{%
 Hier erfolgt die Sammlung und Lagerung verstorbener Personen
 (PLT-Zusatzkarte {\fcolorbox{Black}{White}{\sffamily\bfseries\color{Black}VERSTORBEN}}, s.\,u.). 
 %
 Sie soll möglichst diskret eingerichtet 
 und vom Behandlungsraum, der Sammelstelle Unverletzte und der
 Außenwelt abgeschirmt werden.  
 Die Leichen werden abgedeckt (Leichensäcke, Leintücher, Aludecken, \ldots), 
 für einen ausreichenden Sichtschutz ist zu sorgen.}%2 Text
{\SymbolText}%3 Slide
...
{%
\index{Einsatzleiter Rettungsdienst}%
\index{Rettungsdienst!Einsatzleiter}%
...
{Einsatzleiter Rettungsdienst}%5 Bildtitel
{}%6 Bildbeschreibung
{}%7 Quelle
{}%8 Lizenz
% Vormals \Layout{60}
...
\TextSlideTeaser
{Leitender Notarzt}%1 Titel
{%
\index{Leitender Notarzt}%
\index{Notarzt!Leitender}%
Die Funktion des \T[Leitender Notarzt]{leitenden Notarztes} 
(\T{LNA}) 
ist grundsätzlich im Ärztegesetz 
geregelt, 
...
der \EE{medizinische Leitung} von Sanitätshilfsstellen,
sowie der Beurteilung des Nachschubbedarfs
und der ärztlichen \EE{Beratung der Einsatzleitung} 
geschult.
%
Er ist gegenüber den am Einsatz beteiligten Ärzten und 
Sanitätspersonen weisungsbefugt 
und somit der direkte \EE{Vorgesetzte} aller am Einsatz beteiligten \EE{Ärzte}
\cite{RkRahmenvorschriftGrossunfaelle2007}.
}%2 Text
{%
\begin{itemize}
  \item Medizinische Leitung
  \item Medizinische Beratung der Einsatzleitung
  \item Vorgesetzter der Ärzte
\end{itemize}}%3 Slide
{./images/khd/KHD-Symbole-RK/pdf/LNA}%4 Bilddatei
{Leitender Notarzt}%5 Bildtitel
{}%6 Bildbeschreibung
{}%7 Quelle
{}%8 Lizenz
% Vormals \Layout{60}
...
{%
\index{Leiter SanHist}%
\index{SanHist!Leiter}%
Der Leiter SanHiSt organisiert und führt in Absprache mit dem leitenden 
Notarzt die Sanitätshilfsstelle, indem er insbesondere 
\begin{inparaitem}
  \item die \EE{Räume und Stellen} festlegt,
  \item das ihm zur Verfügung stehende\EE{Personal} einteilt,
  \item die \EE{Leiter} bezeichnet,
  \item das notwendige \EE{Material} anfordert,
  \item die \EE{Verbindung zur Einsatzleitung} hält
  \item und eine eventuell notwendige die \EE{Ablösung} anfordert.
\end{inparaitem}
Ihm sind sämtliche Leiter der SanHist-Stellen und Plätze unterstellt, 
ausgenommen der Einsatzleiter RD und der leitende Notarzt (LNA).
\cite{RkRahmenvorschriftGrossunfaelle2007}
}%2 Text
{
\begin{itemize}
...
{%
\index{Leiter Material-/Meldestelle}%
\index{Material-/Meldestelle!Leiter}%
Er hält engen \EE{Kontakt} mit Leiter SanHiSt und 
führt Evidenz über eingetroffene \EE{Personen} und \EE{Material}. 
\cite{RkRahmenvorschriftGrossunfaelle2007}
...
{./images/khd/KHD-Symbole-RK/pdf/M}%4 Bilddatei
{Leiter Material-/Meldestelle}%5 Bildtitel
{}%6 Bildbeschreibung
{}%7 Quelle
{}%8 Lizenz
% Vormals \Layout{60}
...
{%
%
\index{Behandlungsraum!Leiter}%
Der \T{Leiter Behandlungsraum} betreibt und führt den Behandlungsraum,
insbesonders 
...
{Leiter Behandlungsraum}%5 Bildtitel
{}%6 Bildbeschreibung
{}%7 Quelle
{}%8 Lizenz
% Vormals \Layout{60}
...
{%
%
\index{Transportraum!Leiter}%
Der \T{Leiter Transportraum} \EE{gliedert} seinen Raum, 
...
%
Er organsisiert den \EE{Abtransport} von Patienten entsprechend der diesen 
zugewiesenen
...
%
Er führt ein \EE{Transportprotokoll} 
...
{Leiter Transportraum}%5 Bildtitel
{}%6 Bildbeschreibung
{}%7 Quelle
{}%8 Lizenz
% Vormals \Layout{60}
...
{%
\index{Leiter Triageraum}%
\index{Triageraum!Leiter}%
Dieser muss ein \EE{Arzt} sein.
...
%
Er \EE{triagiert} soweit möglich selbst auf einer Triagestelle.
...
{%
\index{Leiter Information}%
\index{Information!Leiter}%
\index{Informationsstelle}%
Die Informationsstelle hat die Aufgabe, 
Behördenvertreter,
Pressevertreter
und sonstige Betroffene (Angehörige, Unverletzte, etc.)
mit notwendigen \EE{Informationen} zu versorgen und zu betreuen. 
...
{Informationsstelle}%5 Bildtitel
{}%6 Bildbeschreibung
{}%7 Quelle
{}%8 Lizenz
% Vormals \Layout{60}
...
\clearpage 
\section{Das \HeadingKeyword{Patientenleitsystem} sorgt mit der 
Patientenleittasche für eine eindeutige Registrierung}
\label{topic:pls}

\TextSlide{Patientenleitsystem}
{%
Das \index{Patientenleitsystem}\T{Patientenleitsystem}
(\index{PLS}\T{PLS}) ermöglicht eine \EE{eindeutige
Kennzeichnung} und Registrierung von Patienten 
sowie die  Zuordnung von Behandlungsmaßnahmen und Befunden. 
Der wichtigste
Bestandteil ist die
\index{Patientenleittasche}\I{Patientenleittasche}
(\index{PLT}\I{PLT}).}
{%
\begin{itemize}
...
\TextSlide{Patientenleittasche}
{%
Die wichtigste Aufgabe der Patientenleittasche (PLT) ist die \EE{eindeutige 
Kennzeichnung und Registrierung} der Patienten.
%
Durch die Bergetriage oder 
\EE{spätestens an der Triagestelle} bekommt jeder
Betroffene eine  \T{Patientenleittasche} (\index{PLT}\T{PLT}). 
%
Auch Unverletzte und
Verstorbene werden mittels \Abk{PLT} registriert.
%
Die Patientenleittasche verbleibt solange am Patienten,
\E{bis das Aufnahmeverfahren im Krankenhaus abgeschlossen
ist}, 
d.\,h. bis der Patient im Spital administrativ erfasst
ist.
% 
Anschließend wird die \Abk{PLT} der Krankengeschichte
des Patienten beigefügt.
%
Die \T{Patientenleittasche} (\index{PLT}\T{PLT})
besteht aus:

\begin{enumerate}
  \item \StepHeading{Hülle}: 
  Sie dient einerseits dem Schutz der anderen Inhalte, 
  andererseits können auf ihr wichtige Informationen wie z.\,B. die 
  Triagegruppe vermerkt werden.
  \item \StepHeading{Eindeutige Nummer}:
  Die \Abk{PLT} und damit der Patient ist durch eine
  \EE{eindeutige, einmalige Nummer} \EE{gekennzeichnet}.
  \item \StepHeading{Klebeetiketten} mit PLT-Nummer: 
  Mittels \EE{Selbstklebeetiketten} können die Nummern der
  Patienten in verschiedenen Listen schnell erfasst werden.
  Das ist in vielen Bereichen besonders wichtig 
  (Triage,
  Behandlung, 
  Transport). 
  Außerdem können alle Effekte des
  Patienten damit gekennzeichnet werden.
  \item \StepHeading{Protokolle}: 
  Sie werden im Behandlungsraum ausgefüllt wenn
  Zeit dafür ist. 
  Das Ausfüllen der Protokolle darf den
  Abtransport unter keinen Umständen verzögern. 
  Die Protokolle
  können auch leer bleiben.
  \begin{enumerate}
    \item \StepHeading{Behandlungsprotokoll} (blau),
    \item \StepHeading{Identifikationsprotokoll} (rosa) 
  \end{enumerate}
  \item \StepHeading{Zusatzkarten}: 
  Bei einer eventuellen Bergetriage bekommt jeder Patient eine
  Patientenleittasche (\Abk{PLT}). 
  Patienten, welche
  \E{als Erste aus dem Schadensbereich gerettet} werden sollen, 
  werden zusätzlich mit der gelben 
  {\fcolorbox{Black}{Yellow}{\sffamily\bfseries\color{Black}DRINGEND}}\,-Karte 
  gekennzeichnet. 
  Die Karte wird auf der
  Triagestelle wieder entfernt. 
  Tote erhalten zusätzlich zur
  \Abk{PLT} eine schwarze
  {\fcolorbox{Black}{White}{\sffamily\bfseries\color{Black}VERSTORBEN}}\,-Karte.
  \item \StepHeading{Kontaminationsaufkleber}: 
  ...
  schwarzem Rand auf die \Abk{PLT} geklebt. 
  Dies soll alle
  nachfolgenden Personen, welche mit dem Patienten in Kontakt
  treten, warnen. 
  Die Aufkleber sind auf \EE{beiden Seiten}
  der \Abk{PLT} anzubringen!
  \item \StepHeading{Zwei Abschnitte} zur Rückverfolgung (für Leiter Transport 
  und Krankenhaus)
  \begin{enumerate}
    \item \StepHeading{Abriss für die SanHiSt}
    Dieser verbleibt in der SanHiSt beim Leiter Transport, sodass nachvollzogen 
    werden 
    kann, welche Patienten bereits abtransportiert wurden. Auf dem Abschnitt 
    wird die Verladezeit, die KFZ-Nummer, das Zielspital und die Zielabteilung 
    angegeben.
    \item \StepHeading{Abriss für das Zielspital}: 
    Dieser wird im Zielspital 
  ...
  \end{enumerate}
  \item \StepHeading{Befestigung}: 
  Die PLT ist mit einer Gummischnur versehen 
  damit sie dem Patienten umgehängt werden kann.
\end{enumerate}
...
\begin{itemize}
  \item Ziel: Eindeutige Kennzeichnung und Registrierung
  \item {Spätestens an der Triagestelle}
  \item Auch für Unverletzte und Verstorbene 
  \item Verbleibt beim Patienten, 
  bis dieser im Spital administrativ erfasst 
  wurde, 
  dann zur Krankengeschichte
  \item Bestandteile:
  \begin{itemize}
      \item Hülle: Schutz, Kennzeichnung, Notizen
      \item Eindeutige Nummer: Auf PLT und auf Klebeetiketten
      \item Bogen mit gleichlautend {nummerierten Klebeetiketten}
      \item {Behandlungsprotokoll} (blau),
      \item {Identifikationsprotokoll} (rosa) 
      \item {Zusatzkarte}  
      {\fcolorbox{Black}{Yellow}{\sffamily\bfseries\color{Black}DRINGEND}} 
      \dotfill bevorrangte Rettung aus Schadenszone
      \item {Zusatzkarte} 
      {\fcolorbox{Black}{White}{\sffamily\bfseries\color{Black}VERSTORBEN}} 
      \dotfill Verstorbene
      \item {Kontaminationsaufkleber}
      \item {Zwei Abschnitte} zur Rückverfolgung 
      \begin{enumerate}
...
\end{description}}%2 Text


\subsection{Sonderfall: Großambulanzdienste}

\Text
{Großambulanzdienste}%1 Überschrift
{%
...
jeweiligen Fall zur Anwendung kommen.}%2 Text
...
\begin{Literary}
\begin{description}
  \item[\cite{RkRahmenvorschriftGrossunfaelle2007}] \fullcite{RkRahmenvorschriftGrossunfaelle2007}
  \item[\cite{RkPlsNeu2008}] \fullcite{RkPlsNeu2008}
\end{description}
\end{Literary}
