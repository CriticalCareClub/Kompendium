...
\gTODO{GABS}{2010-04-27}{Bilder Blutdruckmesser}{Verscheidene Typen}
\end{center}
 }
...
\gFazit{Der diastolische Wert kann nur
bei der auskultatorischen Methode ermittelt werden!} 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TODO : Neuerstellung
\gTODO{KOCH}{yyyy-mm-dd}{RR, Bild von Arm mit eingez. Arterie: Neuerstellung von
Foto notwendig}{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


\gLayout{0}{\gT{Auskultatorische Methode} -- Vorgehen}
{
...
\gTODO{GABS}{2010-04-27}{Grafik RR-Geräusche vorbereiten}{Grafik gibt es schon
von HIRT}
...
\gLayout{0}{\gT{Palpatorische Methode} -- Durchführung}
{
...
\gEs{Der diastolische Wert kann mit
...
\begin{itemize}
  ...
  \item Der \gE{diastolische} Wert kann \gE{nicht} ermittelt werden!
\end{itemize}
}{}{}{}



\gLayout{28}{Was ist besonders zu beachten?}
{
Die Blutdruckmanschette soll nach Möglichkeit \gEs{\gE{nicht} auf der Seite
\ldots}
\begin{inparaenum}
	\item \ldots\ eines \gEs{Shuntarmes}\footnote{Ein (Dialyse-)\gEs{Shunt} ist ein
...
\begin{itemize}
  \item \gEs{Nicht} auf Seite eines/r \dots{}
  \begin{enumerate}
    \item \gEs{Shuntarmes}
    \item Armödems
