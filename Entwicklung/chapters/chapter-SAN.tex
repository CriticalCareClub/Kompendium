\begin{savequote}
\includegraphics[width=5cm]{./images/nasa-pd/2333main_MM_Image_Feature_19_rs4.jpg}
...
Wenn \Es{Absaugbereitschaft} hergestellt werden muss, wird
aus hygienischen Gründen nur der farbige Trichter des
Katheters ausgepackt und an den Konnektor bzw. den
\T{Fingertip} der Absaugpumpe angeschlossen. Der restliche Teil des Katheters
bleibt so lange in der Verpackung bis mit der Absaugung begonnen
wird.}{
\begin{itemize}
  \item Verpackung nur am farbigen Ende des Katheters öffnen
  \item An Absaugpumpe anschließen
  \item Schlauch bleibt bei Absaugbereitschaft in der Hülle
\end{itemize}
}
{}
{}
...
Der Katheter wird \Es{ohne Sog eingeführt}, dazu wird entweder der Katheter
...
\Es{Kreislaufstörungen} (Bradykardie, Hypotension) kommen. Der Vagus-Nerv ist
...
\subsubsection{Beatmung mit einem Beatmungsbeutel}

\TakeNotesLarge

\subsubsection{Beatmung während der Reanimation}

\TakeNotesLarge

\subsubsection{Beatmung ohne Reanimation: Kontrollierte und assistierte
Beatmung}
...
Beatmungbeutel schließt man dazu einen \ce{O2}-\Es{Verbindungsschlauch} an den
Druckminderer und den Beatmungsbeutel an. Wenn Vorhanden kann ein
\ce{O2}-\Es{Reservoir} verwendet werden, dadurch wird die
Sauerstoffkonzentration auf fast 100\,\% erhöht. 
...
\begin{itemize}
  ...
  \begin{itemize}
    \item \ce{O2}-\Es{Verbindungsschlauch}
    \item \ce{O2}-\Es{Reservoir}
  \end{itemize}
...
\end{wrapfigure}Schienung einer Fuß-, Knie- oder Unterschenkelverletzung "`auf
Zug"'. Achtung: Oberschenkel: Vakuummatratze
