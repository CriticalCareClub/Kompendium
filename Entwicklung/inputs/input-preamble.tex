...
\opt{VAR-VAR2}{\usepackage{asboe}}

% \setkomafont{chapter}{\Huge\usefont{T1}{PTSansCaption-TLF}{m}{n}\selectfont\color{DefaultA}}
% \usepackage[grey,helvetica]{quotchap}
% % \renewcommand{\sectfont}{\Huge\usefont{T1}{PTSansCaption-TLF}{m}{n}\selectfont\color{DefaultA}}
% \definecolor{chaptergrey}{named}{DefaultA}
% \qsetcnfont{PTSansCaption-TLF}
% \renewcommand{\chapnumfont}{\usefont{T1}{PTSansNarrow-TLF}{m}{n}\selectfont\scalefont{4}}
% 
% \setkomafont{chapter}{\Huge\usefont{T1}{PTSansCaption-TLF}{m}{n}\selectfont\color{DefaultA}}
...
\renewcommand{\mtcSfont}{\sffamily\small\bfseries\color{DefaultA}}
\renewcommand{\mtcSSfont}{\sffamily\small\color{DefaultB}}
\renewcommand{\mtcSSSfont}{\sffamily\small\color{DefaultB}}
% \mtcsetoffset{minitoc}{-4em}
% \mtcsetformat{mini-table}{mtcindent}{0pt}

\setlength{\mtcindent}{0pt}
% \mtcsetfeature{minitoc}{open}{\kern1sp\vspace*{-.1ex}}
% \mtcsetfeature{minitoc}{close}{}
...
\renewcommand\footnotelayout{\FootnoteFont\FootnoteStyle}
...
\newcommand{\DefinitionInPara}[1]{{\DefinitionInParaFont\DefinitionInParaStyle#1}}
