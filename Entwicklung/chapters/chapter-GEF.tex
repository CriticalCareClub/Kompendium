...
\E{mit Ärmeln}), sowie \EE{Sicherheitsschuhe} mit
...
220\,000 Volt (220\,\MetricUnit{kV}) sind mindestens
4\Meter* Abstand zu halten.
\cite{Jaros1} 
...
\begin{description}
  ...
  \Fazit{Die Nummernsysteme der ÖBB sind eine eigene
...
eine Null angefügt. 
\Cave{Ein {\sffamily X}  vor der Nummer zur Kennzeichnung
der Gefahr bedeutet, dass der Stoff in  gefährlicher Weise
