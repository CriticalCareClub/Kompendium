...
\toprule\addlinespace
\TabHeading{Maß, Messgröße}		& \TabHeading{Symbol}&
\TabHeading{(Maß-)Einheit}	& \TabHeading{Zeichen}&
\TabHeading{Typ}& \TabHeading{Anmerkungen, Anwendungen} & \TabHeading{}\\\addlinespace\midrule\addlinespace 
\EE{Elektr. Stromstärke}& $I$, $i$ 	&  \EE{Ampere} 		&\MetricUnit{A} & SI Basis \\ 
\EE{Lichtstärke}		& $I_v$ 	& \Z{Candela} 	&\Z{\MetricUnit{cd}} & SI Basis \\ 
\EE{Temperatur} 		& $T$ 		& \EE{Kelvin} 		& \MetricUnit{K}  		& SI Basis \\
\EE{Masse} 				& $m$ 		& \EE{Kilogramm} 	& \MetricUnit{kg} 		& SI Basis  \\
\EE{Weg/Strecke/Länge} 	& $s$, $\ell$& \EE{Meter} 	
&\MetricUnit{m} & SI Basis \\ 
...
Stunde&\MetricUnit{km}/\MetricUnit{h}
& &Fahrzeuge\\\addlinespace 
