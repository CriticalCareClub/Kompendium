...
\begin{description}
	...
	\item[\gT{Symptome}] Krankheitserscheinungen

	\item[\gT{Komplikationen}] möglicherweise auftretende
	Schwierigkeiten

	\item[\gT{Therapie}] Sinnvolle Ma{\ss}nahmen zur Verbesserung
	der  Symptome

	\item[\gT{Differentialdiagnose} (DD)] Erkrankung(en) mit
	\"ahnlichen Symptomen,  Ver\-wechslungs\-gefahr
