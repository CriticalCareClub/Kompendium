...
% \clearpage
\subsection{Zeichen einer Vitale Bedrohung -- Alarmzeichen}

\Layout{0}{Alarmzeichen \RedFlag}
{%
...
\begin{itemize}
  ...
  Kreislauf)
  \item[\RedFlag] \T{Alarm-Symptome}: Zu den Alarmsymptomen
  gehören u.\,a.
  ...
  \item[\RedFlag] \T{Alarm-Diagnosen}: Manche Diagnosen
...
{}
{}
{\scriptsize\NarrowFont\begin{tabulary}{\linewidth}{LLLLLL}
\toprule\addlinespace
