...
\Layout{0}{\TxBeschreibung}
{
Der Arm beginnt mit dem Schultergelenk. Dieses ist ein klassisches
...
\Es{Oberarmknochen} (Humerus). Letzterer bildet als einzelner Knochen den
Oberarm.

Im \Es{Ellenbogengelenk} setzt sich der Oberarm in den Unterarm fort. Dieses
Gelenk wird aus \Es{Oberarmknochen} und \Es{Elle} (Ulna) sowie \Es{Speiche}
(Radius) gebildet. Das Ellenbogengelenk ist ein zusammengesetztes Gelenk. Die Verbindung zwischen Elle
...
Die beiden Knochen des \Es{Unterarmes} sind die \Es{Elle} und die \Es{Speiche}
sind, \Z{sie liegen bei Drehung der Handfläche nach oben parallel, bei Drehung
der Handfläche zum Boden hingegen überkreuz.} Die \Es{Speiche} (Radius) liegt
\Es{daumenseitig}\footnote{Daher ist die Radialarterie daumenseitig zu tasten!},
die Elle an der Seite des kleinen Fingers.

Nun folgt das \Es{Handwurzelgelenk}, welches hauptsächlich aus
...
Es gibt insgesamt 8
\Es{Handwurzelknochen}, Würfelknochen, \Z{welche in zwei Reihen zu jeweils 4
Knochen angeordnet sind.}

Hierauf folgen \Es{5 Mittelhandknochen} und dann die 5 Finger mit jeweils 2
(Daumen) oder 3 (Finger \VonBis{II}{V}) \Es{Fingergliedknochen} (körpernahe,
mittlere und körperferne Fingergliedknochen). Die Grundgelenke
(Mittelhandknochen $\leftrightarrow$ körpernahe Fingergleidknochn) sind
