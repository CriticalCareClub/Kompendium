...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
% 
% \paragraph{Standardlayout 1}\marginpar{\T{\tbs MarriedLi\{\}\{\}\{\}}}~
% 
% \begin{description}
%     \item[Syntax:]
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
% 
% \paragraph{Standardlayout 11 -- Mit Teaser}\marginpar{\T{\tbs MarriedLxi\{\}\{\}\{\}\{\}\{\}\{\}}}~
% 
% \begin{description}
% %     \item[Syntax:] \lstinline$\Married{<text>}$
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
% 
% \paragraph{Standardlayout 12 -- Mit Teaser ohne Überschrift}\marginpar{\T{\tbs MarriedLxi\{\}\{\}\{\}\{\}\{\}\{\}}}~
% 
% \begin{description}
% %     \item[Syntax:] \lstinline$\Married{<text>}$
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
% 
% \paragraph{Standardlayout 31}\marginpar{\T{\tbs MarriedLxxxi\{\}\{\}\{\}}}~
% 
% \begin{description}
%     \item[Syntax:]
%     \lstinline$\MarriedNG{<Paragraphenueberschrift>}{<Fliesstext>}{<Stichworte>}$
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
% 
% \paragraph{Standardlayout 32}\marginpar{\T{\tbs MarriedLxxxii\{\}\{\}\{\}}}~
% 
% \begin{description}
% %     \item[Syntax:] \lstinline$\Married{<text>}$
%     \item[Beschreibung:] 
...
% Überschrift} \marginpar{\T{\tbs MarriedLxxxii\{\}\{\}\{\}\{\}\{\}\{\}}}~
% 
% \begin{description}
% %     \item[Syntax:] \lstinline$\Married{<text>}$
%     \item[Beschreibung:] 
