\chapter{[PAM] Patientenmanagement}

\noindent Dieses Kapitel behandelt den grundsätzlichen Ablauf eines
...
Patientengespräch und Untersuchungen sowei das Beherrschen der theoretischen
...
% \Fazit{Ersteinsch\"atzung ${\rightarrow}$~Erstmaßnahmen
...
\Layout{2}{GI: Ersteindruck}{
\Z{(\Lang{engl.} General Impression)} 
...
\Layout{0}{A -- Atemweg}{
\Z{(\Lang{engl.} Airway)}
Erhoben bzw. beobachtet werden Atemger\"ausche und die Gestik des Patieten.

Die Atemwege können frei oder verlegt sein.
}{
...
Untersucht wird die Frequenz, das Atemmuster, die Anstrengung des Patienten beim
Atmen, andere als die bei A beschriebenen Atemgeräusche und das vorhandensein
von Heimsauerstoff.

\Z{\E{Speziell ausgebildetes} Personal kann mittels eines Stethokops die oben
und unteren Atemwege abhöhren (auskultieren) und damit Störungen von Atemweg und
Atmung besser einschätzen.}

}{
Frequenz, Atemmuster, Anstrengung beim Atmen, Atemgeräusche, Heimsauerstoff

}{}{}{}

\Layout{2}{C -- Kreislauf}{
...
\begin{inparadesc}
\item[Bei Traumapatienten:] \begin{inparadesc}
...
\end{inparadesc}
\item[Bei Nicht-Traumapatienten:] \begin{inparaitem}
    \item Vitalwerte.
\end{inparaitem}
\end{inparadesc}
...
\begin{gWideParEnv}
\MassnahmenNG{Standardmaßnahmen}{Ersteinschätzungsblock}{\label{m:ersteinschaetzung}}{
...
brodelndes Atem\-ge\-r\"ausch, Thoraxschmerz, Schocksymptome und entgleiste
...
\Es{Sobald eine vitale Bedrohung erkannt wird, müssen die \TxMassVit{}
 (\prettyref{tab:standardmassnahmen-vital}) \E{frühzeitig}
...
\noindent W\"ahrend des weiteren Verlaufs (Anamnesegespr\"ach, etc.) kann man
auf weitere Befunde stoßen welche auf eine vitale Be\-drohung hinweisen
...
\Es{5 {\TxMassVit}} (\prettyref{tab:standardmassnahmen-vital}, Seite 
\pageref{tab:standardmassnahmen-vital}),
...
\item Sauerstoffgabe, 
\item Notarztnachforderung, 
\item Renimationsbereitschaft, 
...
Die folgende Checkliste in Tabelle \ref{tab:checkliste-patientenmanagement} gibt
einen Überblick über die Maßnahmen und das Anamnese\-ge\-spr\"ach, die
...
Information verloren geht. Diese \E{Schnittstelle} zwischen Sanitäter und Arzt
bzw. Krankenschwester kann auf den weiteren Behandlungsverlauf einen großen Einfluss
...
\begin{itemize}
  ...
  \item Notarzt-Nachforderung. 
  \item Belassung auf Patientenwunsch oder wenn keine weitere Versorgung
  notwendig ist. \Ca{Rechtliche Hinweise beachten (\prettyref{topic:revers})!}
  \end{itemize}
...
\subsection{Standardamaßnahmen bei vital bedrohten Patienten}


\MassnahmenNG{Standardmaßnahmen}{\TxMassVit}{}{
\label{tab:standardmassnahmen-vital}\label{topic:standardmassnahmen-vital}
\begin{center}

\begin{tabulary}{\linewidth}{LL}
\toprule
\multicolumn{2}{c}{\TabHeading{\TxMassVit}}
\\\midrule
...
Engmaschiges, bestmögliches Monitoring
 &
RR, HF, Pulsoyxymetrie wenn vor\-handen, Sitzwache. 
\\\bottomrule
\end{tabulary}
\end{center}
}
...
\begin{quote}
  ...
  Sie kommen in eine Wohnung. Die Umgebung erscheint sicher, Sie erkenen auch
...
\begin{quote}
  ...
  genaueres über das Beschwerdebild in Erfahrung bringen. Der weitere Plan h\"angt davon ab.
  
  Die Vitalwerte werden gemessen und ein Pulsoxy angeh\"angt (RR 100\,/\,60,
  HF 110, Sp\ce{O2} 94\,\%). Der Patient gibt an, dass er st\"arkste
