...
\TableWide
{Übersicht: Gebräuchliche Einheiten}%1 Titel
{}%2 Beschreibung
{}%3 Label/Hook
{}%4 Quelle
{}%5 Lizenz
...
\addlinespace\toprule\addlinespace
\noindent\TabHeading{Maß, Messgröße}	& \noindent\TabHeading{Symbol} 	& \noindent\TabHeading{Einheit}	& \noindent\TabHeading{Zeichen} & \noindent\TabHeading{Anmerkungen}\\\addlinespace\midrule\addlinespace 
\EE{Elektr. Stromstärke}				& $I$, $i$ 						&  \EE{Ampere} 					&\MetricUnit{A} \\ 
\EE{Lichtstärke}						& $I_v$ 						& \Z{Candela} 					&\Z{\MetricUnit{cd}} \\ 
\EE{Temperatur} 						& $T$ 							& \EE{Kelvin} 					& \MetricUnit{K} \\
\EE{Masse} 								& $m$ 							& \EE{Kilogramm} 				& \MetricUnit{kg} \\
\EE{Weg/Strecke/Länge} 					& $s$, $\ell$					& \EE{Meter} 					&\MetricUnit{m} \\ 
\EE{Stoffmenge} 						& $n$ 							& \EE{Mol} 						& \MetricUnit{mol}  \\
\EE{Zeit} 								& $t$ 							& \EE{Sekunde} 					& \MetricUnit{s}  	 \\\addlinespace\midrule\addlinespace
\Z{Absorptionsdosis}					& \Z{$D$} 						& \Z{Gray} 						&\Z{\MetricUnit{Gy}} 			 \\
% \A{???}					& $I_v$ 	& \Z{Candela} 	& \Z{\MetricUnit{cd}} 		& \\
Dosisäquivalent							& $H$ 							& Sievert 						& \MetricUnit{Sv} 				& Strahlenbelastung \\\addlinespace 
Druck 									& $p$ 							& \T{Bar} 						& \MetricUnit{bar} 				& Luftdruck\\ 
Druck 									& $p$							& Pascal 						& \MetricUnit{Pa}\\ 
Druck 									& $p$							&\T{Millimeter Quecksilbersäule}& \MetricUnit{mmHg} 			& Blutdruck\\
Druck 									& $p$							&\T{Zentimeter Wassersäule} 	& \MetricUnit{cm\ce{H2O}} 		& PEEP-Ventil \\\addlinespace
% Elektr. Leitfähigkeit	&  			& Siemens 			& \MetricUnit{S} \\
Elektr. Ladung							& $q$							& \Z{Coulomb}					& \Z{\MetricUnit{C}} 			& \\ 
Elektr. Spannung 						& $U$							& Volt 							& \MetricUnit{V} \\
Elektr. Widerstand 						& $R$							& Ohm 							& \MetricUnit{$\Omega$} 		& \\\addlinespace
Energie, Arbeit							& $E$, $W$						& \T{Joule}						&  \MetricUnit{J}     			& Defibrillator (elektr. Energie)\\ 
Frequenz								& $f$							& Hertz 						&  \MetricUnit{Hz}     			& \\
% \Z{Kapazität} 			&  			& \Z{Farad} 	&  \Z{\MetricUnit{F}}    		& \\
% \A{???}	 				&  			& \Z{Katal} 	& \Z{\MetricUnit{kat}}  		& \\
% \Z{Indukktivität} 		&  			& \Z{Henry} 	&  \Z{\MetricUnit{H}}    		& \\
\Z{Geschwindigkeit}						& $v$							& \Z{Meter pro Sekunde}			& \Z{\MetricUnit{m}/\MetricUnit{s}}  	& \\ 
Geschwindigkeit							& $v$							& Kilometer pro Stunde			& \MetricUnit{km}/\MetricUnit{h} &\\\addlinespace 
Leistung 								& $P$ 							& Watt 							& \MetricUnit{W}\\\addlinespace
% \A{???}					&  			& \Z{Lumen} 	& \Z{\MetricUnit{lm}}   		& \\
% \A{???}					&  			& \Z{Lux} 		& \Z{\MetricUnit{lx}}   		& \\
Magn. Feldstärke 						& $B$							&  Tesla 						& \MetricUnit{T} 				& MRT\\\addlinespace
% Magn. Fluß 				&  			& \Z{Weber} 	& \Z{\MetricUnit{}} \\
Masse									& $m$							& Dalton 						& \MetricUnit{Da}       	 	& kolloidale Infusionslösungen \\ 
Masse									& $m$							& Tonne							& \MetricUnit{t}\\\addlinespace
Schalldruck 							& $p$ 							& Dezibel						& \MetricUnit{dB}\\\addlinespace 
Stoffmenge 								& $n$ 							& Mol 							& \MetricUnit{mol} 			 	& Stoffmenge bei Infusionszubereitung, BZ-Messung\\\addlinespace 
Temperatur 								& $T$							& Grad Celsius 					& \DegC  						&\\\addlinespace 
%Temperatur 				& $T$ 		& Kelvin 		& \MetricUnit{K} 			& 	&\\\addlinespace 
Volumen 								& $V$   						& Liter							&\MetricUnit{l},{\Liter}\\\addlinespace 
Winkel 									& $\alpha$						& Grad 							& {\Deg}\\
Winkel 									& $\alpha$						& Winkelminute 					& '\\
Winkel 									& $\alpha$						& Winkelsekunde 				& "\\\addlinespace
Zeit									& $t$							& Jahr 							& \MetricUnit{a}\\
Zeit									& $t$							& Tag 							& {\Day}\\
Zeit									& $t$							& Stunde 						& {\Hour}\\
Zeit									& $t$							& Minute    					&{\Min}\\\addlinespace\midrule\addlinespace 
Dosierung								&								&								& \MgKg 						& bzg. a. Gewicht, analog {\Gramm}, \MetricUnit{\textmu\Gramm}, {\Ml}, \ldots\\
Flussrate								&								& 								& \LPerMin 						& entspricht Dosierung\\
Infusionsrate							&								&								& \MgKgH 						& bzg. a. Gewicht\\
Infusionsrate							&								&								& \McgKgH 						& bzg. a. Gewicht\\
Infusionsrate							&								&								& \McgKgMin 					& bzg. a. Gewicht\\\addlinespace
Masseanteil								& 								&								& \MgDl 						& Blutzuckermessung\\
Masseanteil								&								&								& \MetricUnit{\Mg\,\PC}			& = \MgDl
\\\addlinespace\bottomrule
\end{tabularx}
}%6 Tabelle
{}%7 Float
...
\TableWide
{Präfixe für Maßeinheiten}%1 Titel
{}%2 Beschreibung
{\label{tab:unit:prefix}}%3 Label/Hook
{}%4 Quelle
{}%5 Lizenz
{%
...
%     %Circles 
%     \foreach \r in {1, 2,...,7}
%       \draw[DefaultD, thick] (0,0) circle (\r);    
%     \foreach \r in {0.5, 1.5,...,7}
%       \draw[DefaultB, thin] (0,0) circle (\r);
%     %1° Rays
%     \foreach \a in {0, 1,...,359}
%       \draw[DefaultB] (\a:7.7) -- (\a:8);
%     %5° Rays
%     \foreach \a in {0, 5,...,359}
%       \draw[DefaultB] (\a:7.5) -- (\a:8);      
%     %15° Rays
%     \foreach \a in {0, 15,...,359}
%       \draw[thick,DefaultB] (\a:1) -- (\a:8); 
%     %30° Rays
%     \foreach \a in {0, 30,...,359}
%       \draw[thick,DefaultB] (0, 0) -- (\a:8);
...
% 
% 
% \begin{tikzpicture}[font=\sffamily, scale=0.34, transform
% shape]
% 
% %% Fill Color Styles
...
\nocite{FamPropPku2011,FamPropAeGruFert2011,FamPropAeGeFue2010}
