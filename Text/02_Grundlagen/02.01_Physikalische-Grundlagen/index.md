...
Die **Thermodynamik** ist die Lehre von Energie, Wärme, Arbeit und ihren Umwandlungen.
Sie beschreibt, wie Energie übertragen, umgewandelt und gespeichert wird.

- **0. Hauptsatz** (*Temperaturgleichgewicht*):
  Wenn zwei Systeme jeweils mit einem dritten im thermischen Gleichgewicht stehen,
  dann stehen sie auch miteinander im Gleichgewicht.

  > Grundlage für die Definition von **Temperatur**.
...
- **1. Hauptsatz** (*Energieerhaltung*):
  ...
  Änderung der inneren Energie $\Delta U$ = aufgenommene Wärme $Q$ minus verrichtete Arbeit $W$.

  > Energie bleibt in einem abgeschlossenen System erhalten.

- **2. Hauptsatz** (*Richtung von Prozessen*):
  Wärme fließt von selbst nur von warm nach kalt.
  Die Entropie $S$ (Maß für Unordnung) nimmt in einem abgeschlossenen System nie ab:
  $$
  \Delta S \geq 0
  $$
...
- **3. Hauptsatz** (*absolute Temperatur*):
  Am absoluten Nullpunkt ($T = 0 \,{\rm K}$) besitzt ein perfekter Kristall die Entropie $ S = 0 $

  > Der absolute Nullpunkt ist prinzipiell unerreichbar.

:::{admonition} Synopsis
- **0. Hauptsatz:** Temperaturvergleich
- **1. Hauptsatz:** Energieerhaltung
- **2. Hauptsatz:** Richtung der Prozesse (Entropie)
- **3. Hauptsatz:** Nullpunkt der Entropie
:::
...
- $p_0$ Druck an der Flüssigkeitsoberfläche (z. B. Atmosphärendruck): Der Gesamtdruck in der Tiefe $h$ ergibt sich aus Umgebungsdruck plus hydrostatischem Druck.
...
- Zwei Gefäße mit **gleicher Flüssigkeitshöhe** üben am Boden den **gleichen Druck** aus,
  auch wenn ihre Formen und ihr Flüssigkeitsvolumen völlig unterschiedlich sind.
:::
...
- **Blutdruck in Gefäßen:** In abhängigen Körperregionen (z. B. Beine im Stehen) erhöht sich der Druck durch die hydrostatische Säule des Blutes.
- **Orthostatische Dysregulation:** Blut versackt in den Beinen → zu geringer Druck im Gehirn → Schwindel oder Ohnmacht.
- **Infusionen:** Tropfbehälter über Patientenhöhe erzeugen durch hydrostatischen Druck den Fluss.
- **Liquordruckmessung:** Der Druck in der Lumbalpunktion hängt von der Höhe der Liquorsäule ab.
...
:::{rubric} Medizinische Anwendungen
:::
- **Blutdruck und Hämodynamik:** Der Blutstrom in Gefäßen erzeugt neben dem statischen Druck auch einen hydrodynamischen Druckanteil.
...
Elektrizität bezeichnet physikalische Erscheinungen, die mit der Bewegung und den Wirkungen von elektrischen Ladungen verbunden sind.
Sie kann in verschiedenen Formen auftreten, z. B. als **statische Elektrizität** oder als **elektrischer Strom**.
...
Das **Ohm'sche Gesetz** beschreibt den linearen Zusammenhang zwischen Spannung, Strom und Widerstand in einem elektrischen Leiter:
...
Es gilt nur für sogenannte **Ohmsche Widerstände**, bei denen der Widerstand $R$ unabhängig von Spannung und Strom konstant bleibt.
