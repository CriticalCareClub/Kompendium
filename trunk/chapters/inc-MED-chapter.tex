...
\gMassnahmen{
    ...
    \begin{itemize}
        ...
        \gTxMassVitBes
        \begin{itemize}
            \item $O_2$ 10\gLMin, bei Bedarf bis zu 15\gLMin
        \end{itemize}
        \item $O_2$: je nach Symptomen 6-8\gLMin, bei
...
\gE{lebensbedrohlich} krank. Das Herz vebraucht oft schon die allerletzten Reserven, schon die
Aufregung durch den Transport im Stiegenhaus zum Auto kann das Herz
endgültig in den Herz-Kreislaufstillstand bringen. 
}{
\gTabHeading{Kardiales Lungenödem}
\begin{itemize}
...
\end{itemize}
{\mdseries
${\rightarrow}$ Mißverhältnis Sauerstoffangebot -- 
...
Herzkranzgefäß\gE{verschluß} mit Absterben von Herzmuskelgewebe kommt.
...
\index{Herzkranzgefäße!Verschluß}\index{Koronargefäße!Verschluß}
...
Die PTCA ist in Wien u.a. verfügbar im AKH, Donauspital, und KH Hietzing.
...
\\\midrule 
\gT{Kammerflimmern}\index{Kammerflimmern}\index{Flimmern!Kammer-}
& Reanimation  & \emph{"`schockbarer"'} Rhythmus 
\\\addlinespace
\gT{Pulslose Ventrikuläre Tachykardie}\index{Pulslose
Ventrikuläre Tachykardie} \index{Tachylardie!Pulslose
Ventrikuläre} & Reanimation & \emph{"`schockbarer"'}
Rhythmus 
\\\addlinespace
\gT{Asystolie} 
\index{Asystolie}

{\small (HF\,=\,0)} & Reanimation & Nulllinie, \emph{"`nicht-schockbarer"'}
Rhythmus
\\\addlinespace
\gT{Vorhofflimmern}\index{Vorhofflimmern}\index{Flimmern!Vorhof-}
...
Leistungssportler können augrund ihres trainierten Körpers auch sehr
...
stösst und \gEs{versagt} bzw. die Blutversorgung
...
\gMassnahmen{
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Lagerung: Oberkörper hoch
            \item $O_2$ 10\gLMin, bei Bedarf bis zu
            15\gLMin
        \end{itemize}
        \item Beengende Kleidung öffnen
        \item Striktes Bewegungsverbot!
...
\gEs{Reanimationspflichtig!} Vorstufe zum Kammerflimmern, Herz kontrahiert so schnell dass es sich nicht mehr füllen kann ${\rightarrow}$ \gEs{keine Auswurfleistung} 
...
\begin{itemize}
    ...
    \item evt. kurze Bewußtlosigkeit, Ohnmacht
...
\begin{itemize}
    ...
    \item Sympathikusaktivierung, Adrenalin+Cortison (Streßhormone) durch
    Dauerstreß,  Bewegungsmangel, genetische Veranlagung
    \item u.a. \ldots  
\end{itemize}
...
Die Gefäßschädigung und die Belastung des Herzens durch
den hohen Gegendruck. 

Bei der Gefäßschädigung kommt es zur Ablagerung durch Kalk
und sonstige Plaques und über längere Zeit zur Verengung
oder Verstopfung der Gefäße. Je nach Organ kann das sehr
massive Auswirkungen haben. Im Herz führt es zur Angina
Pectoris oder zum Herzinfarkt, im Hirn zu Schlaganfällen, in
den Nieren zu einer Niereninsuffizienz, usw. Selbst große
...
Wie haben also gesehen dass die Hypertonie ein wichtger
...
Wenn es wirklich nur ein Zufallsbefund ist, zum Beispiel wenn
Sie {\quotedblbase}aus Spaß{\textquotedblleft} jemand Blutdruck
...
Beim \gE{arteriellen Verschluß} besteht
...
Beim \gE{arteriellen Gefäßverschluß} wird das
...
Ver\-schluß\-krank\-heit}, Abkz. \gT{paVK}
}
...
ein Gefäß verstopft und eine \gT{Embolie} verursacht.}) verstopft Vene}
...
unteren Atemwege
 ...
 \includegraphics[width=\textwidth]{./images/pharynx-schema.png} \captionof{figure}{\gAuthNotesPicLegalNotOk{pharynx-schema}{}Atemwegsverlegung (Schema). } }
...
\begin{itemize}
    \item Kinder
    \item bewußtseinseingeschränkte Personen
...
HochrisikoPatienten und machen auch bei der $O_2$-Gabe
Probleme! $O_2$ nur bis max. 95\% Sauerstofsättigung
!\cite{Olschewski2009}\gA{\footnote{Vortrag Univ-Prof.Dr.
Horst Olschewski, 5. AGN-Kongreß 2009; Notfall Rettungsmed (2009) 12:322}}}
...
asthmaticus kann tötlich enden.
...
\gMassnahmen{
    ...
    \begin{itemize}
        \item Lagerung: s.u.
        \item $O_2$ bis eine Sauerstoffsättigung von 95\% erreicht ist,
...
{
\captionof{figure}{\gAuthNotesPicLegalOk{}{
...
(COPD)}
\label{topic:copd}
\nocite{Renz-Polster2006} % p442

\emph{Syn.: \gT{Chronic obstructing pulmonary disease}}

\gDefinition{\gT{Chronische Bronchitis}:
Chronische ntzündliche Schleimhautschädigung  der Atemwege.}
...
\gMarried{
Die COPD ist durch eine voranschreitende
...
\begin{itemize}
    ...
    \item Belastungsdyspnoe (bei schwererer COPD
    auch in Ruhe)
...
\gMarried{
Der COPD-Patient erleidet öfters plötzliche
...
\begin{figure}[H]
 ...
 \captionof{figure}[Veränderung der Atemwege bei der
 COPD.]{\gAuthNotesPicLegalNotOk{img81}{}Veränderung der
...
$CO_2$-Konzentration im Blut gesteuert. Die
$CO_2$-Konzentration ist bei COPD-Patienten jedoch chronisch
hoch, der Körper gewöhnt sich an diesen Zusatnd. Er
regelt dann den Atemantrieb direkt über den $O_2$-Gehalt im Blut.

Wird der $O_2$-Gehalt plötzlich künstlich erhöht fehlt der
\index{COPD!Atemantrieb}Atemantrieb und der Patient kann
\gEs{Bewusstseinsstörungen} ("`$CO_2$-Narkose"') und einen
...
\vspace{2em}
    ...
    \captionof{figure}{\gAuthNotesPicLegalNotOk{}{img82}Herkumpft des Thrombus.
    \gSourcePicture{Quelle nicht eruierbar.}}
}{
...
\gDefinition{Flüssigkeitsansammlöung stau in den Alveolen und
Im Zwischengewebsraum der Lunge.}
\nopagebreak
...
\begin{itemize}
  \item beruhigen
  \item Kommandoatmung
  \item $CO_2$-Rückatmung  (Plastiksackerl,
  Handschuh)
  \item falls nicht erfolgreich, Notarzt für Sedierung  nachfordern
  \item KEIN $O_2$  verabreichen! \gEs{Kontraindikation!}
\end{itemize}
}
...
\begin{description}
    ...
    \item[>>Trockener<< Insult] Verschluß eines Hirngefäßes mit anschließendem
...
%     \captionof{figure}{\gAuthNotesPicLegalNotOk{img83}{}Insult: Eine spastische
...
%     \captionof{figure}{\gAuthNotesPicLegalNotOk{img84}{}Insult:
...
\begin{description}
    ...
    \item[Vergiftungen](Medikamente/Drogen/...) können
    wieder fast alles machen, also auch Krampfanfälle.
    \cite{Supady2009}
    ...
    \item[angeboren] ohne organisch faßbare  Ursache
...
auf eine Hand. Der Patient kann bei Bewußtsein sein. Ein
...
Patient nicht bei Bewußtsein, es besteht außerdem i.d.R.
...
\gMarried{
Häufig kommt es während des Anfalles zu einem Zungenbiß,
...
\begin{itemize}
    ...
    \item stabile Seitenlage  (Erholungsschlaf wie  Bewußtlosigkeit)
...
Versorgungsbereich des des Ischias-Nerv, welche u. a. durch eine Entzündung oder durch Reizung bzw. Kompression des Nervs oder seiner
...
gegessen). ${\rightarrow}$  Spritz/Eßabstand
er\-fra\-gen.
...
Ein hoher Blutzuckerspiegel über Jahre schädigt den gesammten
Körper. Es kommt zu:
...
\begin{itemize}
    ...
    \item Haut feucht/blaß
    \item Verwirrtheit, Krampfanfälle, Bewußtlosigkeit
\end{itemize}
}{
\begin{center}
 \includegraphics[width=\linewidth]{./images/noauth/AASdev20090228-img88.png} 
 \captionof{figure}{\gAuthNotesPicLegalNotOk{img88}{}???.
 \gSourcePicture{Quelle nicht eruierbar.}}
\end{center}
}
...
aus\-lösen/imitieren! Bei jeder  neurologischen Symptomatik  (v.a. Bewußtseinsstörungen)
...
\begin{itemize}
    ...
    \item zuviel Glucose ={\textgreater} rel. Flüssigkeitsmangel
    \item Niere gestört
    \item DM II
\end{itemize}
...
\begin{itemize}
    ...
    \item Bewußtseinstrübung bis Bewußtlosigkeit
    \item Kußmaul{\textquotesingle}sche Atmung (sehr tief und schnell)
...
es wirdbräunlich, ähnlich dem Kaffeesatz im Kaffeefilter.}
...
\gDefinition{„Austrocknung“: Es besteht ein hochgradiges Defizit von Füssigkeit im Körper.}

Grundsätzlich wird (wurde) entweder \gE{zuwenig Flüssigkeit zugeführt}
oder \gE{zuviel Flüssigkeit an die Außenwelt abgegeben} (eine Kombination aus
...
Andererseits kann es durch Erbrechen, Durchfall sowie starkes Schwitzen zu
einem stark erhöhtem Flüssigkeitsverlust kommen. Bei Fieber wird auch vermehrt
Feuchtigkeit abgeatmet, und natürlichen können auch Medikamente "`entwässern"'.
}
...
klagt über mehr oder minder heftiges Durstgefühl, ev. über Wadenkrämpfe und Erbrechen.
Die Haut ist auffallend trocken, Falten sind abhebbar und bleiben bestehen.
Mundhöhle und Zunge sind trocken, evt. borkig oder mit eingetrocknetem Schleim
belegt. Die Augen sind charakteristischerweise
tiefliegend, die Nase wirkt auffallend spitz. Der RR ist mitunter sehr nieder,
die HF eher hoch. Der Patient ist bis zur Klärung der Situation nüchtern zu
belassen! }
{
\gTabHeading{Symptome}
...
ausgeprägtes Krankheitgefühl, ähnlich einem grippalem Infekt, Appetitlosigkeit.
Eine Gelbfärbung der Hornhaut im Auge und eine ebensolche Vefärbung der Haut
...
\gDefinition{Abflußbehinderung des Harns aus der
...
Gebährmutterschleimhaut. Der Zyklus ist im Kapitel Anatomie und Physiologie
...
Uterus (Gebärmutter) 4-6 Tage. Wurde die Eizelle befruchtet, kommte es zur
...
Kind gemeint.} mit Nährstoffen und $O_2$ versorgt. Weiters
bildet sich um die Frucht eine \gT{Fruchtblase}, welche mit \gT{Fruchtwasser} gefüllt ist und sie so ideal vor äusseren
Erschütterungen schützt.

Die 'Frucht' hat - je nach Schwangerschafts dauer - verschiedene Namen:
...
Aufgrund verschiedener Ursachen kann es zur Fehlgeburt (Ausstossung der Frucht)
...
Reglunregelmäßigkeiten verwechselt. 
...
Wenn sich die befruchtete Eizelle nicht in der Gebährmutter, sondern schon im
...
\begin{itemize}
    \item Einnistung der Frucht in Eileiter (statt in Gebährmutter)
...
Jede hochschwangere Patientin sollte vorsichtshalber in
Linksseitenlage und nicht in Rückenlage transportiert werden.
...
\gFazit{Die \emph{Prä}eklampsie (EPH-Gestose) kann zu einem lebensgefährlichem
Krampfanfall (Eklampsie) führen.}
...
Mutter-Kind-Paß Untersuchungen zur  Früherkennung
...
Die Geburt verläuft in 3 Phasen. Der \gEs{Eröffnugsphase} mit den Eröffnungswehen und dem Blasensprung. Der \gEs{Austreibungsphase} mit dem Preßwehen und der Geburt des Kindes. Und der \gEs{Nachgeburtsphase} mit der Placenta als Nachgeburt.
...
Wahrscheinlichkeit eines Dammriß minimiert werden. Der \gT{Damm} ist das Stück
...
Am
Ende der Geburt, muss die \gEs{Geburtszeit} und der \gEs{Geburtsort} (Strasse mit
...
Einerseits wird während des Geburtsvorganges die Nabelschnurr durch den
...
nehmen dann ab oder hören plötzlich auf. Damit wird der Geburtsvorgang gestopt
und es herrscht Lebensgefahr für Mutter, wegen lebensbedrohlichen Blutungen, und
Kind, wegen $O_2$-Mangel.
...
Bei Kindernotfällen können als zusätzlicher Streßfaktor für
...
Wichtig für den Transport ins Krankenhaus ist, alle erkrankte Kinder bis zum vollendeten Lebensjahr sind auf eine Kinderambulanz zu transportieren. 
...
Dabei handelt es sich um eine Entzündung des Kehlkopfes. Es können auch die oberen Atemwege mittels Anschwellung des Schleimhäute behindert sein (Pseudokrupp/Kruppsyndrom). Diese Infektion wird durch Viren verursacht.
...
\begin{itemize}
    ...
    \item Mund offen, Speichelfluß, spricht kaum!
    \item Angst!
\end{itemize}
...
\begin{itemize}
	\item Reanimation
	\item Eltern beruhigen; Ihnen das Gefühl geben,  daß sie alles für
...
\subsubsection{Ertrinkungsunfall}\index{Ertrinkungsunfall}
...
\gMassnahmen{
    \paragraph{Spezielle Maßnahmen beim Ertrinkungsunfall}
    ...
    \begin{itemize}
        ...
        Stoffwehchsel verlangsamt wird.
        \item \gTxBeiVit \gTxMassVitBes
...
Grundsätzlich gelten auch bei Kinder die Ausführungen im Abschnitt
...
\gMassnahmen{
    ...
    Die Behandlung erfolgt grundsätzlich wie beim Erwchsenen, siehe
...
\subsection{Kindesmißhandlung}

\gDefinition{Absichtliche psychische oder physische Gewalt gegen Kinder}


Kindesmißhandlung kommt in ALLEN sozialen Schichten vor!
...
\begin{itemize}
    ...
    Ursachen als sexueller Mißbrauch!)
...
\gMassnahmen{
    \paragraph{Maßnahmen bei Verdacht auf Kindesmißhandlung}
    Die Aufgaben des Rettungsdienstes bei verdacht auf Kindesmißhandlung
besteht in:

\begin{enumerate}
    \item Daran denken!
    \item Umstände und Umfeld abklären
    \item Unstimmigkeiten und Auffälligkieten auf eine neutrale Weise
    \gEs{dokumentieren}
    ...
    Verdacht auf eine Mißhandlung besteht und die Erziehungsberechtigten unkooperativ sind notfalls auch die Exekutive beiziehen.
\end{enumerate}

Jedenfalls zu unterlassen sind:

\begin{itemize}
    \item Voreilige Verdachtsäusserungen. \gZ{Nicht alles was stinkt ist ein
    Fisch!}
...
Grundsätzlich muß aber gesagt werden dass psychiatrische
Erkrankungen\footnote{Sofern man den Begriff
\emph{"`Erkrankung"'} überhaupt verwenden kann/soll/darf \ldots}
etwas alltägliches und nichts außergwöhnliches sind. Je nach Studie leiden bis zu 30\,\% der Bevölkerung an psychiatrischen Erkrankungen, allen voran an
...
Extremsituationen auf die reagiert werden muß, sodaß 
diese Überlegungen oft beiseite geschoben werden. 

In
der Gesellschaft (repräsentiert durch die Gesetzgebung) gibt es die Übereinkunft, daß bestimmte
...
Es ist hierbei jedoch festzuhalten, daß auch ein psychiatrischer Patient -- genauso wie jeder andere
Patient auch -- über die selben Selbstbestimmungrechte
...
Erkrankung etwas druchaus alltägliches, oft steht selbige
...
\begin{itemize}
    ...
    \gEs{fühlen}.
    \item Es sollen keine \gEs{falschen oder nicht ein
   lösbare Versprechen} gegeben werden. 
...
Halluzinationen leidet. Jedesmal wenn sie das Badezimmer
...
mehr. Da ihn nun der Geheimndienst nicht mehr erreichen
kann haben sie vom Gebühren-Info-Service eienen Agenten
...
\begin{enumerate}
    \item Sofern eine Gefährung für den Patienten oder für
...
Suizid- oder sontige selbstschädliche Handlungen nicht auf
...
werden}. Es ist wichtig dabei einen \gCa{neutralen Tonfall}
zu verwenden und \gCa{nicht anklagend zu klingen!}

\begin{quotation}
\emph{"`Wollten Sie sich verletzen?"'}

\emph{"`Wollten Sie sich umbrungen?"'}
\end{quotation}
...
Ein mißlungener -- oft zögerlicher -- Selbstmordversuch
...
\gCave{Ein jeder Selbstmordversuch muß ernst genommen
...
untersucht und bescheinigt, daß die Voraussetzungen der
...
\begin{itemize}
    ...
    \item Delirium  (Bewußtseinsstörungen, Halluzinationen )
    \item Krampfanfälle
    \item RR-Entgleisung
...
wieder ${\uparrow}$, bewußtseinsklar
...
\gMassnahmen{
\paragraph{MaßSpezielle Maßnahmen bei Hitzschlag}
...
\begin{itemize}
    ...
    \item Schutz vor weiterer Abkühlung, KEINE AKTIVE ERWÄRMUNG!
    \item Woll- + Aludecken! Mütze!
    \item ev. Wiederbelebungsmaßnahmen
    \item Notarzt !
\end{itemize}
}
...
nützlicher Stoff kann sich in eine totbringende Waffe
...
\begin{description}
    ...
    Drogenkonsum), in den Muskel, in die (Unter-)Haut (z.B.
    Insektenstich)
    \item[Über die Haut] transkutan : fettlöslich e Substanz kann  Hautbarriere durchdringen
...
Kontrollverlust, Bewußtseinstrübung,
...
\begin{itemize}
    ...
    \item Sprach-
    und Gangunsicherheit
    \item Bewußtseinstrübung
\end{itemize}
\gTabHeading{Gefahren}
\begin{itemize}
    \item Koma
    \item Atemdepression
    \item  Ausfall der
...
nach der Einnahme auftreten und tödlich enden. Vegiftungen
...
\gZ{
\paragraph{Pracetamol (Mexalen\texttrademark,
APA\texttrademark, \ldots)} Paracetamol kann in hoher Dosis
zu Leberversagen führen. Symtome treten erst nach Stunden
...
Psychisch kommt es dosisabghängig zu Halluzinationen
...
\gMassnahmen{
\subsubsection{Allgemeine Massnahmen bei
...
\begin{enumerate}
    ...
    Eigenschutz zulässt.
    \item $O_2$-Berieselung mit Maske ist in keinem Fall
...
\subsubsection{Kohlenmonoxid ($CO$) -- oder: Von defekten
Heizlüftern, Gasthermen und Autoabgasen}

Kohlenmonoxid ($CO$) entsteht bei unvollständiger
Verbrennung ($O_2$-Zufuhr ${\downarrow}$), dies passiert
vor allem bei schlecht gewarteten Gasheizungen und
Durchlauferhitzern. $CO$ bindet sich 300 mal besser an den
roten Blutfarbstoff Hämoglobin als $O2$, daher verdrängen
schon kleine Mengen den Sauerstoff aus dem Blut! Die Folge
ist logsicherweise eine Unterversorgung mit Sauerstoff.
...
\subsubsection{Kohlendioxid ($CO_2$) -- Tod im Weinkeller}
...
$CO_2$-Spiegel im Blut das Atemzentrum stimuliert 
\end{itemize}
...
&
Ammoniak,  Nitrosegase, Schwefelwaserstoffe
\\\addlinespace
Haushalt 
&
...
Oberfläche aufrgrund einer irreversiblen Zerstörung (Denaturierung) von
Eiweißstoffen.}
