...
\begin{description}
  ...
  \begin{compactdesc}
    ...
    \item[0.26] \dotfill 2012-10 (VV, 172 Änderungen\footnote{Lt. vorläufiger Statistik, Änderungen nach Redaktionsschluss möglich.})
  \end{compactdesc}
  }
  \item[Auszüge:]~
  ...
  {\scriptsize %
  \begin{compactdesc}
    \item[Ernährungspädagogik] 2011-11 (basierend auf {\AASS} 0.20)
  \end{compactdesc}
  }
\end{description}
