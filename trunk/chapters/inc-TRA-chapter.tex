...
\end{savequote}
\chapter{[MED-TRA] \emph{Spezielle Patientengruppe:} Trauma}
\label{chp:TRA}
\gAasRsN{RS~VII}
...
(Traumacheck) wird unter \gSee{topic:traumacheck} erklärt. 
...
Wird ein \gEs{Fußgänger von einem Fahrzeug (frontal) erfasst}
ist generell mit schweren Verletzungen (vor allem
Schädel-Hirn-Trauma, Wirbelsäule) zu rechnen. \gZ{Zur
...
Radfahrer oder Fußgänger mit mehr als 30 km/h durch ein
Fahrzeug erfasst werden. Erkennbar kann dies durch
Bremsspuren, die bei trockener Fahrbahn länger als 10-20 m
sind, sein.
...
\includegraphics[width=\linewidth]{./images/teaser/blut-tatort-hinterhof.jpg}
\end{wrapfigure}\paragraph{Stich- und Schussverletzungen}
...
und andere \gEs{Fremdkörper sollen niemals
...
daher erst unter kontrollierten Bedingungen \gEs{in einem Operationssaal}
erfolgen. Für den Transport muss man den \gEs{Fremdkörper mittels eines
Verbandes sichern}, um ein Verrutschen und Folgeverletzungen zu verhindern.

\begin{table}[H]
\gTagBugfix{Bilder Fremdkörper}\gCaptionof{table}{Bilderserie:
\gSlideHeading{Fremdkörper}}

\begin{tabularx}{\linewidth}[H]{XXX}
\addlinespace
\includegraphics[width=\linewidth]{./images/trauma/fremdkoerper-stich-fixierung.jpg}
\gCaptionof{figure}{\gAuthNotesPicLegalNotOk{}{}Fixierung
...
\gCaptionof{figure}{\gAuthNotesPicLegalNotOk{}{}Stich mit einem Küchenmesser. Das Messer verbleibt im Körper {\ldots}~
\gSourcePicture{Gabriel}} 
&
\includegraphics[width=\linewidth]{./images/trauma/fremdkoerper-stich-messer-02.jpg}
\gCaptionof{figure}{\gAuthNotesPicLegalNotOk{}{}{\ldots} bis in den Operationssaal.
\gSourcePicture{Gabriel}} 
...
\gDefinition{Eine Wunde ist eine Gewebeschädigung der Haut
...
\begin{table}[H]
\begin{gWideParEnv}
\gCaptionof{table}{Bilderserie: \gSlideHeading{Wunden}}

\begin{tabularx}{\linewidth}[H]{XXX}
\addlinespace
\includegraphics[width=\linewidth]{./images/wunde_rqw1.jpg}
\gCaptionof{figure}{\gAuthNotesPicLegalOk{}{}Rissquetschwunde
...
\gCaptionof{figure}{\gAuthNotesPicLegalOk{}{}Schnittverletzung
oberhalb der "`Pulsader"'.
\gSourcePicture{Hauer}}
\\\addlinespace
\includegraphics[width=\linewidth]{./images/trauma/stichwunde-klein.jpg}
\gCaptionof{figure}{\gAuthNotesPicLegalNotOk{}{}Glatte
...
\gCaptionof{figure}{\gAuthNotesPicLegalOk{}{}Stichverletzung:
...
\gCaptionof{figure}{\gAuthNotesPicLegalNotOk{}{}Stichwunde
...
\begin{table}[H]
\begin{gWideParEnv}
\gCaptionof{table}{Bilderserie: \gSlideHeading{Verätzungen und Verbrennungen}}
...
\gCaptionof{figure}{\gAuthNotesPicLegalNotOk{}{}Verätzung.
\gSourcePicture{Hauer}} 
&
...
\gCaptionof{figure}{\gAuthNotesPicLegalNotOk{}{}Großflächige
Verbrennung. \gSourcePicture{Hauer}} 
&
\includegraphics[width=\linewidth]{./images/trauma/combustio-sa-02-hand.jpg}
\gCaptionof{figure}{\gAuthNotesPicLegalNotOk{}{}Ablederung.
\gSourcePicture{Hauer}} 
&
\includegraphics[width=\linewidth]{./images/trauma/combustio-sa-03-escharotomie.jpg}
\gCaptionof{figure}{\gAuthNotesPicLegalNotOk{}{}Escharatomie. Durch die Ringförmige Verbrennung am Thorax zieht sich die
...
\begin{table}[H]
\gTagBugfix{Bilder Frakturen}\gCaptionof{table}{Bilderserie:
\gSlideHeading{Frakturen}}

\begin{tabularx}{\linewidth}[H]{XXX}
\addlinespace
\includegraphics[width=\linewidth]{./images/trauma/fraktur-offen-finger.jpg}
\gCaptionof{figure}{\gAuthNotesPicLegalNotOk{}{}Nicht immer
...
\gCaptionof{figure}{\gAuthNotesPicLegalNotOk{}{}Unterschenkelfraktur
nach Verkehrsunfall. 
\gSourcePicture{Hauer}} 
&
\includegraphics[width=\linewidth]{./images/trauma/fraktur-us-roe.jpg}
\gCaptionof{figure}{\gAuthNotesPicLegalNotOk{}{}Röntgenbild
...
\gLayout{2}{Grundregeln der Wundversorgung}
{
...
\begin{itemize}
    ...
    \footnote{Bei der Wundversorgung sind immer sterile Materialien zu
    verwenden. Papier-Handtücher o.ä. sind \gE{nicht zulässig}! Eine Ausnahme
    kann lediglich bei der Versorgung des Stiches mittels eines sauberen
    ...
    \gEs{von Innen nach Außen} um keine weiteren Verunreinigungen in die Wunde
    zu bringen.
...
\begin{itemize}
    \item \gEs{Verletzung wichtiger Gewebestrukturen (Organe):} Je nach
    betroffener Körperregion treten unterschiedliche Verletzungsmuster auf. In den folgenden Abschnitten lernen Sie über spezielle traumatologische Notfälle wie z.B. Schädel-Hirn-Trauma, Thorax-Trauma, Bauchtrauma etc.
...
% \gCaptionof{figure}{\gAuthNotesPicLegalNotOk{}{}Muster
% \gSourcePicture{}} 
% &
% \includegraphics[width=\linewidth]{./images/stop.jpg}
% \gCaptionof{figure}{\gAuthNotesPicLegalNotOk{}{}Muster
...
\gMarginNo{\newline\includegraphics[width=\linewidth]{./images/teaser/imgp0722.jpg}}\gDefinition{Gewalteinwirkung
auf den Kopf, die zusätzlich zu den nicht immer vorhandenen Hautwunden und zu den Frakturen des knöchernen Schädels
Funktionsstörungen und Verletzungen des Gehirns hervorrufen.\cite{Gorgass7}} 

(Vgl. Kap. Anatomie, \gSee{topic:zns}.)
...
{
\begin{itemize}
    \item Gedecktes SHT: ohne  Eröffnung der harten Hirnhaut (Dura  mater)
    \item Offenes SHT: mit  Eröffnung der harten Hirnhaut (Dura  mater)
\end{itemize}
}{
...
\gLayout{2}{Begleitende Verletzungen}
{
\begin{itemize}
...
\gMassnahmenNG{Allgemeine Maßnahmen}{SHT}{\label{m:am-sht}}{
...
\begin{itemize}
\item \gT{Gehirnerschütterung} -- SHT 1{\textdegree} --
Commotio cerebri
...
\begin{itemize}
    \item  Bewußtlosigkeit/Bewußtseinstrübung
    {\textless}\,1\,h
    \item Übelkeit, Erbrechen, Schwindel
    \item evt. flüchtige neurologische Ausfälle
...
Krampfanfälle. Mit \gEs{bleibenden Schäden} und Langzeitfolgen ist
zu rechnen.
}{
\begin{itemize}
...
\gMassnahmenNG{Spezielle Maßnahmen}{SHT, gedeckt}{}{
...
\gMassnahmenNG{Spezielle Maßnahmen}{SHT, offen}{}{
%     \subsubsection{Spezielle Maßnahmen beim SHT -- }
    \begin{itemize}
        \item Allgemeine Maßnahmen beim SHT
        (\prettyref{m:am-sht})
...
\gLayout{0}{Intrakranielle Blutungen}
...
\gParallel{
\begin{description}
\item[Bewußtseinslage] klar/getrübt/bewußtlos
\item[Motorik] 
...
\gCaptionof{figure}{\gCa{Alarmzeichen:} Eine Pupillendifferenz kann ein wichtiger
...
\paragraph{\gTxGefahren}

\begin{itemize}
    \item Kompression des Rückenmarks (aufgrund von Einblutungen ins  Rückenmark und dadurch bedingtes Ödem) 
...
\gMassnahmenNG{Spezielle Maßnahmen}{Wirbelsäulentrauma --- Allgemein}{}{
...
Schleudertraumen kommen bei Auffahrunfällen vor, insbesondere dann, wenn der Patient nicht angeschnallt war, oder die Kopfstütze fehlt. Es kommt zu einer Zerrung des Halsmarks, welche sich durch
\begin{itemize}
...
\paragraph{\gTxSymptome des Thoraxtraumas}~
...
(Vgl. Kap. Anatomie, \gSee{topic:atemmechanik} und
\gSee{topic:pleura})
...
Man unterscheidet zwischen \gT{offenem
...
\begin{table}[h]
\begin{gWideParEnv}
\gCaptionof{table}{Bilderserie \gSlideHeading{Pneumothorax}.}

\begin{tabularx}{\linewidth}[H]{XXX}
\includegraphics[width=\linewidth]{./images/pneumothorax_xray_halb.jpg}
\gCaptionof{figure}{\gAuthNotesPicLegalNotOk{}{}Pneumothorax. 
...
\gCaptionof{figure}{\gAuthNotesPicLegalNotOk{}{}Kompletter
Pneumothorax der rechten Seite. Die Lunge ist kollabiert.  
\gSourcePicture{Hauer}} 
&
\includegraphics[width=\linewidth]{./images/pneumothorax_stichverletzung_diskret.jpg}
\gCaptionof{figure}{\gAuthNotesPicLegalOk{}{}Diese
...
\gMassnahmenNG{Spezielle Maßnahmen}{Pneumothorax}{}{
...
\begin{table}[H]
\gCaptionof{table}{Offenes und geschlossenes Bauchtrauma.}
...
inneren Blutungen versteckt sein können.
    ...
    \includegraphics[width=\linewidth]{./images/trauma/bauchtrauma-offenes-01.jpg} \gCaptionof{figure}{\gAuthNotesPicLegalOk{}{}Offenes Bauchtrauma mit Austritt von Darmschlingen.
    \gSourcePicture{Hauer}}
}


\gMassnahmenNG{Spezielle Maßnahmen}{offenes Bauchtrauma}{}{
    ...
    \begin{itemize}
        ...
        \item steril abdecken, mit Ringerlösung feuchthalten
        \begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item gründlich nach \index{Prellmarken}\gEs{Prellmarken}
        suchen!
    \end{itemize}
\end{itemize}
}{
...
\begin{itemize}
    ...
    \end{itemize}
    \item Zerreißung  von Organen (\gEs{Milz},
    \gEs{Leber})
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Sepsis (hohe Lethalität), septischer Schock
        \end{itemize}
    \end{itemize}
\end{itemize}
}
...
\begin{itemize}
    ...
    ${\rightarrow}$ Latenz bis Riß der Kapsel
\end{itemize}
...
\gMassnahmenNG{Spezielle Maßnahmen}{instabiles
    Beckentrauma}{}{
    \begin{itemize}
        \item \gTxMassVitBes
        \begin{itemize}
...
\gDefinition{Gleichzeitige \gEs{Verletzung mehrerer Körperregionen} oder
Organsystemen, von denen \gEs{wenigstens eine} allein
\gEs{oder die Kombination mehrerer} \gEs{lebensgefährlich}
ist.}
...
\gMassnahmenNG{Spezielle Maßnahmen}{Polytrauma}{}{
    ...
    \begin{itemize}
        ...
        \opt{STATUS-EXPERIMENTAL}{\gA{\par\hrule
        ...
        \item \gEs{Wärmeerhalt}: Der Wärmeerhalt hat massiven Einfluß auf das
        Überleben!
        ...
        \item \gZ{Notarzt: Schmerztherapie, Narkose, Intubation und Beatmung}
        \item Transport:
        \begin{itemize}
...
\gDefinition{Zerrung/Überdehnung des Kapsel-/Bandapparates}
...
\gMassnahmenNG{Spezielle Maßnahmen}{Verstauchung}{}{
    \begin{itemize}
		\item Kleidung und Schmuck von der betroffenen Gliedmaße entfernen ($\rightarrow$ Schwellung)
        \item ruhigstellen
        \item hochlagern
        \item kühlen
        \item ad Unfallabteilung (muß nicht sofort sein)
    \end{itemize}    
}
...
\gDefinition{\gT{Luxation}: "`Verrenkung." Gelenkverletzung, bei der zwei das
Gelenk bildende Knochenenden aus ihrer normalen Stellung zueinander verschoben werden. Dabei kommt es oft zu
...
\gMassnahmenNG{Spezielle Maßnahmen}{Verrenkung}{}{
...
\begin{itemize}
    ...
    \item Infektionsgefahr. Bei offenen Frakturen ist Keimfreiheit be\-sonders wichtig, da  die Gefahr
    einer lebenslangen Knochen\-marks\-ent\-zündung \gZ{(Osteomyelitis)}
    besteht! 
    Wenn mögllich soll eine Wundfolie (z.B. 
    \index{OpSite}\gT{OpSite}\texttrademark ) verwendet werden.    \item 
...
Sanitäter mittels Stiefelgriff (siehe \gSee{topic:vacuumbeinschiene-anwendung})
...
\begin{table}[H]
\gCaptionof{table}{Frakturzeichen.}

\begin{tabularx}{\linewidth}[H]{XX}\addlinespace
\multicolumn{1}{c}{\gEs{Sichere Frakturzeichen}}
 &
\multicolumn{1}{c}{\gEs{Unsichere Frakturzeichen}}
\\\midrule
\begin{itemize}
...
\gCaptionof{figure}{Fehlstellung -- In natura und in
...
\gMassnahmenNG{Spezielle Maßnahmen}{Fraktur}{}{
\begin{itemize}
  \item Kleidung und Schmuck von der betroffenen Gliedmaße entfernen ($\rightarrow$ Schwellung)
  \item Blutstillung, Wundversorgung
  \item Bei offenen Frakturen ist Keimfreiheit be\-sonders wichtig, da  die Gefahr
  einer lebenslangen Knochen\-marks\-ent\-zündung \gZ{(Osteomyelitis)}
  besteht! Wenn möglklich soll eine \gE{Wundfolie} (z.B.
  \index{OpSite}\gT{OpSite}\texttrademark ) verwendet werden.
...
mit einer Kreissäge). Je glatter die Wundränder sind desto größer ist die Chance dass das Amputat wieder erfolgreich angenäht werden kann. Der Amputatstumpf wird steril mit einem Druckverband versorgt (kein Abbinden!). An große Blutungen und Schockgefahr denken!

\gMassnahmenNG{Spezielle Maßnahmen}{Versorgung eines Amputats}{}{
...
\gDefinition{Die Verbrennung ist eine durch Hitzeeinwirkung entstandene
...
\gT{Handregel oder mittels der
} \gT{Neunerregel} ermittelt werden. Die Handregel besagt, dass die Handfläche
...
\gMassnahmenNG{Spezielle Maßnahmen}{Verbrennung, leicht}{}{
...
\gMassnahmenNG{Spezielle Maßnahmen}{Verbrennung, großflächig}{}{
    \begin{itemize}
        \item \gTxMassVitBes
        \begin{itemize}
            \item \ce{O2}: 10\gLMin
...
\gMassnahmenNG{Spezielle Maßnahmen}{Inhalationstrauma}{}{
...
\gMassnahmenNG{Spezielle Maßnahmen}{Verletzungen mit chemischen
Substanzen}{}{
...
entscheidende Bedeutung für die zu setzenden Maßnahmen. Den
Schweregrad einer Erfrierung kann man erst nach Tagen voll
einschätzen. Deshalb ist es wichtig, die Warnsymptome ernst zu
nehmen!
...
\\\bottomrule
\end{tabulary}
\gCaptionof{table}{Stadien der Erfrierung \label{tab:Erfrierungen}} 
\end{center}


\gMassnahmenNG{Spezielle Maßnahmen}{Erfrierungen}{}{
\begin{itemize}
...
\gLayout{2}{Allgemeines zum elektrischen Strom und seine
...
\begin{description}
  ...
  in der Einheit \gT{Volt} (V) gemessen. Wie gefährlich eine Spannung ist hängt
  ...
  \begin{itemize}
    \item \gT{Niederspannung}: Von Niederspannung spricht man bei Spannungen
    bis 1000\,V. \gZFootnote{An einer Autobatterie liegt eine Spannung von 12 V. An
    ...
    \item \gT{Hochspannung} \ldots\ ist eine Spannung über 1000\,V.
    \gZFootnote{Über Hochspannungsleitungen wird die elektrische Energie mit
  ...
  \end{itemize}
  \item \gEs{Elektrische Stromstärke:} Der elektrische Strom\gZFootnote{Elektrischer Strom ist der
  Fluss von Elektronen. Die treibende Kraft hinter dem Stromfluss ist die elektrische
  Spannung.} wird durch die elektrische \gT{Stromstärke}
  beschrieben, welche mit der Einheit \gT{Ampere} (A) gemessen wird. Kommt es zu
  einem Stromunfall ist die Schädigung im Körper von der Höhe der Stromstärke
  abhängig.\gZFootnote{Bei geringen Stromstärken \gE{unter 1 Milliampere (mA)} ist nur ein
  elektrischer Schlag spürbar. Bei Stromstärken \gE{ab ca. 10 Milliampere (mA)} kommt es zu
  Schmerzempfindungen und Muskelkontraktionen \cite{Jaros1}, ab \gEs{15-25
  mA} kommt es aufgrund der Muskelkontraktionen zu krampfhaften Festhalten
  der berührten Stromquelle \cite{BoehmerTaschRett6}. Stromstärken ab
  \gE{25-50\,mA} sind \gE{lebensgefährlich}!~\cite{BoehmerTaschRett6}
  Ab \gE{80\,mA} kommt es zu Atemlähmungen und
  Kammerflimmern \cite{Jaros1}, Stärken über \gE{3\,A} führen zusätzlich zu
  Verbrennungen, Verkochungen und Verkohlungen. \cite{LPN3} Die Werte beziehen sich auf Wechselstrom, die Grenzwerte
  für Gleichstrom sind höher. Da oft die Stromart nicht bekannt ist, ist es
  prinzipiell sinnvoll von der gefährlicheren Stromart auszugehen!}
  Stromstärken ab 25\,mA gelten als potentiell tötlich!
  ...
  \gT{Ohm} ($\Omega$) gemessen. Je größer der Widerstand eines
  ...
  (z.B. verbrannter) Haut ist noch geringer.\gZFootnote{Greift man z.B. mit
  feuchten Händen in die Steckdose (230\,V) so stellt sich durch den Körperwiderstand von
  ca. 1000 Ohm ein elektrischer Strom der Stärke 23\,mA ein. Diese Stromstärke
  ist absolut  lebensgefährlich, wie man aus der Übersicht oben schnell
  entnehmen  kann.}\gZFootnote{Man kann dies  durch das Ohmsche Gesetz leicht
  selbst nachrechnen! Die Spannung $U$ ist das Produkt aus dem Widerstand $R$
  und der elektrischen Stromstärke $I$: $U=R \cdot I$}
  ...
  durch den Körper ist dies gefährlicher, als wenn der Strom von einer Hand zum Fuß fließt.
  ...
  Stromrichtung 50~mal pro Sekunde (\gZ{Frequenz = 50\,Hz}), weshalb die
  Wahrscheinlichkeit für Kammerflimmern auch bei kurzen Stromkontakten steigt.
  \cite{RedelsteinerHRNS1} \footnote{Bei monophasischen Defibrillatoren wird mit
  Gleichstrom gearbeitet, biphasische Defibrillatoren polen die Stromrichtung
...
%\gT{Hochspannung}: über 1000\,Volt, Stromstärke
...
\gLayout{2}{Besonderer Gefahrenbereich}
{
\index{Gefahrenbereich!Strom}\label{topic:gefahrenbereich-strom}

Eine Starkstrom- bzw. Hochspannungsanlage muss durch einen \gEs{Fachmann}
...
{
Die Verletzungsmuster und Symptome variieren je nach Spannung (Volt) und Stromstärke (Ampere):
...
\gCave{Das eigentliche Ausmaß der Verletzung ist oft
...
\subparagraph{Blitzschlag} Bei Gewitterblitzen treten
...
\gMassnahmenNG{Spezielle Maßnahmen}{Stromunfälle}{}{
    \begin{itemize}
