...
\begin{Synopsis}
  \SynopsisItem{Vergiftungsinformationszentrale: 01 /
  406 43 43}
\end{Synopsis}
...
\section{Vergiftungen mit \HeadingKeyword{Alkohol}}

\TextSlidePicture
{Einleitung, Wirkung}%1 Titel
{%
...
Alkohol  wirkt ent\-hemm\-end, z.\,T. stimulierend und
stimmungs\-modu\-lator\-isch. Weiters kommt es zu einer Sprach- 
und Gangunsicherheit. 

\Z{Die akute Alkoholvergiftung ist von der chronischen
Alkoholabhängigkeit (Alkoholkrankheit) zu unterscheiden.}}%2 Text
{%
\begin{itemize}
...
\end{itemize}}%3 Slide
{./images/TAE/dif-w2-zelt-1.jpg}%4 Bilddatei
{}%5 Bildtitel
{}%6 Bildbeschreibung
{}%7 Quelle
{}%8 Lizenz
...
\section{Vergiftungen durch \HeadingKeyword{Medikamente}}
...
abgeklärt werden.}%2 Text
{}%3 Slide
{./images/teaser/imgp0482_00800.jpg}%4 Bilddatei
{}%5 Bildtitel
{}%6 Bildbeschreibung
...
\section{Vergiftungen mit \HeadingKeyword{Suchtmitteln} und
\HeadingKeyword{Drogen}}

\subsection{\HeadingKeyword{Opiate}: Heroin \& Co.}
...
\subsection{\HeadingKeyword{\enquote{Partydrogen}}: Ecstacy, 
Schwammerl,
Special K \ldots}
...
\clearpage % TEMP temp clearpage
\section{\HeadingKeyword{Gase}}

\subsection{Vergiftungen mit \HeadingKeyword{Stickgasen}}
...
\subsubsection{\HeadingKeyword{Kohlenmonoxid} 
(\texorpdfstring{\ce{CO}}{CO}) -- oder: Von defekten
...
Es entsteht bei unvollständiger Verbrennung (\ce{O2}-Zufuhr
...
Unterversorgung mit Sauerstoff.}%2 Text
{}%3 Slide
{./images/gabriel-sebastian-aass/Atemschutz_IMG_2043_00800.jpg}%4 Bilddatei
{}%5 Bildtitel
{}%6 Bildbeschreibung
{Sebastian Gabriel}%7 Quelle
{MfG}%8 Lizenz
...
\Picture
{\ce{CO}-Vergiftung}%1 Titel
{Regel\-mäß\-ig kommt es zu Unfällen durch defekte Gasthermen
oder Heizlüfter. Bei diesem Einsatz war ein RTW des ASB
Floridsdorf-Donaustadt beteiligt. Die dritte Patientin
wurde erst \EE{nachdem die Feuerwehr \E{sämtliche}\,(!)
Wohnungen des Wohnhauses aufgebrochen hatte} in der
\E{darüberliegenden Wohnung} gefunden.}%2 Beschreibung
{}%3 Label
{Wien heute, \url{http://wien.orf.at}}%4 Quelle
{}%5 Lizenz
{./images/2006-01-31-gaswienheute2.png}%6 Datei
{}%7 Breitenmodifizierer
{}%8 Float
% vormals \Layout{27}


\subsubsection{\HeadingKeyword{Kohlendioxid} 
(\texorpdfstring{\ce{CO2}}{CO2}) -- Tod im Weinkeller}
...
% M %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% M %
\ProcedurePrintDefault{MT59070C}

\begin{Danger}
  \item Bei Gasunfällen hat der \EE{Selbstschutz} Vorrang.
  Oft ist die Bergung nur mit \EE{schwerem
  Atemschutz} möglich ${\rightarrow}$ FEUERWEHR!
\end{Danger}

\begin{Synopsis}
  \SynopsisItem{Ein toter Helfer ist keine Hilfe.}
\end{Synopsis}

\subsection{\HeadingKeyword{Reizgase}}
...
\Table
{Vorkommen}%1 Titel
{Vorkommen von Reizgasen}%2 Beschreibung
{}%3 Label/Hook
{}%4 Quelle
{}%5 Lizenz
{%
...
\subsection{\HeadingKeyword{Kampfgase}}

\TextSlideTeaser
{Abstand halten!}%1 Titel
{%
...
\FullPrettyRef{topic:gefahrengutunfall}.}%2 Text
{
\begin{itemize}
...
\end{itemize}}%3 Slide
{./images/gabriel-sebastian-aass/schild-atemschutzmaske-abnehmen.jpg}%4 Bilddatei
{}%5 Bildtitel
{}%6 Bildbeschreibung
{Sebastian Gabriel}%7 Quelle
{MfG}%8 Lizenz
...
\clearpage
\section{Wovon man nicht \HeadingKeyword{trinken} sollte 
\ldots}

\subsection{Einnahme von \HeadingKeyword{Säuren} und 
\HeadingKeyword{Laugen}}
...
\subsection{\HeadingKeyword{Schaumbildner} (Wasch-/Putzmittel)}
