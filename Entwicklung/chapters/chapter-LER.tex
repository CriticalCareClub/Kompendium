...
Dies gilt auch für Personen, die schon an anderen Universitätsbibliotheken
entlehnberechtigt sind.

Die Ausstellung der Entlehnberechtigung erfolgt in der Zeit von Mo-Fr von
\VonBis{9:00}{19:30} und Sa \VonBis{9:00}{16:30} (in den Ferien eingeschränkte
Öffnungszeiten!). Gemeinsam mit dem ausgefüllten Anmeldeformular müssen folgende Dokumente
mitgebracht werden:

    * Allgemeiner Benutzer: Meldezettel und amtlicher Lichtbildausweis *
    Studierende und Angehörige MUW-fremder Bildungseinrichtungen: Meldezettel,
    Studienausweis/Dienstausweis * Personen unter 18 Jahren: schriftliche
