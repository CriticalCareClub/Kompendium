...
% \ChNumVar{\Huge\color{darkBlue}} 
% \ChTitleVar{\centering\Large\sf\color{ubuntured}}
% \ChRuleWidth{2pt} 
% \ChNameUpperCase
% % \ChNumVar{\fontsize{76}{80}\usefont{OT1}{lmdh}{m}{n}\selectfont\color{darkBlue}}
\addtokomafont{chapter}{\Huge\sffamily\bfseries\color{ubuntured}}

% \addtokomafont{chapter}{\fontfamily{lmdh}\selectfont\Huge\color{ubuntured}}
...
%   {\gdef\chapterlabel{\thechapter\ lala}}{0pt}
