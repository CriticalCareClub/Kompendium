...
\begin{multicols}{2}
\begin{description}
  \item[lateral] \Lang{Abkz.} lat.; seitlich
  \item[medial] \Lang{Abkz.} med.; mittig
  \item[dorsal] rückenwärts
  \item[ventral] bauchwärts
  \item[cranial] kopfwärts
  \item[caudal] fußwärts (eigeltich: schwanzwärts)
  \item[distal] \Lang{Abkz.} dist.; körperfern
  \item[proximal] \Lang{Abkz.} prox.; körpernah
  \item[dexter, -tra, trum] \Lang{Abkz.} dext.; rechts
  \item[sinister, -tra, trum] \Lang{Abkz.} sin.; links
\end{description}
\end{multicols}
}{}{}{}{}
...
\begin{description}
  ...
  \item[Gynäkologie]
  \item[Hygiene]
  \item[ICU] \Lang{engl.} \emph{Intensive Care Unit};
  Intensivstation
  \item[Innere Medizin]
  ...
  inneren Medizin
  \item[Radiologie]
  \item[Stroke Unit] Spezialstation zur Behandlung schon
  \E{Schlaganfällen}
  \item[Toxikologie]
  \item[Traumatologie] 
...
\EE{Raumforderung} und Schwellung (Tumor\footnote{Der Begriff \E{"`Tumor"'} bedeutet ganz
