...
:Reviewer:
    Alexander Blacky, Standard-Reviewprozess

.. todo:: Literatur: (Longmore et al. 2007) (Swaminatha V and Garmel 2008) (Böcker, Denk, and Heitz 2001) (Fauci et al. 2008) (Forth et al. 2001)
...
-  Fremdkörper sind Wohnhäuser und Autobahnen für Keime
...
Der wohl bekannteste Problemkeim ist der :dfn:`MRSA` :index:`\ <! MRSA>` (
Multiresistenter Staphylococcus aureus, siehe unten). Das liegt schlicht
...
Die Desinfektion führt zur Keimreduktion
----------------------------------------
...
-  Jedes Mittel darf nur für sein jeweiliges Einsatzgebiet verwendet
   werden
...
eine zufriedenstellende Leistung kaum sichergestellt werden kann (nicht
validierbares Verfahren). Sie ist daher nur dann zulässig, wenn eine
geringe Infektionsgefahr besteht und keine andere Methode sinnvoll
...
-  In unsachgemäß gepflegten Desinfektionsmitteln können Keime wachsen!
...
-  In den Fahrzeugen dürfen keine alkoholischen Desinfektionsmittel
   verwendet werden, da diese die Acryloberflächen zerstören können!
...
Sterilisation erzeugt Keimfreiheit
----------------------------------

Beschreibung: Sterilisation
^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
| *Ziel* & Mechanische Beseitigung von Schmutz & *Keim*

| Richtet sich gegen ausgewählte Keime & Abtötung aller Mikroorganismen
| *Ergebnis* & Sauber & Keimreduziert – Nicht keimfrei! & *Keimfrei*
  (steril)
| *Arten* & Abspülen
...
| *Anwendungsbereich* & Vorreinigung vor Desinfektion oder Sterilisation

Nicht-medizinische Gegenstände oder Flächen & Gegenstände, die
ausschließlich mit intakter Haut in Berührung kommen & Gegenstände, die
...
-  Meldung an Leitstelle: *Nicht einsatzbereit, müssen putzen*
...
unter !!! FULLPRETTYREFPROCEDURE !!! IU81001C besprochen.
...
#. Abfälle, die *innerhalb und außerhalb des medizinischen Bereiches
   ...
   Behandlung bedürfen [item:hyg-abfall-oenorm-gruppe3]
...
[item:hyg-abfall-oenorm-gruppe2] an. Für diese ist der Entsorgungsweg je
...
!!! LITERARY !!! Praxisorientiertes und reich illustriertes Fachbuch für
...
und Krankentransport und exemplarischen Desinfektionsplänen: (Kramer,
Heeg, and Botzenhart 2001)

Werk mit Österreich-Bezug: (Flamm and Rotter 1999) !!! LITERARY !!!
