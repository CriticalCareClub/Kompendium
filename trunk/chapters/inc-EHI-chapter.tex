...
%  2) Rettungskette
% 
% II. lebensrettende Sofortma{\ss}nahmen
% 
...
% 
%   7.1) anschlie{\ss}ende Behandlung
% 
%  8) Wiederbelebung
% 
%   8.1) Exkurs -- Defibrillation
% 
%   8.2) anschlie{\ss}ende Behandlung
% 
...
% 
%  14) anschlie{\ss}ende Behandlung
% 
...
% Notfällen und Unfällen. Unfälle sind alle durch äu{\ss}ere
...
% führen, wodurch der Ersthelfer nicht nur Ma{\ss}nahmen zur
...
Rettungssanitäter nur, wenn er durch Setzen   der Ma{\ss}nahme sein
eigenes Leben und/oder seine Gesundheit gefährden würde.}

\subparagraph{2. Grundsatz:} Die zumutbare Erste-Hilfe-Ma{\ss}nahme ist zumindest zu
...
\gZ{
Es muss immer das nächstgrö{\ss}ere Übel beseitigt werden. Es kann mitunter auf
...
% in Kauf zu nehmen. Als Ma{\ss}stab fungiert die Beachtung einer  
...
% Ablauf, der ähnlich einem Baum mit einer Anfangsma{\ss}nahme als
% Stamm beginnt und sich durch Ansammeln weiterer Informationen über
% den Zustand des Patienten in verschiedene Behandlungsma{\ss}nahmen als
...
Jedee Bewältigung eines Notfalls sollte immer nach dem
...
Am Beginn stehen die \gEs{Lebensrettenden Sofortma{\ss}nahmen}, welche noch in
\gE{Allgemeine Sofortma{\ss}nahmen} und in am Patienten gesetzten \gE{Lebensrettenden
Sofortma{\ss}nahmen} unterteilt werden können. Zu den \gE{Allgemeinen Sofortma{\ss}nahmen} zählt 
...
eine 2. Person. Zu den am Patienten zu setzenden
\gE{Lebensrettenden Sofortma{\ss}nahmen} zählt die stabile Seitenlage bei Bewusstlosigkeit, die
...
Sofortma{\ss}nahmen wird der \gEs{Notruf} abgesetzt, falls dies
noch nicht durch eine 2. Person geschehen ist.

Anschlie{\ss}end wird 
\gEs{weitere Erste Hilfe} geleistet, wie zum Beispiel die
Versorgung von einfacheren Verletzung und die psychologische Betreuung des Patienten. Der eintreffende
Rettungsdienst übernimmt den Patienten für die \gEs{Sanitätshilfe} und führt den
\gEs{Transport} durch. Im Spital erfolgt schlie{\ss}lich die
\gEs{ärztliche Betreuung} des Patienten. 

\gH{Je nachdem wie
gut die Rettungskette funktionert hat, landet der Patient im
Erdgeschoss oder nur noch im Keller des Spitals.}
...
% Ma{\ss}nahmen. Das erste Glied mit dem Thema lebensrettende
% Sofortma{\ss}nahmen besteht nach herrschender Meinung aus folgenden
% Ma{\ss}nahmen:}
% 
% \begin{enumerate}
%     
...
% 
% {
% Nähere Beschreibungen der einzelnen Ma{\ss}nahmen siehe unten.}
% 
% {
...
% besteht aus folgenden Ma{\ss}nahmen:}
% 
% \begin{enumerate}
%     
...
% Sofortma{\ss}nahme zu unterscheiden.}
% 
...
Dieser Satz soll  die Wichtigkeit der Erste-Hilfe-Ma{\ss}nahmen
verdeutlichen. Schlie{\ss}lich werden von den fünf Gliedern der
Rettungskette die ersten drei vom Ersthelfer durchgeführt.

%  Dies verdeutlicht
% die Wichtigkeit ersthelferischer Ma{\ss}nahmen. Des Weiteren zeigt sie,
% dass bei jeder Behandlung die lebensrettenden Sofortma{\ss}nahmen der
...
% lebensrettenden Sofortma{\ss}nahmen und dem Notruf als unabhängiges
% zweites Glied. In der realen Behandlung gibt es nur wenige Situationen
% in denen eine Sofortma{\ss}nahme bis zum Schluss durchgeführt wird,
% um erst nach deren Beendigung die Notrufabgabe einzuleiten.
% Tatsächlich muss der Notruf schon während der Sofortma{\ss}nahme
% abgegeben werden und ist daher auch eher als ein Bestandteil der
% lebensrettenden Sofortma{\ss}nahme zusehen als ein eigenständiges
% Glied. Andererseits ist die grobe Trennung zwischen lebensrettenden
% Sofortma{\ss}nahmen und Weiterer Ersten Hilfe nicht zielgerecht, da
...
% Bekämpfung stets lebenserhaltende Sofortma{\ss}nahme benötigt. }
% 
% \gZ{
% Die nachstehende Ausarbeitung folgt zwar in ihrem Rahmen der
% Unterteilung in lebensrettende Sofortma{\ss}nahmen und Weitere Erste
% Hilfe, setzte sich dafür aber bei den Themen der Weiteren Ersten
% Hilfe näher mit den uU. notwendigen lebensrettenden
% Sofortma{\ss}nahmen auseinander.}



\section{Lebensrettende Sofortma{\ss}nahmen}

\subsection{Verhalten am Notfallort}


% Vor dem Setzen irgend einer Ma{\ss}nahme ist es für den Erfolg der
% Behandlung (und uU. für die Gesundheit des Ersthelfers) wichtig, dass
% sich der Ersthelfer:

\gMarriedNG{Verhalten am Notfallort
}{
Vor dem Setzen irgend welcher Ma{\ss}nahmen sollte der Ersthelfer tief
durchatmen und sich danach einen \gEs{Überblick} über die
Situation verschaffen: Was ist passiert? Um welche Art von Notfall handelt es sich? Welche
...
Es gilt \gEs{Ruhe zu bewahren} und \gEs{Ruhe zu
vermitteln}. Dabei stellt man sich ruhig und gezielt auf die
bevorstehenden Ma{\ss}nahmen ein und reiht diese nach
\gEs{Dringlichkeit}. Erst nach diesen anfänglichen
Überlegungen wird mit einer Behandlung begonnen! 
}{
\begin{itemize}
    \item Überblick verschaffen
    \item Ruhe bewahren, Ruhe vermitteln
    \item Ma{\ss}nahmen nach Dringlichkeit sortieren 
\end{itemize}
...
Der Ersthelfer muss \gEs{Absperrma{\ss}nahmen durchführen} und
den Notfallort absichern. 

Wenn möglich und nötig ist der Patient aus dem
Gefahrenbereich zu retten, wobei unbedingt auf den Selbstschutz zu achten ist. Anschlie{\ss}end müssen
...
eine einfache Absicherungsma{\ss}nahme das eigene Leben, sowie
...
Hilfsmittel, wie \gEs{Warnleuchte} oder \gEs{Warndreieck}, sowie
Personen, welche Handzeichen geben, eingesetzt. 
}{
\begin{itemize}
...
herannahende Zug einen \gE{viel längeren Bremsweg} als ein
Auto hat. (ca. 600-800\,m, je nach Geschwindigkeit und
Gewicht des Zuges). Das \gEs{Haltesignal} für den Lokführer ist eine
...
% Fahrer- oder Beifahrersitz ist grds. erlaubt, au{\ss}er das Fahrzeug
...
% \item Freilandstra{\ss}e: 150-200\,m
...
% nicht alltäglich.
% Fahrradfahrer, Fu{\ss}gänger oder sonstige
...
% 
% \begin{itemize}
%     \item Eine der grö{\ss}ten Gefahren für den Ersthelfer auf Strassen oder
...
% 	\item Bei einem beginnenden Fahrzeugbrand kann durch sto{\ss}weises Sprühen mit
...
{
Eine der grö{\ss}ten Gefahren für den Ersthelfer auf Strassen oder
...
Ein beginnender \gEs{Fahrzeugbrand} kann unter Umständen
durch sto{\ss}weises Sprühen direkt auf den Brandherd mit einem Feuerlöscher bekämpft
werden. Sollten \gEs{Kleidungsstücke} brennen, werden die Flammen
sofort mit einer Decke o.ä. erstickt. Wenn möglich
wird die verbrannte Kleidung vom Patient
entfernt.\footnote{Nur wenn leicht möglich. Mit der Haut
verbundene, "`eingebrannte"' Kleidungstücke müssen belasen werden.}

Achtung beim \gEs{Zimmerbrand}! Die
Türschnalle nicht ungeschützt angreifen (heiss!), die Türe
nur langsam öffnen und den Raum nur zum Retten von Personen
betreten. Aufgrund der Rauchgase und des Sauerstoffmangels
darf \gE{nicht geatmet werden!} Bereits ein bis zwei
Atemzügen können eine Bewusstlosigkeit zur Folge haben. Es
darf kein Fenster geöffnet werden, sonst käme wieder
Sauerstoff in den Raum und das Feuer würde wieder angefacht
werden.
	...
	noch die Möglichkeit, den Verunglückten von der Stromquelle loszurei{\ss}en. Bei
...
(\gSee{topic:gefahrengutunfall}). Sie sind -- wie der Name
schon sagt -- mit gefährlichen Gütern versehen und haben somit ein erhöhtes Gefährdungspotential.
...
% liegt im Stra{\ss}enverkehr. Am meisten gefährdet sind jene
% Verkehrsteilnehmer, die ungeschützt am Verkehr teilnehmen. Vorrangig
% zu nennen sind Fu{\ss}gänger, Radfahrer oder Motorradfahrer. Am
...
Durch Anwenden der oben genannten Absicherungsma{\ss}nahmen kann
in vielen Situationen kein vollständiger Schutzbereich errichtet werden.
Insbesondere im Stra{\ss}enverkehr drohen, solange sich der Patient auf
...
% 
% {
% {Durch das gro{\ss}e Engagement eines Wieners namens Franz
...
% ein derma{\ss}en umfangreiches Fachwissen ansammeln konnte, dass er
...
%         Eine Schere findet sich standardmä{\ss}ig in einer
...
% Au{\ss}enseite des Oberarms vom Patienten stellen, danach den Kopf des
...
% In der
% Regel wird davon ausgegangen, dass der Verunglückte bei Bewu{\ss}tsein ist und
...
Helfer (\gE{Einhelfermethode}). Das Wichtigste ist, dass
der Kopf immer stablisiert und die Halswirbelsäule nicht gestaucht wird.
...
\includegraphics[width=\linewidth]{./images/koch-aass/HelmZweihelfer1b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/HelmZweihelfer2b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/HelmZweihelfer3b.JPG}
\\
Schritt 1 &
Schritt 2 &
Schritt 3 \\\addlinespace
\includegraphics[width=\linewidth]{./images/koch-aass/HelmZweihelfer4b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/HelmZweihelfer5b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/HelmZweihelfer6b.JPG}
\\
Schritt 4 &
Schritt 5 &
Schritt 6
...
{
\begin{tabularx}{\linewidth}{XXX}
\includegraphics[width=\linewidth]{./images/koch-aass/HelmEinhelfer1b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/HelmEinhelfer2b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/HelmEinhelfer3b.JPG}
\\
Schritt 1 &
Schritt 2 &
Schritt 3 \\\addlinespace
\includegraphics[width=\linewidth]{./images/koch-aass/HelmEinhelfer4b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/HelmEinhelfer5b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/HelmEinhelfer6b.JPG}
\\
Schritt 4 &
Schritt 5 &
Schritt 6
...
% ersthelferischen Ma{\ss}nahmen an manchen Stellen besonders zu
...
% entwickelt.}
% 
% \gEs{Der Helm ist immer abzunehmen, au{\ss}er der Patient verweigert dies!}
% 
% {
...
% drehen }{und}{ ziehen, bis kurz vor der äu{\ss}ersten
...
% stabilisiert; mit beiden Händen gleichmä{\ss}ig den Helm gerade zum
...
% umschlie{\ss}t. Beide Hände üben einen Zug des Kopfes vom Körper
% weg aus.}
% 
...
% weiter hinter genau durchzulesen und anschlie{\ss}end an dieser Stelle
% weiter zu lesen.
...
% aus einer Zeit in der standardmä{\ss}ig neben der Bewusstseins- und
...
% ein streng einzuhaltender Ma{\ss}nahmenkatalog vorgeschrieben, der aber
...
% blo{\ss}er Bewusstseinsreduzierung und totaler Bewusstlosigkeit
...
% des Kopfes um ca. 30{\textdegree}. Durch diese Ma{\ss}nahme wird die
...
% 
% {
% Nach Feststellen der Bewusstlosigkeit wei{\ss} der Ersthelfer, dass sich
...
Mundhöhle auf Fremdkörper kontrolliert. Anschlie{\ss}end wird der Kopf
nackenwärts \gEs{überstreckt} damit die zurückfallende
Zunge die Atemwege nicht blockiert. Nun kann die
Atemkontrolle durch \gEs{Hören}, \gEs{Sehen} und
\gEs{Fühlen} durchgeführt werden. Dafür wird das Ohr über
...
% grö{\ss}eren Pausen unterbrochene Atemzüge, die sich entsprechend
% ihres Namens wie das Schnappen nach einem Bissen äu{\ss}ern.}
% 
% {
...
Ersthelfer zu der Erkenntnis kommen, dass der Patient zwar \gEs{kein Bewusstsein} hat, aber 
...
Patient besitzt keine Schutzreflexe mehr und ist daher im
wahrsten Sinne des Wortes schutz- und hilflos. }{
\begin{itemize}
...
\gMassnahmenNG{Erste-Hilfe-Ma{\ss}nahmen}{Bewusstlosigkeit}{
\begin{itemize}
...
{
\begin{tabularx}{\linewidth}{XXX}
\includegraphics[width=\linewidth]{./images/koch-aass/Seitenlage1b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/Seitenlage2b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/Seitenlage3b.JPG}
\\
Schritt 1 &
Schritt 2 &
Schritt 3 \\\addlinespace
\includegraphics[width=\linewidth]{./images/koch-aass/Seitenlage4b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/Seitenlage5b.JPG}
&
\\
Schritt 4 &
Schritt 5 &
...
\begin{enumerate}
    \item  Den zum Ersthelfer näher liegenden Arm
    des Patienten im rechten Winkel auflegen.
    \item  Unter das gegenüber liegende
    ...
    überstrecken
\end{enumerate}
Die stabile Seitenlage bietet mehrere Vorteile. Sie bewirkt, dass
...
gewährleistet sie, dass bei Erbrechen der Gro{\ss}teil des
...
\gMarriedNG{Weiterführende Ma{\ss}nahmen
}{
Nachdem der Patient in die stabile Seitenlage gebracht wurde muss der
Ersthelfer weiterführende Ma{\ss}nahmen setzen, um Verschlechterungen
des Gesundheitszustandes zu vermeiden. Sehr wichtig ist der \gEs{Wärmeerhalt}. Der
Ersthelfer kann  sich hierfür unterschiedlicher Mittel bedienen, eines ist die,
in einer Autoapotheke gemä{\ss} \gAbk{ÖNORM} befindliche Rettungsdecke. Weiters muss eine
...
durch den Ersthelfer wird eine gro{\ss}e Bedeutung beigemessen.
}{
\begin{itemize}
...
% \subsubsection{7.1) anschlie{\ss}ende Behandlung:}
% 
% {
...
% Ma{\ss}nahmen sind {\quotedblbase}ersthelferische
...
%     Autoapotheke gemä{\ss}  ÖNORM befindliche Rettungsdecke.}
%     
%     \item  psychische Betreuung:
%     
%     {\scriptsize
...
Nach der Kontrolle Vitalfunktionen, kann der
Ersthelfer zum Ergebnis kommen, dass der Patient \gEs{kein Bewusstsein} und 
...
Sofortma{\ss}nahme} begonnen. }{
\begin{itemize}
    \item Nach der Kontrolle der Vitalfunktionen Notruf absetzen.
    \item Anschlie{\ss}end lebensrettende Sofortma{\ss}nahmen einleiten.
\end{itemize}
}

\gMassnahmenNG{Erste-Hilfe-Ma{\ss}nahmen}{Atem- und Kreislaufstillstand}{
\begin{itemize}
...
% \gMarriedNG{Lebensrettende Sofortma{\ss}nahme
% }{
...
zwischen Wirbelsäule und Brustbein ein künstliches Flie{\ss}geschehen
(Zirkulation) des Blutes.

\gMarriedNG{Technik
}{
\gEs{Position und Druckpunkt} Der Patient muss auf einem
...
\gEs{Arm- und Körperhaltung} Die richtige
    ...
    hervorragende Leistung zu erzielen. Die \gE{Finger
    sollten verschränkt sein}, nur der \gE{Handballen liegt am Brustbein}. Die \gE{Arme bleiben gestreckt}
...
Das Schlimmste, das der Ersthelfer falsch machen kann ist,
 ...
 einen oder anderen Fehler kommen. Ein Bett ist \gEs{keine
 feste Unterlage}! Es darf nicht vergessen zu werden, den
 Patient auf den Boden oder eine andere harte Unterlage zu
 legen.
...
-einrei{\ss}ung durch einen zu tiefen Druckpunkt.  
...
\gT{Mund--zu--Mund--Beatmung}. Dabei wird bei überstreckten Kopf mit der stirnseitigen Hand die Nase des Patienten zu gedrückt. Anschlie{\ss}end mit dem eigenen Mund den des Patienten umschlie{\ss}en und
...
zugehalten. Anschlie{\ss}end mit dem eigenem Mund die Nase des Patienten um
schlie{\ss}en und die Lippen luftdicht an den Patienten drücken. Nun wird die eigene
...
21\,\%. Der \ce{O2}-Gehalt in der \gEs{Ausatemluft} beträgt
noch 16\,\%, d.h. der Mensch verbraucht  nur 5\,\% des
...
\gMarriedNG{Bei der Beatmung ist zu beachten: 
}{
Ein \gEs{zu hohes Atemzugsvolumen} führt zu einem
höheren Druck im Nasen-Rachenraum, sobald die Lunge
vollständig mit Luft befüllt ist. Die Luft findet nur den
Ausweg über die Speiseröhre in den Magen. Dies kann während einer Herz-Lungen-Wiederbelebung meist unbemerkt geschehen. Bei einem \gEs{zu niedrigem Atemzugsvolumen} ist die
\ce{O2}-Versorgung nicht sichergestellt, da die Luft nicht bis in die
Lunge kommt. Bei Bartträgern kann es zu einer
\gEs{ungenügenden Abdichtung} kommen. Eine \gEs{zu hohe
Atemfrequenz} hindert den Patienten am Ausatmen. Wenn es
beim Atemwege freimachen zu einer \gEs{mangelnden Überstreckung} des Kopfes kommt, kann es zu einer unzureichenden Belüftung der Lunge kommen. Bei jeder
...
ansprechbar ist, wird um Hilfe gerufen. Anschlie{\ss}end durch
...
{
\begin{tabularx}{\linewidth}{XXX}
\includegraphics[width=\linewidth]{./images/koch-aass/Rea1b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/Rea2b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/Rea3b.JPG}
\\
Schritt 1 &
Schritt 2 &
Schritt 3 \\\addlinespace
\includegraphics[width=\linewidth]{./images/koch-aass/Rea4b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/Rea5b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/Rea6b.JPG}
\\
Schritt 4 &
Schritt 5 &
Schritt 6
\\\addlinespace
\includegraphics[width=\linewidth]{./images/koch-aass/Rea7b.JPG}
&
&
\\
Schritt 7 &
...
(Reanimation)\index{Bilderserie!Reanimation}\index{Reanimation!Bilderserie}}{}
...
% Ma{\ss}nahmen der Reanimation. Eine ausführlichere Darstellung findet
...
\begin{description}
    \item[Der Patient zeigt \gEs{Lebenszeichen}.] Entweder 
   erwacht der Patient und ist ansprechbar, eine
   leider äu{\ss}erst seltene Form der Reanimationsbeendigung,
   oder der Patient gibt ein Husten oder Räuspern von sich
   bzw. atmet beim Beatmungsvorgang dem Ersthelfer entgegen. \gEs{Erbrechen zählt \gE{nicht} als Lebenszeichen.}
...
% beschriebenen anschlie{\ss}enden Behandlung  weiterversorgt werden.
...
aufgrund der körperlichen Anstrengung im Zusammenhang mit der  Reanimation all seine Kräfte 
aufbrauchen, sodass er sie nicht fortführen kann, ist es  ihm erlaubt diese
...
%         
%         {\scriptsize
%         Der Patient erwacht und ist ansprechbar. Eine leider äu{\ss}erst
...
\gMarriedNG{Anschlie{\ss}ende Behandlung}
{
Die anschlie{\ss}enden Behandlungen orientieren sich an den
...
vorhanden ist, Umlagerung in die stabile Seitenlage. Anschlie{\ss}end weiterführende Ma{\ss}nahmen gemä{\ss} Notfalldiagnose
Bewusstlosigkeit. 

Bei Eintreffen von \gEs{kompetenter Hilfe} muss der Ersthelfer
dem Rettungspersonal Auskunft über relevante Umstände und
die gesetzten Ma{\ss}nahmen geben. 
...
finden. Scheitert auch dieser Versuch, kann der Ersthelfer keine weiteren 
Ma{\ss}nahmen setzen als den Patienten zuzudecken und auf das
...
\begin{itemize}
    ...
    ersthelferische Ma{\ss}nahmen geben
...
% \subsubsection{8.2) anschlie{\ss}ende Behandlung:}
% 
% {
% Die anschlie{\ss}enden Behandlungen orientieren sich an den
...
% Umstände und gesetzte  ersthelferische Ma{\ss}nahmen geben.}
% 
% {
...
%    Bewusstsein: erneute 5 Rückenschläge mit anschlie{\ss}ender
% Kontrolle
% 
...
\gMassnahmenNG{Erste-Hilfe-Ma{\ss}nahmen}{Starke Blutungen}{
\begin{itemize}
    \item Blutstillung
    \begin{itemize}
...
Grö{\ss}en, Dreiecktücher und Mullbinden. Oft sind auch Verbandspäckchen vorhanden. Hier
ist eine Wundauflage bereits in die Mullbinde eingearbeitet.
}{}{./images/koch-aass/MaterialDruckverbandb.JPG}{}{}

\gMarriedNG{Blutstillung durch Zudrücken
}{
Durch \gEs{festen Druck} mit Finger, Handballen oder Faust, je nach grö{\ss}e der
...
kann jeweils an der betroffenen Seite an der Schläfe abgedrückt werden. Bei Blutungen im Bereich des Gesichtes je nach Seite
...
in fast allen Situationen funktioniert sowie einfach und
...
an den Gliedma{\ss}en angelegt werden. Beim Druckverband wird nur Druck auf das
verletzte Gefä{\ss} ausgeübt. Somit ist die Durchblutung der Extremitäten unterhalb
...
{
\begin{tabularx}{\linewidth}{XXX}
\includegraphics[width=\linewidth]{./images/koch-aass/Abdrueckenb.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/Druckverband1b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/Druckverband2b.JPG}
\\
Schritt 1 &
Schritt 2 &
Schritt 3 
...
massiv zu den Folgeschäden verschoben hat. Au{\ss}erdem hat
...
\gEs{nur am Oberarm und Oberschenkel}, denn dort befindet
sich nur ein Knochen, gegen den sämtliche Blutgefä{\ss}e
gedrückt werden können. Dazu darf nur ein \gEs{breites und
schonendes Material} verwendet werden (z.B. Dreiecktuchkrawatte). Nachteil ist die nicht mehr gegebenen Blutversorgung
...
Oberschenkel des Patienten.\footnote{Bislang wurde
empfohlen, dass die maximale Abbindezeit 30 Minuten
betragen soll. Zum Beispiel PHTLS empfiehlt einmal
angebrachte Abbindungen bis zur definitiven Versorgung
(auch nicht probeweise) zu öffnen. \cite{PHTLS6}} }{
\begin{itemize}
...
{
\begin{tabularx}{\linewidth}{XXX}
\includegraphics[width=\linewidth]{./images/koch-aass/AbbindungArm1b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/AbbindungArm2b.JPG}
&
\\
Schritt 1 &
Schritt 2 &
...
{
\begin{tabularx}{\linewidth}{XXX}
\includegraphics[width=\linewidth]{./images/koch-aass/AbbindungBein1b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/AbbindungBein2b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/AbbindungBein3b.JPG}
\\
Schritt 1 &
Schritt 2 &
Schritt 3 \\\addlinespace
\includegraphics[width=\linewidth]{./images/koch-aass/AbbindungBein4b.JPG}
&
&
\\
Schritt 4 &
...
\gMarriedNG{Versorgung abgetrennter Gliedma{\ss}en
}{
Die abgetrennten Gliedma{\ss}en sind \gEs{immer in das Spital mitzunehmen}. Nach
...
Der Schock ist eine \gEs{lebensbedrohliche Kreislaufstörung}, bei der es zu einer
\gEs{Unterversorgung der lebenswichtigen Organe}, wie Hirn,
Herz, Lunge, Leber und Niere mit Sauerstoff kommt. 

\subparagraph{Zentralisation} Der Körper hilft sich
selbst in dem er das Blut zu den lebenswichtigen Organen bringt und äu{\ss}ere Körpergebiete wie Arme,
...
wichtige Körperregionen flie{\ss}en. Der dadurch entstehende Sauerstoffmangel
bei den lebenswichtigen Organen führt zu einer \gEs{Schädigung der Organe}, der
im Weiteren zum \gEs{Versagen der Organe} führt. Der Schock
...
starken Blutungen. Flüssigkeitsverlust kann bei gro{\ss}flächigen Verbrennungen und
...
zwar auch die Blutmenge konstant, aber die Gefä{\ss}e erweitern sich. Daher
entsteht ein unzureichender Druck in den Gefä{\ss}en und das Blut kann nicht weiter
...
% 
% {
% {\textit{ Im Idealzustand sind alle Gefä{\ss}e im Körper bis
% zum Rand mit Blut gefüllt. Durch diese 
% {\quotedblbase}Vollfüllung{\textquotedblleft} wird ein Druck in den
% Gefä{\ss}en aufgebaut, der gewährleistet, dass das Blut in alle 
% Körperregionen transportiert werden kann. Verliert der Körper
% massiv Blut und kann er  dadurch den Druck in den Gefä{\ss}en nicht
...
% unterversorgt, dadurch geschädigt und schlie{\ss}lich absterben.}}}
% 
% {
%  ii) Vergiftungen und allergische Reaktionen:}
% 
% {\itshape
%  Bleibt zwar das Blutvolumen konstant, die Gefä{\ss}wände erweitern
% sich aber in Folge einer  Vergiftung oder allergischen Reaktion,
% entsteht derselbe unzureichende Druck in den  Gefä{\ss}en. Die Organe
% werden unterversorgt, dadurch geschädigt und schlie{\ss}lich
% absterben.}
% 
% {
%  iii) Herzversagen:}
% 
% {\itshape
%  Selbst bei besten Druckverhältnissen in den Gefä{\ss}en kann es zu
...
Der Patient kann eine \gEs{blasse Haut} haben. Weiters besteht die Möglichkeit, dass er
\gEs{zittert und friert} aber paradoxerweise dazu einen
\gEs{kalten, klebrigen Schwei{\ss}} auf der Stirn hat. Der Patient kann ausserdem \gEs{verwirrt, unruhig
...
\begin{itemize}
    ...
    \item kalter klebriger Schwei{\ss}
...
% 
% {
%  iv) gro{\ss}e Angst und Unruhe (Patienten verwenden des Öfteren den
...
\gMassnahmenNG{Erste-Hilfe-Ma{\ss}nahmen}{Schockbekämpfung}{
...
% geschwächten Herzen mittels  Schwerkraft in den Gro{\ss}teil des
...
% anschlie{\ss}end die Ursache des Schocks (falls überhaupt möglich)
...
% ist. Der Magen selbst ist mit einer äu{\ss}erst resistenten 
...
% Er muss sich  vorrangig auf die nachstehenden Ma{\ss}nahmen
% beschränken.}
% 
% 
% 
...
% genüge tun, äu{\ss}erst gering ausgestattet, weil das Gesetz einen
% viel zu gro{\ss}en  Spielraum frei lässt. Mitunter reichen {\S} 102
...
% Gefä{\ss} (Arterie) so fest zu,  bis die Wunde aufhört zu bluten. }
% 
% {\itshape
...
% Gliedma{\ss}eneinklemmung durchgeführt werden. Des Weiteren darf zur
...
% Dreiecktuchkrawatte derma{\ss}en streng gewickelt, dass auf die Wunde
% ein  ausreichend starker Druck zur Stillung der Blutung ausgeübt
% wird. Dabei muss der  abschlie{\ss}ende Knoten direkt auf dem
...
% Erste-Hilfe-Ma{\ss}nahmen daran denken weitere, professionelle Hilfe zu
% verständigen. }
% 
% {
...
% Sofortma{\ss}nahmen gesetzt werden. Bei einem bewusstlosen Patienten
...
\gEs{Wo} ist der Notfallort? Ist es nicht möglich eine
...
reicht die Wahrnehmungen weiter zugeben. Es müssen keine
Diagnosen gestellt werden. 

\gEs{Wie viele} Leute sind betroffen? Hier ist es
...
Die drei traditionell in Österreich geltenden Notrufnummern
lauten wie folgt:
...
{
Die
\gEs{Vergiftungsinformationszentrale} (VIZ) dient nur dazu
Auskunft über die Risiken und Behandlungen von sicher festgestellten Vergiftungen zu
geben (\gE{Expertenrat}). Der Anruf bei der VIZ erspart
nicht einen Anruf beim Rettungsdienst.
...
Notfälle bewältigen zu können. Sein Zweck liegt in der
Behandlung von allgemeinmedizinischen "`Ordinationsfällen"'. Ausserdem hat er durchschnittliche
Wartezeiten von zwei bis drei Stunden\footnote{Ein Umstand,
welcher leider viele Pateinten dazu verleitet lieber bei der Rettung anzurufen, welche
...
Die weitere Erste Hilfe umfasst Ma{\ss}nahmen zur Versorgung von
...
länger als 2 cm sind, gemeint. Bei idealer Behandlung durch
den Ersthelfer müssen diese nicht von einem Arzt versorgt
werden. }{
\begin {itemize}
...
\gMassnahmenNG{Erste-Hilfe-Ma{\ss}nahmen}{Bagatellverletzungen}{
...
\item \gEs{Es kommt nichts aus der Wunde heraus.}
Fremdkörper, welche ein Blutgefä{\ss} durchtrennen, können dieses eventuell abdichten. Wenn nun der Fremdkörper entfernt wird, kommte es zu einer stark blutenden Wunde. 

\end{enumerate}
 Die anschlie{\ss}ende
...
&
damit diese wieder richtig verheilen kann wird sie meistens
im Spital genäht \\\addlinespace
\noindent\gEs{Verbrennungen, Verbrühungen}
&
werden erst ab einer bestimmten Grö{\ss}e bzw. einer gewissen Schädigung der Haut
bedrohlich
\\\addlinespace
\noindent\gEs{Wunden mit Fremdkörper}
&
ab einer gewissen Grö{\ss}e des Fremdkörper macht es Sinn diesen von einem Arzt
...
\\\addlinespace
\noindent\gEs{Wunden an Gelenken, Hand- und Fu{\ss}rücken}
&
...
die Infektionsgefahr sehr gro{\ss}
\\\addlinespace
...
Um festzustellen wie bedrohlich die Verbrennung für den Patienten ist, muss der Schweregrad der Schädigung der Haut eingeteilt werden. Dies geschiet
mittels drei Grade. Beim \gEs{1.~Grad} kommt es zur Rötung der Haut, einer
Schwellung des Gewebes und zu Schmerzen. Beim \gEs{2.~Grad}
kommte es zur Blasenbildung. Es bestehen weiterhin
Schmerzen. Beim \gEs{3.~Grad} kommte es zur Schorfbildung. Die Schmerzen hier sind abhängig von der Tiefe der Schädigung
der Haut.
}{
\begin{itemize}
...
Verbrennung. Damit ist gemeint, wieviel \% der Körperoberfläche sind verbrannt. Dazu gibt es
zwei Möglichkeiten. Einerseits die \gEs{Handregel}, welche
besagt dass die Handfläche des Patienten  1\,\%
seiner Körperoberfläche entspricht. Da dies in der Praxis
bei gro{\ss}flächigen Verbrennungen meist umständlich ist, gibt
es auch noch die \gEs{Neunerregel}. Hier wird der Körper in
9\,\%-Teile eingeteilt.
...
\gMassnahmenNG{Erste-Hilfe-Ma{\ss}nahmen}{Verbrennungen}{
\begin{itemize}
    \item Hitzeeinwirkung sofort stoppen.
    \item Mind. 10\,min mit mä{\ss}ig kaltem Wasser kühlen.
...
\gMassnahmenNG{Erste-Hilfe-Ma{\ss}nahmen}{Erfrierungen}{
...
\gMassnahmenNG{Erste-Hilfe-Ma{\ss}nahmen}{Unterkühlung}{
...
\gMassnahmenNG{Erste-Hilfe-Ma{\ss}nahmen}{Verstauchung}{
...
\gMassnahmenNG{Erste-Hilfe-Ma{\ss}nahmen}{Verrenkung}{
...
Knochenbruchs ist daher der \gEs{Blutverlust}. Je grö{\ss}er der Blutverlust ist
umso grö{\ss}er ist wiederum die Gefahr, dass der Patient in den \gEs{Schock}
...
\gMassnahmenNG{Erste-Hilfe-Ma{\ss}nahmen}{Knochenbrüche}{
...
\gMassnahmenNG{Erste-Hilfe-Ma{\ss}nahmen}{Vergiftungen}{
\begin{itemize}
...
\gMassnahmenNG{Erste-Hilfe-Ma{\ss}nahmen}{Verätzungen der Haut}{
...
\gMassnahmenNG{Erste-Hilfe-Ma{\ss}nahmen}{Verätzungen der Augen}{
...
\gMassnahmenNG{Erste-Hilfe-Ma{\ss}nahmen}{Verätzungen des
Verdauungstrakts}
{ 
\begin{itemize}
...
\gLayout{22}{}{
Pflasterverbände können überall an Händen und Fü{\ss}en
eingesetzt werden. Sie müssen dazu nur passend
zugeschnitten werden. Dort, wo das Pflaster umgebogen werden
muss, schneidet man es keilförmig
aus. }{}{./images/koch-aass/Pflasterb.JPG}{}{}
...
{
\begin{tabularx}{\linewidth}{XXX}
\includegraphics[width=\linewidth]{./images/koch-aass/Kopfverband1b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/Kopfverband2b.JPG}
&
\\
Verband 1 &
Verband 2 &
...
{
\begin{tabularx}{\linewidth}{XXX}
\includegraphics[width=\linewidth]{./images/koch-aass/Schulterverband1b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/Schulterverband2b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/Schulterverband3b.JPG}
\\
Schritt 1 &
Schritt 2 &
Schritt 3 
...
{
\begin{tabularx}{\linewidth}{XXX}
\includegraphics[width=\linewidth]{./images/koch-aass/Handverband1b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/Handverband2b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/Handverband3b.JPG}
\\
Schritt 1 &
Schritt 2 &
Schritt 3 \\\addlinespace
\includegraphics[width=\linewidth]{./images/koch-aass/Handkrawatte1b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/Handkrawatte2b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/Handkrawatte3b.JPG}
\\
Schritt 1 &
Schritt 2 &
Schritt 3
...
{
\begin{tabularx}{\linewidth}{XXX}
\includegraphics[width=\linewidth]{./images/koch-aass/Knieverband1b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/Knieverband2b.JPG}
&
\includegraphics[width=\linewidth]{./images/koch-aass/Knieverband3b.JPG}
\\
Schritt 1 &
Schritt 2 &
Schritt 3 
...
% geistigen) Integrität des Patienten durch äu{\ss}ere
...
% und sich anschlie{\ss}end auf den gesamten Körper ausbreiten. Als
...
% 
% {
% Sind Verletzungen bei denen eine Gewalteinwirkung grö{\ss}ere
...
% 
% \gMassnahmenNG{Erste-Hilfe-Ma{\ss}nahmen}{}{
% \paragraph{Erste-Hilfe-Ma{\ss}nahmen}
% 
% }
% 
% {
...
% einschlie{\ss}lich des Schlüsselbeins:}
% 
% {
...
% Ellenbogen positioniert, das äu{\ss}ere  Ende geht zur vom Knoten
...
% anschlie{\ss}end wieder seine ursprüngliche Position einnimmt.}}
% 
% {
% Kennzeichen:}
% 
...
% denen ein Gelenkskopf aus seiner Pfanne herausgedreht wird und
% anschlie{\ss}end in dieser abnormen Position verbleibt.}}
% 
% {
% Kennzeichen:}
% 
...
% gro{\ss}er Hitze, die von unterschiedlichen Materialen ausgehen kann.
...
% durch Feuer, Strahlung, Reibung, Strom, hie{\ss}e feste Gegenstände
...
% 
% {
% Zur Ermittlung der 5\% oder 10\% nimmt man als Ma{\ss}stab die Hand des
...
% 
% {
%  i) mind. 10 Min. Kühlen mit mä{\ss}ig kaltem Wasser (kein Eis oder
% eiskaltes Wasser)}
% 
% {
...
% ausgeschnitten hat, abzudecken. Anschlie{\ss}end durchzuführen ist: }
% 
% {
%  i) Notrufabgabe}
% 
...
% au{\ss}en erwarten würde!}
% 
% {
% Anschlie{\ss}end durchzuführen ist: }
% 
% {
%  i) Notrufabgabe}
% 
...
% 
% {
% Auch die Schusswunde besteht meist aus einer grö{\ss}eren
% unsichtbaren, inneren Verletzungen als man es von au{\ss}en
...
% betroffene Auge unter flie{\ss}endem Wasser zu reinigen. Dabei muss das
% verletzte Auge nach unten gehalten werden, damit das unverletzte Auge
% nicht im Zuge der Reinigung mit beeinträchtigt wird. Grö{\ss}ere
% Fremdkörper sind im Auge zu belassen und dürfen nicht versucht
% werden hinausgespült zu werden.}
% 
% {
% Anschlie{\ss}end muss nicht nur das verletzte Auge verbunden werden,
...
% Patient ist ab nun äu{\ss}erst hilfsbedürftig. Bevor man einen
% weiteren Schritt setzt muss dies dem Patienten ausdrücklich
% mitgeteilt werden.}
% 
% {
% Abschlie{\ss}end durchzuführen ist: }
% 
% {
%  i) Notrufabgabe}
% 
...
% durch den Biss selber. Hierbei gilt, umso grö{\ss}er und gewaltiger
% die Bei{\ss}werkzeuge, desto grö{\ss}er die Wunde. Als plakatives
% Beispiel dient der Biss eines Hamsters im Verhältnis zum Biss eines
% wei{\ss}en Hais. \ Die andere Gefahr liegt in der Wundentzündung, in
...
% 
% {
% Beim Mann wie bei der Frau sind die Genitalbereiche au{\ss}erordentlich
% gut versorgt mit Nerven und Gefä{\ss}en. Daher können auch
% geringfügige Gewalteinwirkungen gro{\ss}e Schäden und insbesondere
...
% ist eine mä{\ss}ige Kühlung zu empfehlen bei raschem Aufsuchen
...
% auffällig viel Blut nach au{\ss}en sichtbar wird. Die tatsächliche
...
% psychischen Integrität ohne äu{\ss}ere Gewalteinwirkung. Sie
...
% 
% {
% Beiden Erkrankungen ist gleich, dass sie in den Herzkranzgefä{\ss}en
% (also jenen Gefä{\ss}en die das Herz mit Blut versorgen) zu einer
...
% 
% {
% Die Herzkranzgefä{\ss}e werden derart stark verstopft, dass die Region
...
% Gefä{\ss}es vor der Verstopfungsstelle kommen. Da der Gewebstod zu
...
% 
% {
%   g) abschlie{\ss}ende Behandlung durch Wärmerhalt sichern, laufende
...
% 
% {
% Hierbei werden die Herzkranzgefä{\ss}e nicht komplett verstopft,
...
% 
% {
% Genauso wie das Herz muss auch das Gehirn äu{\ss}erst stark
% durchblutet sein. Kommt es in einem Hirngefä{\ss} zum Verlegen oder
...
% 
% {
%   f) abschlie{\ss}ende Behandlung durch Wärmerhalt sichern, laufende
% Kontrolle,   psychische Betreuung}
% 
% }
% 
...
% unterschiedlich äu{\ss}ern, so kann es von kurzfristig geistigen
% Abwesenheitszuständen bis hin zu länger dauernden Krämpfen mit
% anschlie{\ss}ender Bewusstlosigkeit kommen. Eindeutige Kennzeichen sind
% wie folgt:}
% 
% \subparagraph{
% Kennzeichen:}
...
% 
% {
%   a) stabile Seitenlagerung (für den bewusstlosen sowie blo{\ss}
% schlafenden    Patient); Lagerung mit erhöhtem Oberkörper für den
% blo{\ss} verwirrten Patient  b) Mundausräumen (ein Tuch um zwei
...
% 
% {
%   d) abschlie{\ss}ende Behandlung mittels Wärmerhalt sichern, laufende
% Kontrolle,   psychische Betreuung}
% 
% }
% 
...
% 
% {
%  i) anfänglich rote Haut, dann blass, kaltschwei{\ss}ig \& feucht}
% 
% {
...
% Haut warm, gerötet, Schwei{\ss} möglich}}
% 
% {
...
%   a) Kopfschmerzen  
% 
%   b) trockene, gerötete, hei{\ss}e Haut
% 
...
% &
% Eiwei{\ss} beginnt zu gerinnen; Stoffwechsel bricht zusammen; Tod 
% \\\addlinespace\bottomrule
% \end{tabulary}
% \end{table}
% 
% \gMassnahmenNG{Erste-Hilfe-Ma{\ss}nahmen}{}{\paragraph{Erste-Hilfe-Ma{\ss}nahmen}
% 
% {
...
% 
% {
%   d) abschlie{\ss}ende Behandlung durch Wärmerhaltsicherung, laufender
%    Kontrolle, psychische Betreuung}
% }
% 
...
% selbst ist mit einer äu{\ss}erst resistenten Magenschleimhaut
...
% richtig! Denn der lebende Mensch erfährt äu{\ss}erst selten eine
...
% 
% {
%  iv) anschlie{\ss}ende Behandlung durch Wärmeerhaltsicherung, laufende
...
% 
% 
% \subsection{14) abschlie{\ss}ende Behandlung:}
% 
% {
% Zum Abschluss des Themenblock Weitere Erste Hilfe, aber eigentlich auch
% lebensrettende Sofortma{\ss}nahmen, ist nochmals zu wiederholen, dass
...
% Ma{\ss}nahmen hingewiesen worden sein, bedeutet es nicht, dass sie
...
% Problematiken nicht verschlie{\ss}en sollten. Die oben erwähnten
% Grundsätze gelten auch für den Katastrophenbereich, mit der
% Besonderheit, dass die Interessenabwägung einen grö{\ss}eren
...
% sogar vor der Entscheidung eine Ma{\ss}nahme nur an einen Patienten
...
% 
% {
% Das diese Entscheidungen und Ma{\ss}nahmen äu{\ss}erst schwierig zu
...
% Sofortma{\ss}nahmen am Ort des Verkehrsunfalls (Wien:
...
% Handbuch. Sofortma{\ss}nahmen bei Babys, Kindern und Erwachsenen
