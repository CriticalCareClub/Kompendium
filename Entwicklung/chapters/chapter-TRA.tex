...
\Definition{Die Verbrennung ist eine durch Hitzeeinwirkung
...
\begin{enumerate}
  ...
  elektrischen Stromes wird in Ampere (A) gemessen.}, der Stromart (Gleich- oder Wechselstrom), dem Weg des Stromes durch den Körper, dem Kontaktwiderstand (feuchte Hände, Wasserlacke, \ldots) und der Einwirkzeit. Meistens sind die Zahlenwerte dieser Faktoren im
  Einsatzfall jedoch nicht bekannt, sodass eine theoretische Abschätzung der
  Gefährung praktisch nicht durchführbar ist. 
  \item Die Strommarken (Verbrennungen an den Ein- und Austrittsstellen) sind
  i.\,d.\,R. klein, sodass die Schädung im Körperinneren nicht abgeschätzt
