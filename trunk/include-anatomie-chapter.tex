...
Zellkern\index{Zellkern}, der die gesammten Erbinformationen enthält und verschiedenen
Zellorganellen\index{Zellorganellen}. Sie wird von der
...
\item[\gT{Kortikalis}] \index{Kortikalis}feste äußere
Schicht, äußere Form
...
\item[\gT{Gelenkfläche}] \index{Gelenkfläche!Wufbau des
...
\paragraph{Rotes Knochenmark ist für die Blutbildung
zuständig}
\index{Knochenmark!rotes}

Das rote Knochenmark ist das blutbildende Organ
schlechthin. Hier werden \gT{Rote Blutkörperchen}
(\gT{Erythrozyzen}), \gT{weiße Blutkörperchen} (\gT{Leukozyten}) sowie
\gT{Blutplättchen} (\gT{Thrombozyten}) gebildet
...
Röhrenknochen zu fettreichem, gelben Knochenmark um. 

Das gelbe Fettmark kann bei schweren Knochenverletzungen von Bedeutung
sein, da verletzungs\-bedingt kleine Fettptröpchen in die Blutbahn
gelangen können, die dann als Fettgerinnsel  zu ernsten
...
hingegen vollständig \gE{verknöchert}, sodaß
...
(der Schädel muß sich für Geburt verformen
...
\paragraph[Schädelbasis]{Schädelbasis}~
...
auf \gZ{(ausser wenn man auf dem Kopf steht)}. Hirnnerven treten durch die diversen Löcher aus dem
...
\index{Beckengürtel}\index{Extremität, untere}
...
\gMarried{
\subsubsection{Der Beckengürtel}
...
\subsubsection{Die untere Extremität}
...
\begin{itemize}
    ...
    \item 8 \gEs{Fußwurzelknochen}, \gZ{u.a. Sprungbein,
    Fersenbein}
...
\gSourcePicture{Wikipedia,  Jörg Rittmeister. G-FDL, CCAL}}
}
...
\gT{Herzkranzgefäße} (\gT{Koronargefäße}) welche
direkt aus der Hauptschlagader abgehen.

\paragraph{Schichten}

3 Schichten (außen nach innen):
...
\gMarried{Eigenständiges  Erregungs- und  Reizleitungssystem, streng
...
ähnlich dem Geäst eines Baumes, bishin zu
...
muskulösen Arterien.} Ein \gT{Shunt} ist eine künstlich
...
\toprule
\multicolumn{4}{c}{\gTabHeading{Übersicht wichtiger
Blutgefäße}}
\\\midrule
\gEs{Hauptschlagader}
 &
...
Vene
 &
Führt O2-armes, aber nährstoffreiches Blut von Teilen des Darms zur
...
und Venen. Hierfindet der Gas- und Nährstoffaustausch statt. Es gibt
...
\begin{itemize}
    ...
    (pH-Wert muß konstant zwischen 7,35 und 7,45 liegen!)}
\end{itemize}
...
\begin{itemize}
    ...
    \item Körperabwehr, Entzündungszellen
    \item
...
\begin{itemize}
    ...
    \item Wichtige Rolle beim Wundverschluß
...
\begin{itemize}
\item \gT{Motorisches} (willkürliche Bewegung),
...
% filtert daher besonders gut und nur für bestimmte Moleküle ($O_2$,
...
\captionof{figure}{\gAuthNotesPicLegalNotOk{img34}{}Rückenmark
...
\begin{figure}[H]
    ...
    Einfluß auf viele Organe. Diese Bild
...
Körpergewichtsaus und ihre Oberfläche beträgt beim
...
\begin{itemize}
    ...
    \item Temperaturregulation (Schweiß)
...
und Kehlkopf kommende Luft zur Lunge weitergeleitet. Die Luftröhre teilt sich ein einen
...
bis schlußendlich sehr dünne \gT{Bronchioli} in die
...
Die Lunge hat 2 Flügel, welche sich jeweils in 3 (rechts) bzw. 2
...
\\\toprule
\multicolumn{1}{c}{Rechter Flügel}
 &
\multicolumn{1}{c}{Linker Flügel}
\\
\begin{itemize}
    \item \gEs{3} Lappen
    \begin{itemize}
...
Die Oberfläche ist mit dem \gT{Lungenfell}, der
\gE{lungenseitigen} \gT{Pleura}, überzogen. In einem
Lungeflügel verzweigt sich der Hauptbronchus in immer weitere kleinere Bronchien bis schließlich die Bronchioli in
...
\begin{itemize}
    ...
    Brustwand und Zwerchfell verwachsen, kleidet damit die Brusthöhle aus)
    \item \gE{Lungenseitige} Pleura (\gT{Lungenfell},
    überzieht die Lungenoberfläche)
...
Kehldeckel verschliesst beim Schlucken die Luftröhre
\\\hhline{---}
\gEs{Speiseröhre} (\gZ{Ösophagus})
 &
 &
...
\\\hhline{---}
\multirow{4}{8em}{\gEs{Dünndarm}}
&
\gT{Zwölffingerdarm} \gZ{Duodenum}
 &
...
\\\hhline{~-~}
 &
\gEs{S-förmig} gebogener Teil (\gZ{Sigma})
 &
\\\midrule
...
\begin{itemize}
    ...
    \item Salzsäure (Bakterienfalle, pH 1,0)
    ...
    Magenpförtner \gZ{(Pylorus)} in den Zwölffingerdarm
\end{itemize}
...
{\begin{itemize}
    ...
    \begin{itemize}
        ...
        hängt die
    \end{itemize}
    \item \index{Gallenblase}Gallenblase: Nur Speicher für
    Galleflüssigkeit
...
\begin{itemize}
    ...
    Gutes kommt zurück ins Blut, der Rest fliesst weiter Richtung
...
Prostata und den Penis und mündet an der Eichel in die Aussenwelt.
Bei einer Vergößerung der Prostata kann der Harnabfluß bis
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            zum Harnstau ${\rightarrow}$ häufger Notfall!
        \end{itemize}
    \end{itemize}
    \item außen:
    \begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        reifen Eis in Richtung Gebärmutter
        \item \gEs{Gebärmutter}
    ...
    \begin{itemize}
        ...
        \item \gT{Klitoris}: entspricht der männlichen
        Eichel
    \end{itemize}
\end{itemize}
