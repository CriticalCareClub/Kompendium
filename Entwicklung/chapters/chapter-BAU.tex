...
(\PerMin). Neben der Frequenz wird auch die
...
erfolgen (\FullPrettyRef{topic:pulsoxymetrie}). Dabei misst ein
...
Die Messung des Blutdrucks ist unter
\FullPrettyRef{topic:rr-messung}, beschrieben.
