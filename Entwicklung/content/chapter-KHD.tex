...
\begin{itemize}
  ...
  evtl. abschließene medizinische Behandlung, 
  ...
  bzw. Ersatzeirichtugnen errichtet werden. 
...
die \EE{Räume und Stellen} festlegt,
das ihm zur Verfügung stehende\EE{Personal} einteilt,
die ihm unterstellten \EE{Leiter} bestellt,
das notwendige \EE{Material} anfordert,
die \EE{Verbindung zur Einsatzleitung} hält
und eine eventuell notwendige die \EE{Ablösung} anfordert.
...
Der \T{Leiter Transportraum} führt den Transportraum. 
Er \EE{gliedert} seinen Raum, 
...
Behandlungsmaßnahmen und Befunden. 
Der wichtigste
Bestandteil ist die
...
\begin{enumerate}
  ...
  Patienten, welche
  \E{bevorrangt aus dem Schadensbereich gerettet} werden sollen, 
