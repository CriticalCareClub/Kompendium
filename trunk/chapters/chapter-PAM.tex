...
\begin{itemize}
  \item Sicherheit, Selbstschutz; Großschaden?; Umgebung, Ort, Zeit; Umstände,
Hinweise auf Unfallmechanismus
\end{itemize}
}
...
\Layout{60}{GI -- Ersteindruck}{%
\Z{(\Lang{engl.} General Impression.)} Hier wird v.\,a. das 
Aussehen, der Gesichtsausdruck, die Körperhaltung und die Sprache des Patienten
beurteilt.
...
Untersucht wird die \E{Frequenz}, das \E{Atemmuster}, die \E{Anstrengung} des
...
Die erste Einschätzung des Kreislaufes dauert nur weniges Sekunden.
Beurteilt wird die \E{Hautfarbe} und \E{-temperatur}, ob und wie gut
der \E{Radialispuls} zu tasten ist, sowie die \E{Rekap-Zeit} an den
Fingerkuppen. 
}{%
\begin{itemize}
