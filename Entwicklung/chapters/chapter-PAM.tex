...
\ChapterIntro
{%
Unter dem Begriff Patientenmanagement fast man alle
Maßnahmen und Entscheidungen zusammen, die der Untersuchung,
Betreuung und Behandlung von Patienten und Abhandlung von Einsätzen und
anderen patientenbezogenenen Aufträgen dienen, sowie die
richtige und angemessene zeitliche Abfolge dieser Maßnahmen.
...
und das Beherrschen von medizinischem Wissen und
sanitätshilflichen Fertigekeiten. Das Erarbeiten von
(Verdachts-)Diagnosen mittels Patientengespräch und
Untersuchungen sowie das Beherrschen der theoretischen
medizinischen Grundlagen sind weitere Voraussetzungen für
effektives und professionelles Arbeiten.
}
{%
\begin{description}
...
\begin{itemize}
  ...
  Atemnot, verwaschene Sprache, Desorientiertheit, Krämpfe,
...
Atemnot, eine zu schnellle oder langsame Atmung
(Tachy-/Bradypnoe), eine flache oder tiefe Atmung,
pathologische Atemmuster, eine Schnappatmung, eine paradoxe
oder überhaupt fehlende Atmung, sowie besondere Umstände wie
das vorhandensein von Heimsauerstoff oder anderen
Atemhilfen.
}{%
\begin{itemize}
  \item Frequenz, Atemmuster, Anstrengung beim Atmen,
  Atemgeräusche, Heimsauerstoff
\end{itemize}
}
...
und \EE{Bewusstsqualität} (Orientierung zur Person, Raum,
Zeit und Situation) bestimmt. Anschließend werden die
...
inkl. der Ohren Ohren und der Hals \EE{inspiziert} und
...
Vitalwerte, Desorienierung, pathologische Pupillenreaktionen
(abnorme Weitung oder Engstellung, Differenz, verlangsamte
...
werden. Dies inkludiert auch in der Situation besonders
...
\begin{itemize}
  ...
  Krämpfe
  \item Trauma, insb. Hinweise auf WS-Verletzungen od.
  starke Blutungen
\end{itemize}
\end{minipage}
&
...
situationsentsprechend sind. Die Punkte unter "`Typische
Maßnahmen"' sind als \E{Beispiele} zu verstehen.
}
\end{minipage}
\end{minipage}
}
...
wichtig. Die vitale Bedrohung kann sich aus 3 wesetnlcuhen
Säulen ergeben: Massive Störung von Vitalfunktionen 1ter
Ordnung (Bewußtsein, Atmung, Kreislauf), Alarm-Symptomen
und Alarm-Diagnose.

Zu de Alarmsymptomen gehören u.\,a. 
...
Herzinfarkt, das kardiales Lungenödem, 
...
\pageref{m:standardmassnahmen-immer} listet Maßnahmen auf
welche bei jeder Patientenbetreuung -- sofern angemessen --
...
\begin{itemize}
  ...
  Einschtzungsblockes} {\tiny(in angemessenem Umfang)}
  \item \EE{Immer durchzuführende Standardmaßnahmen}
  (\prettyref{topic:standardmassnahmen-immer})
  \item \ldots
\end{itemize}
\end{minipage}
\\\addlinespace\midrule\addlinespace
...
\begin{minipage}{\linewidth}
\begin{itemize}
  \item Welches Spital/Bett buche ich ab? (Arbeitsunfall?
  Welche Abteilung fahre ich an? Ist der Patient bereits in
  einem Spital in Behandlung?)
  
  Brauche ich eine Spezialabteilung? (Schockraum, Stroke
...
Beim \EE{Primäreinsatz} ("`Rettungseinsätze"') ist der
...
Bedeutung nicht unterschätzt werden! Es empfiehlt sich -- so
Zeit dafür ist -- sich bereits vor Eintreffen des Notarztes
oder vor Ankunft im Krankenhaus zu überlegen, welche
