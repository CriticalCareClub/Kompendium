...
festgelegt. Die Medikamente dürfen auf Anweisung durch anwesenden Arzt (jeder mit
jus practicandi -- nicht unbedingt Notarzt) oder nach Verständigung eines
...
\begin{itemize}
  \item Durchführung einer endotrachealen Intubation samt Beatmung, aber ohne
     ...
     \item Durchführung der Intubation auf Anweisung durch anwesenden Arzt (jeder mit jus
practicandi -- nicht unbedingt Notarzt) oder nach Verständigung eines Notarztes.
\end{itemize}
\end{minipage}
...
{Kompetenzstufen von Sanitätern nach dem SanG ({\S}{\S}~\VonBis{9}{12})}
{} 
...
\subparagraph{\EE{Gebot bei Blaulichtfahrten}:}
\Fazit{
...
\subparagraph{Exkurs: \EE{Anschnallpflicht} --- \Z{{\S}\,106}~KFG:}
