...
\section{Allgemeine neurologische Symptome}

\subsection{\HeadingKeyword{Bewusstseinsstörungen}}
...
\subsection{Hirndruckzeichen und Hirnstammeinklemmung}

\TextSlidePicture{Hirndruckzeichen}
{%
\label{topic:hirndruckzeichen-neu}%
{\II{Hirndruckzeichen} deuten auf eine Erhöhung des Druckes 
...
Es kommt es zu einer typischen Kombination von 
Symptomen: 
\begin{itemize}
  ...
  \item \ABCDE{D} \StepHeading{Pupillen}: 
...
\begin{itemize}
  ...
  \item \ABCDE{D} Ungleichweite Pupillen, verlangsamte Lichtreaktion
...
\TextSlide{Hirnstammeinklemmung}
{%
\index{Hirnstammeinklemmung}%
\label{topic:hirnstammeinklemmung}
Das \EE{große Hinterhauptsloch} als Durchtrittsstelle
des Rückenmarks ist die einzige große Öffnung des Gehirnschädels und somit  
die einzige Möglichkeit des Gehirns sich auszudehnen. 
%
Kommt es aufgrund eines sehr großen Hirndrucks zu solch einer Ausdehnung 
kann es zu der Einklemmung des Hirnstammes kommen 
(\T{Hirnstammeinklemmung}). 
%
Da sich im Hirnstamm das Atem- und Kreislaufzentrum befindet 
besteht dabei akute \Ca{Lebensgefahr}!
}
{%
\begin{itemize}
  \item Großes Hinterhauptsloch
  \item Hirnstamm: Atem- und Kreislaufzentrum
  \item \Ca{Akute Lebensgefahr}
\end{itemize}
}

\begin{Danger}
  \item Bei einer Hirndrucksteigerung kann es zu einer akut lebensbedrohlichen 
  Hirnstammeinklemmung kommen.
\end{Danger}

\section{Ein \HeadingKeyword{Schlaganfall} kann ischämisch oder durch eine Blutung entstehen }
\index{Schlaganfall}
\index{Insult}
\index{Apoplexie}
...
\HeadingSub{\Lang{Syn.} Hirninfarkt, Insult, Apoplexie, Apoplektischer Insult, \Lang{engl.} Stroke}
...
\begin{itemize}
  \item \StepHeading{Motorik}: Störungen der Kraft und Beweglichkeit
  sind sehr häufig.
  ...
  \item \StepHeading{Sprache}: Störungen der Sprache sind ebenfalls
  ...
  Durch eine Hirnblutung oder Schwellung des Gehirns (\I{Hirnödem}) kann es zu 
  einer Hirndrucksteigerung 
  und zum Auftreten von Hirndruckzeichen 
  (\FullPrettyRef{topic:hirndruckzeichen}) kommen: 
  
  \begin{itemize}
    \item Übelkeit, Erbrechen
    \item Bewusstseinsstörungen
    \item HF\,$\downarrow$, RR\,$\uparrow$
...
%  ist die \EE{Ungleichheit der Pupillen} \Z{(Anisokorie)\index{Anisokorie|Z}}, 
%bzw.
...
\begin{itemize}
  ...
  \item Symptome, neurologische Ausfälle
  \item Alter des Patienten
  \item Vorbestehende Beeinträchtigungen
\end{itemize}
...
\section{Vom Gehirn ausgehende Krämpfe: \HeadingKeyword{Zerebrale Krampfanfälle}}
...
\begin{Synopsis}
  \SynopsisItem{Im Rettungsdienst gilt praktisch jeder Krampfanfall,
...
\subsection{\HeadingKeyword{Besondere Krampfanfälle}}


\TextSlideTeaser
{Fieberkrampf}%1 Titel
...
\section{Probleme mit der \HeadingKeyword{Wirbelsäule}: Lumbago, Lumbo-ischialgie und Bandscheibenvorfall} 
