...
\TableWide
{Graphische Übersicht: \EEE{Standardisierte Patientenversorgung}}%1 Titel
{}%2 Beschreibung
{}%3 Label/Hook
{}%4 Quelle
{}%5 Lizenz
...
wahrscheinlich? Eine Übersicht.}%2
{\label{tab:alarmzeichen}}%3
{}%4
{}%5
{%
...
\begin{itemize}
  \item Gefahrenzonen, Sicherheit, Selbst- u. Fremdschutz;
...
\end{minipage}
\\\addlinespace\toprule\addlinespace
\noindent\TabHeading{\ABCDEPlain{A}}
...
\begin{itemize}
  ...
  und Abtasten von
  \begin{compactenum}
    \item \EE{Kopf} inkl. Ohren, Nase, Mund
    \item \EE{Hals}
...
{\tiny (Wenn Einschätzung oder Hauptbeschwerde unklar)}
&
\begin{minipage}[t]{\linewidth}
\begin{itemize}
...
\TableWide
{Kurzübersicht: \EEE{Weiterführende Untersuchungen und Anamnese}}%1 Titel
{Die Reihenfolge ist je nach Patient
unterschiedlich!}%2 Beschreibung
{\label{tab:checkliste-patientenmanagement}\label{tab:pam-weiterfuehrende}}%3 Label/Hook
{}%4 Quelle
{}%5 Lizenz
{%
\begin{minipage}{\linewidth}
...
{\tiny(O: Onset, wann traten die Schmwerzen auf?; 
P (Pallation/Provocation): Linderung/Verstärkung; 
Q: Qualität; 
R (Radiation/Location): Austrahlung/Lokalisation; 
S (Severity): Stärke (1-10); 
T (Time): Zeit/Verlauf)}
\\\addlinespace
 &
{\SAMPLER{A}}
...
Extremitäten, Wunden, paradoxe Atmung,
...
{\scriptsize\EE{Fett} gedruckte Punkte haben eine besonders hohe Priorität.}
\end{minipage}
}%6 Tabelle
{}%7 Float
...
\subsection{Gutes Patientenmanagement bringt \HeadingKeyword{Struktur}} 
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Spezielle Maßnahmen je nach Krankheitsbild/Verletzungsmuster/Patientenzustand
	\end{itemize}
...
\clearpage
\section{Der \HeadingKeyword{Einschätzungsblock} beinhaltet die Punkte 
1\,--\,2\,--\,3\,--\,4\,--\,A\,--\,B\,--\,C\,--\,D\,--\,E}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\subsection{{\FontKeyboardFamily{1}} \HeadingKeyword{Szeneüberblick} und (Selbst-)Schutz}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\subsection{{\FontKeyboardFamily{2}} \HeadingKeyword{Eindruck} und
\HeadingKeyword{HWS-Stabilisierung} (General Impression + Cervical Spine)} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\subsection{{\FontKeyboardFamily{3}} \HeadingKeyword{Bewusstsein}
(Alertness)}
...
\prettyref{tab:bewusstseinsgrade-pam}.
}{
\begin{itemize}
  \item W\,--\,A\,--\,S\,--\,B
  \begin{itemize}
    ...
    \item Bewusstlos \dotfill  \EE{komatös}
  \end{itemize}
\end{itemize}
}{}{}{}
...
{Bewusstseinsgrade}%1
{WASB-Schema}%2
{\label{tab:bewusstseinsgrade-pam}}%3
{}%4
{}%5
...
Schmerzreizes: 
\begin{enumerate}
  \item \StepHeading{Ansprechen}: Zuerst wird der Patient laut und 
  ...
  \begin{Danger}
    \item Patienten, die in Folge eines Unfalls verunglückt
      ...
      werden!
  \end{Danger}
  \item \StepHeading{Schmerzreiz}: Sollte der Patient darauf nicht 
  reagieren wird ein Schmerzreiz im Bereich der Nasenscheidewand oder 
  den Kieferwinkeln gesetzt. 
\end{enumerate}
}{%
\begin{itemize}
  \item Ansprechen
...
diese zurück, kann sie den \EE{Atemweg
verlegen}.
Dabei ist manchmal ein dem \E{Schnarchen ähnliches}
Atemgeräusch zu vernehmen.
Details siehe \FullPrettyRef{topic:bewusstseinsstoerung}.
}{%
Gefahren:
\begin{itemize}
  ...
  \item Aspiration
  \item \FullPrettyRef{topic:bewusstseinsstoerung}
\end{itemize}
}{}{}{}

\begin{Synopsis}
  \SynopsisItem{Bewusstseinsstörungen können aufgrund des Ausfalls
...
{%
\begin{itemize}
  \item Spezielle Maßnahmen: Bewusstseinseintrübung 
  (\FullPrettyProcedureRef{MR40001B})
  \item Spezielle Maßnahmen: Bewusstlose und soporöse Patienten 
  (\FullPrettyProcedureRef{MR40021B})
  \item \TxMassVit 
  \begin{compactitem}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\subsection{{\FontKeyboardFamily{4}} \HeadingKeyword{Hauptbeschwerde} (Main
Complaint)} 
...
\Speech{\enquote{Warum haben Sie die Rettung gerufen?}}
\end{quote}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\clearpage
\subsection{{\FontKeyboardFamily{A}} \HeadingKeyword{Atemweg} (Airway)}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\subsection{{\FontKeyboardFamily{B}} \HeadingKeyword{Atmung} (Breathing)}
...
\TextSlide{Totraumventilation}
{%
Unter dem \I{Totraum} versteht man den Teil der Atemwege 
der nicht am Gasaustausch teilnimmt (\FullPrettyRef{topic:totraum}). 
%
...
Bei der \T[Totraum!-ventilation]{Totraumventilation} (\Lang{Syn.} 
\I{Totraumbelüftung})
ist das \I[Atemzugvolumen!Totraumventilation]{Atemzugvolumen} so gering, 
dass die Frischluft im Totraum verbleibt 
und nicht in die Lungenbläschen gelangt.
%
Somit erfolgt kein ausreichender Gasaustausch 
zwischen den Alveolen und der Umgebungsluft: 
%
Das Kohlendioxid kann nicht abgeatmet werden 
und es gelangt nicht genug Nachschub an Sauerstoff 
zum Gasaustausch 
in die Alveolen 
und somit in das Blut. 
\label{topic:schnappatmung}
%
Bei der \T{Schnappatmung} kann genau dies passieren: 
%
Auf den ersten Blick sieht es so aus 
als würde der Patient \enquote*{schnappend} atmen, 
in Wirklichkeit ist das Atemzugsvolumen so gering 
dass es zu einer Totraumventilation kommt: 
%
Die Atmung ist somit insuffizient.
}{
\begin{itemize}
    \item Zu wenig Frischluft in Alveolen
    \item Kohlendioxid kann nciht abgeatmet werden
    \item Kein ausreichender Sauerstoff-Nachschub
    \item Schnappatmung = insuffizient
\end{itemize}
}{}{}{}
...
\TableWide
{Übersicht Normalwerte: Atmung}%1 Titel
{}%2 Beschreibung
{}%3 Label/Hook
{}%4 Quelle
{}%5 Lizenz
...
\TableWide
{Symptome von Atemstörungen}%1
{}%2
{\label{tab:atmung-symptome-pam}}%3
{}%4
{}%5
{\input{./content/tabular-SymptomeAtemstoerungen}}%6
{}%7
...
Sie sitzt auf einer Treppe 
und stützt sich nach hinten mit den Armen ab. 
Die Erstmaßnahmen bei vital bedrohten Patienten wurden ergriffen:
Situationsrechte Lagerung, 
Sauerstoffgabe, 
Reanimationsbereitschaft, 
Notarztnachforderung 
und Monitoring. 
\SourcePicture{Sebastian Gabriel, MfG}}
{empty}
{}
\end{PictureSeriesWide}
...
{%
\begin{itemize}
  \item Spezielle Maßnahmen bei Ateminsuffizienz:
  \FullPrettyProcedureRef{MJ96091C}
  \item Spezielle Maßnahmen bei Atemstillstand: 
  \FullPrettyProcedureRef{MR09020B}
  \item Sauerstoffberieselung: \FullPrettyProcedureRef{SY52210A}
  \item \T{Lippenbremse}: 
  \label{topic:lippenbremse-basic}
  %
  Die Lippenbremse ist eine besondere Atemtechnik bei Erkrankungen der unteren Atemwege 
  und funktioniert ähnlich wie der PEEP (\FullPrettyRef{topic:peep}). 
  %
  Dabei atmet der Patient langsam und gleichmäßig durch die beinahe geschlossenen Lippen, also gegen einen Widerstand, aus. 
  %
  Dadurch kommt es zu einer Verlängerung der Ausatmung 
  und einem Luftrückstau 
  und einer Druckerhöhung bis in die Bronchien und Alveolen, 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\subsection{{\FontKeyboardFamily{C}} \HeadingKeyword{Kreislauf}
(Circulation) und \HeadingKeyword{Schnelle Trauma-Untersuchung} (STU)}
...
entsteht der arterielle
\I{Blutdruck} (\FullPrettyRef{topic:blutdruck}).

\subparagraph{{Beurteilung der Herzfrequenz}}
Die Herzfrequenz ist alters- und belastungsabhängig. 
%
Bei der Beurteilung der Herzfrequenz muss daher immer an die Umstände 
...
\begin{itemize}
    \item \StepHeading{Normbereich}: 
    \SIrange[range-phrase = --]{60}{100}{\per\minute} \index{Herzfrequenz!Normbereich}
    \item \StepHeading{\T{Bradykardie}}: 
    HF {\textless}~\SI{60}{\per\minute}
    \item \StepHeading{\T{Tachykardie}}: 
    HF {\textgreater}~\SI{100}{\per\minute}
\end{itemize}



\subparagraph{{Beurteilung des Blutdruckwerts}}
\label{topic:blutdruck-beurteilung}
Der Blutdruck ist ebenfalls alters- und belastungsabhängig. 
%
Bei der Beurteilung des Blutdrucks muss daher immer an die Umstände 
(Ruhe, Belastung, \ldots) und an den
Erregungszustand des Patienten gedacht werden!
%
Die Werte beziehen sich auf den Erwachsenen in Ruhe: 
...
\begin{itemize}
  ...
  \VonBis{60}{100}\PerMin*
 \begin{itemize}
    \item {Bradykardie}: HF {\textless}~\SI{60}{\per\minute}
    \item {Tachkardie}: {\textgreater}~\SI{100}{\per\minute}
 \end{itemize}
  \item Blutdruck:
  \begin{itemize}
...
\TableWide
{Übersicht altersabhängige Normalwerte: Systolischer Blutdruck und Herzfrequenz}%1 Titel
{}%2 Beschreibung
{}%3 Label/Hook
{}%4 Quelle
{}%5 Lizenz
...
\noindent\TabHeading{\FontSansNarrowFamily Jugendlicher}
&
\noindent\TabHeading{\FontSansNarrowFamily Erwachsener \Male}
&
\noindent\TabHeading{\FontSansNarrowFamily Erwachsene \Female}
\\\addlinespace\midrule\addlinespace
...
die wichtigsten Organeund  besteht aus der  Inspektion
  ...
  \begin{compactenum}
    \item \EE{Kopf} inkl. Mund, Nase, Ohren,
    \item \EE{Hals},
    \item \EE{Thorax} 
    ...
    \item \EE{Rücken} (evtl. erst beim Umlagern auf eine Schaufeltrage oder ein Spine Board).
  \end{compactenum}
}
{\begin{itemize}
  \item Inspektion
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\subsection{{\FontKeyboardFamily{D}} \HeadingKeyword{Neurologie}
(Disability)}

\TextSlide{Cute Eyes}{%
Es wird die \EE{Be\-wusst\-seins\-quali\-tät} (Orientierung zur Person,
Raum, Zeit und Situation) 
oder, wenn angemessen, alternativ 
die Glasgow Coma Scale (\EE{GCS}) bestimmt. 
%
Anschließend werden die
\EE{Pupillen} 
und deren Lichtreaktion untersucht.
%
Die \EE{grobe Motorik} wird an der oberen Extremität mittels
Händedruck (Kraftprobe) überprüft, 
wenn angemessen 
(Auffälligkeiten bei der Untersuchung der oberen Extremität, 
vermutete Erkrankung, 
Verletzungsmuster bzw. Unfallhergang, 
{\ldots}),  
wird auch  die untere Extremität geprüft. 
%
Wenn der Verdacht auf neurologische 
...
\TextSlidePicture{Hirndruckzeichen}
{%
\label{topic:hirndruckzeichen}%
\DefinitionInPara{\T{Hirndruckzeichen} deuten auf eine Erhöhung des Druckes 
innerhalb des Hirnschädels hin 
(\I{Hirndruck}, \I[Druck!intrakranieller]{intrakranieller Druck}).} 
%
Eine solche Steigerung kann besonders bei Verletzungen 
oder blutigen Schlaganfällen vorkommen. 
%
Eine Hirndruckerhöhung wirkt sich negativ sowohl auf das Hirn selbst, 
als auch auf dessen Durchblutung aus 
(\Speech{\enquote{Das Hirn drück sich selbst ab.}}). 

Zusammen mit anderen Befunden 
aus den vorangegangenen Schritten 
des Einschätzungsblockes 
können typische Kombinationen 
von Symptomen festgestellt werden: 
\begin{itemize}
  \item \ABCDE{3} \StepHeading{Bewusstseinsstörungen}
  \item \ABCDE{4} \StepHeading{Übelkeit} und Erbrechen, 
  meist in Verbindung mit Kopfschmerzen
  \item \ABCDE{B} \StepHeading{Atmung}: Evtl. unregelmäßig
  \item \ABCDE{C} \StepHeading{Kreislauf}: 
  Der Patient ist \EE{hyperton}, aber \E{bradykard} 
  (\EE{HF\,$\downarrow$, RR\,$\uparrow$}), 
  der Puls ist langsam, 
  aber äußerst stark spürbar (\I{Druckpuls}). 
  \item \StepHeading{Pupillen}: 
  Typisch für das späte Stadium ist die \EE{Ungleichheit der Pupillen} 
  {(Anisokorie)\index{Anisokorie|Z}}, 
  bzw. eine verlangsamte Lichtreaktion.
  \item \Z{In schweren Fällen kommt es zu sog. \I{Strecksynergismen}, 
  d.\,h. der Patient reagiert bei Schmerzreiz nur mit einem ungerichtetem 
  Strecken der Extremitäten.}
\end{itemize}
\nocite{StriebelAnaesthesie2} %[Bd.2, S.1344]
}
{
\begin{itemize}
  \item \ABCDE{3} Bewusstseinsstörungen
  \item \ABCDE{4} Übelkeit, Erbrechen
  \item \ABCDE{C} HF\,$\downarrow$, RR\,$\uparrow$
  \item Ungleichweite Pupillen, verlangsamte Lichtreaktion
  \item \Z{Strecksynergismen}
\end{itemize}
}
{./images/trauma/pupillendifferenz.jpg}%4 Bilddatei
{Anisokorie}%5 Bildtitel
{}%6 Bildbeschreibung
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\subsection{{\FontKeyboardFamily{E}} \HeadingKeyword{Erweiterte Untersuchung}}
...
muss unbedingt unter \Ca{Wahrung des Wärmeerhalts und der Intimsphäre} erfolgen
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\subsection{{\FontKeyboardFamily{=}} \HeadingKeyword{Beurteilung}}
...
\subsection{\HeadingKeyword{Alarmzeichen} (\protect\enquote*{Red
Flags} \RedFlag) sind Zeichen einer vitalen Bedrohung: }
...
\begin{Danger}
  \item Sobald eine vitale Bedrohung erkannt wird, müssen die
  \TxMassVit{}
  \E{frühzeitig}
...
\subsection{\HeadingKeyword{Sofortmaßnahmen} müssen bei Bedarf sofort ergriffen werden}
...
\subsection{Die \HeadingKeyword{Strategieentscheidung} entscheidet über das weitere Vorgehen}
...
\subsection{Eine \HeadingKeyword{Re-Evaluation} (Verlaufskontrolle) muss regelmäßig durchgeführt werden}
...
Dies beinhaltet sowohl eine \EE{Verlaufskontrolle}, 
als auch notwendige Änderungen in der Behandlung und der Strategie. \Commentary[Einschätzungsblock:
...
\section{\HeadingKeyword{Transportentscheidung}}

\Text
{{\TxBeschreibung}}%1 Überschrift
{%
Nach dem Einschätzungsblock 
und der Strategieentscheidung 
erfolgt die Entscheidung über
den Transport. 
Diese ist abhängig vom
\begin{enumerate}
  \item Ergebnis
  des \EE{Einschätzungsblockes}, der
  \item \EE{Transportpriorität}
  (\FullPrettyRef{topic:transportprioritaet}), und dem
  \item Ergebnis der
...
\begin{enumerate}
  \item Wahl des \EE{Transportzeitpunktes} und der
  \item \EE{Zielentscheidung}.
\end{enumerate}
}%2 Text


\subsection{Die \HeadingKeyword{Zielentscheidung} beeinflusst die weitere Behandlung wesentlich}
...
\clearpage
\section{\HeadingKeyword{Weiterführendes Patientengespräch} und Anamnese: SAMPLER}




%\subsection{Strukturierte Anamneseerhebung mittels 
%\HeadingKeyword{SAMPLER}-Schema}
...
\PictureWide[hb]
{Stille Wasser sind tief \ldots}%1 Titel
{}%2 Beschreibung
{}%3 Label
{xkcd.com}%4 Quelle
{CC-BY-NC-2.5}%5 Lizenz
{./images/xkcd/desert_island}%6 Datei
...
\begin{itemize}
  \item \EE{Onset / Geschehnisse zum Zeitpunkt des Auftretens}: \Speech{\enquote{Seit wann haben Sie die Schmerzen? Was haben Sie gemacht als es begonnen hat?}}
  \item \EE{Provokation / Palliation}:
  \Speech{\enquote{Was macht den Schmerz besser oder schlechter?}}
  \item \EE{Qualität}: \Speech{\enquote{Wie ist der Schmerz? Bohrend,
  		stechend, brennend, ziehend, krampfartig, auf- und
  		abschwellend?}}
  \item \EE{Radiation / Region}: Ausstrahlung / Lokalisation \Speech{\enquote{Strahlt der Schmerz irgendwohin aus? Wo sind die Schmerzen? }}
  \item \EE{Severity / Stärke}: \Speech{\enquote{Wie stark ist der
  		Schmerz?}} Setzen Sie die Aussage des Patienten immer in Relation
  ...
  \item \EE{Time / Zeitdauer }: \Speech{\enquote{Wie lange haben Sie die Schmerzen schon? Haben Sie so einen Schmerz schon einmal gehabt? Haben die
...
\begin{Synopsis}
  \SynopsisItem{Bei der Anamneseerhebung muss immer nach Medikamentenlisten gefragt werden!}
\end{Synopsis}

\begin{Danger}
  \item Das Ignorieren bzw. die Nicht-Mitnahme von 
  Medikamentenlisten o.\,ä. stellt einen schweren Fehler dar!
\end{Danger}


\TableWide
{Besonders häufige bzw. wichtige Medikamente}%1 Titel
{}%2 Beschreibung
{}%3 Label/Hook
{}%4 Quelle
{}%5 Lizenz
...
\subparagraph{\HeadingKeyword{Arzt- und Entlassungsbriefe}}
...
\begin{itemize}
  ...
  \item Behinderungen?
  \item Operationen?
  \item Arzt- und Entlassungsbriefe, Patientenpässe, \item Medikamente $\rightarrow$ Krankheiten 
  \item \ldots
\end{itemize}
}
{}
...
% \bigskip
% \clearpage
\minisec{\HeadingKeyword{Beispiel}: Entlassungsbrief eines Patient mit schlechtem Allgemeinzustand}
...
eventuell eingesetzte Implantate 
oder weisen auf besondere Risiken hin.
%
Hier abgebildet sind 
ein Pass nach einer Herzkatheter-Untersuchung mit Stent-Implantation,
ein Blutdruck-Pass zur Dokumentation des Blutdruckverlaufs 
und eine Medikationsinformation. (Die Patientendaten am Bild sind erfunden.)}% Beschreibung
{}% Label
{Sebastian Gabriel}% Quelle
{MfG}% Lizenz
{./images/gabriel-sebastian-aass/Dokumentation-Patientenausweise-Gestellt-00943pt}% Datei
{}% Breitenmodifizierer
{}% Float
...
\begin{quote}
    ...
    (weiterführende Fragen: Wie hat der Stuhl ausgesehen? Gab es Auffälligkeiten?)
...
%\clearpage
%\subsection{\HeadingKeyword{Dokumentationen} von anderen Gesundheitseinrichtungen und -berufen}
...
\section{\HeadingKeyword{Weiterführende Diagnostik} und \HeadingKeyword{Maßnahmen}}
...
\clearpage % TODO temporary clearpage
\section{\HeadingKeyword{Übergabe} an weiterbehandelndes Fachpersonal}  
...
\end{enumerate}}%2 Text
{}%3 Slide
{./images/shared/aufnahmearzt-ihres-vertrauens-edited2-0500.jpg}%4 Bilddatei
{\enquote{Sie wünschen?}}%5 Bildtitel
{}%6 Bildbeschreibung
{Sbabstian Gabriel}%7 Quelle
{MfG}%8 Lizenz
% Vormals \Layout{60}



\section{\HeadingKeyword{Anwendbarkeit} in der Praxis}
