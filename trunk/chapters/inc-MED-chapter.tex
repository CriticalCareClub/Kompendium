...
\begin{description}
    ...
    \item[\gE{De}kompensierte Herzinsuffizienz] Der Körper kommt aufgrund des
...
\gMarriedNG{{\RainCloud} Komplikationen}
{
\begin{itemize}
...
\gMassnahmen{
    \paragraph{Spezielle Maßnahmen: Herzinfarkt}
...
\begin{description}
    \item[\gT{Bradykardie}] \index{Bradykardie}\ldots zu langsamer Herzschlag
    ...
    \item[\gT{Tachykardie}] \index{Tachykardie}\ldots zu schneller
...
wieder und kennen die Symptome bereits (und oft auch die Behandlung). Die
...
\gMarriedNG{Symptome}
{Es liegt klarerweise eine \gEs{Tachykardie} vor. Die Frequenz ist i.d.R. hoch,
...
Brustschmerz. Dies sind erste Zeichen dass das Herz an seine Grenzen der
Belastbarkeit stößt.
}{
\begin{itemize}
    \item Tachykardie.
...
\gT{Halbseitenzeichen}: Aufgrund des Ausfalls eines Zentrums im
        ...
        Durch die Lähmungen kann es zun \gEs{Schluckstörungen} kommen, es
...
\gMassnahmen{
    \paragraph{Spezielle Maßnahmen: Insult}
...
\gZ{Im
fortgeschrittenen Stadium kann es zu massiven Gerinnungsstörungen kommen, am Körper bilden sich dann dunkle Hämatome (s. Abb. \ref{fig:meningitis-baby}. Einer der häufigsten Erreger sind die Meningokokken, man spricht dann von einer
...
\begin{itemize}
    ...
    \item Hämatome am genazen Körper (im Endstadium).
...
\gMassnahmen{
\paragraph{Spezielle Maßnahmen: Meningitis} ~
...
\begin{itemize}
    ...
    \item Patient erst in das Spitalsgebäude bringen wenn Ziel und Weg
    dorthin klar ist.
...
&
z.B. Kollaps, Ischämie aufgrund eines Gefäßverschlusses
\\\addlinespace
\gTabSub{BZ} 
&
...
\gMarriedNG{Sonstige Besonderheiten}
{
...
\gMarriedNG{Eklamptischer Krampfanfall während der
Schwangerschaft}
{
...
\gMassnahmen{
\paragraph{Spezielle Maßnahmen: Epiglottitis}~
...
\gMassnahmen{
\paragraph{Spezielle Maßnahmen: SIDS}~
...
\gMarriedNG{Der psychiatrische Patient ist nicht entrechtet!}
{
