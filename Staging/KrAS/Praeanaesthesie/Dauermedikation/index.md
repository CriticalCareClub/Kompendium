...
: Bei Absetzen erhöhte Gefahr von Mykardischämien

  ↑ vasodilatierende Effekte in Kombination mit Inhalationsanästhetika, Spinal-/Epiduralanästhesie
...
: {index}`\ <pair: Antiarrhythmika; peri-OP>`
  ...
  *Lidocain* senkt MAC und potenziert Wirkung von i. v.-Anästhetika
  ...
  Klassen Ia, Ib, Ic und III wirken kardiodepressiv und potenzieren
  ...
  **Amiodaron**
  ...
  Allerdings aufgrund der langen Halbwertszeit absetzen nicht
  sinnvoll.
...
: {index}`\ <pair: Tranylcypromin; prä-OP Dauermedikation>`
  ...
  *RO-19-6327* (MAO-B).
  ...
  Vor elektiver OP möglichst **2 Wochen** vorher auf
  *selektive und reversible* der *3.* Generation umstellen;
  Wenn nciht möglich, Weitergabe, Cave Kreislauf

  MAO-A deaminiert v. a. *Serotonin*, *Noradrenalin*, *Adrenalin*,
  MAO-B *2-Phenylethylamine* und *Benzyl-Amine*

  **Kontraindiziert:**

  - *Pethidin*, *Tramadol*, *Dextrometorphan*.
    Exzitatorische Reaktionen mit Atemdepression und Koma
  - Indirekte Sympathomimetika: *Ephedrin*.
    Hypertensive Krisen.
