...
myst_substitutions          = {
    ...
    'TxSamplerS': '🅂 Symptome und Schmerzen',
    'TxSamplerA': '🄰 Allergien',
    'TxSamplerM': '🄼 Medikation',
    'TxSamplerP': '🄿 Patientengeschichte',
    'TxSamplerL': '🄻 Letze …',
    'TxSamplerE': '🄴 Ereignisse vor Notfalleintritt',
    'TxSamplerR': '🅁 Risikofaktoren',
    'WIP': r'''
:::{attention}
