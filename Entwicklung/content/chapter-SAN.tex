...
grundsätzlich immer abzunehmen!Außer der Patient verweigert die Abnahme! Bei bewusstlosen Patienten ist das Einverständnis voraus zusetzen.  }{}{}{}{}
...
\begin{compactitem}
    ...
    \item nicht elastisches Verbandsmaterial (Dreiecktuchkrawatte)
\end{compactitem}
}{}{}{}{}
...
\begin{enumerate}
    ...
    \item Mit einem nicht elastischen Verband
	%\footnote{Druckverband: Unter Umständen ist die Verwendung von
    %flexiblen Verbandsmaterial (z.\,B.
    %PehaHaft{\texttrademark}) ausreichend bzw. je nach Wundlokalisation zu %bevorzugen.} 
	(z.\,B.
