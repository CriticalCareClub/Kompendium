\begin{savequote}
\includegraphics[width=5cm]{./images/nasa-pd/156109main_image_feature_644_ys_full-00800.jpg}
...
\begin{itemize}
  ...
  \item \Es{Anamnese und Patientengespräch}: \CO{[AUP]} (\ref{chp:AUP}).
\end{itemize}
}{
\includegraphics[angle=270,width=\linewidth]{./images/leitsystem/Leitschema-PAM_BAU.pdf}
}
\end{gWideParEnv}
...
\Layout{20}{Material \& Personal}
{
\begin{enumerate}
  \item eine eingeschulte Person
  \item Handschuhe
  \item Kontamed-Box
  \item Alkoholtupfer
...
{
Mit dem
\Es{herkömmlichen Fieberthermometer}\footnote{Unter
...
EKG-Gerät \Es{sechs Ableitungen} \Z{(I, II, III, aVL, aVR
und aVF).}
}{
\begin{itemize}
...
Elektroden erzeugt das \Abk{EKG}-Gerät \Es{sechs
Ableitungen}: \Z{V1 -- V6}. }{
\begin{itemize}
...
\end{enumerate}
  \item \Es{Nackensteifigkeit}\label{topic:nackensteifigkeit-untersuchung} (ein
  ET{Meningismuszeichen}\index{Meningismuszeichen!Nackensteifigkeit!Untersuchung}\index{Nackensteifigkeit!Untersuchung})
  Der Patient liegt flach am Rücken. Der Untersucher fasst den Kopf des Patienten und versucht das Kinn an die Brust zu
