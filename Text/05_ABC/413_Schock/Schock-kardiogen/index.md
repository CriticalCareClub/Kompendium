...
:::{index} single: Schock; kardiogener
:::

(GSCH-SE-Schock-kardiogener)=
...
(GSCH-SE-Schock-kardiogener-Ursachen)=
...
(GSCH-SE-Schock-kardiogener-Pathophysiologie)=

## Pathophysiologie

Die Pathophysiologie des kardiogenen Schocks ist komplex und umfasst mehrere Faktoren.
Im Allgemeinen ist das Herz nicht in der Lage, genug HZV zu liefern, um den Bedarf des Körpers zu decken.
...
(GSCH-SE-Schock-kardiogener-Klinik)=
...
(GSCH-SE-Schock-kardiogener-Diagnostik)=
...
- **Erweitertes Monitoring**
  - HZV-Messung (CO) durch {ref}`Thermodilution <Thermodilution>`, z. B. mittels {ref}`Pulmonalarterienkatheter <Pulmonalarterienkatheter>` oder {ref}`Pulskonturanalyse <Pulskonturanalyse>`

    {ref}`Cardiac index <Cardiac-Index>` (*CI*, auf die Körperoberfläche bezogenes Schlagvolumen) [unter 2 l / min / m²]{.deep}

  - {ref}`Lungenkapillarverschlußdruck <PCWP>` (*PCWP*) [mehr als 15 mm Hg]{.deep}




(GSCH-SE-Schock-kardiogener-Therapie)=

## Therapie

Die Behandlung des kardiogenen Schocks hängt von der zugrunde liegenden Ursache und der Schwere der Erkrankung ab.
Bei einigen Ursachen ist eine kausale Therapie möglich, z. B.:
