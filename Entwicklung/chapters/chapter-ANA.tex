...
und trennt somit den Brustraum vom Bauchraum (Vgl. Atemmechanik, \prettyref{topic:atemmechanik}).
...
\begin{itemize}
  ...
  \item \T{Herzmuskulatur}: Quergestreifter Muskel, der jedoch besondere Eigenschaften hat: nicht willentlich
  steuerbar, nicht ermüdbar und verfügt über eigenen Impulsgeber (Reizleitungssystem). Weiters ist er natürlich trainierbar.
\end{itemize}
...
entfernter ist. Für alle dieser Erklärungen gibt es natürlich Ausnahmen, konkret die
Unterstützung der Atemmuskulatur als \T{Atemhilfsmuskulatur}.
}
{
\begin{itemize}
...
\Layout{20}{\TxBeschreibung}
{%
Das Herz ist ein etwa faustgroßer\ZFootnote{Faustgröße des \E{Patienten!}}
...
Mitralklappe.\protect\footnote{STEUER, Anatomierevire,
2010-12-03}}}% 
...
das Verständnis des Aneurysmas} 
}{
\begin{itemize}
  \item 3 Schichten
...
Erwachsenen. Es setzt sich aus verschiednen Bestandteilen
...
Sakralsegmente. Das letzte Segment endet auf Höhe des 1. bis 2. Lumbalwirbel, da das Rückenmark vor der Wirbelsäule endet.}
}
{
\begin{itemize}
...
\begin{itemize}
  ...
  \item \T{Netzhaut} \Z{(Retina)}: In der Netzhaut befinden
...
abfließen kann, und die \T{Bindehaut} \Z{(Konjunktiva)}, die
...
\begin{itemize}
  \item Äußerer Gehörgang: dieser geht nach vorne oben --
...
\subsection{Die Speiseröhre}
\index{Speiseröhre}
\index{Oesophagus@Ösophagus}
\label{topic:speiseroehre}


\HeadingSub{\Lang{Term.} \T{Ösophagus}}
