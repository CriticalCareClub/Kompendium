...
\begin{itemize}
    ...
    \item Dekompensierte Herzinsuffizienz
\end{itemize}
}


\gMarriedNG{Beurteilung des Schweregrades}
{
...
\gMassnahmen{
    \paragraph{Spezielle Maßnahmen: Herzinsuffizienz}
...
\gMarriedNG{Kardiales Lungenödem und Linksherzinsuffizienz}
{\index{Lungenödem!kardiales - bei Herzinsuffizienz} Patienten mit einem 
\gE{kardialem Lungenödem} sind \gE{lebensbedrohlich} krank. Das Herz verbraucht oft schon die allerletzten Reserven, schon die
...
Die Atemfrequenz und Herzfrequenz ist oft erhöht
(\gEs{Tachypnoe},
...
Krise} \ref{topic:hypertensive-krise}) der eigentliche
...
Patienten sind als besonders kritsich einzuschätzen.
}{
\begin{itemize}
    \item \gEs{Dyspnoe}
    \begin{itemize}
...
Die Patienten müssen oft häufig nachts urinieren. Über
