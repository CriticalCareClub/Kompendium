...
durch Reizung bzw. Kompression des Nervs oder seiner
Wurzeln verursacht werden können. Ursachen können eine Irritation bzw. Kompression im Bereich der Lendenwirbel L4 oder L5 bzw. des Kreuzbeinwirbels S1,
...
\gEs{Schwangerschaftsdauer} Die normale Schwangerschaft dauert 40 Wochen +- 2
...
Einnistung in der Gebärmutterschleimhaut. Dort bildet sich der Mutterkuchen
...
\begin{itemize}
	...
	\item In welchem Krankenhaus ist die Geburt angemeldet? Sofern nicht im Mutterkindpass vermerkt.
\end{itemize}
...
\begin{itemize} 
    ...
    \begin{itemize}
        ...
        Notarzt nachfordern, sonst direkt
...
\subsubsection{Alkohol- und Medikamentenentzug}
...
\subsubsection{Stupor = Erschlaffung}
...
\begin{itemize}
    \item Kopfschmerz, Schwindel, \"Ubelkeit
    \item Krämpfe
    \item Zyanose
...
\gDefinition{Lokale Schädigung der Oberfläche aufrgrund
einer irreversiblen Zerstörung (Denaturierung) von
Eiwei{\ss}stoffen.}
...
\begin{itemize}
    \item \"Atzspuren (Mund/Rachen), Abrinnspuren
    \item W\"urgen
    \item Erbrechen
    \item Schmerzen
...
\gMassnahmen{\subparagraph{Therapie:}
