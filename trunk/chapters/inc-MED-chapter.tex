...
(\gZ{Orthopnoe}\gZFootnote{\gE{Orthopnoe}: Der Patient muss aufrecht sitzen um
...
\gTODO{GABS}{2010-04-18}{Bild: Schmerzausdehnung beim ischämischen
Herzschmerz}{} 
...
unteren Atemwege
\gTODO{GABS}{2010-04-18}{Bild: Atemwegsverlegung (Schema)}{}
}
{}
...
\gTODO{GABS}{2010-04-18}{Bild:COPD Stufen }{}
\gCaptionof{figure}{Eine COPD
entsteht nicht plötzlich: Ein COPD{\textquotesingle}ler hat eine
Karriere hinter sich. \gSourcePicture{Quelle unbekannt}}
\end{center}
\end{figure}
...
\gTODO{GABS}{2010-04-18}{Bild: Herkunft des Thrombus.}{}
}{
...
\gZ{Der fokale Anfall wird
auch \emph{"`petit mal"'}\gZFootnote{Petit mal: \emph{franz.:} "`kleines
Unglück"'} genannt.}
...
\gZ{Der generalisierte Anfall wird auch \emph{"`grand
mal"'}\gZFootnote{Grand mal: \emph{franz.:} "`großes Unglück"'} genannt.}
...
\gLayout{0}{Eklamptischer Krampfanfall während der Schwangerschaft}
{
...
\end{description}
\gTODO{GABS}{2010-04-18}{Bild: }{Interpretation des
...
\begin{labeling}[~--]{xxxxxxx }
   ...
   zu einem absoluten Mangel.}
    ...
    \item[Typ II]
    \gZ{(NIDDM, non insuline dependent DM)} Durch eine dauerhaft zu hohe
    ...
    \gEs{Medikamenten} behandeln. Erst im Endstadium muss mitunter auch Insulin
    gespritzt werden.
...
Ketoazidose (sauer) versucht der Körper diesen Mechanismus auszunutzen: Er \gEs{hyperventiliert} um sich "`vom sauren pH
    ...
    \gEs{schnelle, tiefe Atmung} feststellbar\gZFootnote{Diese
...
\gTODO{GABS}{2010-04-18}{Bild: Meningitis von KAR + Beschreibung}{}
}{}
...
Der Erreger des Wundstarrkrampfes\gZFootnote{Clostridium tetani} kommt
\gE{überall in der Umgebung} vor. Er produziert einen Giftstoff (Toxin),
...
{\gAuthNotesPicLegalOk{PD}{}Patient mit Tetanus.}
...
\gTODO{GABS}{2010-04-18}{Bild: Bild Lungenröntgen TB-Patient als Eye-Catcher.
--> Hauer}{}
