...
\section{\HeadingKeyword{Grundlagen}}

\subsection{Wichtige \HeadingKeyword{Begriffe}}
...
\begin{description}
  ...
  \item[\T{Entzündung}] Reaktion des Körpers mit den Symptomen
  \begin{inparaenum}
    \item Rötung,
    \item Schwellung,
    \item Überwärmung,
  ...
  \end{inparaenum} Vgl.  \FullPrettyRef{topic:entzuendung}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Die wichtigsten \HeadingKeyword{Erreger}}
\label{topic:infektion-erreger}

\Table
[]%1 Float
{Übersicht der Erregerarten}%2 Titel
{}%3 Beschreibung
{}%4 Label/Hook
{}%5 Quelle
{}%6 Lizenz
...
\noindent\TabHeading{Erreger}
&
\noindent\TabHeading{Kurzbeschreibung}
\\\addlinespace\midrule\addlinespace
\noindent\TabSub{Bakterien}
&
klein, im Mikroskop meist sichtbar;
        {\textquotedblleft}Normale{\textquotedblright} Zellen
\\\addlinespace
\noindent\TabSub{Viren}
&
sehr klein, im Mikroskop i.\,d.\,R. nicht
        sichtbar, keine echten Zellen, müssen Zellen befallen
\\\addlinespace
\noindent\TabSub{Pilze}
&

\\\addlinespace
\noindent\TabSub{Parasiten, Tiere}
&
Würmer, Maden, \ldots
\\\addlinespace
\noindent\TabSub{(Toxine)}
&
...
\subsubsection{\HeadingKeyword{Bakterien} sind Zellen}
\index{Bakterien}
...
%{}
% TODO: Bild von Actimel usw.

\begin{Synopsis}
  \SynopsisItem{Daraus folgt: Manche Keime machen immer krank, manche
  nur unter Umständen.
...
\subsubsection{\HeadingKeyword{Viren} sind keine vollständigen Zellen}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Erreger können über verschiedene \HeadingKeyword{Übertragungswege} übertragen werden}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\HeadingKeyword{Kreuzinfektion}}
...
\begin{Synopsis}
  \SynopsisItem{Kreuzinfektion: 
  \EE{Patient 1
  ${\rightarrow}$ \emph{Personal} ${\rightarrow}$ Patient
  2}}
\end{Synopsis}

\subsection{\HeadingKeyword{Angepasste} Hygiene}
...
\TableWide
{Beispiel für Unterschiedliche Hygiene-Risikoprofile}%1 Titel
{}%2 Beschreibung
{}%3 Label/Hook
{}%4 Quelle
{}%5 Lizenz
...
\clearpage
\section{\HeadingKeyword{Multiresistente} Keime}
...
\TextSlideTeaser
{Geschichte und Bedeutung der Antibiotika}%1 Titel
{%
...
Infektionen besiegt. Doch man irrte sich gewaltig {\ldots}}%2 Text
{}%3 Slide
{./images/hygiene/Faroe_stamp_079_europe_fleming.jpg}%4 Bilddatei
{Alexander Fleming}%5 Bildtitel
{}%6 Bildbeschreibung
{Postverk Føroya -- Philatelic Office}%7 Quelle
{PD}%8 Lizenz
 % Vormals \Layout{60}
...
\begin{Synopsis}
  \SynopsisItem{Resistenzen sind ein enorm großes Problem in der
  heutigen Medizin!}
\end{Synopsis}
...
\begin{Synopsis}
  \SynopsisItem{Resistenzen machen Antibiotika zunehmend wirkungslos.
    -- Bald sind wir wieder dort, wo wir 1927, vor der
    Entdeckung des Penicillins, waren: Praktisch machtlos gegen
    bakterielle Infektionen.}
  \SynopsisItem{Je wirkungsloser die Antibiotika werden, desto
    wichtiger ist die Hygiene und die Vermeidung von
    (Kreuz-)Infektionen.}
  \SynopsisItem{Auch im Rettungs- und Krankentransport kommen
...
\subsection{\HeadingKeyword{MRSA}: Multi-Resistenter Staphylococcus
aureus} 
...
\T{MRSA} (Multi-resistenter Staphylococcus aureus).}%2 Text
{
\begin{itemize}
...
%     \end{itemize}
\end{itemize}}%3 Slide
{./images/hygiene/11159_lores_VRSA.jpg}%4 Bilddatei
{Ein
resistenter Staph. aureus (\Abk{VRSA}) im Elektronenmikroskop,
koloriert}%5 Bildtitel
{}%6 Bildbeschreibung
{Public Health Image Library, ID\#: 11159}%7 Quelle
...
\clearpage
\section{Reinigung und hygienische \HeadingKeyword{Wiederaufbereitung}}
...
\subsection{\HeadingKeyword{Techniken} zur Wiederaufbereitung}

\Text
{Verschiedene Techniken}%1 Überschrift
{%
...
gelten ebenfalls als \E{Medizinprodukte}\footnote{{\S}\,2 Abs
2 Medizinproduktegesetz}; es gelten daher die gleichen
Unterweisungspflichten.}%2 Text



\subsubsection{Die \HeadingKeyword{Reinigung} entfernt Verunreinigungen}
...
\subsubsection{Die \HeadingKeyword{Desinfektion} führt zur Keimreduktion}
\index{Desinfektion}
...
\E{(Desinfektions-)Mittel}, welche zur
Wiederaufbereitung von Medizinprodukten eingesetzt werden,
gelten ebenfalls als \E{Medizinprodukte}\footnote{{\S}\,2 Abs
2 Medizinproduktegesetz}; es gelten daher die gleichen
\E{Unterweisungspflichten}.
}{
\begin{itemize}
  \item Keimreduktion
...
\begin{Synopsis}
  \SynopsisItem{Keine Desinfektion ohne vorhergehender Reinigung!}
\end{Synopsis}
...
\begin{Danger}
  \item In Fahrzeugen dürfen i.\,d.\,R. keine alkoholischen
  Desinfektionsmittel verwendet werden, da diese die
  Acryloberflächen zerstören können!
  \item Die Verdünnungsangabe \enquote{\Ca{1:10}} steht für \enquote{1~Teil
  Desinfektionsmittel und
  \Ca{\underline{9}~Teile Wasser!}}
\end{Danger}

\begin{Synopsis}
  \SynopsisItem{Desinfektionsmittel müssen richtig hergestellt,
...
\begin{Danger}
  \item In unsachgemäß gepflegten Desinfektionsmitteln können Keime wachsen!
\end{Danger}
...
\begin{Danger}
  \item In den Fahrzeugen dürfen keine alkoholischen
  Desinfektionsmittel verwendet werden, da diese die
  Acryloberflächen zerstören können!
\end{Danger}
}{
...
\subsubsection{\HeadingKeyword{Sterilisation} erzeugt Keimfreiheit}
...
\subsection{\HeadingKeyword{Praktisches}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Besondere \HeadingKeyword{Verhaltensweisen}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\HeadingKeyword{Selbstschutz}}
...
\TableWide
{Arten von Schutzmasken und Rückhaltevermögen}%1 Titel
{}%2 Beschreibung
{}%3 Label/Hook
{}%4 Quelle
{}%5 Lizenz
...
\noindent\TabSub{Mund-Nasen-Maske} & 95\PC*%\footnotemark[4] 
                                                              & k.\,A. & Basisschutz; \Abk{MRSA}, \ldots
\\\addlinespace 
...
\begin{Synopsis}
  \SynopsisItem{Nie mit schmutzigen Handschuhen in die Tasche greifen!
  Ein Teammitglied hat Patientenkontakt, der andere reicht zu!}
\end{Synopsis}


\TextSlidePicture
{Umgang mit spitzen Gegenständen}%1 Titel
{%
\index{Kontamed}%
...
vorher ausdrücklich kund getan werden.}%2 Text
{
\begin{itemize}
  ...
  Zwecke (Sonderfall)
\end{itemize}}%3 Slide
{./images/motal-aass/kontamed_4779-00800.jpg}%4 Bilddatei
{\enquote{Wer sticht, der entsorgt!}}%5 Bildtitel
{}%6 Bildbeschreibung
...
\begin{Synopsis}
  \SynopsisItem{\Speech{\enquote{Wer sticht, der entsorgt!}}}
  \SynopsisItem{Nadelabwurfbehälter: 
  \EE{Nie} nachstopfen, 
  \EE{nie} ausleeren. -- 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{MRSA und andere \HeadingKeyword{Resistente Keime}}
\index{MRSA}

Die Maßnahmen beim Transport von Patienten mit resistenten Keimen
werden unter \FullPrettyProcedureRef{IU81001C} besprochen.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{\HeadingKeyword{Nadelstichverletzungen}}
...
\subsection{Entsorgung von \HeadingKeyword{Abfall}}

\Text
{Abfall}%1 Überschrift
{%
...
\begin{enumerate}
  ...
  Bereiches} eine Infektions- oder Verletzungsgefahr
