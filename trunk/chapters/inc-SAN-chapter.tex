...
\chapter{[SAN] Angewandte Sanitätshilfe}
\AasRsN{RS~XIII}
\label{chp:SAN}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \Es{{\textquotedblleft}Unterbrechung der
...
Allgemeine
Beschreibung: \See{topic:hws-schiene-beschreibung}
...
Allgemeine
Beschreibung: \See{topic:schaufeltrage-beschreibung}
...
\begin{anfxwarning}[author=GABS]{Schaufeltrage, Kopfdrehung: Vervollständigung
...
\begin{enumerate}
    ...
    Herstellerangabe. Wir empfehlen die Vewrwendung von mind. \E{3} Gurte};
    jeden Gurt zuerst um den Handgriff der einen, dann der anderen Hälfte führen, dann über dem Patienten schließen und festziehen.
    \item Umlagern auf Vakuummatratze: Trage mit vorbereiteter Matratze
    (\See{topic:vakuummatratze-anwendung}) neben Patienten stellen um diesen
...
\fxwarning[author=GABS]{Sandwich-Technik: Neuerstellung von Grafik/Text 
                          notwendig}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Allgemeine
Beschreibung: \See{topic:vakuummatratze-beschreibung}

zur Ruhigstellung des gesamten Körpers, bei Verdacht auf mögliche
Wirbelsäulenverletzungen, Becken- oder Oberschenkelfrakturen
...
\begin{enumerate}
    ...
    legen, Schaufeltrage entfernen (\See{topic:schaufeltrage-handhabung})
...
\See{topic:spineboard-beschreibung}
...
Allgemeine
Beschreibung: \See{topic:rettungskorsett-beschreibung}
...
Allgemeine
Beschreibung: \See{topic:vacuumbeinschiene-beschreibung}
...
Allgemeine
Beschreibung: \See{topic:sam-splint-beschreibung}
...
Grundfertigkeiten{\textquotedblleft}} des \emph{Department für medizinische
Aus- und Weiterbildung -- Medizinische Universität Wien, Abt. Methodik und Entwicklung}, welches in Zusammenarbeit  mit dem Klinischem Institut für Hygiene und
...
\begin{compactenum}
    ...
    \item Absaugeeinheit: \par\Ca{Keine Intubation ohne
    Absaugung!}
...
\begin{enumerate}
    ...
    \item Cuff auf Dichtheit prüfen
...
\begin{enumerate}
    ...
    \item Sauerstoffberiselung einschalten und auf 15\LMin einstellen,
    Reservoir des Beatmungsbeutels füllen. 
    \item Durchführenden melden, dass alle Materialen bereit sind.
    \item \Z{Evt. werden jetzt von einem Arzt Medikamente verabreicht die
...
beklopfen. \emph{Bild: BEMAW}}}
    ...
    \begin{itemize}
        ...
        \item Wird das Medikamen nicht sofort verwendet Spritze mit 
    ...
    \begin{itemize}
        \item Arzt nach Kanülengröße fragen
...
Venenverweilkanülen. \Source{BEMAW (modifiziert)}}
