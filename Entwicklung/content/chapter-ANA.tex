...
Blutungen}.
Hierauf folgt die \I{Schädelkalotte}. 
\Z{Diese ist innen fest
...
ein Zeichen für eine schwerwiegende Verletzung!}%2 Text
{
\begin{itemize}
    \item Kopfschwarte
    \item Knochen
...
\begin{itemize}
  \item \T{Kohlehydratstoffwechsel} (\I{Zuckerstoffwechsel}): Zucker ist ein potenter
...
kommen (\prettyref{topic:oesophagusvarizenblutung}).}%2 Text
{
\begin{itemize}
...
\subsection{\HeadingKeyword{Bauchfell}}
\index{Bauchfell}
...
Darminhalt in die Bauchhöhle kommt.}%2 Text
{
\begin{itemize}
