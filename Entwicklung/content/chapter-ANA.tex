...
(\Speech{\protect\enquote{ZNS $\rightarrow$ Handmuskulatur: Leg' dich auf die Herdplatte}}) 
und von den Organen
zum ZNS 
...
\end{itemize}}%3 Slide
{./images//hirtler-aass/WS_Aufbau.pdf}%4 Bilddatei
{Rückenmark
mit abgehenden peripheren Nerven (gelb)}%5 Bildtitel
{Beachte dass die Nerven
geordnet nach Rückenmarkssegmenten abgehen}%6 Bildbeschreibung
{Lena Hirtler}%7 Quelle
{MfG}%8 Lizenz
% Vormals \Layout{20}
...
%
\T{Vegetative Nerven} leiten Informationen des vegetativen Nervensystems (\FullPrettyRef{topic:vegetatives-nervensystem}). 
...
zurückgefahren. 
%
Umgekehrt versetzt der \II{Parasympathikus} den Körper in einen \E{Ruhemodus} 
und aktiviert Organsysteme wie z.\,B. die Verdauung.
}
{%
\begin{itemize}
  \item Gegenspieler
