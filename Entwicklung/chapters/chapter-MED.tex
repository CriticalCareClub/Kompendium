...
\Layout{0}{\TxSymptome}
{%
Siehe \prettyref{tab:hxpertension-krise-notfall}. Kopfschmerzen und Nasenbluten
...
{\Z{(Die Unterscheidung zwischen "`Hypertensiver
...
oder Akutbehandlung. 
\marginline{\Commentary[Asthma / Spray]{Oft stellt sich die
Frage "`Darf der Patient seinen (vom Arzt vielleicht gerade für diese Situation
verschriebenen) Spray nehmen?"'
Grundsätzlich voll beim schweren Asthma-Anfall davon abgesehen werden,
"`blind"' ein inhalatives Beta-Mimetikum zu geben, das
zweifelhaft ist, ob die Luftpassage ausreicht, umd den
Wirkstoff in die Lunge zu befördern. Eine generelle
Freigabe, verschriebene Srpays einzunehmen, kann in
Anbetrcht der Nebenwirkungen bei Schleimhautresorption
...
\begin{itemize}
  ...
  \Commentary{\EE{Sprays bei Asthmapatienten}: Die Einnahme 
  durch den Patienten soll nicht mehr erfolgen. Rationale
  ist, dass bei schweren Anfällen der Wrikstoff die
  Bronchien nicht im ausreichenden Maße erreicht und
  stattdessen durch die Schleimhäute resorbiert wird.
  Dadurch kommt es zu mehr Neben- als Hauptwirkung.}
\end{itemize}
