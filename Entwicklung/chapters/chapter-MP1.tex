...
an die Absaugpumpe angeschlossen wird (Abbildung
...
an. \Z{Die Farbcodierung kann \prettyref{tab:absaugung}
entnommen werden.}

\begin{table}[H]
\Captionof{table}{Farbcodierung von
Absaugkatheter\label{tab:absaugkatheter}}
