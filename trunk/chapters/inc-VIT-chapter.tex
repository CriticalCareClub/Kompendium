...
\ce{O2}-Konzentration in der Umgebungsluft
...
$\rightarrow$ \ce{O2}-Mangel (Hypoxie)   
...
\begin{itemize}
\item Zu geringer \ce{O2}-Gehalt im Blut (Hypoxie)
\begin{itemize}
...
\end{itemize}}
\\
Zu wenig Flüßigkeit\,/\,Blut vorhanden 
 &
{\begin{itemize}
...
\gE{Kationen:} positiv geladene Teilchen (\ce{K^+}, \ce{Na^+},
\ce{Mg^{++}}, \ce{Ca^{++}}, \ldots); \gE{Anionen:} negativ
geladene Teilchen (\ce{Cl^-} )

Ionenverteilung: \gE{IZR:} viel \ce{K^+}, wenig \ce{Na^+};
\gE{EZR:} viel \ce{Na^+}, wenig \ce{K^+}}
...
Verbindungen, die \ce{H^+} aufnehmen können
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \gZ{\ce{HCO3^- + H^+ <->[\text{Gleichgewicht}] CO2 + H2O}
        (Formel nicht lernen!)}
        \item \ce{$\text{\gZ{\tiny Bikarbonat}}$ + $\text{Säure}$ <->[\text{Gleichgewicht}] CO2 + $\text{\gZ{\tiny Wasser}}$  }
        \begin{itemize}
            \item Atmet der Patient nicht (genug) staut
            sich das \ce{CO2} und bildet mit Wasser \ce{H^+}
            ${\rightarrow}$ \gE{Atmungsbedingte Übersäuerung}
            \item Atmet der Patient zu viel wird zu viel
            \ce{CO2} abgeatmet und wird von \ce{H^+} und dem
            anderen Stoff nachgebildet ${\rightarrow}$ \ce{H^+}
            fehlt ${\rightarrow}$ \gE{Atmungsbedingte Alkalose}
            \item Fällt zu viel \ce{H^+} (Säure) im
            Körper an (durch den Stoffwechsel, Stoffwechselbedingte Übersäuerung) wird es zu (Wasser
            und) \ce{CO2} umgewandelt, \gE{das \ce{CO2} wird
            abgeatmet.}
        \end{itemize}
    \end{itemize}
    \item Lunge
    \begin{itemize}
        \item Abatmung von \ce{CO2} ${\rightarrow}$ Einfluss auf den Puffer (s.o.)
    \end{itemize}
    \item Niere
    \begin{itemize}
        \item Ausscheidung (oder Wiederaufnahme)  von \ce{H^+}
    \end{itemize}
\end{itemize}
...
\marginlabel{\gZ{nach: \cite{ForMed2}}}
...
%\vspace{1em}
\subsubsection{Unterlassung der Reanimation}

\fcolorbox{ubuntured}{White}{
      		\begin{minipage}[t]{\linewidth}
              \gCa{Unter den folgenden Voraussetzungen darf (oder muß) eine
