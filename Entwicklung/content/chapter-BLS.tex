...
{%
Die Reanitmation des Neugeborenen wird unter \FullPrettyRef{topic:reanimation-neugeborenes} ausgeführt.}
{%
\begin{itemize}
  \item \FullPrettyRef{topic:reanimation-neugerborenes}
\end{itemize}
}
