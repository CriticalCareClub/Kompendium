...
berücksichtigt werden. Zum Absichern selbst können Hilfsmittel
...
{
Das Pannendreieck, welches auch zum Schutz dazukommender Dritter dient, sollte
dem jeweiligen Anhalteweg entsprechend zur Unfallstelle aufgestellt werden.
...
Eine der größten Gefahren für den Ersthelfer auf Strassen oder
    ...
    auf der anderen Seite auch ein fester Untergrund vorhanden ist (sonst liegt
    man ev. 30\,m tiefer unter einer Brücke).
Bei jedem Verkehrsunfall herscht \gCa{Explosionsgefahr}
...
werden. Sollten \gEs{Kleidungsstücke} brennen, sollen die Flammen
sofort mit einer Decke o.ä. erstickt werden und, wenn möglich, die verbrannte
Kleidung vom Patient entfernt werden\footnote{Nur wenn leicht möglich. Mit der
Haut verbundene, "`eingebrannte"' Kleidungstücke müssen belasen werden.}.
...
Türklinke angreifen (heiss!) und die Türe nur langsam öffnen. Den Raum nur zum Retten von Personen
	betreten. Aufgrund der Rauchgase, des Sauerstoffmangels und des
	Kohlenmonoxids (\ce{CO}) darf \gE{nicht geatmet werden!} Nach 1-2 Atemzügen
	kann es schon zur Bewusstlosigkeit kommen. Kein
	Fenster öffnen. Dadurch kommt wieder Sauerstoff in den Raum und und das Feuer
	wird wieder angefacht. 
	
	In mit \gEs{Gas gefüllten Räumen}\footnote{Austreten von Gas aus der
	Gasleitung, Stickgase durch defekte Heizungen, Gärkeller, \ldots} besteht akute Explosion- und
	Erstickungsgefahr. Jeder Funke muss vermieden werden! Es darf daher kein Licht aufdreht, nicht telefoniert, geklingelt oder gerauchen werden. Das Fenster 
soll wenn möglich geöffnet und die Gaszufuhr abdreht werden. Auch
hier gilt es, den Raum nur zum Retten von Patienten zu betreten und nicht zu
atmen!
...
Eine Besonderheit stellen \gEs{Gefahrguttransporte} dar
(\gSee{topic:gefahrengutunfall}). Sie sind -- wie es ihr Name schon sagt -- mit
gefährlichen Gütern versehen und haben somit ein erhöhtes Gefärdungspotential.
Zu erkennen sind Gefahrguttransporter durch eine orange, rechteckige Warntafel mit
...
Die Abnahme des Sturzhelmes muss möglichst rasch und schonend erfolgen.
...
\gEs{Atemwege freimachen}. Im Verdachtsfall soll die
Mundhöhle auf Fremdkörper kontrolliert werden. Anschließend wird der Kopf
...
10~Sek. lang überprüft, ob eine normale Atmung vorhanden ist oder nicht. 
...
Nach Beendigung der Vitalfunktionkontrolle, kann der Ersthelfer zu der
Erkenntnis kommen, dass der Patient zwar \gEs{kein Bewusstsein} hat, aber eine \gEs{ausreichende Atmung} und daher ein \gEs{vorhandener Kreislauf} besteht. In
einer solchen Situation liegt die Notfalldiagnose \gT{Bewusstlosigkeit} vor. Der
Patient besitzt keine Schutzreflexe mehr und ist daher chutz- und hilflos. 
}{
\begin{itemize}
...
Autoapotheke gemäß \gAbk{ÖNORM} befindliche Rettungsdecke. Weiters muss eine
...
zugeführt. Zu guter letzt kommt der \gEs{psychischen Betreuung} des Patienten
durch den Ersthelfer eine große Bedeutung zu.
}{
\begin{itemize}
...
Der Patient hat starke \gEs{Schmerzen} im Bereich des betroffenen Gelenkesund
...
\gMassnahmen{
\paragraph{Erste-Hilfe-Maßnahmen bei Knochenbrüchen}~
