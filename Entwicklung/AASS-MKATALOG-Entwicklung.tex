...
Steht keine Pulsoxymetrie zur Verfügung, ist als Richtwert
von einer Dosis von 8\LPerMin* auszugehen, welche dem
klinischen Zustand des Patienten angepasst werden soll.
...
\pagestyle{empty}\loadgeometry{WholePage}\cleardoublepage
...
{Graphische Übersicht: Standardisierte Patientenversorgung}
{}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \autocite{MA70-Protokoll-2012-10-11}:
    \begin{itemize}
