...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TODO Psychologie: Neuerstellung
\TODO{GABS}{????-??-??}{Psychologie/Psychiatrie: Burn-Out: Neuerstellung von
Text notwendig}{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Bestimmungen (\EE{Unterbringungsgesetz}) Maßnahmen
durchzuführen sein, so sind diese von der \EE{Exekutive}
...
Anstalt gebracht werden, wenn ein im \EE{öffentlichen
Sanitätsdienst stehender Arzt} oder ein \EE{Polizeiarzt} sie
...
{\S}\,9\,(1) Die \EE{Organe des öffentlichen Sicherheitsdienstes}
...
öffentlichen Sicherheitsdienstes} die betroffene Person \EE{auch
...
Zittern, Unruhe, Angst, \EE{Halluzinationen} ("`weiße Mäuse"', \ldots), vegetativer Entgleisung (Tachykardie,
