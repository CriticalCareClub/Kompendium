...
\Layout{2}{Kompetenzen werden erweitert}{%
...
\Captionof{figure}{Assistieren beim (not-) ärztlichen Maßnahmen.}
\end{minipage}\par
...
\Captionof{figure}{Führungsrolle bie der Bewältigung eines Großschadensereignis: Der Leider einer Sanitätshilfestelle (SanHiSt).}
\end{minipage}\par
