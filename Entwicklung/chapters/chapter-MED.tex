...
Herz-Kreislauf-Systems zurück.  Mit steigendem Lebensalter erhöht sich die
Wahrscheinlichkeit an einer solchen zu erkranken. 

Eine wichtige Gruppe stellen
die erworbenen, durch den Lebensstil bedingten Erkrankungen
dar. Zu den wesentlichen Risikofaktoren zählen
Übergewicht, mangelnde Bewegung, Rauchen, Bluthochdruck,
erhöhte Blutfettspiegel und ein erhöhter Blutzuckerspiegel.

Akute Notfälle ereignen sich oft nicht unvorhersehbar, oft
leidet der Patient vorab an \E{chronischen
Varianten} einer Herz-Kreislauferkrankung
bzw. einer verwandten Grunderkrankung, welche zu einem
Notfallgeschehen führen kann.
...
\E{chronischer Zustand} mit dem sie gut leben können, da sich
der Körper mit der Zeit an die abnehmende Leistungsfähigkeit
gewöhnt.

Problematisch wird es jedoch, wenn die \E{Kompensationsmechanismen} (köpereigene, Medikamente, {\dots})
versagen und der Patient plötzlich eine Symptomatik entwickelt . Man spricht dann von der \EE{dekompensierten}
...
Symptome sind weniger alarmierend als plötzlich auftretende
Symptome. Plötzlich auftretende Symptome sind oft \EE{Alarmzeichen}. 
}{%
\begin{itemize}
...
\EE{(kardiales) Lungenödem}. Ein typisches Zeichen dafür
ist das \EE{brodelnde Atemgeräusch}\index{Atemgeräusch!brodelndes - bei
...
Lungenkreislauf} kann es zu einem \EE{kardialen Lungenödem}
kommen.

\Layout{0}{Kardiales Lungenödem und Linksherzinsuffizienz}
{\index{Lungenödem!kardiales - bei Herzinsuffizienz}
Patienten mit einem \E{kardialem Lungenödem} sind
...
den Herz-Kreislaufstillstand bringen.
}{
\begin{itemize}
...
\Layout{0}{\TxSymptome}{%
Der Patient klagt über Atemnot (\EE{Dyspnoe}). Oft
...
(\EE{Hypotonie}). Allerdings kann ein erhöhter Blutdruck
bei einer Blutdruckkrise (\EE{Hypertonie}, \E{hypertensive
...
\begin{itemize}
  ...
  \item \EE{Hustenreiz}
  \item Unruhe
  \item \EE{Hypotonie} oder \EE{Hypertonie} (\Abk{RR}\,↑↑ kann Auslöser
  sein)
...
\begin{description}
  ...
  \EE{Herzkranzgefäße} (Koronargefäße)
  ...
  \EE{Unterversorgung des Herzmuskels} mit Blut und
  Sauerstoff. Die Ursache sind in erster Linie verengte oder verstopfte
  Herzkranzgefäße. Das akute Koronarsyndrom ist häufig das
  Ergebnis einer vorbestehenden koronaren Herzkrankheit.
\end{description}
...
\EE{Missverhältnis zwischen Sauerstoffangebot und  
...
\EE{strahlt häufig aus}, häufig in den Kiefer, (linken) Arm und in den Rücken,
evtl. auch in den Oberbauch. Der Schmerz wird als brennend bzw. stechend beschrieben.
Dazu kommt i.\,d.\,R. ein \EE{Druckgefühl} am Brustkorb, \emph{"`als würde jemand
auf dem Brustkorb stehen."'} \EE{Todesangst und Vernichtungsgefühl} ist
häufig. 

Ein weiteres wichtiges Leitsymptom ist die \EE{Atemnot}
(\E{Dyspnoe}).

Ein akuter Angina pectoris-Anfall ist primär \EE{nicht sicher von einem
...
Brustschmerz zusammen mit \EE{Atemnot} und \EE{Todesangst} im Vordergrund. Der
\EE{Brustschmerz} kann in Richtung Magen, rechter oder linker Hand, Kiefer
oder auch Rücken \EE{ausstrahlen}. Zusätzlich zu dem
...
\begin{itemize}
  ...
  \item \EE{Nitro-Spray}: Manche Patienten haben einen
...
\begin{itemize}
  ...
  Verschreibung unbotmäßig eingreifen. Leidiglich bei
...
behandelt und normalerweise nicht auf eine beliebige
Internistische Station gebracht\cite{Kalla2006}. Der Notarzt
muss i.\,d.\,R. zwischen dem Einleiten einer Lyse-Therapie und der Einweisung in ein Herzkatheterlabor entscheiden.

\index{PTCA}
\index{Herzkatheterlabor}
Bei der \EE{Lyse-Therapie} versucht man mittels eines speziellen
Medikaments eine Verstopfung aufzulösen. Mit einem \EE{Herzkatheters}
versucht man die verengten oder verstopften Gefäße aufzudehnen. Dazu benötigt
man ein entsprechend ausgestattetes
\EE{Herzkatheterlabor}. Der Herzkatheter wird oft
...
zwischen Notarzt und diensthabendem Oberarzt der Abteilung
ist erforderlich. Die PTCA ist in Wien im AKH, Donauspital,
KH Hietzing, Rudolfstiftung, Hanusch-Krankenhaus und
Wilhelminenspital verfügbar.\ZFootnote{Angaben ohne Gewähr,
...
{%
Herzrhythmusstörungen können hervorgerufen werden durch eine \EE{Störung der
Frequenz} (zu langsam, zu schnell) oder einer \EE{Störung der Regelmäßigkeit}.
Wenn man die elektrischen Ströme mittels eines EKG darstellt, kann man
zusätzlich auch \EE{Störungen der Form der elektrischen Herzströme} erkennen
...
Im Rahmen von Herzrhythmusstörungen kann es zu einer \EE{Entkoppelung der
...
\EE{keine Auswurfleistung} erreicht!
}
{
\begin{itemize}
  \item \Ca{Reanimation!}
...
Extrasystolen sind "`Extraschläge"' des Herzens, sie können vereinzelt oder
gehäuft auftreten, eventuell auch "`salvenartig"'. Je nach Häufigkeit haben
Extrasystolen unterschiedliche Auswirkungen auf den Kreislauf und können
symptom- bzw. bedeutungslos sein, oder auch Beschwerden verursachen. Wenn die
Extrasystolen die normale Herzpumpfunktion massiv stören, können Sie auch
...
\Layout{0}{\TxBeschreibung}
{%
Tachykarde Attacken sind ein häufiges Notfallbild. Da oft chronische Erkrankungen
die Ursache sind, haben die Patienten diese Attacken immer wieder und kennen die
Symptome bereits (und oft auch die Behandlung). Die Ursachen können sehr
unterschiedlich sein und sind auch vom Fachmann oft nicht leicht zu ermitteln.

Eine große Rolle spielt die \EE{Anamnese}: Oft sind entsprechende
Grunderkrankungen schon seit langem bekannt, oft gibt es bereits entsprechende
Arztbriefe oder Befunde. Ein rasches Hinweisen auf diese Befunde ist für den
nachbehandelnden Arzt wichtig um eine rasche, zielführende Behandlung
einzuleiten.
}{
\begin{itemize}
...
\EE{"`Herzklopfen"'} und ist unruhig. Manchmal wird der Anfall von
...
{%
Da das \EE{Herz plötzlich viel mehr Arbeit leisten
muss}, kann es sein, dass es an seine \EE{Grenzen}
stößt und \EE{versagt} bzw. die Blutversorgung
...
\Layout{0}{Richtwert}{%
Beim Erwachsenen beträgt der untere Grenzwert des Blutdrucks 100\,mmHg syst. 
Jeder Mensch hat allerdings im gewissen Rahmen einen "`eigenen Normalwert"', 
bei Kindern gelten grundsätzlich andere Werte.
\cite{PraxisleitAllgemeinmed6} }{%
\begin{itemize}
  \item Erwachsener: RR\textsubscript{sys} {\textless} 100\,mmHg
...
Die Schädigung des Herzmuskels ist die Folge von dem erhöhten
Druck gegen den das Herz pumpen muss. Der Muskel vergrößert
sich um mit der Belastung fertig zu werden, kann aber dann
nicht mehr ausreichend mit sauerstoffreichen Blut versorgt
werden.
...
hypertensive Krise oder hypertensiver Notfall bezeichnet. Der
Unterschied zwischen den beiden Diagnosen ist das Fehlen bzw.
Vorhandensein von typischen Symptomen, s.
...
\Layout{0}{\TxSymptome}
{%
Siehe \prettyref{tab:hxpertension-krise-notfall}.
Nasenbluten (\T{Epistaxis}\index{Epistaxis}) ist ein
typisches Symptom für einen plötzlich erhöhten Blutdruck.

Symptome wie Kopfschmerzen, Schwindel und Übelkeit und sind
typische Leitsymptome für einen hypertensiven \E{Notfall}.
...
\Layout{0}{\TxSymptome}
{
Leitsymptom ist eine \EE{schmerzhafte Extremität}, zusammen mit einer (meist
einseitigen) \EE{Schwellung}, \EE{Überwärmung} und einer
dunkel-bläulich-violetten (lividen) \EE{Verfärbung}. 
...
Gasaustausch teil: Es entsteht eine \EE{Lungenembolie}
...
\Captionof{figure}{Throm\-bose\-prophy\-laxe. \Z{Niedermolekulares Heparin
...
\SourcePicture{Gabriel}}}
&
\includegraphics[angle=90,width=\linewidth]{./images/hirtler-aass/Thrombus-Embolie.pdf}

\Captionof{figure}{Eine Venenthrombose kann eine Embolie auslösen. \SourcePicture{Hirtler}}
\\\addlinespace\bottomrule
\end{tabularx}
}{Bilderserie: Thromboserisiken}{}
...
wahrnehmbar. Die Exspiration ist ausserdem verlängert. Trockener Husten ist häufig.
...
(\E{Tachypnoe} und \E{Tachykardie}). Die Sauerstoffsättigung kann
erniedrigt sein. 

\subparagraph{\Ca{Schwerer Anfall}}

Im schweren Anfall ist oft \EE{kein}, oder nur mehr ein
\EE{leises Atemgeräusch} hörbar (da kaum mehr
...
\begin{itemize}
  ...
  erreicht ist, \EE{nicht mehr!} Wenn keine Pulsoxymetrie vorhanden ist
  8\LPerMin*. \Commentary{\EE{Asthma: \protect\ce{O2} bis eine
  Sauerstoffsättigung von 95\PC* erreicht ist, oder 8\LPerMin*
  :} Diese Empfehlung ist nicht als streng, sondern als
  Richtwert zu betrachten; die einschlägige Literatur ist
  widersprüchlich. Besonderes betont muss die Notwendigkeit
  zur Überwachung des Patienten bezüglich
  Bewusstsein(sstörungen) und Atmung werden!)}
...
evtl. Zyanose. Man kann oft ein \E{brummendes, pfeifendes oder giemendes
Atemgeräusch} hören.
...
\begin{itemize}
  ...
  man bei Atemnot versuchen \VonBis{1}{2}\LPerMin*{} höher zu dosieren. Die Atmung muss
...
Meist atmet der Patient schnell
(Tachypnoe) und klagt über einen \EE{atemabhängigen Thoraxschmerz}. Daneben
kommt es zu einer \E{Tachykardie} und Angstgefühlen.
...
{%
Oft findet man deutlich hervortretende, \EE{gestaute Venen} am Hals aufgrund des
Blutrückstaus. 

Je nach Ursache der Embolie und Herkunft des Embolus kann man Zeichen anderer
Krankheitsbilder wahrnehmen: Bei einer \EE{tiefen Beinvenenthrombose} ist ein
Bein geschwollen, überwärmt, rot/rot-bläulich verfärbt und schmerzhaft
(\prettyref{topic:thrombose}). Eventuell kann man auch einen \E{arrhythmischen
Puls} in Folge eines Vorhofflimmerns ertasten; evtl. gibt der Patient auch an,
an Vorhofflimmern zu leiden. 
}{
\begin{itemize}
...
Liegegipsverbände oder lange Reisen, innerhalb
der letzten 4 Wochen, erhöht das Risiko einer Thrombose und damit auch das einer
Lungenembolie. 

Oft ist bei den Patienten auch \EE{Vorhofflimmern} als chronische Erkrankung
bekannt.
...
{%
Ein Lungenödem kann aufgrund einer \EE{Herzschwäche} (\E{kardial}) oder
aufgrund von \EE{Inhalation giftiger Substanzen} (\E{toxisch}) entstehen.

Beim \EE{kardialen Lungenödem} versagt die Auswurfleistung des linken Herzens
(\EE{Linksherzinsuffizienz}), dadurch kommt es zu einem \EE{Rückstau} des Blutes
in die Lunge. Aufgrund der Druckerhöhung tritt Flüssigkeit in das Gewebe über, es
bilden sich Ödeme im Gewebe bzw. \EE{Flüssigkeitsansammlungen} in den Alveolen.
Auslöser kann zum Beispiel ein Herzinfarkt sein, der die Funktion des
Hermuskels massiv in MItleidenschaft zieht.

Beim \EE{toxischen  Lungenödem} kommt es aufgrund reizender Stoffe zu einer
\EE{Entzündung}, und damit zu einem \EE{Flüssigkeitsaustritt}, im Lungengewebe.

In beiden Fällen behindert die Flüssigkeit den \EE{Gasaustausch} massiv, beim
kardialen Lungenödem kommt noch das begleitende Herzproblem dazu.
...
sind \EE{lebensbedrohlich krank}. Das Herz verbraucht oft
schon die allerletzten Reserven. In schweren Fällen kann schon die Aufregung
durch den Transport im Stiegenhaus zum Auto zu einem
Herz-Kreislaufstillstand führen. 

Es kommt tatsächlich relativ häufig vor, dass diese Patienten \EE{im
Stiegenhaus} oder \EE{im Auto}
\EE{reanimationspflichtig} werden. Solche Patienten müssen daher \EE{an Ort
und Stelle} eine entsprechende (ärztliche) Therapie erhalten bevor sie
...
Das Leitsymptom ist das \EE{brodelnde Atemgeräusch}, welches in schweren Fällen
bereits ohne Hilfsmittel hörbar und typisch für das Lungenödem ist. Es klingt,
als würde jemand mit einem Strohhalm in ein Glas Wasser hineinblasen. Im
Extremfall kann man es bereits \E{auf mehrere Meter Entfernung} wahrnehmen. 

Weitere häufige Symptome sind \EE{Atemnot} und \EE{Zyanose}. Der Patient bekommt
oft nur \E{aufrecht sitzend} genügend Luft (Orthopnoe). 
}{
\begin{itemize}
...
\Layout{0}{\TxSymptome}
{%
Die Patienten beklagen \EE{Atemnot}, obwohl die \ce{O2}-Zufuhr nicht
beeinträchtigt und das Blut maximal gesättigt ist (Sp\ce{O2} von 100\,\%). Sie
haben eine \EE{tiefe und schnelle Atmung} (\E{Tachypnoe}).
...
einer \EE{psychischen Belastungsreaktion} bzw. Folge einer Panikattacke. Auch
...
aufgrund anderer Ursachen abgegrenzt werden. Bei \EE{Ateminsuffizienz} oder
\EE{durch Erkrankungen verursachte Atemnot} kommt es natürlich auch oft zu
einer (kompensatorischen) Hyperventilation (Herzinfarkt, Lungenembolie, Pneumothorax,
Asthma-Anfall, \ldots). 

Bei einer stoffwechselbedingten \EE{Übersäuerung} (Azidose) kommt es zu einer
Hyperventilation um \ce{CO2} abzuatmen (dadurch wird Säure im Körper abgebaut). Die \E{Kussmaul'sche Atmung} beim \EE{diabetischen Koma} wäre ein typisches
...
\begin{description}
  ...
  zu einer \E{schlaffen, kompletten Lähmung} führen. Ein \E{herabhängender Mundwinkel} ist ein Zeichen einer Lähmung
  der Gesichtsmuskulatur. Durch die Lähmungen kann es zu \EE{Schluckstörungen} kommen, es
  besteht dann eine erhöhte Aspirationsgefahr.
  
  Der \T{Herdblick} ist eine "`Blickdiagnose"': Es kann zu Blicklähmungen
  kommen, der Patient blickt in Richtung des "`Herdes des Geschehens"'.
  
  \item[Sprache] Störungen der Sprache sind ebenfalls sehr
  häufig. Oft nimmt man eine \EE{verwaschene Sprache} wahr, welche (fälschlich) an
  Trunkenheit erinnert. Weiters kann es zu einer "`wirren Sprache"' kommen: Worte fehlen dabei oder
  ...
  z.\,B. Schwindel und Kopfschmerzen auftreten.
  ...
  sind \EE{Kopfschmerzen}, gefolgt von Übelkeit. In weiterer
  Folge treten \EE{Bewusstseinsstörungen} auf. Der Patient
  ist \EE{hyperton, aber bradykard} (RR\,↑, HF\,↓.). Typisch ist
  die \EE{Ungleichheit der Pupillen}
  \Z{(Anisokorie)\index{Anisokorie|Z}}, bzw. eine
  verlangsamte Lichtreaktion. In schweren Fällen kommt es zu sog. Strecksynergismen, d.\,h.  der Patient reagiert bei
  Schmerzreiz nur mit einem ungerichtetem Strecken der
  Extremitäten. 
  \cite{StriebelAnaesthesie2} %[Bd.2, S.1344]
...
\EE{Blutzucker}-Stoffwechsels. Sowohl die Hyper-, als auch die
Hypoglykämie können einen Schlaganfall vortäuschen. Bei
...
%
\EE{Kinder} unter 5~Jahren können bei schnellem, hohen Fieberanstieg
...
\Layout{0}{\TxSymptome}{%
Das Leitsymptom sind Schmerzen in der
...
\Layout{2}{Insulin}
{%
\T{Insulin} \index{Insulin} ist ein Hormon und wird in den "`Beta"'-Zellen
...
\begin{labeling}[~--]{xxxxxxx }
  ...
  \EE{Medikamenten} behandeln. Erst im Endstadium muss mitunter auch Insulin
  gespritzt werden.
...
\begin{labeling}[~--]{xxxxxxxxxxxxxxx }
  \item[Gefäßschäden] \begin{itemize}
    ...
    \item \EE{Beine}: "`Diabetischer
    Fuß"', infolge der Mangeldurchblutung in der Peripherie heilen auch kleine
    Wunden nicht mehr, in weiterer Folge muss immer weiter amputiert
    werden.
    \item \EE{Herz}: Die Herzkranzgefäße
...
\EE{Bewusstseinsstörungen}. Von der anfänglichen
...
Probleme. Einerseits wirkt der Zucker wie ein Elektrolyt auf den \EE{Flüssigkeitshaushalt} ein und
...
Zellen hineinzubekommen, es entsteht ein \EE{Nährstoffmangel}.
}{
\begin{itemize}
...
\EE{vermehrte Harnproduktion} (Zucker wird ausgeschieden). Er klagt über
Abgeschlagenheit, in weiterer Folge kann es zu \EE{Bewusstseinsstörungen} bis
hin zum \EE{Koma} (s.u.) kommen. Die Geschwindigkeit der Veschlechterung ist je
...
einer stoffwechselbedingten Übersäuerung (metabolische \EE{Azidose}
...
Ketoazidose (sauer) versucht der Körper diesen Mechanismus auszunutzen: Er \EE{hyperventiliert} um sich "`vom sauren pH
    zum normalen pH zu atmen"'. Es ist daher bei diesen Patienten eine
    \EE{schnelle, tiefe Atmung} feststellbar\ZFootnote{Diese
...
dann das \EE{Beschwerdebild beschrieben} (Ort des Schmerzes, Art des
...
\begin{itemize}
  ...
  %     verschlechtern.
  \item Transportentscheidung: Situationsgerecht, z.\,B. Abt. f. Chirurgie oder
  Innere Medizin.
...
\begin{itemize}
  ...
  \item Monitoring: Der Zustand kann sich abrupt
  verschlechtern.
  \item Transportentscheidung: Abt. f. Chirurgie, bei Kindern ${\rightarrow}$
...
\Z{%
\index{Ileus}\T{Ileus}  (vollständig)
...
(\EE{kolikartigen}) \EE{Schmerzen} im \EE{rechten Oberbauch},
...
Havel2007,% Rea während Transport
SiewertChirurgie8,
AMLS3,
Erc2005DeSec5,
Erc2005Sec5,
