...
\begin{description}
  \item[ÖBB-Einsatzleiter] Der \Es{ÖBB-Einsatzleiter} ist der
  ...
  Leitstelle)!
  \item[Problem Loaklisation] An den Masten der Oberleitungen der ÖBB sind
  ...
  Schienenfahrzeuge haben einen \Es{massiv verlängerten Bremsweg}: Ein Güterzug
  benötigt ca. 1\,km, ein Personenreisezug bis zu \Es{2,6\,km} um zum Stillstand zu kommen!
...
\begin{itemize}
  \item \Es{G}efahr erkennen
  \item \Es{A}bsperrmaßnahmen durchführen
  \item \Es{S}pezialkräfte anfordern
\end{itemize}
}{}{}{}
