...
\begin{itemize}
    ...
    z.\,B. Hand-, Fußwurzelwurzelknochen
...
\begin{Synopsis}
  \SynopsisItem{AMV = AZV $\ast$ AF, beim Erwachsenen  ca.
  \VonBis{6}{8}\Liter*}
\end{Synopsis}
...
\begin{itemize}
  ...
  %
  \item Durchlutung (Perfusion) der die Alveolen umgebenden Blutgefäße
  %
...
\item  (ganz außen), bildet den Herzbeutel.
\end{itemize}
...
\begin{itemize}
  ...
  Herzauswurf: 
  In der \E{Auswurfphase}(Systole) erreicht er sein \E{Maximum},
  und sinkt danach in der \E{Füllungsphase} des Herzens
  (\T{Diastole}) wieder ab, 
...
Blutungen}.
Hierauf folgt die \I{Schädelkalotte} und die \II{Hirnhäute}.  
...
%
Grundsätzlich hat der \E{Sympathikus} eine 
(nach außen gerichtete) 
\E{leistungssteigernde Wirkung}, 
wohingegen der \E{Parasympathikus} 
eher der \E{Ruhe}, 
Erholung 
...
und Plasmawasser mit zahlreichen darin geklösten Stoffe 
