...
\addtokomafont{section}{\Huge\rmfamily\color{ubuntured}}
\addtokomafont{subsection}{\huge\rmfamily\color{ubuntured}}
\addtokomafont{subsubsection}{\LARGE\rmfamily\color{ubuntured}}
...
\newcommand{\gAuthNotesPicLegalNotOk}[2]{\gAuthNotes{Bild:
\underline{#1}: Quelle zweifelhaft! #2}}
\newcommand{\gAuthNotesPicLegalOk}[2]{\gAuthNotes{{\color{green}Bild:
\underline{#1}: Quelle OK! #2}}}
...
\newcommand{\gSource}[1]{\small\emph{{\bfseries Quelle:}
#1}}

\newcommand{\gSourcePicture}[1]{\small\emph{{\bfseries
Bild:} #1}}
...
{\setlength{\evensidemargin}{3cm}}{\par}
...
\toprule
\multicolumn{3}{c}{\bfseries\sffamily Dias}\\\midrule
#1 & #2 & #3 \\\bottomrule
\end{tabularx}  
%\end{widepar}
...
\begin{description}
\item[Satz und Druckvorstufe] \LaTeX 
...
Sauerstoff (chem. Symbol $O_2$) ist ein lebenswichtiges Gas
welches in unserer Atemluft vorkommt und au{\ss}erdem ein essentielles Notfall{\textquotedblright}medikament{\textquotedblleft}, die
...
in Liter pro Minute (\gLMin) an. Das Barometer zeugt den
Druck in der Sauerstofflasche an wenn das Haupt\-ventil ge\"offnet ist. 
...
Tumor
 &
St\"orungen der $O_2$-Versorgung:
\begin{itemize}
    \item Atemst\"orungen  (Hypoxie)
    \item Herz-Kreislaufst\"orungen
    \item Elektrolytentgleisungen
\end{itemize}
...
\begin{gMassnahmenEnv}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item $O_2$: nach Ermessen, im Zweifel ca.
            6-8\gLMin
        \end{itemize}
...
\begin{center}
\tablehead{}\begin{tabularx}{\linewidth}{XX}
\toprule
klinischer Tod
 &
biologischer Tod
...
Normale Körper-Kerntemperatur: 37\,{\textdegree}C
...
\index{Atome}\index{Ionen}\index{Elektrolyte}
...
Kationen: positiv geladene Teilchen ($K^+$, $Na^+$,
$Mg^{++}$, $Ca^{++}$, \ldots)
...
Beim Neugeborenen / S\"augling 8-9\,\% KG  (70-80\,\% 
K\"orperwasser!)
...
\paragraph{pH-Wert}\index{pH-Wert}
...
$CO_2$  Abatmung vermindert ${\rightarrow}$ Hyperkapnie,  Ans\"auerung des
Blutes
...
\subsubsection{Stoffwechselbedingte \"Ubes\"auerung -Metabolische Azidose}
...
\gFazit{Im Endeffekt kommt immer zu wenig Blut=Sauerstoff zu den
Organen, dadurch ist die Ge\-webedurchblutung nicht ausreichend  f\"ur die
...
Bewu{\ss}tseinsst\"orungen wie Kollaps/Synkope (kurzfristige Blutverteilungsst\"orung, kurzfristige
...
{\sffamily\bfseries\Huge\color{green} \Smiley}
 &
\begin{itemize}
...
\end{itemize}
\\\hline
{\sffamily\Large\color{red} \centering Schwerer Schock\par
...
\end{itemize}
\\\hline
{\sffamily\Large\color{red} \centering Endstadium\par
...
Schockbek\"ampfung\}label{bkm:RefHeading38104902}}\marginlabel{Schockbekämpfung}\label{topic:schockbekaempfung}\index{Schockbek\"ampfung}
...
\subsubsection{Hypovol\"amischer Schock}
...
\begin{center}
\begin{supertabular}{|m{3.31cm}|m{9.99cm}|}
\hline
...
\subsubsection{Septischer Schock und
Toxischer Schock}
...
\begin{figure}[h]
    ...
    die Patientin ist am Monitor angeschlossen.
    \gSourcePicture{Gabriel}}
...
Röntgendarstellung. \gSourcePicture{Hauer}}
\end{center}
\end{figure}
