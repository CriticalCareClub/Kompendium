...
\Layout{2}{\TxBeschreibung}{%
\TODO{GABS}{2010-07-20}{Überarbeitung dringend notwendig!}{}

Atem- oder kreislaufbedingte Störungen des Neugeborenen,
welche zu einer Sauerstoffunterversorgung (Hypoxie) führen.
Die Asphyxie kann vor, während und nach der Geburt
auftreten.

Ursachen können u.\,a. eine Placenta praevia,
ein Nabelschnurvorfall, Lageanomalien, eine Frühgeburt,
u.\,v.\,a.\,m. sein.

Kennzeichen einer Asphyxie sind: 
\begin{itemize}
  \item Fruchtwasser trüb/grünlich
  \item Atmung/Schreien fehlt
  \item Schlaffer Muskeltonus
  \item Fortbestehende Zyanose (eine Zyanose unmittelbar
  nach der Geburt ist normal)
  \item \Abk{HF} < 100\,\nicefrac{x}{min}
\end{itemize}
}{%
...
\begin{itemize}
  ...
  \item Atmung vorhanden? \begin{itemize}
    \item \ce{O2}-Gabe ("`\ce{O2}-Dusche"') für 30\,Sek.
  \end{itemize}
  \item Wenn weiterhin \EE{Atemstillstand} oder
  \EE{Herzfrequenz < 100\,\nicefrac{x}{min}} → Reanimation
  des Neugeborenen
\end{itemize}
}
