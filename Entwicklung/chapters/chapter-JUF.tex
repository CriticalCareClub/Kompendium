...
\begin{itemize}
  ...
  \Speech{\color{DefaultA}Sollten Alex, Sepp und Bernd fälschlich einen
...
berücksichtigen:
\begin{itemize}
  \item \Speech{\color{DefaultA}Da Herr Hauzu eine psychiatrische Erkrankung
...
\Speech{\color{DefaultA}Da der Angriff unmittelbar drohend ist, und auch
...
\Speech{\color{DefaultA}Sowohl die geplante neurologische Untersuchung,
...
Die Patientin Fr.
Uninformiert ist volljährig und zeigt keine Kennzeichen einer fehlenden Einsichts- und
...
\Speech{\color{DefaultA}Die \enquote{Verfügung} erfüllt nicht die strengen
...
\begin{enumerate}
    ...
    \Speech{\color{DefaultA}Bei Anschnallen des Patienten hätte er mit
...
Team zu einem näher gelegenen geeigneten Spital 
und prescht mit dem Patient zur nicht vorinformierten Aufnahme.
...
Ärzte oder Sanitäter haben eine Behandlungspflicht
gegenüber dem Patienten, sondern auch jeder
Durchschnittsbürger. Ebenso sind Krankenanstalten
verpflichtet, akut behandlungspflichtige Patienten
aufzunehmen und ihnen zumindest eine ärztliche Grundversorgung zukommen
zu lassen.
}
}{
...
\Layout{2}{Rechtslage}{\Speech{\color{DefaultA}
