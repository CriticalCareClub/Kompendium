...
\Fazit{Der Sturzhelm ist immer abzunehmen!}
...
zu bewegen\SpeechMargin{"`Bitte bleiben Sie
...
auch mit nur einem Helfer (\II{Einhelfermethode}). Das
Wichtigste ist, dass der Kopf immer stabilisiert und die
\EE{Halswirbelsäule nicht gestaucht} wird!
...
\begin{itemize}
  ...
  \item Ziel: Kopf stabilisieren und HWS nicht stauchen!
\end{itemize}
}
{}
{}
...
\Speech{"`Bitte bleiben Sie ruhig liegen und bewegen Sie
sich nicht! Mein Name ist {\ldots} Wir
...
\Speech{"`Bitte bleiben Sie ruhig liegen und bewegen Sie
sich nicht! Mein Name ist {\ldots} Ich
...
\Speech{"`Bitte bleiben Sie noch ruhig liegen, ich werde
Ihnen jetzt eine Halskrause anlegen, um Ihren Hals zu
stabilisieren."'} 
\\\addlinespace\bottomrule
\end{tabularx}
