...
Auswurfleistung des rechten Herzens. Demensprechend kommt es
zu einem Rückstau des Blutes in den Körperkreislauf und
...
Herzmuskels} mit Blut und Sauerstoff. Die Ursache sind in
erster Linie verengte oder verstopfte Herzkranzgefäße. Das
akute Koronarsyndrom ist häufig das Ergebnis einer
...
Herzens, die Folge sind Schmerzen, Atemnot und ein
Leistungsverlust!
...
stehen."'} \EE{Todesangst und Vernichtungsgefühl} ist
häufig.
...
Station gebracht\cite{Kalla2006}. Der Notarzt muss
...
zeichen für die bludruckbedingte Störung von Organen
...
\protect\cite{WHOISH2003,JNC7Report,BLIM3,IntroClinEmergMed4,Vlcek2008}.\label{tab:hxpertension-krise-notfall}}
{}
...
Algorithmus Nitrolingual-Spray verabreichen. Ist die Gabe
...
\T{Embolus}\index{Embolus} genannt. Mit dem Blutstrohm
gelangt der Embolus über die Hohlvenen in das rechte Herz.
Bis hierhin gibt es noch keine Probleme, da die Blutgefäße
an die Dicke zunehmen. Vom rechten Herzen gelangt der
Embolus jedoch in den Lungenkreislauf (Lungenarterien). Hier
verzweigen sich die Geäße jedoch wieder und der Durchmesser
...
\SourcePicture{Gabriel}]{\includegraphics[width=0.35\linewidth]{./images/economyclass.jpg}}
\hfill
...
\SourcePicture{Gabriel}}]{\includegraphics[width=0.35\linewidth]{./images/lovenox1.jpg}}
\hfill
\subfloat[Eine Venenthrombose kann eine Embolie auslösen. 
\SourcePicture{Hirtler}]{\includegraphics[angle=90,width=0.35\linewidth]{./images/hirtler-aass/Thrombus-Embolie.pdf}}
\end{WidePar}
\end{figure}
...
er nur durch Nicken oder Gesten kommunizieren. In besonders
...
\subparagraph{Milde Verlegung} Bei der milden Verlegung kann
...
bildet mit der einen Hand eine Faust und unschliesst diese
...
\cite{Olschewski2009}\A{\footnote{Vortrag Univ-Prof.Dr. Horst Olschewski, 5. AGN-Kongress 2009; Notfall Rettungsmed (2009) 12:322}}}
...
\begin{itemize}
  ...
  \item \ce{O2} bis eine Sauerstoffsättigung von 95\PC*
  erreicht ist, \EE{nicht mehr!} Wenn keine Pulsoxymetrie
  vorhanden ist 8\LPerMin*. \Commentary[Asthma, Sauerstoffgabe]{\Speech{Asthma:
  \protect\ce{O2} bis eine Sauerstoffsättigung von 95\PC*
  erreicht ist, oder 8\LPerMin* :} Diese Empfehlung ist
  nicht als streng, sondern als Richtwert zu betrachten; die
  einschlägige Literatur ist widersprüchlich. Besonderes
  betont muss die Notwendigkeit zur Überwachung des
  Patienten bezüglich Bewusstsein(sstörungen) und Atmung
  werden!)}
...
\begin{description}
  ...
  Extremitäten. \cite{StriebelAnaesthesie2} %[Bd.2, S.1344]
...
\TODOCRITICAL{GABS}{2011-01-08}{Insult: Hinrdruckzeichen,
Notarzt-Anforderung}{}
...
Problem im Vordergrund steht, kommt es zu}
\E{unterschiedlichen Symptomen}.
...
\begin{itemize}
  ...
  %     verschlechtern.
  \item Transportentscheidung: Situationsgerecht, z.\,B.
  Abt. f. Chirurgie oder Innere Medizin.
...
Baucherkrankung
verstehen \cite{Longmore2007,Renz-Polster2006}. 
...
\Layout{2}{\TxBeschreibung}
{Das \T{Akute Abdomen} ist eine Kombination von bestimmten
Symptomen, die
...
beobachten. Er klagt über Schmerzen im Bauch die können als
diffus (im gesamten Bauch) oder auf ein Bauchsegment
...
\Z{\HeadingSub{Syn. Magengeschwür: Gastritis}}
...
\begin{itemize}
    ...
    \item bei Blutung: Kaffesatz-artiges Erbrechen,  Teerstuhl
\end{itemize}
}{}{}{}



\subsubsection{Bauchspeicheldrüsenentzündung}

\HeadingSub{\Lang{Term.} \T{Pankreatitis}}

\label{topic:pankreatitis}

\TODO{GABS}{2010-08-04}{fehlt: Pankreatitis}{}
...
\Layout{0}{Ursachen}
{%
Hauptursache  dafür ist eine altersbedingte Vergrößerung der
...
Säurebasenhaushalt. Diese Funktionen der Niere sind zum
...
\Z{%
\begin{labeling}{mmm}
  \item[\cite{Renz-Polster2006}] \emph{\bibentry{Renz-Polster2006}} 
  \item[\cite{SiewertChirurgie8}] \emph{\bibentry{SiewertChirurgie8}}
  \item[\cite{ScholzNotfallmedizin2}] \emph{\bibentry{ScholzNotfallmedizin2}} 
  \item[\cite{IntroClinEmergMed4}] \emph{\bibentry{IntroClinEmergMed4}} 
  \item[\cite{Longmore2007}] \emph{\bibentry{Longmore2007}} 
  \item[\cite{Fauci2008}] \emph{\bibentry{Fauci2008}}
\end{labeling}
}
\end{multicols}
\end{WidePar}
