...
\EE{Fortbildung} ist ein wichtiger Teil der Tätigkeit, Sanitäter haben sich
...
welche \EE{eigenverantwortlich} durchgeführt werden. Dazu gehört die
...
Der Tätigkeitsbereich des \EE{Rettungssanitäters} umfasst die selbständige und
...
Der Tätigkeitsbereich des \EE{Notfallsanitäters} umfasst zusätzlich die
...
Angehöriger eines sonstigen Wachkörpers} ausgeübt werden. Die \EE{berufsmäßige}
...
rechtlichen Regelungen sei auf das Kapitel \ref{chp:JUS} verwiesen, an
...
einem Sanitäter erwartet werden, liefert das
...
einhergehend die praktischen Kompetenzen, dieses \EE{zuverlässig und
...
zulasten des Patienten fallen könnten, machen ein \EE{schnelles Einschätzen der
Lage} so wie die Bereitschaft \EE{Verantwortung zu übernehmen} notwendig. Da es
...
höfliche Umgangsformen, \EE{Kommunikationsfähigkeit} sowie \EE{Einfühlungsvermögen} als
Grundvoraussetzung. 
...
Deshalb soll an dieser Stelle die besondere Wichtigkeit einer \EE{einfühlenden
...
Kritikfähigkeit und Selbstdisziplin ("`\EE{Teamfähigkeit}"') ebenso von hoher
Bedeutung sind (Die Praxis zeigt, dass hier häufig viel Spielraum für
Verbesserungen besteht \Code{;-)}).

Weiters sei auf die Wichtigkeit der \EE{\E{körperlichen} Belastungsfähigkeit}
...
Zu guter Letzt und im besonderen sei auf die Bedeutung \EE{psychischer
