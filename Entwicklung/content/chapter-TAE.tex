...
\Text{Allgemeiner Tätigkeitsbereich}
{Der
...
\Text{Tätigkeitsbereich des Rettungssanitäters}
{% 
Der Tätigkeitsbereich des
\II[Rettungssanitäter!Geltungsbereich]{Rettungssanitäters}
umfasst die
...
\II[Notfallsanitäter!Tätigkeitsbereich]{Notfallsanitäters} 
umfasst
...
\begin{PictureSeriesWide}{}{Miteinander}
...
Wenn danach alle Beteiligten so fröhlich sind ist das
ein gutes Zeichen.}
...
Umständen\ZFootnote{%
Die Tätigkeiten des Sanitäters dürfen ferner als 
Soldat im Bundesheer, 
als Organ des öffentlichen Sicherheitsdienstes, 
Zollorgan, 
Strafvollzugsbediensteter oder als
Angehöriger eines sonstigen Wachkörpers 
ausgeübt werden.}%ZFootnote 
ausgeübt werden. Die
...
\Text{{\TxQuerverweise}}{%
\begin{inparaitem}
  \item Gesprächsführung: \CO{[KOM]} (\FullPrettyRef{chp:KOM});
...
Versorgung erkrankter bzw. verunfallter Menschen solides
\EE{medizinisches Wissen} voraussetzt und damit auch einhergehend
...
Weiters sei auf die Wichtigkeit der \EE{körperlichen}
...
\begin{Synopsis}
  \SynopsisItem{Der (richtige) Umgang mit Frustration ist wesentlich,
  um im Rettungs- und Krankentransportdienst auf Dauer \enquote*{zu
  überleben}.}
\end{Synopsis}


\begin{PictureSeriesWide}{}{Hilfeleistungen und Retten}
\PictureSeriesRowWide{3}
{./images/motal-aass/00800/traumacheck1.jpg}
{Hilfeleistung}
{./images/bergung_bagger_00800.jpg}
{Rettung unter speziellen Bedingungen}
{./images/bergung_kran_00800.jpg}
{Rettung unter speziellen Bedingungen}
{}
{}
\end{PictureSeriesWide}

\begin{PictureSeriesWide}{}{Arbeiten im Gefahrenbereich}
\PictureSeriesRowWide{3}
{./images/khd/gef-wind-rauch2}
{Autobrand mit giftigen Dämpfen}
{./images/gabriel-sebastian-aass/UE2011FORTUNA-00518-0154pt-0300dpi}
{Gefahrenstoffunfall}
{./images/gabriel-sebastian-aass/UEKAISERMUEHLENTUNNEL2011-000193-0154pt-0300dpi}
{Ungünstige Sichtverhältnisse, hier bei
einer Übung im Wiener Kaisermühlentunnel}
{}
{}
\end{PictureSeriesWide}


\begin{PictureSeriesWide}{}{Diagnostik und Therapie}
\PictureSeriesRowWide{3}
{./images/motal-aass/00800/neuro6}
{Blutzuckermessung}
{./images/gabriel-sebastian-aass/UEKAISERMUEHLENTUNNEL2011-000246-0154pt-0300dpi}
...
% \begin{PictureSeriesWide}{}{Ambulanzdienste}
% \PictureSeriesRowWide{3}
% {./images/TAE/erste-hilfe-dif-schild-stange-2.jpg}
% {Hitze und Millionen potentielle Patienten: Das Wiener Donauinselfest}
% {}
% {}
% {}
% {}
...
\begin{PictureSeriesWide}{}{Zusammenarbeit}
\PictureSeriesRowWide{3}
{./images/gabriel-sebastian-aass/UEKAISERMUEHLENTUNNEL2011-000253-0154pt-0300dpi}
{Zusammenarbeit zwischen den Organisationen}
{./images/TAE/tae-okt26-bundesheer1.jpg}
{Integraler Bestandteil der zivilen
und militärischen Landesverteidigung: Der Bundesheersanitäter}
{./images/gabriel-sebastian-aass/IMG_1853_1.jpg}
{Die Zusammenarbeit mit der Exekutive -- auch an
...
Die Ausbildungsordnungen, sowohl für den Arzt für Allgemeinmedizin, 
als auch für Fachärzte, befinden sich derzeit in Überarbeitung und 
werden sich in naher Zukunft deutlich ändern.
}
{}
{}
{}
...
\E{eigenverantwortlichen} 
Tätigkeitsbereich, welcher insbesonders die Pflege von
von Patienten vorsieht, sowie einen \E{mitverantwortlichen}
...
Sonderausbildungen (Kinder- und Jugendlichenpflege, psychiatrische 
Pflege, Intensivpflege, Anästhesiepflege, Pflege im 
Operationsbereich, \ldots).
Der \E{interdisziplinäre} Tätigkeitsbereich umfaßt jene Bereiche, die 
sowohl die Gesundheits- und Krankenpflege als auch andere Berufe des 
Gesundheitswesens betreffen.
Dabei haben Angehörige des gehobenen Dienstes für Gesundheits- und 
Krankenpflege das Vorschlags- und Mitentscheidungsrecht und tragen 
die Durchführungsverantwortung für alle von ihnen in diesen Bereichen 
