...
:::{seealso}
- {ref}`Allgemeinnarkose`

Medikamente:
- {ref}`Propofol`
- {ref}`Ketamin-S`
- {ref}`Etomidate`
- {ref}`Thiopental` (Barbiturat)
- {ref}`Midazolam`
- {ref}`Lorazepam`
- {ref}`GHB`
:::
...
Gleichzeitig setzt die *Elimination* ein:
Die maximale Konzentration am Wirkort ist erreicht, wenn sich die Kurven der Blut- und Wirkortkonzentration treffen.
