...
\begin{itemize}
  ...
  \item 1. Schritt: \EE{Einschätzung des Patienten}
  \item 2. Schritt: \EE{Erstmaßnahmen}
  \item 3. Schritt: \EE{Durchatmen, nachdenken, planen}
\end{itemize}
}{
\begin{itemize}
...
\subsubsection{Einschätzungsblock}
...
\Layout{60}{SmS -- Szeneüberblick mit (Selbst-)Schutz}{%
...
\Z{(\Lang{engl.} Exposure.)} Ist die vitale Bedrohung noch
nicht klar einzuschätzen müssen hier die notwendigen
...
\begin{itemize}
  ...
  Krämpfe, sichtbare Verletzungen
  \item Trauma
\end{itemize}
\end{minipage}
&
...
\begin{itemize}
  ...
  \item Pupillen
  \item Grobe Motorik (OE)
  \item[{\tiny\color{Indigo}\ovalbox{Trauma \&
  Bewusstseinsstörung}}] Kontrolle von \E{Mund}, \E{Nase}
  und \E{Ohren} auf Blutungen (Lampe)
...
\begin{minipage}[t]{\linewidth}
\begin{itemize}
  \item {\ldots} situationsgerecht, wenn Einschätzung der vitalen
...
Der Einschätzungsblock muss in regelmäßigen Abständen
...
% begründen können! } 
\noindent Während des weiteren Verlaufs
(Anamnesegespräch, etc.) kann man auf weitere Befunde stoßen
welche auf eine vitale Bedrohung hinweisen (zB. massiv
erhöhter Blutdruck bei vorgeschädigtem Herzen, plötzliche
oder schleichende Zustandsverschlechterung, etc.).

Die Ersteinschätzung muss ständig überprüft werden. Neue
Befunde und der Zustand des Patienten können die Situation
ändern.
...
\subsubsection{Prioritäten setzen, weiterführende Diagnostik und Maßnahmen}

\emph{Was ist wichtig, was kann warten?} -- Weitere
Untersuchungen, S-KAMEL und Maßnahmen.

Nach den Erstmaßnahmen muss man nun planen, welche Maßnahmen,
Untersuchungen und Fragen am dringlichsten sind und zuerst
durchgeführt werden müssen, und was eher in der Abfolge nach
hinten ver\-schoben wird.

Die Kurzübersicht in 
\prettyref{tab:checkliste-patientenmanagement} gibt einen
Überblick über die weiterführenden Maßnahmen und das Anamnese\-ge\-spräch, die
...
\begin{minipage}{\linewidth}
\FontTableBase
\Captionof{table}{Kurzübersicht: Weiterführende Untersuchungen und Anamnese.
...
\subsubsection{Übergabegespräch an weiterbehandelndes Fachpersonal}  
