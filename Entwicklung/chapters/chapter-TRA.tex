...
{Fehlstellung -- In natura und in Röntgendarstellung.}
{Hauer}
...
\begin{itemize}
  ...
  Die
  Symptome können eventuell erst Stunden nach der Verletzung einsetzen. Dazwischen ist der Patient unauffällig.
...
\item \EE{Traumacheck} Ein Traumacheck ist
...
\Z{Vgl. \CO[ANA], \FullPrettyRef{topic:atemmechanik}, und
...
\Z{Ein Arzt kann mittels Drainage bzw. Punktion einen
Pneumothorax entlasten.}
}
