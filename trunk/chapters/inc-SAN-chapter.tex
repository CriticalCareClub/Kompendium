...
Suche nach Verletzungen oder Verletzungsanzeichen am liegenden Patienten
...
Stelle als letztes untersuchen}: von Kopf bis Fuß (Sch\"adeldach, Hinterkopf,
Stirn, Wangenknochen, Nasenbein, Kiefer, Hals, Schultern, Arme, H\"ande, Brustkorb vorne und seitlich (Prellmarken?
Atemmechanik?, gegen leichten Druck einatmen lassen), Bauch in 4 Quadranten
(Prellmarken? Abwehrspannung/harte Bauchdecke?), Schambein, Becken (stabil?), Beine
(sichtbare Verletzungen?), Füße: Schuhe und Socken ausziehen)

\item {\quotedblbase}DMS{\textquotedblleft}: Finger und Zehen: Kontrolle
von \gE{Motorik} (bewegen lassen), \gE{Sensibilität} ({\quotedblbase}Spüren
...
Durchblutungsstörung hin. (einseitig oder beidseitig? lokal oder uU systemisch?)

\item Kontrolle von Mund, Nase und Ohren auf Blutungen (mit einer
Lampe). Tupfertest: etwas Blut aus Ohren oder Nase mit einem Tupfer auffangen.
