...
\subsection{Was muss ich erfragen? -- S-KAMEL}
...
\subsection{Basisuntersuchungen}
...
\subsection{Apparative Untersuchungen}
...
\gMarriedNG{Interpretation und Normalwert}
{
Der Blutzuckerspiegel wird in Miligramm pro Deziliter
(\nicefrac{mg}{dl}\gZ{, enspricht mg\,\%}) gemessen. 
...
Der normale \gEs{Nüchtern-Blutzuckerspiegel} bewegt sich
zwischen \gEs{80\,--\,120\,\nicefrac{mg}{dl}}.

}{
\begin{itemize}
    \item Abhängig von letzter Mahlzeit!
    \item 80\,--\,120\,\nicefrac{mg}{dl} (nüchtern)
\end{itemize}
}
