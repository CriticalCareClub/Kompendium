...
% (Patient1 → Personal
%         → Patient 2 → \EE{\enquote{Unterbrechung der
%         Infektionskette}})
% \end{minipage}
% 
% 
...
Kreuzinfektionen} (\EE{\enquote{Unterbrechung der
        Infektionskette}}). Die normale Händewaschung
        entfernt nur groben Schmutz und sonstige mechanische Verunreinigungen. Die
Desinfektionslösung reduziert jedoch gezielt aktiv viele
Keime.
        
\Fazit{\I{Kreuzinfektion}: Patient~1 → Personal → Patient~2}

\Fazit{Die Hände des Personals sind
        die häufigsten Keimüberträger.} 

Die hygienische Händedesinfektion ist \EE{vor} bzw. \EE{nach jedem Patientenkontakt} durchzuführen!
...
sehen dass in der Umgebung der Plättchen keine Bakterien
wachsen.}
...
% \begin{PictureSeriesWide}{}{Hygienische Händedesinfektion.
% \SourcePicture{Blacky}}
% \PictureSeriesRowWide{4}
% {./images/Skriptumaegf-img3.png}
% {Eine Portion alkoholisches
%     Händedesinfektionsmittel (ca. 3\Ml* = 1~Hohlhand) aus
%     dem Spen\-der entnehmen: Mittels Ellenbogen, vollkommene Benetzung beider Hände und
%     Handgelenke.}
% {./images/Skriptumaegf-img4.png}
% {Handinnenflächen gegeneinander reiben, geschlossene Finger.}
% {./images/Skriptumaegf-img5.png}
% {Handgelenke einreiben}
% {./images/Skriptumaegf-img6.png}
% {Mit ineinander verschränkten Fingern Handinnenflächen
%     gegeneinander reiben.}
% 
% \PictureSeriesRowWide{4}
% {./images/Skriptumaegf-img7.png}
% {Mit rechter Handinnenfläche linken Handrücken reiben und
%     umgekehrt, dabei Finger ineinander verschränken.}
% {./images/Skriptumaegf-img8.png}
% {Hände ineinander verhaken und Finger gegeneinander bewegen}
% {./images/Skriptumaegf-img9.png}
% {Daumen mit gegenüberliegender Hand vollständig umschließen
%     und rotierend reiben. Daumenkuppen nicht vergessen!}
% {./images/Skriptumaegf-img10.png}
% {Fingerkuppen im Handteller kreisförmig einreiben bis Alkohol
%     verdunstet ist}
% \end{PictureSeriesWide}
...
der Helfer muss selbsttätig mit dem Mund (\enquote{Oro})
saugen. Dadurch gelangt das Sekret aus dem Absaugkatheter in den Behälter. Der Katheter und der andere
Schlauch müssen dabei \E{von oben} den Behälter verlassen,
...
Buchstabens \enquote{\EE{\sffamily N}} (\enquote{neue Kennzeichnung})
...
\begin{PictureSeriesWide}{}{Der Guedel-Tubus
...
\PictureSeriesRowWide{3}
{./images/hirtler-aass/GuedelPosition}
{Position des Guedel-Tubus im Querschnitt}
{./images/hirtler-aass/LageWendel}
{Im Vergleich: Lage des über die Nase eingeführten
Wendel-Tubus \ldots} 
{./images/hirtler-aass/LageTubus}
{\ldots\ und ein endotrachealer Tubus.}
{empty}
{}
\end{PictureSeriesWide}
...
{Beatmungsbeutel \enquote{Ambu{\texttrademark} Mark IV} mit
...
dabei die Form des Buchstaben \enquote{C}, die restlichen drei
...
Mit dem Beatmungsgerät \emph{\enquote{Medumat}} der Fa. Weinmann
...
\begin{enumerate}
    ...
    Regionen sowie dem Kopf (\enquote{Ohren}
