...
Riva-Rocci als \emph{\enquote{RR-Messung}}, bzw. der ermittelte Wert als \emph{\enquote{RR}} bezeichnet.
...
Der \enquote{Nicht-invasive Blutdruck} wird auf manchen Überwachungsmonitoren mit
...
Lichtquelle und einem Fotosensor. Auf diese Weise wird
...
15{\LPerMin*} ein Hinweis auf eine schwere Störung der
Atmung darstellt. 
...
\begin{itemize}
  ...
  Kohlenmonoxid-beladenes Blut ist ebenso hellrot
  wie Sauerstoff-beladenes, daher wird der Patient nicht
...
stark an und fällt dann wieder auf einen \enquote{nüchternen
Normalwert} ab. Der normale
\EE{Nüchtern-Blutzuckerspiegel} bewegt sich zwischen
\EE{\VonBis{80}{110}\MgDl*}. Im Rettungsdienst
...
\begin{itemize}
    ...
    \item Normalwert: \VonBis{80}{110}\MgDl*
    (nüchtern)
...
{./images/gabriel-sebastian-aass/bz-wert_1214-00800.jpg}
{\enquote{90\MgDl*.} \SourcePicture{GABS}}
{}
{}
...
>>schönes} EKG haben<< (allerdings nicht
lange)!}
...
\begin{description}
    ...
    (\enquote{\T{12-Kanal-EKG}}) -- Damit können Schäden der
...
\Definition{Einfache, überblickshafte (\enquote{grobe})
...
\begin{enumerate}
  ...
  Einteilung entsprcht weitgehend dem \T{WASB-Schema}
  (\EE{W}ach, Reaktion auf \EE{A}nsprechen, )}:
  	\begin{enumerate}
      ...
      deteilliertere Beschreibung des Bewusstseins. Vgl.
...
\end{enumerate}
  ...
  \EE{passive Bewegung}, der Patient darf dabei nicht mithelfen.
  ...
  \item \EE{Blutzuckermessung}: Eine Blutzuckermessung
  gehört zu einem vollständigen
  Neurocheck.
\end{enumerate}
}{
\begin{itemize}
...
% % MOTM: POI 35: \enquote{ja klingt verünftig.}
% \end{itemize}
% }
% {
% \begin{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    (bewegen lassen), \E{Sensibilität} (\Speech{\enquote{Spüren Sie das?}})
    und \E{Durchblutung} 
    \item \T{Nagelbettprobe} (\EE{Rekapillarisierungszeit}): leichter Druck auf
    Nagelende bis Nagelbett weiß ist, loslassen. Zeit bis Nagelbett wieder
