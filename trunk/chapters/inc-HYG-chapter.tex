...
\Layout{22}{Geschichte}
{
% \begin{quote}
\Z{Zu Beginn des 20. Jahrhunderts waren
...
nicht wachsen wollten: das \E{Penicillin} war geboren. 
...
Heute kann man zwar solche Infektionen mit Antibiotika behandeln, jedoch können
Bakterien \Es{Resistenzen} gegen Antibiotika entwickeln. \Margin{Antibiotika
werden wirkungslos}Die sonst wirksamen Medikamente wirken dann nicht mehr oder
nur noch sehr abgeschwächt. Als behandelnder Arzt steht man dann hilflos vor dem
Patienten.

\Fazit{Resistenzen machen Antibiotika wirkungslos.}

\Fazit{Bald sind wir wieder dort, wo wir 1927, vor der
...
\ldots In Gesundheitseinrichtungen finden sich daher \E{gehäuft} resistente
Keime.
...
\index{Spitalskeime}\T{Spitalskeime}: Keime mit "`angezüchteten"' Resistenzen
...
Kanamycin)}}\footnote{Quelle: AGES}.

\TODO{GABS}{yyyy-mm-dd}{LIT, HYG: MDR/XDR-TB Quelle bei AGES}{}

\Es{Das Problem der multiresistenten Keime wird immer größer.}
...
\Layout{28}{Staphylococcus aureus}
{
