...
Der Begriff \T{Ateminsuffizienz} beschreibt allgemein eine \Es{nicht ausreichende
...
bekommen und leidet an \Es{Atemnot} (\T{Dyspnoe}).

Der \Es{Atemstillstand} (\T{Apnoe}) ist die extremste Form der
...
aufgrund der Osmose (s.u.) großen Einfluss auf die \Es{Flüssigkeitsverteilung}
...
\begin{itemize}
  ...
  abgebaut}. Es entsteht eine \Es{atmungsbedingte Übersäuerung}.
  ...
  \E{fehlt}, kommt es zu einer \Es{atmungsbedingten Alkalose}.
  ...
  abgeatmet.} Es kommt zu einer \Es{tiefen, schnellen Atmung}.
\end{itemize}
}{%
...
\begin{itemize}
  ...
  \item Die \Es{Elektrolyte} haben einen großen Einfluss auf die
