...
.. sidebar:: Fehlerquellen Beatmung
...
.. sidebar:: Defibrillatoren: arbeiten
...
-   **Halbautomatische** Defibrillatoren 
    (:abbr:`SAED (Semi-Automated External Defibrillator)`, 
    oft auch nur *AED* :index:`\ <SAED>`:index:`\ <AED>`): 
    Das Gerät beurteilt den elektrischen Herzrhythmus ob ein schockbarer Rhythmus vorliegt. 
    Die Schockauslösung geschieht durch
    den Anwender. 
    Diese Gerätekategorie kann von nicht-ärztlichem
    Personal und sogar auch von nicht ausgebildeten Laienhelfern
    verwendet werden. 
    Die meisten Geräte leiten den Anwender durch gesprochene 
    und am Gerät angezeigte Anweisungen durch die Reanimation.

-   **Manuelle** Defibrillatoren: 
    Das Gerät zeigt den elektrischen
    Herzrhythmus an, die Beurteilung 
    und Entscheidung zur Schockabgabe geschieht durch den Anwender. 
    Manuelle Defibrillatoren sollen nur durch
    ärztliches Personal angewandt werden. 
    Viele neuere Geräte verfügen
    über einen “Halbautomaten-Modus”, 
    in welchem das Gerät als AED
    verwendet werden kann.

-   **Automatische implantierbare** Defibrillatoren 
    (:abbr:`ICD (Implantable Carciac Defibrillator)`) 
    können Patienten –
    ähnlich einem Herzschrittmacher – implantiert werden
    und geben bei Bedarf, ohne Zutun, einen Schock ab.
...
-  *Nicht-schockbare Rhythmen*
    ...
    -   **Pulslose elektrische Aktivität** :index:`\ <Pulslose
        ...
        (*PEA*): 
        Darunter fallen sämltiche andere elektrische Herzrhythmen, 
...
#.  *Beurteilung* ob die *Atmung normal* ist: 
    ...
    Patient nach Luft schnappt) 
    *ist keine normale Atmung*, 
    sondern ist mit einem Atemstillstand gleichzusetzen.
...
#.  **Herzdruckmassage**: 
    ...
    im Speziellen mit der Herzdruckmassage.

    Der seitlich am Patient knieende ``Helfer 2`` beginnt mit der
    Herzdruckmassage. 

    Sofern es nicht zu
    einer Zeitverzögerung kommt, 
    kann ein zusätzlicher Helfer eine Lagemeldung an die Leitstelle abgeben 
    (*"Reanimation im Gang"*).
    
#.  **Defibrillator bereit machen**: 
    Währenddessen schaltet der am Kopf knieende ``Helfer 1`` 
    den Defibrillator ein und bringt die Klebeelektroden am Patienten an.

    .. todo:: Beatmung erst wenn Defi einsatzbereit ist?
