...
\begin{itemize}
  ...
  \item Engmaschiges \EE{Monitoring} (Patient
...
\begin{description}
    \item[AF] {\dotfill} \EE{12-16\,\nicefrac{x}{min}}
    \item[AZV] {\dotfill} \EE{500\,ml}
    \item[AMV] {\dotfill} \EE{6-8\,l}
\end{description}
}{}{}{}
...
\begin{itemize}
  ...
  \item \EE{Irreversible Hirnschäden nach 3-5\,min}, bei
...
Der Anteil beträgt beim Erwachsenen \VonBis{7}{8}\,\%, beim
Neugeborenes \VonBis{8}{9}\,\% des Körpergewichts.
\E{Verluste bis zu ca. 20\,\%} sind prinzipiell ohne Funktionsbeeinträchtigung tolerierbar, allerdings
...
\begin{itemize}
  ...
  \item Erwachsener \VonBis{7}{8}\,\%, Neugeborenes\,/\,Säugling \VonBis{8}{9}\,\% des Körpergewichts
