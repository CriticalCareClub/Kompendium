...
Vor dem Setzen irgend einer Maßnahme sollte der Ersthelfer einmal tief
...
Anschließend gilt es \gE{Ruhe zu bewahren} und \gE{Ruhe zu
vermitteln}. Dabei soll man sich ruhig und gezielt auf die bevorstehenden
Maßnahmen einstellen und die bevorstehenden Maßnahmen nach \gEs{Dringlichkeit}
sortieren. Erst wenn all diese Schritte gesetzt wurden soll mit einer Behandlung
begonnen werden! }{
\begin{itemize}
...
Daher muss der Ersthelfer u.U. \gEs{Absperrmaßnahmen durchführen} und den
...
Die Methoden der Absicherung sind vielfältig, da sie sich den jeweiligen
Gegebenheiten anpassen müssen. Als Grundsatz jeder Absicherung gilt:
...
telefonieren, klingeln und rauchen. Hier darf bzw. soll das Fenster geöffnet werden. Wenn
	...
	Stecker rauszuziehen oder die Sicherung herauszudrehen. Zuguter letzt bleibt
	noch die Möglichkeit, den Verunglückten von der Stromquelle loszureisen. Bei
	einem Hochspannungsunfall funktioniert dies nicht so leicht. Hier muss über die
...
der Fahrbahn befindet, noch immer Gefahren, da Absicherungsmittel leicht
vom nachkommenden Verkehr übersehen werden kann. Daher
...
den Helm schon selbst abgenommen hat. Ansonsten gilt: befindet sich der Patient
in einer Gefahrenzone, so ist er aus dieser zu retten. Das Visier ist zu öffnen,
um den Verletzten anzusprechen. 

\gFazit{Der Helm ist immer abzunehmen, ausser der Patient
verweigert dies!}

Am idealsten wird der Sturzhelm von zwei Helfern abgenommen
...
nämlich das \gEs{Bewusstsein} und die \gEs{Atmung}. 

Eine Kontrolle des
Kreislaufes, durch Tasten des Pulses an der Halsschlagader (oder irgendeiner anderen
Stelle), wird normalerweise von einem Ersthelfer nicht
...
verknüpft, dass ohne dem Einen das Andere nicht funktionieren
kann. 
}{
\begin{itemize}
...
10~Sek. lang überprüft, ob eine normale Atmung vorhanden ist oder nicht. Es
