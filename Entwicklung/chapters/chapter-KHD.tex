...
Einsatzes beträgt in etwa Minuten bis zu einer Stunde.
Die \E{Infrastruktur}\footnote{\emph{Infrastruktur:} Wichtige
...
\E{intakt}. Die Anzahl der Patienten übersteigt nicht  14
Personen (Richtwert).

Die Erstversorgung erfolgt innerhalb von Minuten durch
Rettungsdienst nach den Regeln der \E{Individualmedizin}. Der
Abtransport wird durch Routinebetrieb mit örtlich vorhandenen
Mitteln durchgeführt. Die Definitive Versorgung erfolgt in
umliegenden Krankenhäusern, ebenfalls nach den Regeln der
\E{Individualmedizin}. Das aufgewendete Material und das
Personal stammt aus dem Normalbetrieb des Rettungs- und
Krankentransportes.
}
...
\Definition{{\quotedblbase}Ein Großunfall liegt vor, wenn
...
Katastrophensituation vorliegt{\textquotedblleft}}

\Layout{0}{\TxBeschreibung}{
Das Ereignis ist \E{lokal begrenzt} und dauert mehrere
Stunden, die \E{Infrastruktur} ist jedoch \E{intakt}. Die
Erstversorgung von 15 oder mehr Patienten (Richtwert) erfolgt
innerhalb von Minuten bis Stunden durch den Rettungsdienst
nach den Regeln der \E{Katastrophenmedizin}. Der Abtransport
erfolgt relativ unbehindert nach der Erstversorgung, es sind
genügend Transportmittel vorhanden.

Die Definitive Versorgung erfolgt in umliegende Krankenhäuser
nach den Regeln der \E{Individualmedizin}. Das Personal setzt
sich aus alle verfügbaren Helfern zusammen, welche sowohl aus
...
erfolgt innerhalb von Stunden bis Tagen durch den
...
den Regeln der \E{Katastrophenmedizin}. Das Material und und
...
viele Leben wie möglich zu retten, \EE{mit bewusstem Verzicht auf zeit-
...
Patienten gemäß der Dringlichkeit und Durchführbarkeit ihrer
Behandlung oder ihres Transportes. Diese Einteilung nennt man Triage.
}{%
\begin{itemize}
...
\Fazit{Grundsatz: {\quotedblbase}Life before Limbs{\textquotedblleft}: Leben vor
...
\Layout{0}{\TxBeschreibung}{
Ziel ist es, das \EE{Bestmögliche} für die größte Anzahl zur rechten Zeit am
rechten Ort zu erreichen. Das ist nur erreichbar wenn  der \E{Bestgeeignete} auf
jeder Stufe führt, klare und eindeutige \EE{Führungsstrukturen} vorhanden sind,
alle Einsatzkräfte ihre \E{Aufgabe kennen},  die \EE{Führungspyramide} von allen
...
\EE{Ausschließlich eine Behörde erklärt ein außergewöhnliches
...
Im Schadensraum gilt: {\quotedblbase}\EE{Ein einziger
...
Leistungsfähigkeit eingesetzt \E{({\quotedblbase}Ökonomie der
Kräfte{\textquotedblleft})}. Er muss rasch auf Änderungen der
...
Der Wagenhalteplatz muss \EE{frühzeitig} bestimmt werden, da weitere Kräfte
rasch nachfolgen werden. Er sollte in ausreichender \EE{Entfernung} festgelegt
...
ermöglicht eine \EE{eindeutige Kennzeichnung} von Patienten und Zuordnung
...
\EE{\E{Spätestens} an der Triagestelle} bekommt jeder Betroffene {\quotedblbase}seine{\textquotedblleft} \Abk{PLT}. Auch Unverletzte
...
Patientenleittasche (\Abk{PLT}). Patienten, welche \EE{bevorrangt gerettet}
...
Kontakt treten, warnen. Die Aufkleber sind auf \EE{beiden
Seiten} der \Abk{PLT} anzubringen!
}{}{}{}{}

\Layout{2}{PLT-Nummer}{%
Die \Abk{PLT} und damit der Patient ist durch eine \EE{eindeutige, einmalige
Nummer} \EE{identifiziert}. Mittels \EE{Selbstklebeetiketten} können die
...
\Fazit{Die Nummerierung der \Abk{PLT} ermöglicht die eindeutige Zuordnung und Erfassung von
