...
zuerst den \E{eigenen} Puls fühlen.

\begin{flushright}
\emph{Dickie, in: Samuel Shem: \emph{House of God.} \cite{HouseOfGodDe}}
\end{flushright}
\end{savequote}
...
kann i.\,d.\,R. nur mit \emph{"`ja"'}, \emph{"`nein"'} oder \emph{"`weiß nicht"'} antworten.
...
Neben der körperlichen Untersuchung gibt das Gespräch mit dem Patienten
...
\noindent Dieses Abfrageschema kann Ihnen im hektischen Notfall
