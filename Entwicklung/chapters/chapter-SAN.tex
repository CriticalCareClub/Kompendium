...
Kreuzinfektionen} (\EE{"`Unterbrechung der
...
besteht aus eine Absaugkatheter, welcher mit einem Behälter
verbunden ist. An dem Behälter geht ein weiterer Schlauch
ab, welcher vom Helfer in den Mund genommen wird. Der
Oro-Sauger wird \E{nicht} an ein Absauggerät angeschlossen,
der Helfer muss selbsttätig saugen. Dadurch gelangt das Sekret
aus dem Absaugkatheter in den Behälter. Der Katheter und der andere
...
{\ldots\ zuerst wird der Guedel-Tubus verkehrt herum
eingeführt \ldots}
{./images/hirtler-aass/GuedelTubus3}
{\ldots\ und anschließend mitteld Drehbewegung endgültig
positioniert.}
{empty}
{}
