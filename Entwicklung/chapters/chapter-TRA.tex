...
Abhängig von den Umständen muss auch an ein \E{Inhalationstrauma} gedacht werden
(\prettyref{topic:inhalationstrauma}). 
}{}{}{}{}
...
Verdunstung besteht ab \Es{10\,\%} (oder \Es{5\,\%} bei Kindern) verbrannter
($\geq$\,2\,{\textdegree}) Körperoberfläche besteht \Ca{Schockgefahr}
...
\Es{Unterkühlung} geht mit einer deutlich erhöhten Sterblichkeit
einher.\ZFootnote{\cite{Loennecker2001} spricht von einer um 43\,\% 
erhöhten Chance zu versterben wenn die Körpertemperatur um 1 Grad abnimmt.}
...
Ab einer betroffenen Körperoberfläche von >\,20\,\% (Erwachsene; Kinder
>\,10\,\%, Säuglinge >\,5\,\%) gilt eine Verbrennung als \E{großflächig}.
...
\begin{itemize}
  ...
  \item Kleidung entfernen (sofern nicht  eingeschmolzen!)
...
\MassnahmenNG{Spezielle Maßnahmen}{Verbrennung, großflächig, $\geq$\,2\,{\textdegree}}{}
{%
\begin{itemize}
  \item \TxMassVitBes
  \begin{itemize}
...
% der betroffenen Regionen.
  \item Keimfreier, nicht verklebender Verband, locker anlegen\ZFootnote{Der Nutzen von kühlenden Spezialverbänden, z.\,B.
  Waterjel{\texttrademark} ist aufgrund der Unterkühlungs-Gefahr und einer
