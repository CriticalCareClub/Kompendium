\documentclass[ngerman,paper=a4,asymmetric,fontsize=9pt,headings=big,draft=no,parskip=half,noonelinecaption]{scrbook}
...
\newrefformat{tab}{{\sffamily\mdseries\color{darkBlue}{\ovalbox{T}}}\,\ref{#1}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Floats
\usepackage{float,wrapfig,picins}
...
\floatname{massnahmen}{\ovalbox{\textrecipe}}
...
pdfsubject=v-0.7.x, % Sets the document information Subject field
pdfcreator=LaTeX, % Sets the document information Creator field
