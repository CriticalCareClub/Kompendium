...
Anweisungen wie \emph{"`Können Sie mich hören? Machen Sie bitte die Augen
auf!"'}. Gleichzeit dazu kann man den Patienten an seinen Schultern \gEs{berühren} und
leicht rütteln.
...
\gCave{Patienten die in Folge eines Unfalls verunglückt sind dürfen
...
Sofortmaßnahme} begonnen\footnote{Beim Erwachsenen.}. }{
\begin{itemize}
...
\begin{description}
    \item[Position und Druckpunkt] Der Patient sollte auf einem harten
    Untergrund liegen. Ggfs. soll der Pateint aus einem Bett o.ä. auf den Boden verbracht werden. Der Helfer kniet seitlich
    daneben und sucht sich den richtigen \gEs{Druckpunkt} für die Herzdruckmassage. Dieser liegt in der \gEs{Mitte des Brustkorbes}.
    \item[Arm- und Körperhaltung] Die richtige
    ...
    \item[Druckerzeugung] Die
    Druckerzeugung hat \gEs{kräftig, aber nicht stoßartig} zu erfolgen. Die
    \gEs{Eindrücktiefe} sollte \gEs{\nicefrac{1}{3} des Brustkorbes} bertragen.
    \item[Druckentlastung] Der Brustkorb muss sich wieder ganz
    ausdehnen können. Es darf daher \gEs{kein Restdruck} mehr bestehen. Die Druck-
    und Entlastungsphasen dauern beide gleich lange.
    \item[Arbeitsgeschwindigkeit] Die Arbeitsgeschwindigkeit der
...
Atemzug beträgt jedoch nur in etwa 500\,ml (vgl. \gSee{topic:atemvolumina}).

Die ausreichende \ce{O2}-Konzentration in der Umgebungs-/Einatmingsluft ist die
Voraussetzung für eine funktionierende Atmung.Ist sie nicht gegeben ist auch die
beste Atemarbeit nutzlos. Der normale \ce{O2}-Gehalt der Umgebungsluft beträgt
...
\begin{description}
    \item[Der Patient zeigt \gEs{Lebenszeichen}.] Dies kann jetzt in
...
\item[Eintreffen von \gEs{kompetenter Hilfe.}] Der Ersthelfer darf aber bei
...
Bei \gEs{unsicheren Lebenszeichen} ist eine
...
Vergiftungsinformationszentrale} und \gEs{141 Ärztefunkdienst}. 
}{
\begin{itemize}
    \item 122 -- Feuerwehr
    \item 133 -- Polizei
...
{
Die
\gEs{Vergiftungsinformationszentrale} dient jedoch nur dazu, lediglich Auskunft
...
\begin{description}
    \item[Vergiftungsinformationszentrale] 01\,/\,406\,43\,43 -- Expertenrat.
    \item[Ärztefunkdienst] 141 -- Allgemeinmedizinische Versorgung in der Nacht,
