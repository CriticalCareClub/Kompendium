...
\begin{labeling}[:]{xxxxxxxxxxxxxxxxx}
  ...
  (17. Oktober 2013)
  \item[Bis Commit \#] 5cc7f96a32560830993ce3663c8c2759223a1779
...
\section{Allgemeines}
\begin{enumerate}
  \item Dr. Withofner aus den Credits herausgenommen. $\to$ siehe Diskussion
  (S. \pageref{chp:review-diskussion}) und TO DO
...
\section{[GYN]}
Umbenennung der Unterabschnitts \E{Uterusatonie} in \E{Blutungen in der
Nachgeburtsperiode}.
...
\label{chp:review-diskussion}
\section{Inhaltlich}
\begin{enumerate}
  \item COPD: Richtwert für $\text{SpO}_2$?
  \item Pulmonalembolie: Risiko durch OP: Welche OP? Welcher Zeitraum?
  \item PAM: Grafik mit oder ohne Text? (\glqq{}Leitfragen\grqq{} und
  \glqq{}Ergebniskommunikation $\to$ andere Helfer\grqq{})
\end{enumerate}

\section{Formal/Layout}
\begin{enumerate}
  \item Hashtags ja/nein?
\end{enumerate}
...
\begin{enumerate}
  \item Dr. Withofner in Einleitung o.Ä. erwähnen (von ihm sind die
  ursprünglichen PowerPoint-Folien, auf welchen dieses Buch basiert)
  \item Belegexemplar an Dr. Withofner senden
  \item Hashtags in Einleitung erklären
  \item \glqq{}red flags\grqq{} erklären
  \item Asthma: \glqq{}Im Endstadium kann der Patient zu erschöpft für eine
  ausreichende Atemarbeit sein.\grqq{} (kommt mehrmals vor)
  \item COPD: Grafik mit den Stufen: Schriftart anpassen/Bild tauschen oder
  anpassen
  \item Insult: Spezielle Anamnese bzgl. Stroke unit
  \item PAM: Grafik aktualisieren (Farben)
  \item ggf. Punkte aus der Diskussion (S. \pageref{chp:review-diskussion})
  einarbeiten
\end{enumerate}
