...
Zellkern\index{Zellkern}, der die gesamten Erbinformationen enthält und verschiedenen
...
Röhrenknochen zu fett reichem, gelben Knochenmark um. 

Das gelbe Fettmark kann bei schweren Knochenverletzungen von Bedeutung
sein, da verletzungs\-bedingt kleine Fettkröpchen in die Blutbahn
...
\begin{description}
    ...
    besitzen Venenklappen um Rückfluss\footnote{Rückfluss:
...
das im Blutplasma gelöste \gZ{Fibrinogen} zu aktivieren und in einen gelleartigen
...
\subsubsection{Das vegetative (autonome)  Nervensystem}
...
\begin{figure}[H]
    ...
    Einfluss auf viele Organe. Diese Bild
...
wiederum die Lunge angewachsen ist) mit bewegen. Und wenn sich das Lungenfell
mit bewegt wird automatisch auch die Lunge wie eine Ziehharmonika
"`aufgezogen"' und Luft
"`angesaugt"'. 
