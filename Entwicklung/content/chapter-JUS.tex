...
{}
{}
{./images/gabriel-sebastian-aass/recht_vertrag.pdf}
{}
...
\TableWide
{\EE{Notwehr} und
\EE{Notwehrüberschreitung} im Affekt}%1
{}%2
{\label{tab:notwehr-notwehrueberschreitung}}%3
{Koller}%4
{AASS}%5
{%
...
% 	{<Float>}%8
\TableWide
{Rechtfertigender und
entschuldigender \EE{Notstand}}%1
{}%2
{\label{tab:notstand}}%3
{Koller}%4
{AASS}%5
{%
\begin{minipage}{\linewidth}
...
Privater}%1
{}%2
{\label{tab:anhalterecht-privater}}%3
{}%4
{}%5
{%
\begin{minipage}{\linewidth}
...
\begin{Danger}
  \item Die Persönlichkeitsrechte psychisch Kranker, die in
...
Es müssen folgende \EE{Voraussetzungen} vorliegen, damit
...
\paragraph{}
\Text
{Zwei Arten der Patientenverfügung}%1 Überschrift
{%
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item   Wenn es gesetzlich vorgeschrieben ist (z.\,B. im
  ...
  \begin{itemize}
    \item \I{Epidemiegesetz}: Bei bloßem Verdacht oder
    sicherer Diagnose einer im Gesetz genannten Erkrankung.
    \item \I{Tuberkulosegesetz}: Bei bloßem Verdacht auf
   ...
   daher darf kein behördlicher Zwang ausgeübt werden. 
   \item
  ...
  Die Meldung hat an die zuständige
  \EE{Bezirksverwaltungsbehörde} (in Wien an die MA\,15), bei AIDS an das Bundesministerium für
  Gesundheit, zu ergehen.
  }
...
\TableWide
{Kompetenzstufen von Sanitätern nach dem SanG}%1 Titel
{({\S}{\S}\,\VonBis{9}{12})}%2 Beschreibung
{\label{tab:sang-kompetenzstufen}}%3 Label/Hook
{}%4 Quelle
{}%5 Lizenz
{%
...
\begin{itemize}
  ...
  und Betreuung
    ...
    \item diagnostische und therapeutische Verrichtungen
\end{itemize}
\end{minipage}
...
\begin{itemize}
  ...
  \EE{Arzneimittelliste 1}:
    ...
    \item Mitarbeit in der Forschung
\end{itemize}
\end{minipage}
...
\subparagraph{}
\Text
{Verhalten bei Blaulichtfahrt}%1 Überschrift
{%
\begin{itemize}
...
\begin{Synopsis}
  \SynopsisItem{Einsatzfahrt: Nur wer noch größere Sorgfalt und Vorsicht wahrt als bei
...
\Text
{{Exkurs: Anschnallpflicht}}%1 Überschrift
{%
Der Fahrer jedes Fahrzeuges ist dazu verpflichtet zu
...
\Text
{Vorrang der Einsatzfahrzeuge untereinander}%1 Überschrift
{%
\begin{enumerate}
...
\Text
{Ohne Blau geht's auch}%1 Überschrift
{%
