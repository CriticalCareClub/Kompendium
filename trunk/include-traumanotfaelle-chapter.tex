...
\begin{itemize}
	...
	\item Eingeklemmte Personen werden im Fahrzeug stabilisiert bis die Feuerwehr die Verunfallten retten; Helme tragen!
...
\itme Deformierung von Teilen der Fahrzeugkabine (Hinweis für Aufschlagpunkt des Körpers im Fahrzeug)
...
\beginn{itemize}
	\item mechanische Wunden: Entstehen durch spitze oder stumpfe Gewalteinwirkung auf den Körper (Stichwunde, Schürfwunde, Schusswunde, Bisswunde, ...)
	\item thermische Wunden: Entstehen durch Kälte- oder Hitzeeinwirkung auf den Körper (Verbrennungen, Stromeinwirkung, Erfrierung, ...)
	\item chemische Wunden: Entstehen durch Verätzungen mit Laugen oder Säuren
\end{itemize}

Eine weitere Unterteilung kann nach der Tiefe der Schädigung des Gewebe vorgenommen werden.

\beginn{itemize}
	\item oberflächliche Wunden: Leichte Verletzungen, welche max. bis zur Lederhaut reichen.
	\item tiefe Wunden: Neben der Verletzung der Haut können hier auch Muskeln, Sehnen, größere Blutgefäße innere Organe und Knochen betroffen sein.
	\item penetrierende Wunden: tiefe Wunden mit Eröffnung mindestens einer Körperhöhle (Schädel, Brust, Bauch)
	\item geschlossene Wunden: Verletzungen der Unterenhautschichten ohne Eröffnung der Oberhaut. (Hämatom)
\end{itemize}

Unterschiedliche Entstehungsmechanismen erzeugen unterschiedliche Wundarten bzw. Wundformen.

\beginn{itemize}
	\item Schnittwunde: Glatte Wundränder; kann tieferliegende Nerven und Blutgefäße verletzen
	\item Stichwund: Glatte Wundränder; meist kleine Wunde dafür aber tiefer
	\item Risswunde: Unregelmäßige Wundränder; meist nur Schädigung der Haut und
	keine tieferliegenden Nerven und Blutgefäßen
	\item Quetschwunde: Unregelmäßige Wundränder; es kann zum Aufplatzen der Haut kommen (Platzwunde)
	\item Rissquetschwunde "RQW": Kombination aus Riss- und Quetschwunde
	\item Schürf- und Kratzwunde: oberflächliche Wunde
	\item Bisswunden: Kombination aus Riss-, Stich- und Quetschwunde
	\item Ablederung: großflächiger Gewebsdefekt, z.B. Skalpierung, große Lappenwunden
	\item Amputation: Abtrennung eines Körperteiles
	\item Pfählung/Einspießung: Eindrinden und Verbleiben von spitzen aber z.T. unregelmäßigen Fremdkörpern
	\item Hämatom: Bluterguss; Ansammlung von Blut im Gewebe ausserhalb der Blutgefäße
	\item Schusswunde: meist nach Aussen kleine Wunde mit großer Wirkung
\end{itemize}
...
\gDefinition{Gewalteinwirkung auf den Kopf, die zusätzlich zu den nicht immer vorhandenen Hautwunden und zu den Frakturen des knöchernen Schädels Funktionsstörungen und Verletzungen des Gehirns hervorrufen.\cite{Gorgaß7}}
...
\gDefinition{Gewalteinwirkung auf die Wirbelsäule, die zur Verschiebung oder zur Fraktur von Wirbeln mit oder ohne Rückenmarkschädigung führt.\cite{Gorgaß7}}

Thoraxverletzunge müssen als besonderns gefährlich eingestuft werden, da im Brustkorb (Thorax) lebenswichtige Organe (Herz, Lunge) und große Gefäße liegen.  Nahezu jeder 2. Verkehrstote ist Opfer eines Thoraxtraumas. \cite{Gorgaß7} 
...
Häufigkeit verletzter Körperregionen bei Polytraumatisierten (nach \cite{Böhmer6} und \cite{Gorgaß7}):
\begin{itemize}
