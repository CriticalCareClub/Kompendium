...
\subsection{Die \HeadingKeyword{\ce{CO2}-Messung (Kapnometrie)} ist ein Standardverfahren bei intubierten Patienten}
...
oder den Partialdruck (mm\,Hg) an Kohlendioxyd 
...
zu erkennen 
bzw. auszuschließen 
und dient als Zielwert um die \EE{Beatmungsparameter} 
bei der Beatmung
...
da die Feuchtigkeit der Ausatemluft die Geräte beschädigt 
bzw. das Messergebnis verfälschen kann!
}%2 Text
...
\Range{4}{5}\PC* CO2-Konzetration 
bzw. \Range{35}{40} mm\,Hg \ce{CO2}-Patialdruck.
%
...
\begin{inparaitem}
  ...
  (z.\,B. bei Fieber) 
  \item oder auf ein \EE{zu niedriges Atemminutenvolumen} hin.
\end{inparaitem}
