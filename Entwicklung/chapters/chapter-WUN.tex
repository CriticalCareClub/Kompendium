...
\label{topic:wunden}\index{Wunde}

\HeadingSub{}

\DefinitionInPara{Eine Wunde \Z{(\Lang{Lat.} \IX{Vulnus} (\I{Vuln.}))} ist eine Unterbrechung des
Zusammenhangs von Körpergeweben durch mechanische,
thermische, Strahlen- oder chemische Einwirkungen
\cite{Pschy259}.}
...
\Layout{0}{Zeitlicher Verlauf}{%
Eine weitere Unterteilung kann nach dem \EE{zeitlichen Verlauf} 
getroffen werden:

\begin{itemize}
  \item \EE{Frische Wunden} (Rezente Wunden\Z{, rec.}):
  Wunden innerhalb der ersten 6\Hour* nach der Entstehung
  \item \EE{Nicht frsiche Wunden} (Nicht rezente Wunden\Z{,
  non rec.}): Wunden älter als 6\Hour*
...
\begin{itemize}
  \item Frische (rezente) Wunden: $\leq$\,6\Hour*
  \item Nicht-frische (nicht-rezente) Wunden:
  $>$\,6\Hour*
