...
%%% FOOTER %%%
% right
\fancyfoot[RO]{{\noindent{\sffamily\footnotesize\url{http://www.aass.at}~~|~~v.\,\DocVersion}~ \AASS{}}}
\fancyfoot[RE]{{\noindent\DocGitCommitFootnotesize}}
% left
\fancyfoot[LO]{{\noindent\DocGitCommitFootnotesize}}
\fancyfoot[LE]{{\noindent\AASS{}~ \sffamily\footnotesize v.\,\DocVersion~~|~~\url{http://www.aass.at}}}

\fancyfoot[CE,CO]{{{\sffamily\footnotesize {\DocVersionTyp} | Nur für den internen Gebrauch!}}}
