...
\begin{table}[H]
\FormatTable
\Captionof{table}{\EE{Bewusstseinsgrade}\label{tab:bewusstseinsgrade}.
Diese Einteilung entspricht weitgehend der oft
  genutzten \T{WASB}-Einteilung (\EE{W}ach, Reaktion auf
  \EE{A}nsprechen, auf \EE{S}chmerzreiz, \EE{b}ewusstlos).}
...
\enquote{vorsichtiger}, bzw. Lungen-schonender, beatmen möchte.} Das entspricht einem
