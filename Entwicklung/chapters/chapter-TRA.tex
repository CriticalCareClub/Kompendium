...
Maßnahmen}{Unfälle}{m:am-unfaelle}{%
}{}
...
%   (Beckenfraktur)
%   \item Vitale Bedrohung einschätzen, ggfs. \TxMassVit.
...
\MassnahmenMK{Spezielle
Maßnahmen}{Verstauchung}{m:verstauchung}{%
}{}
% \MassnahmenNG{Spezielle
...
\MassnahmenMK{Spezielle
Maßnahmen}{Verrenkung}{m:verrenkung}
{
}{}
% \MassnahmenNG{Spezielle
...
\MassnahmenNG{Spezielle Maßnahmen}{SHT}{m:sht}{
}{}
...
\Layout{0}{Schleudertrauma, Peitschenschlagsyndrom}
...
versagt. Somit sinkt der Blutdruck rasch ab, es kommt zu einer lebensbedrohlichen Kreislaufstörung. Bei einem hohen Querschnitt kann auch
nervöse die Atemmuskulatur betroffen sein und es zur
Atemlähmung kommen.
...
{m:ws-trauma}
{%
\EE{Taktik}: \Speech{\Ca{Zeitkritisch! Vitale Bedrochung!} Zügige Bergung,
Immobilisation und Transport in eine geeignete Einrichtung}
}{}
% \MassnahmenNG{Spezielle Maßnahmen}
% {Rückenmarksverletzung, Verdacht}
...
%   \item \EE{Schockbekämpfung}; wenn Beine
%   hochgelagert werden sollen, Tragentisch
%   schräg stellen
...
Atmung}\index{Atmung!paradoxe}, bei der sich der Brustkorb beim Einatmen
senkt.
...
\subsection{Pneumothorax}\label{topic:pneumothorax}
...
\MassnahmenNG{Spezielle
Maßnahmen}{Pneumothorax}{m:pneumothorax}
{
\EE{Taktik}: \Speech{\Ca{Zeitkritisch! Vitale Bedrochung!}
...
\MassnahmenMK{Spezielle Maßnahmen}{Bauchtrauma,
offen}{m:bauchtraume-offen}{
\EE{Taktik}: \Speech{\Ca{Zeitkritisch! Vitale Bedrochung!}
...
\MassnahmenMK{Spezielle Maßnahmen}{Beckentrauma,
instabil}{m:beckentrauma-instabil}
{
}{}
...
Die Arbeitsdiagnose Polytrauma kann auch ausschließlich aufgrund des 
Unfallmechanismus und der Vitalparameter gestellt werden. 
...
unabdingbar! Im Idealfall sollten zwischen dem Eintreffen
der Rettungskräfte und der definitiven Versorgung im Spital
...
%   \begin{itemize}
%     \item Transportziel: Schockraum, mit Voranmeldung
%     (Aviso) über Leitstelle
...
\MassnahmenNG{Spezielle
Maßnahmen}{Amputatversorgung}{m:amputat} {%
}{}
...
\MassnahmenNG{Spezielle Maßnahmen}{Verbrennung, leicht}{m:verbrennung-leicht}
{    
}{}

\MassnahmenNG{Spezielle Maßnahmen}{Verbrennung, schwer}{m:verbrennung-schwer}
{%
}{}
...
\MassnahmenMK{Spezielle
Maßnahmen}{Inhalationstrauma}{m:inhalationstrauma}{
}{}
% \MassnahmenNG{Spezielle
...
\MassnahmenMK{Spezielle Maßnahmen}{Verletzungen mit
chemischen Substanzen}{m:chemische-verletzungen}{
}{}
...
\MassnahmenNG{Spezielle
Maßnahmen}{Erfrierungen}{m:erfrierung}
{%
}{}
% \MassnahmenNG{Spezielle
...
\MassnahmenMK{Spezielle
Maßnahmen}{Stromunfälle}{m:stromunfall}
{
}{}
% \MassnahmenNG{Spezielle
