...
Dazu gibt es zwei Möglichkeiten. Einerseits die \gT{Handregel}, welche
besagt, dass die \gEs{Handfläche des Patienten  1\,\%}
seiner Körperoberfläche entspricht. Da dies in der Praxis
bei großflächigen Verbrennungen meist umständlich ist, gibt
es auch noch die \gT{Neunerregel}. Hier wird der Körper in
9\,\%-Teile eingeteilt.
