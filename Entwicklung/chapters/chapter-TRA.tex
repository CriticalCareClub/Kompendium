...
Auch die Psyche kann als Resultat einer erheblichen seelischen Belastung bzw.
unzureichender Bewältigungsmöglichkeiten ein Trauma erleiden. Dies zeigt sich
dann z.B. als Belastungsstörung oder
...
\begin{itemize}
  ...
  (Blaulicht, Warnblinkanlage, Uniformjacke anziehen, evtl. Helm aufsetzen)
...
Fahrzeugs vor dem Unfall  eine wichtige Rolle spielt. Je schneller das Fahrzeug
unterwegs  war, desto schwerer kann die Verletzung sein. \Z{Dabei steigt die Bewegungsenergie des Fahrzeugs  mit dem
...
Die Gewalteinwirkung auf den Patienten entspricht in ihrer Richtung 
...
Wenn ein Insasse getötet oder eingeklemmt wird, ist bei den weiteren 
  Insassen das Risiko schwerer Verletzungen erhöht.

Knieverletzungen können bei einem Autounfall Hinweise auf Oberschenkel-
...
an HWS-, Wirbelsäulen- und Schädel-Hirn-Trauma zu denken. Bei Sturz auf die
...
Fallhöhe von 6\Meter* ist von einer Polytraumatisierung
auszugehen.
}{
\begin{itemize}
  \item HWS-Trauma
...
und andere \EE{Fremdkörper sollen niemals
...
daher erst unter kontrollierten Bedingungen \EE{in einem Operationssaal}
erfolgen. Für den Transport muss man den \EE{Fremdkörper mittels eines
...
Die übliche Beschreibung einer Wunde als eine Verletzung der Haut ist nicht
korrekt. Meist werden mehrere Gewebearten in Mitleidenschaft gezogen.
...
unterscheiden. In den folgende Abschnitten sind Einteilungen
nach der physikalischen Verletzungsursache, nach der Tiefe
der Schädigung sowie nach der Art der Schädigung (Wundart)
angeführt.
...
steht die Blutstillung im Vordergrund, bei thermischen Wunden
wie z.\,B. Verbrennungen ist unter gewissen Umständen die
Kühlung der betroffenen Stelle als erstes durchzuführen. Bei chemischen
Wunden sollte primär die Verdünnung der ätzenden Substanz mit
Wasser erfolgen. Schlussendlich werden aber alle Wunden mit
einer keimfreien Wundauflage zum Schutz vor Infektionen
bedeckt.
...
einer sterilen Kompresse die Wunde oder eine
zuführende Arterie abgedrückt werden. Techniken
sind dem Kapitel \ref{chp:EHI} zu entnehmen.
...
\begin{itemize}
  ...
  Fremdkörper wie z.\,B. Glassplitter dürfen mittels
  \E{steriler Instrumente} (Pinzette, {\ldots}) entfernt
  werden.
  ...
  \EE{von Innen nach Außen} um keine weiteren Verunreinigungen in die Wunde
  zu bringen.
  ...
  Solche Organteile sollten mit steriler Kochsalzlösung
  (\ce{NaCl}-Lösung) feucht gehalten und anschließend steril  mit einem Verbandstuch abgedeckt werden!
  \item Ein steriler Wundverband mit der jeweiligen Situation
  angemessenem Material (z.\,B. Pflaster, Momentverband,
  Kompresse mit Mullbinde, Wundfolie, \ldots) muss angelegt
  werden (ausgenommen bei Bagatellverletzungen).
\end{itemize}
}{
\begin{itemize}
...
Wunden aus:
\begin{itemize}
  \item \EE{Verletzung wichtiger Gewebestrukturen (Organe):} Je nach
  ...
  \item \EE{Starke Blutung:} Bei großflächigen Wunden oder Verletzung wichtiger
  ...
  \item \EE{Starke Schmerzen:} Treten im Zusammenhang mit einer Verletzung 
  ...
  sollte daher über einen aufrechten \EE{Tetanus}-Impfschutz verfügen 
  ...
  Bisswunden kann über den Speichel einer erkrankten Tieres \EE{Tollwut}
...
\Layout{0}{\TxGefahren}{%
\begin{itemize}
  \item Starke Blutungen, evtl. bis Schock (z.\,B. Oberschenkelfraktur)
...
Da Gelenke durch Bänder vor unnatürlichen bzw. übermäßigen Bewegungen geschützt
werden, können diese sowie die Gelenkskapsel bei einer Distorsion in
Mitleidenschaft gezogen werden und bei adäquater Gewalteinwirkung reißen.
...
werden. Dabei kommt es mesit zu Begleitverletzungen an der Gelenkkapsel bzw. den
...
Schultergelenk, ist dies das am häufigsten luxierte Gelenk im menschlichen
Körper.

\Layout{0}{\TxSymptome}{%
Der Patient klagt über Schmerzen im BEreich des Gelenks, durch die
Weichteilverletzung kommt es zu einer Schwellung der umliegenden Gewebe und zu
einem Hämatom. Klinisch kann man eine abnorme Gelenksstellung, welche einen
federnd fixierten Charakter hat, feststellen. Der Patient kann das entsprechende
...
\EE{gedeckte SHT}, bei dem die harte Hirnhaut (Dura mater) nicht eröffnet wird,
sowie das \EE{offene SHT}, bei dem die harte Hirnhaut eröffnet wird. Bei beiden
...
Kreislaufstörungen bis hin zum Atemstillstand durch Einklemmen des Atemzentrums. 
...
{\Ca{Alarmzeichen:} Eine Pupillendifferenz kann ein wichtiger
...
Linie bilden.
Jedes SHT, auch wenn die Diagnostik vor Ort unauffällig ist, 
ist im Spital abzuklären!

\Cave{\EE{Jedes SHT ist im Spital abzuklären!} Es
besteht die Gefahr dass sich der Patient gegenwärtig im
\EE{"`luziden Intervall"'} 
befindet und sich sein Zustand erst in einigen Stunden, dann aber schlagartig 
verschlechtert. Im Zweifelsfall wird der Patient dort zur 
Beobachtung (24\Hour* lang) aufgenommen.}
...
drückt der Überdruck den Mittelfellraum mit dem Herz auf die Gegenseite,
wodurch auch noch die gesunde Lungenhälfte und evtl. die
Hohlvene komprimiert wird. Im Extremfall kann das Herz an seiner Bewegung
gehindert werden. In diesem Fall spricht man vom \T{Spannungspneumothorax}.
...
jungen, hochgewachsenen und schlanken Menschen auf. Symptome des
...
behandeln, im Vordergrund steht die Erkennung, Schockbehandlung und der zügige Transport in ein
Traumazentrum.
}{
\begin{itemize}
  \item Leberruptur
...
Der Patient klagt meist über einen starken Drucksschmerz im rechten Oberbauch.
Durch den Blutverlust durch die Verletzung dieses stark durchbluteten Organs
kann es zu einem Volumenmangelschock kommen. Wie bei der Milz kann es auch hier
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Bei Wirbelsäulen-Trauma Rücksprache mit der Leitstelle wegen evtl. Hubschrauber-Transport
  \end{itemize}
\end{itemize}
}
...
\begin{itemize}
  ...
  Kälte von ca. 4\,\textcelsius. Zwischen die beiden
  Schichten des Beutels gibt  man Wasser mit Eis (im
  Verhältnis 1:1).
...
Schweregrad der Verbrennung beurteilt werden. Dazu stehen die \E{Neunerregel}
sowie die Einteilung nach (Schwere-)Graden zur Verfügung.

Abhängig von den Umständen muss auch an ein \E{Inhalationstrauma}
(\prettyref{topic:inhalationstrauma}) oder andere Begleitverletzungen gedacht
werden.
}{
\begin{itemize}
...
\Layout{0}{\TxGefahren}{%
In den verbrannten Arealen \EE{verliert die Haut ihre Schutzfunktion}; es
besteht die Gefahr von \E{Verdunstung}, \E{Unterkühlung} und \E{Infektionen}.  

\index{Verbrennungskrankheit}
\label{topic:verbrennungskrankheit}
Ab ca. \VonBis{20}{30}\PC* verbrannter Körperoberfläche
kann sich eine \T{Verbrennungskrankheit} entwickeln. Dabei kommt es zu einer körperweiten
\EE{Entzündungsreaktion}. Besonders dramatisch ist die dadurch entstehende
erhöhte Durchlässigkeit der Blutgefäße: Dadurch tritt Plasmaflüssigkeit in das
Gewebe über und es bilden sich Ödeme. 

Aufgrund des \EE{Flüssigkeitsverlustes} durch die Verbrennungskrankheit und
Verdunstung besteht bei großflächigen Verbrennungen \EE{Schockgefahr}
(hypovolämischer Schock)! Der Schock entwickelt sich allerdings erst allmählich.

Bei ringförmigen, um
den Brustkorb herumlaufenden, Verbrennungen kann sich das Gewebe
zusammenziehen und die Dehnbarkeit des Brustkorbes abnehmen;
dadurch wird die Atmung stark behindert.

\EE{Unterkühlung} bedeutet erhöhte
\E{Sterblichkeit}.\ZFootnote{\cite{Loennecker2001} spricht bei
Verbrennungspatienten von einer über 40\PC*ig erhöhten Chance zu versterben wenn
die Körpertemperatur um 1 Grad abnimmt. Eine Unterkühlung tritt vor allem bei narkotisierten Patienten leicht ein.}
...
verbrannten Körperoberfläche angegeben. Diese kann entweder mit der
\E{Handregel} oder mittels der
 \E{Neunerregel} geschätzt werden. Die \T{Handregel} besagt, dass die Handfläche
des Patienten einem Prozent seiner Körperoberfläche entspricht. 

Bei großflächigen Verbrennungen wird die \T{Neunerregel} angewendet: Hier wird
der Körper in 9\PC*-Teile eingeteilt um das Ausmaß der Vebrennung abschätzen zu können.
...
Man unterscheidet zwischen einer \E{leichten} und einer \E{schweren} Verbrennung,
maßgebliche Faktoren sind die \E{Ausbreitung} und der \E{Verbrennungsgrad}. Ab
einer betroffenen Körperoberfläche von >\,20\PC* (Erwachsene; Kinder >\,10\PC*,
Säuglinge >\,5\PC*) gilt eine Verbrennung als \E{großflächig}. Aufgrund des
\E{Flüssigkeitsverlustes} durch die Verbrennungskrankheit und Verdunstung
besteht ab \E{10\PC*} (oder \E{5\PC*} bei Kindern) $\geq$\,2\,{\textdegree}
verbrannter Körperoberfläche \EE{Schockgefahr}
(hypovolämischer Schock)! Der Schock entwickelt sich allerdings erst allmählich.

\Fazit{Ab \EE{10\PC* $\geq$\,2\,{\textdegree}} verbrannter Körperoberfläche gilt
eine Verbrennung als "`schwer"', für \EE{Kinder} gilt eine Grenze von
\EE{5\PC*.}}

}{%
Ab \EE{10\PC* $\geq$\,2\,{\textdegree}} verbrannter Körperoberfläche gilt
eine Verbrennung als "`schwer"'; für \EE{Kinder} gilt eine Grenze von
\EE{5\PC*}.
}{}{}{}
...
% der betroffenen Regionen.
  ...
  Locker anlegen. Bei großflächigen Verbrennungen können, wenn das sterile
  Material nicht ausreicht, zur Not auch saubere Leintücher o.\,ä. verwendet
...
Eine Besonderheit stellt jedoch der verantwortliche Stoff dar, mit welchem
u.\,U. der Patient, dessen Kleidung und evtl. auch die Umgebung kontaminiert ist. Von
diesem Stoff kann sowohl für den Patienten, als auch für den Helfer eine Gefahr
ausgehen. Auf den Selbstschutz und die \EE{Dekontamination} muss großer Wert
gelegt werden. 
}
{
\begin{itemize}
...
\begin{enumerate}
  ...
  \item Transportentscheidung: Ab einer Ausdehnung von 15\PC* (Erwachsener) bzw.
  10\PC* (Kind) Spezialabteilung für Verbrennungsverletzungen. Bei Augenverletzungen
...
\begin{description}
  ...
  ab \EE{15-25 mA} kommt es aufgrund der Muskelkontraktionen zu  krampfhaftem
  ...
  Ab \E{80\,mA} kommt es zu Atemlähmung und
...
Bei Überlandleitungen ist mit Hochspannung (220\,000 Volt (220\,kV)) zu rechnen.

\subparagraph{Bahnanlagen}
Die Eisenbahn arbeitet mit einer Oberleitungsspannung von 15\,000\,V, auch bei
gesenktem Stromabnehmer oder Dieselfahrzeugen kann durch Kondensatorladung eine
Spannung von bis zu 3\,000\,V anliegen.

Im U-Bahnbereich werden z.\,B.als
Traktionsspannung oft Spannungen um die 700\,V eingesetzt. \cite{U61989}
...
Bei Gewitterblitzen treten Spannungen von Millionen
...
\begin{itemize}
  ...
  Stromkreis hat! \EE{Schalten Sie auf jeden Fall vor jeder Berührung
  den Strom ab!}
  \begin{itemize}
