...
Persönlichkeitsänderung. Vgl. Kapitel \CC{[PSY]}
\prettyref{chp:PSY}.
...
Schienbeinplateau-Frakturen. Ab einer Fallhöhe von 6\Meter*
ist von einer Polytraumatisierung auszugehen.
}{
\begin{itemize}
  \item HWS-Trauma
...
\begin{itemize}
  ...
  \item Fremkörper nicht entfernen!
...
\Commentary[Wunde, Definition]{Definition Pschyrembel (259, S. 1796): Unterbrechung des Zusammenhangs von Körpergeweben mit od. ohne Substanzverlust.}
...
\begin{itemize}
  ...
  entfernen ($\rightarrow$ Schwellung)
  ...
  \index{OpSite}\T{OpSite}\texttrademark ) verwendet werden.
  \item Bei starken Schmerzen oder großem Blutverlust
  $\rightarrow$ Notarzt
...
eine Gelenksverletzung, bei welcher ein Knochen durch eine
...
gezogen werden und bei adäquater Gewalteinwirkung reißen.
...
es mesit zu Begleitverletzungen an der Gelenkkapsel bzw. den
...
Schwere und Mechanismus können verschiedene  Formen des SHT
auftreten. Man unterscheidet das \EE{gedeckte SHT}, bei dem
die harte Hirnhaut (Dura mater) nicht eröffnet wird, sowie
das \EE{offene SHT}, bei dem die harte Hirnhaut eröffnet
...
festgestellt,  ohne dass äußere Wunden vorliegen. Eine \T{sorgfältige
...
\begin{itemize}
  \item Gehirnerschütterung -- SHT 1{\textdegree}
  \item Gehirnprellung -- SHT 2{\textdegree}
  \item Gehirnquetschung -- SHT 3{\textdegree}
\end{itemize}
}{}{}{}

% \OldNew{
% \subsubsection{Gehirnerschütterung -- SHT 1\textdegree}
...
% 
% 
% \subsubsection{Gehirnprellung -- SHT 2\textdegree}
...
\Layout{0}{\Ca{Luzides Intervall} (lichtes Intervall)}
{%
...
Punkte sind hier jedoch nochmal aufgezählt:
\begin{itemize}
	\item Neurologie (Neurocheck)
	\item Weitere Verletzungen (Traumacheck)
...
\Layout{20}{Neurologische Beurteilung}{%
...
{\begin{itemize}
  \item Bewußtseinslage
  \item Motorik
  \item Pupillenweite
  \item Pupillenreaktion
  \item Sprache
  \item Sonstige Hirndruckzeichen
\end{itemize}}
...
\paragraph{Traumacheck} Ein Traumacheck ist
...
Querschnittslähmung, ebenso dass Schädel, HWS und BWS eine
Linie bilden. Jedes SHT, auch wenn die Diagnostik vor Ort
unauffällig ist, ist im Spital abzuklären!

\Cave{\EE{Jedes SHT ist im Spital abzuklären!} Es besteht
...
\Layout{0}{\TxSymptome{} des Thoraxtraumas}{~\par
...
\Z{\HeadingSub{\Lang{Term.} \T{Combustio}}, \Lang{Abkz.} \E{Comb.}}

\TODO{GABS}{2010-08-01}
{Mit Aussendung der ASBÖ-Akademie
(\protect\bibentry{ASBOEAkademieUpdate2010Verbrennung},
\cite{ASBOEAkademieUpdate2010Verbrennung}) bezüglich Konformität kontrollieren!}{}
...
\Z{Sonderform \E{Verbrühung}\ZFootnote{\Lang{Term.} Ambustio, \Lang{engl.}
...
\begin{itemize}
  ...
  \item \EE{Abdeckung}: Sterile, nicht verklebende Wundauflagen; evt.
  metalliserte Wundauflagen
...
% der betroffenen Regionen.
  \item \EE{Abdeckung}: Sterile, nicht verklebende Wundauflagen, evt.
  metalliserte Wundauflagen
  \cite{Helfen2008,RedelsteinerHRNS1}.\ACh{GABS}{2010-08-06}{Metallisierte Verbände sind wünschenswert, werden zB in Helfen2008 empfohlen.}\ZFootnote{Der Nutzen von kühlenden Spezialverbänden, z.\,B. Waterjel{\texttrademark} ist aufgrund der Unterkühlungs-Gefahr und einer möglichen Durchblutungsstörung der Wunde umstritten.}
  Locker anlegen. Bei großflächigen Verbrennungen können,
  wenn das sterile Material nicht ausreicht, zur Not auch
  saubere Leintücher o.\,ä. verwendet
  werden \cite{emergency9}.
...
\T{{\quotedblbase}unsichtbar{\textquotedblleft}}, da der Strom im
