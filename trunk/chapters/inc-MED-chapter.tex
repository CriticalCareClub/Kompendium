...
Kreislaufdepression, Herzfrequenz und Blutdruck stürzen ab, sowie zu Bewusstseinsstörungen. Die
Sauerstoffsättigung ist stark vermindert und der Patient
ist zyanotisch.
...
\gMassnahmenNG{Spezielle Maßnahmen}{Akuter Asthmaanfall}{
     ...
     \begin{itemize}
         ...
         atmen aufhört! Siehe Kap. \gAbk{COPD}
         (\gSee{topic:copd}). Bei sorgfältiger Überwachung
...
Patientin mit einem akuten Asthmaanfall.
    ...
    mit den Armen ab. Die Erstma{\ss}nahmen bei vital bedrohten Patienten wurden ergriffen: 
    \begin{compactitem}
...
Bei Einhaltung der Schutzma{\ss}nahmen (s. Spezielle Maßnahmen) ist eine Ansteckung
...
\begin{itemize}
    \item Allgemeine Selbstschutzma{\ss}nahmen bei der
...
Zwangsma{\ss}nahmen bei psychiatrischen Patienten durch.}
...
\begin{enumerate}
    ...
    \item Wenn erforderlich: Absperrma{\ss}nahmen durchführen
