...
\begin{description}
    ...
    \Es{sofortiges Handeln} notwendig ist und die eigentliche Diagnose, die zu
    ...
    \index{Z.n.|see{Zustand nach}} Abk. \E{'St.p.'}, \E{'Z.n.'}. Bezeichnet eine ``alte Diagnose'', d.h. eine Erkrankung oder eine Behandlung die einmal durchgemacht wurde. Z.B.:
    \begin{itemize}
