...
Leitstelle ist für mehrere Organisationen zuständig sein,
...
Leitstellen können sowohl ortsfest eingerichtet werden, es
...
Datenfunk, bzw. andere geeigneted
...
Um einen Überblick über einsatzbereite zu erhalten sorgt die
Leitstelle für eine \EE{Status- und Standort-Verwaltung}: Es
wird der jeweilige Status und -- wenn möglich -- den
...
Einsatzursache und Zeiten protokolliert, als auch besonder
...
\begin{itemize}
  ...
  \item Erfassung in Einsatzleitsystem * Einteilung und Priorisierung nach Art und
    Dringlichkeit der Meldung, benötigtes Personal, etc. 
  \end{itemize} 
  \item \E{Disposition}
\begin{itemize}
...
Als Funk(technik) bezeichnet man allegmein die
...
Handfunkgeräten, Mobilfunkgeräten oder Feststationen zum
Einsatz kommen.

Der klassische Funkbetrieb wird im
Wechselverkehr (Halbduplexbetrieb) abgewickelt, d.\,h. es
kann nur ein Teilnehmer gleichzeitig senden und belegt dabei
die Frequenz. \Z{Beim Vollduplexbetrieb kann man
gleichzeitig empfangen und senden (z.\,B. Telefon).} Um
...
\TabSub{A} & Anton 		& ←	=		& Alpha 	& \TabSub{O} & Otto 		& ←			& Oscar 	& \TabSub{0} & Null 	& Zero\\\addlinespace
\TabSub{Ä} & Ärger 		& ←			& --- 		& \TabSub{Ö} & Österreich 	& Ökonom	& --- 		& \TabSub{1} & Eins 	& One\\\addlinespace
\TabSub{B} & Berta 		& ←			& Bravo 	& \TabSub{P} & Paula 		& ←			& Papa 		& \TabSub{2} & Zwo 		& Two\\\addlinespace
\TabSub{C} & Cäsar 		& ←			& Charlie 	& \TabSub{Q} & Quelle 		& ←			& Quebec 	& \TabSub{3} & Drei 	& Three\\\addlinespace
\TabSub{Ch}& --- 		& Charlotte	& --- 		& \TabSub{R} & Richard 		& ←			& Romeo 	& \TabSub{4} & Vier 	& Fower\\\addlinespace
\TabSub{D} & Dora 		& ←			& Delta 	& \TabSub{S} & Siegfried 	& Samuel	& Sierra 	& \TabSub{5} & Fünf 	& Five\\\addlinespace
\TabSub{E} & Emil 		& ←			& Echo 		& \TabSub{Sch} & --- 		& Schule	& ---		& \TabSub{6} & Sechs 	& Six\\\addlinespace
\TabSub{F} & Friedrich 	& ←			& Foxtrott 	& \TabSub{ß} & Scharfes s	& Eszett	& --- 		& \TabSub{7} & Sieben 	& Seven\\\addlinespace
\TabSub{G} & Gustav 	& ←			& Golf 		& \TabSub{T} & Theodor 		& ←			& Tango 	& \TabSub{8} & Acht 	& Eight\\\addlinespace
\TabSub{H} & Heinrich 	& ←			& Hotel 	& \TabSub{U} & Ulrich 		& ←			& Uniform 	& \TabSub{9} & Neun 	& Niner\\\addlinespace
\TabSub{I} & Ida 		& ←			& India 	& \TabSub{Ü} & Übel 		& Übermut	& --- 		& \TabSub{./,} & --- 	& Decimal\\\addlinespace
\TabSub{J} & Julius 	& ←			& Juliett 	& \TabSub{V} & Viktor 		& ←			& Victor 	& \TabSub{.} & --- 		& Stop\\\addlinespace
\TabSub{K} & Konrad 	& Kaufmann	& Kilo 		& \TabSub{W} & Wilhelm 		& ←			& Whiskey	& \\\addlinespace
\TabSub{L} & Ludwig 	& ←			& Lima 		& \TabSub{X} & Xaver 		& Xanthippe	& X-ray		& \\\addlinespace
\TabSub{M} & Martha 	& ←			& Mike 		& \TabSub{Y} & Ypsilon 		& ←			& Yankee\\\addlinespace
\TabSub{N} & Nordpol 	& ←			& November	& \TabSub{Z} & Zürich 		& Zacharias	& Zulu\\\addlinespace
...
Unter dem Begriff Datenfunk versteht man die
...
on Folge von Überlastung gestört, ist dieser
...
wird der \Abk{KTW} auch zum Transport und erkrankten,
...
Ein \Abk{RTW} ist mit mindestens 2 Fachpersonen besetzt
...
Der \Abk{NAW} ist mit mindestens 3 Fachpersonen besetzt
...
\begin{itemize}
  ...
  25\,$\times$\,25\,m, es dürfen keine Oberleitungen o.\,ä.
  den gefahrlosen Anflug stören. Ist in der Nähe des
...
bei dem gleichen Patienten mit der gleichen Diagnose es klug
