...
\index{Bauchfell}
% TODO Bauchfell: Fließtext mangelhaft
\fxwarning[author=GABS]{Bauchfell: Fließtext mangelhaft}
% TODO Bauchfell: Beschreibung mangelhaft
\fxwarning[author=GABS]{Bauchfell: Beschreibung mangelhaft}
% TODO Bauchfell: SLIDE fehlt
\fxerror[author=GABS]{Bauchfell: SLIDE fehlt}

\gLayout{20}
{}
{ 
Das Bauchfell (\gT{Peritoneum}) ist eine dünne Haut das die gesamte Bauchhöhle
auskleidet. Dieser Überzug bekleidet die meisten Bauchorgane (außer z.B. die Nieren) und das große
und kleine Netz (\gT{Omentum majus und minus}). Es sorgt durch seine feuchte
