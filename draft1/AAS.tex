...
\documentclass[ngerman,a4paper,fontsize=9pt,BCOR=1.5cm]{scrbook}
...
% Text styles
% \newcommand\textstylehervorgehoben[1]{\textbf{\textcolor[rgb]{0.0,0.0,0.5019608}{#1}}}
...
\renewcommand\descriptionlabel[1]{\hspace{\labelsep}\textcolor[rgb]{0.8,0.8,1}{\Squaresteel}\hspace{\labelsep}\gEs{#1}}

% Define Grissu.org \latex commands
% Character styles names are single letters, 
% Paragraph styles are words

\newcommand\gAuthNotes[1]{\textcolor{red}{\ttfamily #1 }}
...
\newcommand{\gDefinition}[1]{{\centering \cornersize{0.5} \ovalbox{\makebox[10cm]{\parbox{8cm}{\sffamily \textcolor{Terminus}{#1}}}}}}
...
\newcommand{\gMassnahmen}[1]{{\centering \cornersize{0.5} \ovalbox{\makebox[10cm]{\parbox{8cm}{\sffamily #1}}}}}
\newenvironment{gMassnahmenEnv}{\begin{boxedminipage}[t]{10cm}}{\end{boxedminipage}}


\renewcommand{\labelitemi}{\textcolor[rgb]{0.0,0.0,0.4}{\Squaresteel}}
...
\newcommand{\marginlabel}[1]{\mbox{}\marginpar{\raggedright\hspace{0pt}\sffamily\tiny #1}}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   Title

\title{Arbeits- und Ausbildungsstandards f\"ur den Sanit\"atsdienst}
...
\begin{center}
Arbeits- und Ausbildungsstandards\par
und eine Einf\"uhrung in die Welt der Medizin und Sanit\"atshilfe\par
\end{center}
...
\part{T\"atigkeitsbild und Orientierung}

\part{Betriebsinterne Regelungen}

\part{\gStatus{90\% fertig}[RS III] Rechtliche Grundlagen}
Christof Koller \[*\]
...
\minitoc
\chapter{Allgemeine Rechtsgrundlagen}
\section{Struktur der \"osterreichischen Rechtsordnung}


\psset{arrowscale=2}
\begin{longtable}{| p{2.2cm} | p{2.2cm} p{2.2cm} p{2.2cm} | p{2.2cm} p{2.2cm} |}\hline

\multicolumn{1}{|c}{\rnode{EU}{EU-Recht}} & \multicolumn{5}{|c|}{Struktur der \"Osterreichischen Rechtsordnung} \\\hline

{Blah!} & \multicolumn{3}{c}{\centering \rnode{OR}{\"OffentlichesRecht}} & \multicolumn{2}{c|}{\centering \rnode{PR}{Privatrecht} } \\\hline

\multicolumn{1}{c}{Rechts\-gebiete} & 
	\multicolumn{1}{c}{\centering Strafrecht} & 
		\multicolumn{1}{c}{\centering VwR} & 
			\multicolumn{1}{c}{\centering VfR} & 
				\multicolumn{1}{c}{\centering Zivilrecht} & 
					\multicolumn{1}{c}{\centering Sonder\-privat\-rechte} \\\hline

\multicolumn{1}{c}{Wichtigste Gesetzesbereiche} & 
	\multicolumn{1}{c}{\centering StGB, StPO} &
		\multicolumn{1}{c}{\centering Berufsgesetze, KAKuG, UbG} & 
			\multicolumn{1}{c}{BVG; StGG} &
				\multicolumn{1}{c}{\centering ABGB} & 
					\multicolumn{1}{c}{\centering Arbeits\-rechts-ge\-setze,
					Unter\-nehmens\-ge\-setz\-buch}\\\hline 

\end{longtable}

%\ncbarr[arrows=->]{EU}{OR}

\begin{pspicture}(0,-1)(3.5,1.5)
\rnode{A}{Verbinde} Woerter mit \rnode{B}{ncbar}
\ncline[nodesep=3pt]{->}{EU}{OR}
\ncline[nodesep=3pt]{->}{EU}{PR}
...
(nicht von Gerichten) bei Versto{\ss} insofern sanktioniert werden, dass (vorrangig) Geldstrafen verh\"angt werden.
...
ihre Verh\"altnisse zu den Staatsb\"urgern sowie Grunds\"atze der Rechtsordnung enth\"alt.
...
\begin{itemize}
 \item \gT{Zivilrecht}: Enth\"alt jene allgemeinen Normen, die
die Rechtsverh\"altnisse zwischen gleichgestellten B\"urgern regeln.
...
Ersatzleistungen f\"ur den Schaden fordern kann (keine Strafe).
 ...
 \item \gT{Sonderprivatrechte}: eigenst\"andige Rechtsgebiete,
die mittels selbstst\"andigen Normen besondere Rechtsverh\"altnisse
zwischen den B\"urgern regeln. Zu den wichtigsten z\"ahlen das Arbeits-
und das Unternehmensrecht.

\end{itemize}

\section{Vertragsverh\"altnis im Rettungswesen}
...
\tablehead{}\begin{supertabular}{m{3.3cm}m{5.6210003cm}m{4.1730003cm}}
 &
	...
	\centering Gesch\"aftsf\"uhrung ohne Auftrag im Notfall
 	&
	\\
\raggedleft {\bfseries\color{blue} \Rnode{patient}{Patient}}\par
 ...
 &
	{}
 	...
 	&
		...
		\Rnode{rettorg}{(bzw. Krankenanstalt)}
...
\\
 &
	...
	\Rnode{erfgeh}{(Not)Arzt/Sanit\"ater}}\par
...
\gEs{Verh\"altnis zwischen Patient und
Rettungsorganisation} zu bezeichnen, da direkter (Vertrags)Partner zum
Pat. niemals der Sanit\"ater, sondern stets die von ihm vertretene
Organisation ist. Man nimmt n\"amlich an, dass ein Pat., wenn er eine
{\quotedblbase}Rettung{\textquotedblleft} verst\"andigt, nicht mit dem
...
Rechtsverh\"altnis kann nun auf zwei verschiedene Arten zustande
kommen:
...
\begin{itemize}
	...
	\item {\mdseries
	\gT{Gesch\"aftsf\"uhrung ohne Auftrag im Notfall}: der
	Pat. befindet sich in einem derartigen Notfall, dass er sich nicht mehr
	\"au{\ss}ern kann und dringend eine Behandlung ben\"otigt (Bsp.:
	Bewusstlosigkeit)}
...
Im \gEs{Verh\"altnis zwischen Patient und
(Not)Arzt/Sanit\"ater} fungiert der (Not-)Arzt/\ Sanit\"ater blo{\ss} als
...
Sch\"adigungen des Pat. durch Handlungen des (Not)Arztes/ Sanit\"aters,
kann der Gesch\"adigte deliktisch gegen den Erf\"ullungsgehilfen und
...
{\mdseries
Das \gEs{Verh\"altnis zwischen Rettungsorganisation
und (Not-)Arzt/Sanit\"ater} l\"asst sich auf drei verschiedene Arten
begr\"unden:}

\begin{itemize}
\item \gE{Arbeitsvertrag}: Der (Not-)Arzt/Sanit\"ater ist bei
der Organisation als Hauptamtlicher berufsm\"a{\ss}ig besch\"aftigt. 

\item \gE{Vereinsmitgliedschaft}: Der (Not-)Arzt/Sanit\"ater ist
bei der Organisation als Vereinsmitglied und somit als
Ehrenamtlicher/Freiwilliger t\"atig. 

\item \gE{Zivildienst}: Der Sanit\"ater leistet seinen
...
\section{Strafbarkeitspr\"ufung}

\begin{itemize}
\item[] {\mdseries
1. Tatbestandserf\"ullung bzw. Schaden}
...
\textbf{\textcolor{red}{NA}}tascha, Not\"arztin
...
\section{Teil A: Gefahrenbek\"ampfung}

\subsection{Fall 1. Randalierender Patient}
...
\begin{itemize}
\item {\mdseries
gegenw\"artig oder unmittelbar drohender Angriff,}
...
\item {\mdseries
auf ein notwehrf\"ahiges Gut (= Leben, Gesundheit, Freiheit oder
Verm\"ogen) und}

\item {\mdseries
das Gelindeste der zur verl\"asslichen Abwehr verf\"ugbaren Mittel
verwendet wird}
...
\begin{itemize}
\item {\mdseries
Sollten Alex, Sepp und Bernd f\"alschlich einen Agriff angenommen haben,
sind sie entschuldigt, wenn sie aus Furcht gehandelt haben und eine
ma{\ss}gerechte Person sich gleich verhalten h\"atte. }
...
die Sachbesch\"adigung iSd. {\S} 125 StGB darstellt. Dabei darf nur auf
...
\item Selbst- und/oder Fremdgef\"ahrdung
\item Verh\"altnism\"a{\ss}igkeitsgrundsatz
...
unterstellt ist und \"uber die Polizei zu verst\"andigen ist. Der
...
\end{itemize}
\subsection{Fall 2. Gefahr durch Hund}
\paragraph*{Sachverhalt}
...
\item {\mdseries anzuwenden wenn die Gefahr auch tats\"achlich
(objektiv) vorliegt}
...
\item {\mdseries gegenw\"artig oder unmittelbar drohend}
...
\item {\mdseries Zurechnungsprinzip (=~Abwehr geht in Sph\"are des
...
\section{Teil B: Heilbehandlung}

\subsection{Fall 3. Blutzuckermessung = Heilbehandlung}
\paragraph*{Sachverhalt}
...
\begin{itemize}
 ...
 \item durchzuf\"uhren nach Aufkl\"arung des Pat. (${\rightarrow}$ siehe ad 4.)
\end{itemize}
...
\item Strafrecht:
 ...
 \begin{itemize}
  \item a) \gEs{K\"orperverletzung} - {\S}{\S} 83 ff StGB: Sonderfall der HB-Voraussetzungen: es ben\"otigt nur med. Indikation und lege artis Durchf\"uhrung; die Aufkl\"arung ist hierf\"ur irrelevant

  \item b) \gEs{Eigenm\"achtige Heilbehandlung} - {\S} 110 StGB: siehe ad 4.
 ...
 \begin{itemize}
  \item a) \gEs{Schadenersatzanspr\"uche} - {\S}{\S} 1293 ff ABGB: die HB muss alle drei Voraussetzungen erf\"ullen (auch Aufkl\"arung); Umfang des Schadenersatzes siehe ad 11.
 \end{itemize}
...
\begin{itemize}
	...
	Sanit\"ater eine solche Ma{\ss}nahme lege artis durchf\"uhren. Eine
	Aufkl\"arung ist aufgrund der mangelnden Einsichts- und
	Urteilsf\"ahigkeit nicht m\"oglich.}
\end{itemize}
\section{Teil C: Selbstbestimmungsrecht}

\subsection{Fall 4. Aufkl\"arung und Einwilligung}
...
%\begin{multicols}{2}
\subparagraph*{\gEs{Aufkl\"arungspflicht}:}

\begin{itemize}
	\item {\mdseries
	Jeder Pat. ist aufzukl\"aren,}

	\item {\mdseries
	vor Setzung der Ma{\ss}nahme,}

	\item {\mdseries
	wenn er einsichts- und urteilsf\"ahig ist.}

\end{itemize}

\subparagraph*{\gEs{Einsichts- und Urteilsf\"ahigkeit}:}

	\begin{itemize}
	\item {\mdseries
	grunds\"atzlich: bei jedem vollj\"ahrigen Pat. gegeben }
	...
	\begin{enumerate}
		\item grunds\"atzlich unm\"undigen Minderj\"ahrigen (0-14 LJ.), wobei es vorrangig auf die Einsichts- und Urteilsf\"ahigkeit ankommt

		\item bei m\"undig Minderj\"ahrigen (14.-18 LJ.) vorhanden, solange entsprechende Einsichts- und Urteilsf\"ahigkeit nicht fehlt

		\item psychisch erkrankter Pat. mit fehlender Einsichts- und Urteilsf\"ahigkeit
...
\begin{itemize}
	...
	\begin{itemize}
		\item grunds\"atzlich entscheidend ist die vom Einsatzpersonal getroffene
		Beurteilung der Einsichts- und Urteilsf\"ahigkeit des Minderj\"ahrigen

		\item nur im Zweifel ist erst der m\"undige Minderj\"ahrige selbstst\"andig
...
\end{itemize}
\end{itemize}
\subparagraph*{\gEs{Umfang der Aufkl\"arung}:}

\begin{itemize}
	\item {\mdseries
	Grundsatz: Die Aufkl\"arung hat in jenem Rahmen zu erfolgen, der einer
...
\subparagraph*{\gEs{Unterlassen der Aufkl\"arung}:}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		der Patienten  (oder sein zust\"andiger Vertreter) diese Ma{\ss}nahme
		aber verweigert}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			gegenw\"artige Gefahr, die ein Abwarten nicht zul\"asst bzw.
			unmittelbares Handeln verlangt} ben\"otigt es
			keine Aufkl\"arung bzw. Einwilligung und es d\"urfen alle nach Ansicht
			der Einsatzkr\"afte direkt notwendigen Ma{\ss}nahmen gesetzt werden
		\end{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item {f\"ur das Zivilrecht ist die Einwilligung aufgrund einer Aufkl\"arung
...
\subsection{Fall 5. Patientenverf\"ugung}
\paragraph*{
Sachverhalt}
...
\begin{itemize}
	\item 
	Willenserkl\"arung einer einsicht-, urteils- und
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item {\mdseries
		eigenh\"andig unterschrieben und datiert}

		\item {\mdseries
		aufgrund einer umfassenden Aufkl\"arungen durch einen Arzt}
		...
		\item[] 
		Eine Verf\"ugung die alle Elemente enth\"alt ist absolut bindend und
	...
	\begin{itemize}
		\item {\mdseries
		\gEs{grunds\"atzlich}: alle Verf\"ugungen, die nicht
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item {\mdseries
		erkennbare Willensm\"angel des Pat. bei Abgabe der Verf\"ugung (nicht
		ernst gemeint, Irrtum, List, Drohung oder T\"auschung)}
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
	Doch aufgrund des zu allgemeinen Inhalts, der Beil\"aufigkeit der
...
\section{Teil D: Rechte und Pflichten des Sanit\"aters}

\subsection{Fall 6. Unterlassung der Notarztnachforderung}
...
{\quotedblbase}Boder\footnote{"Bader": fr\"uher Kundiger der Heilb\"ader, heute umgangssprl. f\"ur Arzt}{\textquotedblleft} zu warten und der Pat. auch
...
\begin{itemize}
	...
	Ausbildung, F\"ahigkeiten und Kenntnissen. Aber schon zu den Grundlagen
	...
	Notrufes zur  Anforderung von geeigneten Rettungskr\"aften.}
...
\begin{itemize}
	...
	\item {\mdseries
	ein jeder Sanit\"ater, unabh\"angig von seinem Ausbildungsstand, ist zur
...
Was sind die \gT{Kompetenzen} der einzelnen Sanit\"aterstufen
...
\begin{itemize}
	...
	\begin{itemize}
		\item {\mdseries
		Z 1: selbstst\"andige und eigenverantwortliche Versorgung und Betreuung
		des Pat.}
	...
	zus\"atzlich zu den oben genannten Kompetenzen darf der NKA jene
	...
	zus\"atzlich zu den oben genannten Kompetenzen darf der NKV jene
	...
	\begin{itemize}
		...
		\item {\mdseries
		nach Verst\"andigung eines Notarztes.}
...
\subsection{Fall 8. Rechtswidrige Anordnung durch Notarzt}
...
\begin{itemize}
	...
	\item {\mdseries
	nat\"urlichen Rechtsgrunds\"atzen iSd. {\S} 7 ABGB und dem
...
\begin{itemize}
	\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
	Die RTW-Mannschaft darf daher die f\"ur den Pat. sch\"adigende Anordnung
...
\subsection{Fall 9. Dokumentationspflicht}
...
\gZ{{\S}~5}\gEs{ SanG}:
{\quotedblbase}\gC{Sanit\"ater haben [{\dots}] die von
...
\begin{itemize}
	...
	\item {\mdseries
	situationsrelevante Umst\"ande (beim Pat.; am BO; w\"ahrend des
	Transportes; {\dots})}
	...
	\item {\mdseries
	uU. relevante Inhalte der Aufkl\"arung}

	\item {\mdseries
	sonstige f\"ur den Sanit\"ater entscheidend wirkende Umst\"ande }
...
\subsection{Fall 10. Verschwiegenheits- und Auskunftspflicht}
...
\begin{itemize}
	...
	T\"atigkeit als Arzt/Sanit\"ater anvertraut bekommen hat, d\"urfen
...
\begin{itemize}
	\item {\mdseries
	Identit\"at des Pat. bleibt gewahrt}
...
\begin{itemize}
	\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
	Fr. Aufgeregt z\"ahlt als blo{\ss}e Angeh\"orige nicht zum Kreis der
	Auskunftsberechtigten, solange der Pat. die Weitergabe von
	Informationen nicht gestattet. }

\end{itemize}

\subsection{Fall 11. Fortbildungs- und Rezertifizierungspflicht}
...
\gE{Sonderfall NKI}: Ein Notfallsanit\"ater mit
Kompetenzen der Intubation muss sich zus\"atzlich innerhalb seines 2
...
\begin{itemize}
	...
	Medizinproduktebeauftragter,  Lehrsanit\"ater oder Praxisanleiter sowie
...
\section{Teil E: Schadenersatz}

\subsection{Fall 12. Verletzung des Pat. durch Sanit\"ater:}
...
dessen Angeh\"origen, kann der Gesch\"adigte nach
\gZ{{\S} 1313a} ABGB direkt gegen die
Rettungsorganisation seine SchEA geltend machen. Denn ein Sanit\"ater
...
\begin{itemize}
	...
	Kausalit\"at gegeben. Weiters verst\"o{\ss}t es gegen die gesetzlichen
	und vertraglichen Pflichten den Pat. ohne anzuschnallen zu
	transportieren, weshalb eine Rechtswidrigkeit bejaht werden kann. }

	\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
	Auch h\"atten sich unsere Sanit\"ater anders, n\"amlich den Pat.
...
\subsection{Fall 13. Sachbesch\"adigung}
...
\paragraph*{Rechtsfrage: Schadenersatz wegen Sachbesch\"adigung}
...
\begin{itemize}
	...
	\item {\mdseries
	konkret f\"ur Sachsch\"aden: \gZ{{\S} 1331 ABGB}}
...
\begin{itemize}
	\item {\mdseries
	realer Schaden (= tats\"achlich eingetretener Schaden)}
...
\section{Teil F: Behandlungspflicht}

\subsection{Fall 14. Behandlungspflicht von Krankenanstalten, \"Arzten,
...
\item {\mdseries
	...
	\begin{itemize}
		...
		bestimmten KA{\textquoteright}s, ist trotzdem zul\"assig, da sich der
		Pat. w\"ahrend des Transportes schon in einem pr\"aklinischen Umfeld (=
		Einsatzwagen mit Sanit\"atern und Medizinprodukten) befindet. Sollte
		sich aber der Zustand des Pat. w\"ahrend der Fahrt verschlechtern, so
		darf das n\"achstgelegene Spital angefahren werden. \newline
		Erst wenn der Pat. wieder transportf\"ahig ist, darf er mit geeigneten
	...
	\begin{itemize}
		...
		\item {\mdseries
		\"Arzte, unabh\"angig ihrer Fachausbildung, sind dazu verpflichtet
	...
	\item {\mdseries
	\gEs{Behandlungspflicht f\"ur Sanit\"ater} -
	\gZ{{\S} 4 iVm {\S} 8 iVm {\S} 9 Abs. 1 Z 1 SanG}:}

	\begin{itemize}

		\item {\mdseries
		Jeder t\"atigkeits- oder berufsberechtigter Sanit\"ater, unabh\"angig
		von seinem Kompetenzstand, ist zur selbstst\"andigen und
	...
	\begin{itemize}
		...
		\item {\mdseries
		Jeder B\"urger (und nicht mehr t\"atigkeitsberechtigter Sanit\"ater) ist
	...
	\begin{itemize}
		\item {\mdseries
		man das eigene Leben oder die Gesundheit gef\"ahrden w\"urde oder}
...
\section{Teil G: Meldepflichtenrecht}

\subsection{Fall 15. Ansteckende Krankheiten}
...
\gEs{Meldepflichtige Krankheiten}:}
	...
	\begin{itemize}
		\item {\mdseries
		da sich st\"andig neue \"ubertragbare KH entwickeln, gibt das
...
\begin{itemize}
	...
	Gesundheitsberufe aufgrund der schon erw\"ahnten Auskunftspflicht gem.
	\gZ{{\S} 7} SanG.}

\end{itemize}

\subsection{Fall 16. Strafbare Handlungen}
...
\begin{itemize}
	\item {\mdseries
	\"arztliche Anzeigepflicht - \gZ{{\S} 54 Abs. 4 und 5
	\"ArzteG}:}
	...
	\begin{itemize}
		...
		\item {\mdseries
 		Misshandelung, Qu\"alung, Vernachl\"assigung oder sexueller Missbrauch
		von:}

		\begin{itemize}
			\item {\mdseries
			Minderj\"ahrigen oder}

			\item {\mdseries
			Vollj\"ahrigen, die nicht alleine in der Lage sind ihre Interessen
			wahrzunehmen}
...
entstammenden Pflicht f\"ur den Sanit\"ater {\quotedblbase}das Wohl der
...
\section{Teil H: Stra{\ss}enordnung}

\subsection{Fall 17. Blaulichtverwendung}
...
\begin{itemize}
	\item {\mdseries
	grunds\"atzlich bei: Gefahr in Verzug}
...
\begin{itemize}
	...
	\item {\mdseries
	Verkehrsgebote und --beschr\"ankungen gelten nicht}
	...
	\item {\mdseries
	es d\"urfen weder Personen noch Sachen gef\"ahrdet oder besch\"adigt
	werden}
...
\begin{quotation}
Nur wer noch gr\"o{\ss}ere Sorgfalt und Vorsicht wahrt als bei normaler Fahrt, verh\"alt sich richtig! \gE{Beinhaltet mitunter eine geringere Fahrgeschwindigkeit als die h\"ochst zul\"assige!}
\end{quotation}
...
Rettungstransport besteht zus\"atzlich gem. \gZ{{\S}
...
sich anzuschnallen bzw. sollte vom Sanit\"ater angeschnallt werden.
...
\begin{itemize}
	\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
	W\"urde unser RTW-Team tats\"achlich Blaulicht und Folgetonhorn
...
\item[NFS]  Notfallsanit\"ater

\item[NKA]  Notfallsanit\"ater mit Kompetenzen der
Arzneimittel

\item[NKI]  Notfallsanit\"ater mit Kompetenzen der
Intubation

\item[NKV]  Notfallsanit\"ater mit Kompetenzen des
ven\"osen Zugangs

\item[OGH]  Oberster Gerichtshof

\item[OSR]  Oberster Sanit\"atsrat
...
\item[RS]  Rettungssanit\"ater

\item[RTW]  Rettungstransportwagen

\item[SanG]  Sanit\"atergesetz
...
\part{[RS I] Erste Hilfe und erweiterte Erste Hilfe}

\part{[RS IX] Ger\"atelehre und Sanit\"atstechnik}

\part{[RS XIII] Untersuchung und Anamnese}

\setcounter{page}{0}
\part{Anatomie und Physiologie}
...
\part{[RS V] Vitalfunktionen}

\part{[RS VI] Krankheiten und Notf\"alle}
...
\nopagebreak{\chapter{Herz-Kreislaufstörungen}}
...
Abh\"angig davon wie gut der KÃ¶rper mit der Einschr\"ankung zurecht kommt unterteilt man: 
\begin{description}
	\item[Kompensierte Herzinsuffizienz] Der K\"orper hat noch genug Reserven, kann gegensteuern und kommt mit der eingeschr\"ankten Leistung aus.
...
Verlaufes beurteilen}: Bekannte, seit l\"angerer Zeit bestehende
...
hochgef\"ahrliches, Alarmzeichen ist das
\gEs{brodelnde Atemger\"ausch} beim Lungen\"odem. 
...
\subsection*{Linksherzinsuffizienz}
...
\subsection*{Rechtsherzinsuffizienz}
...
\begin{description}
	...
	\gEs{Herzkranzgef\"a{\ss}e} (Koronargef\"a{\ss}e)
	bei der es zu einer Verengung der Gef\"a{\ss}e kommt.
...
\subsection[Angina pectoris]{Angina pectoris}
...
Der Anfall vergeht wieder von selbst ohne bleibende Sch\"aden.}
...
eine Erkrankung der Herzkranzgef\"a{\ss}e, diese werden durch
Ablagerung von Fetten und Kalk gesch\"adigt und eingeengt, dadurch kann
...
\begin{itemize}
	...
	\item {\mdseries
	prim\"ar \gEs{nicht sicher von MCI unterscheidbar} }
...
\subsection{Herzinfarkt - Myokardinfarkt (MCI)}

\gDefinition{Verschlu{\ss} eines oder mehrer Herzkranzgef\"a{\ss}e mit
...
\hline
 ...
 &
\\\hline
{\mdseries Kammerflimmern}

 &
{\mdseries Reanimation [F07E?]}

 &
\\\hline
{\mdseries Pulslose Ventrikul\"are Tachykardie}
...
{\mdseries Reanimation [F07E?] }
 ...
 &
\\\hline
{\mdseries Asystolie (HF = 0)}

 &
{\mdseries Reanimation  }

 &
\\\hline
{\mdseries Bradykardie (HF {\textless} 60/min)}

 &
 &
\\\hline
{\mdseries Tachykardie (HF {\textgreater}100/min)}

 &
 &
\\\hline
{\mdseries Vorhofflimmern}

 &
{\mdseries regellose Erregung im Vorhof}

{\mdseries oft symptomlos}

 &
{\mdseries Sehr viele Leute haben Vorhofflimmern und leben ganz gut
damit.}

{\mdseries Komplikationen:}

{\mdseries Tachykardie-Anf\"alle}

{\mdseries Thrombenbildung}

{\mdseries deshalb Therapie mit Gerinnungshemmenden
...
\paragraph{Pulslose Ventrikul\"are Tachkardie}
...
\begin{itemize}
    ...
    \item {\mdseries
    ev. kurze Bewu{\ss}tlosigkeit}
    
    \item {\mdseries
    Patient(in) sackt zusammen}
...
\begin{gMassnahmenEnv}
    ...
    \begin{itemize}
        ...
        \item Hospitalisierung  zur Abkl\"arung  unbedingt erforderlich
...
Sch\"aden am K\"orper anrichten kann und im Zuge von pl\"otzlichen
Blutdruckkrisen auch akut Probleme machen kann. 

\begin{itemize}
    \item 
    Chronische Hypertonie: Grenze derzeit bei 140/90
...
\begin{gCaveEnv}
    ...
    EPH-Gestose -- Pr\"aeklampsie - Eklampsie erkl\"art.}!
\end{gCaveEnv}
...
\begin{itemize}
    \item {\mdseries
    Widerstandserh\"ohung (durch Engstellung der Gef\"a{\ss}e)}
    
    \item {\mdseries
    vermehrte Herzarbeit}
    
    \item {\mdseries
    Sympathikusaktivierung, Adrenalin+Cortison (Stre{\ss}hormone) durch
...
\begin{itemize}
    ...
    \begin{itemize}
        \item {\mdseries
        Herzkranzgef\"a{\ss}e ${\rightarrow}$ Infarkt}
        
        \item {\mdseries
        Hirngef\"a{\ss}e ${\rightarrow}$ Schlaganfall}
        
        \item {\mdseries
        Nierengef\"a{\ss}e ${\rightarrow}$ Niereninsuffizienz ${\rightarrow}$
        Dialyse ${\rightarrow}$ typischer KTW-Patient}
        
        \item {\mdseries
        Hauptschlagader ${\rightarrow}$ Aneurysma%
        %
        }
...
\subsection[Hypertensive Krise / Hypertensiver \ Notfall]{Hypertensive
...
\section{Gef\"a{\ss}verschl\"usse in den Extremit\"aten}

{\mdseries
\textbf{\textcolor[rgb]{0.7882353,0.0,0.08627451}{Arteriell}}:  }

{\mdseries
\textbf{\textcolor{blue}{Ven\"os}}:   \index{tVT}\gT{tVT}
(tiefe Venen Thrombose)}

\subsection{Arterieller Gef\"a{\ss}verschlu{\ss}}
{\mdseries
Zuerst chronische Gef\"a{\ss}sch\"adigung:
\index{PaVK}\gT{PaVK} (\index{periphere arterielle
Verschlu{\ss}krankheit}periphere arterielle  Verschlu{\ss}krankheit)}
...
\begin{table}
\tablehead{}\begin{tabular}{|cll|}
\hline
{\mdseries 5 P  (englisch):}
...
\centering 3.\par
 ...
 &
{\mdseries \gZ{Pulsless}}

 &
{\mdseries \gEs{pulslos}}

\\\hline
\centering 4.\par

 &
{\mdseries \gZ{Paresthesia}}

 &
{\mdseries \gEs{gef\"uhllos}}

\\\hline
\centering 5.\par

 &
{\mdseries \gZ{Paralysis}}

 &
{\mdseries \gEs{gel\"ahmt}}
...
\begin{gMassnahmenEnv}
    \subparagraph*{Spezielle Ma{\ss}nahmen}
    
    \begin{itemize}
        \item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
        Lagerung: Extremit\"at h\"angen lassen, weich und warm lagern}
...
\begin{itemize}
    ...
    \item {\mdseries
    Lange Resien ohne Bewegung: \index{Economy class
...
\item 
Schwellung (einseitig, anderes Bein auch ansehen zum Vergleich!)

\item {\mdseries
Dunkel-bl\"auliche (livide ) Verf\"arbung}
...
\begin{itemize}
\item {\mdseries
Abschie{\ss}en des Thrombus ${\rightarrow}$
\gEs{Lungenembolie} (s.
...
\begin{gMassnahmenEnv}
    ...
    \begin{itemize}
        \item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
        Lagerung:  liegend, Bein hoch!}
        
        \item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
        Bewegungsverbot: Pat. nicht mehr gehen lassen  (Emboliegefahr!)}
        
    \end{itemize}
\end{gMassnahmenEnv}

\nopagebreak\chapter{Respiratorische / Pulmologische  Notf\"alle}
\subparagraph*{
...
Fremdk\"orper/-s\"afte (Magensaft, Erbrochenes, Bolus) gelangt in die
unteren Atemwege
...
\begin{itemize}
    ...
    \item {\mdseries
    bewu{\ss}tseinseingeschr\"ankte Personen}
    
    \item {\mdseries
    Z.n. Bienenstich bei Allergiker (Kehldeckel\"odem)}
...
\begin{itemize}
    ...
    \item {\mdseries
    in/exspiratorisches Pfeifen (Stridor)}
...
\begin{gMassnahmenEnv}
    ...
    \begin{itemize}
        ...
        \item 
        Schlag zwischen Schulterbl\"atter
...
\begin{itemize}
    \item {\mdseries Zyanose}
    
    \item {\mdseries Status asthmaticus}
    
    \item {\mdseries Panik (${\rightarrow}$ Tachykardie)}
...
\begin{figure}[h]
    \includegraphics[width=10cm]{./images/asthma-paramedic.jpg}
    \caption{Patientin mit einem akuten Asthmaanfall, sitzend auf einer Treppe. 
    Man beachte wie sie sich hinten mit den Armen aufstützt. Die Erstmaßnahmen bei 
...
\begin{gMassnahmenEnv}
    ...
    \begin{itemize}
        ...
        \item
        $O_2$ \footnote{Achtung: In seltenen Fällen
    ...
    \begin{itemize}
        \item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
        Beruhigen, voratmen (Lippenbremse)}
        
        \item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
        Sprays, die Patient ev. bei sich hat d\"urfen nicht mehr genommen
        werden.}
    \end{itemize}
...
\begin{itemize}
    \item {\mdseries Tiefe (Bein-)Venenthrombose}
    
    \item {\mdseries Immobilisation (Gips, lange Reise)}
    
    \item {\mdseries Herz: Bei Rhythmusst\"orungen}
    
    \item {\mdseries Tumorpatienten}
...
\begin{itemize}
    \item {\mdseries
    eher atemabh\"angige Schmerzen (Atemstopp)}
...
\begin{itemize}
    ...
    \item {\mdseries
    Atemfrequenz und Herzschlag ${\uparrow}$}
...
\begin{itemize}
    \item {\mdseries
    Bein wie bei tiefer Beinvenenthrombose:  einseitg geschwollen,
    \"uberw\"armt, rot/rot-bl\"aulich verf\"arbt, schmerzhaft}
    
    \begin{center}
\begin{minipage}{5.976cm}
{\mdseries
\gH{${\leftarrow}$ wenn der Embolus aus dem Bein
kommt}}

\end{minipage}
    \end{center}
    \item {\mdseries
    evt. gestaute Halsvenen}
    
    \begin{center}
        \begin{minipage}{6.726cm}
{\mdseries
\gH{${\leftarrow}$ Blut staut zur\"uck}}
...
\begin{itemize}
    \item {\mdseries
    \gEs{Lange Reise}, Flug, Auto, Bahn {\dots}}
...
\begin{gMassnahmenEnv}
    ...
    \begin{itemize}
        \item {\color[rgb]{0.0,0.0,0.5019608}
        Lagerung: Oberk\"orper hoch, \gE{wenn m\"oglich beine
        herabh\"angen lassen}}
...
Es kommt h\"aufig vor das diese Patienten \gEs{im
...
\section{Lungenentzündung --- \gT{Pneumonie}}
...
\chapter{Neurologische Notf\"alle}
Erkrankungen, Notfälle und sonstige Störungen die das Nervensystem betreffen. Neurologische St\"orungen gehen oft mit einer St\"orung des Bewusstseins
...
\begin{description}
    ...
    \item 
    [Vergiftungen] können fast alles machen, und neurologische Symptome erst recht
    
    \item 
    [Sch\"adel-Hirn-Trauma] Abkz. 'SHT'; 
    
    \item 
    [Stoffwechselstörungen] welche Einfluß auf das Nervensystem nehmen, z.B. Zuckerentgleisungen
    
    \item 
    [Infektionen] können das Nervensystem beeinflussen, z.B. Verwirrtheit bei Fieber
    
    \item 
    [Alter] beeinflusst auch das Nervensystem, im Rahmen einer Demenz kommt es z.B. zum Abbau der Denkleistung
    
    \item 
    [Krampfanf\"alle] können vom zentralen Nervensystem ausgehen
    
    \item 
    [Erkrankeungen des St\"utzapparates] Aufgrund der räumlichen Nähe zum Stütz- und Bewegungsapparates kann das Nervensystem in Mitleidenschaft gezogen werden, z.B. bei Bandscheibenvorfällen
...
\begin{description}
    ...
    \item[>>Trockener<< Insult] Verschlu{\ss} eines Hirngef\"a{\ss}es mit anschlie{\ss}endem
    ...
    \item 
    Sonderform \index{TIA}TIA: \index{Transitorisch -- Isch\"amische
...
\begin{itemize}
\item 
BZ ${\downarrow}$, ${\uparrow}$ (${\rightarrow}$ Bei neurologischen
Symptomen immer messen!)
...
\begin{gMassnahmenEnv}
    ...
    \begin{itemize}
        \item
        Standardma{\ss}nahmen bei vital bedrohten Patienten
        
        
        \begin{itemize}
            \item
            Lagerung: \gE{leicht erh\"ohter Oberk\"orper},
            
            \item
            $O_2$ 10~l, bei Bedarf bis zu 15~l
            
            \item
            ·~Notarzt, ·~Reanimationsbereitschaft, ·~Vitalwerte \& Monitoring
            
        \end{itemize}
        
        \item
        \gEs{Neurocheck} inkl. \gEs{BZ-Messung} (DD!)
...
{\mdseries = eitrige Entz\"undung der Hirnh\"aute}

{\mdseries ansteckende Form:}

{\mdseries Meningokokken-Meningitis ${\rightarrow}$ hoch ansteckend}

\paragraph*{ Symptome:}

\begin{itemize}
    \item {\mdseries Kopfschmerzen, Lichtscheu}
    
    \item {\mdseries Erbrechen, \"Ubelkeit}
    
    \item {\mdseries Meningismus :}
    
\end{itemize}
\begin{itemize}
    \item {\mdseries Fieber}
    
    \item {\mdseries Nackensteifigkeit}
    
\end{itemize}
\begin{itemize}
    \item {\mdseries Ausschlag (Exanthem )}
    
\end{itemize}

\marginlabel{
\begin{figure}[h]
    \includegraphics[width=5cm]{./images/meningitis-kind-waterhouse.png}
    %[Warning: Image ignored] [width=6.696cm,height=3.813cm]{AASdev20090228-img86.png}
...
oder chronischen Erkrankungen des Gehirns. Dabei entladenden sich unkontrolliert Nervenzell-Gruppen.
im  Gehirn.
...
\begin{itemize}
\item {\mdseries
fokal - petit mal -- Anfall}

\item {\mdseries
generalisiert grand mal - Anfall }
...
\begin{description}
    ...
    \item[Hirnblutung]
    \item[Sauerstoffmangel] z.B. Isch\"amie aufgrund eines Gefäßverschlusses
...
\paragraph{'Petit mal'-Anfall -- Fokaler Anfall}

\begin{itemize}
    
    \item {\mdseries
    D\"ammerzustand (Absence )}
    
    \item {\mdseries
    Dauer: meist nur Sekunden}
    
    \item {\mdseries
    k\"onnen sich ev. zu grand mal-Anf\"allen  ausweiten}
...
\begin{itemize}
    ...
    \item
    zuerst kompletter Tonusverlust
    
    \item
    Niederst\"urzen (Zungenbi{\ss})
    
    \item
    Tonus ${\uparrow}$, unkontrollierte Zuckungen
    ...
    \item {\mdseries
    nach Krampfphase Erholungsschlaf}
    
    \item {\mdseries
    ev. sogar tiefe Bewu{\ss}tlosigkeit}
    
\end{itemize}

Für den Anfall selbst besteht Amnesie! ${\rightarrow}$ Patient
...
\begin{itemize}
\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
Patient vor Verletzungen sch\"utzen}

\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
M\"obel etc. entfernen oder polstern}

\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
NICHT festhalten -- aber sichern, Eigenschutz beachten!}

\marginpar{
\textbf{Sichern}: Patient darf nicht von der Trage oder aus dem Bett
...
\begin{itemize}
\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
Krampf bei Eintreffen, }

\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
{\textgreater} 2 Anf\"alle in 24 Stunden, }
...
\begin{itemize}
\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
nach Anfall BAK-Schema, Atemwege freihalten}

\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
stabile Seitenlage  (Erholungsschlaf wie  Bewu{\ss}tlosigkeit)}
...
\begin{itemize}
\item {\mdseries
Anf\"alle {\textgreater} 15 Minuten oder}

\item {\mdseries
wiederholte Anf\"alle in kurzem Intervall}
...
\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
neurologische Notf\"alle -- Epilepsie}
...
\begin{itemize}
\item {\mdseries
erstmaliges Auftreten eines Krampfanfalls}

\item {\mdseries
Status epilepticus}

\item {\mdseries
ABKL\"ARUNG  der Ursache in diesen  F\"allen wichtig!}
...
\begin{itemize}
\item {\mdseries
90\% psychogen! (typisch: pubertierende  M\"adchen)}
...
\item {\mdseries
Kr\"ampfe (Gesichtsmuskulatur),  Pf\"otchenstellung}
...
\end{itemize}
\chapter{Metabolische St\"orungen (Stoffwechselst\"orungen)}
{\mdseries
Die relevanteste Stoffwechselst\"orung im Rettungsdienst ist der
\index{Diabetes mellitus}\gT{Diabetes mellitus}. Dieser
stellt eine St\"orung des Kohlehydrat-(zucker-)stoffwechsels dar.
...
\begin{description}
\item[\gT{Hyp}\gT{o}\gT{glyk\"amie}] ... Unterzucker

\item[\gT{Hyp}\gT{er}\gT{glyk\"amie}] ... {\quotedblbase}\"Uberzucker{\textquotedblleft}
...
Zwei St\"orungen sind möglich:

\begin{enumerate}
    \item Es wird zu wenig Insulin vorhanden.
    
    \item Der K\"orper hat einen gesteigerten Bedarf an Insulin weil er schon 
...
\begin{description}
    ...
    insuline dependent)} ... keine Insulinproduktion des K\"orpers, der Patient muss
    ...
    (schlechte Ern\"ahrung), folglich zu viel Insulin, K\"orper gew\"ohnt
    ...
    sp\"ater ${\beta}$-Zellen ersch\"opft
    
    \begin{itemize}
        \item {\mdseries
        sp\"ate Manifestation: {\textgreater}35 Jahre}
...
\begin{itemize}
    \item {\mdseries
    Gef\"a{\ss}sch\"aden durch Verkalkung}
    
    \begin{itemize}
        \item {\mdseries
        Gef\"a{\ss}verschl\"usse (kleine und gro{\ss}e Gef\"a{\ss}e)}
        ...
        werden.}
        \item {\mdseries
        \textbf{Herz}: Die Herzkranzgef\"a{\ss}e (Koronar\-arterien) sind ebenso
        betroffen. Diabetiker sind Risikopatienten f\"ur
        Herz-Kreislauf-Erkrankungen wie zB Herz\-infarkt.}
        \item {\mdseries
        \textbf{Hirn}: Wie beim Herzen kommt es zu Gef\"a{\ss}sch\"aden, daher
        ist das Risiko f\"ur Schlag\"anf\"alle erh\"oht.}\item
        \item {\mdseries
        \textbf{Niere}: Die sehr kleinen Gef\"a{\ss}e der Niere werde
        gesch\"adigt, im weiteren Verlauf stellt die Niere ihre Arbeit ein
    ...
    \end{itemize}
    \item {\mdseries
    Nervensch\"aden \gZ{(periphere Polyneuropathie )}:
    Gef\"uhlslosigkeit vor allem in den Extremit\"aten, aber auch am
    gesammten K\"orper: Ein Herzinfarkt kann zum Beispiel schmerzlos
    ablaufen!}
    
    \item {\mdseries
    Augensch\"aden -- Erblindung}
...
\begin{figure}
    ...
    \includegraphics[15cm]{./images/diabetes-folgeerkrankungen.png}
    \caption[Die h\"aufigsten Folgeerkrankungen des Diebetikers:
...
\begin{itemize}
    ...
    \item {\mdseries
    Verwirrtheit, Krampfanf\"alle, Bewu{\ss}tlosigkeit}
    
\end{itemize}

Hypoglyk\"amie kann alle neurologischen  St\"orungen
aus\-l\"osen/imitieren! Bei jeder  neurologischen Symptomatik  (v.a. Bewu{\ss}tseinsst\"orungen)
an  Hypoglyk\"amie denken!

\gFazit{${\rightarrow}$ BZ-Messung bei jeder neurologischen St\"orung. }
...
\section{Das Akute Abdomen --- Alarmzeichen mit Bretthartem Bauch}
...
\gT{Akutes Abdomen}: Zustand mit plötzlichen, stark schmerzhaften Bauchschmerzen und brettharten Bauch, es sind viele Ursachen  m\"oglich!
...
\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
n\"uchtern lassen (in Hinblick auf m\"oglicherweise bevorstehende
Operation, nichts essen oder trinken lassen)}

\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
Hospitalisierung: ad Chirurgie, bei Kindern ${\rightarrow}$ Kinder, bei
Frauen evt. Gyn\"akologie oder Chirurgie mit Gyn im Haus (SMZ-O, Rudi,
Wili, etc.)}
...
{\mdseries
\index{Ileus}\gT{Ileus}  (vollst\"andig)}

{\mdseries
\index{Subileus}\gT{Subileus}  (unvollst\"andig)}
...
\item {\mdseries
keine (paralytisch ) oder spritzende  (mechanisch ) Darmger\"ausche}
...
\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
unertr\"agliche Schmerzen ={\textgreater} Notarzt}
...
\begin{itemize}
\item {\mdseries
L\"ahmung (Querschnittl\"ahmung)}

\item {\mdseries
Schlie{\ss}muskel-Krampf}

\item {\mdseries
Verlegung der Harnr\"ohre}
...
\chapter{Schwangerschaft und geburtshilfliche Notf\"alle}
{\mdseries\itshape
...
\"uberlebensf\"ahig (und ggfs. reanimationsplflichtig).}
...
\\\hline
\subparagraph*{ Er\"offnungsphase}

 &
{\mdseries Er\"offnungswehen}

{\mdseries Geb\"armutterhals (Cervix) verk\"urzt sich,  Muttermund
\"offnet sich}
...
{\mdseries Muttermund vollst\"andig er\"offnet}
...
{\mdseries Kopf geboren ${\rightarrow}$ K\"orper folgt schnell nach
...
\begin{itemize}
\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
Allgemeine Ma{\ss}nahmen bei lebensbedrohlichen Zust\"anden}
...
vermindert und es kann zu einem \gEs{pl\"otzlichen
...
rechts der K\"orpermitte verl\"auft. }
...
\begin{itemize}
\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
Linksseitenlage (Hohlvene verl\"auft eher rechts)}
...
\end{enumerate}
{\mdseries
Synonym: \index{Pr\"aeklampsie}\gT{Pr\"aeklampsie}}
...
\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
Becken erh\"oht lagern (Schwerkraft verz\"ogert  Geburt)}
...
\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
Evt. Druck mit beiden F\"austen oberhalb  Schambein ${\rightarrow}$
...
\end{itemize}
\chapter{P\"adiatrie - Kinderheilkunde}
{\mdseries\itshape
Michael Withofner, Dr. med. univ.}
...
\item {\mdseries
Kind w\"ahrend Transport am Besten eng bei  Vertrauensperson belassen }
...
{\mdseries Kehlkopf steht h\"oher, ist verkippt}
...
\end{itemize}
\\\hline
\subparagraph*{ Pulstasten beim S\"augling:}
...
\\\hline
\subparagraph*{ Wasser-, Elektrolyt- und W\"armehaushalt}

 &
{\mdseries Kinder haben im Verh\"altnis zu ihrem  K\"orpergewicht eine
gr\"o{\ss}ere K\"orperoberfl\"ache  als Erwachsene!}

{\mdseries h\"oherer Wasseranteil}

{\mdseries Austrocknung und Unterk\"uhlung schneller  m\"oglich!!!}
...
\begin{itemize}
\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
Schlag zwischen die Schulterbl\"atter tangential  (Kopf tief)}

\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
bei gr\"o{\ss}eren Kindern auch Heimlich-Maneuvre}
...
{\mdseries
{\quotedblbase}\index{pl\"otzlicher
Kindstod}\gT{pl\"otzlicher Kindstod}{\textquotedblleft}}
...
\item {\mdseries
Gelegenheitskr\"ampfe:}

\item {\mdseries
Einfache Fieberkr\"ampfe}

\item {\mdseries
Komplizierte Fieberkr\"ampfe}
...
Anstalt, ausreichend \"arztlich behandelt oder betreut werden kann.}
...
Anstalt gebracht werden, wenn ein im \textbf{\"offentlichen
Sanit\"atsdienst stehender Arzt} oder ein \textbf{Polizeiarzt} sie
...
{\mdseries
{\S} 9. (1) Die \textbf{Organe des \"offentlichen Sicherheitsdienstes}
...
\"offentlichen Sicherheitsdienstes die betroffene Person in eine
...
l\"anger angehalten werden.}

{\mdseries
(2) \textbf{Bei Gefahr im Verzug} k\"onnen die \textbf{Organe des
\"offentlichen Sicherheitsdienstes} die betroffene Person \textbf{auch
...
\textbf{erforderlichenfalls den }\textbf{\"ortlichen Rettungsdienst
beizuziehen}.}
...
(urs\"achlich!), (${\rightarrow}$~{\S}3~Abs.~1)

\item \gEs{Eigen-}  und/oder
\gEs{Fremdgef\"ahrdung},
(${\rightarrow}$~{\S}3~Abs.~1)

\item \gEs{Keine weniger einschr\"ankende
M\"oglichkeit} zur Abwendung der Gef\"ahrdung,
...
welcher \"uber die Polizei verst\"andigt wird. 
...
\end{itemize}
\chapter{Systemische Hitzesch\"aden}
{\mdseries
...
\gT{Hitzeersch\"opfung} , \gT{Hitzschlag}
...
\begin{itemize}
\item {\mdseries
\textbf{W\"armestau}  (zugef\"uhrte W\"arme  kurzfristig {\textgreater}
abgegebene)}

\item {\mdseries
Erweiterung der Blutgef\"a{\ss}e in der Haut  (maximal)}
...
\begin{itemize}
\item {\mdseries
W\"armeaufnahme {\textgreater}  W\"armeabgabe}
...
\item {\mdseries
Haut zun\"achst trocken, rot und hei{\ss},  sp\"ater grau-blau, Kopf
hochrot}

\item {\mdseries
stark  erh\"ohte  K\"orpertemperatur (bis  43{\textdegree}C m\"oglich
={\textgreater} LEBENSGEFAHR !!!)}

\item {\mdseries
Bewusstseinsst\"orung, Bewusstlosigkeit}
...
\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
K\"uhlung von au{\ss}en (F\"acher, mit Eisw\"urfeln abreiben etc.)}
...
\item {\mdseries
Kann kombiniert mit anderen Hitzesch\"aden auftreten}

\item {\mdseries
Gesichts- u. Kopfhaut hochrot u. hei{\ss}, restlicher K\"orper k\"uhl}

\item {\mdseries
Abgeschlagenheit, heftiger Kopfschmerz, Schwindel}

\item {\mdseries
Unruhe,Verwirrtheitszust\"ande, Brechreiz}

\item {\mdseries
Nackensteifigkeit}

\item {\mdseries
Schwere F\"alle: Krampfanf\"alle, Bewusstlosigkeit}
...
\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
K\"uhlung von au{\ss}en (F\"acher, mit Eisw\"urfeln abreiben, kalte
Umschl\"age auf die Stirn etc.)}
...
K\"altezittern, Herzfrequenz steigt ({\textgreater}100
Schl\"age/Minute), schnelle Atmung, Schmerzen}

\item {\mdseries
\gT{Ersch\"opfungsphase}:
34{\textdegree}-30{\textdegree}C, Bewusstseinstr\"ubung, K\"altestarre,
Herzfrequenz sinkt wieder ({\textless}60/min), zu langsame Atmung,
keine Schmerzen mehr}

\item {\mdseries
\gT{K\"altenarkose}: 30{\textdegree}-27{\textdegree}C,
...
\begin{itemize}
\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
nur soviel wie UNBEDINGT n\"otig ist  bewegen (BERGUNGSTOD)}
...
{\mdseries
\gT{Vergiftung} bedeutet eine (meist  dosisabh\"angige)
organische  Funktionsbeeintr\"achtigung / Sch\"adigung  des Organismus
...
\item \gEs{Wie}?
(inhalativ/oral/perkutan/intraven\"os etc.)

\item \gEs{Wieviel}? (Dosisabsch\"atzung)
...
\begin{itemize}
\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
Sofortige Sp\"ulung mit Wasser / Ringerl\"osung}
...
\subparagraph*{
Bei Gasunf\"allen hat der \gEs{Selbstschutz} Vorrang.
Oft ist die Bergung nur mit \gEs{schwerem
Atemschutz} m\"oglich ${\rightarrow}$ FEUERWEHR!}
...
\part{[RS VII] Traumatologische Notf\"alle}

\part{[RS II] Hygiene }

\part{[RS XI] Katastrophen, Gro{\ss}schadensereignisse,
Gefahrengutunfall}

\part{Fallbeispiele und Arbeitsaufgaben}
...
\part{ILS: Arzneimittel}
\part{ILS: Minimalinvasive T\"atigkeiten und Behandlung}
\part{Glossar --- Begriffserkl\"arungen}
{\mdseries
...
\begin{description}
\item[Gesch\"aftsf\"uhrer:] Berhnard Lehner, Ing. Alexander Prischl
