...
\Definition{Als Trauma  bezeichnet man eine
...
(Traumacheck) wird unter \See{topic:traumacheck} erklärt. 
...
\begin{table}[H]
\TagBugfix{Bilder Fremdkörper}\Captionof{table}{Bilderserie:
...
\Captionof{figure}{\AuthNotesPicLegalNotOk{}{}Stich mit einem Küchenmesser. Das Messer verbleibt im Körper {\ldots}~
...
\Parallel{
Eine Einteilung bezieht sich auf die \E{physikalische
Verletzungsursache}:
...
Eine weitere Unterteilung kann nach der \E{Tiefe der
...
ist meist nicht ersichtlich, \Z{evt. Ausschuss größer als
Einschuss}
\\\addlinespace
\noindent\Es{(Hämatom)} 
&
...
\Captionof{figure}{\AuthNotesPicLegalNotOk{}{}Escharatomie. Durch die Ringförmige Verbrennung am Thorax zieht sich die
...
\begin{table}[H]
\TagBugfix{Bilder Frakturen}\Captionof{table}{Bilderserie:
\SlideHeading{Frakturen}}
...
\begin{itemize}
  ...
  \item Versuchen Sie \E{nicht}, ausgetretene Strukturen
...
\begin{itemize}
  ...
  \item \Es{Starke Blutung:} Bei großflächigen Wunden oder Verletzung wichtiger Blutgefäße kann es zu starken Blutungen und infolge dessen zu einem Volumenmangelschock kommen. Blutstillung und Schockbekämpfung sind die wichtigsten Maßnahmen.
  \item \Es{Starke Schmerzen:} Treten im Zusammenhang mit einer Verletzung starke Schmerzen auf, muss ein Notarzt für eine Schmerztherapie gerufen werden.
...
\MarginNo{\newline\includegraphics[width=\linewidth]{./images/teaser/imgp0722.jpg}}\Definition{Gewalteinwirkung
...
(Vgl. Kap. Anatomie, \See{topic:zns}.)
...
\Fazit{Das Leitsymptom eines jeden SHT ist die
\Es{Bewusstseinsstörung}.}
...
\Married{Kommt es zu einer Druckerhöhung (z.B. aufgrund
...
\Married{Aufgrund des Unfalls kommt es zu einer plötzlichen Durchtrennung des Rückenmarks, wodurch die Gefäßregulation (und somit der Gefäßtonus) versagt. Somit sinkt der Blutdruck rasch ab, es kommt zu einer lebensbedrohlichen Kreislaufstörung.}{
\begin{itemize}
...
\Cave{Sie sollten niemals aufgrund der äußeren Verletzungen auf die Schwere des Thoraxtraumas schließen, da schwere innere Verletzungen auftreten können!}
...
(Vgl. Kap. Anatomie, \See{topic:atemmechanik} und
\See{topic:pleura})
...
Pneumothorax nennt man \T{Spontanpneumothorax} und tritt
...
\Married{Von einer \Es{Serienrippenfraktur} spricht man,
...
\begin{itemize}
  ...
  \item \Es{Herzkontusion}: Hier kommt es durch Quetschungen der Herzmuskulatur zu Sickerblutungen. Bei Sternumfrakturen mit Herzrhythmusstörungen sollte man an eine Herzkontusion denken.
  \item \Es{Herzbeuteltamponade}: Es kommt zu einer Einblutung in den Herzbeutel, wodurch das Herz komprimiert wird und sich nicht mehr mit Blut füllen kann. Leitsymptome sind gestaute Halsvenen und schwerer Schockzustand (kardiogener Schock).
\end{itemize}
...
inneren Blutungen versteckt sein können.
    ...
    \includegraphics[width=\linewidth]{./images/trauma/bauchtrauma-offenes-01.jpg} \Captionof{figure}{\AuthNotesPicLegalOk{}{}Offenes Bauchtrauma mit Austritt von Darmschlingen.
    \SourcePicture{Hauer}}
}
...
\Married{Die Milz ist ein teuflisches Organ. Sie besitzt rund um
...
\Married{Die Leber ist auch gut durchblutet und kann im Falle einer Verletzung große Probleme machen. Ursachen sind meist stumpfe Verletzungen, z.B. ein Lenkradaufprall oder eine Sicherheitsgurtkompression}{
\begin{itemize}
...
\Fazit{Die Arbeitsdiagnose Polytrauma kann auch ausschließlich aufgrund des Unfallmechanismus und der Vitalparameter gestellt werden. Patient gilt als polytraumatisiert bis zum Beweis des Gegenteils! Jedes Polytrauma ist notarztpflichtig.}
...
\begin{itemize}
  ...
  \item \Es{Wärmeerhalt}: Der Wärmeerhalt hat massiven Einfluß auf das
  Überleben!
...
Bei der Verstauchung (\T{Distorsion}) handelt es sich um eine Gelenksverletzung, bei welcher ein Knochen durch eine stumpfe Gewalteinwirkung kurz verschoben oder verdreht wird. Im Gegensatz zur Verrenkung springt der Knochen aber von selbst wieder in seine ursprüngliche Stellung im Gelenk zurück.
...
Die Verrenkung (\T{Luxation}) ist eine Gelenksverletzung, bei der -- im Gegensatz zur Verstauchung -- der verschobene oder verdrehte Knochen nicht von selbst in das Gelenk zurück gesprungen ist. Die betroffene Extremität kann daher nicht mehr bewegt werden. Bei einer Luxation dürfen keine eigenständigen Einrenkversuche unternommen werden!
...
Sanitäter mittels Stiefelgriff (siehe \See{topic:vacuumbeinschiene-anwendung})
...
Röntgendarstellung. \SourcePicture{Hauer}\AuthNotesPicLegalOk{}{}}
\end{center}
\end{figure}
...
\begin{itemize}
  ...
  besteht! Wenn möglklich soll eine \E{Wundfolie} (z.B.
...
\Definition{Amputation bezeichnet einen kompletten oder inkompletten Abriss bzw. Abtrennung (von Teilen) einer Extremität oder eines anderen Körperteils, sodass deren Durchblutung ganz oder teilweise aufgehoben ist. Den abgetrennten Körperteil nennt man Amputat. \cite{BoehmerTaschRett6}}
...
unter \See{topic:veraetzung-intoxikation} besprochen. 
...
Einteilung erfolgt in drei \Es{Stadien} (siehe Tab. \ref{tab:Erfrierungen}), diese haben am Notfallort keine
...
\Layout{2}{Allgemeines zum elektrischen Strom und seine
...
\begin{description}
  ...
  \end{itemize}
  \item \Es{Elektrische Stromstärke:} Der elektrische 
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \See{topic:gefahrenbereich-strom}
    \item Sicherheitsabstand
    (\See{topic:gefahrenbereich-strom})
    \item Schrittspannung und Spannungskegel
    beachten \See{topic:gefahrenbereich-strom}
