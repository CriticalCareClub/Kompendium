...
aufzubereiten, dass er \underbar{unter Normalbedingungen}
...
\E{vorhergehende Reinigung} des Gegenstandes.
}{
\begin{itemize}
  \item Keimreduktion
...
Um den Schmutz überall nicht zu verteilen wird \EE{von außen
...
\begin{compactdesc}
  \item [Untersuchungshandschuhe] \ldots\ sind obligat und
  ...
  \item [Schürzen] Einweg-Plastikschürzen bieten Schutz
  gegen Kontamination der Kleidung im Rumpf- und
  Beinbereich.
  \item [Schutzbrillen] \ldots\ sollen in allen Situationen
  getragen werden in denen mit einem Spritzen von
  schädlichen bzw. infektiösen Flüssigkeiten des Patienten
  gerechnet werden muss.
  \item [Atemmasken] \ldots\ kommen zum Schutz vor
  luftübertragbaren Krankheiten zum Einsatz. Je nach Keim
  werden unterschiedliche Schutzklassen empfohlen. Man
  unterschiedet die klassische \EE{Mund-Nasen-Maske}
  (\enquote{OP-Maske}) und Feinpartikel-Filtermasken nach
  \EE{FFP} Klassen \VonBis{1}{3}.
