...
dabei sichergestellt ist, daß sie sich gegenseitig
verstehen.
...
Der Begriff Diagnose wird dauernd verwendet, dennoch ist er noch einfach zu
erklären. Eine Diagnose gibt einem Zustand eine Bezeichnung, das heisst einem
Beschwerdebild wird ein definiertes Kranheitsbild zugeordnet. 
...
aber unsicher. Um die Unsicherheit dieser Diagnosen anzuzeigen ahben sich
verscheidene Begriffe eingebürgert: 

\begin{description}
    \item[Verdachtsdiagnose] Die Diagnose ist unsicher, man hat zwar den
    Verdacht in Richtung eines bestimmten Krankheitsbildes, andere ähnliche
    ...
    \item[Arbeitsdiagnose] Arbeitsdiagnosen sind Verdachtsdiagnosen bei denen
    eine endgültige Klärung nicht möglich ist. Für die Behandlung wird die
    wahrscheinlichste Diagnose ausgewählt um \emph{``am Patienten arbeiten zu
    können''.}
    \item[Notfalldiagnose] Eine Notfalldiagnose  ist im Prinzip eine
    Arbeitsdiagnose. Der Patient ist dabei in einem Zustand bei dem
    ...
    Die Ursachen dafür sind erstmal unwichtig, die entsprechende Behandlung der
    Notfalldiagnose muß sofort begonnen werden.
...
\begin{description}
    \item[Kompensierte Herzinsuffizienz] Der K\"orper hat noch
    genug Reserven, kann gegensteuern und kommt mit der
    eingeschränkten Leistung aus. 
    \item[Dekompensierte Herzinsuffizienz] Der K\"orper kommt aufgrund des
    Fortschreitens der Erkrankung oder aufgrund eines erh\"ohten
...
Symptome sind weniger wichtig als pl\"otzlich auftretende
...
\gDefinition{Pl\"otzliches Engegef\"uhl in der Brust meist mit
...
des Herzens f\"ur diese Arbeit nicht mehr reicht und ein
...
\paragraph{Kammerflimmern}

\gEs{Reanimationspflichtig}. NICHT verwechseln mit
Vorhofflimmern! Die elektrische Erregung im Herzen ist ungerichtet, als w\"urden alle Autos 
...
\begin{itemize}
    ...
    s.\,\ref{topic:tia} S.\,\pageref{topic:tia})
\end{itemize}
...
\textit{Patient hat \"uberhaupt keine Beschwerden?} Warum hat
...
oft ein anderes Luftnot-Empfinden. Diese Patienten sidn
HochrisikoPatienten und machen auch bei der $O_2$-Gabe
Probleme! $O_2$ nur bis max. 95\%
!\cite{Olschewski2009}\gA{\footnote{Vortrag Univ-Prof.Dr.
Horst Olschewski, 5. AGN-Kongreß 2009; Notfall Rettungsmed (2009) 12:322}}}

% TODO Vortrag Univ-Prof.Dr. Horst Olschewski, 5. AGN-Kongreß 2009; Notfall Rettungsmed (2009) 12:322
...
\end{itemize}
 ...
 \captionof{figure}{\gAuthNotesPicLegalNotOk{img81}{}???.
...
\item {\mdseries
KEIN $O_2$  verabreichen! \gEs{Kontraindikation!}}
...
\begin{description}
    ...
    \item [Erkrankungen des St\"utzapparates] Aufgrund der räumlichen Nähe zum Stütz- und Bewegungsapparates kann das Nervensystem in Mitleidenschaft gezogen werden, z.B. bei Bandscheibenvorfällen
\end{description}
...
\gDefinition{Eitrige Entz\"undung der Hirnhäute aufgrund
...
\index{Status!epilepticus}Der Status Epilepticus ist eine lebensgefährliche\marginline{\gEs{LEBENSGEFAHR!}} Steigerung des
...
Unter Ischialgie (Lumboischialgie) versteht man Schmerzen im
Versorgungsbereich des des Ischias-Nerv, welche u. a. durch eine Entzündung oder
durch Reizung bzw. Kompression des Nerv oder seiner
Wurzeln verursacht werden können. Ursachen können eine Irritation bzw. Kompression im Bereich der Lendenwirbeln L4 oder L5 bzw. des Kreuzbeinwirbels S1,
ein Bandscheibenvorfall, Rückenmarktumore, sowie andere Erkrankungen der
Wirbelsäule, aber auch ein Unfall sein. 

Symptome sind Schmerzen in der
...
der Bauchspeicheldr\"use (Pankreas) produziert. Es ist für
den Zuckerstoffwechsel wichtig. Es sorgt daf\"ur dass Zucker
...
gegessen). ${\rightarrow}$  Spritz/E{\ss}abstand
er\-fra\-gen.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        Gefä{\ss}schäden, daher ist das Risiko f\"ur
...
\begin{description}
    ...
    \item [BZ messen!] Zur Diagnosestellung \gE{vor} und und \gE{nach} Zuckergabe
...
\gEs{brettharten Bauch}. Es sind viele Ursachen  möglich!}
...
des rund alle 28 Tage stattfindenden Reifens mindestens einer Eizelle, dem
Eisprung und den damit im Zusammenhang stehenden Veränderungen der
Gebährmutterschleimhaut. Der Zyklus ist im Kapitel Nanatomie und Physiologie
...
\gEs{Schwangerschaftsdauer} Die normale Schwangersachft dauert 40 Wochen +- 2
Wochen. Das sind rund neun Kalendermonate oder 10 Mondmonate
(Lunarmonate\footnote{\gZ{lat. luna: Mond.}}). Der Fortschritt der
Schwangerschaft wird in Schwangerschaftswochen, Abk. SSW, angegeben. Von einer \gT{Frühgeburt} spricht man wenn die Geburt zwischen der
26. und bis zur vollendeten 37. SSW erfolgt. Ab der 42. SSW spricht man von einer
Übertragung, und die Geburt wird künstlich eingeleitet.

\gEs{Schwangerschaftsverlauf} Nach dem Eisprung ist die Eizelle 8-10\,Std.
befruchtungsfähig. Sie benötigt für die Wanderung Eierstock -- Eileteiter --
Uterus (Gebärmutter) 4-6 Tage. Wurde die Eizelle befruchtet, kommte es zur
Einnistung in der Gebärmutterschleimhaut. Dort bildet sich Mutterkuchen
(\gT{Plazenta}) welcher die Frucht mit Nährstoffen und $O_2$ versorgt. Weiters bildet sich um die Frucht eine Fruchtblase, welche mit
Fruchtwasser gefüllt ist und sie so ideal vor äusseren Erschütterungen schützt.
...
spüren. Ab der 24.
SSW gilt das Kind als überlebensfähig und ggfs. bei einer Frühgeburt als
...
flachen, runden Öffnung (Muttermund). Spätestens am Ende der Eröffnungsphase
kommt es zum Platzen der Fruchtblase (Blasensprung), welches den Abgang von
Fruchtwasser und eventuell die Absonderung von blutigen Sekret mit sich führt. Ab
...
Senkwehen mehr, sondern richtige Presswehen. Das Hinterhaupt des Kindes wird nun
zwischen den Schamlippen  sichtbar. 
}{
...
Mutter geschützt\footnote{Durch das Pressen wird nciht nur das Kind geboren
...
rutschig!). Nun wird das Neugeborenen mittles Schleimabsuager abgesaugt und kann
für das Abnabeln vorbereitet werden. Dabei wird eine Handbreit von Kind die erste
Nabelklemme gesetzt. Dann wird die Nabelschnurr Richtung Mutter ausgestreift und
wieder eine Handbreit entfernt die zweite Klemme gesetzt. Zwischen den beiden
Klemmen wird die Nabelschnur durchtrennt. Zu guter letzt wird das Neugeborene
...
sind. Es kommt zur Geburt der Placenta (Mutterkuchen). Die Gefahr hiebei ist,
dass es zu strakem Blutverlust bei der Mutter kommen kann. Die Placenta ist zur
Kontrolle der Vollständigkeit in Krankenhaus mit zunehmen.
}{
...
\begin{itemize}
	\item Die wievielte Geburt ist das? Bei Mehrgebärenden ist der Geburtsverlauf oft rascher.
	\item In welchen Abstand sind die Wehen? Je nachdem ist erkennbar in welcher Geburtsphase sich die Gebärende befindet
	\item Gab es schon einen Blasensprung? Wenn ja darf die Gebärende nur mehr liegend transportiert werden! Gefahr: Nabelschnurrvorfall!
	\item Gab es während der Schwangerschft komplikationen?
	\item Mutterkindpass verlangen. Darin stehen mit unter wichtige Informationen über die Schwangerschaft bzw. die  Geburt.
	\item In welchem Krankenhaus ist die Geburt angemeldet? Sofern nicht im Mutterkind vermerkt.
\end{itemize}

\gEs{Der Transport:}

Befindet sich die Mutter noch in der Eröffnungsphase wird ein schnellmöglichster,
...
angetroffen haben, wird am Trnasportschein dokumentiert "stehend angetroffen;
liegend transportiert". 

Um die Gefahr eines Vena-cava-Kompressionssyndrom (s.
\ref{topic:vena-cava-syndrom} zu vermeiden, sollte die
Patientin liegend in leichter Linkseitenlage transportiert werden. Befindet
sich die Mutter schon in der Austreibungsphase und der Kindskopf ist zwischen den Schamlippen sichtbar, ist der weitere Transport zu
...
\begin{itemize} 
    ...
    \begin{itemize}
        ...
        \item Nur wenn Patientenzustand kritsich ist
        Notarzt anchfoerdern, sonst direkt
        Hospitalisieren, Abt. f. Gynäkologie und
        Geburtshilfe.
    \end{itemize}
\end{itemize}} 

\gCave{Achtung! Ab der 24. SSW ist die theoretische
Lebensfähigkeit erreicht, das Kind muß reanimiert werden!}
...
eines akuten Abdomens und eine hypovolämischen Schocks. 
}{
\begin{itemize}
...
Blutung kommen. Es besteht \gEs{Lebensgefahr} f\"ur Mutter und Kind durch
...
\begin{enumerate}
    \item \gEs{E}dema (\"Odeme)
    \item \gEs{P}roteinuria (Proteinurie = Eiwei{\ss} im Harn)
...
dazukommen, dass sich die Placenta \emph{vor} den Geburtskanal bildet. Dies ist
...
Frauenarzt bekannt und erfragt bzw. im Mutter-Kind-Pass nachgelesen werden.
...
Kommt meistens nur nach vorangegangenen Kaiserschnitt vor. Somit nicht bei
...
\gMassnahmen{
    ...
    \begin{itemize}
        \item absaugen
        \item Fu{\ss}sohlen und R\"ucken klopfen, reiben
        \item $O_2$
...
\subparagraph*{Altersgruppen bei Kinder}
...
Austrocknung und Unterk\"uhlung schneller  möglich!
\\\bottomrule
\end{tabulary}
\end{center}
...
Bei Kindernotfällen können als zusätzlicher Stressfaktor für den Rettungsdienst stark emotional betroffene Angehörige sein. Daher gilt es besonders ruhig und gezielt zu handeln. Sie sollten sich der Verantwortung bewusst sein, es geht um die Rettung eines jungen Menschen mit langer Lebenserwartung. 
...
\begin{itemize}
    ...
    \item feuchte Luft einatmen lassen (ev. Fenster öffnen; feuchte Tücher im Raum aufhängen; Dusche im Badezimmer aufdrehen)
...
Dabei handelt es sich um eine bakterielle Entz\"undung und daraus  folgende Schwellung des
...
\begin{itemize}
    \item Notarztindikation
    \item $O_2$ -gabe, Luftbefeuchtung
...
\begin{itemize}
	\item Reanimation
	\item Eltern beruhigen; Ihnen das Gef\"uhl geben,  da{\ss} sie alles f\"ur
...
\gDefinition{\gEs{Ertrinken}: Tod in den ersten 24 h nach Unfall: Ertrinken}
...
\gMassnahmen{
    \paragraph{Ma{\ss}nahmen bei Verdacht auf Kindesmißhandlung}
...
Psyhiatrie ist es auch besonders schwierig, zwischen
...
Man trifft oft auch nicht klar umrissene Krankheitsbilder,
und auch deren jeweiliger Krankheitswert ist oft umstritten,
bzw. sehr vom einzelnen Patienten abhängig.

Im Rettungsdienst begegnet man jedoch meist
Extremsituationen, sodaß sich diese Überlegungen gar nicht
stellen. In der Gesellschaft (repräsentiert durch die
Gesetzgebung) gibt es die Übreinkunft, daß bestimmte
Krankheitsbilder bzw. Symptome als behandölungswürdig bzw.
sogar behandlungspflichtig angesehen werden. Als
behandlungspflichtig werden zum Beipisle die Eigen. und
Fremdgefährdung aufgrund einer psychiatrischen Erkrankung
angesehen, hier hat der Gesetzgeber Maßnahmen nach dem
Unterbringungsgesetz (UbG) vorgesehen. Auch der geistige
Verfall (z.B. Im Rahmen einer (Alters-)Demenz kann
rechtliche Schritte nach sich ziehen, im Sinne einer
Besachwaltung. Es ist hierbei jedoch festzuhalten, daß auch
ein psychiatrischer Patient -- genauso wie jeder andere
...
Bestimmungen (Unterbringungsgesetz) Maßnahmen durchzuführen
sein, so sind diese von der \gEs{Exekutive}
(Polizei) vorzunehmen. 
...
spezieller Krankheitsbilder und Symptome notwendig. 
...
Gespräches erzählt die Patienten, daß sie schon seit
emhreren Jahren arbeitsunfähig ist, da sie an
Halluzinationen leidet. Jeden aml wenn sie das Badezimmer
betritt sieht sie eine ihr unbekannte Frau beim Fenster
hinein schauen, obwohl sie im zweiten Stock wohnt. Sie
erzählt dass sie wisse das es nicht real sein kann,
...
erlebt, auch wenn sie vielleicht sogar wissen daß sie nciht
real sein können. 
...
sein, auch hier gib tes verschiedene Abstufungen. 
...
Geheimndienstes Mossad, welcher im Auftrag der CIA geheime
...
kann haben sie vom Gebühren-Info-Service eienn Agenten
vorbeigeschickt, welcher nun gewaltsam die Gedanken des
Patienten wegnehmen wollte."'}
\end{quotation}

\gMassnahmen{
\paragrapah{Umgang mit Patienten mit Wahnvorstellungen}
...
\subsubsection{Der \emph{stuporöse} Patient}




\subsubsection{Der \emph{eigen- oder fremdgefährdende}
Patient}
...
Vergiftungen sind eine interessante Sache: Einerseits kann
sich ein ansich nützlicher Stoff in eine totbringende Waffe
verwandeln wenn er im Übermaß zugeführt wird, andererseits
können Vergiftung in Abhängigkeit vom ursächlichen Stoff so
ziemlich alle Erscheinungsformen darbieten. 
...
\begin{enumerate}
    ...
    \item Quellenforschung (Mistk\"ubel
    durchsuchen)
...
\begin{itemize}
    ...
    (\ref{vergiftung-allgemein-massnahmen})
...
unter dem Namen \gE{"`Ecstcasy"' (XTC, E, X)}, ist eine der
...
\begin{enumerate}
    \item 
    \item Patienten bergen, aber nur wenn es der
    Eigenschutz zulässt.
    \item $O_"$-Berieselung mit Maske ist in keinem Fall
...
vor allem bei schlecht gewarteten Gasheizungen udn
...
\begin{itemize}
    ...
    \item Tachykardie
    \item Schwindel, Kopfschmerz, \"Ubelkeit, Erbrechen
...
\gZ{Inhalatives Korticoid (Pulmicort{\textregistered}) 
durch NFS / Notarzt}
...
Selbstschutz uund Expert

\subsection{Vergiftungen mit Säuren und Laugen}

\subsection{Vergiftungen mit Insektiziden}

\subsection{Vergiftungen durch giftige Tiere}
...
\paragraph{Symptome bei Ingestion}
...
\begin{itemize}
\item Sofortige Sp\"ulung mit Wasser / Ringerlösung
...
\paragraph{Schaumbildner (Wasch-/Putzmittel)}
\subparagraph{Symptome:}
