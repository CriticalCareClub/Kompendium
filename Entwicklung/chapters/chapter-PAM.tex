...
Merkfähigkeit \cite{Pschy259}.} \Z{Die \enquote{wahre} Definition von Bewusstsein ist seit
...
den \EE{Bewusstseinsgrad}(quantitativ;
\E{Wieviel} Bewusstsein ist vorhanden? Klar, somnolent, soporös, komatös) und
...
\Layout{0}{Vom Gurgeln und Schnarchen}{%
Unter Punkt
...
\Layout{0}{Take a deep breath \ldots}{%
\index{Atemprobe}
...
{\begin{itemize}
  ...
  \item[\eye] Tachy-/Bradypnoe (AF <\,8\PerMin* oder >\,30\PerMin*)
  \item[\eye] Atemtiefe (flach, tief, Schnappatmung)
  \item[\eye] Path. Atemmuster
  \item[\eye] Paradoxe, fehlende Atmung
  \item[\eye] Sauerstoffsättigung
  \item[\eye] \Z{Auskultation: Belüftung, feuchte
  Rasselgaräusche, Spastik}
  \item[\eye] Heimsauerstoff, Atemhilfen
  \item[\eye] \FullPrettyRef{tab:atmung-symptome}
\end{itemize}
}
{}
{}
...
nicht immer akut von Bedeutung. Viele Patienten sind
...
\Layout{0}{E -- Wenn es nicht so klar ist: Raum für Instinkt und Erfahrung}{%
...
{
\begin{itemize}
  \item[\eye] Sonst. Hinweise auf vitale Bedrohung
  \item[\eye] Anamnese (z.\,B.
  $\geq$ 2 Krämpfe/24\Hour*)
  \item[\eye] Gefährliche Kombinationen von
  Erkankungen
  \item[\eye]Prellmarken
  \item[\eye] \ldots 
\end{itemize}
}
{}
...
\begin{itemize}
  ...
  \item Vorgezogene Strategie- und Zielentscheidung bei absolut zeitkritischen Patienten.
\end{itemize}
...
Zielentscheidung bei absolut zeitkritischen Patienten}
{%
\label{topic:sonderfall-absolut-zeitkritische-patienten}
\index{Vorgezogene Strategie- und Zielentscheidung 
...
Strategie- und Zielentscheidung} (Spital,
