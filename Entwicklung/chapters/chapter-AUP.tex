...
werden, hier am Besipiel Schmerzen\footnote{Diese
Fragenabfolge wird in Anlehnung auf die Benennung der
EKG-Zacken als \T{OPQRST} bezeichnet: Onset
(Geschehnisse zum Zeitpunkt des Auftretens), Provocation or
Palliation (Was macht es besser bzw. sschlechter), Quality (Schmerzqualität,
...
\begin{itemize}
  ...
  \Speech{\enquote{WWas haben Sie gemacht als es begonnen
  hat?}}
