...
\gTempPicMissing{EINFÜGEN BILD AMBU von PP}
...
PEEP-Ventils eine notärztliche Maßnahme ist, muss bei der
Anwendung durch eines Sanitäters immer auf Null stehen.
Mögliche Einstellungen für das PEEP-Ventil sind 5 bzw. 10 cm
Wassersäule.

\gTempPicMissing{EINFÜGEN BILD PEEP VENTIL AUS PP}
...
Mund-Rachen-Raum entfernt werden. Es gibt unterschiedliche
Modelle von Absaugpumpen. Grundsätzlich wird nach der
Betriebsart unterschieden zwischen \gEs{elektrische
...
\gTempPicMissing{EINFÜGEN BILD AUBSAUGTECHNIK VON PP}

\section{Transporttechniken bzw. -geräte}

Als Sanitäter hat man während dem ganzen Transport die
...
Der Patient ist immer anzuschnallen. Bei den Transport über
Stiegen hat der Patient immer Talwärts zu blicken.

\gTempPicMissing{EINFÜGEN BILD VON PP}
...
von liegende Patienten wo der Einsatz einer Krankentrage
...
\gTempPicMissing{EINFÜGEN BILD UMLAGERN VON PP}
...
vielfältig. Es reicht vom sicheren Transport in unwegsamen
...
Wirbelsäule verwendet. Es kann natürlich aber für das Retten
alle sitzenden Patienten aus einer Gefahrenzone verwendet
werden.

\gTempPicMissing{EINFÜGEN BILD PP}

\section{Schienungsmaterial}

\subsection{Halswirbelsäule - Schiene}

Dient zum Ruhigstellen der Halswirbelsäule. 

\gTempPicMissing{BILD EINFÜGEN AUS PP}

\subsection{SAM-Splint}

Dient am idealsten für das Ruhigstellen von Extremitäten
Verletzungen mit abnormer Stellung. Da es sich leicht an den
Arm an formen lässt. Es muss jedoch noch mit einer Mullbinde
oder einem Dreiecktuch fixiert werden.

\gTempPicMissing{EINFÜGEN BILDER SAMSPILNT VON PP}

\subsection{Vakuumbeinschiene}

Dient zum Ruhigstellen von Verletzungen zwischen Knie und Zehen.

\gTempPicMissing{Vakuum-Beinschiene: BILD WÄRE NETT}
