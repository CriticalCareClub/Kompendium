...
beschrieben. Dazu kommt i.\,d.\,R. ein \EE{Druckgefühl} am Brustkorb, \emph{\enquote{als würde jemand auf dem Brustkorb stehen.}} \EE{Todesangst und Vernichtungsgefühl} sind häufig.
...
\begin{itemize}
  ...
  der Gefäße mit \enquote{Versacken} des Blutes in den Beinen)
...
Es gibt jedoch auch typische \enquote{Kollaps-Situationen}: Ein
...
Wenn es wirklich nur ein Zufallsbefund ist (\enquote{Gesundheitstage},
...
\end{itemize}
 ...
 (\E{Achtung}: Obwohl es
\enquote{\emph{Verschluss}krankheit} heißt, sind die Gefäße nicht komplett
...
empfinden (\E{\enquote{Ameisenlaufen}}). Tabelle \ref{tab:5p}
listet die klassischen Symptome auf \Z{(die \emph{\enquote{5
englischen P's}})}.
...
(\enquote{Raucherhusten}). Es kommt dabei zu einer gesteigerten
...
Überblähung der Lungenbläschen und zu einer \enquote{Faß-förmigen}
...
\enquote{Karriere} hinter sich. \SourcePicture{Hirtler}}
\end{center}
\end{figure}
...
\EE{Bewusstseinsstörungen} (\enquote{\ce{CO2}-Narkose}) und einen
...
auf. Rauchen sowie die Einnahme der \enquote{Pille} erhöhen
ebenso das Risiko.}
}{
\begin{itemize}
  \item Immobilisation
...
% \Layout{2}{Wann ist die Diagnose \emph{\enquote{Lungenembolie}}
%  wahrscheinlich?}
% {%
...
\enquote{um{\textquotesingle}s Eck} 
...
\begin{itemize}
  \item Subjektiv: \emph{\enquote{Atemnot}}, Sp\ce{O2} von 100\PC* 
  \item Tiefe, schnelle Atmung
  \item Schwindel, Bewusstseinsstörungen
  \item Kribbeln in den Fingern
  \item Tonische Krämpfe (\enquote{Pfötchenstellung})
\end{itemize}
}{}{}{}
...
\Definition{\enquote{Austrocknung}: Es besteht ein hochgradiges Defizit von Flüssigkeit im Körper.}
