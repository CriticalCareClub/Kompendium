...
Nach ihrer Form und ihrer Bewegungsfreiheit bzw. der Anzahl der Bewegungsachsen werden verschiedene *Gelenksformen* unterschieden, vgl. {numref}`TAB-Gelenksformen`:

:::{list-table} Gelenksformen
:header-rows: 1
:name: TAB-Gelenksformen
...
- **Einfaches Gelenk** [(Art. simplex)]{.deep}: Ein einfaches Gelenk verbindet,
...
- **Zusammengesetzte Gelenk** [(Art. composita)]{.deep}:
  ...
  1. Oberarmknochen–Elle (*Scharniergelenk*)
  2. Oberarmknochen–Speiche (*Kugelgelenk*)
  3. Elle–Speiche (*Zapfengelenk*)

- **Komplexes Gelenk** [(Art. complexa)]{.deep}:
