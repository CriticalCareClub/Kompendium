...
\Table
[]%1 Float
{Atemfrequenz und -zugvolumen im
Altersvergleich}%2 Titel
{Richtwerte: Die genauen Normalwerte sind abhängig von den Faktoren
Alter, Geschlecht und Größe.}%3 Beschreibung
{}%4 Label/Hook
{}%5 Quelle
{}%6 Lizenz
{%
...
\begin{itemize}
    \item \StepHeading{Normbereich}: zwischen \RRmmHg{90}{60} und
    \RRmmHg{140}{90} \index{Blutdruck!Normbereich}
    \item \StepHeading{\T{Hypotonie}}: RR {\textless}~\RRmmHg{90}{60}
    \index{Hypotonie}
    \item \StepHeading{\T{Hypertonie}}: RR
