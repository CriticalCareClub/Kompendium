...
entspricht einem Atemminutenvolumen (\T{AMV}) von  6\,--\,8\LPerMin*.  Für eine
...
Die Symptome eine Schocks sind abhängig vom jeweiligen
...
\begin{labeling}[~:]{Volumenmm}
  ...
  vorhanden im Gefäßsystem vorhanden
  \begin{itemize}
...
Auslöser eines Schocks wird auch zum kardiogenen Schock gerechnet, da es durch die
...
\Layout{0}{\TxSymptome}{%
Typisch ist ein Blutdruckabfall. Durch die den
...
Durchlässigkeit der Gefäße \Z{(Gefäßpermeabilität)}
Das Blut versackt und es kommt zu einem  Plasmaverlust in
den Zwischengewebsraum \Z{(Interstitium)}; der Blutdruck
fällt massiv ab!
}{%
\begin{itemize}
  \item Überschießende
