...
:Spezialitäten:
    Amiodaron 50 mg / mL Amp. à 3 mL
    (z. B. Sedacoron™);
    orale Präparationen verfügbar.
...
:⚙ Pharmakodynamik:
    **Klasse III-Antiarrhythmikum**:
    Verlängert durch *Blockade der K⁺-Kanäle* im Herzen
    die Dauer des kardialen Aktionspotentials in atrialen und ventrikulären Myozyten.
    Dadurch kommt es zu einer *Verlängerung der Refraktärzeit* des Aktionspotentials und zu einer Suppression der Ektopien und Re- Entry-Arrhythmien ebenso wie zu einer
    *Verlängerung des QTc-Intervalls*.

    Außerdem blockt Amiodaron auch die Na+-Herzströme (Klasse-I-Effekt) und die Ca2+-Ströme im Herzen (Klasse-IV-Effekt).
...
:Indikation(en):
    ...
    -   ⚠ fraglich ⚔ Re-Entry-AV-Tachykardie,
...
:℞ Dosierungen:
    ...
    -   Kinder und Jugendliche: Off-label.
        Für Neugeborene i.v. kontraindiziert (Benzylalkohol), sonst intravenös:
...
:Spezielle Patientengruppen:
    ...
    -   Schwangerschaft, Stillzeit:
        Amiodaron und Benzylalkohol treten über Plazenta und in Muttermilch über. Strenge Indikationsstellung!
    -   Kinder: Off-label.
...
:Kontraindikation(en):
    ...
    -   Sinusbradykardie,
        ...
        Relativ: Überleitungsstörungen (hochgradiger AV-Block, bifaszikulärer oder trifaszikulärer Block) oder Sick-Sinus-Syndrome
...
:Pharmakokinetik:
    Langsame Eliminationsrate und ausgeprägte Gewebeaffinität,
    lange Halbwertzeit, die je nach Patient zwischen 20 und 100 Tagen liegen kann.

    **Elimination**: Der Hauptausscheidungsweg ist über die Leber und die Galle,
    10% der Substanz wird über die Nieren ausgeschieden.
    Wegen der niedrigen renalen Ausscheidung kann Patienten mit Niereninsuffizienz die übliche Dosis verabreicht werden.

    **Wirkung**:Nach Injektion Wirkmaximum nach 15 Minuten,
    danach Verteilung im Gewebe, insbesonders Fettgewebe,
    und schnelle Abnahme der Plasmakonzentration innerhalb von 4 Stunden.
    Der Steady State wird innerhalb eines Zeitraumes von einem bis zu mehreren Monaten erreicht,
    daher Sättigungsdosis empfohlen,
    um eine schnelle Sättigung des Gewebes zu erreichen.
    Abhängig von der Sättigungsdosis können die therapeutischen
    Effekte zwischen einigen Tagen und bis zu zwei Wochen liegen.
...
:Wechselwirkungen:
    ...
    -   QT-Intervall verlängernde Medikamente, insb.: Warfarin, Digoxin, Phenytoin und alle Arzneimittel, die das QT-Intervall verlängern.
    -   Betablocker, Kalziumkanalblocker (Verapamil, Diltiazem), Laxantien, die eine Hypokaliämie verursachen können.
    -   Erhöhte Flecainid-Plasmaspiegel.
    -   Erhöhung der Digoxin-Konzentration im Plasma
...
:Intoxikation:
    ...
    Hypotonie, Herzblock und Torsade-de-pointes, Schilddrüsenüberfunktion

    Symptomatische Beahndlung (ICU, Volumstherapie, Vasopressoren, Alpha- oder Beta-Adrenergika, Pacing).
