...
\gDefinition{Beendigung einer Schwangerschaft vor der 26. SSW.} \gACh{GAB:
...
einigen Tagen ausgestoßen wird.
...
\gMassnahmen{
    \begin{itemize}
        \item \gTxMassVitBes
        \begin{itemize}
            \item Lagerung: sterlie Vorlage und Lagerung nach Fritsch
            \item falls erforderlich Schocktherapie
            \item je nach Zustand: NA nachfordern oder direkt ins KH ad Gyn
        \end{itemize}
    \end{itemize}
}
