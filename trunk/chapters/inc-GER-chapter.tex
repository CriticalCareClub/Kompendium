...
\label{topic:sauerstoff}\label{topic:o2}\index{Sauerstoff}\index{\ce{O2}}
...
einzuplanen, in der Flasche sollten min. \gEs{5 bar
...
\ce{O2}-Berieselungseinheit mit einem Flow von 15\gLMin{} angeschlossen werden um die höchstmögliche \ce{O2}-Konzentration der Einatemluft zu
erreichen. 
}{
\begin{center}
\includegraphics[width=\linewidth]{./images/geraete/ger-ambu.jpg}
\gCaptionof{figure}{Beatmungsbeutel mit Reservoir,
...
\begin{itemize}
    \item \gMarginBugfix{Medumat}Hersteller: Fa. Weinmann, Produktfamilie:
    \gT{Medumat} (Notfall-Beatmungsgerät)
    \begin{itemize}
        \item Medumat Compact
        \item Medumat Standard
        \item Medumat Standard a
    \end{itemize}
    \item Hersteller: Fa. Weinmann, Produktfamilie: \gT{Medumat}
    (Intensivtransport-Be\-atmungs\-ge\-rät)
    \begin{itemize}
        \item Medumat Transport
    \end{itemize}
\end{itemize}
}
\end{minipage}
...
\gCaptionof{figure}[Bedienfelder Berieselungseinheit \gE{Modul Oxygen} (li.) und
Beatmungsgerät \gE{Medumat Standard} (re.).]{Bedienfelder Berieselungseinheit \gE{Modul Oxygen} (li.)
und Beatmungsgerät \gE{Medumat Standard} (re.).
...
\gE{Medumat Standard (re.):} \gZ{Air-Mix-Schalter, Ein-Ausschalter, Stellräder
...
\begin{itemize}
    \item \gMarginBugfix{Accuvac}Hersteller: Fa. Weinmann, Produktfamilie:
    \gT{Accuvac}
    \begin{itemize}
        \item Accuvac Rescue (rote Deckplate)
        \item Accuvac Basic (grüne Deckplate)
    \end{itemize}
    \item Hersteller: Fa. Laerdal
    \begin{itemize}
        \item Laerdal Suction Unit (auslaufend)
    \end{itemize}
    \item Handabsaugpumpe
    \begin{itemize}
        \item RES-Q-VAC
    \end{itemize}
    \item Orosauger, div. Hersteller
\end{itemize}
...
Patienten. Außerdem sollte das Stiegenhaus oder die zurück
...
\begin{center}
    ...
    \gCaptionof{figure}{\gAuthNotesPicLegalNotOk{GER-tragsessel.jpg}{}Tragsessel}
\end{center}
}
...
Wirbelsäulen-schonend. Ist eine Immobilisation der
...
\paragraph{Krankentrage mit Fahrgestell}~
...
\end{itemize}
    ...
    \gCaptionof{figure}{\gAuthNotesPicLegalNotOk{GER-fahrtrage-stollenwerk.jpg}{}Krankentrage mit Fahrgestell.}
    \end{center}
}
...
\paragraph{Umlagern von Patienten}
    ...
    \gCaptionof{figure}{\gAuthNotesPicLegalNotOk{GER-umlagern.png}{}\label{fig:rollstuhl-umgang}\label{fig:umlagern}}
    \end{center}
...
\vspace{3em}
    \gCaptionof{figure}{\gAuthNotesPicLegalNotOk{GER-schaufeltrage.jpg}{}Eine Schaufeltrage}
}{
    \begin{center}
...
\vspace{3em}
    \gCaptionof{figure}{Ein Rettungskorsett.
...
\vspace{3em}
    ...
    \gCaptionof{figure}{\gAuthNotesPicLegalNotOk{GER-stiffneck.jpg}{}HWS-Schiene} 
    }{
    \begin{center}
...
\gCaptionof{figure}{\gAuthNotesPicLegalNotOk{GER-samsplint.png}{}Sam-Splint}
}{
    \begin{center}   
...
\vspace{3em}
    ...
    \gCaptionof{figure}{\gAuthNotesPicLegalOk{}{}Vakuumbeinschiene.}
}{
    \begin{center}
...
\vspace{3em}
    ...
    \gCaptionof{figure}{Vakuummatratze.}
} 
{
    \begin{center}
...
Sauerstoffsättigung (Sp\ce{O2}) des arteriellen Blutes. Dies
...
\begin{itemize}
	\item \ce{CO}-Vergiftungen; Das Gerät verwechselt \ce{O2} und
	\ce{CO}-Moleküle und zeigt einen falschen hohen Wert.
