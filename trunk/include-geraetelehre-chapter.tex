...
Im Rettungsdienst sollte jede Beatmung mit einem Beatmungsbeutel oder einem Beatmungsgerät durchgeführt werden. Wenn an dem Beatmungsbeutel dann noch ein Verbindungsschlauch an eine Sauerstoffflasche mit einem Flow von 15 l/min angeschlossen wird und zusätzlich auch noch ein Reservoir angesteckt ist,  wird mit der größt möglichen Reserve an Sauerstoff beatmet.
