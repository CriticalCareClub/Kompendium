...
\Layout{0}{\TxSymptome}
{%
Der Patient berichtet berichtet über Schwindel, evtl. ist er
...
\Co{Unterschätze nie die Schwere eines Asthmaanfalles!
Gefährlich sind besonders die "`ruhigen"', wenig klagenden
Patienten. Asthma-Patienten haben oft ein anderes
Luftnot-Empfinden. Diese Patienten sind HochrisikoPatienten
und machen auch bei der \ce{O2}-Gabe Probleme! \ce{O2} nur
...
\begin{itemize}
  ...
  Ausatmen lassen. Ebenso eignet sich eine \EE{\ce{O2}-Maske mit Reservoir}. 
  Handschuh)
