...
Die Niere filtert ausscheidungspflichtige Substanzen aus dem Blut. Daher ist
auch sie äußerst gut durchblutet und reagiert sehr empfindlich auf einen
Blutdruckabfall. Aus diesem Grund kann auch sie den Blutdruck regulieren.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \EE{Vergrößert sich im Alter} und
            kann die \EE{Harnröhre abdrücken}, es kommt
...
\begin{itemize}
    \item innen:
    \begin{itemize}
        \item \EE{Eierstöcke} \Z{(Ovar)}: Reifung der
        Eizellen \index{Eierstöcke}
        \item \EE{Eileiter} \Z{(Tuben)}: Transport des
        reifen Eis in Richtung Gebärmutter \index{Eileiter}
        \item \EE{Gebärmutter} \index{Gebärmutter}
...
\index{Eileiter\-schwanger\-schaft}\EE{Eileiter\-schwanger\-schaft}
