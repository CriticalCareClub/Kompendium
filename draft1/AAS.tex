...
\documentclass[ngerman,a4paper,fontsize=9pt,BCOR=1.5cm,headings=big,draft=yes]{scrbook}
...
\marginline{Reanimation}Der Herz-Kreislaufstillstand wird unter
\gAuthNotes{Verweis???} besprochen.
...
\begin{captionbeside}{Endstadium einer bakteriellen Meningitis. Die
...
innerhalb weniger Stunden zu erwarten.\newline \emph{Quelle: unbekannt}}\end{captionbeside}
\end{figure}
...
\subparagraph*{Schwangerschaft -- Verlauf}
