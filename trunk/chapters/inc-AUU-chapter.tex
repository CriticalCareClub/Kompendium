...
\begin{itemize}
    \item \Es{Lokalisation}: \emph{"`Wo sind die
    Schmerzen?"'}
    \item \Es{Zeitdauer/Beginn}: \emph{"`Seit wann haben Sie
    ...
    \item
    \Es{Qualität}: \emph{"`Wie ist der Schmerz? Bohrend,
    stechend, ziehend, krampfartig, auf- und
    abschwellend?"'}
    \item \Es{Ausstrahlung}: \emph{"`Strahlt der Schmerz
    irgendwohin aus?"'} 
    \item \Es{Provokation}: \emph{"`Was
    macht den Schmerz besser oder schlechter?"'} 
    \item \Es{Stärke}: \emph{"`Wie stark ist der
