...
Nach der Überblickgewinnung, muss der Ersthelfer den Notfallort für den
Patienten aber vor allem für sich selbst vor Gefahren absichern. Dabei gilt
Selbstschutz geht vor Fremdschutz. Bei seinem Vorgehen muss der Ersthelfer
...
\subsubsection{Gefahrenbereiche un d Hinweise für den Ersthelfer}
...
\subparagraph{Gefahren im Verkehr}

\begin{itemize}
    \item Eine der größten Gefahren für den Ersthelfer ist, das
    Überfahrenwerden von nachkommenden Fahrzeugen.
    ...
    \item Wenn bei einem Unfall auf einer Eisenbahnkreuzung der herannahende
    Zug gewarnt werden soll, bedenke
\end{itemize}
...
Eine Besonderheit stellen Gefahrenguttransporter dar
(\gSee{topic:gefahrengutunfall}). 
\gZ{Sie sind -- wie es ihr Name schon sagt -- mit gefährlichen Gütern versehen und tragen
...
\gZ{Selbstschutz geht vor Fremdschutz!}
...
\item  Ortsgebiet:  0-50\,m\footnote{
