...
Wesenltichen aus drei Säulen zusammen:
...
\begin{itemize}
  ...
  auch von nicht ausgebildeten Laienhelfern verwendet
  werden.
  ...
  Die manuelle Defibrillation wird im Kapitel \CO{[AED]},
...
\begin{itemize}
    ...
    \item \II{Pulslose Ventrikuläre Tachykardie}: Zu
    schneller Herzrhythmus, das Herz kann sich nicht ausreciehnd
    füllen, daher fehtl die Pumpleistung
  \end{itemize}
  \item \EE{Nicht-schockbare Rhythmen}
  \begin{itemize}
    \item \II{Asystolie}: Keine Elektrische Aktivität
    \item \II{Pulslose elektrische Aktivität} (PEA): Das
...
Wenn keine Atmung vorhanden ist wird mit der
...
Herzdruckmassgae zügig angebracht. Sobald die Elektroden angebracht wurden
und das Gerät einsatzbereit ist wird mit der Analyse
begonnen. Empfiehlt das Gerät einen Schock wird dieser
abgegeben. Die Herzdruckmassage muss -- egal ob ein
Schock empfohlen wurde oder nicht -- unverzüglich
wiederaufgenommen werden.

Alle 5 HDM-/Beatmungs-zyklen wird eine neuerliche Analyse
durchgeführt.
