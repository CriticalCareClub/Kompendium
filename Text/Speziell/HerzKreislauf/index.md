...
{term}`🗎 Wells 2000` P. S. Wells et al.:
**Derivation of a Simple Clinical Model to Categorize Patients Probability of Pulmonary Embolism: Increasing the Models Utility with the Simplired d-Dimer.**
*Thromb Haemost* 2000:83 (3), 416—20.
(Derivation of a simple clinical model to categorize patients probability of pulmonary embolism: increasing the models utility with the SimpliRED D-dimer.)

{term}`🗎 Sachsenweger 2003`  (Augenheilkunde)

{term}`🗎 Zeiler 2001`  (Grundlagen der Klinischen Neurologie 1. Grundlagen für Human- und Zahnmediziner)

{term}`🗎 RueckerBildatlas 1`  (Bildatlas Notfall- und Rettungsmedizin)
