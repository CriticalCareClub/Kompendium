...
\begin{itemize}
    ...
    \item \EE{"`Monogam"'}: Stellen Sie immer nur \E{eine
    Frage gleichzeitig}.
    \item \EE{Information}: Informieren Sie den Patient über
    Ihr Vorgehen!
    ...
    den Patient einreden! Der Patient sollte wenn möglich nur
...
\begin{itemize}
  ...
  \item \EE{Suggestivfragen} sind "`böse"': Hier
...
\noindent Dieses Abfrageschema kann im hektischen
