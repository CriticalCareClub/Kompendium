...
\begin{labeling}[:]{Inkubationszeitx}
  ...
  Erkrankten} (\Speech{\enquote{1 von 5 Erkrankten stirbt}}).
...
% \subsubsection{\enquote{Biologische Arbeitsstoffe}}
% 
...
\begin{itemize}
  \item Vollständige, \enquote{echte} Zellen\,/\,Lebewesen
...
\enquote{\EE{Konkurrenzkampf der Bakterien}} notwendig. Wenn sich verschiedene
...
\Layout{0}{Nachweis}{%
Die Tests haben
üblicherweise ein \E{\enquote{diagnostisches Fenster}}, in
...
Gegenstände als \enquote{Vehikel} fungieren. \E{Hygienisches Arbeiten} und
...
\begin{itemize}
  ...
  gehäuft resistente Keime vor! Der \enquote{Haltegriff in der
  U-Bahn} ist daher nicht mit dem \enquote{Haltegriff im
...
{%
Der \emph{Staphylococcus aureus} ist ein \enquote{Allerweltskeim}, bis zu 50\% der
...
\begin{compactdesc}
  ...
  (\enquote{OP-Maske") und Feinpartikel-Filtermasken nach \EE{FFP}
  Klassen \VonBis{1}{3}.
...
in den Nadelabwurfbehälter (\enquote{Gelbe Box",
\enquote{Kontamed\texttrademark", \enquote{Sharp", \ldots ) zu entsorgen!
