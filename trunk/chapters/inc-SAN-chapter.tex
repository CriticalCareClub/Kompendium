...
\end{quote}
 ...
 Verschlechterung des AZs des Pat. vom Wohnungsachbarn berufen wurde.
...
Regimes im therapeutischen Bereich stabilisiert.
  ...
  Im Einverständnis mit dem Pat. und desen Tochter wurde ein Platz im
...
Ausnahmefällen (COPD) nach dem Sp$O_2$-Wert. Der
...
\begin{center}
\begin{tabulary}{\linewidth}[H]{cp{8em}L}
\toprule
\gTabSub{\gZ{GI}}
&
...
\begin{itemize}
    \item Vitalwerte 
    \item Orientierender Traumacheck: \par Schädel, Thorax,
...
\gTxMassVit}, die sofort zu erfolgen haben. Bei
...
Die HWS-Schiene dient der Stabilisierung der
