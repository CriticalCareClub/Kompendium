\chapter[{[MP1]} Medizinprodukte 1]{[MP1]\\Medizinprodukte 1}
\label{chp:GER}
% \AasRsN{RS~IX}
...
\Es{Beatmungsbeutel} (\prettyref{topic:beatmungsbeutel}) oder \Es{Beatmungsgerät}
durchgeführt. Dabei handelt es sich um eine \E{Überdruckbeatmung}, d.h. es
wird mit Druck Luft in die Atemwege des Patienten gepumpt. (Im Unterschied dazu
...
\TODO{GABS}{2010-mm-dd}{Absaugung, Bild:: Überarbeitung: Bild
verwirrend}
{Absaugung, Bild:: Überarbeitung: Bild verwirrend; 
...
abnormer Stellung. Er lässt sich leicht an den Arm anformen, muss jedoch noch mit einer Mullbinde oder mit Dreiecktücher
fixiert werden. Die Anpassung erfolt an der \E{gesunden} Extremität. 
