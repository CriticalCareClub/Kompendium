...
\subsection{Pyhsiologie der Atmung}
...
{
\begin{itemize}
  \item[\eye] Entgleiste Vitalwerte
...
\Layout{0}{\SAMPLER{S} Symptome und Schmerzen}{%
...
\Layout{0}{\SAMPLER{P} Medikamente}{%
...
\Layout{0}{\SAMPLER{L} Letzte \ldots}{%
...
\Layout{2}{\SAMPLER{E} Ereignisse vor Notfalleintritt}{%
...
\Layout{0}{\SAMPLER{R} Risikofaktoren}{%
