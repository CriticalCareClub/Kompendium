...
\section{\HeadingKeyword{Einsatztaktische} Überlegungen bei 
verunfallten Patienten}
...
\begin{Synopsis}
  \SynopsisItem{Es ist sinnvoll, nach Möglichkeit den Unfallmechanismus 
...
\subsection{Besondere \HeadingKeyword{Unfallmechanismen}}
...
\subsection{\HeadingKeyword{Zusammenfassung}}
...
\section{Verletzungen der Knochen: \HeadingKeyword{Frakturen}}
...
\Table
{Frakturzeichen}%1 Titel
{}%2 Beschreibung
{\label{tab:frakturzeichen}\index{Frakturzeichen}}%3 Label
{}%4 Quelle
{}%5 Lizenz
{%
...
\begin{itemize}
  ...
  welches vor allem aus Fett besteht, 
  kann 
  v.\,a. bei Frakturen langer Röhrenknochen 
  zu Fettembolien führen:
  Kleine Fetttröpfchen gelangen dabei in die
  Blutbahn und können eine Lungenarterie verstopfen,
  dadurch kommt es zu einer Lungenembolie 
  (\FullPrettyRef{topic:lungenembolie}). 
...
\subsection{\HeadingKeyword{Spezielle Knochenbrüche}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Verletzungen der Gelenke: 
\HeadingKeyword{Verrenkung} und \HeadingKeyword{Verstauchung}}


\subsection{\HeadingKeyword{Verstauchung}, Bänderzerrung und 
Bänderriss}
...
\subsection{\HeadingKeyword{Verrenkung}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage % TEMP temp clearpage
\section{Schädel-Hirn-Trauma (\HeadingKeyword{SHT})}
...
\TextSlideTeaser
{\TxBeschreibung{} und Arten}%1 Titel
{%
...
wird. Bei beiden Arten kommt es zu Bewusstseinsstörungen.}%2 Text
{
\begin{compactitem}
  ...
  \end{compactitem}
\end{compactitem}}%3 Slide
{./images/teaser/imgp0722_00500.jpg}%4 Bilddatei
{}%5 Bildtitel
{}%6 Bildbeschreibung
...
\begin{Synopsis}
  \SynopsisItem{Das Leitsymptom des SHT
...
\begin{Danger}
  \item Die Schwere eines \Abk{SHT} lässt sich nur bedingt von
...
{%
\begin{itemize}
  \item \StepHeading{\T[Intervall!luzides]{Luzides Intervall} (lichtes 
  Intervall)}:
  Die
  ...
  \item \StepHeading{Hirndrucksteigerung}:
  Sowohl durch eine \E{Hirnblutung}, 
  als auch durch ein verletzungsbedingtes \E{Anschwellen des Hirngewebes} 
  (\I{Hirnödem}) 
  kann es zu einer Drucksteigerung innerhalb des Schädels
  und zum Auftreten von \I{Hirndruckzeichen} 
  (\FullPrettyRef{topic:hirndruckzeichen}) kommen:
  \begin{itemize}
    \item Übelkeit, Erbrechen
    \item Bewusstseinsstörungen
    \item Bradykardie, Hypertonie (HF\,$\downarrow$, RR\,$\uparrow$)
  ...
  \Ca{Hirnstammeinklemmung}\index{Hirnstammeinklemmung} 
  (\FullPrettyRef{topic:hirnstammeinklemmung}).
  %
  Da sich im Hirnstamm das Atem- und Kreislaufzentrum befindet besteht dabei 
  akute \Ca{Lebensgefahr}!
  \item \StepHeading{HWS-Verletzung}:
  Oft kommt es bei einer einem \Abk{SHT} zu einer
  Mitverletzung der Halswirbelsäule.
  \item \ABCDE{B} \StepHeading{Atmungsprobleme}: 
  Unregelmäßige oder insuffiziente Atmung u.\,a. aufgrund einer direkten oder 
  indirekten Hirn- bzw. Rückenmarksschädigung
\end{itemize}
}{%
\begin{itemize}
  ...
  \end{itemize}
  \item Hirnblutung 
  \item Hirndrucksteigerung, \Ca{Hirnstammeinklemmung}
  \item \Abk{HWS}-Verletzung
...
\begin{Synopsis}
  \SynopsisItem{Aufgrund des lichten Intervalls können Symptome eines SHT erst 
  Stunden nach der eigentlichen Verletzung auftreten.}
  \SynopsisItem{Bei einem SHT kann es zu einer Hirndrucksteigerung kommen, 
  die in einer akut lebensbedrohlichen Hirnstammeinklemmung enden kann.}
\end{Synopsis}

\begin{Danger}
  \item Das luzide Intervall kann zu einer katastrophalen Fehleinschätzung des 
  Patientenzustandes führen!
  \item Die Hirnstammeinklemmung ist akut lebensbedrohlich!
\end{Danger}

\TextSlidePicture
{Spezielle Diagnostik beim SHT}%1 Titel
...
\begin{itemize}
  ...
  Kopf;
  vgl.
  \FullPrettyProcedureRef{YY14200B}).
...
{Pupillendifferenz}%5 Bildtitel
{Sie ist ein Alarmzeichen: Eine Pupillendifferenz kann ein
wichtiger Hinweis auf einen erhöhten Hirndruck sein!}%6 Bildbeschreibung
{Sebastian Gabriel}%7 Quelle
{MfG}%8 Lizenz
% Vormals \Layout{20}

\begin{Danger}
  \item \EE{Jedes \Abk{SHT} ist im Spital abzuklären!} Es besteht
...
\subsection{\HeadingKeyword{Offenes} SHT}
...
\subsection{\HeadingKeyword{Gedecktes} SHT}
...
\clearpage
\section{Verletzungen der \HeadingKeyword{Wirbelsäule} und des
\HeadingKeyword{Rückenmarks}}
...
\TextSlide{Typische Unfallmechanismen}{
\begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage % TEMP temp clearpage
\section{\HeadingKeyword{Thoraxtrauma}}
...
\begin{Danger}
  \item Man darf niemals aufgrund der äußeren Verletzungen auf
...
diese aufgrund der Gewalteinwirkung ein, ensteht ein
...
\subsection{Beim \HeadingKeyword{Pneumothorax} befindet sich 
Luft im Pleuraspalts}
...
Ein Pneumothorax kann \EE{auch ohne einer Verletzung}
...
{Im Vergleich: 
Kompletter Pneumothorax der rechten Seite 
(auf dem Bild auf der linken Seite). 
Die Lunge ist kollabiert.  
\SourcePicture{Hauer}}
...
\subsection{\HeadingKeyword{Rippenfraktur}, Serienrippenfraktur und 
instabiler Thorax}
...
\TextSlide{{\TxBeschreibung}}
{%
Eine Fraktur einer oder mehrer Rippen ensteht typischerweise durch eine meist 
stumpfe Gewalteinwirkung auf den Thorax.
%
Von einer \T{Serienrippenfraktur} spricht man,
wenn mindestens drei benachbarte Rippen gebrochen sind. 

Häufige Mechnismen sind z.\,B. 
ein Sturz auf den Thorax 
(insbesonders gegen einen Gegenstand oder eine Kante),
Schlägereien (Knüppel!), 
oder Verletzungen durch einen Airbag.

Nach Rippenfrakturen kann es durch spitze Fragmente 
zu einer Lungenfell- oder Lungenverletzung kommen,
die aufgrund einer Blutung 
oder Ateminsuffizienz lebensgefährlich werden kann. 
%
Eine wesentliche Komplikation ist dabei die Entstehung eines
\Ca{Pneumothorax}. 
\Z{Eine Röntgenuntersuchung und Verlaufskontrolle ist daher unbedingt 
erforderlich.}
%
Ebenso kann es zu einer Schädigung der Oberbauchorgane kommen.

}{
\begin{itemize}
  \item Stumpfe Gewalteinwirkung gegen Thorax
  \item Gefahren:
  \begin{itemize}
    \item Pneumothorax
    \item Ateminsuffizienz
    \item Schädigung der Oberbauchorgane
  \end{itemize}
\end{itemize}
}{}{}{}

\begin{Danger}
  \item Der Pneumothorax ist eine gefährliche Komplikation einer Rippenfraktur.
\end{Danger}

\TextSlide{{\TxSymptome}}
{%
Sind die Rippen an verschiedenen Stellen gebrochen 
oder gar zertrümmert, 
werden diese Teile bei der Einatmung nach innen gezogen 
und bei der Ausatmung nach außen gedrückt. 
%
Man bezeichnet dies 
(Brustkorb \E{senkt} sich bei der Einatmung)
als \II[Atmung!paradoxe!bei Serienrippenfraktur]{paradoxe Atmung} 
bei \EE{instabilem Thorax}. 
%
Die Folge ist eine hochgradige Atemnot, 
außerdem treten (z.\,T. heftige) Schmerzen auf, 
die sich bei der Einatmung verstärken. 
%
Rippenbruchstücke können darunter liegende Organe verletzen. 
Es kann zu Lungeneinrissen, 
sowie Leber- und Milz- und Nierenverletzungen 
mit starken \EE{inneren Blutungen} kommen. 
%
Der Blutverlust kann mehrere Liter betragen \cite{LPN3}. 
%
In diesem Fall herrscht höchste \E{Schockgefahr}.
}{
\begin{itemize}
...
\subsection{\HeadingKeyword{Sternumfraktur}}
\label{topic:sternumfraktur}\index{Sternumfraktur}
...
tasten. \cite{LPN3} Es kann zu Begleitverletzungen kommen.
}
{%
\begin{itemize}
  \item Aufprall des Brustkorbes
  \item Schmerzen
\end{itemize}
}
...
\EE{Pneumothorax} oder einer \EE{Herzverletzung} bzw. einer \I{Herzbeuteltamponade} denken.
Bei der \T{Herbeuteltamponade} kommt es durch Eintritt von Flüssigkeit (z.\,B. Blut) in den Herzbeutel zu einer Einschränkung der Füllung und Bewegung des Herzens.
}
{%
\begin{itemize}
  \item Pneumothorax
...
\subsection{Verletzung des \HeadingKeyword{Herzens} und der 
\HeadingKeyword{großen Gefäße}}
...
\clearpage % TEMP temp clearpage
\section{\HeadingKeyword{Bauch-} und \HeadingKeyword{Beckentrauma}}
\index{Bauchtrauma}
...
\TableWide
{Offenes und geschlossenes Bauchtrauma}%1 Titel
{}%2 Beschreibung
{}%3 Label/Hook
{}%4 Quelle
{}%5 Lizenz
...
\subsection{\HeadingKeyword{Offenes} Bauchtrauma}
...
\end{itemize}}%3 Slide
{./images/trauma/bauchtrauma-offenes-01.jpg}%4 Bilddatei
{Offenes Bauchtrauma mit Austritt von Darmschlingen}%5 Bildtitel
{}%6 Bildbeschreibung
...
\subsection{\HeadingKeyword{Geschlossenes} Bauchtrauma}
...
\begin{Synopsis}
  \SynopsisItem{Immer nach \EE{Prellmarken} suchen. \EE{Patienten
  entkleiden!}}
\end{Synopsis}
...
daher ist bei einer Verletzung die Blutungsgefahr sehr groß.
%
Aufgrund der festen Kapsel kann es sowohl unmittelbar nach der Verletzung zu starken Blutungen kommen,
aber auch zeitversetzte, verspätete Blutungen sind möglich. 
%
Demnach unterscheidet man: 
\begin{itemize}
  \item \T[Milzruptur!einzeitige]{Einzeitige (primäre) Milzruptur}: Die Milz und
  die Kapsel reißen gleichzeitig, es kommt zu einem unmittelbaren
  Schockzustand.
  \item \T[Milzruptur!zweizeitige]{Zweizeitige (sekundäre) Milzruptur}:
  \label{topic:milzruptur-zweizeitig}%
  \index{Milzriss!zweizeitiger}%
  Das Milzgewebe ist verletzt, die Kapsel bleibt jedoch erhalten:
  %
  Es blutet zuerst in die noch erhaltene
  Kapsel ein und der Druck steigt. 
  Wird der Druck zu groß reißt
  nach einer gewissen Zeit, 
  es kann sich dabei um Stunden oder auch Tage handeln 
  \E{(Latenzzeit)}, 
  die Kapsel 
  und der Patient blutet nun \E{plötzlich} ungehindert
  in den Bauchraum: 
  \Ca{Der Patient wirkt zuerst unauffällig, 
  unerwartet und plötzlich
  verschlechtert sich seine Kreislaufsituation 
  und sein Zustand,}
  er kann binnen kurzer Zeit in einen
  \I[Schock!Milzruptur]{Volumenmangelschock} geraten.
  
  \E{Daher
  ist es wichtig jeden Patienten, bei dem auch nur der geringste
  begründete Verdacht auf eine Milzverletzung besteht, 
  einer weiterführenden Untersuchung 
  und Überwachung im Spital
  zuzuführen
   und bis dahin jede weitere Bewegung zu vermeiden 
   (\EE{Bewegungsverbot})!}\ZFootnote{Mittels Ultraschall oder
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Blutung in die Kapsel, Druck steigt
    \item Symptomfreies Intervall (Latenzzeit)
    \item Wenn Druck weiter steigt: Kapselriss $\rightarrow$ 
    plötzlich starke Blutung $\rightarrow$ 
    Volumenmangelschock
  \end{itemize}
\end{itemize}
}
...
\begin{Danger}
  \item Cave: \index{Zweizeitige
  Milzruptur}Zweizeitige Milzruptur
\end{Danger}
...
\subsubsection{Weitere \HeadingKeyword{innere Verletzungen}}
...
\subsection{\HeadingKeyword{Beckentrauma}}
\index{Beckentrauma}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage % TEMP temp clearpage
\section{\HeadingKeyword{Polytrauma}}
...
\noindent Beispiele:
\begin{itemize}
  \item Bauchtrauma + Oberschenkelfraktur 
  
  \Abk{SHT} + WS + Thoraxtrauma 
  
  ${\rightarrow}$ Polytrauma
...
\begin{Synopsis}
  \SynopsisItem{Der Patient gilt als 
  polytraumatisiert bis zum Beweis des Gegenteils! Jedes
  Polytrauma stellt eine \EE{vitale Bedrohung} dar. }
  \SynopsisItem{Ein polytraumatisierter Patient ist ein
  \EE{zeitkritischer} Patient!}
\end{Synopsis}
...
% 	{Float}%8
\Table
{Häufigkeit der betroffenen Organsysteme bei der Diagnose Polytrauma}%1
{}%2
{}%3
{nach \cite{BoehmerTaschRett6,Gorgass7}}%4
{}%5
{%
\begin{tabular}{cl}
...
&
\noindent\TabHeading{Bereich}
\\\addlinespace\midrule\addlinespace
\VonBis{60}{67} & Schädel-Hirn
\\
\VonBis{45}{75} & Extremitäten
\\
\VonBis{25}{30} & Thorax
\\
\VonBis{10}{37} & Abdomen und Becken
\\
\VonBis{5}{15} & Wirbelsäule
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage % TEMP temp clearpage
\section{\HeadingKeyword{Extremitätentrauma} und Sportverletzungen}
...
\subsection{\HeadingKeyword{Amputationen}}
...
\subsection{\HeadingKeyword{Weitere} Verletzungsbilder}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage % TEMP temp clearpage
\section{\HeadingKeyword{Verbrennung} und 
\HeadingKeyword{Verbrühung}}
...
Bei \EE{ringförmige Verbrennungen}, die um den Brustkorb
...
\begin{tabulary}{\linewidth}[H]{LCCC}
\addlinespace\toprule\addlinespace
\noindent & \multicolumn{3}{c}{\noindent\TabHeading{\PC}}
\\\cmidrule(lr){2-4}
\noindent & \noindent\TabHeading{Erwachsener} &\noindent\TabHeading{Kind} {\scriptsize$\leq$ 5. Lj} & \noindent\TabHeading{Säugling}
\\\addlinespace\midrule\addlinespace
Kopf: 			&  9 & 15	& 20
\\
Arm, je:  		&  9 &  9,5	&  9
...
3\textdegree
 &
\noindent\T{Verschorfung} (Vebrennungspanzer), Schmerzen
...
\PictureSeriesRowWide{3}
{./images/wikipedia-pd/Verbrennung1-00441pt}
{Verbrennung 1\textdegree \SourcePicture{Trent Easton; de.wikipedia / PD}}
{./images/wikipedia-cc-by-sa/VerbrennungGrad2a-00441pt}
{Verbrennung 2\textdegree \SourcePicture{Yunaerith; WMC / CC-BY-SA 3.0 unported}}
{./images/wikipedia-cc-by-sa/Verbrennung_3gradig01}
{Verbrennung 3\textdegree \SourcePicture{Sushma Koirala Memorial Hospital, Dr. Andreas Settje; WMC / CC-BY-SA 3.0 unported}}
{}
{}
\PictureSeriesRowWide{3}
...
{Aufgrund der
ringförmigen Verbrennung am Thorax zieht sich die Haut
zusammen und die Atmung wird beeinträchtigt (Verbrennungspanzer).
Durch
{Entlastungsschnitte} (\I{Escharatomie}) kann der Patient wieder atmen.
\SourcePicture{Hauer}}
{}
{}
\end{PictureSeriesWide}
...
bereits ab  \EE{10\PC*} (oder \E{5\PC* bei Kindern})
...
\begin{itemize}
  \item Ab \EE{10\PC* $\geq$\,2\,{\textdegree}} $\rightarrow$ {schwer}
  \item \EE{Kinder}: \EE{5\PC*}
\end{itemize}
Für
...
\begin{Synopsis}
  \SynopsisItem{Ab \EE{10\PC* $\geq$\,2\,{\textdegree}} verbrannter
...
% \clearpage % TEMP temp clearpage
\subsection{\HeadingKeyword{Inhalationstrauma}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\subsection{Verletzungen durch \HeadingKeyword{chemische 
Stoffe} -- \enquote{Chemische Verbrennungen}}
...
\EE{Dekontamination} muss großer Wert gelegt werden.}%2 Text
{
\begin{itemize}
...
\end{itemize}}%3 Slide
{./images/trauma/notbrause2.jpg}%4 Bilddatei
{}%5 Bildtitel
{}%6 Bildbeschreibung
{Sebastian Gabriel}%7 Quelle
{MfG}%8 Lizenz
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage % TEMP temp clearpage
\section{\HeadingKeyword{Erfrierungen}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage % TEMP temp clearpage
\section{Unfälle durch \HeadingKeyword{Strom}- und 
Blitzschlag}
...
\begin{Danger}
  \item Das eigentliche Ausmaß der Verletzung ist oft
  \EE{{\quotedblbase}unsichtbar{\textquotedblleft}}, da der
  Strom im Körperinneren -- unterhalb des Hautmantels
...
\begin{description}
  ...
  Matalle) berühren (vgl. Gefahrenzonen: \FullPrettyRef{topic:gefahrenzonen})!
  \item[Bahnanlagen]
  ...
  von bis zu 3\,000\,V anliegen (vgl. Gefahrenzonen: \FullPrettyRef{topic:gefahrenzonen}).
...
\section*{Weiterführende \HeadingKeyword{Literatur}}
