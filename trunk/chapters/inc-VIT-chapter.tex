...
\gTabHeading{Kennzahlen}
\begin{description}
    \item[AF] {\ldots} Atemfrequenz
    \item[AZV] {\ldots} Atemzugsvolumen
    \item[AMV] {\ldots} Atemminutenvolumen
\end{description}
}
...
\gTabHeading{Normalwerte Atmung}
\begin{description}
    \item[AF] \ldots{} 12-16\,\nicefrac{x}{min}
    \item[AZV] \ldots{} 500\,ml 
    \item[AMV] \ldots{} 6-8\,l
\end{description}
...
\gCo{Die Einstellungen eines Beatmungsgerät können von den
...
Patienten ist immer von einer Reanimation auszugehen.}
...
\gParallel{
\gTabHeading{Wärmeproduktion durch}
