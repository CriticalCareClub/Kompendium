...
Auswurfleistung des rechten Herzens.
...
kommt es oft zu Ödemen (Beine, \ldots) und gestauten
Halsvenen.

Die Patienten müssen häufig nachts urinieren. Über längere
Zeit kann sich die Leber vergrößern und ein sog.
"`Wasserbauch"' (\Z{Aszites}) bilden\Z{, dabei wird durch
...
\begin{description}
  ...
  \item[Das \T{Akute Koronarsyndrom}]\index{Akutes
  Koronarsyndrom} ist ein Sammelbegriff für \E{Herzinfarkt},
  \E{stabile} und \E{instabile Angina pectoris}. Bei diesen
  Krankheitsbildern kommt es zu einer akuten
  \EE{Unterversorgung des Herzmuskels} mit Blut und
  Sauerstoff. Die Ursache sind in erster Linie verengte oder
  verstopfte Herzkranzgefäße. Das akute Koronarsyndrom ist
  häufig das Ergebnis einer vorbestehenden koronaren
  Herzkrankheit.
\end{description}
...
Grunde liegt, wobei es beim Infarkt im Gegensatz zur Angina
...
bekannt, bzw. es besteht eine "`\index{Koronare
Herz-Krankheit}\T{Koronare Herz-Krankheit}
(\index{KHK}\T{KHK})"'. Die KHK ist eine Erkrankung der
...
\Layout{0}{Richtwert}{%
Beim Erwachsenen beträgt der untere Grenzwert des
systolischen Blutdrucks 100\MmHg*. Jeder Mensch hat
allerdings im gewissen Rahmen einen "`eigenen Normalwert"', bei Kindern gelten
grundsätzlich andere Werte.
\cite{PraxisleitAllgemeinmed6} }{%
\begin{itemize}
  \item Erwachsener: RR\textsubscript{sys} {\textgreater}
  100\MmHg
...
\begin{description}
  ...
  \EE{hyperton, aber bradykard} (RR\,↑, HF\,↓.). Typisch ist
