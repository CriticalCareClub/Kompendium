...
:::{index} pair: Echokardiographie; transthorakale
:::
:::{index} single: TTE
:::
:::{index} single: 4-Kammer-Blick
:::
:::{index} single: Vena; cava inferior
:::
...
:::{index} pair: Echokardiographie; transösophageale
:::
:::{index} single: TEE
:::
...
Die transösophageale Echokardiographie (TEE) wird in der Routine deutlich seltener durchgeführt als der transthorakale Zugang. Sie weist jedoch Eigenschaften auf, die ein „ideales“ hämodynamisches Überwachungssystem ausmachen {term}`🗎 Vignon 2017`:

Aufgrund der Nähe des Schallkopfs sowohl zum Herzen als auch zu den großen Gefäßen liefert die TEE eine durchwegs bessere Bildqualität als die transthorakale Echokardiographie (TTE).
