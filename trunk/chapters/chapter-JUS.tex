...
Spruch auf den Lippen: "`immerhin konn des
...
des Patienten, da er meint, dass "`eh kana däs
...
hat"', da sie ihr Freund mit \index{HIV}\E{HIV} angesteckt hat.
...
\Z{{\S}\,1} des "`Bundesgesetzes gegen
...
ist"'. Trotzdem sollte der Patient aufgefordert werden
