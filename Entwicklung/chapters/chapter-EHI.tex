...
\begin{enumerate}
  ...
  Unzumutbarkeit abgelehnt werden!\ZFootnote{Unzumutbar ist die Erste Hilfe für
  ...
  nicht von vornherein als unmöglich abgelehnt werden!\ZFootnote{Gemeint sind hierbei Fälle in denen für den
  ...
  vor Unwichtigem!\ZFootnote{Es muss immer das nächstgrößere Übel beseitigt
  werden.
  Es kann mitunter auf Grund der Dringlichkeit in der Situation nicht immer Rücksicht auf das Eigentum
...
% verbundene, \enquote{eingebrannte} Kleidungstücke müssen belassen werden.}
% 
...
zu bewegen. 
% \SpeechMargin{\enquote{Bitte bleiben Sie
...
\prettyref{topic:hws-schiene-anlegen}: \Speech{\enquote{Bitte bleiben Sie noch ruhig liegen, wir werden
...
der Patient \E{Lebenszeichen}, ist eine
...
Wenn der \E{Ersthelfer erschöpft} ist, sollte er (falls überhaupt
...
\begin{itemize}
  ...
  kommt von Verletzungen mit starken Blutungen. Flüssigkeitsverlust kann bei großflächigen Verbrennungen und
...
\item Bei \EE{Vergiftungen und allergischen Reaktionen} bleibt
...
ausgerüstet, Notfälle zu bewältigen. Sein Zweck liegt in der
...
Bei vital bedrohten Patienten werden {\TxMassVit} ergiffen,
...
(\I[Ischämie!Akutes Koronarsyndrom]{Ischämie}\footnote{\T{Ischämie}  bezeichnet die akute Unterversorgung eines
...
des Gewebes bishin zum Gewebstod.}). Das akute Koronarsyndrom
...
% Herzkranzgefäße. \SourcePicture{WmCo \enquote{Bionerd}, CC-BY-3.0}}
% \\\bottomrule
% \end{tabularx}
% \end{WidePar}
% \end{table}
...
Herzkranzgefäße. \SourcePicture{WmCo \enquote{Bionerd}, CC-BY-3.0}]{\includegraphics[width=0.23\linewidth]{./images/wikipedia-cc-by/Hk_coronary_bionerd.jpg}}
\end{WidePar}
...
Herzens(\I[Ischämie!Angina pectoris]{Ischämie}), die Folge sind Schmerzen, Atemnot und ein
Leistungsverlust!
...
Brustkorb, \emph{\enquote{als würde jemand darauf stehen}}. Die
...
Blässe, Kaltschweißigkeit, Hypotonie, etc.\VARIANT{VAR-STANDARD}{ (\ref{topic:schock-kardiogener})}.
}{
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Druckgefühl, \enquote{als würde jemand am
    Brustkorb stehen}
    \item Todesangst
    \item \EE{Dyspnoe}
...
{%
Herzinfarktpatienten werden \enquote{besonders} behandelt und
...
Herzkatheter wird oft mit \enquote{\I{PCI}} \Z{(Percutane Coronare
Intervention)} oder \enquote{\I{PTCA}} \Z{(Perkutane Transluminale
...
% meint \enquote{es sei eh nicht dringend} unbedingt
...
gerinnungs\-hemmenden (\enquote{blut\-ver\-dünnenden}) Medi\-ka\-menten:
z.\,B. \E{\enquote{Marcoumar}} ${\rightarrow}$ Patient ist blutungsgefährdet
\\\addlinespace\midrule\addlinespace
\TabSub{Extrasystole}
&
Extraschläge
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    (\enquote{blutverdünnenden}) Medikamenten:
...
{Heimlich-Manöver.}
{\enquote{Air Force Staff Sgt. Abraham Jara provides instruction in the proper
...
Gefährlich sind besonders die \enquote{ruhigen}, wenig klagenden
...
wird, \Z{\enquote{silent chest}}). Es kommt zu einer
...
Der
\enquote{Status} ist eine gefürchtete Komplikation des
...
%   \enquote{\Abk{COPD}} (\prettyref{topic:copd}). Bei sorgfältiger
...
%   \enquote{Darf der Patient seinen (vom Arzt vielleicht gerade für
...
\begin{itemize}
  ...
  Der \T{Herdblick} ist eine \enquote{Blickdiagnose}: Es kann zu
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    Arbeit ein, es kommt zu einer \enquote{\T{chronischen
...
\begin{itemize}
  \item Erstmanifestation DM~Typ~I
  \item Diätfehler
...
\I[Ketoazidose!diabetische]{diabetischen Ketoazidose}}\VARIANT{VAR-STANDARD}{, \FullPrettyRef{topic:azidose-metabolische}}). 
...
Die \EE{harte Bauchdecke} (\enquote{\E{bretthart}}) ist neben den
...
Beantwortung der Fragen \emph{\enquote{Wie schlecht, bzw. wie gut
...
\begin{itemize}
  ...
  \item Entzündung der Bauchspeicheldrüse 
  \item Durchbruch / Zerreißung eines Hohlorganes
  \item Blutungen in den Bauchraum
  \item Bauchaortenaneurysma
  \item andere abdominelle Erkrankungen
...
{\begin{itemize}
  ...
  \item Übelkeit, Erbrechen, Fieber
\end{itemize}}
{}
{}
{}
...
\Fazit{{\QSO}Nobody is dead until warm and dead!{\QSC}
...
{\QSO}sozial akzeptiert{\QSC}. Wenn der Betroffene
{\QSO}über's Ziel hinaus schießt{\QSC}, kann es schnell zu
...
andere EKG-Veränderungen und {\QSO}Farbensehen{\QSC}.
}
...
unter dem Namen \I{Ecstasy} (XTC, E, X)}, ist eine
der bekanntesten \I{Partydrogen}. Auf den ersten Blick
...
\begin{itemize}
  ...
  \item Gesteigertes {\QSO}Glücksgefühl{\QSC}.
...
\begin{itemize}
    ...
    \item \Speech{{\QSO}mmer beim duschen!{\QSC}}
\end{itemize}
}{
\begin{itemize}
