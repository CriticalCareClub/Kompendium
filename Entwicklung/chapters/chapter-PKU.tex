...
{\CC{[PKU]}\\Erweiterte Physikalisch-körperliche Untersuchung}
\label{chp:PKU}
...
\begin{figure}[H]
\includegraphics[width=\linewidth]{./images/pku/clean-img1.jpg}
...
\Layout{2}{Strukturierte Beobachtung / Checklisten / Famulaturpropädeutikum}{%
...
\Layout{2}{Mitarbeit und Übungszeit}
{%
...
\Layout{2}{Weitere Möglichkeiten zum Selbststudium}
...
\Layout{2}{Kontakt mit dem Patienten}{%
...
\Layout{2}{Beim Beenden des Patientenkontakts}{%
\begin{itemize}
...
\Layout{2}{Dokumentation von Befunden}{%
...
(\SymbolPkuNormal), häufige Varianten (\SymbolPkuVariante) 
oder häufige pathologische Befunde
(\SymbolPkuPathologisch) angegeben.
...
\Layout{2}{Allgemeinzustand, Ernährungszustand}{%
...
\Layout{2}{Inspektion des Gesichtshautzustandes}{%
...
\Layout{2}{Palpation der Nasennebenhöhlen und des Mastoids}{%
...
\Layout{2}{Trigeminus-Austrittspunkte}
...
\item[\SymbolPkuPathologisch] Seitenungleichheit, Parese
\end{PkuBefunde}
}{}{}{}
...
\Layout{2}{Begutachtung der Augen}{%
\begin{itemize}
...
%   \item[\SymbolPkuPathologisch] \PkuBefund{}
\end{PkuBefunde}
}{}{}{}
...
\Layout{0}{Gesichtsfelduntersuchung (Fingerperimetrie)}
...
%   \item[\SymbolPkuVariante] \PkuBefund{}
  \item[\SymbolPkuPathologisch] \PkuBefund{Skotom {\ldots} / Hemianopsie {\ldots} }
\end{PkuBefunde}
}{}{}{}
...
\Layout{0}{Pupillen und Pupillenreflex}{%
...
\Layout{0}{Inspektion des Mundes}{%
...
\begin{PkuBefunde}[]
  ...
  belegt}
  \item[\SymbolPkuPathologisch] \PkuBefund{Zunge
...
\Layout{0}{Untersuchung des Pharynx und der Tonsillen}{%
\index{Uvula}%
...
\begin{PkuBefunde}[]
  ...
  \item[\SymbolPkuPathologisch] \PkuBefund{Pharynx gerötet
...
% \Layout{2}{{\protect\dsliterary} Weiterführende Literatur}{%
% \begin{labeling}{mmm}
...
\Layout{0}{Beurteilung der Wirbelsäule: }
{%
...
\Layout{0}{Inspektion des Thorax (Form, Symmetrie, inkl. Haut)}
...
\clearpage
\Layout{2}{Orientierung/Orientierungslinien}
{\mbox{}
...
%   \item[\SymbolPkuVariante] \PkuBefund{}
  \item[\SymbolPkuPathologisch] \PkuBefund{Paradoxe Atmung}
...
\Layout{0}{Perkussionsuntersuchung}{%
...
\Layout{0}{Vergleichende Perkussion}{%
...
\Layout{0}{Prüfung der Atemverschieblichkeit}{%
...
\Layout{0}{Inspektion der Mammae}{%
...
\Layout{0}{Palpation des Herzspitzenstoßes}{%
...
\Layout{0}{Mehrmalige Auskultation der Auskultationspunkte}
...
\Layout{0}{$\oplus$ Beurteilung S\textsubscript{1} über Herzspitze} 
...
\Layout{0}{$\oplus$ Beurteilung S\textsubscript{2} über Herzbasis} 
...
\Layout{0}{Bei V.\,a. Rechtsherzinsuffizienz: Inspektion der
Jugularvenen bds.}
...
\Layout{0}{Bei V.\,a. Aorteninsuffizienz: Kapillarpuls am Fingernagel testen}
...
\Layout{0}{Auskultationsbefund erstellen}
{
\begin{description}
  \item[Normalbefund]
...
\begin{PkuBefunde}[]
  ...
  \item[\SymbolPkuPathologisch] \PkuBefund{arrhythmisch,
...
\Layout{2}{Erstellen einer Verdachtsdiagnose}
...
\Layout{0}{\CO{[D2]} Inguinale und rektale Untersuchung}
{%
\begin{itemize}
...
\Layout{2}{Einteilung des Abdomens in Quadranten}
...
\Layout{0}{Inspektion in Rückenlage}
...
\Layout{0}{Ausführliche Auskultation des Abdomens in allen 4
Quadranten} 
...
{\begin{PkuBefunde}[]
  ...
  \item[\SymbolPkuPathologisch] \PkuBefund{Fehlende
  Darmgeräusche}
...
\Layout{2}{Anmerkungen zur Palpation des Abdomens}
...
\Layout{0}{Perkussion und Palpation des rechten oberen Quadranten} 
{Die Technik der Perkussion wird im Detail unter
\prettyref{topic:perkussion} auf
Seite \pageref{topic:perkussion} vorgestellt.
Bei der Perkussion und Palpation wird quadrantenweise
...
\Layout{0}{Perkussion und Palpation des linken oberen Quadranten} 
...
\Layout{0}{Perkussion und Palpation des linken unteren Quadranten} 
...
\Layout{2}{Perkussion und Palpation des rechten unteren Quadranten}
...
\Layout{0}{Besonderheit: Stosswellenperkussion}
...
\Layout{0}{Besonderheit: Flankendämpfung}
...
\Layout{2}{Perkussion der Nierenlager}{%
...
\Layout{2}{Inspektion der Leistenregion}{%
...
\Layout{0}{Palpation der inguinalen Lymphknoten}{%
...
\Layout{0}{{\SignErwaehnt} Leistenhernien}{%
...
% \Layout{2}{Klinische Untersuchung des
% \IX[Skrotum]{Skrotums}} 
...
\Layout{2}{\CO{[E1]} Inspektion der Extremitäten und grobe Funktionsprüfung der Gelenke}
{
\begin{itemize}
...
\Layout{2}{Inspektion Skelett und Gelenke}{%
...
\Layout{2}{Grobe Funktionsprüfung der Gelenke (Selbststudium)}{%
...
\Layout{2}{Inspektion und Palpation der Haut (v.\,a. untere Extremitäten)}{% 
...
\Layout{2}{Der Status \enquote{3 $\times$ 3 $+$ 3}}
...
% \Layout{2}{5 Sehnenreflexe (gesteigert, abgeschwächt)}
...
% 
% 
% \Layout{2}{6 Pyramidenbahnzeichen}
% {6a Trömner
% 6b Babinski}
% {}
% {}
...
% 
% 
% \Layout{2}{7 Nervendehnungsschmerzen}
% {7aMeningismus
% 7b Lasegue}
% {}
% {}
...
\Layout{2}{\TextCircled{1} Kraftprüfung (Beugung und
...
\Layout{2}{\TextCircled{2} Muskeltonus}
{Vgl. Lehrvideo.
...
\Layout{2}{\TextCircled{3} Trophik}
{Vgl. Lehrvideo.
...
\Layout{2}{\TextCircled{4} Feinmotorik}
...
\Layout{2}{\TextCircled{5} Sehnenreflexe}
...
\Layout{2}{\TextCircled{6} Pyramidenbahnzeichen}{%
...
\Layout{2}{Nervendehnungsschmerz (Lasègue-Zeichen)}{%
...
% \Layout{2}{Feinmotorik (Diadochokinese)}{%
...
% 
% 
% \Layout{2}{Koordinationsprüfung (Finger-Nase-Versuch)}{%
...
\Layout{2}{Überprüfung eines möglichen Meningismus}
...
%   \item[\SymbolPkuNormal] 
  ...
  \item[\SymbolPkuPathologisch] Schohnhaltung, Zynose
\end{itemize}
\end{minipage}
\\\addlinespace\midrule\addlinespace
...
\begin{itemize}
  ...
  \item[\SymbolPkuPathologisch] Reaktion auf
...
%   \item[\SymbolPkuVariante]
  \item[\SymbolPkuPathologisch] Atemwege verlegt
\end{itemize}
\end{minipage}
\\\addlinespace\midrule\addlinespace
\noindent\T{B}
