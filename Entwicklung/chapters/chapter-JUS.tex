...
\subparagraph{\EE{zwei Arten der Patientenverfügung}:}
...
\subparagraph{\EE{Absolute Unwirksamkeit/Unbeachtlichkeit bei}:}
...
\subparagraph{\EE{Suche nach Patientenverfügung} --
\Z{{\S}\,12 PatVG:}}~
...
\Layout{2}{Rechtslage}{%
Die \EE{Kompetenzstufen} sind im SanG\ZFootnote{{\S}{\S}\,9--12 SanG}
geregelt:
