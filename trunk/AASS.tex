\documentclass[ngerman,a4paper,fontsize=9pt,BCOR=1.5cm,headings=big,draft=no,parskip=half,noonelinecaption]{scrbook}
...
%\addtokomafont{subsubsection}{\LARGE\color{darkBlue!70}}
\addtokomafont{subsubsection}{\LARGE\color{ubuntured!60}}
...
%%% uppertitleback
\uppertitleback{
    \emph{Titelbild: Sebastian Gabriel.}
