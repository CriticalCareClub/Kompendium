...
Arterie 
 &
\gEs{-- \ce{O2}-arm.} Geht von der rechten Herzkammer weg in
...
Vene 
 &
\gEs{-- \ce{O2}-reich.} Kommt von den Lungenkapillaren und
...
\begin{itemize}
    ...
    \item \ce{CO2}-Abtransport \index{\ce{CO2}-Abtransport} 
...
\captionof{figure}{\gAuthNotesPicLegalOk{}{PD-CE}Querschnitt durch
...
\subsubsection{Das egetative (autonome)  Nervensystem}
...
Sie dient nur als Zwischenspeicher für die Galleflüssigkeit.
