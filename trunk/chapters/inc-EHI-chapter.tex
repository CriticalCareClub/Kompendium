...
\fxwarning[author=GABS]{Rettungskette: Grafik Neuerstellung}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TODO : Neuerstellung
\fxwarning[author=GABS]{: Neuerstellung von Text notwendig}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\gFazit{Der Helm ist immer abzunehmen!}
...
\fxwarning[author=GABS]{: Neuerstellung von Grafik notwendig}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
der Atemwege zu einer \gEs{mangelnden Überstreckung} des Kopfes
kommt, kann es zu einer unzureichenden Belüftung der Lunge kommen. Bei jeder Atemspende ist der \gEs{Brustkorb} des Patienten zu \gEs{beobachten}. Dieser
...
wird gezwungener Maßen die Wiederbelebung ab-, bzw. unterebrochen. 
% aufgrund der
...
\fxwarning[author=GABS]{Abdrückpunkte: Neuerstellung von Grafik/Text 
                          notwendig}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
}{
\begin{itemize}
...
der Extremität. Für die weitere Versorgung des Patienten ist es wichtig, den \gEs{Zeitpunkt der Abbindung} zu notieren, am besten gleich am Oberarm bzw.
...
{
Bagatellverletzungen sind \gEs{kleine, oberflächige Wunden}, wie z.B.
Schürfwunden und kleine Schnitte, welche nicht tiefer als \nicefrac{1}{2}\,cm
und nicht länger als 2 cm sind, gemeint. Bei idealer Behandlung durch
...
Schwellung des Gewebes und zu Schmerzen. Der \gEs{2.~Grad} ist charakterisiert
...
besagt, dass die \gE{Handfläche des Patienten  1\,\%}
...
\begin{itemize}
    ...
    \item Mind. 10\,min mit lauwarmen Wasser kühlen (Richtwert 20\textcelsius).
...
\gDefinition{Absinken der Körperkerntemperatur unter 36\,\textcelsius{}}

\gLayout{0}{\gTxSymptome{} und Kennzeichen}
{
Am Beginn hat der Patient \gEs{Schmerzen}, Atem- und Herzfrequenz sind erhöht.
Je weiter die Temperatur sinkt, desto \gEs{teilnahmsloser}
und \gEs{müder} wird der Patient. Zu Letzt kommt es zum \gEs{Absinken
...
\begin{itemize}
    ...
    \gCa{Bergungstod!}\footnote{Unter dem Begriff \emph{Bergungstod} versteht
...
\gDefinition{Überdehnung der Bänder bzw. des Kapselapparates eines Gelenkes.}

\gLayout{0}{\gTxSymptome{} und Kennzeichen}
{
Der Patient hat \gEs{Schmerzen} im Bereich des betroffenen Gelenkes, es
...
kann sich auch ein \gEs{Bluterguss} bilden. Auch eine \gEs{Einschränkung der
Bewegung} ist -- schermzbedingt -- möglich. 
}{
\begin{itemize}
    \item Schmerzen.
    \item Schwellung.
...
\gDefinition{Gelenkverletzung, bei der zwei das Gelenk bildende Knochenenden
aus ihrer normalen Stellung zueinander verschoben werden. Dabei kommt es oft zu
Begleitverletzungen an der Gelenkkapsel bzw. den Gelenkbändern. \cite{Gorgass5}}



\gLayout{0}{\gTxSymptome{} und Kennzeichen}
{
Der Patient hat starke \gEs{Schmerzen} im Bereich des verletzten Gelenkes,
...
den \gT{sicheren Kennzeichen} zählt die \gEs{Fehlstellung} (abnorme Stellung,
Verkürzung, Treppenbildung), die \gEs{abnorme Beweglichkeit} und die
\gEs{Krepitation} (das hörbare und fühlbare Aneinanderreiben der Knochen). \gT{Unsichere Kennzeichen} sind \gEs{Schmerzen}, \gEs{Schwellungen}, \gEs{Bewegungseinschränkungen} und \gEs{Blutergüsse}. }{
\begin{itemize}
...
\gLayout{22}{}{
Pflasterverbände können nahezu überall eingesetzt werden. Sie müssen dazu nur
