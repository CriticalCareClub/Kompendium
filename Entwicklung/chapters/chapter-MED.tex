...
dem der gleiche Mechanismus wie der der Angina Pectoris zu
...
einem \EE{Herzkatheters} versucht man die verengten oder
...
Herzrhytmusstörungen sind häufig, allerdings auch oft sehr
...
\Layout{0}{Richtwert}{%
Beim Erwachsenen beträgt der untere Grenzwert des Blutdrucks
\RRmmHg{100} syst. Jeder Mensch hat allerdings im gewissen
Rahmen einen "`eigenen Normalwert"', bei Kindern gelten
...
\begin{itemize}
  ...
  vorhanden ist 8\LPerMin*. \Commentary{\EE{Asthma:
...
Blut-pH sehr rasch basisch. Dadurch geraten die Elektrolyte
im Blut in ein Ungleichgewicht, es kommt zu Symptomen.
}{
\begin{itemize}
...
gesättigt ist (Sp\ce{O2} von 100\,\%). Sie haben eine
...
\Layout{2}{Insulin}
{%
\T{Insulin} \index{Insulin} ist ein Hormon und wird in den
