...
\begin{inparaitem}
  ...
  \item auf eine schwere Lungenerkrankung (z.\,B. COPD) hin.
\end{inparaitem}
...
{%
Bei dieser Methode der \ce{CO2}-Erkennung wird der Patient durch einen Indikator mit Lackmuspapier beatmet. Da \ce{CO2} einen sauren pH-Wert hat, verfärbt sich der Indikator bei jeder Ausatmung. Durch die Verfärbung kann eine ungefähre Aussage über die \ce{CO2}-Konzentration in der Ausatemluft getroffen werden.
%
