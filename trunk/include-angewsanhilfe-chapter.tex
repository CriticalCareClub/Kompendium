...
\begin{itemize}
    ...
    Schmerz?"'} (In einigen Lehrbüchern wird empfohlen, den Schmerz anhand
...
\begin{itemize}
\item die Herzfrequenz, 
\item den Blutdruck und 
\item die Atemfrequenz.
\end{itemize}
...
Die Messung des Blutdrucks ist im Kapitel Gerätelehre - RS IX
...
\begin{enumerate}
  ...
  seitlich (Rand!), nicht in die Finkerkuppe, nicht zu nahe
...
\end{enumerate}
  ...
  Seitengleichheit.  \item 
    \begin{enumerate}
  \item Patient überkreuz die Hände geben, bei kräftigen
...
\end{enumerate}
  ...
  Nackensteifigkeit wird unter \ref{topic:meningitis}
...
\begin{enumerate}
    ...
    \end{itemize}
\end{enumerate}
\includegraphics[width=\linewidth]{./images/infusion_tropfkammer.jpg}
\end{multicols}
