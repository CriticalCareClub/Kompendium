...
\begin{itemize}
    ...
    Funktionen wie der \gT{Schluck-}, \gT{W\"urge-} bzw. \gT{Hustenreflex}
...
\\\midrule
\gTabSub{Bewu{\ss}tseinsklar}
 &
 &
 wach
 &
\\\addlinespace
\gTabSub{Bewu{\ss}tseinsgetr\"ubt}
&
...
Die genauen Werte sind Alters-, Geschlechts- und
Größenabhängig. 
...
Die Atemfrequenz ist stark altersabh\"angig:
...
\subsection{St\"orungen der Atmung}
...
\\\midrule
\gTabSub{Neuro\-muskul\"aren Atemregulation}
 &
...
%    \begin{itemize}
%        \item \"Offnen des Mundes \gA{(Esmarch-Handgriff)
%        -- evt. erklären}
...
\begin{itemize}
    ...
    \item Der \gEs{sonst \"ubliche} Blutdruck des Patienten
    (erfragen, Blutdruckprotokoll).
    \item Der \gEs{Verlauf} des Blutdruckes w\"ahrend der
...
Ge\-webedurchblutung f\"ur die Versorgung aller Organe mit
Sauer\-stoff nicht ausreichend.}

K\"orpereigene Mechanismen k\"onnen versuchen gegenzusteuern
...
verl\"angert sich. Wenn die Kompensationsma{\ss}nahmen 
...
Ein Schockzustand ist grunds\"atzlich als vitale
...
\centering\includegraphics[width=1.5cm]{./icons/sm-pale.png}
 ...
 \begin{itemize}
     \item HF ${\uparrow}$
     \item m\"a{\ss}iger RR-Abfall, aber RR noch {\textgreater} HF
...
\gMassnahmen{
\paragraph{Allgemeine Ma{\ss}nahmen der
Schockbek\"ampfung}~
...
Kreislaufregulation. Es kommt zu inad\"aquater arterieller
und ven\"oser Gef\"a{\ss}erweiterung.
\gZ{(Vasodilatation)}}
...
\gParallel{
\gTabHeading{W\"armeproduktion durch}
...
in Wasser l\"oslich. Wenn sie in Wasser gel\"ost sind heissen sie
"`\gT{Elektrolyte}"'.
...
Elekktrolyte einen Druck auf das Wasser aus\"uben {\quotedblbase}die Seiten zu
...
Konzentrationsgef\"alle{\textquotedblleft}.}
} 
{\begin{center}
...
die Wand passieren kann? Daf\"ur gibt es in der Zelle spezielle "`Pumpen"'
\gZ{(Transportproteine)} die die Ionen hin und her
bef\"ordern. }

Die Steuerung der richtigen Verteilung der verschiedenen
Ionen ist recht kompliziert aber lebenswichtig. Eine {\quotedblbase}falsche{\textquotedblleft} Verteilung der Elektrolyte kann schlimme Folgen haben (zB. Herzrhythmusst\"orungen). 
...
Neugeborenen / S\"augling 8-9\,\% des Körpergewichts. 

Verluste bis 20\,\% sind prinzipiell ohne
Funktionsbeeintr\"achtigung tolerierbar, allerdings
kommt es bald zu Sch\"aden in der Endstrombahn. 
...
\subsubsection{Atmungsbedingte \"Ubers\"auerung --
Respiratorische Azidose} \label{bkm:RefHeading35233321}\label{topic:azidose-respiratorische}\index{\"Ubers\"auerung}\index{Respiratorische
...
\index{\"Ubes\"auerung}\index{Metabolische Azidose}Zunahme von S\"auren im  K\"orper
...
bösartige Grunderkrankung gilt nich per se als Argument um
nicht zu reanimieren --> Pateintenverfügung, mutmaßlicher
Patientenwille. Prostatakarzinom und Infarkt?}
\end{multicols}
