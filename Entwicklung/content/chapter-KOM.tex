...
\section{\HeadingKeyword{Einführung}}
...
\end{compactitem}
  ...
  \begin{compactitem}
    \item \enquote{Alle Teammitglieder am gleichen Stand}
...
\section{Die \HeadingKeyword{Kommunikationstheorie} versucht Kommunikation zu beschreiben}
...
\begin{itemize}
  ...
  will, undeutliche Sprache, Sprachschwierigkeiten, 
...
\begin{Synopsis}
  \SynopsisItem{\E{Gedacht} ist nicht gesagt, 
  \E{gesagt} ist nicht gehört,
  \E{gehört} ist nicht verstanden,
  \E{verstanden} ist nicht gewollt.}
  \SynopsisItem{Es gilt nicht was gesagt, sondern was verstanden wurde.}
\end{Synopsis}
...
\Picture
{Das Sender-Empfänger-Modell \cite{Informatik3}}%1 Titel
{}%2 Beschreibung
{}%3 Label
{User:Wiska Bodo, original uploader Freak222
auf \url{http://de.wikipedia.org}, modifiziert}%4 Quelle
{CC-BY-SA 3.0}%5 Lizenz
{./images/wikipedia-cc-by-sa/Sender-Empfaenger-Modell-edited}%6 Datei
...
\Picture
{Vier-Ohren-Modell der Kommunikation}%1 Titel
{nach Friedemann Schulz von Thun \cite{ThunRedenI46}}%2 Beschreibung
{CC-BY-SA 3.0}%3 Label
{User \enquote*{Mussklprozz} auf Wikipedia, modifiziert}%4 Quelle
{}%5 Lizenz
{./images/wikipedia-cc-by-sa/SchulzVonThunVierOhrenModell-edited.pdf}%6 Datei
{}%7 Breitenmodifizierer
{}%8 Float
% vormals \Layout{27}
...
\begin{itemize}
  ...
  Patienten neigen dazu, grundsätzlich \Speech{\enquote{ja}} zu
