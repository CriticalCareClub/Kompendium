...
\paragraph{Erste Hilfe und erweiterte Erste Hilfe}~
  ...
  \begin{enumerate}
    ...
    \item    Plötzlich auftretende Erkrankungen \dotfill  \FullRef{chp:MED}
...
\paragraph{Hygiene}~
  ...
  \begin{enumerate}
    ...
    \\
    \Abk{MRSA} und andere resistente Keime:  \dotfill \prettyref{m:mrsa-transport}
  \end{enumerate}
...
\paragraph{Anatomie und Physiologie}~
  ...
  \begin{enumerate}
    ...
    \\
    Gastro-intestinaltrakt: \dotfill
...
\paragraph{Störungen der  Vitalfunktionen  und Regelkreise und zu setzende Maßnahmen}~
  ...
  \begin{enumerate}\item
    ...
    \begin{enumerate}
      ...
      Dosierung:  \dotfill \FullRef{m:sauerstoffberieselung}
...
\paragraph{Spezielle Notfälle und zu setzende Maßnahmen}~
  ...
  \begin{enumerate}
    ...
    \begin{enumerate}
      ...
      \item      Keuchhusten \dotfill  \FullRef{topic:}
...
\paragraph{Katastrophen, Großschadensereignisse, Gefahrgutunfälle} ~
  ...
  \begin{enumerate}
    ...
    \item    Stressursachen, -entstehung und -faktoren \dotfill \FullRef{topic:stress}
