...
% \end{savequote}
\def\ChapterCode{APAM}
	\chapter
[\CO{[APAM]} Adavnced: Patientenmanagement und standardisierte Patientenversorgung]
{Advanced: Patientenmanagement und standardisierte Patientenversorgung}
\label{chp:APAM}
...
{\label{tab:alarmzeichen-advanced}}%3
{}%4
{}%5
{%
...
{\label{m:ersteinschaetzung-advanced}\label{m:einschaetzungsblock-advanced}}
...
{\label{tab:checkliste-patientenmanagement-advanced}\label{tab:pam-weiterfuehrende-advanced}}%3 Label/Hook
{}%4 Quelle
{}%5 Lizenz
{%
\begin{minipage}{\linewidth}
...
1\,--\,2\,--\,3\,--\,4\,--\,A\,--\,B\,--\,C\,--\,D\,--\,E}
\label{topic:ersteinschaetzung-advanced}
\label{topic:einschaetzungsblock-advanced}
...
\label{topic:bewusstsein-advanced}
\index{Bewusstsein}
...
\label{topic:bewusstseinsstoerung-grade-advanced}
\label{topic:bewusstseinsgrad-advanced}
\index{Bewusstsein!Symptome!Advanced}
%
...
{Bewusstseinsgrade}%1
{WASB-Schema}%2
{\label{tab:bewusstseinsgrade-apam}}%3
{}%4
{}%5
...
{%
\label{topic:bewusstseinsstoerung-apam}%
...
\label{topic:atemweg-apam}
\label{topic:airway-apam}
...
\label{topic:atmung-apam}
\label{topic:breathing-apam}
...
{}%2
{\label{tab:atmung-symptome-apam}}%3
{}%4
{}%5
...
\begin{itemize}
  ...
  \item T{Lippenbremse}: 
  \label{topic:lippenbremse-advanced}
  %
...
\label{topic:kreislauf-apam}
\label{topic:circulation-apam}
...
\label{topic:patientenmanagement-erstmassnahmen-apam}
\label{topic:patientenmanagement-sofortmassnahmen-apam}
...
{%
\label{topic:sonderfall-absolut-zeitkritische-patienten-apam}
...
\label{topic:pam-strategie-apam}
\label{topic:strategieentscheidung-apam}
...
\label{topic:transportprioritaet-apam}%
...
\subsection{Strukturierte Anamneseerhebung mittels \HeadingKeyword{SAMPLER}-Schema}
...
\label{topic:dokumentation-andere-gesundheitsberufe-apam}

\subsubsection{\HeadingKeyword{Arzt- und Entlassungsbriefe}}
...
% \bigskip
% \clearpage
\subsubsection{\HeadingKeyword{Beispiel}: Patient mit schlechtem
Allgemeinzustand}
...
\subsection{\HeadingKeyword{Anwendung} in der Praxis}
