...
{
\begin{description}
  \item[\SAMPLE{S}] Das Leitsymptom ist die \EE{Tachykardie} vor. 
  Der Patient
...
Brustschmerz. Dies sind erste Zeichen, dass das Herz an
  ...
  \item[\SAMPLE{M}] Viele Patienten, bei denen
  ...
  stark beeinflusst!
  \item[\SAMPLE{P}] Eine große Rolle spielt die \EE{Anamnese}: Da oft
  ...
  \item[\SAMPLE{L}] Bei regelmäßig wiederkehrenden Beschwerden sind 
  Informationen über die vorherigen Episoden einzuholen.
  \item[\SAMPLE{E}] Die Ereignisse sind genau zu erfragen und zu
...
\end{itemize}
  \item[\SAMPLE{M}] \Z{Antiarrhythmika.} Eingenommene und verschriebene Medikamente unbedingt sorgfältig erheben!
  \item[\SAMPLE{P}] Oft vorbekannte Erkrankung(en); Arztbriefe und Befunde!
  \item[\SAMPLE{L}] Frühere Episoden?
  \item[\SAMPLE{E}] Genau erfragen und dokumentieren!
\end{itemize}
}
{}
{}
