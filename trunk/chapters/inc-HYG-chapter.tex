...
können Bakterien \Es{Resistenzen} gegen Antibiotika
entwickeln. \Margin{Antibiotika werden wirkungslos}Die sonst wirksamen Medikamente
...
letzten Jahren ist die Resistenzentwicklung aber auch bei vielen anderen Keimen zu beobachten, \Z{Beispiele
dafür sind die \Abk{ESBL}{\textquotesingle}s und \Abk{VRE}{\textquotesingle}s
...
treten mittlerweile resistente Keime auf: \E{2008} wurden die ersten Fälle
registriert bei denen der Keim auf mind. \E{4} Antibiotika resistent
war\opt{NIVMED}{ (\E{XDR-TBC}. Resistenzen gegen: Isoniazid, Rifampizin,
...
Antibiotika-Resistent: Man spricht dann vom \T{MRSA}.
}{
\begin{itemize}
...
gesammte Oberfläche benetzt ist, es muss daher \Es{luftblasenfrei} eingelegt werden. Schwimmende
Teile werden mittels eines \Es{Niederhaltesiebes} unter den
Flüssigkeitsspiegel gedrückt. Zerlegbare Gegenstände müssen \Es{soweit als
...
Die Einfachste Form ist die (chirurgische)
Mund-Nasen-Maske (\Abk{MNM}, "`OP-Maske"'), welche für viele Situationen einen ausreichenden Schutz
darstellt\footnote{Beim Ausbruch von \Abk{SARS} in Honkong in 2003 konnten
