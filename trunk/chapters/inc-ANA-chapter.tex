...
"`Ringe"' um die Brustorgane. Die 5
...
("`\T{unechte Rippen}"',
\emph{"`echt"'} bedeutet die Rippe hat eine direkte Verbindung zum Sternum), das
11. und das 12. Paar endet mit knorpeligen Spitzen frei zwischen den
Bauchmuskeln("`\T{fliegende
Rippen}"') bezeichnet werden.
...
ein \E{anderer} beugt ihn). Jeder Muskel hat einen Ursprung
...
\emph{"`rechten"'} oder
\emph{"`linken Herz"'}. Jede
Hälfte wird durch \Es{Klappen} in einen \T{Vorhof}
...
\paragraph{Blutgerinnung} \Z{Die Blutgerinnung ist der wichtigste
