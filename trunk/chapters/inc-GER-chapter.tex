...
(li.) und Beatmungsgerät \gE{Medumat Standard} (re.).}
\end{figure}
...
\end{itemize}
    ...
    \includegraphics[width=\linewidth]{./images/noauth/GER-fahrtrage-stollenwerk.jpg}
...
\begin{table}[H]
\gCaptionof{table}{Farbe und Positionen der EKG-Ekeltroden für die
