...
\begin{itemize}
  ...
  (\II{AED}\footnote{\Lang{Abkz.} AED: Automatisierter externer Defibrillator }): 
  Das Gerät kontrolliert den elektrischen Herzrhythmus und beurteilt,
...
\begin{itemize}
  ...
  durchgeführt.
  \item Wird vom AED ein \EE{Schock empfohlen} müssen
  alle Helfer den Kontakt zum Patienten lösen. Der Helfer am Kopfende
  des Patienten bedient den AED und erinnert
  die Kollegen durch das \EE{\underline{laute}} Kommando
  \Speech{\enquote{Vorsicht! Patient nicht berühren! --- Schock!}} an
  den nötigen Sicherheitsabstand. Bevor  der Elektroschock durch Druck auf die
  Schock-Taste am AED endgültig ausgelöst
