...
\end{savequote}
\chapter
[\CO{[LER]} Lernen lernen]
{\CC{[LER]} Lernen lernen} 

\section{Wissensquellen}

\subsection{Fachbuchhandlungen}

\paragraph{Facultas in der Berggasse} 
...
\href{mailto:facultas@facultas.at}{\nolinkurl{facultas@facultas.at}}
  \item[Öffnugszeiten:] \VonBis{Mo}{Fr} \VonBis{8:30}{18:30} Uhr, Sa \VonBis{9:00}{12:30}–
Uhr, Juli und August geänderte Öffnungszeiten
  \item[Anmerkungen:] 
\end{compactdesc}
...
\paragraph{Universitätsbibliothek der Medizinischen Universität Wien}~

\begin{compactdesc}
  \item[Anschrift:] Allgemeines Krankenhaus (Neubau)
Währinger Gürtel \VonBis{18}{20}, A-1097 Wien
  \item[Kontakt:] \begin{inparadesc}
...
\end{inparadesc}
  \item[Öffnugszeiten:] \begin{inparadesc}
  \item[\VonBis{Mo}{Fr}] \VonBis{8:00}{20:00},
  \item[Sa] \VonBis{9:00}{17:00}
  \item[Sonst.:] In den Ferien gelten geänderte öffnungszeiten. Die Schalter
  (Kassa, Entlehnung, Ausweise, \ldots) haben abweichende Öffnungszeiten.
\end{inparadesc}
  \item[Anmerkungen:] Voraussetzung für die Entlehnberechtigung ist eine gültige Bibliothekskarte der
Universitätsbibliothek der Medizinischen Universität Wien. Dies gilt auch für Personen, die schon an anderen Universitätsbibliotheken
entlehnberechtigt sind.

Die \EE{Ausstellung der Entlehnberechtigung} erfolgt in der Zeit von
\VonBis{Mo}{Fr} von \VonBis{9:00}{19:30} und Sa \VonBis{9:00}{16:30} Uhr (in den Ferien
eingeschränkte Öffnungszeiten!). 

Gemeinsam mit dem ausgefüllten Anmeldeformular müssen folgende Dokumente
mitgebracht werden:
\begin{inparaitem}
  \item \E{Allgemeiner Benutzer}: Meldezettel und amtlicher Lichtbildausweis;
  \item \E{Studierende} und \E{Angehörige MUW-fremder Bildungseinrichtungen}:
  Meldezettel, Studienausweis/Dienstausweis;
    \item \E{Personen unter 18 Jahren}: schriftliche
    Zustimmungs- und Haftungserklärung des/der Erziehungsberechtigten,
    Meldezettel, amtlicher Lichtbildausweis.
\end{inparaitem}
\end{compactdesc}
...
\item[\cite{BLIM3}] \EE{Fachbuch} für speziell an Medizin interessierte, mit
guter, kurzer Einführung in anatomische und physiologische Grundlagen am Anfang
...
\begin{compactdesc}
  ...
  Erscheint einmal
monatlich und durchgehend vierfarbig mit Magazinteil, beinhaltet aktuelle
Informationen aus dem Bereich der präklinischen Notfallmedizin, Fallberichte,
zertifizierte Fortbildung, Notfallpraxis, Recht, Berufspolitik u.\,a. 
