...
\Abk{SHT} ohne Eröffnung der harten Hirnhaut. Je nach Schwere wird das \Abk{SHT} in drei Grade eingeteilt:
...
Thoraxverletzungen gelten als besonders gefährlich, da im Brustkorb (Thorax) lebenswichtige Organe (Herz,
...
unterscheiden. Alle Bauchtrauma können mit massiven inneren
...
gefährlich. So kann es z.\,B. bei einer Milzruptur zu einem
Blutverlust von 4~Liter kommen! \cite{Gorgass7}
...
ist. (Definition nach H. Tscherne)
\cite{BoehmerTaschRett6,Gorgass7,RedelsteinerHRNS1,LPN3}}
...
Polytrauma stellt eine \EE{vitale Bedrohung} dar. Die
Behandlung muss sich daher in erster Linie an den
Vitalfunktionen und nicht an den Einzelverletzungen
orientieren!}
...
steril mit einem Druckverband versorgt (kein Abbinden!). An große Blutungen und Schockgefahr
denken!
...
\begin{itemize}
  ...
  Zwischen die beiden Schichten des Beutels gibt man Wasser mit Eis (im Verhältnis 1:1).
...
angegeben. Diese kann entweder mit der \E{Handregel} oder mittels der
