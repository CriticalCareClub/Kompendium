...
\Layout{22}{Fußgänger vs. Fahrzeug}{%
...
\Layout{0}{\TxSymptome}{%
Bei einer Distorsion klag der Patient über Schmerzen im Gelenksbereich. Je nach
Unfallschwere kann der Patient das entsprechende Gelenk ev. eingeschränkt
bewegen. Durch die Weichteilverletzung kommt es zu einem Anschwellen des
umliegenden Gewebes und zu einem Bluterguss (Hämatom).

Falls es zu einem Bänderriss gekommen ist, berichten der Patient oder die
Unfallzeugen meist über ein hörbares Schnaltzen.
}{
\begin{itemize}
  \item Schmerzen
  \item Schwellung
