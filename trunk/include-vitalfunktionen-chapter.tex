...
\begin{itemize}
    ...
    \item \gEs{Aspiration}  (Husten- bzw. Würgereflex
    sowie sämtliche andere Schutzreflexe ausgefallen,  Muskulatur komplett erschlafft
...
\gMarried{
Die \gT{Atemfrequenz} (\gT{AF}) gibt die Anzahl der Atemzüge
pro Minute an. Das \gT{Atemzugsvolumen} (\gT{AZV}) gibt die
Menge an Luft an die eingeatmet wird. Das
\gT{Atemminutenvolumen} (\gT{AMV}) errechnet sich aus der
Atemfrequenz und dem Atemzugsvolumen. Es gibt die Menge an \gE{pro Minute}
...
\begin{description}
    \item[Normbereich] zwischen 90/60\,mmHg und 140/90\,mmHg  
...
Schock"'}. Es besteht spätestens dann akute
\gEs{Lebensgefahr}!
...
Schockbekämpfung}\marginlabel{Schockbekämpfung}\label{topic:schockbekaempfung}\index{Schockbekämpfung}
...
\index{Übersäuerung}\index{Metabolische Azidose}Zunahme von
Säuren im  Körper
...
\label{topic:alkalose-respiratorische}\index{Alkalose}Hyperventilationssyndrom
...
\begin{itemize}
    ...
    \ref{topic:patientenverfuegung} ausgeführt
