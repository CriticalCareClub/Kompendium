...
\begin{itemize}
    \item  Bewußtlosigkeit/Bewußtseinstr\"ubung
    {\textless}\,1\,h
...
Leitsymptom ist die \gEs{Bewusstlosigkeit größer
 ...
 \begin{itemize}
    ...
    \item Bewußtseinstr\"ubung {\textgreater}\,24\,h
...
%    \item z.B. geplatztes Aneurysma, Br\"uckenvenenabriß bei
%    Decelerationstrauma
...
\gParallel{
\begin{description}
\item[Bewußtseinslage] klar/getr\"ubt/bewußtlos
\item[Motorik] 
...
\begin{itemize}
    \item Sturz aus großer H\"ohe (> 3 m)
    \item Motorradunfall
...
%\begin{itemize}
%   \item Lungen- (innerer) oder  Brustwandverletzung (\"außerer)
%    \begin{itemize}
...
%        \begin{itemize}
%            \item gesunde Seite wird verdr\"angt + Abknickung  großer
%            Gef\"aße!
%        \end{itemize}
%    \end{itemize}
%\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        Volumenmangelschock
    \end{itemize}
    \item Zerreißung  von Hohlorganen (Magen, Darm,Galleng\"ange )
    \begin{itemize}
...
\gDefinition{Gleichzeitige \gEs{Verletzung mehrerer K\"orperregionen} oder
...
Die Gr\"oße des gesch\"adigten Areals wird in Prozent der
ver\-brannten K\"orperoberfl\"ache angegeben. Diese kann entweder mit der
...
\gMassnahmenNG{Spezielle Maßnahmen}{Verbrennung, leicht}{}{
    ...
    \begin{itemize}
        ...
        \item mind. 10 min. mit m\"aßig kaltem Wasser die betroffenen Körperregionen spülen  --
...
lassen)
\item Auge: Sp\"ulung mit Wasser / Ringerlösung (nach außen abrinnen
...
entscheidende Bedeutung f\"ur die zu setzenden Maßnahmen. Den
...
{
Die Verletzungsmuster und Symptome variieren je nach Spannung (Volt) und Stromst\"arke (Ampere):
