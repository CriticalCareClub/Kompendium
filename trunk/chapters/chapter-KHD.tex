...
\begin{enumerate}
    ...
    \item \Margin{z.\,B. I → III}Verbesserung des Patientenzustandes
    (z.\,B. nach erfolgter Behandlung).
    \item \Margin{z.\,B. IV → I}Verbesserung der Versorgungslage (zusätzliches 
    Personal bzw. Material verfügbar, oder Behandlungskapazitäten sind frei geworden).
\end{enumerate}
