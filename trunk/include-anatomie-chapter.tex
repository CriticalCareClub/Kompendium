...
\\\addlinespace
\gEs{Untere Hohlvene} \index{Untere Hohlvene} 
...
\begin{itemize}
    ...
    \item $CO_2$-Abtransport \index{$CO_2$-Abtransport} 
...
\begin{itemize}
    ...
    \gZ{(4.000.000\,/$\mu$l\textsuperscript{3})}
\end{itemize}
...
\begin{itemize}
    ...
    \item
    \gZ{(4\,000\,-\,8\,000\,/$\mu$l\textsuperscript{3})}
\end{itemize}
...
\begin{itemize}
    ...
    \item
    \gZ{(150\,000\,-\,300\,000\,/$\mu$l\textsuperscript{3})}
\end{itemize}
...
Wundverschluss durch Bildung eines Thrombozytenpfropfs 
...
\subsection{Das Zentralnervensystem}
 \index{Zentralnervensystem}  \index{ZNS} 
...
fast die gesammte Atemarbeit. Bei verstärkter Atmung kommen die Zwischenrippenmuskeln zum Einsatz \cite{LippertAnatomie7}.
...
\index{Gastrointestinaltrakt}  \index{GIT}
...
\index{Speiseröhre}\index{Ösophagus}
...
Milzriss}\index{Milz!-riß, zweizeitiger}\gT{Zweizeitiger
...
mündet an der Eichel in die Aussenwelt. Bei einer Vergößerung der Prostata kann der Harnabfluß bis
