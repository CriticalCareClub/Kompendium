...
:header-rows: 1
:name: Table-bewusstseinsstoerungen-ursachen

- - Primäre Ursachen
  - Sekundäre Ursachen
- - betreffen direkt das ZNS
  - betreffen über Umwege das ZNS
...
: - {{ TxMassVitMKBes }}
  ...
  - Diagnostische Schwerpunkte:
    ...
    - **Traumacheck**. Suche nach Primär- und
      Folgeverletzungen!
    - **Ursachenforschung** -- Warum ist der Patient bewusstlos
      oder soporös?
    - (Fremd-)Anamnese, Umstände, Szenerie

### Hirndruckzeichen und Hirnstammeinklemmung

(hirndruckzeichen-neu)=
...
: - {{ TxMassVitMKBes }}
    ...
    - **Notarzt**: Grundsätzlich ist ein
      ...
      *wenn folgende Umstände gegeben sind*:
      ...
      1. Die Verdachtsdiagnose gilt als *sehr sicher*.

      2. Der Patient ist sonst als *stabil*
      ...
      3. Es gibt sonst *keine anderen Umstände*
         die die Berufung
         eines Notarztes erforderlich machen.

      4. Es muss versucht werden, eine Aufnahme auf eine
      ...
      5. Regionale Bestimmungen müssen beachtet werden!
  ...
  - **Transportentscheidung**:
    ...
    1. Alter
    2. Beginn der Symptome
    3. Vorherige Schlaganfälle
...
- *Vergiftungen*: (Medikamente/Drogen/...) können wieder fast alles
  machen, also auch Krampfanfälle[^fallberichtsupady].
...
[^petitmal]: Petit mal: *franz.:* "kleines Unglück"
...
1. *Beginn*:
   ...
   anfangs schlaff.
   Wenn der Patient gestanden ist,
   fällt er ungebremst auf den Boden
   (Cave: *Verletzungen!*).
   Manchmal kommt es vor,
   dass der Patient einen *Initialschrei* von sich gibt,
   der gruselig klingen kann.
2. *Krampf*:
   Dann kommt es zu *tonisch-klonischen Krämpfen*,
   die den ganzen Körper betreffen.
   Während des Anfalls ist der Patient nicht bei Bewusstsein,
   es besteht außerdem i.d.R. ein Atemstillstand.
   Er kann jedoch starke Kräfte entwickeln,
   es besteht massive Verletzungsgefahr.
3. *Danach*:
   ...
   *Verlauf* beurteilen zu können.
   Für den Anfall selbst besteht Amnesie!
   Daher muss man den Patienten aufklären was passiert ist,
   wo er sich befindet, etc.
   Ein *Neuro-* und *Traumacheck* ist nach Anfall
   unbedingt notwendig!

[^grandmal]: Grand mal: *franz.:* "großes Unglück"
...
>   Seitenlage
>
>   - Patient vor Verletzungen schützen, Möbel etc. entfernen
>     oder polstern
