...
(\index{KHK}\T{KHK}){\textquotedblleft}. Die KHK ist
...
\begin{itemize}
	...
	{\quotedblbase}\index{PTCA}\Es{PTCA}{\textquotedblleft}
...
\begin{labeling}[~--]{xxxxxxxxxxxxxxx }
    ...
    \begin{itemize}
        ...
        \item \Es{Beine}: {\quotedblbase}Diabetischer
        ...
        Arbeit ein, es kommt zu einer {\quotedblbase}\T{chronischen
...
bedeutet dass der \Es{HIV-Test nicht
...
Schwangerschaft dauert \Es{40 Wochen $\pm$  2 Wochen}. Das sind rund
\Es{neun Kalendermonate} oder 10 Mondmonate
(Lunarmonate\footnote{\Z{lat. luna: Mond.}}). Der
Fortschritt der Schwangerschaft wird in
\T{Schwangerschaftswochen}, Abk. \T{SSW}, angegeben. Von
...
\E{42.~SSW}\Z{, die Geburt wird dann künstlich
eingeleitet}.
...
\Layout{0}{Psychiatrische Erkrankung in der Praxis}
{
...
{\quotedblbase}\index{Amtsarzt}\Es{Amtsarzt}{\textquotedblleft},
...
\Married{Bei der Hitzeerschöpfung ist die Wärmeaufnahme
...
\Fazit{{\quotedblbase}Nobody is dead until warm and dead.{\textquotedblleft}
