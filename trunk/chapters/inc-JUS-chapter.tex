...
unverz\"uglich f\"ur eine Meldung an die
Polizei\gMarginNo{\includegraphics[width=\linewidth]{./images/polizei_funkwagen.jpg}}
gesorgt wird.
...
\begin{table}[H]
\gCaptionof{table}{Rechtslage: Gegenüberstellung rechtfertigender vs.
...
\begin{itemize}
	...
	\item 
	\gT{NKV} -
	\gMarginNo{\includegraphics[width=\linewidth]{./images/venflon_in_situ.jpg}}\gZ{{\S} 11 Abs. 1 Z 2} SanG: zusätzlich zu den oben genannten Kompetenzen darf der NKV jene Medikamenten der Arzneimittelliste 2 verabreichen, die \"uber ven\"osen Zugang verabreicht werden k\"onnen.
...
\begin{wrapfigure}{r}{5cm}
\includegraphics[width=\linewidth]{./images/teaser/emergency_physician_vehicle.jpg}
\end{wrapfigure}Sepp konnte sich nun dazu \"uberreden lassen keinen Venflon zu legen und
...
\gFazit{
	Die RTW-Mannschaft darf daher die f\"ur den Patienten	schädigende Anordnung ablehnen. Natascha hingegen macht
...
wird gem. \gZ{{\S}\,1298} ABGB das Verschulden des Beklagten
...
\begin{itemize}
	...
	\item sonstige f\"ur den Sanitäter entscheidend wirkende Umstände 
\end{itemize}

\gFazit{Grundsatz: Alles darf dokumentiert werden, es darf aber nicht Nichts
dokumentiert werden.}
...
\begin{itemize}
	\item {\mdseries
	Anonymität des Patienten bleibt gewahrt}
...
\gFazit{
	...
	Umgang mit dem Medizinprodukt zu K\"orperverletzungen kommen, wird aufgrund der mangelnden
...
\begin{wrapfigure}{r}{5cm}
\includegraphics[width=\linewidth]{./images/teaser/blut-tatort-jacke.jpg}
\end{wrapfigure}Dort angekommen finden sie in einer Lacke von Blut die 25 jährige Fr.
...
\begin{wrapfigure}{r}{5cm}
\includegraphics[width=\linewidth]{./images/trauma/haematom-fehlpunktion-001.jpg}
\end{wrapfigure}Die Schnittwunden am Handgelenk sind nicht die einzigen Verletzungen der
...
\paragraph{Allgemeine Pflichten}

 

\gMargin{§ 4. SanG} (1) Sanitäter haben ihre Tätigkeit ohne Ansehen der Person
gewissenhaft auszuüben. Sie haben das Wohl der Patienten und der betreuten Personen nach Maßgabe der fachlichen und wissenschaftlichen Erkenntnisse und Erfahrungen zu wahren. Nötigenfalls ist ein Notarzt oder, wenn ein solcher nicht zur Verfügung steht, ein sonstiger zur selbständigen Berufsausübung berechtigter Arzt anzufordern.

(2) Sanitäter haben sich tätigkeitsrelevant fortzubilden.


\paragraph{Dokumentationspflicht}

 

\gMargin{§ 5.} (1) Sanitäter haben bei Ausübung ihrer Tätigkeit die von ihnen
gesetzten sanitätsdienstlichen Maßnahmen zu \gEs{dokumentieren}.

(2) Den betroffenen Patienten oder betreuten Personen sowie deren gesetzlichen
Vertretern sind auf Verlangen \gEs{Einsicht} in die Dokumentation zu gewähren
und gegen Kostenersatz Kopien auszufolgen.

\gZ{(3) Die Aufzeichnungen gemäß Abs. 1 sind durch die Einrichtungen gemäß § 23
Abs. 1 mindestens zehn Jahre aufzubewahren.}



\paragraph{Verschwiegenheitspflicht}

\gMargin{§ 6. SanG} (1) Sanitäter sind zur Verschwiegenheit über alle ihnen in
Ausübung ihrer Tätigkeit anvertrauten oder bekannt gewordenen Geheimnisse verpflichtet.

(2) Die Verschwiegenheitspflicht besteht nicht, wenn
								
\begin{itemize}
    \item 1. nach gesetzlichen Vorschriften eine Meldung über den
Gesundheitszustand bestimmter Personen vorgeschrieben ist,

    \item 2. Mitteilungen oder Befunde an die Sozialversicherungsträger und
Krankenfürsorgeanstalten oder sonstige \gEs{Kostenträger} zur Wahrnehmung der
diesen übertragenen Aufgaben erforderlich sind,

    \item 3. der durch die Offenbarung des Geheimnisses Betroffene den
Sanitäter von der Geheimhaltung \gEs{entbunden} hat oder

    \item 4. die Offenbarung des Geheimnisses nach Art und Inhalt zum Schutz
\gEs{höherwertiger Interessen der öffentlichen Gesundheitspflege oder der
Rechtspflege} unbedingt erforderlich ist.
\end{itemize}

Das Strafgesetzbuch kennt noch eine härtere Variante: 



\subparagraph{Verletzung von
Berufsgeheimnissen: Strafrecht (!)}\gTag{Verschwiegenheit im Strafrecht}

\gMargin{§ 121. StGB}(1) Wer ein Geheimnis offenbart oder verwertet, das den Gesundheitszustand einer
Person betrifft und das ihm bei berufsmäßiger Ausübung eines gesetzlich
geregelten Gesundheitsberufes oder bei berufsmäßiger Beschäftigung mit Aufgaben
der Verwaltung einer Krankenanstalt oder mit Aufgaben der Kranken-, der Unfall-,
der Lebens- oder der Sozialversicherung ausschließlich kraft seines Berufes
...
worden ist, ist mit \gEs{Freiheitsstrafe} bis zu \gEs{sechs Monaten} oder mit
Geldstrafe bis zu 360 Tagessätzen zu bestrafen.

(2) Wer die Tat begeht, um sich oder einem anderen einen \gEs{Vermögensvorteil}
zuzuwenden oder einem anderen einen Nachteil zuzufügen, ist mit Freiheitsstrafe
\gEs{bis zu einem Jahr} oder mit Geldstrafe bis zu 360 Tagessätzen zu bestrafen.

(4) Den Personen, die eine der in den Abs. 1 und 3 bezeichneten Tätigkeiten
ausüben, stehen ihre \gEs{Hilfskräfte}, auch wenn sie nicht berufsmäßig tätig
sind, sowie die Personen gleich, die an der Tätigkeit zu
\gEs{Ausbildungszwecken} teilnehmen.

(6) Der Täter ist nur auf Verlangen des in seinem Interesse an der Geheimhaltung
Verletzten (Abs. 1 und 3) zu verfolgen.


\paragraph{Auskunftspflicht}

\gMargin{§ 7.} (1) Sanitäter haben
								
\begin{itemize}
    \item 1. den \gEs{betroffenen Patienten} oder den betreuten Personen,

    \item 2. deren \gEs{gesetzlichen Vertretern} oder

    \item 3. Personen, die von den betroffenen Patienten oder betreuten
Personen \gEs{als auskunftsberechtigt benannt} wurden,
\end{itemize}
alle Auskünfte über die von ihnen gesetzten Maßnahmen zu erteilen.

(2) Sie haben außerdem \gEs{anderen Angehörigen der Gesundheitsberufe}, \gEs{die
die betroffenen Personen betreuen (!)}, behandeln oder pflegen, die für die
Betreuung, Behandlung oder Pflege erforderlichen Auskünfte zu erteilen.
...
\begin{itemize}
    \item 1. Information über die neuesten berufseinschlägigen Entwicklungen
und Erkenntnisse und
    \item 2. Vertiefung der in der Ausbildung erworbenen Kenntnisse und
Fertigkeiten 
...
\paragraph{Rezertifizierungen}


\gMargin{§ 51} (1) Sanitäter sind verpflichtet, die Kenntnisse und Fertigkeiten
im Bereich der \gEs{Herz-Lungen-Wiederbelebung} einschließlich der
Defibrillation mit halbautomatischen Geräten binnen jeweils \gEs{zwei Jahren}
durch einen qualifizierten Arzt überprüfen zu lassen.

\gZ{(2) Die erfolgreiche Überprüfung der Kenntnisse und Fertigkeiten gemäß Abs.
1 ist im Fortbildungspass durch die Einrichtung gemäß § 23 Abs. 1, in der der Sanitäter
tätig ist, zu bestätigen. Die Eintragung berechtigt nach Maßgabe des § 16 zur
weiteren auf zwei Jahre befristeten Ausübung des Berufs bzw. von Tätigkeiten des
Sanitäters.}

\gZ{(3) Notfallsanitäter, die zur Durchführung der besonderen Notfallkompetenz
Intubation gemäß § 12 berechtigt sind, haben ihre Kenntnisse und Fertigkeiten
alle zwei Jahre durch einen qualifizierten Arzt überprüfen zu lassen.}

\gZ{(4) Die erfolgreiche Überprüfung der Kenntnisse und Fertigkeiten gemäß Abs.
3 ist im Fortbildungspass durch die Einrichtung gemäß § 23 Abs. 1, in der der Sanitäter
tätig ist, zu bestätigen. Die Eintragung berechtigt zur weiteren auf zwei Jahre
befristeten Ausübung der besonderen Notfallkompetenz Intubation.}

\gZ{(5) Die Berechtigung zur Durchführung der besonderen Notfallkompetenz
Intubation gemäß Abs. 3 ruht, wenn
								
\begin{itemize}
    \item 1.eine rechtzeitige Überprüfung nicht erfolgt ist oder
    \item 2.eine Überprüfung nicht erfolgreich bestanden wurde.
\end{itemize}}

\gZ{(6) Der Dienstgeber oder der Rechtsträger, zu dem Sanitäter tätig sind,
haben sicherzustellen, dass Möglichkeiten der Überprüfungen gemäß Abs. 1 und 3
gewährleistet sind.}


\subsubsection{Strafbestimmungen}

\gMargin{§ 53. Abs. 1 Z 3 SanG} Wer einer oder mehreren in § 5 Abs. 1 und 3
(Dokumentationspflicht), § 6 (Verschwiegenheitspflicht), § 22 Abs. 3 (Führung
einer falschen oder irreführenden Berufs- und Tätigkeitsbezeichnungen), § 23
(Ausübung der Tätigkeit abseits der vorgegebenen Bedingungen) und § 25 Abs. 2
(Rückgabe des Ausweises nach Entzug der Berechtigung) enthaltenen Anordnungen
oder Verboten zuwiderhandelt, begeht, sofern die Tat nicht den Tatbestand einer
in die Zuständigkeit der Gerichte fallenden strafbaren Handlung bildet, eine
Verwaltungsübertretung und ist mit einer \gEs{Geldstrafe bis zu 3 600 Euro} zu
bestrafen. \gEs{Der Versuch ist strafbar.}
...
Sanitätsdienst - Allgemein
  ...
  § 8. Der Sanitätsdienst umfasst den Tätigkeitsbereich des Rettungssanitäters
  und des Notfallsanitäters entsprechend die eigenverantwortliche Anwendung von
  Maßnahmen der
								
\begin{itemize}
    \item 1. qualifizierten Ersten Hilfe,

    \item 2. Sanitätshilfe und

    \item 3. Rettungstechnik,
\end{itemize}
...
\begin{itemize}
    \item 1. die \gEs{selbständige und eigenverantwortliche Versorgung und Betreuung
    kranker, verletzter und sonstiger hilfsbedürftiger Personen, die medizinisch
    indizierter Betreuung bedürfen, vor und während des Transports, einschließlich
    der fachgerechten Aufrechterhaltung und Beendigung liegender Infusionen nach
    ärztlicher Anordnung sowie der Blutentnahme aus der Kapillare zur
    Notfalldiagnostik},
    \item 2. die \gEs{Übernahme} sowie die \gEs{Übergabe} des Patienten oder
    der betreuten Person im Zusammenhang mit einem Transport,
    \item 3. Hilfestellung bei auftretenden Akutsituationen einschließlich der
    Verabreichung von Sauerstoff,
    \item 4. eine qualifizierte Durchführung von \gEs{lebensrettenden
    Sofortmaßnahmen} sowie
    
    \item 5. die sanitätsdienstliche Durchführung von Sondertransporten.
\end{itemize}
(2) \gEs{Lebensrettende Sofortmaßnahmen} sind
insbesondere

\begin{itemize}
    \item 1. die Beurteilung, Wiederherstellung bzw. Aufrechterhaltung der lebenswichtigen
    Körperfunktionen,
    \item 2. die Defibrillation mit halbautomatischen Geräten,
    \item 3. die Herstellung der Transportfähigkeit sowie die
    sanitätsdienstliche Durchführung des Transports,
\end{itemize}
solange und soweit ein zur selbständigen Berufsausübung berechtigter Arzt nicht
zur Verfügung steht. Eine unverzügliche Anforderung des Notarztes ist zu
veranlassen.
