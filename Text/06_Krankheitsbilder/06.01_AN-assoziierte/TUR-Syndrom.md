...
:::{index} single: Syndrom; TUR-
:::
:::{index} single: TUR-Syndrom
:::
...
Risikofaktoren
: Op-Dauer + Druck > 60 cm H₂O, Lagerung, Operateur, Alter d. Pat.
...
:::{seealso}
- {ref}`Transurethrale Resektion der Blase <TUR-B>`
- {ref}`Transurethrale Resektion der Prostata <TUR-P>`
:::
