...
\subsubsection{Definition Unfall (Bagatelle, Notfall)}
...
\subsubsection{Definition \index{Gro{\ss}unfall}Gro{\ss}unfall
...
\subsubsection{Definition \index{Katastrophe}Katastrophe (au{\ss}ergew\"ohnliche
Lage)}

griech.:  {\quotedblbase}Umkehr der normalen
Verh\"altnisse{\textquotedblleft} 

\gDefinition{Ein unvorhergesehenes Ereignis mit einem au{\ss}ergew\"ohnlichen
...
\subsubsection{Definition Individualmedizin}\index{Individualmedizin}
...
\subsubsection{Definition Katastrophenmedizin}\index{Katastrophenmedizin}
...
\paragraph{Sanit\"ater/NA und Not\"arzte m\"ussen F\"uhrungsaufgaben
\"ubernehmen}
...
\subsubsection{Sofortbehandlung vor Ort}
...
\subsubsection{Dringende Behandlung}
...
\subsubsection{Warten Leichtverletzte}
...
\subsubsection{Warten Schwerverletzte}
