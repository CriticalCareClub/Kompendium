\documentclass[ngerman,paper=a4,fontsize=9pt,headings=big,draft=no,parskip=half,noonelinecaption]{scrreprt}
...
\begin{description}
    ...
    0.6.0), für 0.8.0 (ET 2009/09)    \item[]
\end{description}
...
\\\addlinespace
\gTabSub{ANA} & Anatomie & \caps{Gabriel} &
