...
Erstversorgung von ungefähr 15 oder mehr Patienten (Richtwert) erfolgt
...
z.\,B. wenn sich der Zustand des Patienten ändert oder mehr Resourcen 
zur Verfügung stehen. Eine ständige Nachtriage ist daher erforderlich! 
...
\begin{itemize}
  \item \EE{Transportpriorität A}: Hohe Transportpriorität. Der rasche Transport zur
  frühzeitigen Fachbehandlung nach ärztlicher Notversorgung ist
  angesagt.
  \item \EE{Transportpriorität B}: Niedrige Transportpriorität. Der Transport zur Fachbehandlung
