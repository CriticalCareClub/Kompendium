...
\begin{itemize}
    ...
    \item Bildung von roten und weißen Blutkörperchen (im roten Knochenmark!)
    \gACh{GABS}{2010-03-09}{Wenn man die Körperchen aufzählt müssen die
...
\fxerror[author=GABS]{ANA: Knochenmark, rotes: Entweder lange oder kurze
Überschrift.} 
\paragraph{Das \gT{Rote Knochenmark} ist für die Blutbildung zuständig}
...
\fxerror[author=GABS]{ANA: Knochenmark, gelbes: Entweder lange oder kurze
Überschrift.} 
