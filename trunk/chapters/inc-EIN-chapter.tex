...
\begin{description}
    ...
    Ein Beispiel hierfür sind die Bewußtlosigkeit und der
...
\begin{description}
    ...
    \item[Obstruktion] Verlegung. z.B. im Rahmen der COPD
    \gSee{topic:copd}.
...
Wucherungen zwischen Karzinome, Sarkome und Blastome.}
...
\begin{enumerate}
    ...
    Sturkturen beengt oder behindert werden (Hirn,
    Luftröhre, \ldots).
...
Psychiatrische Erkankung, V.a. Wahnvorstellungen, Unterbringung nach UbG}
