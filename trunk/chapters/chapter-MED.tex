...
Bei der \Es{Lyse-Therapie} versucht man miittels eines speziellen
Medikaments eine Verstopfung aufzulösen. Mittels eines \Es{Herzkatheters}
...
\Layout{0}{\TxSymptome}
{ 
Der Patient berichtet berichtet über Schwindel, evt. ist er zusammengesackt,
...
\begin{itemize}
  \item Schwindel. 
  \item evt. kurze Bewusstlosigkeit, Ohnmacht, Schwarzwerden vor Augen. 
  \item RR ${\downarrow}$, evt. Bradykardie oder Tachykardie. 
\end{itemize}
}{}{}{}
...
{
Ursächlich für die Bildung eines Blutgerinnsels ist miestens eine verminderte
...
auch scherzhaft als\index{Economy class Syndrom}\T{Economy class Syndrom}
bezeichnet.
