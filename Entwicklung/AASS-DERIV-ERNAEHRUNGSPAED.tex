...
% Titel
\input{./inputs/input-title-DERIV-ERNAEHRUNGSPAED}

% Dokumenteinfos (Status, Version, ...)
\input{./inputs/input-docinfo-DERIV-ERNAEHRUNGSPAED}
...
\input{./inputs/input-includeonly-DERIV-ERNAEHRUNGSPAED}

% optional --- Optionaler Text. 
\input{./inputs/input-optkeys-DERIV-ERNAEHRUNGSPAED}
