...
\begin{itemize}
  ...
  \E{Einzelfall} zu entscheiden: Das Wohl des Patienten
  bleibt oberstes Gebot und die Verfügung soll in die
  Entscheidung
  einfließen.\index{Patientenverfügung!Unterlassung der
  Reanimation} (Bis zur zweifelsfreien Klärung der Situation
  muss jedenfalls eine Reanimation begonnen bzw. fortgeführt
  werden!)
...
Fahrbahn in einen vollständig sicheren Raum neben der
Fahrbahn zu retten.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TODO : Liegender Patient: Neuerstellung
...
miteinander verknüpft, dass ohne dem Einen das Andere nicht
funktioniert.
}{
\begin{itemize}
...
Sollte der Patient darauf nicht reagieren, muss im Bereich
des Kopfes ein \EE{Schmerzreiz} gesetzt werden. Jede
...
Möglichkeit Halsschlagaderblutungen zu stoppen}. Nachteil an
...
Abdrückstelle in der jeweiligen Schlüsselbeingrube.
...
allen Mitgliedsstaaten der EU anwendbar ist.
Bei Wählen dieser Nummer wird man zu einer Stelle
...
Sitzwache/Patientenbeobachtung, etc.\footnote{Zuerst werden
...
(\I[Ischämie!Akutes
Koronarsyndrom]{Ischämie}\footnote{\T{Ischämie}  bezeichnet
die akute Unterversorgung eines
...
Herzmuskel. 
\SourcePicture{Patrick J. Lynch, CC-BY-2.5}]{\includegraphics[width=0.23\linewidth]{./images/wikipedia-cc-by/Heart_coronary_artery_lesion-lq.jpg}}
\hfill
...
Herzens(\I[Ischämie!Angina pectoris]{Ischämie}), die Folge
sind Schmerzen, Atemnot und ein
Leistungsverlust!
...
\Definition{Plötzliche Tachykardie ohne erkennbare Ursache,
wobei der Patient
...
klagt oft über ein \EE{\enquote{Herzklopfen}} und ist
unruhig. Manchmal wird der Anfall von
...
Akuten Abdomens ist oft nicht ganz eindeutig: Einerseits
kann man da\-runter jede plötzlich auftretende
Baucherkrankung
...
{%
\ACh{GABG}{2009-05-07}{NEU}Im Vordergrund der akuten
Appendizitis steht anfänglich meist ein als eher diffus
empfundener, heftiger Schmerzzustand im Bereich der
Nabelgegend\ACh{GABS}{2009-05-07}{Magengegend -->
Nabelgegend}, der innerhalb weniger Stunden in den rechten
Unterbauch wandert. Übelkeit, Brechreiz und Verstopfung
\ACh{GABS}{2009-05-07}{Obstipation --> Verstopfung} können
das Krankheitsbild begleiten. Meist ist die Körpertemperatur
bis 38\DegC{} leicht erhöht \ACh{GABS}{2009-05-07}{gelöscht
da unerheblich für RS: , wobei eine rektale und axilläre
Messung eine Differenz um ca. 1\DegC aufweist}.
\ACh{GABS}{2009-05-07}{alt: Unbehandelt kann der weitere
Verlauf durch eine Abszeßbildung und Perforation in die
Bauchhöhle gekennzeichnet sein. neu: Unbehandelt kann es zu
einer Eiterung und einem Durchbruch in die Bauchhöhle
kommen.} Unbehandelt kann es zu einer Eiterung und einem
Durchbruch in die Bauchhöhle kommen. In diesem Stadium
entwickelt sich ein \ACh{GABS}{2009-05-07}{alt:
Schockzustand, der eine absolute Lebensbedrohung darstellt;
neu: akutes Abdomen, siehe \ref{topic:akutes-abdomen}}
akutes Abdomen (\prettyref{topic:akutes-abdomen}).
...
\Definition{Blutungen im Magen-Darm-Trakt bzw. blutende
\enquote{Krampfadern} in der
Speiseröhre.}\nopagebreak[4]
...
\Definition{„Austrocknung“: Es besteht ein hochgradiges
Defizit von Flüssigkeit im Körper.}
...
\begin{itemize}
    ...
    \item Medikamente\footnote{Nicht-steroidale
    Antirheumatika (NSAR), wie z.\,B.
