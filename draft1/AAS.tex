...
\addtokomafont{chapter}{\Huge\color{darkBlue}}
\addtokomafont{section}{\huge\color{darkBlue}}
\addtokomafont{subsection}{\LARGE\color{darkBlue}}
...
\newcommand{\gDefinition}[1]{\addlinespace{\mdseries\color{Terminus}\rmfamily\textit{{\bfseries{Definition:
}}#1}}\addlinespace}
...
und eine Einf\"uhrung in die Welt der Medizin und Sanitätshilfe\par
\end{center}
...
\part{Tätigkeitsbild und Orientierung}
...
\section{Vertragsverhältnis im Rettungswesen}
...
\\
 &
	...
	\Rnode{erfgeh}{(Not)Arzt/Sanitäter}}\par
...
(Not-)Arzt/Sanitäter erf\"ullt werden. Gleichzeitig treffen auch die
Organisation und den Sanitäter Rechte und Pflicht im Umgang
miteinander.
...
\section{Teil A: Gefahrenbekämpfung}
...
ganze Nacht durchgemacht und ist schon weitläufig bekannt f\"ur seine
...
\subsection{Fall 4. Aufklärung und Einwilligung}
...
\section{Teil D: Rechte und Pflichten des Sanitäters}
...
\subsection{Fall 7. Sanitäterkompetenzen}
...
\subsection{Fall 12. Verletzung des Pat. durch Sanitäter:}
...
\subsection{Fall 13. Sachbeschädigung}
...
\part{[RS IX] Gerätelehre und Sanitätstechnik}
...
\part{[RS VI] Krankheiten und Notfälle}
...
Abhängig davon wie gut der KÃ¶rper mit der Einschränkung zurecht kommt unterteilt man: 
\begin{description}
...
\gDefinition{Verschlu{\ss} eines oder mehrer Herzkranzgefä{\ss}e mit
...
\begin{supertabular}{m{4.367cm}m{4.367cm}m{4.367cm}}
\toprule
Rhythmus & Bedeutung & Bemerkung
\\\midrule
Kammerflimmern & Reanimation  & ?
\\
Pulslose Ventrikuläre Tachykardie & Reanimation & ?
\\
...
\begin{itemize}
    \item {\mdseries
    Widerstandserh\"ohung (durch Engstellung der Gefä{\ss}e)}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item {\mdseries
        Herzkranzgefä{\ss}e ${\rightarrow}$ Infarkt}
        
        \item {\mdseries
        Hirngefä{\ss}e ${\rightarrow}$ Schlaganfall}
        
        \item {\mdseries
        Nierengefä{\ss}e ${\rightarrow}$ Niereninsuffizienz ${\rightarrow}$
...
\section{\marginpar{Gefäßverschlüsse}Gefä{\ss}verschlüsse
in den Extremitäten}
...
\subsection{Arterieller Gefä{\ss}verschlu{\ss}}
...
\marginlabel{Chronische Gefäßschädigung}Meistens liegt eine
chronische Schädigung der Gefäße infolge anderer Erkankungen oder aufgrund eines ungesunden
...
der \marginlabel{\gT{periphere arterielle
Veschlußkrankheit}, Abkz. \gT{paVK}}\gT{peripheren
arteriellen Veschlußkrankheit}, abgekürzt \gT{paVK}. Sie ist eine chronische
...
\begin{tabular}{cll}
\toprule
\multicolumn{3}{}{\gEs{Arterieller Gefäßverschluss}}\\
...
\chapter{Respiratorische / Pulmologische  Notfälle}
...
\section{COPD - Chronic obstructing pulmonary disease}
...
\section{Lungenembolie\label{bkm:RefHeading37612625}}
...
\chapter{Neurologische Notfälle}
...
Abhängig welche Hirnregion betroffen ist. Die Symptome können sehr
...
\begin{gMassnahmenEnv}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item
            Lagerung: \gE{leicht erhöhter Oberkörper},
...
{\mdseries = eitrige Entz\"undung der Hirnhäute}
...
\gAuthNotes{
FEHLT: Querverwis Meningimus\\FEHLT: Ma{\ss}nahmen}
...
Vom Gehirn ausgehende motorische Krampfanfälle aufgrund von akuten
...
\begin{itemize}
    ...
    \item {\mdseries
    können sich ev. zu grand mal-Anfällen  ausweiten}
...
aufklären was passiert ist, wo er sich befindet, etc.
...
\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
Möbel etc. entfernen oder polstern}
...
\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
{\textgreater} 2 Anfälle in 24 Stunden, }
...
\begin{itemize}
\item {\mdseries
Anfälle {\textgreater} 15 Minuten oder}

\item {\mdseries
wiederholte Anfälle in kurzem Intervall}
...
\item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
neurologische Notfälle -- Epilepsie}
...
\item {\mdseries
ABKL\"ARUNG  der Ursache in diesen  Fällen wichtig!}
...
\end{itemize}
\chapter{Metabolische Störungen (Stoffwechselstörungen)}
{\mdseries
...
\chapter{Schwangerschaft und geburtshilfliche Notfälle}
{\mdseries\itshape
...
\end{itemize}
\chapter{Pädiatrie - Kinderheilkunde}
{\mdseries\itshape
Michael Withofner, Dr. med. univ.}
...
\end{itemize}
\chapter{Systemische Hitzeschäden}
{\mdseries
...
\part{[RS VII] Traumatologische Notfälle}
...
\part{ILS: Minimalinvasive Tätigkeiten und Behandlung}
