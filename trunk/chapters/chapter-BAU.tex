\chapter{[BAU] Basisuntersuchungen}
...
Die Messung des Blutdrucks ist unter \See{topic:rr-messung} beschrieben.
...
\See{topic:blutgefaesse-wichtige} besprochen.}} 
...
Blutgefäßsystem, der  während der \E{Auswurfsphase} des Herzens, in der sich
...
Druckmanschette\ZFootnote{Mittels der Durckmanschette wird gemessen, bei welchem
Druck ein mittels Stethoskop hörbarer, mittels Pulstasten fühlbarer oder mittels
sonstiger technischer Hilfmittels messbahrer Blutfluß stattfindet. Dies erlaubt
Rückschlüsse auf den Druck im Blutgefäß.}. Dazu gibt es unterschiedliche
...
elektronische Blutdruckmessgeräte, welchezum Beispiel in
Überwachungsmonitoren zum Einsatz kommen. Alelrdings sind auch diese Geräte 
mitunter fehleranfällig, wenn die Messbedingungen nicht optimal
(z.\,B. erschütterungsfrei) sind.
...
\TODO{GABS}{2010-04-27}{Bilder Blutdruckmesser}{Verscheidene Typen}
\end{center}
}{
...
\TODO{GABS}{2010-04-27}{Grafik RR-Geräusche vorbereiten}{Grafik gibt es schon
von HIRT}

   
    \Captionof{figure}{\AuthNotesPicLegalNotOk{GER-rr-geraeusche.png}{}Prinzip
...
\ldots}
\begin{inparaenum}
	\item \ldots\ eines \Es{Shuntarmes}\footnote{Ein (Dialyse-)\Es{Shunt} ist ein
	künstlicher Kurzschluss zwischen einer Armarterie und einer Armvene. Dadurch wird
		...
		\item \ldots\ eines Armödems, z.\,B. nach einer
		Brustamputation, oder
		\item \ldots\ einer Halbseitenschwäche oder -lähmung 
\end{inparaenum} 
angelegt werden.
...
\T{Sauerstoffsättigung} (\T{Sp\ce{O2}}) des kapillären
...
(\nicefrac{mg}{dl}\Z{, enspricht mg\,\%}) gemessen. Der
...
\fxwarning[author=GABS]{BZ-Messung mit Streifen: Neuerstellung von Grafik/Text 
                          notwendig}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
(\E{rektal}, v.a. bei Kleinkindern) bestimmt werden. Die
...
\end{enumerate}
  ...
  Nackensteifigkeit wird unter \See{topic:meningitis}
...
\Layout{0}{Ausführlicher Traumacheck}
{
Der
...
\MarriedNG{Schneller Traumacheck}
{
