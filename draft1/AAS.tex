...
\renewcommand{\labelitemi}{\textcolor[rgb]{0.0,0.0,0.5019608}{$\rhd$}}
...
\chapter{Einf"uhrung in die Medizin}

\paragraph*{Einteilung} Notf\"alle kann man mehr oder weniger willk\"urlich einteilen

\begin{itemize}
	\item {\mdseries
	St\"orungen des Bewu{\ss}tseins --  neurologische Notf\"alle}
	...
	\item {\mdseries
	Gef\"a{\ss}verschl\"usse}

	\item {\mdseries
	Abdominelle Notf\"alle}
...
\begin{description}
	...
	\item[\gT{Komplikationen}] m\"oglicherweise auftretende
	Schwierigkeiten
...
\chapter[Herz-Kreislaufst\"orungen]{Herz-Kreislaufst\"orungen}
...
\begin{itemize}
    \item {\mdseries
    Ven\"ose Insuffizienz (Krampfadern =  Venenaussackungen aufgrund
...
\chapter{Respiratorische / Pulmologische  Notf\"alle}
\subparagraph*{
...
\hline
{\mdseries Wiederholte Anf\"alle von Atemnot durch}
...
\begin{itemize}
    \item {\mdseries akute Atemnot mit trockenem Husten}
    
    \item {\mdseries exspiratorischer Stridor (Brummen, Pfeifen,  Giemen)}
    
    \item {\mdseries Einsatz der Atemhilfsmuskulatur}
    
    \item {\mdseries Verl\"angerte Ausatmungsphase}
    
\end{itemize}
\subparagraph*{Komplikationen}
...
\begin{itemize}
    \item {\color[rgb]{0.0,0.0,0.5019608}
    Erstma{\ss}nahmen bei vital bedrohten Patienten: Starke Atemnot ohne
    Besserung}
...
\begin{itemize}
    ...
    \item {\color[rgb]{0.0,0.0,0.5019608}
    Erstma{\ss}nahmen bei nicht vital bedrohten Patienten: Leichte Atemnot,
    Besserung}
...
\begin{itemize}
    ...
    \item {\color[rgb]{0.0,0.0,0.5019608}
    O2 ca. 6~l, bei Bedarf bis zu 15~l}
...
\begin{itemize}
    \item {\mdseries\color[rgb]{0.0,0.0,0.5019608}
    Sauerstoff: VORSICHT:  O2 Vorsichtig dosieren, nur 2-3 l/ min. und
    Atmung \"uberwachen.\newline
    Wenn der Patient bereits Heimsauerstoff verordnet hat 1-2 l/min h\"oher
    stellen und Atmung \"uberwachen!\newline
    Heimsauerstoff muss weiter gegeben werden!}
...
&
{\mdseries Tiefe (Bein-)Venenthrombose}

{\mdseries Immobilisation (Gips, lange Reise)}

{\mdseries Herz: Bei Rhythmusst\"orungen}

{\mdseries Tumorpatienten}
...
\item {\mdseries
Erkrankeungen des St\"utzapparates (Wirbels\"aule, Bandscheiben)}
...
\begin{itemize}
\item {\mdseries
Gef\"a{\ss}verschlu{\ss} (isch\"amischer Insult)}

\item {\mdseries
Blutung (h\"amorrhagischer Insult)}
...
\begin{itemize}
\item {\mdseries
Symptome wie bei Insult, vergehen aber innerhalb von 24 Stunden.}
...
\begin{itemize}
\item {\mdseries
Halbseitenschw\"ache oder -l\"ahmung, h\"angener Mundwinkel}
...
\item {\mdseries
{\quotedblbase}wirre Sprache{\textquotedblleft}: Worte fehlen, Silben
werden vertauscht, ...}

\end{itemize}
\begin{itemize}
\item {\mdseries
Sehst\"orungen, pl\"otzliche Erblindung, Doppelbilder,
...
\item {\mdseries
pl\"otzlicher, rasender Kopfschmerz, Schwindel}

\item {\mdseries
in schweren F\"allen bis Bewu{\ss}tlosigkeit}
...
\item {\mdseries
Narbengewebe nach Insult, Hirnverletzung}

\item {\mdseries
Hirnblutung, Isch\"amie}

\item {\mdseries
BZ }

\item {\mdseries
angeboren, ohne organisch fa{\ss}bare  Ursache}
...
\begin{itemize}
\item {\mdseries
motorisch: Jackson-Anfall}

\item {\mdseries
{\quotedblbase}Jacksonian march{\textquotedblleft}}
...
Stoffwechselerkrankungen mit  gest\"orter Blutzuckerregulation, daraus 
resultierend:}

\begin{itemize}
\item
\gT{Hyp}\gT{o}\gT{glyk\"amie}
... Unterzucker

\item
\gT{Hyp}\gT{er}\gT{glyk\"amie}
... {\quotedblbase}\"Uberzucker{\textquotedblleft}
...
\begin{itemize}
\item {\mdseries
\gT{Diabetes mellitus Typ I}  \gZ{(IDDM,
insuline dependent)} ... keine Insulinproduktion des K\"orpers, muss 
immer Insulin spritzen }

\item {\mdseries
\gT{Diabetes mellitus Typ II}
...
ist das Risiko f\"ur Schlag\"anf\"alle erh\"oht.}
...
\begin{minipage}{4.2cm}
{\mdseries
\textbf{Erinnere Dich}: Hyperventilationstetanie ${\rightarrow}$
...
\part[RS II{]} Hygiene ]{[RS II] Hygiene }
