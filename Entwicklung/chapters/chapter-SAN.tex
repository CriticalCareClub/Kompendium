...
ist oder einzutreten droht ("`Notfallpüatient"'), soll,
...
dabei den Buchstaben "`C"', die restlichen drei Finger heben
das Kinn am Unterkiefer an.
...
in normalerweise in einer normalen Atemfrequenz
("`\EE{Eigenfrequenz}"') erfolgen. Wird zu schnell (und
...
bewusstseinsklare Patienten zu oder vom Fahrzeug zu
...
\FormatTable
\begin{WidePar}
\Captionof{figure}{Bilderserie: Helmabnahme und Anlage
einer
HWS-Schiene
\SourcePicture{Motal}\label{fig:helmabnahme-hws-schiene}\label{fig:hws-schiene-anlegen}}
...
\hfill
\subfloat[Den Kopf sofort mit den Händen fixieren, Visier öffnen und Patienten ansprechen.]
...
{\includegraphics[width=0.32\linewidth]{./images/motal-aass/00800/hwsschiene3.jpg}}
...
\begin{description}
  ...
  alternativ verwendet werden. \cite{AsboeLehrmeinung2011-10}
...
{Beißkeil (hier: Güdel-Tubus) einführen}
