...
\gDefinition{Flüssigkeitsansammlung Stau in den Alveolen und
...
\item kompensatorisch Kussmaul{\textquotesingle}sche Atmung
(\ce{CO2} - Abatmung)
...
\begin{itemize}
    ...
    \item Kussmaul{\textquotesingle}sche Atmung (sehr tief und schnell)
...
anderen vor bestehenden Erkrankungen des Patienten und der
...
ist eine der gefürchtetsten Komplikationen der Spätschwangerschaft.
...
Atemgeräusche
\\\hline
\gTabSub{Puls tasten beim Säugling}
&
...
an einen massiven Leidens druck zu haben.
\end{quotation}
...
Suizid- oder sonstige selbst schädliche Handlungen nicht auf
...
diesen bei zuziehen. Bescheinigt der Arzt das Vorliegen der
...
Im Zweifelsfall Polizei nach alarmieren...
...
\item Flachlagerung an kühlem Ort (Schatten), Beine und Kopf hoch lagern
...
\item Vitale Bedrohung einschätzen.
    ...
    \item Flachlagerung an kühlem Ort (Schatten), Kopf hoch lagern
    \item beengende Kleidungsstücke lockern
...
34{\textdegree}-30{\textdegree}C, Bewusstseinstrübung, Kälte starre,
...
\begin{description}
    ...
    Insektenstich)
    \item[Über die Haut] transkutan : fett lösliche Substanz kann  Hautbarriere durchdringen
...
Atemdepressionen, d.h. die Atemfrequenz wird Dosis abhängig
...
Psychisch kommt es Dosis abhängig zu Halluzinationen
