...
\begin{itemize}
    ...
    \item Viren
    \begin{itemize}
        \item sehr klein, im Mikroskop i.d.R. nicht
...
\paragraph{AIDS}
Nach ca 5-10 Jahren bricht die eigentliche Erkrankung,
das AIDS, aus.

\paragraph{Therapie}

\begin{itemize}
    \item Derzeit ist keine Heilung möglich, jedoch kann
    eine deutliche Lebensverlängerung durch Medikamente
    erreicht werden.
\end{itemize}
...
\caption{Öffnen von sterilen Material unter verschiedenen
