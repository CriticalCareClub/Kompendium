...
\Text{Kompetenzlevel}
{Die Kompetenzlevel des Zielpublikums der einzelnen Inhalte der {\AASS} 
sind wie in der folgenden Tabelle gegliedert:}
...
\setlength{\parskip}{0pt}%
  ...
  \item[Abk.]   Abkürzung
  \item[Abs.]   Absatz
  \item[ACS]    \Lang{engl.} Acute coronary syndrome: Akutes Koronarsyndrom
