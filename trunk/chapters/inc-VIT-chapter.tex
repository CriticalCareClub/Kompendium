...
\\\bottomrule
\end{tabulary}
\gCaptionof{table}{Wachheitszustände}
\end{center}
\end{table}
...
Beispiel: Bewusstseinsklarer Patient: 15 Punkte. Toter Patient: 3 Punkte (nicht
0!)
...
\begin{table}[H]
\gCaptionof{table}{GCS - Glasgow Coma Scale}
...
Sauerstoffkonzentration \\\midrule
\gTabSub{Wie oft?}
& 
Herzfrequenz 
...
\\\bottomrule
\end{tabulary}
\gCaptionof{table}{Symptome: Atmung.}
\end{table}
\end{center}
...
\begin{center}\gCaptionof{table}{Stadien der Anaphylaxie}
...
\gCaptionof{figure}{Diffusion. \gSourcePicture{Fischer}}
\end{center}}
...
Elektrolytstörungen}\index{Elektrolytstörungen}
...
\gFazit{Wer zu viel atmet wird basisch und spürt ein
Kribbeln in den Fingern.}

\gFazit{Wer Probleme mit dem Stoffwechsel hat kann auch
