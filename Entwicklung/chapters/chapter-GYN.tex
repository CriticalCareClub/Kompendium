...
fortgeschritten ist bzw. die Frucht entwickelt ist. Oft kommt es zu einem Abort
bevor die Frau überhaupt weiß dass sie schwanger gewesen ist; er macht sich dann
vor allem durch eine \Es{vaginale Blutung} bemerkbar, die mitunter als
\Speech{"`verstärkte Regelblutung"'} fehlgedeutet wird. Weiters kann es zum
\Es{Abgang von Gewebsteilen} und \Es{Unterbauchschmerzen} kommen. 

Eine Fehlgeburt kann jedoch auch zu einem späteren Zeitpunkt während der
Schwangerschaft vor Erreichen der Lebensfähigkeit des Kindes
vorkommen\ZFootnote{Danach spricht von einer \E{Totgeburt}}. 
}{
\begin{itemize}
