...
\TabSub{Szeneüberblick m. Schutz}
&
Sicherheit, Selbstschutz; Großschaden?; Umgebung, Ort, Zeit;
Trauma?; Umstände, Hinweise auf Unfallmechanismus
\\\addlinespace\midrule\addlinespace
\noindent\T{GI}
...
&
{\eye} \emph{Blässe, Zyanose, Schweiß,
...
Bedrohung unklar ist.

Inkludiert relevante Teile der (Fremd-)Anamnese
...
\end{wrapfigure}Die Übergabe des Patienten in den
...
\MassnahmenNG{Stabdardmaßnahmen}{Reanimationsbereitschaft}
{%
\begin{enumerate}
...
\begin{labeling}{mmm}
  \item[\cite{SudoweProfHandelnRD1}]
  \emph{\bibentry{SudoweProfHandelnRD1}}
