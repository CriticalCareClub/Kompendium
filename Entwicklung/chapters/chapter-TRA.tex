...
auf mögliche bzw. wahrscheinliche Verletzungen des Patienten geben. Eine
detaillierte Analyse des Unfallhergangs kann durch die
...
\end{itemize}
\cite{ITLSde6}, \cite{RedelsteinerHRNS1}
...
Auswirkung auf den Schweregrad des Unfalls hat. Je
schneller das Fahrzeug unterwegs war, desto schwerer kann die Verletzung sein. \Z{Dabei steigt die Bewegungsenergie des Fahrzeugs  mit dem
...
schwer verletzt sind. Stellt sich also bei der Behandlung
eines Patienten eine schwere Verletzung heraus, muss es zu
einer neuen Lageeinschätzung kommen.
...
\Layout{0}{Frontal- und Heckzusammenstöße}{%
...
Stellt man im Szeneüberblick fest, dass
 ...
 In \cite{BoehmerTaschRett6} S.\,357 sind folgende Faustregen angegeben:
\begin{itemize}
  ...
  Fahrbahn an Bremsspure, die länger als \VonBis{10}{20}\Meter* sind, erkannt werden.)
...
\begin{itemize}
  ...
  Verletzungen zu rechnen, ab einer Fallhöhe von \E{6\Meter*} ist von einem \E{Polytrauma} (\ref{topic:polytrauma})
...
werden zu \EE{penetrierende Verletzungen} zusammen gefasst.\footnote{\Z{lat. penetrare:
...
% Die unterschiedlichen Wundarten benötigen
...
% 
% Je nach Stärke der Blutung werden Wunden zunächst durch
% Hochhalten des betroffenen Körperteils und anschließend mit
% einem Wundverband, einem Druckverband oder in extremen Ausnahmesituationen durch Abbindung versorgt. Als
...
der blutzuführenden Arterie, Druckverband und Abbinden) sind im Kapitel
\ref{chp:EHI} beschrieben. Der professionelle Helfer muss
neben den Erste-Hilfe-Maßnahmen zusätzlich Prioritäten bzgl.
...
Schmerztherapie nachfordern. Im Folgenden sind wichtige
Grundprinzipien der präklinischen Wundversorgung
aufgelistet.
...
\begin{itemize}
  ...
  Besitzer des Tieres ist. Unter Umständen kann es notwendig sein die Polizei
  einzuschalten.
...
manchen Büchern, z.\,B. in \cite{Gorgass7}, wird ein offener Knochenbruch durch eine direkte Verbindung zwischen Wunde und Bruchstelle
...
luxierte Gelenk im menschlichen Körper. \Z{45\,\% aller
...
Helfer z.\,B. durch die Glasgow Coma Scale einschätzen.}
