...
\section{Betreuung in der \HeadingKeyword{Schwangerschaft}}

Vgl. \FullPrettyRef{topic:schwangerschaft}.


\subsection{\HeadingKeyword{Notfälle} in der \HeadingKeyword{Frühschwangerschaft}}
\label{topic:notfall-fruehschwangerschaft}

\subsubsection{\HeadingKeyword{Fehlgeburt}}
...
\cite{HaagGyn2007,ForMed2}}%DefinitionInPara
%
...
\subsubsection{\HeadingKeyword{Eileiterschwangerschaft}}
...
\begin{Synopsis}
  \SynopsisItem{Bei Frauen mit akutem Abdomen muss immer eine mögliche
...
% \clearpage % TEMP temp clearpage
\subsection{\HeadingKeyword{Notfälle} in der \HeadingKeyword{Spätschwangerschaft}}
\label{topic:notfall-spaetschwangerschaft}

\subsubsection{Vorzeitige \HeadingKeyword{Plazentalösung}}
...
\subsubsection{\HeadingKeyword{Vena-cava}-Kompressionssyndrom}
...
\begin{Synopsis}
  \SynopsisItem{\EE{Jede hochschwangere Patientin} soll in (leichter)
...
\subsubsection{\HeadingKeyword{Präeklampsie}, EPH-Gestose, HELLP-Syndrom, \HeadingKeyword{Eklampsie}}
...
\begin{Synopsis}
  \SynopsisItem{Die \E{Prä}eklampsie (EPH-Gestose) kann zu einem
...
\subsubsection{Vorzeitiger \HeadingKeyword{Fruchtwasserabgang}}
...
\clearpage
\section{\HeadingKeyword{Geburtshilfe}}

\subsection{Die \HeadingKeyword{Geburt}}
\label{topic:geburt}
\index{Geburt}
...
{%
Die \T{Eröffnungsphase} beginnt mit den ersten regelmäßigen
...
\begin{Danger}
  \item Ab dem Blasensprung darf die Gebärende nicht mehr aufstehen,
...
{%
Die \T{Austreibungsphase} beginnt mit der
...
\cite{AsboeLehrmeinungRd2011-20}.
...
{}{}
%\PictureSeriesRowWide{1}
%{./images/pallinger-christoph-aass/Partus_Set_aufgelegt_33048-01445pt}
%{Durchtrennung der Nabelschnur, die patientenferne Klemme ist durch die Hand verdeckt. \SourcePicture{WMC: \enquote{Jeremykemp} / PD}}
%{./images/wikipedia-pd/Navelklem.jpg}{Abgeklemmte Nabelschnur \SourcePicture{WMC: \enquote{Harmid} / PD}}
%{./images/wikipedia-pd/Umbilicalstump.jpg}{Nabelschnurstumpf nach sieben Tagen \SourcePicture{WMC: \enquote{Fatrabbit} / PD}}
%{}{}
...
\subsubsection{Die \HeadingKeyword{bevorstehende Geburt}}
...
\subsubsection{Der \HeadingKeyword{Geburtsvorgang} und Versorgung des \HeadingKeyword{Neugeborenen}}
...
\PictureWide
[h]% Float
{Set für eine Geburt (Partus-Set)}% Titel
{Verbandsmaterial, 
saugstarke Tücher, 
Nabelklemmen (2 Stk.), 
Orosauger, 
...
Klebeband, 
Schere, 
Verbandspäckchen}% Beschreibung
{\label{fig:partus-set}}% Label
{Christoph Pallinger}% Quelle
{MfG}% Lizenz
{./images/pallinger-christoph-aass/Partus_Set_aufgelegt_33048-01445pt}% Datei
{}% Breitenmodifizierer
...
\begin{Danger}
  \item Die Versorgung des Neugeborenen hat absoluten Vorrang 
...
\subsection{\HeadingKeyword{Notfälle} während und unmittelbar nach der \HeadingKeyword{Geburt}}
\label{topic:notfall-geburt}

\subsubsection{\HeadingKeyword{Basisreanimation} des Neugeborenen}
\label{topic:reanimation-neugeborenes}
...
% TODO Grassl Foto: Basisreanimation des Neugeborenen

\subsubsection{\HeadingKeyword{Asphyxie} während der Geburt}
...
\subsubsection{\HeadingKeyword{Nabelschnurvorfall}}

\Text
{{\TxBeschreibung}: Nabelschnurvorfall}%1 Überschrift
{%
...
Strangulation des Kindes.}%2 Text
...
\subsubsection{Die \HeadingKeyword{Placenta praevia} liegt im Geburtskanal}
...
\subsubsection{Pathologische \HeadingKeyword{Geburtslagen}}
...
\subsubsection{\HeadingKeyword{Uterusruptur}}
...
\subsubsection{\HeadingKeyword{Blutungen} in der Nachgeburtsperiode}

\TextSlide
{\TxBeschreibung}
{%
Blutungen in der Nachgeburtsperiode können sehr
schwerwiegend sein und können verschiedene Ursachen haben.
Der Blutverlust kann sehr hoch sein und vom hypovolämischen
Schock bis zum Kreislaufversagen führen.
Eine häufige Ursache ist die \T{Uterusatonie}:
Normalerweise zieht sich in der Nachgeburtsphase die
Uterusmuskulatur zusammen und komprimiert somit die Blutgefäße. Bei der Uterusatonie 
kommt es jedoch zur
Erschlaffung (Atonie) der Gebärmutter, die Folge sind
lebensbedrohliche Blutungen durch das Fehlen der Kontraktion
des Uterus nach der Plazentalösung.}
{
\begin{itemize}
  \item Starke Blutungen möglich!
  \item Uterusatonie: Erschlaffung der Gebärmutter
  \item Hypovolämischer Schock bis Kreislaufversagen möglich
\end{itemize}
}
{}
{}
...
\ProcedurePrintDefault{GO72000C}


% \clearpage % TEMP temp clearpage
\section{\HeadingKeyword{Sonstige} gynäkologische Erkrankungen und Notfälle}

\subsection{Vaginale \HeadingKeyword{Blutungen}}
...
bei Kindern darf man \E{nicht} automatisch von einem
