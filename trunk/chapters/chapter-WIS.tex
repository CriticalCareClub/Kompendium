...
\Es{Empfehlungen} und Leittlinien zur Diagnostik, Therapie und Vorbeugung
u.ä. Diese Empfehlungen sind nicht "`gesetzlich bindend"', aber geben i.d.R.
den \Es{Stand der Wissenschaft} wieder. Ausserdem müssen diese, oft allgemein
...
"`Guidelines\footnote{{\flq}engl.{\frq} \emph{Guideline}: Richtlinie,
