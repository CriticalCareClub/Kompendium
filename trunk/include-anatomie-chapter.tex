...
Tritt Liquor in die Umwelt aus (Nase, Ohr, ...)  ist das
...
\begin{itemize}
    \item Nasennöhle mit Nasennebenh\"ohlen
    \item Mundhöhle
...
Seiten und die Pleuraflüssigkeit fungiert sogar ein
bisschen als "`Schmiermittel"'). 

Wenn sich nun der Brustkorb oder das Zwerchfell bei der Atmung bewegt
bewegt sich natürlich das Rippenfell mit (es ist ja mit dem Brustkorb
und dem Zwerchfell verwachsen). Da der Pleurazwischenraum luftdicht ist
muss sich zwangsläufig aber auch das Lungenfell (an dem
...
Frage: Was würde passieren wenn der Zwischenraum zwischen
den Pleurablättern aufgrund einer Verletzung (Z.B. ein Loch
nach einer Stichwunde in die Brust) nicht mehr luftdicht ist? Antwort: s.
\footnote{Antwort: Die Lunge würde in sich zusammenfallen,
da sie ja nicht mehr aufgespannt wird. Siehe
"`Pneumothorax"'.} 
