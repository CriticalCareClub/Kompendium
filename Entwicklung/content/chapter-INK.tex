...
\subsection{Bakterielle \HeadingKeyword{Meningitis}}
\index{Meningitis}
\label{topic:meningitis}

\Text{{\TxBeschreibung}}
{%
\DefinitionInPara{Die bakterielle \T{Meiningitis} ist eine eitrige Entzündung der Hirnhäute aufgrund einer Infektion mit Bakterien.}
Sie ist ist eine gefürchtete
Erkrankung, da sie einerseits hoch ansteckend ist, und andererseits
rasch tödlich endenkann. 
...
\TextSlide{{\TxBeschreibung}}
{%
Ebola-Viruserkrankung (Ebola) ist eine seltene, schwere 
Infektionskrankheit, die durch Ebola-Viren
verursacht wird. Je nach Virus-Typ verläuft die Erkrankung in 25 – 90 
Prozent der Fälle tödlich. Im
März 2014 wurde der bisher größte Ausbruch in Westafrika bekannt, der 
sich derzeit auf drei Länder
Guinea, Liberia und Sierra Leone ausbreitet.

Die Übertragung des Erregers erfolgt über direkten Kontakt mit Blut 
oder anderen Körper-
flüssigkeiten (z.B. Erbrochenes, Urin, Samenflüssigkeit) von lebenden 
oder toten an Ebola erkrankten
Menschen. Ansteckungsgefahr besteht auch bei direktem Kontakt mit 
infizierten lebenden oder
toten Wildtieren, insbesondere von Flughunden und Menschenaffen. Das 
Virus kann auch durch die
Zubereitung und den Verzehr von rohem Fleisch wilder Tiere, 
sogenanntem Buschfleisch, vom Tier
auf den Menschen übertragen werden. Heimische Wildtiere und Haustiere 
tragen keine Ebolaviren in
sich.



Das Ebola-Virus erzeugt ein oft tödlich verlaufendes Fieber mit 
Blutungen (\I[Fieber!hämorrhagisches]{hämorrhagisches Fieber}).
Das Virus verursacht im ganzen Körper schwere Zell- und 
Gewebsschädigungen, davon sind auch die Blutgefäße betroffen. 

Ansteckend sind nur jene Patienten, welche bereits
die Symptome der Krankheit zeigen.

Eine Ansteckung kann nur durch direkten Kontakt mit Blut oder anderen 
Körperflüssigkeiten
erkrankter Personen erfolgen. Darum sind nur Menschen mit engem 
Kontakt zu einem an
Ebolafieber-Erkrankten oder -Verstorbenen, wie Familienangehörige 
oder medizinisches


Ebola wird nicht durch die Luft oder
durch Tröpfcheninfektion übertragen,
sondern nur durch direkten Kontakt
mit Blut oder anderen
Körperflüssigkeiten infizierter oder
verstorbener Personen oder Tiere.
...
\TextSlide{{\TxSymptome}}
{
Die ersten Beschwerden ähneln einem grippalen Infekt: plötzliches 
hohes Fieber, Muskelschmerzen,
Schwächegefühl, Kopf- und Halsschmerzen. Das nächste Stadium der 
Erkrankung ist gekennzeichnet
durch Erbrechen, Durchfall, Ausschlag sowie Leber- und 
Nierenfunktionsstörungen.
Patienten können auch starke innere und äußere Blutungen sowie 
Multiorganversagen aufweisen.
Dadurch endet die Krankheit oft tödlich. Personen ohne Beschwerden 
sind nicht ansteckend.



Die Leitsymptome sind hohes Fieber (über 38,5\textcelsius) und später 
auch Blutungen, sowohl im Körper, als auch aus den Körperöffnungen. 
Daneben sind unspezifische Krankheitssysmptome wie Schüttelforst, 
Muskelschmerzen, Ausschläge, Erbrechen, Hypotension und Apathie zu 
beobachten. 
Die \E{Inkuationszeit} beträgt ca. \Range{2}{21} Tage. 

Die Dauer bis zum Auftreten von Krankheitszeichen nach einer 
Ansteckung mit Ebolaviren beträgt
mindestens 2 Tage und höchstens 21 Tage, meist jedoch 8 bis 10 Tage. 
Betroffene sind ansteckend,
sobald sie Krankheitszeichen entwickeln und so lange sie Fieber 
haben. In Samenflüssigkeit können
die Viren noch bis zu drei Monate nach der Genesung enthalten sein.

Da die Symptome oft unspezifisch sind, ist die Reiseanamnese wichtig. 
Insbesonders ist zu erheben, ob der Pateint in den letzten 21 Tagen 
...
{ %
\begin{enumerate}
  \item Enger Kontakt (<1m) ohne
  entsprechenden Schutzmaßnahmen
  mit einem wahrscheinlichen oder
  bestätigten Ebola-Verdachtsfall (mit
  den Symptomen Husten, Erbrechen,
  Durchfall oder Blutungen).
  \item 
  Ungeschützter sexueller Kontakt mit
  einem Ebola-Verdachtsfall bis zu drei
  Monaten nach der Genesung.
  \item 
  Direkter Kontakt mit jedem Material,
  das mit Körperflüssigkeiten eines
  wahrscheinlichen oder bestätigten
  Ebola-Verdachtsfall kontaminiert ist.
  \item 
  Gesundheitspersonal, welches Kontakt
  mit bestätigtem Fällen oder deren
  Körperflüssigkeiten hatte, selbst wenn
  adäquate Schutzausrüstung richtig
  verwendet wurde.
  \item 
  Perkutane Verletzung mit
  kontaminierten Gegenständen
  (z. B. Nadelstichverletzung).
  \item 
  Schleimhautkontakt mit
  Körperflüssigkeiten, Geweben oder
  Laborproben von wahrscheinlichen
  oder bestätigten Ebola-
  Verdachtsfällen (Erkrankte/Tote).
  
  Teilnahme an Begräbnisritualen und
  direktem Kontakt mit sterblichen
  Überresten in oder aus den
  betroffenen Gebieten ohne
  entsprechende Schutzausrüstung.
  
  Direkter Kontakt mit Fledermäusen,
  Nagetieren oder Primaten (lebend
  oder tot) in oder aus den betroffenen
  Gebieten.
  
  Konsum oder direkter Kontakt mit
  (rohem) „Buschfleisch“ (Wildfleisch
  von Tieren in Afrika) aus betroffenen
  Gebieten.
...
Die Klassifizierung der Fälle nach der spezifischen Definition beruht 
auf klinischen und
epidemiologischen Kriterien sowie auf Labor- und 
Hochrisikoexpositions-Kriterien. Diese
Kriterien gestatten die Identifizierung von Personen, die auf eine 
Ebola-Viruserkrankung
untersucht werden sollen.


\begin{enumerate}
  \item Klinische Kriterien
  \begin{enumerate}
    \item Fieber $\geqq$ 38,6\textcelsius
    \item UND mindestens eines der folgenden Symptome:
    \begin{enumerate}
    ...
    \end{enumerate}
    \item ODER eine Person, die plötzlich und auf unerklärliche Weise 
    verstarb.
  \end{enumerate}
  \item Epidemiologische Kriterien
  \begin{enumerate}
  ...
  \end{enumerate}
  \item Kriterien für Hochrisikoexposition (Jedes einzelne der 
  folgenden Kriterien ist als Hochrisikoexposition anzusehen)
  \begin{enumerate}
    ...
    mit einem EVD-Fall bis zu drei Monaten nach Genesung
    ...
    wahrscheinlichen oder bestätigten EVD-Fällen 
    (Erkrankte/Tote)
  ...
  \end{enumerate}
  \Z{\item Laborkriterien (eines der folgenden)}
  \Z{\begin{enumerate}
...
\begin{description}
  ...
  Person die klinischen und epidemiologischen
  Kriterien zutreffen, oder bei Personen mit
  Hochrisikoexposition \E{und} zumindest einem
  der aufgelisteten Symptome 
  (Fieber jeder Höhe, 
