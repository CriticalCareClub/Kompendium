...
\ChapterIntro
{%
%Weiterführende Resourcen und Wissenquellen.  
...
\glqq{}Rezept für Lernerfolg\grqq{} sein. Das soll es auch
nicht! In diesem Kapitel sollen lediglich Tipps und
...
\section{Strukturierung des Lerninhalts}
...
Das vielzitierte \glqq{}vernetzte Denken\grqq{} gelingt dann
effizienter. Es zahlt sich also aus sich einen
\EE{Überblick} zu verschaffen, bevor man sich auf ein Detail stürzt.

\Layout{0}{Eingrenzung des Lehrstoffs}{
...
\begin{itemize}
  ...
  gegeben.
  \item Der Prüfungsstoff ergibt sich aus dem Cirriculum
  (\glqq{}Lehrplan\grqq{}) für die jeweilige Ausbildung.
...
\begin{itemize}
  ...
  \item Cirriculum (\glqq{}Lehrplan\grqq{})
  \item Lehrunterlage
\end{itemize}
}{}{}{}

\Layout{0}{Strukturierung}{Zur Strukturierung stehen
verschiedene Möglichkeiten zur Verfügung:
  ...
  Gliederung des Inhalts eines (Lehr-)Buches kann man leicht
  eine (von vielleicht mehreren möglichen) Strukturen des
...
Leitsysteme sind Grafiken, welche symbolisieren wie das
Wissen aus verschiedenen Kapitel zusammen fließt bzw. in
welchen Kapiteln später auf Inhalte des aktuellen Kapitels
zurück gegriffen wird. Das Leitsystem zeigt somit
systemische Zusammenhänge. Beispielhaft sind hier
Querverweise und Leitsystem aus dem Kapitel \ref{chp:PAM}
\nameref{chp:PAM} dargestellt: 
...
Verschiede Kapitel, z.\,B.
\ref{chp:BAU} \nameref{chp:BAU} oder \ref{chp:SAN}
\nameref{chp:SAN}, führen zum \glqq{}Handwerk\grqq{} des
medizinischen Fachpersonals, das zusammen mit dem
\glqq{}Mundwerk\grqq{} (Kapitel \ref{chp:AUP}
\nameref{chp:AUP}) zum \nameref{chp:PAM} führt. Die anderen
Kapitel (grau) fließen als Hintergrundwissen ein.
...
\begin{figure}[H]
    \begin{center}
    \includegraphics[width=\linewidth]{./images/emhofer-josef-aass/Lernen.pdf}
    \vspace{6pt}
    
    \Captionof{figure}{Mind-map des aktuellen Kapitels\label{fig:mindmap}}
    \end{center}
\end{figure}
