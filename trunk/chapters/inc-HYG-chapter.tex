...
an fiebern (38{\textdegree}-40{\textdegree}C) mit Sch\"uttelfrost,  Kopf-, Hals-,
...
\paragraph{Womit?}~
\begin{itemize}
    \item H\"andedesinfektionsl\"osung:
...
\begin{enumerate}
    ...
    H\"andedesinfektionsmittel (ca. 3\,ml = 1~Hohlhand) aus
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Sterile Tupfer
        \item KEINE Papierhandt\"ucher oder unsterile
        Tupfer!
    \end{itemize}
...
\gZ{Basierend auf \footnote{Gemeinsame Erkl\"arung der
