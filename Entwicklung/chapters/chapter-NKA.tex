...
{\CC{[NKA]} Notkompetenz: Arzneimittel}
\label{chp:NKA}
...
\section{Verabreichungswege}

\subsection{Intramuskuläre Injektion}
...
\subsubsection{Handlungsschritte}
...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item Wundpflaster
  \end{enumerate}
  \EnumerateBreak{Nachbereitung und Verabschiedung}
...
\Layout{2}{{\SymbolKomplikationen} Blutaspiration}
...
\Cave{CAVE: Impfungen werden nicht intragluteal sondern in den M. deltoideus
verabreicht.}
...
\subsubsection{\RoteKarte\ Fallstricke}
...
\subsection{Sonderfall: Epipen{\texttrademark}}


\section{Relevante Medikamentemente}
