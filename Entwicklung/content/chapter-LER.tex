...
\begin{itemize}
  \item Der Prüfungsstoff wird von den Lehrenden \EE{bekannt
  gegeben}.
  \item Der Prüfungsstoff ergibt sich aus dem \II{Curriculum}
  (\I{Lehrplan}) für die jeweilige
  Ausbildung.
...
\begin{itemize}
  \item \EE{Teile} sind Blöcke, 
  in welchen Kapitel 
  gemäß des geforderten Kompetenzlevels 
  zusammengefasst werden. 
%  So fasst z.\,B. der Teil
...
%  selbsterklärend. 
  ...
  selbst noch in \E{Abschnitte} und \E{Unterabschnitte}
  gegliedert.
\end{itemize}
Beispiel: Der Abschnitt \enquote{\nameref{topic:hitzekollaps}} ist der
...
In diesem Buch gibt es in einigen Kapiteln \textsf{\EE{Querverweise}}
und \E{Leitsystem}, die helfen sollen, das
