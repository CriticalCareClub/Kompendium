...
\begin{itemize}
  \item \EE{Herzschwäche} (\E{kardial}) oder aufgrund
  von
  \item \EE{Inhalation giftiger Substanzen} (\E{toxisch})
\end{itemize}
entstehen.
...
\begin{itemize}
  \item \EE{{Hyp\underline{\E{o}}glykämie}}: "`Unterzucker"'
  \item \EE{{Hyp\underline{\E{er}}glykämie}}: "`Überzucker"'
\end{itemize}
}
{}
