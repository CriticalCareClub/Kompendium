...
\gCaptionof{figure}{ICE-Ungl\"uck von Eschede am 3. Juni
...
\\\bottomrule
\end{tabulary}
\footnote{\emph{Infrastruktur:} Wichtige
...
Jedes Großschadens- oder Katastrophenereignis zeigt unabh\"angig von seiner
...
Bereichen in Listen erfasst (Triage, Behandlung, Transport). Außerdem
...
\gCaptionof{figure}{PLT: Umtriagierung nach l\"angerer Zeit}
\begin{itemize}
...
\subsection{Gefahr erkennen: Kennzeichnung von gef\"ahrlichen Stoffen und
Gefahrenbereichen}
...
\subsection{Absperrmaßnahemen durchführen}

\subsection{Speziealkräfte anfordern}
