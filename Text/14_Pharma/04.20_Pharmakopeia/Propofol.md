...
Propofol ist gegenwärtig DAS Hypnotikum schlechthin und kann quasi als Goldstandard
betrachtet werden.
...
: - Atmung: Atemdepression bis zur Apnoe
  ...
  - {ref}`Propofolinfusionssyndrom <Propofolinfusionssyndrom>` (speziell Kinder, \> 48 h Sed mit > 5 mg / kg / h + \> 5h Narkose)
...
Dosierung
: Siehe {numref}`TAB-Propofol-Dosierung` {ref}`TAB-Propofol-Dosierung`
  ...
  - TIVA: 3-9 mg / kg / h
  - TCI[^Propofol-TIVA-TCI] (Target Controlled Infusion): Zielplasmakonzentration = durchschnittlich 3 µg / ml
...
- {ref}`Propofolinfusionssyndrom <Propofolinfusionssyndrom>`
:::
