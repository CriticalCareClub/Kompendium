...
Das Herz besitzt ein eigenständiges Erregungszentrum, das elektische Impulse
über das Reizleitungssystem  zum Herzmuskel leitet. Jeder Impuls wird
normalerweise vom Herzmuskel mit einer Kontraktion beantwortet. Vom Sinusknoten
ausgehend, wird die Erregung zum AV-Knoten geleitet, von dort über das His-Bündel, welchches sich im Bereich der Vorhof-Kammer-Grenze befindet, weiter in
die Tawara-Schenkel, jeweils rechts und links. Nun mehr fließt die Erregung über
die Purkinje-Fasern in die Muskulatur rechten bzw. linken Kammer. 

Bei einem Ausfall eines Knotens, bzw. der Unterbrechung der Erregungsleitung
(z.\,B. durch Gewebeschädigung nach einem Herzinfarkt) kann die jeweils nächste
Station als Impulsgeber -- allerdings mit deutlich langsamerer Frequenz --
fungieren. Im Extremfall, wenn das gesamte Leitungssystem ausfällt, können auch die
Herzmuskelzellen selbbst einen minimalen Rhythmus ($\sim$\,30\,\nicefrac{}{min})
aufrecht erhalten.
