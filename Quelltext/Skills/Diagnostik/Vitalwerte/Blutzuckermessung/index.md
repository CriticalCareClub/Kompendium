...
02. *Einstichstelle* bestimmen: Am Fingerendglied, seitlich (Rand!),
...
04. *Blutzuckermessstreifen halb in das Gerät* schieben, aber noch nicht
    einrasten lassen.
05. Mit einer schnellen, beherzten Bewegung den Patientenfinger *mit der
...
08. *Messstreifen* ganz in das Gerät schieben, das Gerät schaltet sich
    ein und führt einen Selbsttest durch. Wenn im Display ein Tropfen
    angezeigt wird ist das Gerät messbereit.
09. Den Messstreifen mit dem Gerät *an den Bluttropfen halten*, das Blut
    steigt aufgrund der Kapillarwirkung auf. [^footnote-1]
10. Beim *Piepton* ist genug Blut in die Testkammer eingeströmt und das
    Gerät beginnt mit der Messung.
11. Mit einem trockenen *Tupfer* auf die Einstichstelle drücken (lassen).
12. Ein neuerlicher Piepton zeigt an, dass die Messung beendet wurde und
    der Wert vom Display abgelesen werden kann.
13. *Messstreifen entsorgen* (normaler Restmüll).

[^footnote-1]: Blutzuckermessung, Kapillarwirkung: Je nach Modell kann es hier zu
