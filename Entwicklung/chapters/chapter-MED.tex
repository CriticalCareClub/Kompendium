...
\begin{itemize}
  ...
  \end{itemize}
  \item \ce{O2}: je nach Symptomen \VonBis{6}{8}\LMin, bei
...
\subsubsection{Rechtsherzinsuffizienz}\marginline{\TabHeading{\color{DefaultRed}Rechtsherinsuffizienz}}
...
\begin{itemize}
  ...
  8\LMin. \Commentary{\EE{Asthma: \protect\ce{O2} bis eine
  Sauerstoffsättigung von 95\PC* erreicht ist, oder 8\LMin
