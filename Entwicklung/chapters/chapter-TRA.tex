...
\Fazit{Es ist sinvoll, nach Möglichkeit den Unfallmechanismus 
...
\section{Wunden}\label{topic:wunden}\index{Wunde}

\HeadingSub{\Z{\Lang{Lat.} \IX{Vulnus} (\I{Vuln.})}}
...
\HeadingSub{\Lang{Syn.} \T[Fraktur]{Fraktur}\Z{, \Lang{lat.} \IX{Fractura} (\I{Fract.})}}
...
\HeadingSub{\Lang{Syn.} \T{Distorsion}, \Z{\Lang{lat.} \I{Distorsio} (\I{Dist.})}}
...
\HeadingSub{\Lang{Syn.} \T{Luxation}, \Z{\Lang{lat.} \I{Luxatio} (\I{Lux.})}}

\Definition{\T{Verrenkung} (\I{Luxation}):  
Gelenkverletzung,
...
\HeadingSub{\Lang{Lat.} \I{Amputatio} (\I{Amp.})}
...
\Z{\HeadingSub{\Lang{Lat.} \I{Combustio} (\I{Comb.})}}
...
\Z{Sonderform \I{Verbrühung}\ZFootnote{\I{Verbrühung}: \Lang{Lat.} \I{Ambustio} (\I{Amb.}), \Lang{engl.}
