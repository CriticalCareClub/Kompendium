...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Kreislaufstillstand}
...
\begin{ABCDEText}
  ...
  %%%
  \item[\ABCDE{4}] Der Patient klagt über Atemnot (\EE{Dyspnoe}). Oft berichten
  ...
  %   \item[\ABCDE{A}]
  %%%
  \item[\ABCDE{B}] Die Atemfrequenz und Herzfrequenz sind
  oft erhöht (\EE{Tachypnoe},
  \EE{Tachykardie}\index{Hyperventilation!bei
  Herzinsuffizienz}), oft besteht ein \E{Hustenreiz}. Die
  Sauerstoffsättigung kann deutlich erniedrigt sein.
  ...
  %%%
  \item[\ABCDE{C}] Es können Zeichen eines kardiogenen
  Schocks auftreten
  (\FullPrettyRef{topic:kardiogener-schock}).
  %%%
  \item[\ABCDE{D}] Grundsätzlich ist der Blutdruck vermindert (\EE{Hypotonie}).
...
\begin{ABCDESlide}
  ...
  Evtl.Hörbares \Ca{Kardiales Lungenödem = lebensgefährlich
  krank!}
  %%%
  %   \item[\ABCDE{A}]
  %%%
  ...
  %%%
  \item[\ABCDE{C}] \EE{Tachykardie}
  %%%
  \item[\ABCDE{D}] \EE{Hypotonie} oder \EE{Hypertonie}
  (\Abk{RR}\,\Sign{↑}\Sign{↑} kann Auslöser sein)
  %%%
  \item[\ABCDE{E}]
  %%%
  \item[\ABCDE{\ldots}] \EE{Lungenstauung/Lungenödem} (Blut staut sich
...
%   \item[\ABCDE{2}] 
  ...
  Eindruck, eventuell ist er kaltschweißig und blass.
  %%%
  \item[\ABCDE{4}] Die Leitsymptome sind ein \EE{akuter,
  nicht atemabhängiger, Brustschmerz} und \EE{Atemnot}
  (\E{Dyspnoe}).
...
erwarten. Eine Ausnahme stellen Schwangere Patientinnen dar:
...
\Commentary[Hypertonie]{Neben der systemischen
...
\Fazit{Der Unterschied zwischen einer hypertensiven Krise
...
gesammten Verlauf der Aorta auftreten, man unterscheidet
...
\begin{ABCDEText}
  ...
  Aneurysmas klagt der Patient über \EE{Brust-}, \EE{Bauch-}
...
{
\begin{ABCDESlide}
  \item[\ABCDE{2}] Evtl. Schockzeichen, Schohnhaltung
  \item[\ABCDE{4}] Brust-, Bauch- oder Rückenschmerzen;
...
\subsection{Peripherer arterieller Gefäßverschluß}
...
\begin{ABCDEText}
  ...
  Schmerz, zusammen mit Blässe, Gefühlslosigkeit und evtl.
...
\Fazit{Die klassischen Symptome des arteriellen Gefäßverschlusses sind 
Schmerz, Blässe,
Pulslosigkeit,
Gefühllosigkeit und
evtl. Lähmung
...
{Symptomatische Therapie und zügiger Transport an
...
\subsection{Peripherer venöser Gefäßverschluss: 
...
\begin{SAMPLERText}
  ...
  Spitalsaufenthalt, welchem eine Immobilsation folte,
