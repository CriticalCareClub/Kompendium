...
\gLayout{1}{Diabetes mellitus: Typen}
{
\begin{description}
   ...
   ${\beta}$-Zellen des Pankreas kommt. Durch den Produktionsausfall ko
  mmt es zu einem absoluten Mangel.}
    ...
    Wirkungsverlust des vom Körper produzierten Inulins
...
\gLayout{1}{Ursachen}
{
Die häufgsten Ursachen für eine plötzliche Hypoglykämie sind Diätfehler und/oder
eine falsche Anwenung von Insulin oder bestimmten anderen
Diabetes-Medikamenten. Aufgrund besonderer Anstrenungen kann es zu einem
gesteigerten Zuckerbedarf des Körper kommen, wodurch der Blutzuckerspiegel
sinkt. Dies kommt häufig im Rahmen von Begleiterkanken, wie z.B. grippalen
Infekten, vor. 
}{
\begin{itemize}
    \item zu viel Insulin (spritzen ohne zu Essen).
    \item Fasten (spritzen ohne zu Essen).
    \item Besondere Anstrengungen, Begleiterkrankungen, insb. Infekte.
\end{itemize}
}{}{}{}
...
häufig feststellbar. Manchmal klagt der Patient über Überkeit und Heißhunger.
...
\gMassnahmen{
\paragraph{Spezielle Maßnahmen: Hypoglykämie} ~
...
\gLayout{1}{Hyperglykämie: Zustand oder Notfall?}
{
Eine Erhöhung des Blutzuckerspiegels ist nicht automatisch ein Notfall. Die
Bedrohlichkeit ist z.B. stark davon abhängig davon wie rasch sich deise
Erhöhung entwickelt hat. So hat ein Patient, bei dem seit Jahren ein unerkannter Diabetes
mellitus besteht auch mit sehr hohen Blutzuckerwerten (akut) keine
...
\gLayout{1}{Auswirkungen}
{
Im Grunde bereitet der Zcuker im Akutfall dem Körper 2 Probleme. Einerseits
wirkt der Zucker wie ein Elektrolyt auf den \gEs{Flüssigkeitshaushalt} ein und
...
Notfall oft die Erstmanifestation (die Diagnose Diabetes ist nocht nocht
bekannt!). Sonst sind Diätfehler oder eine mangelnde Insulinzufuhr häufige
Ursachen. Auch Stress und Begeliterkrankungen wie z.B. akute Infektionen
kommen in Betracht, da hier der Insulinbedraf steigt.
}{
\begin{itemize}
...
geschrieben wurde kann es sowohl zu einem Problem des Flüssigkeitshaushaltes und/oder der Nährstoffversorung der Zellen kommen. Je
nachdem welches Problem im Vordergrund steht kommt es zu} \gE{unterschiedlichen
Symptomen}. 
...
bei einer Hyperventilation in Richtung basisch wandert. Bei der diab. Ketoazidose (sauer) versucht der Körper diesen
    Mechanismus auszunutzen: Er \gEs{hyperventiliert} um sich "`vom sauren pH
...
\gMassnahmen{
\paragraph{Spezielle Maßnahmen: Hyperglykämisches Koma}
...
\gLayout{22}{Der Bauch: unendliche Weiten}
{
...
\gMarriedNG{\gTxBeschreibung und Ursachen}
...
Medikamente (z.B. Paracetamol) zu nennen. 
}
{
\begin{itemize}
...
Selbstmordversuchen geprägt war. Es sollte nicht bei den Verscuhen bleiben,
...
\gMarriedNG{Psychiatrische Erkrankung in der Praxis}
{
