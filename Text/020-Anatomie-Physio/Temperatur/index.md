...
- Konduktion (Wärmeleitung über Masse)
- Konvektion (forcierte Konduktion durch Luftströmung)
- Abgabe über Strahlungswärme
- Schwitzen
...
- *physiologisch*:
  ...
  - bei schwerer Arbeit
  - durch zirkadiane Rhythmik
  - Schwankungen durch den Menstruations-Zyklus

- *pathologisch*:

  - Fieber: Sollwertverstellung zu höherer Körpertemperatur
  - exogene Pyrogene: stimulieren die Bildung von endogenen Pyrogenen
    durch Makrophagen (mit einigen Mediatoren der Immunabwehr
    identisch)
