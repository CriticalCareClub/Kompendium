...
Hilfe weiterhin Anwendung findet.} % Commentary
...
macht. Es wird v.\,a. die Hautfarbe, der Gesichtsausdruck, die
\EE{Körperhaltung} und die \EE{Sprache} des Patienten beurteilt. 
...
Verletzungen, u.\,v\,a.\,m. Ebenso
können eventuell Hinweise auf ein \E{Trauma} erkannt werden.
}{%
\begin{itemize}
  \item Hautfarbe, Gesichtsausdruck, Haltung, Sprache,
  sonstige Auffälligkeiten
  \item[\eye] Blässe, Zyanose, Schweiß, Schonhaltung,
  Atemnot, verwaschene Sprache, Desorientiertheit, Krämpfe, sichtbare
  Verletzungen
\end{itemize}
}
...
{%
Beurteilt wird der \E{quantitative Bewusstsein}, also der
\EE{Bewusstseinsgrad} (\Speech{"`\EE{Wieviel} Bewusstsein
ist vorhanden?"'}, vgl.
\prettyref{topic:bewusstseinsstoerung-grade}). Es wird dazu
die Reaktion auf verbale Ansprache, bzw. wenn notwendig, auf
einen Weckversuch oder Schmerzreiz bewertet. Der Patient
kann \E{klar}, \E{somnolent}, \E{soporös} oder
\E{komatös}/\E{bewusstlos} sein (Quantitavive
...
\subparagraph{\eye}
Speziell \E{pfeifende},
\E{gurgelnde} oder \E{schnarchende} Atemgeräusche können ein
Hinweis auf eine Verlegung sein. Oft gibt auch die \EE{Gestik} und
Haltung des Patienten Hinweise.
% \vspace{1.4cm}
}{%
\begin{itemize}
  \item Frei oder verlegt
  \item Inspektion \& ggfs. Abtasten von \E{Mund}, \E{Nase}
  und \E{Hals}
...
Dazu wird zuerst die Frequenz  und Tiefe der Atmung
eingeschätzt. Dabei wird der Thorax inspiziert, und während
der Einatmung auf das \E{gleichseitige} Heben des
Brustkorbes geachtet. Bei Verdacht auf eine
Verletzung wird der Thorax auch abgetastet
und bei der Einatmung mit den flachen Händen
gegen den Brustkorb gedrückt (\E{Atemprobe}). Dadurch kann
eine ungleichsetige Belüftung der Lungenflügel erkannt
...
Atemnot, eine zu schnellle oder langsame Atmung (Tachy-/Bradypnoe), eine
flache oder tiefe Atmung, pathologische Atemmuster, eine
Schnappatmung, eine paradoxe oder überhaupt fehlende Atmung,
sowie besondere Umstände wie das vorhandensein von
Heimsauerstoff oder anderen Atemhilfen.
}{%
\begin{itemize}
...
Vitalfunktionen erster Ordnung betreffen. nicht direkt. 

Es werden die \EE{Vitalwerte} (\Abk{HF}, \Abk{RR}) gemessen
und \EE{Bewusstsqualität} (Orientierung zur
...
Besteht der Verdacht auf ein \EE{Trauma},
werden der Kopf inkl. der Ohren Ohren und der Hals
\EE{inspiziert} und \EE{abgetastet} und überprüft, ob der
Patient \E{Hände} und \E{Füße} \EE{spüren und bewegen}  kann (Schädigung
des Rückenmarks). 

% \EE{Mund, Nase und Ohren} werden, unter
% Zuhilfenahme einer Lampe, auf Blutungen kontrolliert. Zuletzt wird kontrolliert, ob der Patient \E{Hände} und \E{Füße} \EE{spüren und bewegen} kann.

Wenn Verletzungen auf einen Körperteil beschränkt sind und
der Unfallhergang eindeutig ist (Amputation eine Fingers
durch eine Säge, \ldots) oder Bagatellverletzungen
vorliegen (eingezogener Schiefer, \ldots), können u.\,U.
manche Untersuchungen entfallen. Es muss aber bedacht werden, dass auch kleine Verletzungen aufgrund von zugrundeliegenden Erkrankungen entstehen, oder Folgeverletzungen vorliegen können!

\subparagraph{\eye} Erkennen lassen sich z.\,B. entgleiste
Vitalwerte, Desorienierung, pathologische Pupillenreaktionen (abnorme
Weitung oder Engstellung, Differenz, verlangsamte
oder fehlende Reaktion (Fixierung), Entrundung), Motorische
(Lähmungen) oder sensible (Kribbeln, Gefühlsverlust)
Ausfälle oder andere kritische Verletzungen.
...
weitere Unterschungen oder Anamneseschritte} durchgeführt
werden. Dies inkludiert auch in der Situation besonders relevante Teile der Anamnese,
u.\,U. auch eine \E{Fremdanmnese}. Es müssen zielgerichtete
Fragen oder Untersuchungen zur Abklärung von
\E{Alarmzeichen}, insbesonders Alarm-Diagnosen und relevante
...
scih nicht unbedingt besonders gefährlich sind, können in
\EE{Kombination} miteinander gefährlich sein. 

Besonders bei Trauma-Patienten kann es
notwendig sein den Patienten zu \EE{entkleiden} um beispielsweise \E{Prellmarken} zu erkennen. Das Entkleiden des Patienten muss unbedingt unter \Ca{Wahrung des Wärmeerhalts} erfolgen und darf i.\,d.\,R. nur in warmer
Umgebung und unter Schutz vor Witterungseinflüssen erfolgen.
Eventuell muss dieser Schritt so lange verzögert werden bis
sich der Patient in einer warmen Umgebung befindet.

Bei Punkt E ist ein solides \EE{Hintergrundwissen} über
relevante Erkrankungen, Verletzungen entscheidend, je souveräner das
Wissen beherrscht wird, desto gezielter können Fragen
und Befunde erhoben werden und desto besser wird die
Einschätzung des Patienten erfolgen.
...
zwei mal gekrampft hat, was ein Hinweis für einen
...
Hinweis auf eine Intoxikation sein (wobei diese nicht
Ursache des aktuellen Problem sein müssen!).
}{%
...
könne auch von einer zweiten Person parallel durchgeführt
werden. Wenn die jeweiligen Sofortmaßnahmen durchgeführt
...
Krankentransport, Ambulanzdienst, etc.) hat die
Transportentscheidung eine unterschiedliche Bedeutung. 

Beim
\EE{Primäreinsatz} ("`Rettungseinsätze"') ist der Transport
des Patienten die Regel. Besonders wichtig ist die \EE{Auswahl
des richtigen Zieles}. Bei kritischen Patienten hat diese
Auswahl oft große Folgen für den Erfolg der weiteren
Behandlung. Wird der Patient einer ungeeigneten Einrichtung
(unzuständige Fachabteilung, benötigte Spezialeinrichtungen
nicht verfügbar, \ldots) zugeführt, kann es zu
\EE{Verzögerungen} in der Behandlung kommen, welche
\EE{bleibende (vermeidbare) Schäden} verursachen können. 

Beim \EE{Sekundäreinsatz} gibt es i.\,d.\,R. eine
vordefinierten Zielpunkt. Hier muss vor allem Bedacht werden, ob das
vorhandene \EE{Material ausreicht}, um den Patienten für die
Dauer des Transportes wie gewünscht zu versorgen. Dazu ist
die Kenntnis über die speziellen Bedürfnisse des Patienten
notwendig (Medikamente, Sauerstoff, Dekubitusprophylaxe,
\ldots).

\index{Triage!Patientenmanagement}
Bei \EE{Ambulanzdiensten} wird der Sanitätsdienst häufig
von Patienten in Anspruch genommen, welche keine
schwerwiegenden Gesundheitsstörungen aufweisen.
Dementsprechend werden sie oft nicht in eine andere
Gesundheitseinrichtung transportiert, sondern begeben sich
auf eigenen Wunsch selbstständig in eine weiterführende
Betreuung, oder werden nach ärzticher Begutachtung aus der
...
Abtransport benötigen. Zusätzlich kann es notwendig sein, Prioritäten zu setzen,
wenn die verfügbare Anzahl der Transportmittel nicht
ausreicht. Bei vielen Großambulanzdiensten werden Patienten
entsprechend dem Patientenleitsystem in die
Behandlungsprioritäten \VonBis{I}{IV} sowie die
Transportprioritäten A und B eingeteilt
(\E{Triage}, \prettyref{topic:triage}).
