...
2. *Stabilisierung notwendig?* Ergibt sich ebenfalls aus der
...
3. Ggfs. *Verfügbarkeit eines Notarztmittels*:
...
4. *Transportdauer zur Zieleinrichtung*:
...
2. *Transportpriorität* ({ref}`Transportprioritaet`), und dem
...
- **Herzkatheterlabor**
  (PTCA[^footnote-1] bzw. PCI[^footnote-2]) für Herzinfarktpatienten
- **Schockraum**:
...
[^footnote-1]: PTCA: Perkutane Transluminale Coronar-Angioplastie
