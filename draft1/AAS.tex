...
\newcommand{\gDefinition}[1]{{\mdseries\color{Terminus}\rmfamily\textit{{bfseries{Definition:
}#1}}}}
...
\subtitle{und eine Einf\"uhrung in die Welt der Medizin und Sanitätshilfe}
...
\subsubsection{Arterieller Gefä{\ss}verschlu{\ss}}
