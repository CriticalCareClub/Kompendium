...
{NACA \VonBis{III}{V}: Die unmittelbare vitale Bedrohung ist
abhängig von den Vitalwerten.

\EE{Taktik}: \Speech{Unmittelbare vitale Bedrohung
einschätzen, Vermutliche Ursache und Differentialdiagnosen
...
NACA \VonBis{II}{IV}: Unmittelbare Bedrohung je nach Vitalwerten.

\EE{Taktik}: \Speech{Nüchtern lassen, Differentialdiagnosen
...
\EE{Taktik}: \Speech{Differntialdiagnosen abklären,
Transport an geeignete Abteilung}
...
\Layout{0}{\TxBeschreibung}
{Im Verlauf des Magen-Darm-Traktes kann es asn verschiedenen
...
schwallartigem Erbrechen  von rotem, frischen Blut (\Z{\I{Hämatemesis}}) oder häufiger zum
Erbrechen von
...
spricht vom sog. \T{Teerstuhl}. Bei Butungen im \EE{Endteil}
ist der wird Blut ausgeschieden. 
...
\MassnahmenNG{Spezielle Maßnahmen}{Gastrointestinale
Blutung}{}{ 
NACA \VonBis{III}{V}: \Ca{Vitale Bedrochung bei
hohem Blutverlust!}

\EE{Taktik}: \Speech{Schockbekämpfung, zügiger Transport}
