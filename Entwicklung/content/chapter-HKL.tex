...
\\\addlinespace\bottomrule
\end{tabulary}}
{Übersicht: Wichtige und häufige
...
%   \item[{\color{AltBlueLight}\usefont{T1}{PTSansNarrow-TLF}{m}{n}\selectfont A-Problem}] 
  ...
  ist i.\,d.\,R. hoch, meist über 160\PerMin* und evtl. nur
  schwach tastbar.
  Der Patient kann bei mangelnder Herzauswurfleistung
  kreislaufinsuffizient werden und einen kardiogenen Schock
  entwickeln. Im Extremfall ist auch ein Kreislaufstillstand
  möglich.
