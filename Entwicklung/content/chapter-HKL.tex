...
Herz-Kreislauf-Erkrankungen}%1 Titel
{}%2 Beschreibung
{}%3 Label/Hook
{}%4 Quelle
{}%5 Lizenz
...
\TableWide
{Übersicht: \SlideHeading{Schockarten}}%1 Titel
{}%2 Beschreibung
{\label{tab:uebersicht-schockarten}}%3 Label/Hook
{}%4 Quelle
{}%5 Lizenz
{%
...
\begin{itemize}
  ...
  \end{itemize}
\end{itemize}}%3 Slide
{./images/teaser/imgp0481.jpg}%4 Bilddatei
{%
Der Strawinsky-Brunnen von Jean Tinguely beim Centre Pompidou in Paris %
}%5 Bildtitel
{}%6 Bildbeschreibung
...
\TableWide
{Unterscheidung Hypertensive Krise und Hypertensiver Notfall}%1 Titel
{\protect\citep{WHOISH2003,JNC7Report,BLIM3,IntroClinEmergMed4,Vlcek2008}}%2 Beschreibung
{\label{tab:hxpertension-krise-notfall}}%3 Label/Hook
{}%4 Quelle
{}%5 Lizenz
{%
...
\begin{ABCDESlide}
  ...
  \item[\ABCDE{C}] Evtl. {\RedFlag\,}kardiogener Schock
  RR $\uparrow$ (Richtwert\Abk{RR}~{\textgreater}~\RRmmHg{230}{130} 
  bzw. deutliche individuelle Erhöhung)
\end{ABCDESlide}
}
{}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    Unzureichende Leistung des \E{linken} Herzens. Es kommt
     zu einem \E{Rückstau} des Blutes \E{in den
  ...
  \begin{itemize}
    \item \T{Kompensierte Herzinsuffizienz}: 
    Der Körper hat noch genug Reserven, 
    kann gegensteuern (kompensieren) 
    und kommt mit der eingeschränkten Herzleistung aus. 
    %
    Für viele Patienten ist sie ein \E{chronischer Zustand} mit dem sie
    gut leben können, da sich der Körper mit der Zeit an die
    abnehmende Leistungsfähigkeit gewöhnt.
    %
    \item \T[Dekompensierte Herzinsuffizienz]
    {\E{De}kompensierte Herzinsuffizienz}:
    %
    Problematisch wird es jedoch, 
    wenn die \E{Kompensationsmechanismen} 
    (köpereigene, Medikamente, {\dots}) versagen 
    oder nicht mehr ausreichen, 
    weil der Körper aufgrund des Fortschreitens der Erkrankung 
    oder aufgrund eines erhöhten Bedarfs nicht mehr
    mit der reduzierten Herzleistung auskommt.
    %
    Es treten plötzlich akute Symptome auf.    
  \end{itemize}
\end{itemize}
...
\begin{ABCDEText}
  ...
  %   \item[\ABCDE{2}]
  %%%
  \item[\ABCDE{2}] Evtl. ist der Patient bleich bzw.
...
\begin{ABCDESlide}
  ...
  %   \item[\ABCDE{2}]
  %%%
  \item[\ABCDE{2}] Blass, evtl. kaltschweißig. Evtl.
  agitiert
  %%%
...
\Picture
{Akutes Koronarsyndrom}%1 Titel
{Typische Schmerzausdehnung bzw. -ausstrahlung beim ischämischen
Herzschmerz}%2 Beschreibung
{}%3 Label
{Lena Hirtler}%4 Quelle
{MfG}%5 Lizenz
{./images/hirtler-aass/Herzschmerz.pdf}%6 Datei
...
Herzinfarktes}%1 Titel
{}%2 Beschreibung
{}%3 Label
{WM}%4 Quelle
{PD}%5 Lizenz
{./images/wikipedia-pd/12_lead_generated_ventricular_tachycardia}%6 Datei
{}%7 Breitenmodifizierer
{}%8 Float
% vormals \Layout{27}
...
%
\begin{itemize}
  \item \II{Bradykardie}:  Langsamer Herzschlag
...
\subsubsection{Besondere \HeadingKeyword{Rhythmen}}
...
\Picture
{Unauffälliger EKG-Befund}%1 Titel
{}%2 Beschreibung
{}%3 Label
{WM}%4 Quelle
{PD}%5 Lizenz
{./images/wikipedia-pd/Lead_II_rhythm_generated_sinus_bradycardia}%6 Datei
{}%7 Breitenmodifizierer
{}%8 Float
% vormals \Layout{27}
...
\subparagraph{Anmerkung} Aortenaneurysmen sind sehr oft
...
\section{Störungen des \HeadingKeyword{Blutes}}

\subsection{\HeadingKeyword{Gerinnungsstörungen}}


\TextSlide{\TxBeschreibung}
{%
Gerinnungsstörungen können vielfältige Ursachen haben, 
beispielsweise:
\begin{itemize}
  \item Die \StepHeading{Bluterkrankheit (Hämophilie)} ist eine angeborene Erkrankung, 
  bei der dem Patienten wictige Gerinnungsfaktoren fehlen, 
  es kommt daher nicht zu einer ausreichenden Blutstillung. 
  %
  \item  \StepHeading{Knochenmarkschädigende Therapien}:
  \index{Knochenmark!-schädigende Therapien} 
  Einige medizinische Behandlungen\footnote{Knochenmarkschädigende medizinische Therapien: 
  Z.\,B. Bestrahlung, 
  Chemotherapien bei Krebspatienten etc.} 
  verursachen als Nebenwirkung eine massive 
  \E{Schädigung des Knochenmarks}\index{Knochenmark!Schädigung} 
  und beeinträchtigen somit auch die Bildung der Blutplättchen, 
  welche für die Blutstillung durch Ausbildung eines \I{Thrombozytenpropfs} wichtig sind.
\end{itemize}
}
{%
\begin{itemize}
  \item Bluterkrankheit
