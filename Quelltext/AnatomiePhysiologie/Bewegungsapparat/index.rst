...
-   Art. atlantooccipitalis: Eigelenk, Seitwärtsneigungen
    (Lateralflexion) und Nickbewegungen (Anteflexion)
-   Art. atlantoaxialis: Zapfengelenk, ca. 50° Gesamtbewegungsumfang (25°
    links und 25° rechts), Drehbewegungen (Rotation)
-   Art. lumbosacralis
-   Art. sacrococcygea
...
-   Schultergürtelmuskeln (M. serratus anterior, M. pectoralis major und
    minor, M. latissimus dorsi, M. trapezius etc.)
...
-   vordere Bauchmuskeln:
    ...
    -   *M. rectus abdominis*: ausgehend von der 5.-7. Rippe bis beidseits
...
werden im Abschnitt der unteren Extremität besprochen.
...
Er beinhaltet Pharynx (Rachen), Ösophagus (Speiseröhre), Larynx
(Kehlkopf), Trachea (Luftröhre), Glandula thyroidea (Schilddrüse), Os
hyoideum (Zungenbein) sowie die großen Leitungsbahnen für den Kopf (A.
carotis communis, V. jugularis interna et externa, Lymphbahnen, N. vagus
(X), Truncus sympathicus).

Neben den Halswirbeln ist in dieser Region noch ein einzelner Knochen zu
nennen, das *Zungenbein (Os hyoideum)*. Dieser Knochen ist der einzige,
der keine nähere Verbindung zu anderen Knochen aufweist, und ist
zwischen den Oberzungenbeinmuskeln und den Unterzungenbeinmuskeln
eingebettet. Befestigt wird das Zungenbein über das Lig. stylohyoideum
am Proc. styloideus.

Halsmuskeln:

-   *Platysma*: mimischer Muskel des Halses, oberflächlichster Muskel,
    innerviert durch N. facialis (VII)
-   *M. sternocleidomastoideus*: reicht von Manubrium sterni und
    Clavicula (Schlüsselbein) bis zum Os occipitale (Hinterhauptsbein);
...
-   Fossa cranii anterior: enthält den Stirnlappen (Lobus frontalis) des
    Gehirns.
-   Fossa cranii media: enthält den Schläfenlappen (Lobus temporalis) des
    Gehirns.
...
Extremitas distalis: Caput ulnae, Circumferentia articularis, Proc.
styloideus ulnae.
