...
\begin{itemize}
  ...
  eingesetzt werden!
  \item \StepHeading{Kinder}: Viele Geräte dürfen bei \EE{Kindern} erst ab einem 
  bestimmten Körpergewicht oder Alter (je nach Herstellerangabe)
  eingesetzt werden.
  \item \StepHeading{Sauerstoff}: Während der Schockabgabe sind etwaige
...
%   nicht defibrilliert werden. % ex mit ERC 2010
  ...
  \item \StepHeading{Interferenzen}: 
