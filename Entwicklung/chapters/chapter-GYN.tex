...
Die Geburt verläuft in 3 Phasen. Der \EE{Eröffnungsphase}
mit den Eröffnungswehen und dem Blasensprung. Der
\EE{Austreibungsphase} mit den Presswehen und der Geburt
des Kindes. Und der \EE{Nachgeburtsphase} mit der Placenta als
Nachgeburt.
...
beginnt die Austreibungsphase. Die Wehen kommen nun alle \EE{\VonBis{2}{3}}
Minuten und sind nun keine Senkwehen mehr, sondern richtige \EE{Presswehen}. Das
Hinterhaupt des Kindes wird nun zwischen den Schamlippen  sichtbar. 

\index{Damm}
\index{Damm!-schutz}
Mittels \T{Dammschutz} kann die
Wahrscheinlichkeit eines Dammriss minimiert werden. Als \T{Damm} wird das
Stück Haut zwischen Scheide und Anus bezeichnet. Gleichzeitig wird das Kind vor
dem Stuhl der Mutter geschützt\footnote{Durch das Pressen wird nicht nur
...
Ursachen können u.\,a. eine Placanta praevia,
