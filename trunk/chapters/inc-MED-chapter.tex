...
\gMassnahmenNG{Spezielle Maßnahmen}{Insult}{}{
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \gA{\hrule ERRATUM 0.8.0 Nachberunfung des Notarztes beim
            Schlaganfall:} Notarzt: Grundsätzlich ist ein Schlaganfall-Patient aufgrund seiner Diagnose als vital bedroht einzustufen. Es gibt jedoch eine
            ...
            Therapie möglichst schnell erfolgt. Daher soll von einer
            \gEs{Nachberufung eines Notarztes abgesehen werden \gE{wenn folgende
            ...
            \begin{itemize}
              ...
              \item Der Patient kann in eine \gE{Spezialabteilung} für
              Schlaganfälle eingeliefert werden (Stroke Unit, Kontaktaufnahme
              mit der Leitstelle).
            \end{itemize}
            \gA{HART: Muss es unbedingt eine Spezialabteilung sein?
            "`bewusstseinsklar könnte missversatnden werden.}
            \gA{← ENDE ERRATUM\hrule}
            % Ende Erratum
        \end{itemize}
