...
:::
:::{index} single: Narkose
:::
:::{index} single: Hypnose
:::
:::{index} single: Analgesie
:::
:::{index} single: Amnesie
:::
:::{index} single: Relaxierung
:::
...
% -  **Anästhesie**: altgriechisch ἀν- „un-, nicht“ und αἴσϑησις „Wahrnehmung“
% -  **Anästhesie** : „ohne Gefühl, gefühllos“
% -  **Narkose**: altgrichisch ναρκώδης *narkōdēs* „erstarrt“
% -  **Narkose**: „Lähmung, Erstarrung“
...
- Verminderung des Muskeltonus: „**Relaxierung**[^Relaxierung-Relaxanz]“


[^Relaxierung-Relaxanz]: Relaxierung hat in diesem Zusammenhang nicht zwangsläufig etwas mit der Gabe eines dezidierten Muskelrelaxanz zu tun.

Dies wird erreicht durch die strukturierte Zufuhr
...
Die Auswahl der {ref}`Atemwegstechniken <Airway-Techniken>` richtet sich dabei grundsätzlich nach der Aspirationsgefahr des Patienten, sowie Art und Dauer der Operation.
Während bei einer Sedierung von nüchternen Patienten mit weitgehend erhaltener Spontanatmung häufig das mechanische Offenhalten der Atemwege im Vordergrund steht, so muss man bei einer Allgemeinnarkose mit der Notwendigkeit einer assistierten oder kontrollierten Beatmung rechnen, sodass die Anwendung entsprechender Atemwegs-Devices sinnvoll ist.

Häufige Atemwegs-Techniken bzw. -Devices im Rahmen der Allgemeinnarkose sind die
- {ref}`Endotracheale Intubation <ETI>` und die
- {ref}`Larynxmaske <Larynxmaske>` als weniger invasive Alternative für nüchterne Patienten ohne besondere Aspirationsgefahr, Eingriffe in Rückenlage und kurzer bis mittlerer Eingriffsdauer.
...
Durch reversible Beeinflussung von Erregungsbildung und -überleitung im
ZNS führen Anästhetika zu folgenden Wirkungen:

- Bewusstseinsverlust
- Tonusabnahme der Muskulatur
- Analgesie

Eine Narkose während zum Beispiel einer Operation hat also folgende
Ziele:
...
Narkotika beeinflussen das ZNS in einer bestimmten Reihenfolge – zuerst
die Hirnrinde, dann folgt das Mittelhirn, darauf der Hirnstamm, dann das
Rückenmark und nur bei Überdosierung die Medulla oblongata.

Heutzutage wird meist eine Kombinationsnarkose angewandt. Diese kann aus
verschiedenen Medikamentengruppen bestehen:

- Prämedikation (Sedierung, vegetative Dämpfung)
- Narkoseeinleitung (i.v.-Anästhetikum)
- Aufrechterhaltung der Anästhesie (Inhalationsanästhetikum)
- Verstärkung der Analgesie (Lachgas)
- Opioid
- vollständige Muskelerschlaffung (Muskelrelaxans)

Um dem Anästhesisten einen Eindruck der Narkosetiefe zu ermöglichen,
kontrolliert er in regelmäßigen Abständen den Blutdruck, welcher mit
zunehmender Narkosetiefe abfällt, und die Reaktionen des Patienten auf
chirurgische und anästhesiologische Reize (unzureichende Narkosetiefe:
Blutdruck-Anstieg, Herzfrequenz-Anstieg, Schwitzen, Bewegungen)
wiederspiegelt.

Narkosestadien die während jeder Narkose durchlaufen werden:
...
Logischerweise sollte die Operation im Stadium der Toleranz erfolgen und
die Paralyse nie erreicht werden. Bei der Narkoseausleitung durchläuft
der Patient die Stadien in umgekehrter Reihenfolge.

:::{rubric} Intravenöse Anästhetika
:::

Im Gegensatz zu den Inhalationsanästhetika haben i.v.-Anästhetika den
Vorteil einer raschen Narkoseeinleitung. Man kann sie jedoch schlechter
steuern. Die i.v.-Anästhetika verteilen sich je nach Durchblutung in den
verschiedenen Geweben ([Abb. 1](#anchor)).

:::{figure} media/Pictures/10000000000017DB00000D0752D550DF16925D68.png
Verteilung von i.v.-Anästhetika in den verschiedensten Geweben
:::
...
:::{attention} Die Videolaryngoskopie ist per se *kein* Garant für einen schnellen Intubationserfolg. Bei hellem Umgebungslicht oder viel Sekret (Blut, Erbrochenes etc.: blockiert die Kamera) kann sie nachteilig sein.
:::

:::{admonition} Bespiel: Ablauf RSI: Jung, gesund, 70 kg, Reflux

1. Präoxygenieren
2. Fentanyl 0,2 mg
3. Abwarten der Fentanylwirkung
4. Propofol 200 mg
5. Phenylephrin 0,050 mg
6. Rocuronium 70 mg
7. 1 Minute warten
8. {ref}`ETI <ETI>`
:::
...
1. Präoxygenieren
2. Norardrenalin einschleichen
3. Propofol 50 mg
4. Noradrenalin steigern, ev. Phenylephrin 0,100 mg
5. Rocuronium 70 mg
6. Noradrenalin steigern, ev. Phenylephrin 0,100 mg
7. 1 Minute warten
8. {ref}`ETI <ETI>`
:::
