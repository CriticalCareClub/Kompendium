...
Freiheit oder durch Drohung mit gegenwärtiger Gefahr für Leib oder Leben
 zur Vornahme oder Duldung des Beischlafes, oder einer dem Beischlaf
gleichzusetzenden geschlechtlichen Handlung, nötigt.\ZFootnote{{\S}\,201 StGB}
}{}{}{}{}

\Layout{2}{Geschlechtliche Nötigung}{%
Eine Geschlechtliche Nötigung begeht, wer -- außer in den Fällen von
Vergewaltigung -- eine Person mit Gewalt oder durch gefährliche Drohung zur Vornahme oder
Duldung einer geschlechtlichen Handlung nötigt.\ZFootnote{{\S}\,202 StGB}
}{}{}{}{}
...
Verleitung zu geschlechtlichen Handlungen unter bestimmten Umständen, unter
welchen die betreffe Person aufgrund ihres Alters, Geschäftsfähigkeit,
bestehender Abhängigkeiten oder anderer Gründe \E{besonderen Schutz durch das
Gesetz genießt}.
...
einzusehen} {\ldots}, {\ldots} dadurch missbraucht, dass er an ihr eine \E{geschlechtliche Handlung}
vornimmt oder von ihr an sich vornehmen lässt oder sie zu einer geschlechtlichen Handlung mit
einer anderen Person oder, {\ldots}, dazu verleitet, eine geschlechtliche Handlung an sich selbst
vorzunehmen, ist mit Freiheitsstrafe {\ldots} zu
bestrafen.
...
als vier Jahre {\ldots}, so ist der Täter
nach Abs. 1 und 2 \E{nicht zu bestrafen}, es sei denn, die unmündige Person
...
mangelnden Reife sowie seiner \E{altersbedingten Überlegenheit} eine
geschlechtliche Handlung vornimmt, {\ldots}, ist {\ldots} zu
bestrafen.

(2) Wer an einer Person, die das 16. Lebensjahr noch nicht vollendet hat,
\E{unter Ausnützung einer Zwangslage} dieser Person eine geschlechtliche
...
durch ein Entgelt dazu verleitet, eine geschlechtliche Handlung {\ldots} vorzunehmen {\ldots},
ist {\ldots} zu bestrafen. 
}
\item Sittliche Gefährdung von Personen unter sechzehn Jahren\ZFootnote{
...
Eine Vernachlässigung begeht, wer einem anderen, der seiner Fürsorge oder Obhut
untersteht und der das achtzehnte Lebensjahr noch nicht vollendet hat oder wegen
Gebrechlichkeit, Krankheit oder einer geistigen Behinderung wehrlos ist,
körperliche oder seelische Qualen zufügt; bzw. wer seine Verpflichtung zur
Fürsorge oder Obhut einem solchen Menschen gegenüber gröblich vernachlässigt und
dadurch, wenn auch nur fahrlässig, dessen Gesundheit oder dessen körperliche oder
geistige Entwicklung beträchtlich schädigt.\ZFootnote{{\S}\,92 StGB: Quälen oder
Vernachlässigen unmündiger, jüngerer oder wehrloser Personen}
