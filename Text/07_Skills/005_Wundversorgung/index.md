...
- *Eintritt von Krankheitserregern (Infektionsgefahr):* Jede Wunde ist
  ...
  verfügen
  (s. {ref}`tetanus-impfschutz`)[^tetanusimpfschutz].
  Bei Bisswunden kann
...
[^tetanusimpfschutz]: Zur Verifizierung eines aufrechten Tetanus-Impfschutzes muss jede
