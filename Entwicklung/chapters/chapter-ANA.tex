...
Strukturen, wie z.\,B. Herz, Hirn, Lunge, Knochen, Muskel,
\protect\enquote{erbauen}.

Zellen gleicher Art bilden also Gewebe. Wenn sich
verschiedene Gewebearten zusammentun entsteht hieraus ein
Organ. Organe, die dem gleichen Ziel dienen, können zu
...
\begin{itemize}
  ...
  Gruppe.
  \item Binde- und Stützgewebe: Unter Bindegewebe versteht
  man eine Art \protect\enquote{Lückenfüller}, es verbindet
...
notwendig. Deshalb kann man nach Frakturen auch Nägel in die
...
{Bei den Gelenken kann man zwischen Gelenken \E{mit
...
\begin{inparaitem}
  ...
  \item \T{Wirbelbogen}\index{Wirbelbogen}, welcher das
...
Blutbestandteile (4\,000\,000\,/$\mu$l) und tragen die
...
verschiedene Arten von Leukozyten\ZFootnote{\begin{inparaitem}
  \item \T{Granulozyten}: Sie bilden den Beginn der
Immunabwehr.
...
%   und Parasiten) und basophile G.
  \item \T{Lymphozyten}: In diese Gruppe fallen
  Antikörper-bildende Zellen.
  \item \T{Monozyten}: Sie Können sich durch zelleigene
...
Die Blutplättchen sind kleine kernlose Scheibchen. Sie
dienen der \EE{Blutgerinnung} und dem Wundverschluss.
\Z{Ihre Anzahl wird mit 150\,000 bis 300\,000 pro $\mu$l
...
\EE{Gehirn} und \EE{Rückenmark} bilden
...
\begin{itemize}
    ...
    \item Bewusstsein und
    \enquote*{Bewusstmachung}
    \item Abgabe  von zweckentsprechenden Impulsen
...
Der Augapfel hat eine annähernde Kugelform. Von außen nach
...
\index{Gallenblase}
\index{Gallengang}
Von der Leber leiten die Gallengänge die Gallenflüssigkeit
