...
\gE{Zellkern}\index{Zellkern}, der die gesamten Erbinformationen in Form von DNS
...
\index{Bauchfell}
% REVIEW Bauchfell: Fließtext mangelhaft
\fxnote[author=HIRT]{Review: Bauchfell: Fließtext}
% REVIEW Bauchfell: Beschreibung mangelhaft
\fxnote[author=HIRT]{Review: Bauchfell: Beschreibung mangelhaft}
% REVIEW Bauchfell: SLIDE fehlt
\fxnote[author=HIRT]{Review: Bauchfell: SLIDE fehlt}

\gLayout{20}
{}
{ 
Das Bauchfell (\gT{Peritoneum}) ist eine dünne Haut das die gesamte Bauchhöhle
auskleidet. Dieser Überzug bedeckt die meisten Bauchorgane (außer z.B. die
Nieren) und das große und kleine Netz (\gT{Omentum majus und minus}). Es sorgt durch seine feuchte
und glatte Oberfläche dafür, dass die Organe, wie z.B. Darm, ihre Bewegungen
zur Verdauungen besser durchführen können.
