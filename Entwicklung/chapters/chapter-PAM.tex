...
Arbeits- und Ausbildungsstandards} {\color{DefaultGrey}für den Sanitätsdienst}} | {\AASS} \opt{VAR-VAR2}{| {\color{AsboeRed}ASBÖ}}
...
\begin{itemize}
  ...
  \item Suerstoffgabe (\prettyref{MK-m:sauerstoffberieselung})
...
\clearpage
\section{Kommunikation mit Patienten, Angehörigen und Mitarbeitern}
...
Bedienstete von Verkehrsbetrieben usw. Dabei darf man auch
...
\clearpage
\section{Einschätzungsblock -- ABCDE}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\subsection{{\FontKeyboardFamily{2}} Eindruck + HWS-Stabilisierung (Cervical
Spine)} 

\Layout{0}{Ei | Eindruck + HWS-Stabilisierung (Cervical Spine)}{%
...
Halswirbelsäule begonnen. \index{HWS-Stabilisierung!Eindruck (ABCDE)}

\subparagraph{\eye} Auffallen kann eine \E{blasse  Haut}, \E{Zyanose},
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\subsection{{\FontKeyboardFamily{4}} Hauptbeschwerde}
\Layout{0}{{Hb} | Hauptbeschwerde}{%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\subsection{{\FontKeyboardFamily{A}} Atemweg}
\Layout{0}{{A} | Atemweg}{%
...
\subparagraph{\eye} Speziell \E{pfeifende}, \E{gurgelnde} oder \E{schnarchende}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\subsection{{\FontKeyboardFamily{B}} Atmung}
\Layout{0}{{B} | Atmung}{%
...
\subparagraph{\eye} Erkennbar sind z.\,B. eine Zyanose,
Anzeichen einer (oder Klage über) Atemnot, eine zu schnelle
...
Die genauen Normalwerte sind abhängig von den Faktoren
Alter, Geschlecht und Größe.
\cite{KlinkePhysio3,SchmidtPhysio28,DRAn3,StriebelAn7}

\begin{table}[H]
\Captionof{table}{Atemfrequenz und -zugvolumen im
...
Atemzugsvolumen so klein dass die \enquote*{frische} Luft im
Totraum bleibt und nicht in die Lungenbläschen gelangt: Es
gelangt keine frische Luft in die
Lungenbläschen und folglich kein Sauerstoff ins Blut.
\label{topic:schnappatmung}
Bei der \index{Schnappatmung}\T{Schnappatmung} kann
...
ist die \Abk{COPD} (\FullPrettyRef{topic:copd}).
}{
\begin{itemize}
...
Das Herz kontrahiert\footnote{\I{Kontraktion}:
Zusammenziehen; hier: Herzschlag} beim Erwachsenen mit einer
\I{Herzfrequenz} (\I{HF}) von \VonBis{60}{100}\PerMin* und wirft 
dabei jedes Mal ein \I{Schlagvolumen} (\I{SV}) von ca.
\VonBis{70}{80}\Ml* aus
...
\noindent{\tiny Werte beziehen sich auf den Erwachsenen.}
...
können!}. 
Sie dient dem Aufspüren von akut
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\subsection{{\FontKeyboardFamily{D}} Schnelle Untersuchung}
...
\begin{compactitem}
  ...
  \item[\eye] Zuckerstoffwechselstörungen
\end{compactitem}
}{}{}{}
...
\Ca{Der Einschätzungsblock muss regelmäßig während der Betreuung bzw. 
...
% \clearpage
\subsection{Zeichen einer Vitale Bedrohung: Alarmzeichen (\protect\enquote*{Red
Flags} \RedFlag)}

\Layout{0}{Alarmzeichen (\protect\enquote*{Red
Flags} \RedFlag)}
{%
...
\begin{itemize}
  \item[\RedFlag] \EE{Massive BeABC-Störung}: Massive
  Störungen von Vitalfunktionen 1ter Ordnung (Bewußtsein, Atmung,
  Kreislauf)
...
{
\begin{itemize}
    \item[\RedFlag] Massive BeABC-Störungen
    (Vitalfunktionen)
...
\begin{itemize}
  ...
  \item Vorgezogene Strategie- und Transportentscheidung bei absolut zeitkritischen Patienten.
\end{itemize}
...
\index{Vorgezogene Strategie- und Transportentscheidung 
...
{
\begin{itemize}
  \item \Ca{Im Ausnahmefall schon nach dem Punkt C Strategie- und Transportentscheidung}
...
bereits ausgeführt kann bei 
\EE{absolut zeitkritischen Patienten}, bei denen bereits die 
ABC-Einschätzung ergibt dass ein Transport nicht aufschiebbar ist, 
schon \EE{nach dem Punkt C eine Transportentscheidung} (Spital, 
...
\clearpage
\section{Patientengespräch und Anamneseerhebung -- SAMPLER}
...
\Layout{0}{Symptome und Schmerzen}{%
...
\section{Weiterführende Diagnostik, Anamnese und
Maßnahmen}
...
% \clearpage % TODO Temp clearpage
\section{Transportentscheidung und Transport}
