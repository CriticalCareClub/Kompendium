...
herrscht. Er ist in Kombination mit der Herzfrequenz einer
der wichtigsten Messwerte im Rettungsdienst.

\subsection{Messung der Herzfrequenz - HF}

Die Herzfrequenz entspricht der Anzahl der Schläge des
Herzens pro Minute. Sie wird mittels fühlen des Pulses
ermittelt. Dieser wird idealerweise an der Handgelenkarterie
(a.radialis) bzw. bei nicht ansprechbaren oder schockierten
Patienten an der Halsschlagader (a.carotis) ertastet. Bei
Neugeborenen und Säuglingen kann man ihm auch an der
Oberarmarterie (a.brachialis) fühlen. Gemessen wird immer mit
zwei bis drei Finger. Nie jedoch mit dem Daumen, da hier
meistens nur der eigene Puls gefühlt wird und nicht der des
...
zwei bis drei Finger ertastet. Nun werden 15 Sekunden lang
die Schläge gezählt. Dieser Messwert wird mit 4 multipliziert
und herauskommt die Herzfrequenz (HF) des Patienten. Der
Normalwert liegt zwischen 60 und 100 Schlägen pro Minute.
Dokumentiert wird sie mit einem f (z.B.: f=70)

\subsection{Messung des Blutdrucks - RR}

\gMarried{ Der Blutdruck kann mittels elektronischer
Blutdruckmessgeräte ermittelt werden. Diese sind aber im
Rettungsdienst nicht in Verwendung, da es immer wieder zu
Gerätefehler kommen kann. Ausserdem können die Batterien leer
...
Bei der Blutdruckmessung gibt es nun zwei Möglichkeiten zu
...
(Entspannungsphase). Der diastolische Wert kann aber nur
...
kann. Nun noch 20 mmHg weiter aufpumpen. Das Stethoskop wird
nun in der Ellenbeuge auf die Oberarmarterie (a.brachialis)
...
Normalwert liegt bei RR 120/80 mmHg.
...
auf der Handgelenkarterie (a.radialis). Die Luft langsam aus
der Manschette ablassen. Sobald man wieder einen Puls fühlt,
...
ist aber in der Regel der systolische Wert der wichtigere.
...
&
 \includegraphics[width=4cm]{./images/noauth/GER-absaugung-katheter.png}
\\\bottomrule
\end{tabulary}
\end{center}
...
\begin{figure}[H]
    ...
    \captionof{figure}{\gAuthNotesPicLegalNotOk{GER-tragsessel.jpg}{}}
    \end{center}
\end{figure}
...
\begin{figure}[H]
    ...
    \captionof{figure}{\gAuthNotesPicLegalNotOk{GER-fahrtrage-stollenwerk.jpg}{}}
    \end{center}
\end{figure}
...
\begin{figure}[H]
    ...
    \captionof{figure}{\gAuthNotesPicLegalNotOk{GER-umlagern.png}{}}
    \end{center}
\end{figure}
...
Gelände bis zum Retten aus einer LKW-Kabine.
    ...
    \captionof{figure}{\gAuthNotesPicLegalNotOk{GER-schaufeltrage.jpg}{}}
    \end{center}
}
...
werden.
 ...
 \begin{center}
    ...
    \includegraphics[width=5cm]{./images/noauth/GER-rr-geraeusche.png}
   
    \captionof{figure}{\gAuthNotesPicLegalNotOk{KED}{}}
    \end{center}
}
...
oder einem Dreiecktuch fixiert werden.
    ...
    \includegraphics[width=\linewidth]{./images/noauth/GER-samsplint.png}
   
    \captionof{figure}{\gAuthNotesPicLegalNotOk{GER-samsplint.png}{}}
}
...
Dient zum Ruhigstellen von Verletzungen zwischen Knie und Zehen.
    ...
    \captionof{figure}{\gAuthNotesPicLegalNotOk{GER-vakuummatratze.png}{}}
    \end{center}
}
...
{
    \begin{center}
    \includegraphics[width=5cm]{./images/gereate/KED.jpg}
