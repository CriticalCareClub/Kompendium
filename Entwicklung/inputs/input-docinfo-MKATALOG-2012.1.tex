...
\newcommand{\VarAassVersion}{0.26}
\newcommand{\DocVersion}{2012.1}
...
\renewcommand{\DocVersionInfo}{Vorabversion} 
\hypersetup{
% draft,
unicode=true,
colorlinks=false,
...
\renewcommand{\DocGitCommit}{\input{git-lastcommitsha1.tmp}}
