...
\end{wrapfigure}Für Unfälle mit Fahrzeugen gilt allgemein:
...
\begin{table}[H]
\gTagBugfix{Wundarten}\gCaptionof{table}{Wundarten.}
...
\begin{table}[H]
\gTagBugfix{Bilder Wunden}\gCaptionof{table}{Bilderserie:
\gSlideHeading{Wunden}}
...
\begin{table}[H]
\gTagBugfix{Bilder Verätzungen und Verbrennungen}\gCaptionof{table}{Bilderserie:
\gSlideHeading{Verätzungen und Verbrennungen}}
