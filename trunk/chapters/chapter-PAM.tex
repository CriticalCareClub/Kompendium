...
\end{wrapfigure}Gerade zu Beginn der Tätigkeit als medizinische Fachkraft
...
\begin{itemize}
  ...
  \item 1. Schritt: \Es{Ersteinschätzung des Patienten}
...
\begin{itemize}
  ...
  \item Ersteinschätzung des Patienten
  \item Erstmaßnahmen
...
\subsubsection{Erster Schritt: Ersteinschätzung}
...
\Layout{0}{A -- Atemweg}{
\Z{(\Lang{engl.} Airway)}
Erhoben bzw. beobachtet werden Atemgeräusche und die Gestik des Patieten.
...
\Z{\E{Speziell ausgebildetes} Personal kann mittels eines Stethoskops die oben
und unteren Atemwege abhören (auskultieren) und damit Störungen des Atemwegs und
der Atmung besser einschätzen.}
...
ergriffen werden (evt. sogar noch Abschluss des
Ersteinschätzungsblockes)!}}{\vspace{1em}
