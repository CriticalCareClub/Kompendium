...
Patient niemals der Sanitäter, sondern stets die von ihm vertretene
...
\begin{itemize}
	\item {\mdseries
	\gT{Heilbehandlungsvertrag}: Der Patient selber w\"unscht
	behandelt zu werden}
...
Schädigungen des Patienten durch Handlungen des (Not)Arztes/
Sanitäters, kann der Geschädigte deliktisch gegen den Erf\"ullungsgehilfen und
vertraglich gegen die Organisation vorgehen. (IdR. wird der
...
bis zur Krankenanstalt (= KA) bestimmen, da erst in der Krankenanstalt von 2
...
\begin{itemize}
	...
	auffallenden Patienten medizinisch indiziert und
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item \"uber Umstände die f\"ur verständigen Patienten ins
...
\begin{itemize}
	...
	der Patientin das oberste Gebot bleibt. Mit einer
	Reanimation ist zu beginnen (wenn \"uberhaupt noch erfolgreich).}
...
{\quotedblbase}Boder\footnote{"Bader": fr\"uher Kundiger der Heilbäder, heute umgangssprl. f\"ur Arzt}{\textquotedblleft} zu warten und der Patient auch
...
Nitro-Verabreichung zur Bekämpfung des hohen Blutdrucks (200/110 mm Hg) anordnet, obwohl sie von Sepp \"uber
...
darunter sich versteckende Katze fällt. Bernd kann sich beim Sturz wenigsten selber
...
die Reise zur Krankenanstalt. Doch ist leider das einzig abbuchbare Bett, welches
...
dem Patient zur nicht vorinformierten Aufnahme. 
...
\item {\mdseries
	...
	\begin{itemize}
		...
		verschlechtern, so darf das nächstgelegene Spital angefahren werden. \newline
...
\gEs{Meldepflichtige Krankheiten}:}
	...
	\begin{itemize}
		...
		bei HIV) oder Todesfall mit erkennbaren AIDS typischen
		Krankheiten\footnote{s. Kap. Hygiene, \ref{topic:aids}}}
...
gro{\ss}es Feilchen ziert das rechte Auge der jungen
Patienten. Als Natascha auf diese weiteren Verletzungen
...
Patient) unangeschnallt mitfahren darf, wenn es ansonsten
