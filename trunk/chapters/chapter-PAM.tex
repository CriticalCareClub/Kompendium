...
Bewusstseinsgrad (\Speech{"`\Es{Wieviel} Bewusstsein ist vorhanden?"'}, vgl.
...
\begin{itemize}
  ...
  \item Notarzt-Nachforderung (bei Bedarf, z.\,B. Schmerztherapie, Belassung
  trotz Behandlungsnotwendigkeit auf Patientenwunsch, \ldots).
