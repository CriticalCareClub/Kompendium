...
\subsection{\HeadingKeyword{Allgemeines}}
...
\subsection{Die \HeadingKeyword{Rettungskette}}
\index{Rettungskette}
...
\begin{Synopsis}
  \SynopsisItem{Rettungskette: Eine Kette ist immer nur so stark 
...
\section{\HeadingKeyword{Lebensrettende Sofortmaßnahmen}}

\subsection{\HeadingKeyword{Verhalten} am Notfallort}
...
\subsection{\HeadingKeyword{Gefahrenbereich}}
...
\Text{Absichern des Gefahrenbereichs}
...
\begin{Synopsis}
  \SynopsisItem{Selbstschutz geht vor Fremdschutz!}
\end{Synopsis}
...
Der Ersthelfer muss vor dem Aussteigen aus dem Auto
eine \EE{Warnweste} auziehen und mit bereits
geöffnetem \EE{Warndreieck} (Pannendreieck) dem 
Verkehr entgegengehen. 
}{
\begin{itemize}
...
\begin{Synopsis}
  \SynopsisItem{Niemals selbst gefährden!}
\end{Synopsis}
...
\subsubsection{\HeadingKeyword{Gefahrengutransport}}
...
\subsubsection{\HeadingKeyword{Retten} aus dem Gefahrenbereich}
...
\begin{Synopsis}
  \SynopsisItem{Der Patient ist so rasch und so schonend wie möglich aus der
...
\subsection{Eine \HeadingKeyword{Helmabnahme} ist verpflichtend}
...
\begin{Synopsis}
  \SynopsisItem{Ein Sturzhelm ist bei einem Unfall grundsätzlich immer abzunehmen!}
\end{Synopsis}
...
\subsection{\HeadingKeyword{Kontrolle} der Vitalfunktionen}
...
möglich ist: \E{Ohne Kreislauf keine Atmung, ohne Atmung kein Kreislauf!}
}{
\begin{itemize}
...
\begin{Synopsis}
  \SynopsisItem{Ohne Atmung kein Kreislauf.}
\end{Synopsis}
...
\begin{enumerate}
  ...
  \begin{Danger}
    \item Patienten, die in Folge eines Unfalls verunglückt
...
Wenn eine ausreichende Atmung vorhanden ist, 
so ist auch ein Kreislauf vorhanden.
%
Fehlt eine ausreichende Atmung (und ebenso das Bewusstsein), 
so ist das mit dem Fehlen eines Kreislaufs 
(Kreislaufstillstand) 
gleichzusetzen.
}{
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Fühlen
  \end{itemize}
  \item[\SymbolFindingNormal] \Range{2}{3} Atemzüge / 10\Sec*
  \item Wenn Atmung vorhanden, ist auch ein Kreislauf vorhanden
  \item Kein Bewusstsein, keine Atmung = Kreislaufstillstand
\end{itemize}
}{}{}{}

\begin{Synopsis}
  \SynopsisItem{Wenn eine Atmung vorhanden ist, dann ist auch ein
  Kreislauf vorhanden.}
  \SynopsisItem{Fehlt das Bewusstsein und die Atmung, 
  dann ist das mit einem Kreislaufstillstand gleichzusetzen.}
\end{Synopsis}
...
schaut auf den Brustkorb -- schematisch {\ldots} \SourcePicture{Hirtler}}
...
\subsection{Notfalldiagnose \HeadingKeyword{Bewusstlosigkeit}}
...
\subsection{Notfalldiagnose \HeadingKeyword{Atem- und Kreislaufstillstand}}
...
\T{Atem-/Kreislaufstillstand} vor.

\subparagraph{Besonderheit: Notruf}
%
...
\begin{itemize}
  ...
  \item $\rightarrow$ Kein Kreislauf
  \item Besonderheit Notruf: Bereits nach Kontrolle der Vitalfunktionen
  \item Anschließend lebensrettende Sofortmaßnahmen
\end{itemize}
}{}{}{}
...
\subsubsection{Die \HeadingKeyword{Herzdruckmassage} ist die Basis der Wiederbelebung}
...
möglichst \EE{harten und unnachgiebigen}, 
\EE{festen Unterlage} gelagert werden, 
...
\E{ungenügenden Fluss} des Blutkreislaufs. 
...
\begin{Synopsis}
  \SynopsisItem{Wird bei der Reanimation einmal ein falscher Druck ausgeübt oder eine
  Rippe gebrochen: Nicht aufhören, sondern den richtigen
  Druckpunkt erneut aufsuchen und Reanimation fortsetzen!}
\end{Synopsis}

\subsubsection{\HeadingKeyword{Beatmung}}
...
Das entscheidende Kennzeichen für das \EE{Atemzugvolumen} ist das 
...
\begin{itemize}
  ...
  \item Atemzugvolumen: Heben und Senken des Brustkorbes 
  (ca. 500\Ml*)
  \item Sauerstoffkonzentration:
  \begin{itemize}
    \item Umgebungsluft 21\PC* 
    \item Ausatemluft 16\PC* 
  \end{itemize}
\end{itemize}
}{}{}{}
...
Es soll mit dem richtigen \EE{Atemzugvolumen} beatmet werden: 
%
Ein \E{zu hohes} Atemzugvolumen führt zu einem höheren
...
einem \EE{zu niedrigen} Atemzugvolumen ist die
\ce{O2}-Versorgung nicht sichergestellt, da die Luft nicht
bis in die Lunge kommt. 
%
Eine zu hohe \EE{Atemfrequenz} hindert den Patienten am Ausatmen. 
%
Bei Bartträgern kann es zu einer
ungenügenden \EE{Abdichtung} kommen.
Wenn es
...
\subsubsection{Algorithmus \HeadingKeyword{Herz-Lungen-Wiederbelebung}}
...
{Ansprechen, berühren\Z{, (Schmerzreiz)}}
...
\begin{enumerate}
  \item \EE{Ablösung durch andere Helfer}: 
  Dies können entweder professionelle Rettungskräfte, aber auch 
  andere Ersthelfer sein. 
  Der
  Helfer darf beim Eintreffen der Ablösung
  nicht sofort mit der Wiederbelebung  aufhören, sondern
  muss diese weiterführen bis er ausdrücklich vom
  nachfolgenden Helfer abgelöst wird.
  ...
  \Ca{Erbrechen zählt \E{nicht} als Lebenszeichen.}
\end{enumerate}
...
\begin{Danger}
  \SynopsisItem{Erbrechen ist kein Lebenszeichen!}
\end{Danger}
...
\subsection{Starke \HeadingKeyword{Blutung}}
...
\TextSlide{Material für die Blutstillung}
{%
\index{Blutstillung}%
...
\Picture
{Material für einen Druckverband}%1 Titel
{Handschuhe, Wundauflage, Druckkörper, Dreiecktuch}%2 Beschreibung
{}%3 Label
{\AASS}%4 Quelle
{MfG}%5 Lizenz
{./images/koch-aass/00800-gamma/MaterialDruckverbandb.JPG}%6 Datei
{}%7 Breitenmodifizierer
{}%8 Float


\TextSlideTeaser
{Blutstillung durch Zudrücken}%1 Titel
...
Unter Umständen kann auch der Patient selber zum 
Zudrücken angeleitet werden.}%2 Text
{%
\begin{itemize}
...
\end{itemize}}%3 Slide
{./images/hauer-david-aass/blutstillung_druck-00800.jpg}%4 Bilddatei
{Simpel, aber Wirkungsvoll: Draufdrücken!}%5 Bildtitel
{}%6 Bildbeschreibung
{David Hauer}%7 Quelle
{MfG}%8 Lizenz
 % Vormals \Layout{60}
...
abzudrücken. 
Auch hier soll nach Möglichkeit die betroffene Extremität 
hochgehalten werden
...
\begin{Danger}
  \item Am Hals darf kein Druckverband angelegt
  ewerden!
\end{Danger}
...
{Als Erstmaßnahme Extremität hochlagern und mit einer
...
eliminiert worden. Grund dafür ist, 
...
\begin{Danger}
  \item Abbindung nur bei lebensbedrohlichen Blutungen, die
  nicht anders stillbar sind!\footnote{Z.B. bei totaler
  Amputation, teilweiser Abtrennung/Zerfetzung oder
  unerreichbarer Blutungsquellle (Einklemmung).}
  \item \Ca{Die Abbindung ist die letzte Wahl!}
\end{Danger}
...
Dazu darf nur ein \EE{breites und
schonendes Material} verwendet werden (z.\,B.
Dreiecktuchkrawatte, Blutdruckmanschette, etc.). 
Nachteil
ist die Unterbrechung der Blutversorgung der Extremität.
...
Auch hier soll die betroffene Extremität nach Möglichkeit 
hochgelagert werden.
}{ 
\begin{itemize}
  \item Nur bei lebensbedrohlichen Blutungen, die anderweitig nicht stillbar ist:
  \begin{itemize}
  	\item Totale Amputation, teilweise Abtrennungen/Zerfetzung
  	\item Unerreichbare Blutungsquelle, z.\,B. bei Einklemmung
  	\item Im Großschadensfall bei Anwendung der Katastrophenmedizin
  \end{itemize}	
  \item Nur am Oberarm und Oberschenkel
  \item Nur breites und schonendes Material
  \item Zeitpunkt der Abbindung notieren
  \item Hochlagern der verletzten Extremität
\end{itemize}
}{}{}{}
...
Der Zustand, 
welcher umgangssprachlich oft als \enquote*{Schock} bezeichnet wird, 
ist eine Schreckreaktion mit Muskelzittern,
weichen Knien, Schwächegefühl und Blässe. 
Es handelt sich dabei um eine Reaktion des Nervensystems, 
ist normalerweise nicht bedrohlich 
und hat mit dem hier beschriebenen Schock nichts zu tun. 
}%2 Text
...
\begin{itemize}
  ...
  \item \EE{Dezentralisation}: Hält dieser Zustand länger an,
  bzw. ist nach wie vor zu wenig Blut vorhanden, 
  endet die Zentralisation 
  und es kommt wieder zu einem Blutfluss auch in die weniger lebenswichtigen Organe des Körper: 
  \I{Dezentralisation}. 
  Der dadurch
  entstehende Blut- und Sauerstoffmangel bei den lebenswichtigen
  Organen führt zu einer \EE{Schädigung der Organe}, die in
  weiterer Folge zum \EE{Versagen der Organe} führt. 
  Der Schock ist daher ein höchst lebensbedrohlicher Zustand.
\end{itemize}
...
Schockzeichen werden oft erst (zu) spät erkannt, 
da sie oft erst spät auftreten, 
und man auch oft die Symptome anderen Umständen 
(Kälte, Aufregung, {\ldots}) zuschreibt. 
Der Patient hat oft eine \EE{blasse Haut}, 
manchmal \EE{zittert und friert} er. 
Paradoxerweise hat er dabei einen \EE{kalten, klebrigen
Schweiß} auf der Stirn. 
Der Patient kann außerdem
\EE{verwirrt, unruhig und ängstlich} sein. 
Oft hat er eine
...
\section{Gemeinsam statt einsam: \HeadingKeyword{Notruf}}
\index{Notruf}
...
\index{133}
\index{144}
Die drei in Österreich geltenden grundlegenden Notrufnummern
lauten:
\EE{\Code{122} Feuerwehr}, 
\EE{\Code{133} Polizei} 
und \EE{\Code{144} Rettung}. 
%
Vor einigen Jahren kam durch die EU eine weitere
Notrufnummer dazu:
...
Die
\II{Vergiftungsinformationszentrale} (VIZ) dient nur dazu
...
Der \II{Ärztefunkdienst} (\Abk{ÄFD})
...
Für Alpinunfälle wurde vom Österreichischen \II{Bergrettungsdienst} die Notrufnummer \Code{140} eingerichtet.
}{
\begin{description}
  ...
  \item[Bergrettungsdienst] \Code{140}
\end{description}
}{}{}{}



\section{\HeadingKeyword{Weitere Erste Hilfe} und wichtige Krankheitsbilder}
...
\subsection{\HeadingKeyword{Wunden} und andere spezielle Situationen}
...
\TextSlide{Oberflächliche Schürf- und Schnittwunden}
{%
Darunter fallen neben Schürfwunden kleine Schnittwunden mit 
-- je nach Körperregion -- 
einer Tiefe bis \nicefrac{1}{2}\CM* 
und einer Länge von maximal 2\CM*, 
sofern sie nicht unter 
\FullPrettyRef{tab:wunden-aerztliche-begutachtung}, aufgeführt sind. 
Bei richtiger Behandlung durch den Ersthelfer 
und bestehendem Tetanus-Impfschutz 
müssen diese nicht ärztlich begutachtet werden.
}{
\begin{itemize}
  \item kleine, oberflächliche Wunden:
  
  max. \nicefrac{1}{2}\CM* tief und 2\CM* lang
\end{itemize}
}{}{}{}
...
\TextSlide{Wunden, welche ärztlich begutachtet werden müssen}
{%
Alle Wunden, 
welche tiefer als \nicefrac{1}{2}\CM* 
oder länger als 2\CM* sind,
bzw. an besonders gefährdeten Stellen liegen 
(Augenlied, \ldots), 
müssen ärztlich begutachtet 
und ggfs. weiter versorgt werden, vgl. auch 
\FullPrettyRef{tab:wunden-aerztliche-begutachtung}. 
Für diese Fälle
gibt es \E{zwei Gebote} für den Ersthelfer, 
welche er unbedingt einhalten muss:
\begin{enumerate}
  \item \EE{Es kommt nichts in die Wunde hinein}; 
  Wundpuder, 
  Wundsalben 
  oder Ähnliches sind tabu! 
  Derartige \enquote*{Hilfsmittel} müssen sonst bei einer weiteren Versorgung mühevoll aus der Wunde entfernt werden.
  \item \EE{Es kommt nichts aus der Wunde heraus.}
  Fremdkörper, 
  welche ein Blutgefäß durchtrennen, 
  dichten dieses oft ab. 
  Beim Entfernen kann es dann zu
...
\TableWide
{Wunden, welche ärztlich begutachtet werden müssen}%1 Titel
{}%2 Beschreibung
{\label{tab:wunden-aerztliche-begutachtung}}%3 Label/Hook
{}%4 Quelle
{}%5 Lizenz
{%
\begin{tabulary}{\linewidth}{LL}
\addlinespace\toprule\addlinespace
\noindent\EE{Tiefe oder ausgedehnte Wunden}
&
Je nach Körperregion, 
Richtwert:  >~\nicefrac{1}{2}\CM* tief oder  2\CM* lang
\\\addlinespace
...
\\\addlinespace
\noindent\EE{Wunden an Gelenken, Händen oder Füßen}
&
...
\subsubsection{\HeadingKeyword{Verbrennungen}, Verbrühungen}
...
es \E{für Erwachsene} auch noch die \T{Neunerregel}: Hier wird der 
Körper in
...
\begin{table}[H]
\caption{Neunerregel (Erwachsene)}
...
\begin{Danger}
  \item Schockgefahr!
  \item Bei Kindern ist ab \EE{5\PC*}, 
  bei Erwachsenen ab \EE{10\PC*}
...
\subsubsection{\HeadingKeyword{Erfrierungen}}
...
%\clearpage
\subsubsection{\HeadingKeyword{Unterkühlung}}
...
\subsubsection{Überdehnt: \HeadingKeyword{Verstauchung}}
...
\subsubsection{\enquote*{Entgleist}: \HeadingKeyword{Verrenkung}}
...
\subsubsection{\HeadingKeyword{Knochenbrüche}}
...
\begin{enumerate}
  ...
  \item \EE{Krepitation} 
  (hörbares und fühlbares Aneinanderreiben der Bruchstücke)
...
\subsubsection{\HeadingKeyword{Vergiftungen}}
...
\subsubsection{\HeadingKeyword{Verätzungen}}
...
\subsection{\HeadingKeyword{Wundverbände}}
...
\subsubsection{\HeadingKeyword{Pflasterwundverband}}
...
der Klebestreifen von außen keilförmig eingeschnitten.}%2 Text
{%
\begin{itemize}
  \item Zuschneiden: Keilförmig einschneiden
\end{itemize}%
}%3 Slide
{./images/koch-aass/00800-gamma/Pflasterb.JPG}%4 Bilddatei
{Zurechgeschnittene Pflasterschnellverbände}%5 Bildtitel
{}%6 Bildbeschreibung
{\AASS}%7 Quelle
{MfG}%8 Lizenz
 % Vormals \Layout{20}

\subsubsection{\HeadingKeyword{Dreiecktuchverbände}}
...
\nocite{BuchfelderErsteHilfe4,Erc2005Sec9,Erc2005Sec2,Erc2005Sec8,Erc2005Sec6,WirthEH,HolaubekASB16h,KoehnleinEH,KeggenhoffEH,KarutzKursbuchEH}
