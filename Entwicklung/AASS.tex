...
\newcommand{\KAMEL}[1]{{\color{DefaultB}\textcircled{\ttfamily\bfseries\scriptsize#1}}}
...
\begin{center}
\includegraphics[width=\linewidth]{./images/pallinger-christoph-aass/Ambubeutel_32741-AASS-0176mm.jpg}
\end{center}
...
\begin{center}
{\color{Grey}Herausgeber} \vspace{0.5em}
\\{\color{DefaultB}\bfseries Gabriel, Koch, Emhofer, Motal, Steuer}
% \vspace{0.5em}
