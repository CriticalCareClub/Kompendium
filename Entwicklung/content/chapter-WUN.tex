...
\section{Allgemeines und Einteilung von 
\HeadingKeyword{Wunden}}
...
{Wundarten}%1 Titel
{}%2 Beschreibung
{\index{Wundarten}\label{tab:Wundarten}}%3 Label/Hook
{}%4 Quelle
{}%5 Lizenz
{%
...
\TextSlide{{\TxGefahren} von Wunden}{
...
\section{\HeadingKeyword{Wundversorgung} frischer Wunden}
...
wie möglich abwenden und ggf. eine ärztliche
Schmerztherapie einleiten (lassen).
...
\section{\HeadingKeyword{Dekubitus} und Dekubitusprophylaxe}
\index{Dekubitus!Prophylaxe}
\label{topic:dekubitusprophylaxe}

\TextSlide{Wundliegen}
{%
\index{Wundliegen}\index{Dekubitus}Wenn
...
%
Bereits der Auflagedruck 
durch das Gewicht des eigenen Körpers 
auf einer Unterlage kann ausreichen 
um zu solch einer
Unterversorgung zu führen. 
%
Besonders Stellen, 
an denen \EE{Knochen ohne Muskel- oder Fettpolster direkt unter der
Haut} 
liegen sind gefährdet:
\begin{itemize}
  \item Kreuzbein
  \item Fersen
  \item Sitzbein
...
Ein gesunder Mensch kann effektiv 
...
sogar bewusstlosen oder narkotisierten
Patienten ist dies nur mehr eingeschränkt oder gar nicht
mehr möglich.
%
Betroffen sind somit vor allem alte 
oder pflegebedürftige bettlägrige Menschen, 
bewusstlose Patienten 
bzw. sedierte Intensivpatienten 
sowie Patienten mit Querschnittsläsionen. 
%
Es ist Aufgabe des Fachpersonals für eine
