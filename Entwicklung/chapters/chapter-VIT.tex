...
Die Abgrenzung der Atemstörung zur Kreislaufstörung ist oft nicht einfach. Eine
Störung des Kreislaufes hat meist auch einen verminderten Sauerstoff\E{transport} zur Folge,
daher kommt es dabei häufig \E{auch} zur Atemnot u.\,ä. Symptomen. 
...
Verfügung stehen. Man unterscheidet den \EE{Zucker- bzw.
Kohlehydratstoffwechsel}, den \EE{Fettstoffwechsel} und den
\EE{Eiweißstoffwechsel}.
...
\EE{Blutzuckers} in der Blutbahn. Die Leber speichert eine Zuckerreserve von ca.
24\,h.
...
\Z{Aminosäuren}. Zusammen gebaute Proteine können wieder "`\E{zerlegt}"'
werden, mit den entstehenden Aminosäuren können wiederum andere, \E{neue
...
Behandlungsmethoden verursachen als Nebenwirkung eine massive \EE{Schädigung des Knochenmarks}\index{Knochenmark!Schädigung} (z.\,B.
...
aufgrund der Osmose (s.u.) großen Einfluss auf die \EE{Flüssigkeitsverteilung}
