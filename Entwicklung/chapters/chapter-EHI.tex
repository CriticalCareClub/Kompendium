...
immer Beginn und Grundpfeiler jeder Behandlung.
% Daher ist
...
§ 95 StGB Unterlassung der Hilfeleistung: (1) Wer es bei einem
Unglücksfall oder einer Gemeingefahr (§ 176) unterläßt, die zur Rettung eines
Menschen aus der Gefahr des Todes oder einer beträchtlichen Körperverletzung
oder Gesundheitsschädigung offensichtlich erforderliche Hilfe zu leisten, ist
...
Geldstrafe bis zu 360 Tagessätzen zu bestrafen, es sei denn, daß die
Hilfeleistung dem Täter nicht zuzumuten ist. (2) Die Hilfeleistung ist
insbesondere dann nicht zuzumuten, wenn sie nur unter Gefahr für Leib oder
Leben oder unter Verletzung anderer ins Gewicht fallender Interessen möglich
wäre



§ 94 StGB Imstichlassen eines Verletzten 1) Wer es unterläßt, einem anderen,
...
\begin{itemize}
  \item 1. Lebensrettende Sofortmaßnahmen
  \item 2. Notruf
  \item 3. Weitere Erste Hilfe
  \item 4. Sanitätshilfe - Transport
  \item 5. Ärztliche Betreuung
\end{itemize}
}
{}{}{}
...
\subsubsubsection{Der schmerzende Bauch}
...
\subsubsubsection{Das Akute Abdomen --- Alarmzeichen mit
bretthartem Bauch}
...
\subsubsubsection{Darmverschluss}
...
\subsubsubsection{Blinddarmentzündung}
...
\subsubsubsection{Magen-Darm-Grippe, Gastroenteritis,
...
\subsubsubsection{Flüssigkeitsmangel: Exsikkose}
...
\subsubsubsection{Magen- und Zwölffingerdarmgeschwür}
...
\subsubsubsection{Mesenterialinfarkt}
...
\subsubsubsection{Bauchfellentzündung}
...
\subsubsubsection{Kohlenmonoxid (\ce{CO}) -- oder: Von defekten
...
\subsubsubsection{Kohlendioxid (\ce{CO2}) -- Tod im Weinkeller}
