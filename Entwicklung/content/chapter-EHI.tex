...
\begin{itemize}
  \item \StepHeading{Sterile Wundauflage}
  \item \StepHeading{Druckkörper}: Es eignen sich nur kompakte, weiche
  und saugfähige Objekte. Ein solches Objekt, das sich auch in
  der Verbandsbox befindet, ist die Mullbinde.
  \item \StepHeading{Befestigungsmittel}: Z.\,B. Dreiecktuchkrawatte
...
eliminiert worden, 
da es zu beträchtlichen Folgeschäden kommen kann. 
%
Eine Abbindung soll daher nur erfolgen,
wenn die Blutung bedrohlich ist und 
andere Maßnahmen nicht ausreichend sind (\enquote{letztes Mittel}).
