...
:::{image} ../../../../Submodules/3134-medical-picture-collection/Gabriel-Sebastian/Input/minen_hinweis2.\*
:align: right
:width: 23%
:::
...
4. **Engmaschiges, bestmögliches Monitoring**:
   Je nach vorhandenem Material

   RR, HF, Pulsoxymetrie, EKG,
   Sitzwache/Patientenbeobachtung, etc. [^patientenbeobachtung]

5. **Reanimationsbereitschaft** herstellen
   ({ref}`m-reanimationsbereitschaft`)

6. **I.v.-Zugang**

[^patientenbeobachtung]: Zuerst werden die Patientenbeobachtung
...
1. Ggfs. Platz schaffen [^platzschaffen]

2. Geräte vorbereiten:

   1. **Beatmungsbeutel**
   2. **Absaugeinheit** und passenden Katheter  in
      Griffweite stellen. Steriles Material bleibt verpackt.
   3. **Defibrillator** in Griffweite stellen,
