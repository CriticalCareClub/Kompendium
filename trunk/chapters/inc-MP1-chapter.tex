...
Das \gE{Elektrokardiogramm} (\gAbk{EKG}) zeigt mittels eines
...
aufgeklebt und mittels eines Kabels mit dem \gAbk{EKG}-Gerät
...
{\quotedblbase}schönes{\textquotedblleft} \gAbk{EKG} haben (allerdings nicht lange)!}}
...
\begin{description}
    ...
    ist das 12-Kanal-\gAbk{EKG} (\emph{"`12er"'}) für die
...
\gAbk{EKG}-Gerät \gEs{6 Ableitungen}: \gZ{V1 -- V6}. 
}{
\begin{itemize}
...
Die richtige Positionierung der \gAbk{EKG}-Elektroden ist die Voraussetzung um
ein sinvoll auswertbares \gAbk{EKG} zu erstellen. Falsch angebrachte
Elektroden können ein \gAbk{EKG} derart verfälschen, dass es zu
...
\gLayout{0}{Beenden der \ce{O2}-Gabe und Wechsel von Druckflaschen}
{
Nach der Verwendung des Sauerstoffsystems wird das Hauptventil geschlossen
und der \gEs{Überdruck} aus den Druckleitungen bzw. dem
Druckminderer \gEs{abgelassen}. Erst danach wird das Abgabeventil ebenfalls
verschlossen.

Gleiches gilt für den Wechsel einer Sauerstoffflasche: Es muss --
zur eigenen Sicherheit -- sichergestellt sein, dass \gEs{im Entnahmeschenkel
\gCa{kein Überdruck}} herrscht. Vor dem Abmontieren des Druckminderers oder einer Druckleitung muss dies auf alle Fälle \gEs{extra am
Manometer kontrolliert werden}! Das \gEs{Abgabeventil} muss beim Abmontieren
\gEs{geöffnet} sein.
...
\gEs{Warnleuchten} müssen kontrolliert werden. }{
\begin{itemize}
   \item Prüfung von
   \begin{itemize}
