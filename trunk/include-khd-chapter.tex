...
\begin{multicols}{2}
\gT{\"Aussere Absperrung}: Gro{\ss}r\"aumige Verkehrsumleitung

\gT{Innere Absperrung}: h\"alt Schaulustige fern, h\"alt Personen in Panik
zur\"uck

\gT{Sicherheitsring}: Absperrung des Schadenplatzes, Sicherheit f\"ur
Einsatzkr\"afte

\gT{Pforte}: Einbahnsystem f\"ur Einsatz-Kfz, keine Fremdfahrzeuge,
m\"oglichst nur eine Pforte 

\gT{Leiter Information} (i) f\"ur Weiterleitung von Informationen an die
Au{\ss}enwelt (Presse, Angeh\"orige, ...)

\gT{Bergetriage} (BT) 

\gT{Sanit\"atshilfsstelle} (\gT{SanHist}): mit Triageraum, Behandlungsraum und
Transportraum;

\gT{Einsatzleiter} (EL) 

\gT{Leitender Notarz}t (LNA)

\gT{Mobile Leitstelle} (MLS) 

\gT{Material- und Meldestelle} (M)

\gT{Sammelstelle Tote} (t) und \gT{Unverletzte} (U) 
...
Warning: Draw \& image objects ignored!
Warning: Image ignored % Unhandled or unsupported graphics:
 
[width=4.457cm,height=9.22cm]{AASdev20090228-img146}
}
...
[width=4.457cm,height=9.063cm]{AASdev20090228-img147}
}
...
\gTabHeading{Abriss f\"ur das Zielspital:}
...
Verbleibt beim Leiter Transport/Protokollf\"uhrer
 ...
 [Warning: Image ignored] % Unhandled or unsupported graphics:
[width=6.653cm,height=12.217cm]{AASdev20090228-img148}
}
