...
\gE{Zellkern}\index{Zellkern}, der die gesamten Erbinformationen in Form des
Riesenmoleküls \gE{DNS}\footnote{Desoxyribonukleinsäure} enthält und
...
\gACh{GABS}{2010-03-09}{Ist Muskel nicht ein Organ?}
\gACh{HIRT}{2010-03-09}{Wie du sicher weißt gibt es verschiedene Definitionen
von Organen.Bei den gängigsten fallen die Muskeln nicht hinein.}
\gACh{GABS}{2010-03-12}{Bei welcher? 
...
\gACh{HIRT}{2010-03-13}{Damit ist die Diskussion beendet.}
\gACh{GABS}{2010-03-14}{Neue Formulierung passt, weil unmissverständlich.}
}
\end{anfxnote}
...
\begin{itemize}
    ...
    \gACh{GABS}{2010-03-09}{Auch für nicht-aufrechte Haltung wichtig?}
    \gACh{HIRT}{2010-03-09}{Hier geht es um die grundsätzliche Vorstellung,
...
\begin{itemize}
    ...
    (im roten Knochenmark!) \gACh{GABS}{2010-03-09}{Wenn man die Körperchen aufzählt müssen die
    Thrombos aber auch hinein \ldots}
    \gACh{HIRT}{2010-03-09}{Vielen vielen Dank für den Hinweis\ldots}
\end{itemize}
}
{
\begin{itemize}
...
\subparagraph{\gT{Periost}} \index{Periost}\gE{Beinhaut}, überzieht den Knochen und
...
\subparagraph{\gT{Kompakta}} (Kortikalis),
\index{Kompakta}\index{Kortikalis}feste äußere Schicht,
äußere Form, Verantwortlich für Stabilität des Knochens
\subparagraph{\gT{Spongiosa}} \index{Spongiosa}\index{Knochenbälkchen}Knochenbälkchen
${\rightarrow}$ Zug- und Druckfestigkeit
\subparagraph{\gT{Markhöhle}} \index{Markhöhle}s.u.
\subparagraph{\gT{Epiphysenfuge}} \index{Epiphysenfuge}Wachstumsfuge
\subparagraph{\gT{Gelenkfläche}} \index{Gelenkfläche!Aufbau des
...
des Körpers. Hier werden die \gEs{zellulären Bestandteile des Blutes
...
eingefügt:}
\gFazit{Das \gE{rote Knochenmark} ist für die Blutbildung zuständig}
...
\fxwarning[author=GABS]{Review: 2010-03-12: Alte Überschrift als Fazit
eingefügt:}
\gFazit{Das \gE{gelbe Knochenmark} besteht aus Fett}
}
{
\begin{itemize}
  \item fettreich
...
\gT{Diarthrose}) und Gelenken ohne Gelenksspalt ("unechtes Gelenk",
\gT{Synarthrose}) unterscheiden.
...
Rippen-Brustbein-Verbindungen des Thorax (\gT{Syndesmose, Synchondrose,
Synostose}).
\gACh{HIRT}{2010-03-11}{Um allen Diskussionen zuvorzukommen: ich finde es
...
{\gAuthNotesPicLegalOk{}{Lena }Ein Gelenk im Querschnitt.}
{Lena Hirtler}
\gAuthNotes{KOCH. löschen: Membrana synovialis und membrana fibrosa}


\paragraph{Es gibt verschiedene Arten von Gelenken}
\index{Gelenke!Arten}

Klassische Beispiele: \index{Kugelgelenk}\gT{Kugelgelenk} (Hüftgelenk),
\index{Scharniergelenk}\gT{Scharniergelenk} (Fingergliedgelenke,
Ellbogengelenk), \index{Sattelgelenk}\gT{Sattelgelenk} (Daumengrundgelenk).  


\begin{minipage}{\linewidth}
% \includegraphics[width=\linewidth]{./images/noauth/AASdev20090228-img23.png}
\gTODO{GABS}{2010-04-11}{Bild: von HIRT anpassen und einfuegen.}{}
...
\gLayout{0}{Aufbau des Hirnschädels}
{
Der Hirnschädel besteht aus der \gEs{Schädelbasis} und dem \gEs{Schädeldach}
...
\gLayout{20}{Fontanelle}{
\index{Fontanelle}
Die \gT{Fontanellen} sind \gEs{knorpelige 
...
vieler wichtiger Muskeln. Sie hat eine doppelt \gE{S-förmig gekrümmte Form},
welche den \gE{aufrechten Gang} ermöglicht.

\subparagraph{Bestandteile}
Die Wirbelsäule besteht aus mehreren Komponenten. Die knöchernen, übereinander
"`gestapelten"' \gT{Wirbel} \gZ{(Vertebrae)} geben der Wirbelsäule ihre Form
und Stabilität. Die Wirbel sind i.d.R. zueinander im gewissen Umfang
\gE{beweglich}.

Zwischen den
einzelnen Wirbeln finden sich \index{Bandscheiben}\gT{Bandscheiben}
(\gT{Discus}), welche als \gEs{Stoßdämpfer} dienen. Mit zunehmenden Alter können
diese \gE{verschleißen}. 
    
Von den Wirbeln wird ein Kanal, der sog. \gT{Wirbelkanal}\index{Wirbelkanal}
gebildet. In diesem ist das \gEs{Rückenmark} eingebettet.
...
\begin{inparaitem}
    ...
    \item 5 verschmolzene \gEs{Kreuzbein}wirbel \gZ{(Os sacrum)}, sowie
    \item 3-4 \gEs{Steißbein}"`wirbel"' \gZ{(Os coccygis)}.
\end{inparaitem}
...
(\gE{Wirbelsäulentrauma}, \prettyref{topic:wirbelsaeulentrauma}). Bandscheiben
können aufplatzen und der weichere Kern in den Wirbelkanal rutschen. Durch
den Druck auf das Rückenmark kann das starke Schmerzen und
Nervenausfälle verursachen (\gE{Bandscheibenvorfall},
...
\gTabSub{Bestandteile}

\begin{itemize}
    \item Wirbel \gZ{(Vertebrae)}
...
Der Wirbekörper trägt die Last des Rumpfes, zwischen ihnen sind die
...
\gLayout{20}{\gTxBeschreibung}
{
Der  Brustkorb besteht \gE{vorne} aus dem \gT{Brustbein}
 (\gT{Sternum}) und \gEs{12
Rippenpaaren}, welche \gE{hinten} mit der \gEs{Brustwirbelsäule} (12
...
({\quotedblbase}\gT{unechte Rippen}{\textquotedblleft},
...
\begin{itemize}
    ...
    \item \gEs{12  Rippenpaare}
    \begin{itemize}
        \item \gZ{7 "`echte"'}
        \item \gZ{3 "`unechte"'}
        \item \gZ{2 "`fliegende"'}
    \end{itemize}
    \item \gEs{Brustwirbelsäule} (12 Brust\-wirbel), mit Rippen in gelenkiger Verbindung
\end{itemize}
}
...
Der Schultergürtel ermöglicht die Bewegung des Armes. Über eine Bandverbindung
...
Nach einem Unfall kann es zu einer Fraktur des Beckengürtels kommen. Stehen und
Gehen ist nicht mehr möglich, der Patient verspürt starke Schmerzen bei
jeglicher passiven Bewegung BEIDER Beine. Eine Kompression des Beckens ist
wichtig um den möglichen großen Blutverlust (einige Liter!) einzudämmen.
...
\fxnote[author=HIRT]{Review: ANA: Knöchel erwähnt, gut so?} 
...
ein \gE{anderer} beugt ihn). Jeder Muskel hat einen Ursprung (Wo kommt er her?)
...
Hälfte wird durch \gEs{Klappen} in einen \gT{Herzvorhof}
...
Im Herzbeutel befindet sich Flüssigkeit, die die reibungslose Bewegung des
Herzens ermöglicht. Wenn durch Eintritt von z.B. Blut nach einer Verletzung der
Herzbeutel zu viel gefüllt ist, kann es dadurch zu einer Einschränkung der
Herzbewegung kommen und schlimmstenfalls zum Tod.
}{}{./images/hirtler-aass/Herz-edited-0800.png}{\gAuthNotesPicLegalOk{}{}Das Herz.} {Hirtler.}

~


\gLayout{20}{Herzklappen}
{
\index{Herzklappen}   
\index{Segelklappen}
...
{\gAuthNotesPicLegalOk{img28}{}Das
 Herz.}
 {Hirtler}
...
Gliederungsebenen ist aber zur Erregungsbildung  fähig.
...
Hohlvene}{\textquotedblleft}, Vena cava superior und Vena cava inferior) münden. 
}
{
\includegraphics[width=\linewidth]{./images/hirtler-aass/Kreislauf-Schema-edited-0800.png}

\gCaptionof{figure}{\gAuthNotesPicLegalOk{}{Blutkreislauf, Schema.}Der
Blutkreislauf.}
...
\begin{labeling}[\dots{}]{Kapillargefäßexxx}
    \item[\gT{Arterien}] führen \gE{vom Herzen \gEs{weg}} und haben eine dicke
    Wand. 
    \item[\gT{Venen}] führen \gE{zum Herzen \gEs{hin}} und
...
muskulösen Arterien.     
    \item[\gT{Kapillargefäße}] sind dünne "`Haargefäße"',
    in denen der \gE{\gEs{Gasaustausch}} stattfindet; sie \gE{verbinden Arterien
    und Venen}. 
\end{labeling}


\gLayout{0}{Sonderfall Shunt}
{
\label{topic:shunt}
Ein \gT{Shunt} \index{Shunt}  ist eine
künstlich (chirurgisch) angelegte Verbindung zwischen Arterien und
Venen und wird oft bei Dialyse-Patienten 
\index{Dialyse-Patient!Shunt} eingesetzt\gZFootnote{Dadurch dass durch die
...
benötigt werden) punktieren.}. Ein Shunt ist \gCa{verletzlich}, daher darf an
...
\begin{itemize}
  ...
  \item Dialyse
  \item \gCa{Verletzlich}
  \item Nicht stauen!
\end{itemize}
}{}{}{}


\gLayout{0}{Blutgefäße sind in Schichten aufgebaut}
{
% TODO INHALT: Blutgefäße sind in Schichten aufgebaut

\gTODO{GABS}{2010-04-dd}{INHALT: Blutgefäße sind in Schichten aufgebaut.}{}
...
Arterie
&
Hauptarterie = Aorta geht von der linken Herzkammer ab, von dort zweigen alle
...
fühlbar.
\\\addlinespace
\gEs{Leistenarterie} \index{Leistenarterie}
&
\gT{A. femoralis} \index{A. femoralis}
&
Arterie
&
verläuft am Oberschenkel, Puls tastbar in der Leistenbeuge, wird für
Herzkatheter als Zugang verwendet. \\\addlinespace
...
%  \includegraphics[width=\linewidth]{./images/noauth/AASdev20090228-img32.png} 
 \gTODO{GABS}{2010-04-11}{Bild: neu erstellen: Bestandeteile des Blutes.}{}
 
 \gCaptionof{figure}{\gAuthNotesPicLegalNotOk{img32}{}Die Bestandteile des Blutes.
...
\gZ{Die Blutgerinnung ist der wichtigste
...
\subsection{Das Zentralnervensystem -- ZNS}\gTagNo{Unterteilung nach Lage und
Aufbau}
...
\gLayout{22}{Unterteilung nach Lage und Aufbau}
{
...
\gLayout{22}{Der Schädel besteht aus Schichten}
{
%\index{Epiduralraum}
%\index{Dura mater}
...
{\gAuthNotesPicLegalOk{}{PD-CE}Querschnitt durch
die Schädeldecke. }
{Gray's Anatomy, Copyright expired.}
...
{\gAuthNotesPicLegalOk{}{}Rückenmark
...
\begin{figure}[H]
    \begin{center}
    \gTODO{GABS}{2010-04-11}{Bild: neu erstellen: Fight.}{}
    
    \gTODO{GABS}{2010-04-11}{Bild: neu erstellen: Flight.}{}
...
\gTODO{GABS}{2010-04-11}{Bild: neu erstellen: Übersicht vegetatives
Nervensystem.}{}
...
\paragraph{}~
\gLayout{22}{Die Haut ist in Schichten aufgebaut}
{
...
{\gAuthNotesPicLegalOk{}{Haut
Querschnitt}Die Haut im Querschnitt: \gTabSub{A:} Oberhaut \gZ{Epidermis},
\gTabSub{B:} Lederhaut \gZ{Dermis},
\gTabSub{C:} Unterhaut (Subkutis),
\gTabSub{d:} \gZ{Meißner'sches Tastkörperchen},
\gTabSub{e:} Talgdrüse,
\gTabSub{f:} Haar mit Haarfollikel,
\gTabSub{g:} Schweißdrüse,
\gTabSub{h:} Venole,
\gTabSub{i:} Freie Nervenenden (Schmerzempfindung),
\gTabSub{j:} Arteriole,
\gTabSub{k:} \gZ{Pacini-Körperchen}.
}
{Hirtler.}
...
wundliegen kommen. Die Wunden nennt man dann \gT{Dekubitus} oder Druckgeschwüre.
\gZ{Besonders gefährdet sind jene Stellen,
...
{\gAuthNotesPicLegalOk{}{PD}Die Atemwege, Übersicht.\label{fig:respiraktionstrakt-uebersicht}}
{Mariana Ruiz Villarreal, Public domain}
...
\gE{lungenseitigen} \gT{Pleura}, überzogen. In einem Lungenflügel verzweigt
sich der Hauptbronchus in immer weitere kleinere Bronchien bis schließlich die
Bronchioli in die \gT{Lungenbläschen} (\gT{Alveolen}) enden.
...
\gTODO{GABS}{2010-04-11}{Bild: neu erstellen: Pleura.}{}

}{}
% {./images/noauth/AASdev20090228-img41.png}
{./icons/under-construction.png}
{\gAuthNotesPicLegalNotOk{img41}{Pleura}Pleura.}
...
\gTODO{GABS}{2010-04-11}{Bild: neu erstellen: Atemmechanik.}{}
...
\gNiveau{2}{Thoraxwand und Lunge besitzen elastische Eigenschaften: Sie werden gedehnt
...
\gDefinition{Als Atemgas bezeichnet man jenes Gasgemisch,
...
\centering
\gTODO{GABS}{2010-04-11}{Bild: neu erstellen: Ösophagus.}{}

\gTODO{GABS}{2010-04-11}{Bild: neu erstellen: Ösophagus, Röntgen (nice to have).}{}
...
\gCaptionof{figure}{\gAuthNotesPicLegalNotOk{img44 img45}{}Ösophagus. \gSourcePicture{Quelle nicht eruierbar.}}
...
\gParallel{
\gTODO{GABS}{2010-04-11}{Bild: neu erstellen: Lage des Magens.}{}
\centering
...
\gTODO{GABS}{2010-04-11}{Bild: neu erstellen: Magen, Pförtner, Duodenum.}{}
...
\gTODO{GABS}{2010-04-11}{Bild: neu erstellen: Lage des Duodenums.}{}
...
\gTODO{GABS}{2010-04-11}{Bild: neu erstellen: Duodenum und Pankreas.}{}
...
\gTODO{GABS}{2010-04-11}{Bild: neu erstellen: Leber.}{}
...
\gTODO{GABS}{2010-04-11}{Bild: neu erstellen: Leber von vorne.}{}
...
\gTODO{GABS}{2010-04-11}{Bild: neu erstellen: Leber mit Gallenblase von
unten.}{}
...
\gCaptionof{figure}{\gAuthNotesPicLegalOk{}{}Gallenblase.
\gSourcePicture{Gray's Anatomy, PD, Copyright expired.}}
...
\gTODO{GABS}{2010-04-11}{Bild: neu erstellen: Dünndarm Querschnitt.}{}

}{}
{./icons/under-construction.png}
% {./images/noauth/AASdev20090228-img56.png}
{\gAuthNotesPicLegalNotOk{img56}{}Dünndarm
Querschnitt.}
...
\gEs{Enddarm}(\gT{Rectum})\index{Enddarm}&
\\\bottomrule
\end{tabulary}
\end{center}
...
\gTODO{GABS}{2010-04-11}{Bild: neu erstellen: Lage Dickdarm, Appendix.}{}
...
{}
{ 
Das Bauchfell (\gT{Peritoneum}) ist eine dünne Haut welche die gesamte
...
\gACh{GABS}{2010-03-09}{Unter großem und
...
\gT{Appendizitis}) entstehen. Es kann sich auch selbst entzünden
(= \gT{Peritonitis}), wenn es beispielsweise bei einem Durchbruch
(\gT{Perforation}) des Darmes zu einem Übertritt von Darminhalt in die
Bauchhöhle kommt.
}
{
\begin{itemize}
    ...
    \item Bauchfellentzündung = \gT{Peritonitis}
\end{itemize}
\gTODO{GABS}{2010-04-11}{Bild: neu erstellen: Bauch aufgeklappt.}{}
}
{./icons/under-construction.png}
% {./images/noauth/AASdev20090228-img58.png}
{\gAuthNotesPicLegalNotOk{}{}Der Bauch, geöffnet, mit aufgeklapptem
...
\gCave{{\quotedblbase}\index{Zweizeitiger
...
\gTODO{GABS}{2010-04-11}{Bild: neu erstellen: Milz, Lage.}{}


}{}
{./icons/under-construction.png}
% {./images/noauth/AASdev20090228-img60.png}
{\gAuthNotesPicLegalNotOk{img60}{}Milz:
Lage.}
{Quelle nicht eruierbar.}
...
\gTODO{GABS}{2010-04-11}{Bild: neu erstellen: Niere, Lage.}{}

}{}
{./icons/under-construction.png}
% {./images/noauth/AASdev20090228-img61.png}
{\gAuthNotesPicLegalNotOk{img61}{}Niere.}
{Quelle nicht eruierbar.}
...
{\gAuthNotesPicLegalOk{}{Lena}Harntrakt
...
\gCaptionof{figure}{\gAuthNotesPicLegalOk{}{}Die männlichen Geschlechtsorgane im Querschnitt. \gSourcePicture{Lena Hirtler}} 
}
\end{gWideParEnv}
...
\includegraphics[width=\linewidth]{./images/anatomie/anatomie-genitale-weiblich-edited.png} \gCaptionof{figure}{\gAuthNotesPicLegalOk{}{Lena }Weibliche Geschlechtsorgane, Querschnitt.
...
\gTODO{GABS}{2010-04-11}{Bild: neu erstellen: Zyklus.}{}
