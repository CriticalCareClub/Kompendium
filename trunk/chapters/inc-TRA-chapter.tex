...
erschwert. Durch die "`Entlastungsschnitte"' kann der Pateint wieder atmen. 
\SourcePicture{Hauer}} 
\\\addlinespace\bottomrule
\end{tabularx}
\end{gWideParEnv}
...
\begin{itemize}
  ...
  steriler Kochsalzlösung (\ce{NaCl}-Lösung) feucht gehalten und anschließend
...
\MarginNo{\newline\includegraphics[width=\linewidth]{./images/teaser/imgp0722.jpg}}
...
Geschlossene Bauchtraumata sind aufgrund der inneren Blutungen bqesonders
...
sie zu den Bauchverletzungen gezählt. Besonders gefährlich sind die
Beckenfrakturen, bei welchen binnen weniger Minuten bis zu fünf Liter Blut (also
fast die gesamte Blutmenge) verloren gehen können. Es besteht höchste
Schockgefahr!
...
Einteilung erfolgt in drei \Es{Stadien} (siehe Tab. \ref{tab:Erfrierungen}),
diese haben am Notfallort keine entscheidende Bedeutung für die zu setzenden
Maßnahmen. Den Schweregrad einer Erfrierung kann man erst nach Tagen voll
