...
%\includeonly{./chapters/inc-TAE-chapter,./chapters/inc-EIN-chapter}
...
\setkomafont{caption}{\mdseries\sffamily\small}
...
ENTWICKLUNGSVERSION -- {\tiny
Zweig: }\input{./tmp/git-current-branch.tmp} -- {\tiny
Letztes Commit: }\input{./tmp/git-lastcommit.tmp}}}

% %% FINAL %%%
% \fancyfoot[CE,CO]{\gEs{{\itshape \gDocVersionTyp -- Nur für den
% internen Gebrauch!}}}
% \fancyfoot[LE]{{\AASS{}~ \itshape
% v.\,\gDocVersion}}
...
\newcommand{\gChapterBibliography}{\bibliographystyle{babunsrt}{\begin{multicols}{2}\scriptsize\setlength{\parskip}{1pt}
...
\titlehead{\gDocVersionTyp \gDocVersion (Ed. ASB --
geplant für ET IX/2009)}
...
\paragraph{Literaturverzeichnis} JabRef 2.5.0, Zotero,
BibTeX \paragraph{Textverarbeitung und Rohentwurf} OpenOffice 
