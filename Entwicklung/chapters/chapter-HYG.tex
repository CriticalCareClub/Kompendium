...
hängt von verschiedenen Faktoren ab. Grundsätzlich entscheidend ist die 
\EE{Bakterienart}: Je nachdem welcher Spezies und welchem
Stamm das Bakterium angehört, kann es unterschiedliche
...
spricht dann vom \T{MRSA} (Multi-resistenter Staphylococcus aureus).
...
Maßnahmen}{MRSA-Transport}{m:mrsa-transport}{
}
...
\noindent Spitze Gegenstände (Nadeln, Lanzetten, \ldots )
sind sofort in den Nadelabwurfbehälter (\enquote{Gelbe Box},
\enquote{Kontamed\texttrademark}, \enquote{Sharp}, \ldots )
zu entsorgen!
...
\MassnahmenMK{Spezielle Maßnahmen}{Nadelstichverletzung}
