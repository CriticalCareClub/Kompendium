...
kommen, man spricht dabei auch vom \T{"`stummen
Infarkt"'}\index{Stummer Infarkt}.

Sonst steht normalerweise der \E{stechende/brennende}, nicht
atemabhängige Brustschmerz zusammen mit \EE{Atemnot} und
\EE{Todesangst} im Vordergrund. Der \EE{Brustschmerz} kann
...
Bei der \EE{Lyse-Therapie} versucht man mittels eines
...
entsprechend ausgestattetes \EE{Herzkatheterlabor}. Der
Herzkatheter wird oft mit "`\E{PCI}"' \Z{(Percutane Coronare
Intervention)} oder "`\E{PTCA}"' \Z{(Perkutane Transluminale
...
100\,mmHg syst. Jeder Mensch hat allerdings im gewissen
