...
die erworbenen, durch den Lebenstil bedingten Erkrankungen
...
\emph{\Lang{Syn.} 
\index{Insult}
\index{Apoplektischer Insult}Apoplektischer Insult, \index{Apoplexie}Apoplexie}
...
können sehr unterschiedlich sein und umfassen:
  ...
  \subparagraph{Motorik} Störungen der Kraft und Beweglichkeit sind sehr
  häufig:
  ...
  \subparagraph{Sprache} Störungen der Sprache sind ebenfalls sehr
...
Ebenso ist immer an \EE{Vergiftungen} zu denken.
