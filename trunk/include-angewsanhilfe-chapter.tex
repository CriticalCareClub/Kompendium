...
\begin{enumerate}
  ...
  Hand.
  \item Einstichstelle bestimmen: Am Fingerendeglied,
  ...
  \item Lanzette in die Kontamed-Box entsorgeb.
  ...
  werden kann. 
  \item Meßstreifen in der Kontamed-Box entsorgen.
\end{enumerate}
...
in der Praxis eher unüblich. Es ist bie der Messung eine
...
\end{enumerate}
  ...
  unterer Extremität, beurteilt wird die die Kraft und die
...
\label{topic:hws-schiene-anlegen}\index{HWS-Schiene!anlegen}\index{s.
