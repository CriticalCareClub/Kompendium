...
Die Arbiets- und Ausbildungsstandards -- gegenwärtige in der
Version 0.16.0 (8. Vorabversion) -- sind das
...
\begin{description}
    ...
    \item[0.16.0] 2011-03 (VV, 141 Änderungen\footnote{Lt.
...
\\\addlinespace
\TabSub{ALS} & Erweiterte Reanimation  &
\\\addlinespace
\TabSub{ANA} & Anatomie  &
\\\addlinespace
\TabSub{APP} & Appendix  &
\\\addlinespace
\TabSub{AUU} & Anamnese und Untersuchung  &
\\\addlinespace
\TabSub{BET} & Betriebsinterne Regelungen  &
\\\addlinespace
\TabSub{COL} &  Farbdefinitionsdatei  &
\\\addlinespace
\TabSub{EHI} & Erste Hilfe  &
\\\addlinespace
\TabSub{EIN} & Einführung in die Medizin  &
\\\addlinespace
\TabSub{EUR} & Einsatztaktik und Rettungswesen  &
\\\addlinespace
\TabSub{GER} & Gerätelehre  &
\\\addlinespace
\TabSub{HYG} & Hygiene  &
\\\addlinespace
\TabSub{HYP} &  Hyphenation (Trennungskorrekturen)  &
\\\addlinespace
\TabSub{INF} & Autoreninformation  &
\\\addlinespace
\TabSub{JUS}  & Recht  &
\\\addlinespace
...
\\\addlinespace
\TabSub{REG} & Regionale Besonderheiten &  
\\\addlinespace
\TabSub{RES} & Reserve &  
\\\addlinespace
\TabSub{SAN} & Angewandte Sanitätshilfe &  
\\\addlinespace
\TabSub{STY}  & Stildefinitionsdatei &  
\\\addlinespace
\TabSub{TAE} & Tätigkeitsbild &  
\\\addlinespace
\TabSub{TRA} & Trauma &  
\\\addlinespace
\TabSub{VIT} & Vitalfunktionen &  
\\\addlinespace
