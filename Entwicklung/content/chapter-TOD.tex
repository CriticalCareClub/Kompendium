...
\section{Der \HeadingKeyword{Tod} allgemein}
\index{Tod}
\label{topic:tod}

\DefinitionInPara{Der \T{Tod} ist das Ende der Lebensfunktionen
...
\section{\HeadingKeyword{Todesfeststellung}}
...
\begin{enumerate}
    ...
    \item Späte Leichenerscheinungen: \EE{Fäulnis}, \E{Verwesung}, \E{Mumifizierung}, \E{Tierfraß}
und \E{Skelettierung}
\end{enumerate}
Die ersten drei Punkte sind \E{frühe
...
treten die \E{späten Leichenerscheinungen} auf.
...
\begin{Synopsis}
  \SynopsisItem{Es gibt sichere Todeszeichen, das Erkennen dieser
  Zeichen ist aber unsicher und bedarf Wissen und Erfahrung!}
  \SynopsisItem{Die Todesfeststellung erfolgt grundsätzlich nur durch einen
  Arzt!}
\end{Synopsis}
\index{Todesfeststellung}
\begin{Danger}
  \item Für unterkühlte Patienten gilt: 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\HeadingKeyword{Unterlassung} einer Reanimation}
\label{topic:reanimation-unterlassung}

Unter bestimmten Umständen darf (oder muss) eine Reanimation unterlassen werden.
...
\section{\HeadingKeyword{Begleitung} und Betreuung Sterbender}
...
\begin{Synopsis}
  \SynopsisItem{Für den Umgang mit Sterben und dem Tod gibt es kein
...
{%
\label{topic:palliativbehandlung-tod}%
...
\begin{itemize}
  ...
  Eine Übernahme der Probleme des Patienten durch den 
  Helfer ist weder möglich noch sinvoll. 
  \item Der Helfer muss im Rahmen der Möglichkeiten im Sinne
  des Patienten handeln und seine angemessenen
  Bedürfnisse befriedigen.
%   \item Wenn der Helfer mit unzufrieden mit der Betreuung
