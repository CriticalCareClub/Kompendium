...
:::{index} single: Pericarderguss
:::
:::{index} single: Herzbeuteltamponade
:::
...
Therapie
: echogezielte Punktion, Perikardfenestrierung {index}` <Perikardfenestrierung>` (Einleitung erst wenn Chirurg gewaschen am Tisch steht!!!)
