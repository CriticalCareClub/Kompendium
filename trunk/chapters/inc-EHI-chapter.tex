...
Unfallstelle nähert, soll er nach Möglichkeit sein
Fahrzeug in einem angemessenen \gEs{Sicherheitsabstand} zum Gefahrenbereich anhalten.
...
Der Ersthelfer soll vor dem Aussteigen aus dem Auto
eine \gEs{Warnweste} anziehen und mit bereits
...
\gE{Einbruch duch Eis} kann sich der Ersthelfer flach am
Bauch liegend mit Bretter, Stange oder Leiter dem Patienten
...
der Brustkorb des Patienten freigeschaufelt werden, damit
die Atmung möglich ist.
}{
\begin{itemize}
...
\gEs{Position und Druckpunkt} Der Patient sollte auf einem harten
    Untergrund liegen. Ggfs. wird der Patient aus einem Bett
    o.ä. auf den Boden verbracht. Der Helfer kniet
...
\gEs{Arm- und Körperhaltung} Die richtige
    ...
    nur der \gE{Handballen liegt am Brustein}. Die \gE{Arme bleiben gestreckt}
...
\gEs{Druckerzeugung} Die
    ...
    erfolgen. Die \gE{Eindrücktiefe} sollte \gE{\nicefrac{1}{3} des Brustkorbes} bertragen.
...
Es ist wichtig, den Zeitpunkt der
Abbindund zu notieren, am besten gleich am Oberarm bzw.
Oberschenkel. }{
\begin{itemize}
    \item Nur am Oberarm und Oberschenkel.
    \item Nur breites und schonendes Material.
    \item Max. Abbindezeit: 30\,min.
\end{itemize}
}
