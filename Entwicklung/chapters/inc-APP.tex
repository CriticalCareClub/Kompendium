...
Druck 					& $p$		&\T{Zentimeter Wassersäule} &
\MetricUnit{cm\ce{H2O}} & PEEP-Ventil \\\addlinespace
...
Energie, Arbeit			& $E$, $W$	& \T{Joule}		&  \MetricUnit{J}     	
& & Defibrillator (elektr. Energie)\\ 
...
Geschwindigkeit			& $v$		& Kilometer pro
Stunde&\MetricUnit{km}/\MetricUnit{h} &Fahrzeuge\\\addlinespace 
Leistung & $P$ 			& Watt 	&\MetricUnit{W}\\\addlinespace
% \A{???}					&  			& \Z{Lumen} 	& \Z{\MetricUnit{lm}}   		& \\
% \A{???}					&  			& \Z{Lux} 		& \Z{\MetricUnit{lx}}   		& \\
Magn. Feldstärke 		& $B$		&  Tesla 		& \MetricUnit{T} & &
MRT\\\addlinespace
...
Masseanteil				&			&					& \MetricUnit{\nicefrac{\Mg}{\PC}}& = \MgDl\\\addlinespace\bottomrule
\end{tabularx}
}
