...
\section{Ein \HeadingKeyword{langer Dienst}}
...
\subsection{\HeadingKeyword{Gefahrenbekämpfung}}

\subsubsection{Fall 1. \HeadingKeyword{Randalierender} 
Patient}
...
\subsubsection{Fall 2. Gefahr durch \HeadingKeyword{Hund}}
...
\begin{Danger}
  \item Schon vor Betreten der Wohnung sollte ein
  Hund von seinem Besitzer in einen  separaten Raum
  weggesperrt werden.
\end{Danger}


\subsection{\HeadingKeyword{Heilbehandlung}}

\subsubsection{Fall 3. \HeadingKeyword{Blutzuckermessung} =  
Heilbehandlung}
...
\subsection{\HeadingKeyword{Selbstbestimmungsrecht}}

\subsubsection{Fall 4. \HeadingKeyword{Aufklärung} und 
Einwilligung}
...
\subsubsection{Fall 5. \HeadingKeyword{Patientenverfügung}}
...
Beiläufigkeit der Abfassung (auf Serviette) zu verneinen.}
...
\subsection{\HeadingKeyword{Rechte} und \HeadingKeyword{Pflichten} 
des Sanitäters}

\subsubsection{Fall 6. \HeadingKeyword{Unterlassung} der 
...
% \clearpage
\subsubsection{Fall 7. \HeadingKeyword{Sanitäterkompetenzen}}
...
Arzt kann.}%2 Text
{}%3 Slide
{./images/venflon_in_situ.jpg}%4 Bilddatei
{Ein blutiger Venflon vom Fleischhauer?}%5 Bildtitel
{Sebastian Gabriel}%6 Bildbeschreibung
{}%7 Quelle
{}%8 Lizenz
 % Vormals \Layout{60}
...
\subsubsection{Fall 8. \HeadingKeyword{Rechtswidrige 
Anordnung} durch Notarzt}
...
Viagra-Packung informiert wurde.}%2 Text
{}%3 Slide
{./images/teaser/emergency_physician_vehicle_00800.jpg}%4 Bilddatei
{}%5 Bildtitel
{}%6 Bildbeschreibung
...
\subsubsection{Fall 9. \HeadingKeyword{Dokumentationspflicht}}
...
\subsubsection{Fall 10. \HeadingKeyword{Verschwiegenheits-} 
und \HeadingKeyword{Auskunftspflicht}}
...
\subsubsection{Fall 11. \HeadingKeyword{Fortbildungspflicht}}
...
\subsection{\HeadingKeyword{Schadenersatz}}
\label{topic:schadenersatz}

\subsubsection{Fall 12. \HeadingKeyword{Verletzung des Patienten} 
durch
Sanitäter:}
...
\subsubsection{Fall 13. \HeadingKeyword{Sachbeschädigung}}
...
\subsection{\HeadingKeyword{Behandlungspflicht}}


\subsubsection{Fall 14. \HeadingKeyword{Behandlungspflicht} von 
Krankenanstalten, Ärzten,
...
\subsection{\HeadingKeyword{Meldepflichtenrecht}}

\subsubsection{Fall 15. \HeadingKeyword{Ansteckende} 
Krankheiten}
...
\index{HIV!Meldepflicht}\Abk{HIV} angesteckt hat.}%2 Text
{}%3 Slide
{./images/teaser/blut-tatort-jacke.jpg}%4 Bilddatei
{}%5 Bildtitel
{}%6 Bildbeschreibung
{Sebastian Gabriel}%7 Quelle
{}%8 Lizenz
...
\subsubsection{Fall 16. \HeadingKeyword{Strafbare Handlungen}}
...
Polizei verständigen würde.}%2 Text
{}%3 Slide
{./images/trauma/haematom-fehlpunktion-001.jpg}%4 Bilddatei
{Hämatom}%5 Bildtitel
{}%6 Bildbeschreibung
{Sebastian Gabriel}%7 Quelle
{MfG}%8 Lizenz
...
\subsection{\HeadingKeyword{Straßenordnung}}
\label{topic:strassenverkehrsordnung}

\subsubsection{Fall 17. \HeadingKeyword{Blaulichtverwendung}}
...
{}%3 Slide
{./images/gabriel-sebastian-aass/IMG_1896_00800.jpg}%4 Bilddatei
{}%5 Bildtitel
{}%6 Bildbeschreibung
{Sebastian Gabriel}%7 Quelle
{MfG}%8 Lizenz
