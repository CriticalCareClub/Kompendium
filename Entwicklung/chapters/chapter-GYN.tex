...
Gebärmutterschleimhaut. Der Zyklus ist unter \prettyref{topic:weiblicher-zyklus} beschrieben.
}
...
\Es{vaginale Blutung} bemerkbar, die mitunter als \Speech{"`verstärkte Regelblutung"'} fehlgedeutet wird. Weiters kann es zum
\Es{Abgang von Gewebeteilen} und \Es{Unterbauchschmerzen} kommen. 
...
Verdachtsdiagnose \Speech{"`V.\,a. Abort"'} \Es{vermieden} werden, um die
...
\Layout{0}{\TxSymptome}{%
Die Symptome sind unspezifisch: Im Vordergrund steht der \Es{Schock}
infolge der Blutung. Zusätzlich zu den Schocksymptomen kann die Frau Symptome
eines \Es{akuten Abdomens} zeigen.
}{%
\begin{itemize}
  \item unspezifisch:
  \begin{itemize}
...
\Layout{2}{\TxBeschreibung}{%
Bei hochschwangeren Frauen kann es vorkommen, dass das \Es{Kind die untere
