...
Der Larynxtubus wurde von der Firma VBM Medizintechnik entwickelt.

Der Larynxtubus stellt eine, in manchen Situationen
überlegene, Alternative zur endotrachealen Intubation dar.
Er kann blind und ohne Hilfsmittel eingeführt und kommt
aufgrund seiner Bauweise normalerweise in der Speiseröhre zu
liegen.


Er besitzt \E{ein} Lumen und zwei Cuffs
Der obere Cuff kommt nach dem Einführen im Rachen zu liegen, während
der untere am Ende die Speiseröhre abdichtet. Dazwischen
liegt die Öffnung des Lumens, nach dem Einführen in Höhe
des Kehlkopfes. Da oben und unten abgedichtet ist, kann
die Luft über den Kehlkopf und den Kehldeckel in die
Luftröhre strömen. Es existiert eine
modifizierte Variante (LT-S) mit einem weiteren
Kanal, über welchen sich eine Magensonde legen
lässt und eine Dekompression der Speiseröhre und des Magens
zulässt.

Es sind verschiedene Größen je nach Körperlänge erhältlich.
...
Cuff \ML
\\\addlinespace\midrule\addlinespace
0	& Transparent	& Neugeborene			& \textless\,5\Kg*
\\
1	& Weiß			& Kleinkinder			& \VonBis{5}{12}\Kg*
\\
2	& Grün			& Kinder				& \VonBis{12}{25}\Kg*
\\
3	& Gelb			& Erwachsene (klein)	& \textless\,155\CM*
\\
4	& Rot			& Erwachsene (mittel)	& \VonBis{155}{180}\CM*
\\
5	& Violett		& Erwachsene (groß)		& \textgreater\,180\CM*
\\\bottomrule
\end{tabulary}

Der
Larynxtubus wird ohne Hilfsmittel blind
über den Mund des Patienten eingeführt, wobei der Kopf 
in Neutralstellung oder leicht überstreckt gelagert wird.
