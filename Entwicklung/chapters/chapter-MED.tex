...
Einerseits kann eine Minderdurchblutung des Herzmuskels (Myokard)
  aufgrund einer oder mehrerer \E{Einengung(en) von Herzkranzgefäßen}
  (Koronararterien) die Ursache sein, oder 
es kommt zu einem \E{erhöhtem Sauerstoffbedarf} des Herzens bei
  Anstrengung.
...
\begin{itemize}
  ...
  \begin{compactitem}
    ...
    \item Marcoumar ${\rightarrow}$ Patient ist Blutungsgefährdet
  \end{compactitem}
\end{itemize}
}
{%
