...
\begin{itemize}
  ...
  zuständiger Vertreter	wünscht behandelt zu werden
     \item \Es{\T{Geschäftsführung ohne Auftrag} im Notfall}: der
...
\begin{itemize}
  ...
  Abs. 2 StGB}:
  \begin{itemize}
    \item Sollten Alex, Sepp und Bernd fälschlich einen Angriff angenommen haben,
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        Umfang des Schadenersatzes siehe \prettyref{jus-fall:fortbildung}.
    \end{itemize}
...
\Layout{2}{Sachverhalt}{Nach langem hin und her, können Sepp und Bernd gemeinsam den Alex
...
\Layout{2}{Rechtslage}{\Z{{\S}\,5} \Es{SanG}:
...
\Layout{2}{Sachverhalt}{rch die Aufregung verschlechtert sich allmählich der Zustand des Hr.
...
\begin{itemize}
    \item gleiche Voraussetzungen wie bei Körperverletzungen
\end{itemize}
...
\begin{wrapfigure}{r}{5cm}\includegraphics[width=\linewidth]{./images/trauma/haematom-fehlpunktion-001.jpg}
\end{wrapfigure}Mehrere Hämatome\footnote{\emph{Hämatom:}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \end{itemize}
  \end{itemize}
  \item polizeiliche Ermittlungspflicht - \Z{{\S}\,99 StPO}
  für alle Delikte
\end{itemize}
