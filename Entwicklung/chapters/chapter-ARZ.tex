...
\begin{labeling}[:]{mm}
  ...
  \item[Rx] 6\,mg rasch \Abk{IV}, bei 0 Erfolg Rep 12\,mg, dann 18\,mg
  nach jeweils 60 Sek.
...
\begin{labeling}[:]{mm}
  \item[Ind] Reanimation: PEA, Asystolie; Sinusbrady, Prophylaxe u. Therapie.
  ...
  \item[Rx] \begin{itemize}
    \item \EE{Reanimation}: Erw: 3\,mg einmalig; Ki:
    \item \EE{Hypersalivation}: 0,01\,--\,0,02\,\nicefrac{mg}{kg} (od: 0,5\,mg Bolus,
    bis 3\,mg)
    \item \EE{Alkylphosphat-Intox}: Initial 2-4\,mg, dann 0,5\,mg alle 5 Min.
  \end{itemize}
...
\begin{labeling}[:]{mm}
  ...
  \item[KI] AV-Block 2\,--\,3{\textdegree}, Bradykardie, dekomp.
...
\begin{labeling}[:]{mm}
  ...
  \item[\textrecipe]
  \begin{itemize}
    \item \EE{Reanimation:} Erw: 1\,mg, \EE{Ki: 0,01\,\nicefrac{mg}{kg}}
    (1\,ml\,/\,10\,kg (bei 1:10\,000)); Rep alle 3\,min.)
    \item \EE{Kardiogener Schock:}
    \VonBis{0,025}{0,3}\,{\textmu}g\,/\,kgKG\,/\,min
    \item \EE{Anaphylaxie:} 3{\textdegree} u. schweres Asthma bronchiale: Erw.
    0,1\,mg \Abk{IV} oder \VonBis{0,2}{0,3}\,mg \Abk{SC}/\Abk{IM}; Ki:
    0,01\,\nicefrac{mg}{kg}/\Abk{SC}/\Abk{IM}; Rep alle \VonBis{5}{15} Min
  ...
  gleichz. Ca-Gabe \EE{Arrhythmien}; \EE{NaBic} über gl. Zugang inakt.
  Katech.; Kein Adrenalin in Akren spritzen; sehr Temp.-labil ({\textgreater}\,40{\textcelsius}), nur farblose
...
\begin{labeling}[:]{mm}
  ...
  \item[Rx] \VonBis{2}{10} (20) {\textmu}g\,/\,kg\,/\,min .
...
\item[Rx] 2\,--\,10 (20) {\textmu}g\,/\,kgKG\,/\,min
...
\begin{labeling}[:]{mm}
  ...
  0,01\,--\,\EE{0,1}\,--\,1,0\,{\textmu}g\,/\,kg\,/\,min
...
\begin{labeling}[:]{mm}
  ...
  \item[Ind] erh. ICP, Epi, Intox mit Trizyklika
  \item[KI]
...
\begin{labeling}[:]{mm}
  ...
  \item[Beschreibung:]
  \item[Ind] Opioidanalg., Einl. u. Vert. d. Narkose
...
\begin{labeling}[:]{mm}
  ...
  \item[Rx]
  \begin{inparaitem}
  \item Asthma Bronchiale: \VonBis{1}{2} H, Rep nach
  ...
  Perf: \VonBis{0,01}{0,05}\,{\textmu}g\,/\,kgKG\,/\,min., zB
  2\,mg\,/\,50\,ml\,/\,1-5 
  \end{inparaitem}.
  \item[Cave] ---.
