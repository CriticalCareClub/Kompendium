...
\end{itemize}}
\item Brustwirbels\"aule (12 Brust\-wirbel), sie steht mit
...
\begin{itemize}
    ...
    \item Fingergliedknochen mit 2-3 Gliedern
\end{itemize}
}
{~
...
\begin{itemize}
    ...
    \end{itemize}
    \item Sprunggelenk
    \item 8 Fu{\ss}wurzelknochen, \gZ{u.a. Sprungbein,
    Fersenbein}
    \item 5 Mittelfu{\ss}knochen  (Ossa metatarsalia)
    \item Zehengliederknochen mit je 2-3 Gliedern
...
Druck ausüben, daher sind Gegenspieler 
(Agonist u. Antagonist) erforderlich (z.B. ein Muskel streckt den Arm,
ein anderer beugt
ihn). Jeder Muskel hat
einen Ursprung und
einen Ansatz, diese
beiden Punkte bestimmen
die Bewegung.}{\captionof{figure}{\gAuthNotes{Bild fehlt:
Muskelzug}}}
...
Das Herz pumpt in Ruhe ca. 4\,-\,6\,l  Blut (bzw. 1\,x das
...
\begin{itemize}
    ...
    \item \gZ{(4.000\,-\,8.000\,/\mu m\textsuperscript{3})}
\end{itemize}
...
% TODO Hirnteile in grau
\gA{STEU: Hirnteile in grau}
