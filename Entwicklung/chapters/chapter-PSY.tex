\chapter
[\CO{[PSY]} \emph{Spezielle Patientengruppe:} Psychologie und Psychiatrie]
{\CC{[PSY]} \emph{Spezielle Patientengruppe:} Psychologie und Psychiatrie}
...
sehr vom einzelnen Patienten und seiner Situation abhängig: Während der eine
...
\begin{itemize}
  \item 1. an einer \Es{psychischen Krankheit} leidet und im Zusammenhang
  damit \Es{sein Leben} oder seine \Es{Gesundheit} oder das Leben
  \Es{oder} die Gesundheit \Es{anderer} ernstlich und erheblich
  gefährdet und
  \item 2. \Es{nicht in anderer Weise}, insbesondere außerhalb einer
...
Anstalt gebracht werden, wenn ein im \Es{öffentlichen
Sanitätsdienst stehender Arzt} oder ein \Es{Polizeiarzt} sie
...
{\S}\,9\,(1) Die \Es{Organe des öffentlichen Sicherheitsdienstes}
...
(2) \Es{Bei Gefahr im Verzug} können die \Es{Organe des
öffentlichen Sicherheitsdienstes} die betroffene Person \Es{auch
...
\Es{erforderlichenfalls den }\Es{örtlichen Rettungsdienst
beizuziehen}.
...
\subsubsection{Depression und Manie}
\label{topic:manie}
