...
\begin{tabularx}{\linewidth}{XX}
\toprule
\multicolumn{2}{c}{\gTabHeading{Zwei Triagepl\"atze, damit der
NA abwechselnd triagieren kann}
}\\\midrule
Vorbereitung durch RS/NFS
...
\begin{center}
\begin{supertabular}{m{2.4459999cm}m{4.0030003cm}m{2.299cm}m{4.1520004cm}}
\centering   [Warning: Image ignored]
% Unhandled or unsupported graphics:
...
erm\"oglicht eine eindeutige Kennzeichnung von Patienten und Zuordnung
...
\multicolumn{2}{m{13.5cm}}{ PLT Vorderseite\par
