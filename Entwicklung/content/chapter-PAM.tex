...
\TabHeading{Szeneüberblick m. Selbstschutz}
&
...
{\tiny(O:Onset, wann traten die Schmwerzen auf?; P: Pallation/Provocation: Linderung/Verstärkung; Q: Qualität; R: Radiation/Location: Austrahlung/Lokalisation; S: Severity: Stärke (1-10); T: Time: Zeit/Verlauf)}
\\\addlinespace
 &
{\SAMPLER{A}}
 &
...
\begin{itemize}
  ...
  Zeit (\enquote{72-Stunden Regel;Reklamation})?)}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Bewusstlos \ldotfill  \EE{komatös}
  \end{itemize}
\end{itemize}
}{}{}{}
...
Händedruck (Kraftprobe) überprüft, wenn Auffälligkeiten vorliegen wird auch 
...
\begin{itemize}
  ...
  Störungen von Vitalfunktionen 1. Ordnung (Bewußtsein \ABCDE{3}, Atemweg und/oder Atmung \ABCDE{A}\ABCDE{B},
  Kreislauf \ABCDE{C})
