...
\begin{itemize}
    \item Ortsgebiet:		unmittelbar bis zu ca. 50m
    \item Freilandstrasse:	ca. 150m
    \item Autobahn:			ca. 250-400m
\end{itemize}

Bei einem Unfall an einer Eisenbahnkreuzung ist zu bedenken, dass der
herannahende Zug einen viel längeren Bremsweg hat. (ca.600-800m, je nach
Geschwindigkeit und Gewicht des Zuges). Das Haltsignal für den Lokführer ist
eine kreisende Armbewegung. Dadurch sollte er gewarnt sein und eine Notbremsung
einleiten.
...
\begin{itemize}
    ...
    man ev. 30m tiefer unter einer Brücke.
    \item bei jedem Verkehrsunfall herscht Explosionsgefahr auf Grund des
    explosiven Gemisch im Tank bzw. der Benzinleitung. Daher in diesem Bereich
    nicht rauchen!
...
(UN-Nummer) an. Die Nummern sind beim Notruf anzugeben.
	...
	\item In einem Gasgefüllterraum kein Licht aufdrehen, nicht telefonieren,
	klingeln und rauchen. Hier darf das Fenster geöffnet werden. Wenn möglich die
	Gaszufuhr abdrehen. Auch hier den Raum nur zum retten von Patienten betreten.
	\item 
\end{itemize}
