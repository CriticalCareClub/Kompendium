...
- Prasugrel / Efient: 7–10 Tage Pause, WB nach 6h (erhöhte cerebrale Blutungen > 75 Lj)
- Ticagrelor / Brilique: 5 Tage Pause, WB nach 6h: reversible Antagonist, in den ersten 12h nach Einnahme werden auch transfundierte Thrombozyten gehemmt, und sind wirkungslos! Hohe Proteinbindung, nur durch Plasmapherese reversibel.
...
Schrittmacher:
- **Ausweis** (Typ, Indikation, letzte Kontrolle < 12 Mo?, Implantationsdatum)
  {index}` <Schrittmacher; Ausweis>`
  {index}` <Ausweis; Schrittmacher>`
...
:::{index} single: Diabetes mellitus; Prämedikation
:::
...
- SGLT-2-Inhibitoren: 72 h prä- und port-OP pausieren (euglykämische Ketoazidose)
...
- GFR 25–40 ml/min Hydration (NaCl, Elomel™ isoton, kein RL) und Diurese forcieren (Lasix, Harnvolumen > 0,5 ml/kg / h) + Hypotonie vermeiden (RBF!) um ANV zu verhindern!
...
- **Atemweg**: Oft schwierige Intubation (Videolaryngoskop bzw. fiberoptische Wachintubation erwägen)
...
- Epilepsie: Dauermedikamente präoperativ weitergeben, ev. Spiegelbestimmung; mögliche
  Wechselwirkung der Prämedikation und Anästhetika mit Antikonvulsiva durch
  Interaktion an den Ionenkanälen und GABA-Rezeptoren.
- Parkinson: Dauermedikamente präoperativ weitergeben.
