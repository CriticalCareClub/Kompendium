...
\begin{itemize}
	\item \gEs{Mechanische Wunden:} Entstehen durch spitze
	oder stumpfe Gewalteinwirkung auf den Körper (Stichwunde, Schürfwunde, Schusswunde, Bisswunde, ...)
	\item \gEs{Thermische Wunden:} Entstehen durch Kälte- oder
	Hitzeeinwirkung auf den Körper (Verbrennungen, Stromeinwirkung, Erfrierung, ...)
	\item \gEs{Chemische Wunden:} Entstehen durch Verätzungen
	mit Laugen oder Säuren
\end{itemize}
...
\begin{itemize}
	...
	Unterenhautschichten ohne Eröffnung der Oberhaut. (Hämatom)
\end{itemize}
...
\begin{itemize}
    ...
    \item Wunden, die im Spital weiterversorgt werden, sollen
    nicht übermäßig gereingt werden. Grobe Verschmutzungen
    werden nur wenn notwendig mit steriler Flüssigkeit
    \gZ{(Kochsalzlösung, Ringerlösung, o.ä.)} abgespült. Lose,
    kleine Fremdkörper wie z.B. Glassplitter dürfen entfernt
    werden.
    \item Verwenden Sie kein alkoholisches
    Desinfektionsmittel!
