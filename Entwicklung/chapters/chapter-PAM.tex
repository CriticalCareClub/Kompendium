...
Ziel: Rasches Erkennen einer vitalen Bedrohung, Überblick
gewinnen und Hauptbeschwerden/Leitsymptome ermitteln.
...
\TabSub{Szeneüberblick m. Schutz}
&
Sicherheit, Selbstschutz; Patientenanzahl; Umgebung, Ort,
Zeit; Trauma?; 
&
{\eye} \itshape Gefahrenzonen, Umstände, weitere
Resourcen erforderlich, Unfallmechanismus, Großschaden 
&
GAS-Maßnahmen (\prettyref{topic:gefahrengutunfall}),
Schutzausrüstung,
...
&
{\eye} \itshape Blässe, Zyanose, Schweiß,
Schonhaltung, Atemnot, verwaschene Sprache,
Des\-orientiertheit, Krämpfe, sichtbare Verletzungen
...
Symptome
&
{\eye} \itshape Kritische Symptome
...
Tiefe, Thorax-/Bauchbewegungen

Atemmuster

Anstrengung beim Atmen, Atemhilfsmuskulatur, Zeichen der
Atemnot (\prettyref{topic:atemnot-zeichen-kinder})

Atemgeräusche

Hautfarbe

Heimsauerstoff, Sp\ce{O2}

\Z{Seitenvergleichende Auskultation}
&
{\eye} \itshape Zyanose
...
\Z{Entlastung Spannungspneumothorax}
\\\addlinespace
\noindent\T{C}
...
\begin{itemize}
  \item Vitalwerte (HF, RR, evtl. AF)
  \item Bewusstseinsgrad, -qualität
  \item Pupillen
  \item \EE{Trauma, Bewusstseinsstörung}: Kontrolle von
  Mund, Nase und Ohren auf Blutungen (Lampe)
  \item \EE{Trauma}: Inspektion und
  Abtasten von
  \begin{inparaenum}
    \item Kopf,
    \item Hals,
  ...
  \end{inparaenum}
  \item Grobe Motorik (OE)
  \item \EE{Trauma}: Kann der Patient
  \E{Hände} und \E{Füße} spüren und bewegen?
\end{itemize}
% \protect\Parallel{
...
\end{minipage}
&
{\eye} \itshape Entgleiste Vitawerte

Bewusstseinsgrad klar, somnolent, soporös,
komatös/bewusstlos

Abnorme Pupillenweite, -differenz, -reaktionslosigkeit,
-entrundung
...
\TabSub{Erweiterte Untersuchung}
&
{\ldots} situationsgerecht, wenn Einschätzung der vitalen
