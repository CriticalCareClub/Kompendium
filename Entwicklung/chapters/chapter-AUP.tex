...
\subsection{Struktur durch \enquote*{SAMPLE}}
\index{SAMPLE}\index{S-KAMEL}
...
Abfrageschema \T{SAMPLE}\footnote{Sample \Lang{engl.}:
...
\Layout{2}{Symptome und Schmerzen}{%
\index{Schmerz}Die Einstiegsfrage hat uns u.U. bereits auf das Hauptsymptom
...
\subparagraph{Fragen zu Symptomen}
Gibt der Patient Symptome an, müssen diese weiter abgeklärt
werden, hier am Besipiel Schmerzen:
\index{Schmerz!Arten}
...
Notfallpatient kann bewusstlos werden und villeicht zu
...
Medikamentenpackungen des Patienten geischert werden.
...
\subparagraph{Fragen zu Letzte\ldots}
\begin{quote}
...
\begin{multicols}{2}
\begin{itemize}
  \item {\fullcite{DahmerGespraechsfuehrung5}}
  \item {\fullcite{FamPropAeGeFue2010}}
  \item {\fullcite{ThunRedenI46}}
  \item {\fullcite{ArgelanderErstinterview8}}
