...
:::{index} single: Duchenne; myotone Muskeldystrophie
:::
:::{index} single: Myotone Muskeldystrophie; Typ Duchenne
:::
...
Verminderte Produktion von *myotoner Proteinkinase* mit *erhöhtem Muskeltonus* und  *Übererregbarkeit* der quergestreiften Muskulatur, mit *verspäteter Relaxation* durch abnorme Schließung der Na/Cl-Kanäle nach Depolarisation, dies bewirkt eine repetitive Entladung und Kontraktionen.
...
: - Präoperativ:
  ...
  - Wenn möglich RA!
  - Sonst TIVA mit {ref}`Rocuronium <Rocuronium>` (mit TOF  !!! Verstärkte Wirkung!)
    ndMR der Wahl wäre Atracurium.
