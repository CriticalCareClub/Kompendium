...
\end{savequote}
\chapter
[\texttt{[TRA]} \emph{Spezielle Patientengruppe:} Trauma]
{[TRA] \emph{Spezielle Patientengruppe:} Trauma}
\label{chp:TRA}
% \AasRsN{RS~VII}
...
% der betroffenen Regionen.
  \item Steriler, nicht verklebender Verband, locker anlegen\ZFootnote{Der
  Nutzen von kühlenden Spezialverbänden, z.\,B. Waterjel{\texttrademark} ist aufgrund der Unterkühlungs-Gefahr und einer
  möglichen Durchblutungsstörung der Wunde umstritten.}
...
\begin{itemize}
    ...
    Verbrennungen!)\TODOCRITICAL{GABS}{2010-08-02}{Quelle? fragwürdig}{}
\end{itemize}
}{
