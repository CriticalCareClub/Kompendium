...
\begin{itemize}
  ...
  {\ttfamily Solange Herr Hauzu nur droht, kann keine
  ...
  {\ttfamily Sollten Alex, Sepp und Bernd fälschlich einen
  ...
  {\ttfamily Solange keine gerichtlich strafbare Handlung
...
berücksichtigen:
\begin{itemize}
  \item {\ttfamily Da Herr Hauzu eine psychiatrische Erkrankung
...
{\ttfamily Da der Angriff unmittelbar drohend ist, und auch
...
{\ttfamily Sowohl die geplante neurologische Untersuchung,
...
\begin{itemize}
  ...
  \item \E{fehlend}:
  \begin{enumerate}
    \item grundsätzlich bei \E{unmündigen} Minderjährigen (\VonBis{0}{14}. Lebensjahr), wobei es
    vorrangig auf die Einsichts- und Urteilsfähigkeit ankommt
    \item bei mündigen Minderjährigen (\VonBis{14}{18}. Lebensjahr) \E{vorhanden}, solange
...
\begin{enumerate}
    ...
    {\ttfamily RQW Stirn, gebrochene Rippen}
    \item \EE{Kausalität}: bei Wegdenken der
    Schädigerhandlung, bleibt auch der Erfolg aus:
    
    {\ttfamily Bei Anschnallen des Patienten hätte er mit
    ...
    {\ttfamily Das Anschnallen des Patienten ist laut
    ...
    {\ttfamily Aufgrund der erfolgten Geräteeinschulung
