...
Auch Schädigungen der Leber aufgrund von toxischen Substanzen (Alkohol, etc.)
können eine Hepatitis auslösen, diese Form ist unter
\gSee{topic:hepatitis-toxisch} beschrieben.
...
Die infektiöse (virale) Hepatitis wird unter \gSee{topic:hepatitis-virale} besprochen.

\gLayout{1}{\gTxBeschreibung{} und Ursachen}
{%%% Gerhard Gabriel <gerhard.gabriel@grissu.org> 
Hepatitis bedeutet eine
entzündliche Erkrankung der Leber. Diese Entzündung kann durch Erreger wie
Viren, oder Mikroorganismen hervorgerufen werden (infektiöse Hepatitis,
\gSee{topic:hepatitis-virale}). Aber auch Schädigungen der Leber
durch Geiftstoffe wie Alkohol, Medikamente \gZ{(z.B. Paracetamol)}, etc. können
zu einer (chrinischen) Entzündung führen. } {
\begin{itemize}
