...
\Code{trunk/chapters/inc-ALS-chapter.tex} 
\\\addlinespace
\TabSub{ANA} & Anatomie & \caps{Hirtler} &
\Code{trunk/chapters/inc-ANA-chapter.tex} 
\\\addlinespace
\TabSub{APP} & Appendix &  \caps{---} &
\\\addlinespace
\TabSub{AUU} & Anamnese und Untersuchung &  \caps{Gabriel} &
\Code{trunk/chapters/inc-AUU-chapter.tex} 
\\\addlinespace
...
\subsubsection{Schwache Betonung -- \Code{\tbs gE\{\}}}\marginpar{\T{\tbs
gE\{\}}}
...
\subsubsection{Starke Betonung -- \Code{\tbs gEs\{\}}}\marginpar{\T{\tbs
gEs\{\}}}
...
\subsubsection{Terminus -- \Code{\tbs gT\{\}}}\marginpar{\T{\tbs gT\{\}}}
...
\Box{Beispiel}{Terminus -- \Code{\tbs gT\{\}}}{black}
{
...
\subsubsection{Zusatzinformation -- \Code{\tbs gZ\{\}}}\marginpar{\T{\tbs
gZ\{\}}}
...
\subsubsection{Cave (Fließtext) -- \Code{\tbs gCa\{\}}}\marginpar{\T{\tbs
gCa\{\}}}
...
\subsubsection{Handschrift -- \Code{\tbs gH\{\}}}\marginpar{\T{\tbs
gH\{\}}}
...
\subsubsection{Allgemeine Autorennotizen -- \Code{\tbs gA\{\}}}\marginpar{\T{\tbs
gA\{\}}}
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
% 
% \paragraph{Standardlayout 1}\marginpar{\T{\tbs gMarriedLi\{\}\{\}\{\}}}~
% 
% \begin{description}
%     \item[Syntax:]
%     \lstinline$\MarriedNG{<Paragraphenueberschrift>}{<Fliesstext>}{<Stichworte>}$
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
% 
% \paragraph{Standardlayout 2 -- ohne Überschrift}\marginpar{\T{\tbs
% gMarriedLii\{\}\{\}\{\}}}~
% 
% \begin{description}
% %     \item[Syntax:] \lstinline$\Married{<text>}$
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
% 
% \paragraph{Standardlayout 11 -- Mit Teaser}\marginpar{\T{\tbs gMarriedLxi\{\}\{\}\{\}\{\}\{\}\{\}}}~
% 
% \begin{description}
% %     \item[Syntax:] \lstinline$\Married{<text>}$
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
% 
% \paragraph{Standardlayout 12 -- Mit Teaser ohne Überschrift}\marginpar{\T{\tbs gMarriedLxi\{\}\{\}\{\}\{\}\{\}\{\}}}~
% 
% \begin{description}
% %     \item[Syntax:] \lstinline$\Married{<text>}$
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
% 
% \paragraph{Standardlayout 13 -- Mit Bild}\marginpar{\T{\tbs
% gMarriedLxii\{\}\{\}\{\}\{\}\{\}\{\}}}~
% 
% \begin{description}
% %     \item[Syntax:] \lstinline$\Married{<text>}$
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
% 
% \paragraph{Standardlayout 14 -- Mit Bild, ohne Überschrift}\marginpar{\T{\tbs
% gMarriedLxii\{\}\{\}\{\}\{\}\{\}\{\}}}~
% 
% \begin{description}
% %     \item[Syntax:] \lstinline$\Married{<text>}$
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
% 
% \paragraph{Standardlayout 15 -- Nur Bild}\marginpar{\T{\tbs
% gMarriedLxiii\{\}\{\}\{\}\{\}\{\}\{\}}}~
% 
% \begin{description}
% %     \item[Syntax:] \lstinline$\Married{<text>}$
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
% 
% \paragraph{Standardlayout 16 -- Nur Bild ohne Überschrift}\marginpar{\T{\tbs
% gMarriedLxiii\{\}\{\}\{\}\{\}\{\}\{\}}}~
% 
% \begin{description}
% %     \item[Syntax:] \lstinline$\Married{<text>}$
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
% 
% \paragraph{Standardlayout 31}\marginpar{\T{\tbs gMarriedLxxxi\{\}\{\}\{\}}}~
% 
% \begin{description}
%     \item[Syntax:]
%     \lstinline$\MarriedNG{<Paragraphenueberschrift>}{<Fliesstext>}{<Stichworte>}$
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
% 
% \paragraph{Standardlayout 32}\marginpar{\T{\tbs gMarriedLxxxii\{\}\{\}\{\}}}~
% 
% \begin{description}
% %     \item[Syntax:] \lstinline$\Married{<text>}$
%     \item[Beschreibung:] 
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%#
% 
% \paragraph{Standardlayout 41 -- Mit Bild und Punkten} \marginpar{\T{\tbs
% gMarriedLxli\{\}\{\}\{\}\{\}\{\}\{\}}}~
% 
% \begin{description}
% %     \item[Syntax:] \lstinline$\Married{<text>}$
...
% Überschrift} \marginpar{\T{\tbs gMarriedLxxxii\{\}\{\}\{\}\{\}\{\}\{\}}}~
% 
% \begin{description}
% %     \item[Syntax:] \lstinline$\Married{<text>}$
%     \item[Beschreibung:] 
...
% \marginpar{\T{\tbs gMarriedLxxxiii\{\}\{\}\{\}\{\}\{\}\{\}}}~
% 
% \begin{description}
% %     \item[Syntax:] \lstinline$\Married{<text>}$
%     \item[Beschreibung:] 
...
\subsubsection{Definitions-Box -- \Code{\tbs gDefinition\{\}}}\marginpar{\T{\tbs
gDefinition\{\}}}
...
\subsubsection{Fazit-Box -- \Code{\tbs gFazit\{\}}}\marginpar{\T{\tbs
gFazit\{\}}}
...
\begin{lstlisting}
\Fazit{Diese Aussage fasst etwas zusammen oder trift eine Aussage die Speziell hervorgehoben sein soll. Sie kann wichtig sein oder sonst eine enstprechende  Bedeutng haben. Wir sind froh die rote Fahne zu haben! }
\end{lstlisting}

\Fazit{Diese Aussage fasst etwas zusammen oder trift eine Aussage die Speziell
...
\subsubsection{Parallel-Box -- \Code{\tbs gParallel\{\}}}\marginpar{\T{\tbs
gParallel\{\}}}
...
gMassnahmenNG\{\}\{\}\{\}\{\}}}\marginpar{\T{\tbs gMassnahmen\{\}\{\}\{\}\{\}}}
...
\subsubsection{Cave-Box -- \Code{\tbs gCave\{\}}}\marginpar{\T{\tbs
gCave\{\}}}
...
Die Cave-Box kann auch mit der \Ca{\tbs gCa\{\}-Formatierung} kombiniert werden!
}
\end{lstlisting}
