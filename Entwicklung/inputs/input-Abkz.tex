...
\begin{WidePar}
\section{Abkürzungsverzeichnis und Nomenklatur}
\begin{multicols}{3}
{\small
\begin{description}
...
\setlength{\parskip}{0pt}
  ...
  \item[Cave] \Lang{lat.} \Speech{"`Hüte Dich vor \dots
  ...
  Nitrolingual) und Gabe von Acetylsalicysäure (Aspirin{\texttrademark},
  Aspisol{\texttrademark}).
  \item[MPG]  Medizinproduktegesetz
  \item[N.] \begin{inparaenum}
    \item Nervus, \Lang{lat.}
  Nerv\index{N.|see{Nervus}}
  \item Neoplasma, \Lang{lat.}
  Neubildung\index{N.|see{Neoplasma}}
  \end{inparaenum}
  \item[NA]  Notarzt
  ...
  \item[PatVG] PatVG] Patientenverfügungsgesetz
  ...
  \item[Rz.]  Randzahl
  \item[S.]  Seite
  \item[SanAVO]  Sanitäter-Ausbildungsverordnung.
