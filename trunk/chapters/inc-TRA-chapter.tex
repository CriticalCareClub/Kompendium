...
\begin{itemize}
  ...
  steriler Flüssigkeit \gZ{(Kochsalzlösung (\ce{NaCl}-Lösung), Ringerlösung,
  ...
  (z.B. Gehirn, Eingeweide) zurück zu stopfen! Solche Organteile sollten mit
  steriler Kochsalzlösung (\ce{NaCl}-Lösung) feucht gehalten und anschließend steril mit einem Verbandstuch abgedeckt werden!
...
auf den Kopf, die zusätzlich zu den nicht immer vorhandenen Hautwunden und  zu
den Frakturen des knöchernen Schädels Funktionsstörungen und Verletzungen  des
Gehirns hervorrufen.\cite{Gorgass7}}
...
verschiedene  Formen des SHT auftreten.
...
\gCave{Die Schwere eines SHT lässt sich nur bedingt von den äußerlich
...
\begin{itemize}
    ...
    \item ev. Druckpuls (Bradykardie mit hohen Blutdruckwerten als Folge des
    Hirndrucks)
...
\gDefinition{Gewalteinwirkung auf die Wirbelsäule, die zur Verschiebung oder
...
Einen Knochenbruch nennt man auch \gT{Fraktur}. Man erkennt ihn am  häufigsten
...
\gTODO{GABS}{2010-04-18}{Bild: Neunerregel}{}
}
{\begin{itemize}
    \item Handregel
    \item Neunerregel
...
\gCave{CAVE Unterkühlung bei zu langer oder zu kalter Spülung!}
}

\gLayout{2}{Was man \gCa{nicht} tun sollte \ldots}
{
\begin{itemize}
...
\begin{description}
  ...
  \end{itemize}
  \item \gEs{Elektrische Stromstärke:} Der elektrische 
  Strom\gZFootnote{Elektrischer Strom ist der Fluss von Elektronen.  Die
  treibende Kraft hinter dem Stromfluss ist die elektrische Spannung.}  wird
  durch die elektrische \gT{Stromstärke} beschrieben, welche mit der  Einheit
  \gT{Ampere} (A) gemessen wird. Kommt es  zu einem Stromunfall ist die 
  Schädigung im Körper von der Höhe der Stromstärke  abhängig.\gZFootnote{Bei
  geringen Stromstärken \gE{unter 1 Milliampere (mA)}  ist  nur ein
  elektrischer Schlag spürbar. Bei Stromstärken \gE{ab ca.  10 Milliampere
  (mA)} kommt es zu Schmerzempfindungen und  Muskelkontraktionen \cite{Jaros1},
  ab \gEs{15-25 mA} kommt es aufgrund der Muskelkontraktionen zu  krampfhaften
  ...
  Übersicht  oben schnell entnehmen  kann.}\gZFootnote{Man kann dies  durch 
...
\begin{itemize}
  \item \gEs{Eigenschutz!} Bevor  Sie den Patienten berühren,
  vergewissern Sie sich, dass der Patient keinen Kontakt  mehr mit dem
  Stromkreis hat! \gEs{Schalten Sie auf jeden Fall vor jeder Berührung
  den Strom ab!}
  \begin{itemize}
