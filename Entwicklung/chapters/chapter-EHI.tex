...
Am Beginn stehen die \EE{Lebensrettenden Sofortmaßnahmen}, welche noch in
...
Sofortmaßnahmen wird der \EE{Notruf} abgesetzt, falls dies
noch nicht durch eine 2. Person geschehen ist.

Anschließend wird 
\EE{weitere Erste Hilfe} geleistet, wie zum Beispiel die
Versorgung von einfacheren Verletzungen und die psychologische Betreuung des
Patienten. Der eintreffende Rettungsdienst übernimmt den Patienten für die \EE{Sanitätshilfe} und führt den
\EE{Transport} durch. Im Spital erfolgt schließlich die
\EE{ärztliche Betreuung} des Patienten. 
...
\EE{Spezialkräfte} angefordert und ihnen sämtliche verfügbaren Informationen über die Gefahr bekannt gegeben werden. 
}{
\begin{description}
...
Fahrzeug in einem angemessenen \EE{Sicherheitsabstand} zum Gefahrenbereich an.
Besondere \EE{Gefahrenquellen} wie Kurven,
...
Hilfsmittel, wie \EE{Warnleuchte} oder \EE{Warndreieck}, sowie
...
Gewicht des Zuges, ca. 600-800\,m). Das \EE{Haltesignal} für den Lokführer ist
eine \EE{kreisende Armbewegung}. Dadurch wird er gewarnt und leitet 
...
das \EE{Bewusstsein} und die \EE{Atmung}. 
...
Ersthelfer zu der Erkenntnis kommen, dass der Patient zwar \EE{kein Bewusstsein} hat, aber 
eine \EE{ausreichende Atmung} und daher einen \EE{vorhandenen Kreislauf}. 
...
Das Schlimmste, das der Ersthelfer falsch machen kann, ist
 ...
 einen oder anderen Fehler kommen. Ein Bett ist \EE{keine
...
{
Die \EE{Atemfrequenz} des Erwachsenen beträgt 12-16\,\nicefrac{x}{min}, d.h.
wir atmen 12-16\,\nicefrac{x}{min} ein und aus. Das \EE{\underline{max.} (!)
...
21\,\%. Der \ce{O2}-Gehalt in der \EE{Ausatemluft} beträgt
...
{
Bagatellverletzungen sind \EE{kleine, oberflächliche Wunden}, wie z.\,B.
...
Schmerzen. Beim \EE{3.~Grad} kommt es zur Schorfbildung. Die Schmerzen sind abhängig von der Tiefe der Schädigung
der Haut.
}{
\begin{itemize}
...
besagt, dass die \EE{Handfläche des Patienten  1\,\%}
...
Bei Kindern ist ab \EE{5\,\%}, bei Erwachsenen ab \EE{10\,\%}
...
\EE{Krepitation} (das hörbare und fühlbare Aneinanderreiben der Knochen). \T{Unsichere Kennzeichen} sind \EE{Schmerzen}, \EE{Schwellungen}, \EE{Bewegungseinschränkungen} und \EE{Blutergüsse}. }{
\begin{itemize}
