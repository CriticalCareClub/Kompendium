...
- **Metoclopramid**
  ...
  AnTagonist an zentralen und vagalen 5HT{sub}`3`- und an zentralen und peripheren D{sub}`2`-Rezeptoren, AGonist an peripheren 5HT{sub}`4`-Rezeptoren: Freisetzung von ACh von enterischen Motoneuronen
