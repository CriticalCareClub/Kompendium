...
\gEs{Atemnot}, \gE{pl\"otzlich auftretende
...
\begin{itemize}
    ...
    \item \gEs{brodelnde Atemgeräusch} beim Lungen\"odem
    \item Ödeme
\end{itemize}
}


Das kardiale Lungen\"odem wird im unter
\gSee{topic:lungenoedem} (Lungen\"odem) besprochen. 
...
\gEs{Reanimationspflichtig!} Vorstufe zum Kammerflimmern, Herz kontrahiert so schnell dass es sich nicht mehr f\"ullen kann ${\rightarrow}$ \gEs{keine Auswurfleistung} 
...
\begin{figure}[H]
 ...
 Atemwege bei der COPD. \emph{Oben links:} Bei der COPD  sind die kleinen Luftwege verschleimt und verengt. \emph{Unten links:} Die Lungenbläschen (Alveolen) sind \"uberbläht, weil die Luft nur erschwert wieder entweichen kann.
...
\gMassnahmen{
\paragraph{Spezielle Ma{\ss}nahmen bei der Lungenembolie}
...
\gDefinition{Fl\"ussigkeitsansammlöung stau in den Alveolen und
...
\gMassnahmen{
\paragraph{Ma{\ss}nahmen bei unruhigen oder aggressiven
Patienten}
...
gefährdet und
\item 2. \textbf{nicht in anderer Weise}, insbesondere au{\ss}erhalb einer
...
Zittern, Unruhe, Angst, \gEs{Halluzinationen} ("`wei{\ss}e Mäuse"', \ldots), vegetativer Entgleisung (Tachykardie,
...
\item Patient sitzen lassen, Fl\"ussigkeit
\end{itemize}
}
...
\gMassnahmen{
\paragraph{Ma{\ss}Spezielle Maßnahmen bei Hitzschlag}
...
\gMassnahmen{
\paragraph{Spezielle Ma{\ss}nahmen bei Sonnenstich}
...
\item \gEs{Niemals absichtlich Erbrechen  herbeif\"uhren!}
...
\begin{itemize}
    \item Allgemeine Maßnahmen bei Vergiftungen
    (\gSee{vergiftung-allgemein-massnahmen})
    \item Patienten n\"uchtern lassen
