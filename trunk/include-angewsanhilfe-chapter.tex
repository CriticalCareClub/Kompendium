...
\gFazit{Ersteinsch\"atzung ${\rightarrow}$  Erstma{\ss}nahmen
...
\marginpar{\fcolorbox{ubuntured}{White}{
      		\begin{minipage}[t]{\linewidth}
      			{\sffamily\gEs{Massive St\"orungen von} 
...
(zB. massiv erh\"ohter Blutdruck bei vor\-ge\-sch\"adigtem Herzen,
...
\subsubsection{Zweiter Schritt: Erstma{\ss}nahmen}
...
M\"ogliche Ma{\ss}nahmen, die Reihenfolge ist je nach Patient unterschiedlich\label{tab:checkliste-patientenmanagement}}
{\sffamily
...
Ausserdem, hat der Patient so etwas schonmal gehabt? Oder sind einschl\"agige
...
\begin{multicols}{2}
\begin{enumerate}
    \item Ein Helfer (\gE{hinterer} Helfer) fixiert den Helm von hinten und l\"asst nicht mehr los,
    ...
    \item Ein Helfer (\gE{seitlicher} Helfer) spricht den Patienten von vorne an, \"offnet Visier und
    Kinnriemen
...
\begin{enumerate}
    ...
    schleifen kann (h\"alt sonst nicht mehr)
...
\begin{enumerate}
    ...
    zur\"uckziehend so eng es geht anlegen und festzurren.
...
\begin{itemize}
    ...
    \item Druckk\"orper: zB Mullbinde
...
\begin{enumerate}
    ...
    \item Druckk\"orper mit einer Dreiecktuchkrawatte fest und m\"oglichst
...
\begin{multicols}{2}
\begin{enumerate}
    \item Aufh\"angevorrichtung auf Flasche aufsetzen wenn nötig
    ...
    \begin{itemize}
        ...
        \item Infusionsschlauch entl\"uften
...
\toprule
\multicolumn{2}{m{5.408cm}}{Nur zur Illustration!} 
&
Länge
&
 Durchfluss 
...
d\"unn
\\
\gZ{0,7 x 1,0} & \gZ{20} & \gZ{32} & \gZ{55} & rosa & d\"unn
\\
\gZ{0,9 x 1,2} & \gZ{18} & \gZ{40} & \gZ{90} & gr\"un &
normal
\\
\gZ{1,1 x 1,4} & \gZ{17} & \gZ{42} & \gZ{135} & wei{\ss} &
dick
\\
