...
Als Knöchel wird die Knochengabel, gebildet aus Schien- und Wadenbein, auf Höhe
des Sprunggelenkes bezeichnet. Daher kann man einen Innen- und Außenknöchel
(distales Ende von Schien bzw. Wadenbein). Bei einer Verletzung durch Umknicken
des Fußes nach außen (häufiger) bzw. innen kann einerseits dieser
Knochen-Fortsatz brechen, oder die Bandfixierung dieser Strukturen zu den
...
"`Sternum"' verwenden udn daran gewöhnt werden.}}} und teilweise im linken
...
künstlich (chirurgisch) angelegte, angeborene oder akzidentiell entstandene
Verbindung zwischen Arterien und Venen. Z.B. bei Dialyse-Patienten 
\index{Dialyse-Patient!Shunt} wird chirurgisch ein
Shunt eingesetzt\ZFootnote{Dadurch dass durch die Vene umgeleitetes,
arterielles, Blut mit höherem Druck fließt, verdickt sich die Vene und man
kann sie mit dickeren Kanülen (wie sie für die Dialyse benötigt werden)
punktieren.}. Ein Dialyse-Shunt ist \Ca{verletzlich}, daher darf an einem Arm
mit Shunt nicht gestaut werden; das betrifft insbesonders die Blutdruckmessung
(vgl. \prettyref{topic:blutdruckmessung}). }{
\begin{itemize}
