...
\EE{nicht ausreichende Atmung}, 
unabhängig von der Ursache der Störung. 
Sie führt zu einem Sauerstoffmangel (Hypoxie). 
Der \T{Atemstillstand} (\T{Apnoe}) ist die extremste Form
der Ateminsuffizenz. 
Störungen der Atemgeschwindigkeit
werden als \I{Bradypnoe} (zu langsam) und als \I{Tachypnoe}
(zu schnell) bezeichnet.
Das wichtigste Leitsymptom von Atemstörungen ist die \EE{Atemnot} 
(\T{Dyspnoe}).
Oft führen Störungen außerhalb des Atemsystems zu einer Störung der 
Sauerstoffversorgung des Körpers und dadurch zu Atemnot. 
}{
\begin{itemize}
...
Hirn mit Sauerstoff.
Außerdem ist die \EE{\ce{CO2}-Abgabe} gestört und es kommt
...
\TableWide
{Ursachen für
Atemstörungen}%1 Titel
{}%2 Beschreibung
{\label{tab:atemstoerungen-ursachen}}%3 Label/Hook
{}%4 Quelle
{}%5 Lizenz
{%
...
\toprule\addlinespace
\TabHeading{Verdachts\-diagnose}
&
\TabHeading{Typische Befunde}
&
\TabHeading{SAMPLER}
\\\addlinespace\midrule\addlinespace
\noindent\TabSub{Lungenembolie}
&
&
\\\addlinespace
\noindent\TabSub{Lungenembolie}
...
\\\addlinespace
\noindent\TabSub{Asthma bronchiale}
&
...
Kalte Luft
\\\addlinespace
\noindent\TabSub{COPD-Exzerbation}
&
Orthopnoe
...
Infekt
\\\addlinespace
\noindent\TabSub{Atemwegsverlegung}
&
...
&
\\\addlinespace
\noindent\TabSub{Akutes Koronarsyndrom} (ACS)
&
Thoraxschmerz: Stechend, schneidend, brennend

Enge-/Druckgefühl
&


Austrahlende Schmerzen in li. Arm, Bauch, Kiefer, Rücken

Kardiale Vorerkrankungen
\\\addlinespace
\noindent\TabSub{Dekompensierte Herzinsuffizienz}
&
Brodelndes Atemgeräusch

Beinödeme

Zunehmende Atemnot bei Flachlagerung
&
Kardiale Erkrankung

Schleichender Beginn
\\\addlinespace
\noindent\TabSub{Pneumothorax}
&
Rippenfraktur

Ungleichmäßge Atembewegungen
...
\clearpage % TODO temporary clearpage
\section{Mechanische \HeadingKeyword{Atemwegsverlegung}}
...
möglich) \citep{Erc2005Sec2,Erc2005Sec6,Erc2005DeSec2,Erc2005DeSec6}.}%2 Text
{%
\begin{itemize}
...
{./images/hirtler-aass/Fremdkoerper.pdf}%4 Bilddatei
{Atemwegsverlegung (Schema)}%5 Bildtitel
{Der linke Bissen steckt in der Luftröhre fest, der
andere befindet sich in der Speiseröhre.}%6 Bildbeschreibung
...
\begin{Synopsis}
  \SynopsisItem{Die (Un-) Fähigkeit zu sprechen und zu husten ist das
...
\begin{ABCDEText}
  ...
  verlegt. Eventuell ist ein pfeifendes Atemgeräusch
...
\clearpage % TODO temporary clearpage
\section{\HeadingKeyword{Asthma bronchiale}}
...
\end{itemize}}%3 Slide
{./images/asthma-paramedic.jpg}%4 Bilddatei
{Patientin mit einem akuten Asthmaanfall}%5 Bildtitel
...
Sauerstoffgabe, Reanimationsbereitschaft, Notarztnachforderung und Monitoring.\label{fig:asthma-paramedic}}%6 Bildbeschreibung
...
%\Text{{\TxQuerverweise}}{%
%\begin{compactitem}
%  \item Lippenbremse: \dotfill \FullPrettyRef{topic:lippenbremse-basic}
%\end{compactitem}
%}
...
\section{Chronische
Bronchitis und \HeadingKeyword{COPD}}
\label{topic:copd}
...
COPD-Patienten}
{% 
Beim gesunden Menschen ist der \EE{Atemantrieb} vom \EE{\ce{CO2}-Gehalt} des Blutes abhängig: 
%
Je höher der \ce{CO2}-Gehalt, desto stärker der Atemantrieb.
%
Bei COPD-Patienten ist die \E{\ce{CO2}-Konzentration} im Blut jedoch chronisch \E{erhöht}, 
dadurch \E{gewöhnt} sich der Körper an diesen Zustand. 
%
Er beginnt dann den \E{Atemantrieb direkt über den \ce{O2}}-Gehalt im Blut zu
regeln.


\index{Sauerstoff!COPD-Patient}%
Dies kann bei der Behandlung \E{Probleme} bereiten: 
Wird bei solch einem Patienten der \ce{O2}-Gehalt künstlich erhöht
(z.\,B. durch Sauerstoffberieselung), 
fehlt der Atemantrieb, es gilt bei \E{diesen} Patienten:
\Speech{Je höher der \ce{O2}-Gehalt des Blutes, 
desto geringer der Atemantrieb.} 
%
Somit wird \ce{CO2} nicht mehr ausreichend abgeatmet,
der \ce{CO2}-Gehalt im Blut steigt weiter an 
und es kommt dadurch zu \EE{Bewusstseinsstörungen}
(\I[\ce{CO2}-Narkose@CO2-Narkose]{\ce{CO2}-Narkose}).
%
Im Extremfall kann es auch zu einem 
\II[Atemstillstand!Sauerstoffgabe bei COPD]{Atemstillstand} 
kommen.
}{
\begin{itemize}
  \item Atemantrieb normalerweise durch \EE{\ce{CO2}}-Spiegel
  \item COPD: \ce{CO2}-Spiegel dauerhaft erhöht
  $\rightarrow$ Gewöhnungseffekt 
  $\rightarrow$ Atemantrieb gemäß \ce{O2}-Spiegel
  \item Problem bei Sauerstoffgabe: Verminderter Atemantrieb
  \begin{itemize}
    \item Verminderte \ce{CO2}-Abatmung $\rightarrow$ Bewusstseinsstörungen
    \item Extremfall: Atemstillstand
  \end{itemize}
\end{itemize}

\Ca{Bewusstseinsstörungen bei übermäßiger
...
\begin{Danger}
  \item {Bei COPD-Patienten kann es bei Sauerstoffgabe zu Bewusstseinsstörungen und im Extremfall zu einem Atemstillstand kommen.}
\end{Danger}
...
{Veränderung der
	...
	Lungenbläschen (Alveolen) sind überbläht, weil die Luft nur erschwert wieder entweichen kann.}
{}
{\label{fig:copd-veraenderungen}}
{Hirtler}
{}
{./images/hirtler-aass/Alveolen-Bronchus-COPD-edited2.png}
{}
...
{Eine COPD
	entsteht nicht plötzlich: Ein COPD{\textquotesingle}ler hat eine
	\protect\enquote{Karriere} hinter sich.}
{}
{}
{Hirtler}
{}
{./images/hirtler-aass/COPD-Stufen_edited.pdf}
{}
...
\section{\HeadingKeyword{Lungenembolie}}
...
\TextSlideTeaser
{{\TxBeschreibung} und Ursachen}%1 Titel
{%
...
\begin{itemize}
  ...
  \end{itemize}
\end{itemize}}%3 Slide
{./images/hirtler-aass/Thrombus-Embolie.pdf}%4 Bilddatei
{Herkunft des Thrombus}%5 Bildtitel
{}%6 Bildbeschreibung
{Lena Hirtler}%7 Quelle
{}%8 Lizenz
 % Vormals \Layout{60}
...
\section{\HeadingKeyword{Lungenödem}}
...
\begin{itemize}
  ...
  Herzmuskels massiv in Mitleidenschaft zieht.
...
\section{\HeadingKeyword{Hyperventilationssyndrom} und -tetanie}
\label{topic:hyperventilationstetanie}
\label{topic:hyperventilationssyndrom}
...
\begin{Synopsis}
  \SynopsisItem{Beim Hyperventilationssysdrom ist die Atmung \EE{ohne 
