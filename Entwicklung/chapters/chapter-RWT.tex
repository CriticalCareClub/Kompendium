...
\begin{description}
  \item[Landefläche] Der Hubschrauber benötigt einen
  ...
  \item[Tageszeit] Nur wenige Hubschrauber sind
  nachtflugtauglich, außerdem verbietet sich eine Landung
  abseits gesicherter Landeplätz in der Nacht.
  \item[Kosten] Sowohl die Vorhaltung als auch der Einsatz
  eines Hubschraubers ist immens teuer.
  \item[Platz] Je nach Typ ist im Hubschrauber aufgrund des
