...
\newcommand{\VarAassVersion}{1.1-dev-\pdfdate}
\newcommand{\DocVersion}{1.1-dev-\pdfdate}
...
%%%
\newcommand{\DocVersionTyp}{Entwicklungsversion (Iteration 43)}
% \renewcommand{\DocVersionTyp}{Vorabversion}
% \renewcommand{\DocVersionTyp}{Beta-Version}
% \renewcommand{\DocVersionTyp}{Release}
\newcommand{\DocVersionInfo}{Entwicklungsversion (Iteration 43) -- Für den internen Gebrauch.}
