...
\usepackage{xr}
\externaldocument[MK-]{AASS-MKATALOG}
...
% 4: Text / Taktik
% 5: Punkte
\newcommand{\MassnahmenMK}[5]{\Layout{Massnahmen}{{\SignMassnahme}
#1: #2}{#4\par Siehe
\FullPrettyRef{MK-#3}}{#5\FullPrettyRef{MK-#3}}{}{}{}}

\newcommand{\QSO}{>>}
\newcommand{\QSC}{<<}
\newcommand{\QSSO}{>>}
\newcommand{\QSSC}{<<}
\newcommand{\SlideCompensation}[1]{#1\baselineskip}
...
Referenzen finden sich im im Maßnahmenkatalog (Version
\VarMkatalogVersion).
\end{WidePar}
...
gekennzeichnete Referenzen finden sich im im Maßnahmenkatalog (Version
\VarMkatalogVersion).
