...
\begin{compactdesc}
  ...
  \item[Base] \fxwarning[author=GABS]{EIN / Begriffe: "`Base"' muss noch
  erklärt werden.}
  ...
  zusammengesetzt.
  \item[Säure] \fxwarning[author=GABS]{EIN / Begriffe: "`Säure"' muss noch
  erklärt werden.}
...
\begin{compactdesc}
  ...
  \item[Organ] \fxwarning[author=GABS]{EIN / Begriffe: "`Organ"' muss noch
  erklärt werden.}
