...
\subsection{Der schmerzende \HeadingKeyword{Bauch}}
...
\section{\HeadingKeyword{Häufige} und gut erkennbare Erkrankungen}



\subsection{Das \HeadingKeyword{Akute Abdomen}}
...
\subsection{\HeadingKeyword{Darmverschluss}}
...
\subsection{\HeadingKeyword{Appendizitis} (Blinddarmentzündung)}
...
\subsection{\HeadingKeyword{Gallenkolik}}
...
\HeadingKeyword{Blutungen} und Ösophagusvarizenblutung}
...
{
\begin{itemize}
    \item Oberer Teil: Ösophagusvarizen
...
spricht vom sog. \T{Teerstuhl} (\T{Meläna}. Bei Blutungen im
...
\begin{Synopsis}
  \SynopsisItem{Der Patient kann aufgrund des Blutverlustes akut
...
\subsection{Magen-Darm-Grippe, \HeadingKeyword{Gastroenteritis},
...
\subsection{Flüssigkeitsmangel: \HeadingKeyword{Exsikkose}}
...
% \clearpage % TEMP temp clearpage
\section{\HeadingKeyword{Weniger häufige} oder nicht-so-gut-erkennbare Erkrankungen}
...
\subsection{Magen- und Zwölffingerdarm\HeadingKeyword{geschwür}}
...
\subsection{Entzündung der Bauchspeicheldrüse: \HeadingKeyword{Pankreatitis}}
...
\subsection{Verschluss eines Mesenterialgefäßes: \HeadingKeyword{Mesenterialinfarkt}}
...
% \clearpage % TEMP temp clearpage
\subsection{\HeadingKeyword{Bauchfellentzündung}}
