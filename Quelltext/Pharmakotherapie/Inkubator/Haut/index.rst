...
Die Haut bildet die äußere Oberfläche des Körpers und dient als

-  Schutz vor Schäden
-  als Sinnesorgan
-  zur Wärmregulation durch Schweißsekretion sowie Regulation der
   Blutgefäße (Eng-/Weitstellung)

Die Haut ist anatomisch in mehrere Schichten gegliedert:

-  Kutis:

   -  Epidermis: Oberhaut, ist die Hautoberfläche, ca. 0,5 – 5 mm dick
      mit verhorntem Plattenepithel. In der Epidermis befinden sich
      Immun- und Pigmentzellen sowie die Zellen für den Tastsinn. Sie
      besteht aus mehreren Schichten (z.B. Stratum corneum, Startum
      granulosum sowie Stratum basale, die innerste Schicht, in der
      durch ständige Zellteiliung die Oberhaut erneuert wird). Die
      Epidermis bildet auch die undurchlässige Hornschicht. Es sind
      keine Gefäße in der Epidermis.
   -  Dermis: Lederhaut, diese ist gut durchblutet, beinhaltet
      Nervenfasern und Sinnesrezeptoren. Sie besteht aus Bindegewebe,
      Kollagenfasern uns elastischen Fasern. Talg- und Schweißdrüsen
      sowie Haarfollikel sind in der Dermis eingelagert.
...
| topisch                          |                                  |
+----------------------------------+----------------------------------+
| Benzoylperoxid                   | Benzaknen®, Akneroxid®, Panoxyl® |
|                                  |                                  |
|                                  | (kann Kleidung ausbleichen bei   |
|                                  | direktem Kontakt)                |
+----------------------------------+----------------------------------+
...
+----------------------------------+----------------------------------+
| Erythromycin                     | Aknemycin, Akne-Cordes           |
|                                  |                                  |
|                                  | in Kombination mit Tretinoin:    |
|                                  | Aknemycin plus                   |
+----------------------------------+----------------------------------+
| Clindamycin                      | Basocin                          |
+----------------------------------+----------------------------------+
| Isotretinoin (Vitamin-A-Derivat) | Isotrex-Gel (lokal)              |
+----------------------------------+----------------------------------+
| systemisch                       |                                  |
+----------------------------------+----------------------------------+
| Natürliche Derivate von          |                                  |
...
+----------------------------------+----------------------------------+
| Synthetische Derivate von        |                                  |
| Vitamin A (2. Generation)        |                                  |
+----------------------------------+----------------------------------+
| Acitretin                        | Neotigason®                      |
+----------------------------------+----------------------------------+
| Etretinat                        |                                  |
+----------------------------------+----------------------------------+
| 3. Generation (Arotinoide)       |                                  |
+----------------------------------+----------------------------------+
...
+----------------------------------+----------------------------------+
| Minocyclin                       | Klinomycin                       |
+----------------------------------+----------------------------------+
| Doxycyclin                       | Generika                         |
+----------------------------------+----------------------------------+
| Antiandrogene                    |                                  |
+----------------------------------+----------------------------------+
| Cyproteronacetat                 | Diane (für Frauen: Antiandrogene |
|                                  | in Kombination mit Östrogenen    |
|                                  | zur gleichzeitigen               |
|                                  | Kontrazeption).                  |
+----------------------------------+----------------------------------+
...
-  Normalisierung von Wachstum und Differenzierung von Haut- und
   Schleimhautzellen
-  Senkung der erhöhten Teilungsrate
-  Auflockerung der Hornschicht
-  Reduktion des gesteigerten Anhaftens von Hornzellen im Follikelkanal
-  Immunmodulierend
-  Entzündungshemmend
...
-  Erhöhung von Transaminasen und Lipiden
-  Alle Retinoide sind bei oraler Applikation **teratogen**! Bei Frauen
   im gebärfähigen Alter ist auf eine ausreichende Kontrazeption zu
   achten!
...
P. vulgaris, P. punctata, P. guttata etc.
...
|                           |                           |            |
|                           | kombiniert mit            |            |
|                           | Salicylsäure: Psoralon    |            |
|                           |                           |            |
|                           | kombiniert mit Harnstoff: |            |
|                           | Psoradexan                |            |
+---------------------------+---------------------------+------------+
| Glucocorticoide           | Vertreter mit sehr        |            |
|                           | starker oder starker      |            |
|                           | Wirkung z.B.              |            |
|                           |                           |            |
|                           | Clobetasol-17-propionat   |            |
|                           | (Dermovate)               |            |
|                           |                           |            |
|                           | Diflucortolon-21-verlat   |            |
|                           | (Neriforte, Nerisona)     |            |
|                           |                           |            |
...
|                           | (Pecisone, Aureocort)     |            |
|                           |                           |            |
|                           | Vertreter mit schwacher   |            |
|                           | Wirkung                   |            |
|                           |                           |            |
|                           | Hydrocortison (Hydroderm, |            |
|                           | Locoidon)                 |            |
+---------------------------+---------------------------+------------+
| Vitamin-D3-Analoga        |                           |            |
+---------------------------+---------------------------+------------+
| Calcipotriol              | Psoricutan, Daivonex      |            |
+---------------------------+---------------------------+------------+
...
| UV-B                      |                           |            |
+---------------------------+---------------------------+------------+
| PUVA                      | Psoralene Methoxsalen     | Oxsoralen® |
|                           | (Amoidin,                 |            |
|                           | 8-Methoxypsoralen),       |            |
|                           | Trioxsalen                |            |
+---------------------------+---------------------------+------------+
...
| (Lithanthracis pix)       |                           |            |
+---------------------------+---------------------------+------------+
| ?*Sulfonierte Schieferöle | Ichtyol??                 |            |
|                           |                           |            |
...
-  Dithranol: der Wirkstoff bewirkt durch aktive Sauerstoffspezies eine
   Senkung der erhöhten Mitoserate. Starker Reizeffekt auf die Haut,
   systemische Nebenwirkungen sind nicht bekannt. Eine
   Wirkungsverstärkung kann durch Kombination mit Harnstoff und
   Salicylsäure erzielt werden.
-  Teerpräparate und sulfonierte Schieferöle: diese wirken
   antiproliferativ, antimitotisch, entzündungshemmend, antiekzematös,
   juckreizstillend und schwach antimikrobiell. Nebenwirkung sind
   Photosensibilisierung, Follikulitis, Teerakne, Hautirritationen oder
   allergische Reaktionen. Teerpäparate erwiesen sich im Tierversuch
   zudem als kanzerogen, beim Menschen jedoch nicht belegt. Schieferöle
   haben ein geringeres Risiko für gentoxische Wirkung durch einen
   geringeren Gehalt an polycyclischen aromatischen Kohlenwasserstoffen

Lokal angewendet werden auch

1. Retinoide (Acitretin, Tazaroten) s. o.**:
2. Vitamin D3-Analoga Calicpotriol, Tacalcitol: diese binden an
   intrazelluläre Rezeptoren und erhöhen die Zellproliferation und
   –differenzierung. Werden diese topisch angewendet, beeinflussen sie
   den Ca\ :sup:`2+`-Stoffwechsel kaum. Nebenwirkungen sind lokale
   Reizerscheinungen, ev. Hypercalciämie und Hypercalciurie
3. Immunsuppressiva wie Ciclosporin, Tacrolimus*, Sirolimus*(pasen die
   da eh rein..**) Methotrexat, Azathioprin, Fluorouracil u.a. bei
   schwerster, therapieresistenter Psoriasis. Diese Präparate bewirken
   eine Hemmung von T-Zellen. In höhere Dosierung wirken diese
   hepatotoxisch (Methotrexat) bzw. nephrotoxisch (Ciclosporin).
4. Glucocortikoide: diese wirken antiphlogistisch, antiproliferativ,
   immunsuppressiv, antipruriginös und vasokonstriktorisch. Sie hemmen
   die Bildung proinflammatorischer Zytokine in der Keratozyten
   ->**ibroblasten??*\* Nebenwirkungen sind z.B. Hautatrophien,
   periorale Dermatis, Purpura*, Follikulitis, Kontaktallergien,
   Hautpilze und –bakterien können überwuchern. Eine Langzeitanwendung
   und großflächige Anwendung soll nur unter strenger Kontrolle erfolgen
   (Gefahr systemischer Nebenwirkungen wie Cushing-syndrom,
   Wachstumshemmung bei Kindern).

Folgende Vorsichtsmaßnahmen sind daher angezeigt:

1.

   -  Vertreter mit möglichst geringer Wirkstärke
   -  Geringe Dosierung
   -  Möglichst kurze Anwendung
   -  Kleine Flächen
   -  Keine Okklusionsverbände

2. Fumarsäureester wie Dimethylfumarat, Ethylhydrogenfumarat: diese
...
3. Biologicals \**\* wie Etanercept, Efalizumab, Alefacept, Infliximab:
   bei schwerer bis mittelschwerer Psoriasis mit unzureichendem
   Ansprechen oder Unverträglichkeit z.B. von Ciclosporin, PUVA,
   Methotrexat.
...
-  verschiedene Formen der Dermatitis (Ekzeme), Flechten**, Urtikaria
   (z.B. bei allergischen Reaktionen der Haut) und Angioödem. Behandelt
   wird vorrangig die Entzündung mit Antiphlogistika und
   Immunsuppressiva. Die Ursachen der Erkrankungen sind jedoch
   verschieden.

-  Virusinfektionen der Haut:

   -  Warzen durch human Papillom-Viren: Behandlung mit Keratolytika mit
      verschiedenen Säuren, kombiniert auch mit Fluorouracil
      (Verrumal!*)
   -  Feigwarzen im Anogenitalbereich bei Erwachsenen durch HPV:
      topische Behandlung mit Imiquimod, einem Immunmodulator.
   -  Herpesinfektionen (Herpes simplex und Herpes zoster [Gürtelrose]).
      ??*\*

-  Furunkel: Entzündungen der Haarbälge
-  Hühneraugen: Epidermis-Hypertrophie durch Druck in zu engen Schuhen.
   Behandlung mit keratolytischen Lösungen (mit Salicylsäure,
   Milchsäure).
-  Parasitosen z.B. Sakbies (Krätze)
-  Pilzinfektionen: z.B. Fußpilz (Tinea pedis) und Soor (Candidiasis).
   Die Behandlung erfolgt mit Antimykotika [VERWEIS*]
-  Tumorerkrankungen wie Melanome, Basaliome oder
   Plattenepithelkarzinome: Behandlung mit Imiquimod, Fluorouracil,
   Diclofenac oder Aminolävulinsäuremethylester oder z.B. bei Basaliomen
   und Melanomen operativ.
-  Stöungen der Pigmentierung
-  Lichtschäden: durch Sonnenbrand. Prophylaxe mit Sonnenschutzmitteln!
-  Verbrennungen
-  Ulcera wie Dekubitalulcera, Diabetischer Fuss: Wundversorgung,
   Sekretabsaugung, spezielle Lagerung des Patienten. Die Wunde muss
   trocken\* und keimfrei\* gehalten werden, um ein Abheilen zu
   ermöglichen. Bei größeren Ulcera sind Hauttransplantationen
   notwendig*******(CHECK*)
-  Hirsutismus (übermässiger Haarwuchs): Behandlung mit Eflornithin
   (Vaniqa-Creme), um die Regulation des Haarwachstums zu verbessern.
-  Haarverlust beim Mann: um das Fortschreiten des Haarausfalls
   aufzuhalten, Behandlung mit Finasterid (Propecia), einem Hemmer der
   5α-Reduktase in den Haarbildenden Zellen. Andernfalls:
   Haartransplantation.
