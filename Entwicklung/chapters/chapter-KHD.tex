...
{Führungsrolle bie der Bewältigung eines Großschadensereignis: Der Leider einer Sanitätshilfestelle (SanHiSt). \SourcePicture{Gabriel}}
{./images/gabriel-sebastian-aass/UEKAISERMUEHLENTUNNEL2011-000253-0154pt-0300dpi}
...
Der Unfall ist plötzlich und unerwartet, die Dauer des
...
\Definition{\enquote{Ein Großunfall liegt vor, wenn
anzunehmen ist, dass das Ereignis mit den örtlichen
personellen und materiellen Kräften und Mitteln nicht
bewältigt werden kann, aber keine erklärte
...
\Definition{Ein \EE{unvorhergesehenes Ereignis} mit einem
\EE{außergewöhnlichen Schadensausmaß} das unmittelbar
bevorsteht oder bereits eingetreten ist, eine \EE{konkrete
Gefahr für Menschen}\Z{, Tiere, Umwelt, Kulturgüter} und
Sachwerte sowie für die \EE{Infrastruktur} zur Sicherstellung
der Versorgung mit lebensnotwendigen Gütern und
Dienstleistungen, welches der \EE{koordinierten Führung durch
die Behörde} bedarf. }

\Layout{0}{\TxBeschreibung}{
Das Ereignis betrifft ein \E{(über)-regionales Gebiet} und
...
\begin{itemize}
  \item \T{Naturkatastrophen}: Erdbeben, Überschwemmungen,
...
Regeln der Katastrophenmedizin
\\\addlinespace
\TabSub{Material und Mann\-schaft:}
 &
...
\Definition{Massenversorgung von Verletzten und Erkrankten
mit beschränkten Mitteln und dem Zwang zur Einteilung nach
...
Umständen so viele Leben wie möglich zu retten, \EE{mit
...
Diese Einteilung nennt man Triage.
}{%
\begin{itemize}
...
\Definition{\EE{Begutachten} aller Patienten mit geringen Mitteln und
  Aufwand sowie das \EE{Einteilen} in Triagegruppen gemäß der
  \EE{Behandlungsdringlichkeit} und \EE{-möglichkeit} mit dem Ziel mit
...
\Layout{0}{Triagegruppen können sich im Verlauf ändern}{%
...
Nach einer erfolgten Behandlung kann eine Transportpriorität 
zugewiesen werden. 
...
\Layout{0}{\TxBeschreibung}{
Ziel ist es, das \EE{Bestmögliche} für die größte Anzahl zur
...
besteht.  Wir müssen mit einem großen Patientenanfall, 
besonderen Verletzungsmustern, einer längeren
Einsatzzeit vor Ort und nicht zuletzt mit einer
...
Die Katastrophenhilfegesetze regeln die Aufgaben der Länder,
Organisationen und Zuständigkeiten in Ihrem Bereich.
\EE{Ausschließlich eine Behörde erklärt ein
außergewöhnliches Schadensereignis zur Katastrophe} im Sinne
des Gesetzes. Behördliche Alarmpläne dienen zur Festlegung
...
Einsatz von Personal, Material und Transportmitteln

Im Schadensraum gilt: \enquote{\EE{Ein einziger
...
\begin{enumerate}
    ...
    \item festlegen, wohin die Patienten im Schadensraum
    gebracht werden sollen (Beginn einer Triage)
...
\begin{description}
  ...
  drei Räumen \T{Triageraum}, \T{Behandlungsraum} und
   \T{Transportraum} besteht. Definiert wird Sie z.B. in der ASBÖ Rahmen\-vor\-schrift für
...
Das Team muss mind. aus einem NFS und einem NA bestehen. Es
erfolgt eine Sichtung der Betroffenen und Festlegung der
Behandlungsdringlichkeit. Die Bergetriage behandelt nicht!
}{
\begin{itemize}
...
\Layout{2}{Behandlungsprotokoll / Identifikationsprotokoll}{%
...
\Layout{2}{Kontaminationsaufkleber}{%
...
\subsubsection{Felder der Patientenleittasche}
...
\paragraph{Feld \emph{\enquote{Triage}}} \textcircled{a}
...
\paragraph{Feld \emph{\enquote{Transport}}} \textcircled{c}
...
\begin{itemize}
    \item Atmung (\ce{O2}, Intubation, usw..)
...
betrauten Betrauten festzulegen, welche Verfahrensweisen im
