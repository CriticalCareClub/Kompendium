...
{~
\begin{ABCDEText}
  \item[\ABCDE{Eindruck}] Der Patient erscheint
  schmerzgeplagt und nimmt oft eine Schohnhaltung ein.
  \item[\ABCDE{Hauptbeschwerde}] Leitsymptom ist der
...
{~
\begin{ABCDEText}
  \item[\ABCDE{Szeneüberblick}] Es finden sich evtl.
  Hinweise auf Bettlägrigkeit oder stattgehabte Reisen
  (Koffer, \ldots). 
  \item[\ABCDE{Eindruck}] Evtl. fällt eine
  \EE{Schwangerschaft} auf.
  \item[\ABCDE{Hauptbeschwerde}] \EE{Schmerzen} in der
...
\begin{ABCDESlide}
  ...
  \item[\ABCDE{Be}] 
  \item[\ABCDE{Hb}] 
  \item[\ABCDE{\ldots}] \begin{compactitem}
