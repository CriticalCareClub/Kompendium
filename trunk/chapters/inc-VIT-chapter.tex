...
\Z{Die {\quotedblbase}wahre{\textquotedblleft} Definition
...
Unter \See{topic:saeure-basen-haushalt} werden wir sehen dass das \ce{CO2}
...
\See{topic:azidose-respiratorische}) kommen.
}{
\begin{itemize}
    \item \ce{O2}-Gehalt im Blut ↓ (Hypoxie).
    \item \ce{CO2}-Gehalt im Blut ↑.
    \item Respiratorische Azidose (\See{topic:azidose-respiratorische}).
\end{itemize}
}{}{}{}
...
unter \See{topic:herz-kreislauf-stoerungen} besprochen. 
...
\Definition{{\quotedblbase}Lebensbedrohliche Kreislaufstörung aufgrund von
...
\MassnahmenNG{Spezielle Maßnahmen}{Hypovolämischer
    Schock}{}{
...
\AuthNotes{Begriff {\quotedblbase}Schocklagerung{\textquotedblleft}
...
Siehe auch: Hygiene, \See{topic:sepsis}.
...
\MassnahmenNG{Spezielle Maßnahmen}{Septischer und
    Toxischer Schock}{}{
...
\Parallel{
\SlideHeading{Wärmeproduktion durch}
...
{\quotedblbase}\index{osmotischer Druck}\T{osmotischen
...
\Z{Daneben gibt es den {\quotedblbase}onkotischen
...
\begin{description}
  ...
  \item[\T{Basen}] Stoffe, die \ce{H^+} aufnehmen können, =
  \T{Laugen}
\end{description}
}{}{}{}
...
\begin{itemize}
    ...
    \item Die
    \Es{Elektrolyte} haben einen großen Einfluß auf die Wasserverteilung: Nur
...
Die ersten beiden Punkte sind \E{frühe
Leichenerscheinungen}, da sie relativ rasch auftreten.
Andere frühe Leichenerscheinungen sind die \E{Abkühlung
der Leiche} und die \E{Totenstarre}. Längere Zeit nach dem Tod treten die \E{späten
Leichenerscheinungen} auf, dazu gehören \E{Fäulnis und
Verwesung}, \E{Mumifizierung}, \E{Tierfraß} und
\E{Skelettierung}. 
