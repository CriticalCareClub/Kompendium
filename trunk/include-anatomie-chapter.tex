...
so kann iene Volumsvergrößerung (Einatmung) durch eine
...
Schüssel}
{\quotedblbase}\gT{Gastrointestinaltrakt}{\textquotedblleft} (GIT)
...
Speicheldrüsen: produzieren Speichel um Nahrung
gleitfähig zu machen und Nahrung mit Verdauungsenzymen
\gZ{(für Zucker und Stärke)} zu versetzen.
...
\begin{itemize}
    \item Produziert Enzyme f\"ur Verdauung ${\rightarrow}$
    Zw\"offingerdarm
...
\begin{itemize}
    ...
    \item \index{Harnleiter}je 1 Harnleiter  (Ureter ),
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        Eizellen
        \item \gEs{Eileiter} (Tuba): Transport des reifen
