...
Advisory Committee for Aeronautics} diente ursprünglich der Bewertung von 
...
%
Der Bewusstseinsgrad gibt Auskunft über die Quantität des Bewusstseins (\enquote{\E{Wieviel} Bewusstsein ist
...
Zwecken.\ZFootnote{Regelmäßig findet man
Handlungsanweisungen -- überwiegend für ärztliches Personal -- in der Literatur,
...
in Ruhe \VonBis{12}{16}\PerMin*.
  ...
  500\Ml*.\ZFootnote{Die Einstellungen eines Beatmungsgeräts können von den Normalwerten deutlich abweichen, da man z.\,B. manchmal
...
Alter, Geschlecht und Größe. \cite{KlinkePhysio3,SchmidtPhysio28,DRAn3,StriebelAn7}
...
\ce{O2}-Konzentration der Umgebungsluft notwendig, denn
ohne Sauerstoff in der Einatemluft ist die beste Atmung nutzlos. Der normale \ce{O2}-Gehalt der Umgebungsluft
beträgt 21\PC*.
...
\T[Totraum!-ventilation]{Totraumventilation} ist das Atemzugsvolumen so klein dass die
\enquote*{frische} Luft im Totraum bleibt und nicht in die
...
\begin{itemize}
    ...
    \item Respiratorische Azidose (\FullPrettyRef{topic:azidose-respiratorische})
\end{itemize}
}{}{}{}
...
\RRmmHg{155}{95}. Der Patient kennt seinen \enquote{gewöhnlichen} Blutdruck
nicht.}  
...
erklärbar durch die starken Schmerzen und den damit verbundenen
...
mittels Medikamenten unbedingt gesenkt werden. 
\end{quote}
...
\begin{itemize}
  ...
  medizinische Behandlungsmethoden verursachen als Nebenwirkung eine massive \EE{Schädigung des Knochenmarks}\index{Knochenmark!Schädigung} (z.\,B. Bestrahlung, Chemotherapien bei Krebspatienten (\enquote{onkologische Patienten}), etc.). Diese Patienten leiden
...
\Speech{\enquote{\ce{H^+} entspricht Säure.}}} abgeben können,
