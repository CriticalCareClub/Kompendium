...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Störungen des Kreislaufs}
\subsection{Schock}
\index{Schock}
\label{topic:schock}
...
\subsection{Störungen des Blutdrucks}
\subsubsection{Hypotonie}
...
\subsection{Erkrankungen der Herzkrankzgefäße}
...
\subsubsection{Peripherer arterieller Gefäßverschluß}
...
\subsubsection{Peripherer venöser Gefäßverschluss: 
